module.exports = {
  // TypeScript and TSX files - very permissive linting
  '*.{ts,tsx}': [
    'eslint --fix --max-warnings 50', // Allow many warnings without failing
    'prettier --write --ignore-unknown',
  ],

  // JavaScript and JSX files - very permissive linting
  '*.{js,jsx}': [
    'eslint --fix --max-warnings 50', // Allow many warnings without failing
    'prettier --write --ignore-unknown',
  ],
