...
class CRDTBenchmark {
   ...
   */
  async benchmarkConcurrentNodeCreation(nodeCount: number, userCount: number): Promise<BenchmarkResult> {
   ...
   */
  async benchmarkSynchronization(nodeCount: number, syncCount: number): Promise<BenchmarkResult> {
