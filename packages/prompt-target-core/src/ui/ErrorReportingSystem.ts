...
export class ErrorReportingSystem {
  ...
  private listeners = new Set<ErrorReportingListener>();
  ...
  private calculatePlatformCompatibility(report: ValidationReport): number {
  ...
  private generateReportDownloadUrl(graphId: string): string {
