...
export class AdaptorTestFramework {
  private testResults: AdaptorTestResults = {
    compliance: {
   ...
   * Test interface compliance
   */
  private async testInterfaceCompliance(adaptor: ModelAdaptor): Promise<void> {
   ...
   */
  private async testQualityScoring(adaptor: ModelAdaptor): Promise<void> {
  ...
  private createTestGraph(): PromptGraph {
    return this.createSimpleTextGraph();
  }

  private generateTestGraphs(count: number): PromptGraph[] {
    const graphs: PromptGraph[] = [];
  ...
  private createSimpleTextGraph(): PromptGraph {
    return {
      id: 'simple-text',
      version: '1.0',
      nodes: [
  ...
  private createMultiNodeGraph(): PromptGraph {
    return {
      id: 'multi-node',
      version: '1.0',
      nodes: [
  ...
  private createComplexGraph(): PromptGraph {
    return {
      id: 'complex',
      version: '1.0',
  ...
  private createInvalidGraph(): PromptGraph {
    return {
      id: 'invalid',
      version: '1.0',
      nodes: [
  ...
  private createCyclicGraph(): PromptGraph {
    return {
      id: 'cyclic',
      version: '1.0',
      nodes: [
  ...
  private createLargeGraph(): PromptGraph {
    return {
      id: 'large',
      version: '1.0',
  ...
  private createDeepGraph(): PromptGraph {
    const depth = 20;
    return {
      id: 'deep',
      version: '1.0',
  ...
  private createDisconnectedGraph(): PromptGraph {
    return {
      id: 'disconnected',
      version: '1.0',
      nodes: [
  ...
  private createOptimalGraph(): PromptGraph {
    return {
      id: 'optimal',
      version: '1.0',
      nodes: [
  ...
  private createProblematicGraph(): PromptGraph {
    return {
      id: 'problematic',
      version: '1.0',
      nodes: [
