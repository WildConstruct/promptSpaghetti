 ...
 */
export function createValidationEngine(config?: Partial<ValidationEngineConfig>): ValidationRulesEngine {
  const defaultConfig = {
 ...
 */
export function createStrictValidationEngine(): ValidationRulesEngine {
 ...
 */
export function createDevelopmentValidationEngine(): ValidationRulesEngine {
  return new ValidationRulesEngine({
    enabledCategories: Object.values(ValidationCategory),
    minSeverity: ValidationSeverity.INFO,
    enableAutoFix: true,
 ...
 */
export function createSecurityValidationEngine(): ValidationRulesEngine {
  return new ValidationRulesEngine({
 ...
 */
export function createPerformanceValidationEngine(): ValidationRulesEngine {
  return new ValidationRulesEngine({
 ...
 */
export async function validateAndFixGraph(
  graph: any,
  targetPlatform?: string,
  capabilities?: any
): Promise<{
 ...
 */
function detectPlatformFromGraph(graph: any): string | null {
 ...
 */
function generateBasicCapabilities(platform: string): any {
 ...
 */
function estimateTokenCount(graph: any): number {
