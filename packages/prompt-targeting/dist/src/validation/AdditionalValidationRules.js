 ...
 */
import { ValidationCategory, ValidationSeverity } from './ValidationRulesEngine';
/**
 * Validates that all nodes have valid and required properties
 */
export class MissingRequiredPropertiesRule {
  ...
  getDefaultValue(property, nodeType) {
    const defaults = {
 ...
 */
export class DuplicateContentRule {
  ...
  async validate(context) {
    ...
    const contentMap = new Map(); // content -> nodeIds[]
 ...
 */
export class LanguageConsistencyRule {
 ...
 */
export class SensitiveContentRule {
  ...
  sensitiveCategories = ['Personal Information', 'Confidential Data', 'Potentially Harmful', 'Inappropriate Content'];
  applies() {
    return true;
  }
  async validate(context) {
 ...
 */
export class ProcessingTimeRule {
  id = 'processing-time';
...
//# sourceMappingURL=AdditionalValidationRules.js.map
