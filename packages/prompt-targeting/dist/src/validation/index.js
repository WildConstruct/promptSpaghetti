 ...
 */
export async function validateAndFixGraph(graph, targetPlatform, capabilities) {
 ...
 */
function detectPlatformFromGraph(graph) {
    if (!graph.nodes)
        return null;
 ...
 */
function calculateBasicComplexity(graph) {
