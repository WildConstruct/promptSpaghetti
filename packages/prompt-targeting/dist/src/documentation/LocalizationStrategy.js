...
export class DocumentationLocalizationStrategy {
    ...
    static createDefaultConfig() {
        ...
        Promise < DocumentationTranslation > {
        ...
        };
        {
            ...
            try {
                ...
                try {
                     ...
                     */
                    async;
                    getLocalizedString(key, string, language, string, section, keyof, DocumentationTranslation['content'] = 'api', interpolations ?  : Record);
                    Promise < string > {
                        try: {
                        ...
                        if (!localizedString) {
                            ...
                            if (interpolations) {
                                ...
                                try {
                                     ...
                                     */
                                    async;
                                    loadCulturalAdaptation(locale, string);
                                    Promise < CulturalAdaptation > {
                                        : .culturalAdaptations.has(locale)
                                    };
                                    {
                                         ...
                                         */
                                        async;
                                        getPlatformGuidelines(locale, string, platform, string);
                                        Promise < string[] > {
                                                ...
                                                for (const restriction of adaptation.promptGuidelines.restrictions) {
                                                    if (content.toLowerCase().includes(restriction.toLowerCase())) {
                                                        ...
                                                        if (adaptation.promptGuidelines.communicationStyle === 'formal' && !isFormal) {
                                                             ...
                                                             */
                                                            async;
                                                            generateLocalizedDocumentation(language, string);
                                                            Promise < {
                                                                language: string,
                                                                documentation: {
                                                                    apiReference: string,
