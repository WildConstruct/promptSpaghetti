 ...
 */
import { ValidationError, TranslationError } from '../types';
...
export class AdvancedBaseAdaptor extends BaseAdaptor {
    ...
    async validate(graph, config) {
        ...
        try {
            ...
            this.stats.errors++;
            throw new ValidationError(`Enhanced validation failed: ${error instanceof Error ? error.message : 'Unknown error'}`, [], 'ENHANCED_VALIDATION_FAILED');
        }
    }
    /**
