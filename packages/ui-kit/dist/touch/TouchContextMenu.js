        ...
        children: [
          ...
          `,
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  item.icon && _jsx('span', { className: 'menu-item-icon', children: item.icon }),
                  _jsx('span', { className: 'menu-item-label', children: item.label }),
                ],
              }),
              _jsxs('div', {
                ...
                children: [
                  showShortcuts &&
                    item.shortcut &&
                    _jsx('span', { className: 'menu-item-shortcut', children: item.shortcut }),
                  hasSubmenu && _jsx('span', { className: 'menu-item-arrow', children: '\u25B6' }),
                  item.type === 'checkbox' &&
                    item.checked &&
                    _jsx('span', { className: 'menu-item-check', children: '\u2713' }),
                ],
              }),
            ],
          }),
          hasSubmenu &&
            ...
            _jsx('div', {
              ...
              children: item.submenu.map((subItem, subIndex) => renderMenuItem(subItem, items.length + subIndex)),
            }),
        ],
      },
      item.id
...
export const ContextMenuProvider = ({ items, longPressDelay = 500, enableHaptics = true, children }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx('div', { ref: containerRef, style: { width: '100%', height: '100%' }, children: children }),
      menuState.visible &&
        _jsx(TouchContextMenu, {
