  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      canConnect &&
        _jsxs(_Fragment, {
          children: [
            _jsx(ConnectionHandle, { type: 'input', nodeId: node.id, onConnect: handlers.onNodeConnect }),
            _jsx(ConnectionHandle, { type: 'output', nodeId: node.id, onConnect: handlers.onNodeConnect }),
          ],
        }),
    ],
  });
