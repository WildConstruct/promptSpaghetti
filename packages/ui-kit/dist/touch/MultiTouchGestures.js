...
export const GestureTrainer = ({ onComplete }) => {
  ...
  return _jsxs('div', {
    className: 'gesture-trainer',
    children: [
      _jsx('h3', { children: 'Learn Touch Gestures' }),
      _jsx('div', {
        className: 'training-steps',
        children: trainingSteps.map((step, index) =>
          _jsxs(
            'div',
            {
              className: `training-step ${completed[index] ? 'completed' : ''} ${currentStep === index ? 'active' : ''}`,
              children: [
                _jsx('div', { className: 'step-icon', children: completed[index] ? '✓' : index + 1 }),
                _jsx('div', { className: 'step-description', children: step.description }),
              ],
            },
            step.gesture
          )
      ...
      _jsx('div', {
        ...
        children: _jsx(MultiTouchController, {
          handlers: {
            onTwoFingerSwipe: () => {
              if (currentStep === 5) {
          ...
          children: _jsx('div', {
            className: 'gesture-practice-area',
            children: _jsxs('p', { children: ['Practice the gesture: ', trainingSteps[currentStep]?.description] }),
          }),
        }),
      }),
    ],
