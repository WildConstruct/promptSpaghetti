  ...
  if (internalCollapsed) {
    return _jsx('div', {
      ...
      children: _jsx(Button, {
        ...
        children: orientation === 'vertical' ? '▶️' : '🔽',
      }),
    });
  }
  return _jsxs('div', {
    className: cn('ui-node-palette', className),
    style: paletteStyles,
    'data-testid': testId,
    ...props,
    children: [
      _jsxs('div', {
        className: 'ui-node-palette-header',
        style: headerStyles,
        children: [
          _jsxs('div', {
            style: {
          ...
          searchable &&
            _jsx(Input, { placeholder: 'Search nodes...', value: searchTerm, onChange: setSearchTerm, size: 'sm' }),
        ],
      }),
      !isMobile &&
        _jsx('div', {
      ...
      _jsx('div', {
        className: 'ui-node-palette-content',
        style: contentStyles,
        children: _jsx(Stack, {
          spacing: 'xs',
          children:
