...
export const Sizes = {
  render: () =>
    _jsxs('div', {
      ...
      children: [
        _jsx(Input, { size: 'sm', label: 'Small', placeholder: 'Small input' }),
        _jsx(Input, { size: 'md', label: 'Medium', placeholder: 'Medium input' }),
        _jsx(Input, { size: 'lg', label: 'Large', placeholder: 'Large input' }),
      ],
    }),
  parameters: {
    docs: {
...
export const WithIcons = {
  render: () =>
    _jsxs('div', {
      style: { display: 'flex', flexDirection: 'column', gap: '1rem', width: '300px' },
      children: [
        _jsx(Input, { label: 'Search', icon: '\uD83D\uDD0D', iconPosition: 'left', placeholder: 'Search...' }),
        _jsx(Input, {
          label: 'Email',
          type: 'email',
          icon: '\uD83D\uDCE7',
...
export const InputTypes = {
  render: () =>
    _jsxs('div', {
      style: { display: 'flex', flexDirection: 'column', gap: '1rem', width: '300px' },
      children: [
        _jsx(Input, { label: 'Text', type: 'text', placeholder: 'Text input' }),
        _jsx(Input, { label: 'Email', type: 'email', placeholder: 'email@example.com' }),
        _jsx(Input, { label: 'Password', type: 'password', placeholder: 'Password' }),
        _jsx(Input, { label: 'Number', type: 'number', placeholder: '123' }),
        _jsx(Input, { label: 'URL', type: 'url', placeholder: 'https://example.com' }),
        _jsx(Input, { label: 'Search', type: 'search', placeholder: 'Search...' }),
      ],
    }),
  parameters: {
    docs: {
...
export const States = {
  render: () =>
    _jsxs('div', {
      style: { display: 'flex', flexDirection: 'column', gap: '1rem', width: '300px' },
      children: [
        _jsx(Input, { label: 'Normal', placeholder: 'Normal input' }),
        _jsx(Input, { label: 'Disabled', disabled: true, placeholder: 'Disabled input' }),
        _jsx(Input, { label: 'Read Only', readOnly: true, value: 'Read only value' }),
        _jsx(Input, { label: 'Required', required: true, placeholder: 'Required input' }),
        _jsx(Input, { label: 'Invalid', invalid: true, error: 'This field has an error', value: 'Invalid value' }),
      ],
    }),
  parameters: {
    docs: {
