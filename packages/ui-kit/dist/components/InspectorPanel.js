      ...
      children: _jsxs('div', {
        ...
        children: [
          ...
          _jsx(Button, {
            ...
            children: position === 'bottom' || isMobile ? '🔼' : '▶️',
          }),
        ],
      }),
    });
              ...
              children: [
                _jsx(Card, {
                  ...
                  children: _jsxs(Stack, {
                    spacing: 'sm',
                    children: [
                      _jsx(Input, { label: 'Node ID', value: selectedNode.id, readOnly: true, size: 'sm' }),
                      _jsx(Input, { label: 'Node Type', value: selectedNode.type, readOnly: true, size: 'sm' }),
                    ],
                  }),
                }),
                nodeEditor,
...
const WeightedChoiceEditor = ({ node, onUpdate }) => {
  ...
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Weighted Choices' }) }),
      _jsx(CardContent, {
        children: _jsxs(Stack, {
          spacing: 'sm',
          children: [
...
const ConcatEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Concatenation' }) }),
      _jsx(CardContent, {
...
const OutputEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Output' }) }),
      _jsx(CardContent, {
        children: _jsx(TextArea, {
          label: 'Text',
...
const IncludeEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Include Reference' }) }),
      _jsx(CardContent, {
        children: _jsx(Input, {
...
const SetVariableEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Set Variable' }) }),
      _jsx(CardContent, {
        children: _jsxs(Stack, {
          spacing: 'sm',
          children: [
...
const GetVariableEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Get Variable' }) }),
      _jsx(CardContent, {
        children: _jsx(Input, {
          label: 'Variable Key',
          value: node.data.key || '',
...
const WeightedAdvancedEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Advanced Weighted Choice' }) }),
      _jsx(CardContent, {
        children: _jsx('div', {
...
const ConditionalEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Conditional Logic' }) }),
      _jsx(CardContent, {
        children: _jsx('div', {
          style: { padding: '16px', textAlign: 'center', color: '#666' },
          children: 'Conditional expression configuration',
        }),
      }),
    ],
  });
...
const SequentialEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Sequential Processing' }) }),
      _jsx(CardContent, {
        children: _jsx('div', {
          style: { padding: '16px', textAlign: 'center', color: '#666' },
          children: 'Sequential pattern configuration',
        }),
      }),
    ],
  });
...
const MarkovEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Markov Chain' }) }),
      _jsx(CardContent, {
        children: _jsx('div', {
          style: { padding: '16px', textAlign: 'center', color: '#666' },
          children: 'State transition configuration',
        }),
      }),
    ],
  });
...
const GenericEditor = ({ node, onUpdate }) => {
  return _jsxs(Card, {
    ...
    padding: 'sm',
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { level: 4, children: 'Node Configuration' }) }),
      _jsx(CardContent, {
        children: _jsxs('div', {
          style: { padding: '16px', textAlign: 'center', color: '#666' },
          children: ['No specific editor available for ', node.type],
        }),
      }),
    ],
  });
