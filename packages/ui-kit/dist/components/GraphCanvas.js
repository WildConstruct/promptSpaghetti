...
export const GraphCanvas = ({ graph, onNodeSelect, onNodeMove, onEdgeCreate, onEdgeDelete, selectedNodeId, readOnly = false, showMinimap = false, showControls = true, fitView = false, className, style, testId, ...props }) => {
    ...
    const handleConnectionEnd = useCallback((targetNodeId, e) => {
    ...
    return (_jsxs("div", { className: cn('ui-graph-canvas', className), style: canvasStyles, "data-testid": testId, ...props, children: [_jsx("div", { ref: canvasRef, className: "ui-graph-canvas-container", style: {
                    width: '100%',
                    height: '100%',
                    position: 'relative',
                    userSelect: 'none',
                }, onMouseDown: e => handleMouseDown(e), onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseUp, onWheel: handleWheel, children: _jsxs("div", { className: "ui-graph-content", style: transformStyles, children: [_jsxs("svg", { className: "ui-graph-edges", style: {
                                position: 'absolute',
                                top: 0,
                                left: 0,
                                width: '100%',
                                ...
                                }, onMouseDown: e => handleMouseDown(e, node.id), onClick: e => {
                                    e.stopPropagation();
                                    onNodeSelect?.(node);
                                        ...
                                        }, children: [_jsx("span", { children: node.type }), !readOnly && (_jsxs("div", { style: { display: 'flex', gap: '4px' }, children: [_jsx("div", { className: "ui-connection-handle ui-connection-handle--output", style: {
                                                            width: '8px',
                                                            height: '8px',
                                                            borderRadius: '50%',
                                                            backgroundColor: theme.colors.success,
                                                            cursor: 'crosshair',
                                                        }, onMouseDown: e => handleConnectionStart(node.id, e) }), _jsx("div", { className: "ui-connection-handle ui-connection-handle--input", style: {
                                                            width: '8px',
                                                            height: '8px',
                                                            borderRadius: '50%',
                                                            backgroundColor: theme.colors.info,
                                                            cursor: 'crosshair',
                                                        }, onMouseUp: e => handleConnectionEnd(node.id, e) })] }))] }), _jsx("div", { style: {
                                            fontSize: `${theme.typography.fontSize.xs}px`,
                                            color: theme.colors.textSecondary,
                                            overflow: 'hidden',
                                            textOverflow: 'ellipsis',
                                        }, children: node.id })] }, node.id))) })] }) }), showControls && (_jsxs("div", { className: "ui-graph-controls", style: {
                    position: 'absolute',
                    ...
                    zIndex: 10,
                }, children: [_jsx(Button, { variant: "outline", size: "sm", onClick: zoomIn, children: "\uD83D\uDD0D+" }), _jsx(Button, { variant: "outline", size: "sm", onClick: zoomOut, children: "\uD83D\uDD0D-" }), _jsx(Button, { variant: "outline", size: "sm", onClick: resetView, children: "\uD83C\uDFAF" }), _jsx(Button, { variant: "outline", size: "sm", onClick: fitToView, children: "\uD83D\uDCD0" })] })), showMinimap && !isMobile && (_jsx("div", { className: "ui-graph-minimap", style: {
                    position: 'absolute',
                    ...
                    zIndex: 10,
                        ...
                        color: theme.colors.textSecondary,
                        textAlign: 'center',
                    }, children: ["Minimap", _jsx("br", {}), "Zoom: ", Math.round(viewport.zoom * 100), "%"] }) })), _jsxs("div", { className: "ui-graph-status", style: {
                    position: 'absolute',
                    bottom: `${theme.spacing.md}px`,
