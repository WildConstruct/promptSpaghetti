...
export const MOBILE_DARK_COLORS = {
  text: '#FFFFFF',
 ...
 */
export function createMobileTheme(baseTheme, isDark = false) {
  return {
    ...baseTheme,
    colors: {
      ...baseTheme.colors,
 ...
 */
export function getSafeAreaPadding(area = 'top') {
 ...
 */
export function isTouchTargetAccessible(width, height) {
  return width >= TOUCH_TARGETS.minimum && height >= TOUCH_TARGETS.minimum;
}
/**
 * Get responsive font size for mobile
 */
export function getMobileFontSize(baseSize, scaleFactor = 1, minSize = 12, maxSize = 32) {
