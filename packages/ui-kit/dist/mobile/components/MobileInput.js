...
export const MobileInput = ({ clearable = false, mobileAutoFocus = false, showCount = false, mobileInputMode, maxLength, value, onChange, className, style, ...props }) => {
    ...
    return (_jsxs("div", { className: cn('mobile-input-wrapper', className), style: { position: 'relative' }, children: [_jsx(Input, { ...props, ref: inputRef, value: currentValue, onChange: handleChange, maxLength: maxLength, inputMode: mobileInputMode, style: mobileInputStyles, className: cn('mobile-input', isTouch && 'touch-device') }), clearable && hasValue && (_jsx("button", { className: "mobile-input-clear", onClick: handleClear, type: "button", "aria-label": "Clear input", style: {
                    position: 'absolute',
                    right: 0,
                    top: '50%',
                ...
                }, children: "\u00D7" })), showCount && maxLength && (_jsxs("div", { className: "mobile-input-count", style: {
                    fontSize: 12,
                    color: 'var(--color-text-secondary)',
                    textAlign: 'right',
                    marginTop: 4,
...
export const MobileSearchInput = ({ onSearch, searchOnEnter = true, placeholder = 'Search...', ...props }) => {
    ...
    return (_jsxs("div", { className: "mobile-search-wrapper", style: { position: 'relative' }, children: [_jsx("span", { className: "mobile-search-icon", style: {
                    position: 'absolute',
                    ...
                    color: 'var(--color-text-secondary)',
                    pointerEvents: 'none',
                }, children: "\uD83D\uDD0D" }), _jsx(MobileInput, { ...props, type: "search", mobileInputMode: "search", placeholder: placeholder, clearable: true, onKeyDown: handleKeyDown, style: {
...
export const MobileTextArea = ({ minRows = 3, maxRows = 10, autoResize = true, showCount = true, style, ...props }) => {
    ...
    return (_jsxs("div", { className: "mobile-textarea-wrapper", children: [_jsx(TextArea, { ...props, ref: textAreaRef, onInput: handleInput, rows: minRows, style: {
                    ...
                    ...mobileStyles.tapHighlight,
                    ...style,
                } }), showCount && props.maxLength && (_jsxs("div", { className: "mobile-textarea-count", style: {
                    fontSize: 12,
                    color: 'var(--color-text-secondary)',
                    textAlign: 'right',
                    marginTop: 4,
