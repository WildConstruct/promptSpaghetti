...
export const MobileHeader = ({
  ...
  return _jsxs('header', {
    ...
    children: [
      ...
      children && _jsx('div', { className: 'mobile-header-content', style: { flex: 1 }, children: children }),
      rightActions.length > 0 &&
        _jsx('div', {
          className: 'mobile-header-actions right',
          style: { display: 'flex', gap: 4 },
          children: rightActions.map((action, index) =>
            _jsx(
              'button',
              {
