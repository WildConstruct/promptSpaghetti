...
export const MobileButton = ({ size = 'md', mobileFullWidth = false, hapticFeedback = true, mobileLoading = false, onClick, className, style, children, ...props }) => {
    ...
    return (_jsx(Button, { ...props, size: size, onClick: onClick ? handleClick : undefined, className: cn('mobile-button', isTouch && 'touch-device', className), style: mobileButtonStyles, loading: mobileLoading || props.loading, children: children }));
};
export const MobileFAB = ({ position = 'bottom-right', offset = 16, className, style, children, ...props }) => {
    ...
    return (_jsx(MobileButton, { ...props, variant: "primary", className: cn('mobile-fab', className), style: {
            ...positionStyles,
            ...style
        }, children: children }));
};
//# sourceMappingURL=MobileButton.js.map