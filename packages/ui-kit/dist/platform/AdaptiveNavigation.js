...
export const AdaptiveNavigation = ({
  ...
  if (navVariant === 'bottom') {
    ...
    if (os === 'iOS') {
      return _jsxs(_Fragment, {
        children: [
          title &&
            _jsx(IOSNavigationBar, {
              title: title,
              leftItems: showBackButton && onBack ? [] : undefined,
              rightItems: actions,
              onBack: showBackButton ? onBack : undefined,
            }),
          _jsx(IOSTabBar, { items: bottomItems, activeItem: activeItem, onItemSelect: onNavigate }),
        ],
      });
    }
    return _jsxs(_Fragment, {
            ...
            navigationIcon:
              showBackButton && onBack
                ? _jsx('svg', {
                    ...
                    viewBox: '0 0 24 24',
                    fill: 'currentColor',
                    children: _jsx('path', { d: 'M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z' }),
                  })
                : undefined,
            actions: actions,
            onNavigationClick: onBack,
          }),
        _jsx(MaterialBottomNav, { items: bottomItems, activeItem: activeItem, onItemSelect: onNavigate }),
      ],
    });
  }
      ...
      children: _jsxs('nav', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              !isCollapsed && title && _jsx('h2', { style: { margin: 0, fontSize: '20px' }, children: title }),
              _jsx('button', {
                ...
                children: _jsx('svg', {
                  ...
                  viewBox: '0 0 20 20',
                  fill: 'currentColor',
                  children: _jsx('path', { d: isCollapsed ? 'M7 4L13 10L7 16' : 'M13 16L7 10L13 4' }),
                }),
              }),
            ],
          }),
  ...
  if (navVariant === 'rail') {
    return _jsx('nav', {
      ...
      children: items.slice(0, 7).map(item =>
        _jsxs(
          'button',
          {
            onClick: () => onNavigate(item.id),
            ...
            children: [
              _jsx('div', {
                style: { fontSize: '24px' },
                children: activeItem === item.id && item.activeIcon ? item.activeIcon : item.icon,
              }),
              _jsx('span', { style: { fontSize: '12px' }, children: item.label }),
              item.badge &&
                item.badge > 0 &&
                _jsx('div', {
                  style: {
  ...
  return _jsxs('nav', {
    ...
    children: [
        ...
        _jsxs('button', {
          ...
          children: [
            _jsx('svg', {
              ...
              viewBox: '0 0 20 20',
              fill: 'currentColor',
              children: _jsx('path', { d: 'M15 18l-8-8 8-8' }),
            }),
            'Back',
          ],
        }),
      title && _jsx('h1', { style: { margin: 0, fontSize: '20px', marginRight: 'auto' }, children: title }),
      _jsx('div', {
      ...
      actions && _jsx('div', { style: { display: 'flex', gap: '8px', marginLeft: '24px' }, children: actions }),
    ],
  });
};
  ...
  return _jsxs('div', {
    children: [
      _jsxs('button', {
        ...
        children: [
          _jsx('div', {
            style: { fontSize: '20px', width: '20px', flexShrink: 0 },
            children: isActive && item.activeIcon ? item.activeIcon : item.icon,
          }),
          !isCollapsed &&
            _jsxs(_Fragment, {
              children: [
                _jsx('span', { style: { flex: 1, textAlign: 'left' }, children: item.label }),
                item.badge &&
                  item.badge > 0 &&
                  _jsx('div', {
                    style: {
                ...
                item.children &&
                  _jsx('svg', {
                    ...
                    children: _jsx('path', { d: 'M6 4L10 8L6 12' }),
                  }),
              ],
            }),
        ],
      ...
      !isCollapsed &&
        ...
        _jsx('div', {
          ...
          children: item.children.map(child =>
            _jsx(NavItem, { item: child, isActive: isActive, isCollapsed: isCollapsed, onClick: onClick }, child.id)
          ),
        }),
    ],
  });
        ...
        parent &&
          _jsxs(_Fragment, {
            children: [
              ...
              _jsx('span', { style: { color: 'var(--color-text-secondary)' }, children: '\u203A' }),
            ],
          }),
        _jsx('span', { style: { fontWeight: 600 }, children: current.label }),
      ],
    });
  }
  ...
  return _jsx('nav', {
    ...
    children: items.map((item, index) =>
      _jsxs(
        ...
        {
          children: [
            index > 0 && _jsx('span', { style: { color: 'var(--color-text-secondary)' }, children: '\u203A' }),
            index < items.length - 1
              ...
              : _jsx('span', { style: { fontWeight: 600, color: 'var(--color-text)' }, children: item.label }),
          ],
        },
        item.id
      )
