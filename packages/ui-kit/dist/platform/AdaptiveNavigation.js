                ...
                height: '100vh',
                    ...
                    flexDirection: 'column',
                            ...
                            justifyContent: 'space-between',
                                    ...
                                    borderRadius: '4px',
                                    cursor: 'pointer',
                                }, children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { d: isCollapsed ? 'M7 4L13 10L7 16' : 'M13 16L7 10L13 4' }) }) })] }), _jsx("div", { style: { flex: 1, padding: '8px' }, children: items.map(item => (_jsx(NavItem, { item: item, isActive: activeItem === item.id, isCollapsed: isCollapsed, onClick: () => onNavigate(item.id) }, item.id))) }), actions && (_jsx("div", { style: {
                            padding: '16px',
