...
export const MaterialAppBar = ({ title, type = 'small', navigationIcon, actions, scrolled = false, onNavigationClick }) => {
    ...
    return (_jsx("header", { className: `material-app-bar ${type}`, style: {
            position: 'fixed',
            top: 0,
            left: 0,
            right: 0,
            ...
            justifyContent: 'flex-end'
                ...
                height: 64,
                padding: '0 4px'
            }, children: [navigationIcon && (_jsx("button", { onClick: onNavigationClick, className: "material-icon-button", style: {
                        width: 48,
                        height: 48,
                        borderRadius: '50%',
                        display: 'flex',
                    ...
                    }, children: navigationIcon })), _jsx("h1", { style: {
                        flex: 1,
                        ...
                        color: 'var(--md-sys-color-on-surface)'
                    }, children: title }), actions && (_jsx("div", { style: { display: 'flex', gap: '4px' }, children: actions }))] }) }));
};
export const MaterialBottomNav = ({ items, activeItem, onItemSelect }) => {
    return (_jsx("nav", { className: "material-bottom-nav", style: {
            position: 'fixed',
            bottom: 0,
            left: 0,
            right: 0,
            ...
            return (_jsxs("button", { onClick: () => {
                ...
                }, className: `nav-item ${isActive ? 'active' : ''}`, style: {
                    flex: 1,
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center',
                    ...
                    transition: `all ${materialMotion.duration.short4}ms ${materialMotion.standard}`
                }, children: [_jsx("div", { className: "nav-indicator", style: {
                            position: 'absolute',
                            top: '12px',
                        ...
                        }, children: isActive && item.activeIcon ? item.activeIcon : item.icon }), _jsx("span", { style: {
                            fontSize: '12px',
                            fontWeight: isActive ? 500 : 400,
                            position: 'relative'
                        }, children: item.label }), item.badge && item.badge > 0 && (_jsx("div", { className: "badge", style: {
                            position: 'absolute',
                            top: '8px',
                            right: 'calc(50% - 20px)',
...
export const MaterialFAB = ({ icon, label, size = 'medium', extended = false, position = { bottom: 16, right: 16 }, onClick }) => {
    const sizes = {
        small: 40,
        medium: 56,
        large: 96
    ...
    return (_jsxs("button", { onClick: () => {
        ...
        }, className: `material-fab ${size} ${extended ? 'extended' : ''}`, style: {
            position: 'fixed',
        ...
        }, children: [icon, extended && label && (_jsx("span", { style: { fontSize: '14px', fontWeight: 500 }, children: label }))] }));
};
export const MaterialSwitch = ({ checked, onChange, disabled = false }) => {
    return (_jsx("button", { onClick: () => !disabled && onChange(!checked), className: `material-switch ${checked ? 'checked' : ''} ${disabled ? 'disabled' : ''}`, role: "switch", "aria-checked": checked, disabled: disabled, style: {
            position: 'relative',
            width: '52px',
            height: '32px',
            borderRadius: '16px',
...
export const MaterialRipple = ({ children }) => {
    ...
    return (_jsx("div", { ref: rippleRef, className: "material-ripple-container", onMouseDown: createRipple, onTouchStart: createRipple, style: {
            position: 'relative',
            overflow: 'hidden'
        }, children: children }));
};
export const MaterialSnackbar = ({ message, action, duration = 4000, onDismiss }) => {
    ...
    return (_jsxs("div", { className: "material-snackbar", style: {
            position: 'fixed',
            ...
            zIndex: 9999
        }, children: [_jsx("span", { style: { fontSize: '14px', lineHeight: '20px' }, children: message }), action && (_jsx("button", { onClick: action.onPress, style: {
                    marginLeft: '8px',
                    padding: '8px',
                    backgroundColor: 'transparent',
                    border: 'none',
