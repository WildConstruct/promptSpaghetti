...
export const OptimizedImage = memo(({ src, alt, width, height, lazy = true, priority = false, onLoad, onError }) => {
    ...
    return (_jsx("div", { ref: imgRef, style: {
            ...
            overflow: 'hidden'
        }, children: isInView && (_jsx("img", { src: getOptimizedSrc(), alt: alt, width: width, height: height, loading: lazy && !priority ? 'lazy' : 'eager', decoding: priority ? 'sync' : 'async', onLoad: () => {
                setIsLoaded(true);
                onLoad?.();
...
export const OptimizedScroll = ({ children, onScroll, horizontal = false, showScrollbar = true }) => {
    ...
    return (_jsx("div", { ref: scrollRef, className: `optimized-scroll ${platform} ${!showScrollbar ? 'hide-scrollbar' : ''}`, style: {
...
export const OptimizedAnimation = ({ children, type, duration = 300, delay = 0, trigger = true }) => {
    ...
    return (_jsx("div", { ref: elementRef, style: getAnimationStyles(), children: children }));
};
/**
...
`;
//# sourceMappingURL=PlatformOptimizations.js.map