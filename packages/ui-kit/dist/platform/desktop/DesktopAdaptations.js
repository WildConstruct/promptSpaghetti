...
export const DesktopContextMenu = ({ items, children }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx('div', { onContextMenu: handleContextMenu, children: children }),
      visible &&
        _jsx('div', {
          ref: menuRef,
          ...
          children: items.map((item, index) => {
            ...
            return _jsxs(
              'button',
              {
                ...
                children: [
                  item.icon && _jsx('span', { style: { marginRight: '8px' }, children: item.icon }),
    ...
    children: [
      _jsx('button', {
        ...
        children: _jsx('svg', {
          ...
          height: '1',
          fill: 'currentColor',
          children: _jsx('rect', { width: '10', height: '1' }),
        }),
      }),
      _jsx('button', {
        onClick: onMaximize,
        ...
        children: _jsx('svg', {
          ...
          fill: 'none',
          stroke: 'currentColor',
          children: _jsx('rect', { x: '0.5', y: '0.5', width: '9', height: '9', strokeWidth: '1' }),
        }),
      }),
      _jsx('button', {
        onClick: onClose,
        ...
        children: _jsx('svg', {
          ...
          height: '10',
          fill: 'currentColor',
          children: _jsx('path', { d: 'M0 0L10 10M10 0L0 10', stroke: 'currentColor', strokeWidth: '1' }),
        }),
      }),
    ],
  });
