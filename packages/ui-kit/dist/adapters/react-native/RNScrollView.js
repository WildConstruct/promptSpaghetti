...
export const RNScrollView = forwardRef(({ children, horizontal = false, showsVerticalScrollIndicator = true, showsHorizontalScrollIndicator = true, bounces = true, pagingEnabled = false, scrollEnabled = true, keyboardShouldPersistTaps = 'never', contentContainerStyle, style, onScroll, scrollEventThrottle = 16, decelerationRate = 'normal', maximumZoomScale = 1, minimumZoomScale = 1, pinchGestureEnabled = false, zoomScale = 1, testID, ...props }, ref) => {
    ...
    return (_jsx("div", { ref: ref, style: webScrollViewStyle, onScroll: onScroll, "data-testid": testID, ...props, children: _jsx("div", { style: webContentStyle, children: children }) }));
});
