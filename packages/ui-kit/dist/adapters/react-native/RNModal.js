...
export const RNModal = ({ animationType = 'fade', presentationStyle = 'overFullScreen', supportedOrientations = ['portrait'], onOrientationChange, statusBarTranslucent = false, hardwareAccelerated = true, testID, isOpen, onClose, children, ...props }) => {
    ...
    if (RNModalComponent) {
        return (_jsx(RNModalComponent, { ...rnProps, children: _jsx(Modal, { ...props, isOpen: true, onClose: onClose, style: {
                    ...rnProps.style,
    ...
    return (_jsx(Modal, { ...props, isOpen: isOpen, onClose: onClose, style: {
            ...rnProps.style,
...
//# sourceMappingURL=RNModal.js.map