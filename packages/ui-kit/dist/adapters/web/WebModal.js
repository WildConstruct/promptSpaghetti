...
export const WebModal = ({ backdrop = 'clickable', keyboard = true, scrollable = true, centered = false, fullscreen = false, animation = true, isOpen, onClose, children, ...props }) => {
    ...
    return (_jsx(Modal, { ...props, isOpen: isOpen, onClose: onClose, size: getModalSize(), closeOnOverlayClick: backdrop === 'clickable', closeOnEscape: keyboard, style: {
            ...props.style,
        ...
        }, "data-modal": "true", tabIndex: -1, role: "dialog", "aria-modal": "true", onClick: handleOverlayClick, children: children }));
};
