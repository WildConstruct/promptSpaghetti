    ...
    children: [
      ...
      enableKeyboardShortcuts &&
        _jsxs('div', {
          ...
          children: [
            _jsx('div', { children: 'Ctrl+Z: Undo' }),
            _jsx('div', { children: 'Ctrl+Shift+Z: Redo' }),
            _jsx('div', { children: 'Ctrl+C: Copy' }),
            _jsx('div', { children: 'Ctrl+V: Paste' }),
            _jsx('div', { children: 'Delete: Remove' }),
            _jsx('div', { children: 'Ctrl+A: Select All' }),
          ],
        }),
    ],
  });
