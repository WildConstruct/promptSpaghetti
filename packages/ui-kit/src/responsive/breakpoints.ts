 ...
 */
export function getCurrentBreakpoint(width: number, breakpoints: Breakpoints = defaultBreakpoints): BreakpointKey {
...
export const breakpoints = {
  up: (bp: BreakpointKey, bps = defaultBreakpoints) => createMediaQuery(bp, 'up', bps),

  down: (bp: BreakpointKey, bps = defaultBreakpoints) => createMediaQuery(bp, 'down', bps),

  only: (bp: BreakpointKey, bps = defaultBreakpoints) => createMediaQuery(bp, 'only', bps),
