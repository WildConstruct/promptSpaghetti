...
describe('Responsive Components', () => {
  ...
  describe('CollapsiblePanel', () => {
    it('should toggle collapse state based on breakpoint', async () => {
      const { container } = render(
        <CollapsiblePanel title="Test Panel" collapseAt="md" defaultCollapsed={false}>
  ...
  describe('ResponsiveDrawer', () => {
    it('should render as overlay on mobile', () => {
      ...
      const { container } = render(
        <ResponsiveDrawer open={true} onClose={() => {}}>
  ...
  describe('ResponsiveTabs', () => {
    ...
    it('should render as dropdown on mobile', () => {
      ...
      const { container } = render(<ResponsiveTabs tabs={tabs} activeTab="tab1" onChange={() => {}} />);
  ...
  describe('ResponsiveImage', () => {
    ...
    it('should lazy load by default', () => {
      const { container } = render(<ResponsiveImage src="/image.jpg" alt="Test Image" />);
