...
export const RNScrollView = forwardRef<any, RNScrollViewProps>(
  (
    ...
    if (RNScrollViewComponent) {
      return <RNScrollViewComponent {...rnProps}>{children}</RNScrollViewComponent>;
    }
    ...
    return (
      <div ref={ref} style={webScrollViewStyle} onScroll={onScroll} data-testid={testID} {...props}>
        <div style={webContentStyle}>{children}</div>
      </div>
    );
  }
);
