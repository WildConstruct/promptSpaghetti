  ...
  nodes: [
    {
      ...
      data: {
        choices: [
          { value: 'Option A', weight: 0.7 },
          { value: 'Option B', weight: 0.3 },
        ],
      },
  ...
  nodes: [
    {
      ...
      data: {
        choices: [
          { value: 'Morning', weight: 0.5 },
          { value: 'Evening', weight: 0.5 },
        ],
      },
      position: { x: 50, y: 100 },
    },
...
const meta: Meta<typeof GraphCanvas> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Interactive graph canvas for visualizing and editing node-based graphs. Supports drag-and-drop, zoom, pan, and node selection.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Interactive: Story = {
  render: () => {
    ...
    const handleEdgeCreate = (edge: { source: string; target: string }) => {
      const newEdge = {
        id: `edge-${Date.now()}`,
        ...edge,
      };
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Fully interactive graph canvas with state management. Try selecting nodes, dragging them around, and creating connections!',
      },
    },
  },
};
