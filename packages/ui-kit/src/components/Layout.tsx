...
export const Flex = forwardRef<HTMLDivElement, LayoutProps>(
  (
    ...
    return (
      <div ref={ref} className={cn('ui-flex', className)} style={flexStyles} data-testid={testId} {...props}>
        {children}
      </div>
    );
  }
...
>(
  (
    ...
    return (
      <div ref={ref} className={cn('ui-grid', className)} style={gridStyles} data-testid={testId} {...props}>
        {children}
      </div>
    );
  }
...
>(
  (
    { children, spacing = 'md', divider, align = 'stretch', padding, margin, className, style, testId, ...props },
    ref
  ) => {
    const theme = useTheme();
    ...
    return (
      <div ref={ref} className={cn('ui-stack', className)} style={stackStyles} data-testid={testId} {...props}>
...
>(({ children, colSpan, rowSpan, colStart, colEnd, rowStart, rowEnd, area, className, style, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn('ui-grid-item', className)} style={gridItemStyles} {...props}>
      {children}
    </div>
  );
});
...
>(({ children, minHeight = '100%', className, style, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn('ui-center', className)} style={centerStyles} {...props}>
      {children}
    </div>
  );
});
...
>(({ children, maxWidth = '1200px', centerContent = true, className, style, ...props }, ref) => {
  const theme = useTheme();
  ...
  return (
    <div ref={ref} className={cn('ui-container', className)} style={containerStyles} {...props}>
      {children}
    </div>
  );
});
