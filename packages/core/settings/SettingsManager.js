...
export class SettingsManager {
     ...
     */
    updateSettings(newSettings: any, source: string = 'user') {
     ...
     */
    updateSetting(key: string, value: any, source: string = 'user') {
     ...
     */
    addChangeListener(listener: (event: any) => void) {
     ...
     * Add seed to history
     */
    addSeedToHistory(seed: string | number): void {
