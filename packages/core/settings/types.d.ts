 ...
 */
export declare const SeedSettingsSchema: z.ZodObject<{ enabled: z.ZodDefault<z.ZodBoolean>;
    value: z.ZodOptional<z.ZodNumber>;
    history: z.ZodDefault<z.ZodArray<z.ZodNumber, "many">>;
    autoGenerate: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { history: number[];
    enabled: boolean;
    autoGenerate: boolean;
    value?: number | undefined }, { history?: number[] | undefined;
 ...
 */
export declare const TemperatureSettingsSchema: z.ZodObject<{ enabled: z.ZodDefault<z.ZodBoolean>;
 ...
 */
export declare const RunCountSettingsSchema: z.ZodObject<{ value: z.ZodDefault<z.ZodNumber>;
    showPerformanceWarning: z.ZodDefault<z.ZodBoolean>;
    presets: z.ZodDefault<z.ZodArray<z.ZodNumber, "many">> }, "strip", z.ZodTypeAny, { value: number;
    presets: number[];
    showPerformanceWarning: boolean }, { value?: number | undefined;
    presets?: number[] | undefined;
    showPerformanceWarning?: boolean | undefined }>;
/**
 * Batch execution configuration
 */
export declare const BatchSettingsSchema: z.ZodObject<{ batchSize: z.ZodDefault<z.ZodNumber>;
    outputFormat: z.ZodDefault<z.ZodEnum<["individual", "combined", "csv", "json"]>>;
    namingPattern: z.ZodDefault<z.ZodString>;
    includeMetadata: z.ZodDefault<z.ZodBoolean>;
    autoDownload: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { includeMetadata: boolean;
    batchSize: number;
    outputFormat: "json" | "csv" | "individual" | "combined";
    namingPattern: string;
    autoDownload: boolean }, { includeMetadata?: boolean | undefined;
 ...
 */
export declare const PerformanceSettingsSchema: z.ZodObject<{ showExecutionTimes: z.ZodDefault<z.ZodBoolean>;
    enableCaching: z.ZodDefault<z.ZodBoolean>;
    showMemoryUsage: z.ZodDefault<z.ZodBoolean>;
    logExecutionSteps: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { enableCaching: boolean;
    showExecutionTimes: boolean;
    showMemoryUsage: boolean;
    logExecutionSteps: boolean }, { enableCaching?: boolean | undefined;
 ...
 */
export declare const UISettingsSchema: z.ZodObject<{ theme: z.ZodDefault<z.ZodEnum<["auto", "light", "dark"]>>;
    ...
    highContrast: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { theme: "auto" | "light" | "dark";
    showTooltips: boolean;
    enableKeyboardShortcuts: boolean;
    reduceAnimations: boolean;
    highContrast: boolean }, { theme?: "auto" | "light" | "dark" | undefined;
 ...
 */
export declare const AdvancedSettingsSchema: z.ZodObject<{ seed: z.ZodObject<{ }
        enabled: z.ZodDefault<z.ZodBoolean>;
        value: z.ZodOptional<z.ZodNumber>;
        history: z.ZodDefault<z.ZodArray<z.ZodNumber, "many">>;
        autoGenerate: z.ZodDefault<z.ZodBoolean>;
    }, "strip", z.ZodTypeAny, { history: number[];
        enabled: boolean;
        autoGenerate: boolean;
        value?: number | undefined }, { history?: number[] | undefined;
        value?: number | undefined;
...
}, "strip", z.ZodTypeAny, { performance: {
    ...
    batch: { includeMetadata?: boolean | undefined;
        batchSize?: number | undefined;
        outputFormat?: "json" | "csv" | "individual" | "combined" | undefined;
        namingPattern?: string | undefined;
        autoDownload?: boolean | undefined };
    ui: { theme?: "auto" | "light" | "dark" | undefined;
        showTooltips?: boolean | undefined;
        enableKeyboardShortcuts?: boolean | undefined;
        reduceAnimations?: boolean | undefined;
        highContrast?: boolean | undefined };
    runCount: { value?: number | undefined;
        presets?: number[] | undefined;
        showPerformanceWarning?: boolean | undefined };
 ...
 */
export declare const SettingsGroupSchema: z.ZodObject<{ id: z.ZodString;
    name: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    icon: z.ZodOptional<z.ZodString>;
    order: z.ZodDefault<z.ZodNumber>;
    collapsible: z.ZodDefault<z.ZodBoolean>;
    defaultExpanded: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { id: string;
    name: string;
    defaultExpanded: boolean;
    collapsible: boolean;
    order: number;
    description?: string | undefined;
    icon?: string | undefined }, { id: string;
    name: string;
    description?: string | undefined;
 ...
 */
export declare const SettingItemSchema: z.ZodObject<{ key: z.ZodString;
    groupId: z.ZodString;
    label: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    ...
    advanced: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { type: "string" | "number" | "boolean" | "select" | "slider" | "multiselect";
    key: string;
    label: string;
    advanced: boolean;
    disabled: boolean;
    ...
    helpText?: string | undefined }, { type: "string" | "number" | "boolean" | "select" | "slider" | "multiselect";
    key: string;
    label: string;
    groupId: string;
    description?: string | undefined;
...
export interface SettingsExport { settings: AdvancedSettings;
    metadata: {
        exportedAt: string;
        version: string;
        appVersion: string }
