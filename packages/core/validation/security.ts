...
export class SecurityValidation {
  ...
  static limitedString(maxLength: number = 10000) {
    return z.string().max(maxLength, `String must be less than ${maxLength} characters`);
  }
