...
export class ContextValidationFramework extends EventEmitter {
  ...
  async validateContext(
    ...
    try {
      ...
      const errorResult: ContextValidationResult = {
        valid: false,
  ...
  private addStateValidationRules(): void {
  ...
  private addCacheValidationRules(): void {
  ...
  private updateContextHealth(
    health: ContextValidationResult['contextHealth'],
    ruleName: string,
    result: ContextValidationRuleResult
  ): void {
