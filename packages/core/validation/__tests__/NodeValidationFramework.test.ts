...
describe('NodeValidationFramework', () => { let validator: NodeValidationFramework;
  beforeEach(() => {
  validator = new NodeValidationFramework() });
  describe('Basic Node Validation', () => { it('should validate a valid simple node', () => {
  ...
  weights: [1, 2, 1] }
    ...
    it('should reject node with invalid config structure', () => { const nodeData: AdvancedNodeData = {,
  id: 'test-node-1',
  type: 'WeightedChoice',
  config: {,
  ...
  describe('Security Validation', () => { it('should detect eval usage security threat', () => {
  const nodeData: AdvancedNodeData = {,
  id: 'dangerous-node',
  type: 'Conditional',
  config: {,
  ...
  condition: 'eval("malicious code")' }
    ...
    it('should detect Function constructor threat', () => { const nodeData: AdvancedNodeData = {,
  id: 'dangerous-node',
  type: 'WeightedChoice',
  config: {,
  deterministic: true,
  ...
  choices: ['new Function("return alert(1)")()'] }
    ...
    it('should detect prototype pollution threat', () => { const nodeData: AdvancedNodeData = {,
  id: 'dangerous-node',
  type: 'WeightedChoice',
  config: {,
  deterministic: true,
  ...
  choices: ['__proto__.isAdmin = true'] }
    ...
    it('should detect template injection threat', () => { const nodeData: AdvancedNodeData = {,
  id: 'dangerous-node',
  type: 'WeightedChoice',
  config: {,
  deterministic: true,
  ...
  template: 'Hello ${user.input}'}
    ...
    it('should validate Python transform security', () => { const nodeData: AdvancedNodeData = {,
  id: 'python-node',
  ...
  code: 'exec("import os; os.system(\'rm -rf /\')")' }
    ...
    it('should allow safe code in Python transform', () => { const nodeData: AdvancedNodeData = {,
  id: 'safe-python-node',
  type: 'PythonTransform',
  config: {,
  deterministic: true,
  ...
  describe('Performance Validation', () => { it('should detect potential infinite loop in Sequential node', () => {
  const nodeData: AdvancedNodeData = {,
  id: 'infinite-node',
  type: 'Sequential',
  config: {,
  ...
  items: [] // Empty items array causes infinite loop }
    ...
    it('should detect Markov node with no exit conditions', () => { const nodeData: AdvancedNodeData = {,
  id: 'stuck-markov',
  type: 'Markov',
  config: {,
  deterministic: true,
  ...
  transitionMatrix: {
    ...
    it('should estimate memory usage correctly', () => { const nodeData: AdvancedNodeData = {,
  id: 'large-node',
  type: 'WeightedChoice',
  config: {,
  deterministic: true,
  ...
  weights: new Array(1000).fill(1) }
    ...
    it('should flag excessive memory usage', () => { // Create validator with low memory limit
  ...
  describe('Type Safety Validation', () => { it('should validate basic type safety', () => {
  const nodeData: AdvancedNodeData = {,
  id: 'typed-node',
  type: 'WeightedChoice',
  config: {,
  ...
  describe('Configuration Options', () => { it('should respect disabled security validation', () => {
  ...
  condition: 'eval("malicious code")' }
    ...
    it('should respect disabled performance validation', () => { const performancelessValidator = new NodeValidationFramework({)
  ...
  describe('Complex Nested Validation', () => { it('should scan nested objects for security threats', () => {
  const nodeData: AdvancedNodeData = {,
  id: 'nested-node',
  type: 'WeightedChoice',
  config: {,
  ...
  tags: ['safe', '__proto__.danger = true'] }
    ...
    it('should handle arrays in nested validation', () => { const nodeData: AdvancedNodeData = {,
  id: 'array-node',
  type: 'WeightedChoice',
  config: {,
  deterministic: true,
...
describe('NodeValidationUtils', () => { describe('validateUserInput', () => {
    ...
    it('should return empty array for safe input', () => { const threats = NodeValidationUtils.validateUserInput('Hello, world!');
      expect(threats).toHaveLength(0) });
  });
  describe('estimateNodePerformance', () => { it('should estimate performance metrics', () => {
  const nodeData: AdvancedNodeData = {,
  id: 'test-node',
  type: 'WeightedChoice',
  config: {,
  ...
  describe('validateNodeBatch', () => { it('should validate multiple nodes', () => {
    ...
    it('should handle empty array', () => { const results = NodeValidationUtils.validateNodeBatch([]);
      expect(results).toHaveLength(0) });
  });
});
describe('Security Threat Detection Patterns', () => { let validator: NodeValidationFramework;
  beforeEach(() => {
  validator = new NodeValidationFramework() });
