...
export class NodeValidationFramework {
   ...
   */
  private scanForThreats(obj: any, threats: SecurityThreat[], location: string): void {
   ...
   */
  private scanStringForThreats(text: string, threats: SecurityThreat[], location: string): void {
   ...
   */
  private validatePythonTransformSecurity(nodeData: AdvancedNodeData, threats: SecurityThreat[]): void {
   ...
   */
  private validateInfiniteLoops(nodeData: AdvancedNodeData, issues: PerformanceIssue[]): void {
