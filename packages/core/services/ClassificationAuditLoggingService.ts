...
export class ClassificationAuditLoggingService {
   ...
   */
  private determineResourceType(dataId: string): AuditLogEntry['resourceType'] {
    if (dataId.startsWith('doc_')) return 'DOCUMENT';
   ...
   */
  private generateAuditSummary(entries: AuditLogEntry[], query: AuditQuery): AuditSummary {
