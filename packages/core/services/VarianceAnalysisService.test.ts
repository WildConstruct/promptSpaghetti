...
describe('VarianceAnalysisService', () => { describe('analyzeVariance', () => {
    ...
    it('should calculate low variance for very similar results', () => { const results = [
    ...
    it('should calculate high variance for diverse results', () => { const results = [
    ...
    it('should calculate medium variance for balanced results', () => { const results = [
  ...
  steps: [{ nodeId: 'node4', nodeType: 'Sequential' }, { nodeId: 'node5', nodeType: 'Output' }]
    ...
    it('should calculate structural diversity correctly', () => { const results = [
  ...
  describe('createDiversityIndicators', () => { it('should create proper diversity indicators', () => {
      const results = [
    ...
    it('should categorize metrics correctly', () => { const results = [
  ...
  describe('getVarianceLevelInfo', () => { it('should return correct info for low variance', () => {
    ...
    it('should return correct info for medium variance', () => { const info = varianceService.getVarianceLevelInfo('medium');
      expect(info.color).toBe('#f59e0b');
      expect(info.icon).toBe('🟡');
      expect(info.description).toContain('balance') });
    it('should return correct info for high variance', () => { const info = varianceService.getVarianceLevelInfo('high');
      expect(info.color).toBe('#10b981');
      expect(info.icon).toBe('🟢');
      expect(info.description).toContain('diversity') });
  });
  describe('suggestion generation', () => { it('should generate increase suggestions for low variance', () => {
      const results = [
    ...
    it('should generate optimization suggestions for high variance', () => { const results = [
      ...
      const analysis = varianceService.analyzeVariance(results);
      if (analysis.overallVariance === 'high') { expect(analysis.suggestions.some(s => s.type === 'optimize')).toBe(true) });
    it('should provide actionable suggestions', () => { const results = [
  ...
  describe('edge cases', () => { it('should handle empty results', () => {
    ...
    it('should handle very short outputs', () => { const results = [
        createMockResult(1, 'a'),
        createMockResult(2, 'b') }
    ...
    it('should handle identical outputs', () => { const results = [
