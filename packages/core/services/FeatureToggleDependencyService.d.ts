...
export interface DependencyMetadata { category: string;
    epic?: string;
    story?: string;
    tags: string[];
...
export interface DependencyRecommendation { id: string;
...
export interface DependencyServiceConfig { detection: {
    ...
    validation: { validateOnActivation: boolean;
        allowCircularDependencies: boolean;
        maxCircularDepth: number;
        strictMode: boolean };
    visualization: { maxNodesInGraph: number;
        clusteringEnabled: boolean;
        layoutAlgorithm: 'hierarchical' | 'force' | 'circular' | 'dagre';
        showMetadata: boolean };
    analysis: { analyzeInterval: number;
 ...
 */
export declare class FeatureToggleDependencyService extends EventEmitter { private dependencies;
