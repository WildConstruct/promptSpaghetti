...
describe('ResultExportService', () => {
  ...
  describe('Individual Result Export', () => {
    it('should export individual result with basic options', async () => {
      const options = {
    ...
    it('should include execution paths when requested', async () => {
      const options = {
  ...
  describe('Batch Result Export', () => {
    it('should export multiple selected results', async () => {
  ...
  describe('Comparison Export', () => {
    it('should export all results for comparison', async () => {
      const options = {
  ...
  describe('Format Support and Validation', () => {
    it('should return available formats with correct properties', () => {
    ...
    it('should return validation errors for invalid options', () => {
    ...
    it('should warn about large export sizes', () => {
  ...
  describe('Custom Export Handling', () => {
    beforeEach(() => {
    ...
    it('should handle plain text export as fallback', async () => {
      const options = {
    ...
    it('should handle execution timeline export', async () => {
      const options = {
    ...
    it('should handle variance report export', async () => {
      const options = {
        format: 'variance-report' as ExportFormat,
        includeMetadata: true,
        includeExecutionPaths: false,
    ...
    it('should handle batch summary export', async () => {
      const options = {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle results without execution paths', async () => {
