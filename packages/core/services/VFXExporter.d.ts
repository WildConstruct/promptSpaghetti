...
export declare const generateVFXDocumentation: (exportData: VFXExportFormat) => string;
export declare const validateVFXExport: (exportData: VFXExportFormat) => VFXValidationResult;
