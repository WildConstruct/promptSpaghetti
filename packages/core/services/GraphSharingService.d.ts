...
export interface SharedGraphFormat { metadata: {
        exportId: string;
        version: string;
        timestamp: string;
        title: string;
        ...
        versionControl: { version: number;
            previousVersion?: string;
            changes: string[];
            tags: string[];
            branch?: string };
        sharing: { permissions: 'private' | 'read_only' | 'collaborative' | 'public';
            collaborators: Array<{
                userId: string;
                name: string;
    ...
    annotations: { connectionLabels: Array<{
            edgeId: string;
            label: string;
            style?: any;
            position?: any;
            visible: boolean }>;
        stickyNotes: Array<{ id: string;
            position: {
                x: number;
                y: number };
            size: { width: number;
        ...
        nodeLabels: Array<{ nodeId: string;
            label?: string;
            description?: string;
            tags: string[];
            color?: string;
    ...
    collaboration: { changeHistory: Array<{
            id: string;
            timestamp: string;
            author: string;
            operation: string;
...
export declare class GraphSharingService { private static instance;
    ...
    importSharedGraph(sharedGraph: SharedGraphFormat, options?: { )
        ...
        preserveAnnotations?: boolean }): Promise<{ success: boolean;
        graph?: {
            nodes: Node[];
            edges: AnnotatedEdge[] };
...
export declare export declare const importSharedGraph: (sharedGraph: SharedGraphFormat, options?: any) => Promise<{ success: boolean;
    graph?: {
        nodes: Node[];
        edges: AnnotatedEdge[] };
    annotations?: SharedGraphFormat["annotations"];
