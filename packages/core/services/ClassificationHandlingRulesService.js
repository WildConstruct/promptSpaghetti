...
export class ClassificationHandlingRulesService {
     ...
     */
    async validateDataHandling(dataId, classification, operation, context) {
     ...
     * Validate monitoring requirements
     */
    validateMonitoringRequirements(requirements, context) {
        const errors = [];
        const warnings = [];
     ...
     */
    async recordViolations(dataId, classification, errors, context) {
     ...
     */
    getSeverityForClassification(classification) {
        const severityMap = {
            PUBLIC: 'LOW',
            INTERNAL: 'MEDIUM',
            CONFIDENTIAL: 'HIGH',
     ...
     */
    getHandlingRules(classification) {
        if (classification) {
     ...
     */
    getComplianceChecks(classification) {
        if (classification) {
     ...
     */
    getComplianceScore(classification) {
