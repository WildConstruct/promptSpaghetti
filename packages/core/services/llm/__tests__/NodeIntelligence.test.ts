...
describe('NodeIntelligenceService', () => {
  ...
  describe('variable extraction', () => {
    ...
    it('should preserve variables in generated text', () => {
      const preserveVariables = (service as any).preserveVariables.bind(service);
  ...
  describe('offline suggestions', () => {
    it('should provide category-based offline suggestions', () => {
      const getOfflineSuggestions = (service as any).getOfflineSuggestions.bind(service);
    ...
    it('should provide offline inspiration themes', () => {
      const getOfflineInspiration = (service as any).getOfflineInspiration.bind(service);
