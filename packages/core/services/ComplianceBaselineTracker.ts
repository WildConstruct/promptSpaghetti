...
export interface BaselineDashboard { overallHealthScore: number; // 0-100;
...
export class ComplianceBaselineTracker { private baselines: Map<string, ComplianceBaseline> = new Map();
  ...
  */
  ...
  severity: alertData.severity
    ...
    console.log(`🚨 ${alertData.severity.toUpperCase()},}
