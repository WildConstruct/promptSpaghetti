...
export interface ModuleContent { id: string;
    type: ContentType;
    title: string;
    content: string;
    url?: string;
...
export interface ActivityConfig { parameters: Record<string, any>;
    timeLimit?: number;
...
export interface BadgeCriteria { type: string;
    condition: string;
    value: any;
    timeframe?: number }
}
...
export interface UserProgress { overallProgress: number;
...
export interface ModuleProgress { progress: number;
    timeSpent: number;
    completedActivities: string[];
    lastAccessed: Date;
    attempts: number;
...
export interface UserAnalytics { totalTimeSpent: number;
 ...
 */
export declare class Epic16LearningPathService extends EventEmitter { private learningPaths;
