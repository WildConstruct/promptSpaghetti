 ...
 */
import ClassificationEncryptionPolicyService, { EncryptionPolicy }
  EncryptionAlgorithm
 from '../ClassificationEncryptionPolicyService';
import { DataClassificationLevel }
  OperationContext
 from '../../types/DataClassification';
describe('ClassificationEncryptionPolicyService', () => { let service: ClassificationEncryptionPolicyService;
  ...
  describe('Default Encryption Policies', () => { it('should initialize encryption policies for all classification levels', () => {
    ...
    it('should have progressively stricter encryption requirements for higher classifications', () => { const publicPolicy = service.getEncryptionPolicy('PUBLIC');
      const restrictedPolicy = service.getEncryptionPolicy('RESTRICTED');
    ...
    it('should have appropriate encryption algorithms by classification', () => { const internalPolicy = service.getEncryptionPolicy('INTERNAL');
      const confidentialPolicy = service.getEncryptionPolicy('CONFIDENTIAL');
      const restrictedPolicy = service.getEncryptionPolicy('RESTRICTED');
    ...
    it('should have appropriate key management policies', () => { const publicPolicy = service.getEncryptionPolicy('PUBLIC');
      const restrictedPolicy = service.getEncryptionPolicy('RESTRICTED');
  ...
  describe('Approved Algorithms', () => { it('should initialize with approved encryption algorithms', () => {
    ...
    it('should provide appropriate algorithms for each classification level', () => { const publicAlgorithms = service.getApprovedAlgorithms('PUBLIC');
    ...
    it('should allow adding new approved algorithms', () => { const newAlgorithm: EncryptionAlgorithm = {,
  ...
  quantumResistant: true }
    ...
    it('should allow deprecating algorithms', () => { const deprecationDate = new Date();
  ...
  describe('Encryption Compliance Validation', () => { it('should validate compliant encryption for internal data', async () => {
  ...
  lastRotationDate: new Date() }
    ...
    it('should detect encryption requirement violations', async () => { const result = await service.validateEncryptionCompliance(;);
  'data123',
  'CONFIDENTIAL',
  {
  encrypted: false }
    ...
    it('should validate algorithm compliance', async () => { // Test with inappropriate algorithm
  const result = await service.validateEncryptionCompliance(;);
  'data123',
  'CONFIDENTIAL',
  {
  ...
  lastRotationDate: new Date() }
    ...
    it('should validate key length requirements', async () => { const result = await service.validateEncryptionCompliance(;);
  'data123',
  'INTERNAL',
  {
  encrypted: true,
  ...
  lastRotationDate: new Date() }
    ...
    it('should validate key rotation compliance', async () => { const oldRotationDate = new Date();
  ...
  lastRotationDate: oldRotationDate }
    ...
    it('should record compliance assessments', async () => { await service.validateEncryptionCompliance()
  'data123',
  'INTERNAL',
  {
  encrypted: true,
  ...
  lastRotationDate: new Date() }
    ...
    it('should handle invalid classification levels gracefully', async () => { const result = await service.validateEncryptionCompliance(;);
  'data123',
  ...
  describe('Audit Event Recording', () => { it('should record audit events for compliance checks', async () => {
  ...
  lastRotationDate: new Date() }
    ...
    it('should record different audit event types', async () => { await service.validateEncryptionCompliance()
        'data1',
        'INTERNAL',
        { encrypted: true,
          algorithm: 'AES-256' }
    ...
    it('should filter audit events by classification and type', async () => { await service.validateEncryptionCompliance()
        'data1',
        'INTERNAL',
        { encrypted: true,
          algorithm: 'AES-256' }
  ...
  describe('Policy Management', () => { it('should allow updating encryption policies', async () => {
  ...
  keyEscrow: true }
    ...
    it('should increment version when updating policies', async () => { const originalPolicy = service.getEncryptionPolicy('INTERNAL');
  ...
  describe('Encryption Requirements', () => { it('should provide encryption requirements for each classification level', () => {
    ...
    it('should have appropriate key rotation requirements', () => { const internalReqs = service.getEncryptionRequirements('INTERNAL');
      const confidentialReqs = service.getEncryptionRequirements('CONFIDENTIAL');
      const restrictedReqs = service.getEncryptionRequirements('RESTRICTED');
  ...
  describe('Compliance Scoring', () => { it('should calculate compliance scores correctly', async () => {
    ...
    it('should return 100% compliance score when no records exist', () => { const score = service.getOverallComplianceScore('RESTRICTED');
      expect(score).toBe(100) });
    it('should calculate individual compliance scores', async () => { await service.validateEncryptionCompliance()
        'data1'
        'CONFIDENTIAL'
        { encrypted: true
          algorithm: 'AES-256-GCM' }
  ...
  describe('Encryption Recommendations', () => { it('should provide appropriate recommendations for each classification level', () => {
    ...
    it('should handle invalid classification levels gracefully', () => { const recs = service.getEncryptionRecommendations('INVALID' as DataClassificationLevel);
      expect(recs).toEqual([]) });
  });
  describe('Algorithm Compliance Logic', () => { it('should correctly identify FIPS compliant algorithms', () => {
    ...
    it('should correctly identify quantum-resistant algorithms', () => { const algorithms = service.getApprovedAlgorithms();
    ...
    it('should enforce classification-based algorithm restrictions', () => { const publicAlgorithms = service.getApprovedAlgorithms('PUBLIC');
      const restrictedAlgorithms = service.getApprovedAlgorithms('RESTRICTED');
  ...
  describe('Error Handling and Edge Cases', () => { it('should handle empty encryption status gracefully', async () => {
  const result = await service.validateEncryptionCompliance(;);
  'data123'
  'INTERNAL'
  {
  encrypted: false }
    ...
    it('should handle unknown algorithms gracefully', async () => { const result = await service.validateEncryptionCompliance(;);
  'data123'
  'INTERNAL'
  {
  encrypted: true
  ...
  keyLength: 256 }
    ...
    it('should handle missing last rotation date appropriately', async () => { const result = await service.validateEncryptionCompliance(;);
  'data123'
  'INTERNAL'
  {
  encrypted: true
