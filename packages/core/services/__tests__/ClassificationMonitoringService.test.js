 ...
 */
import ClassificationMonitoringService from '../ClassificationMonitoringService';
describe('ClassificationMonitoringService', () => {
    ...
    describe('Dashboard and Reporting', () => {
        it('should generate comprehensive dashboard data', async () => {
            ...
            const results = ['SUCCESS', 'SUCCESS', 'SUCCESS', 'FAILURE', 'WARNING'];
            for (let i = 0; i < 20; i++) {
                await service.recordEvent({
                    timestamp: new Date(),
