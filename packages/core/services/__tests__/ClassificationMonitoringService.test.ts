 ...
 */
import ClassificationMonitoringService, { MonitoringEvent,
  MonitoringAlert,
  MonitoringThreshold,
  UserActivity }
  ClassificationStats
...
describe('ClassificationMonitoringService', () => { let service: ClassificationMonitoringService;
  ...
  describe('Event Recording', () => { it('should record monitoring events', async () => {
  ...
  dataSize: 1024 }
    ...
    it('should update classification statistics when recording events', async () => { await service.recordEvent({)
  timestamp: new Date(),
        eventType: 'ACCESS',
  ...
  processingTimeMs: 50 }
    ...
    it('should track user activity across events', async () => { const userId = 'user123';
  ...
  timestamp: new Date(),
    ...
    it('should handle real-time event notifications', async () => { const receivedEvents: MonitoringEvent = [];
  ...
  describe('Threshold Monitoring', () => { it('should trigger alerts when thresholds are exceeded', async () => {
  ...
  receivedAlerts.push(alert) });
      ...
      for (let i = 0; i < 10; i++) { await service.recordEvent({)
  timestamp: new Date(),
  ...
  operation: 'read',
    ...
    it('should respect threshold cooldown periods', async () => { const receivedAlerts: MonitoringAlert = [];
  service.onAlert((alert) => {
  receivedAlerts.push(alert) });
  ...
  complianceScore: 60 }
    ...
    it('should allow threshold configuration updates', () => { const threshold = service.getThreshold('high-violation-rate');
  ...
  describe('Suspicious Activity Detection', () => { it('should detect rapid access to restricted data', async () => {
  ...
  operation: 'read',
    ...
    it('should detect multiple violations in short time', async () => { const userId = 'violating-user';
  ...
  operation: 'write',
    ...
    it('should detect unusual access times', async () => { const userId = 'night-user';
  ...
  timestamp: nightTime,
    ...
    it('should calculate user risk scores based on activities', async () => { const userId = 'risky-user';
  ...
  describe('Dashboard and Reporting', () => { it('should generate comprehensive dashboard data', async () => {
  ...
  complianceScore: 80 + (i % 20) }
    ...
    it('should filter events by various criteria', async () => { // Generate test events
      await service.recordEvent({)
  timestamp: new Date(),
        eventType: 'ACCESS',
        classification: 'INTERNAL',
  ...
  timestamp: new Date(),
    ...
    it('should export monitoring data in different formats', async () => { // Generate some test data
      await service.recordEvent({)
  timestamp: new Date(),
        eventType: 'ACCESS',
        classification: 'INTERNAL',
  ...
  describe('Alert Management', () => { it('should create and manage alerts', async () => {
  const receivedAlerts: MonitoringAlert = [];
  service.onAlert((alert) => {
  receivedAlerts.push(alert) });
      // Trigger an alert
  ...
  complianceScore: 50 // Very low compliance }
    ...
    it('should allow alert resolution', async () => { // Trigger an alert
      await service.recordEvent({)
  timestamp: new Date(),
        eventType: 'COMPLIANCE_CHECK',
        classification: 'CONFIDENTIAL',
  ...
  describe('Data Management', () => { it('should limit stored events to prevent memory issues', async () => {
  ...
  operation: 'read',
    ...
    it('should clear all monitoring data when requested', async () => { // Generate some data
      await service.recordEvent({)
  timestamp: new Date(),
        eventType: 'ACCESS',
        classification: 'INTERNAL',
  ...
  describe('Performance Metrics', () => { it('should track processing time metrics accurately', async () => {
  ...
  processingTimeMs: time }
    ...
    it('should calculate compliance rates correctly', async () => { const scores = [100, 80, 90, 70, 85];
