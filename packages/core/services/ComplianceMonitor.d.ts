...
export declare class EnhancedComplianceMonitor extends ComplianceMonitor {
     ...
     */
    recordComplianceMeasurement(framework: 'GDPR' | 'CCPA' | 'SOC2' | 'ISO27001' | 'MPA' | 'INTERNAL', metricName: string, actualValue: number, context?: Record<string, any>): Promise<void>;
    /**
