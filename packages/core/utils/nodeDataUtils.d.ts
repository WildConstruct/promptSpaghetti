...
export declare function addVariationToNode(nodeData: NodeData, variation: string): NodeData;

export declare function removeVariationFromNode(nodeData: NodeData, index: number): NodeData;
...
export declare function getRandomVariation(nodeData: NodeData, seed?: number): string;
...
export declare function validateNodeDataLegacyWrapper(
  nodeData: NodeData
): { valid: boolean; errors: string[] };

export declare function validateNodeDataLegacy(
  nodeData: NodeData
): { valid: boolean; errors: string[] };
