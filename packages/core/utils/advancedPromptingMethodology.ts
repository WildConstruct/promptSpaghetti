...
export const ZADA_SCREENPLAY_TEMPLATES: ZadaTemplateComponent[] = [
  ...
  },
  {
    ...
    template:
      'The {weather} creates a {mood} atmosphere, with {lighting} casting {shadow_type} shadows',
  ...
  },
  {
    ...
    template:
      'As {obstacle} {obstacle_action}, {protagonist} must {response_action} or face {consequence}',
    variables: [
      'obstacle',
      'obstacle_action',
      'protagonist',
  ...
  // Locations (Spatial Context)
  {
    ...
    template:
      'The scene unfolds in {location_type}, characterized by {location_features} and {location_mood}',
  ...
  },
  {
    ...
    template:
      'Surrounding details include {detail_1}, {detail_2}, and {detail_3} that {impact_on_scene}',
  ...
  // Characters (Who is involved)
  {
    ...
    template:
      '{character_name}, a {character_type} with {character_trait_1} and {character_trait_2}',
    variables: [
      'character_name',
      'character_type',
      'character_trait_1',
  ...
  // Cinematography (Visual presentation)
  {
    ...
    template:
      'Shot with {camera_angle} using {camera_movement}, emphasizing {visual_focus}',
  ...
  },
  {
    ...
    template:
      'Lit with {lighting_style} creating {lighting_effect} that {emotional_impact}',
...
export const MARS_FRAMEWORK_TAGS: MarsTag[] = [
  // Camera Tags [CAM]
  {
    ...
    syntax: '[CAM:WIDE]',
    examples: [
      '[CAM:WIDE] establishing shot of the battlefield',
      '[CAM:WIDE] panoramic view of the castle'
    ],
    priority: 8,
  ...
  },
  {
    ...
    syntax: '[CAM:CLOSE]',
    examples: [
      "[CAM:CLOSE] character's determined expression",
      '[CAM:CLOSE] intricate sword details'
    ],
    priority: 8,
  ...
  },
  {
    ...
    syntax: '[CAM:LOW]',
    examples: [
      '[CAM:LOW] hero rising from the ground',
      '[CAM:LOW] towering castle walls'
    ],
    priority: 7
  },
  {
    ...
    syntax: '[CAM:HIGH]',
    examples: [
      '[CAM:HIGH] vast landscape below',
      '[CAM:HIGH] character looking small'
    ],
    priority: 7
  },
  {
    ...
    syntax: '[CAM:AERIAL]',
    examples: [
      '[CAM:AERIAL] birds-eye view of the battle',
      '[CAM:AERIAL] sweeping forest canopy'
    ],
    priority: 6,
    conflicts: ['CAM:CLOSE', 'CAM:MACRO']
  },
  // Subject Tags [SUBJ]
  {
    ...
    syntax: '[SUBJ:HERO]',
    examples: [
      '[SUBJ:HERO] brave knight in shining armor',
      '[SUBJ:HERO] determined space captain'
    ],
    priority: 10
  },
  {
    ...
    syntax: '[SUBJ:VILLAIN]',
    examples: [
      '[SUBJ:VILLAIN] dark sorcerer with glowing eyes',
      '[SUBJ:VILLAIN] ruthless corporate executive'
    ],
    priority: 9
  },
  {
    ...
    syntax: '[SUBJ:CROWD]',
    examples: [
      '[SUBJ:CROWD] cheering festival attendees',
      '[SUBJ:CROWD] fleeing townspeople'
    ],
    priority: 6
  },
  {
    ...
    syntax: '[SUBJ:OBJECT]',
    examples: [
      '[SUBJ:OBJECT] ancient magical artifact',
      '[SUBJ:OBJECT] mysterious locked door'
    ],
    priority: 7
  },
  // Effects Tags [FX]
  {
    ...
    syntax: '[FX:MAGIC]',
    examples: [
      '[FX:MAGIC] glowing energy swirling around hands',
      '[FX:MAGIC] portal opening with mystical light'
    ],
    priority: 8
  },
  {
    ...
    syntax: '[FX:FIRE]',
    examples: [
      '[FX:FIRE] dragon breathing intense flames',
      '[FX:FIRE] torches flickering in darkness'
    ],
    priority: 8
  },
  {
    ...
    syntax: '[FX:PARTICLES]',
    examples: [
      '[FX:PARTICLES] dust motes dancing in sunbeams',
      '[FX:PARTICLES] magical sparkles floating'
    ],
    priority: 6
  },
  {
    ...
    syntax: '[FX:WEATHER]',
    examples: [
      '[FX:WEATHER] heavy rain creating atmosphere',
      '[FX:WEATHER] mysterious fog rolling in'
    ],
    priority: 7
  },
  {
    ...
    syntax: '[FX:MOTION]',
    examples: [
      '[FX:MOTION] sword swinging with blur trails',
      '[FX:MOTION] character running at super speed'
    ],
    priority: 7
  },
  // Focal Priority Tags !FOCAL
  {
    ...
    examples: [
      "!FOCAL:PRIMARY the hero's moment of decision",
      '!FOCAL:PRIMARY crucial plot revelation'
    ],
    priority: 10
  },
  {
    ...
    examples: [
      '!FOCAL:SECONDARY background castle architecture',
      "!FOCAL:SECONDARY companion's reaction"
    ],
    priority: 7
  },
  {
    ...
    examples: [
      '!FOCAL:BACKGROUND distant mountain range',
      '!FOCAL:BACKGROUND crowd of extras'
    ],
    priority: 3
  },
  // Setting Tags
  {
    ...
    syntax: '[SET:MEDIEVAL]',
    examples: [
      '[SET:MEDIEVAL] stone castle with banners',
      '[SET:MEDIEVAL] village market square'
    ],
    priority: 8,
  ...
  },
  {
    ...
    syntax: '[SET:SCIFI]',
    examples: [
      '[SET:SCIFI] gleaming space station corridors',
      '[SET:SCIFI] hovering vehicles in neon city'
    ],
    priority: 8,
  ...
  },
  {
    ...
    syntax: '[SET:FANTASY]',
    examples: [
      '[SET:FANTASY] enchanted forest with glowing mushrooms',
      '[SET:FANTASY] wizard tower with floating books'
    ],
    priority: 8
  },
  // Mood Tags
  {
    ...
    syntax: '[MOOD:EPIC]',
    examples: [
      '[MOOD:EPIC] triumphant hero standing victorious',
      '[MOOD:EPIC] vast army preparing for battle'
    ],
    priority: 8
  },
  {
    ...
    examples: [
      '[MOOD:INTIMATE] quiet conversation by firelight',
      "[MOOD:INTIMATE] character's private moment"
    ],
    priority: 7,
  ...
  },
  {
    ...
    syntax: '[MOOD:DARK]',
    examples: [
      '[MOOD:DARK] shadows lurking in corners',
      '[MOOD:DARK] ominous storm clouds gathering'
    ],
    priority: 8
  }
];
...
export class AdvancedPromptingMethodology {
  ...
  static getInstance(): AdvancedPromptingMethodology {
    if (!AdvancedPromptingMethodology.instance) {
      AdvancedPromptingMethodology.instance =
        new AdvancedPromptingMethodology();
    }
    ...
    for (const tag of foundTags) {
      if (tag.requires) {
        for (const required of tag.requires) {
          if (
            !foundTags.some(t =>
              t.description.toLowerCase().includes(required.toLowerCase())
            )
          ) {
            suggestions.push(
              `Consider adding ${required} to support ${tag.tag}`
            );
          }
        }
      }
  ...
  createHybridTemplate(
    ...
    const structure: any = {
      ...
      marsFramework: marsFramework
        ? this.parseMarsFramework(naturalTemplate)
        : null
    };
  ...
  getMarsAutocompletions(
    ...
    const matchingTags = MARS_FRAMEWORK_TAGS.filter(
      tag =>
  ...
  private sortByDependencies(
    components: ZadaTemplateComponent[]
  ): ZadaTemplateComponent[] {
    const sorted: ZadaTemplateComponent[] = [];
    const remaining = [...components];
    while (remaining.length > 0) {
      const nextComponent = remaining.find(
        comp =>
          !comp.dependencies ||
  ...
  private enhanceWithMarsFramework(template: string): string {
    ...
    // Add contextual MARS tags based on content analysis
    if (
      template.toLowerCase().includes('character') &&
      !template.includes('[SUBJ:')
    ) {
      enhanced = `[SUBJ:HERO] ${enhanced}`;
    }
    if (
      template.toLowerCase().includes('magic') &&
      !template.includes('[FX:')
    ) {
      enhanced = enhanced.replace(/magic/gi, '[FX:MAGIC] magic');
    }
    if (
      (template.toLowerCase().includes('medieval') ||
        template.toLowerCase().includes('castle')) &&
      !template.includes('[SET:')
    ) {
...
export const advancedPromptingMethodology =
  AdvancedPromptingMethodology.getInstance();
...
export const createHybridTemplate = (
  naturalTemplate: string,
  marsFramework: boolean = false
) =>
  advancedPromptingMethodology.createHybridTemplate(
    naturalTemplate,
    marsFramework
  );

export const getMarsAutocompletions = (
  context: string,
  currentInput: string
): VariableSuggestion[] =>
