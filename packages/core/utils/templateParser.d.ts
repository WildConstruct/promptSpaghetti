...
export declare const setVariableContext: (nodeType?: string, existingVariables?: string[]) => void;
export declare const trackVariableUsage: (variableName: string) => void;
export declare const clearTemplateCache: () => void;
 ...
 */
export declare const generateSmartDefaults: (parseResult: TemplateParseResult) => Record<string, string>;
/**
 * Get contextual default values based on node type and template content
 */
export declare const getContextualDefault: (name: string, nodeType: string, template?: string) => string;
export {};
