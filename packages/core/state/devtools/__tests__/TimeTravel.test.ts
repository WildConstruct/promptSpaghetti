...
describe('TimeTravel', () => {
  ...
  maxSnapshots: 10,
    ...
    it('should initialize main branch', () => {
  ...
  timestamp: Date.now() + i * 1000,
    ...
    it('should navigate by entry ID', () => {
      const timeline = timeTravel.getTimeline();
    ...
    it('should navigate by timestamp', () => {
      const timeline = timeTravel.getTimeline();
    ...
    it('should step backward and forward', () => {
      timeTravel.goToPosition(2);
      // Step back
  ...
  describe('State Diffing', () => {
    ...
    it('should create state diffs between snapshots', () => {
      const timeline = timeTravel.getTimeline();
    ...
    it('should handle missing entries gracefully', () => {
      expect(() => {
        timeTravel.createStateDiff('nonexistent1', 'nonexistent2');
      }).toThrow('One or both entries not found');
    });
  });
  ...
  timestamp: Date.now() + i * 1000,
    ...
    it('should import history data', () => {
      const originalData = timeTravel.exportHistory();
      // Clear and import
  ...
  describe('Global Instance', () => {
    it('should provide a global TimeTravel instance', () => {
  ...
  describe('Edge Cases', () => {
    it('should handle recording when disabled', () => {
      timeTravel.stopRecording();
      const snapshot = {
    ...
    it('should handle navigation on empty timeline', () => {
      const state = timeTravel.getTimeTravelState();
    ...
    it('should handle invalid branch operations', () => {
      const switchSuccess = timeTravel.switchBranch('nonexistent');
