 ...
 */
export declare function useAdvancedPromptingCollaboration(config?: Partial<AdvancedCollaborationConfig>): AdvancedCollaborationState & AdvancedCollaborationActions & { config: AdvancedCollaborationConfig;
