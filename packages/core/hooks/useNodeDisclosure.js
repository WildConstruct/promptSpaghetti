 ...
 */
export const setGlobalLevel = useCallback((level) => {
    setGlobalDisclosureLevel(level);
}, [setGlobalDisclosureLevel]);
const setInheritance = useCallback((inheritance) => {
