...
export type UseExportReturn = UseExportState & UseExportActions;
  ...
  const handleApiCall = useCallback(async <T>(;);
    ...
    onSuccess?: (result: T) => void
      ...
      if (onSuccess) {
        onSuccess(result);
      return result } catch (error) { const errorMessage = error instanceof Error ? error.message : 'An error occurred';
  setError(errorMessage);
  throw error } finally { setLoading(false) }, [setLoading, setError]);
  // Template Actions
  ...
  method: 'POST'
      ...
      return data.data }, (newTemplate) => { setState(prev => ({ )
  ...prev
  ...
  method: 'PUT'
      ...
      return data.data }, (updatedTemplate) => { setState(prev => ({ )
  ...prev
  ...
  method: 'DELETE';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to delete template') }, () => { setState(prev => ({ )
  ...prev
  ...
  const getTemplateWithStats = useCallback(async (id: string): Promise<ExportTemplateWithStats> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get template stats');
      return data.data });
  }, [handleApiCall]);
  // Job Actions
  ...
  method: 'POST'
      ...
      return data.data }, (newJob) => { setState(prev => ({ )
  ...prev
  ...
  method: 'PUT'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to update export job');
      return data.data }, (updatedJob) => { setState(prev => ({ )
  ...prev
  ...
  method: 'PUT';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to cancel export job') }, () => { setState(prev => ({ )
        ...prev }
  ...
  const getJobWithTemplate = useCallback(async (id: string): Promise<ExportJobWithTemplate> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get job details');
      return data.data });
  }, [handleApiCall]);
  const getJobProgress = useCallback(async (id: string): Promise<ExportProgress> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get job progress');
      return data.data });
  }, [handleApiCall]);
  ...
  method: 'POST'
      ...
      return data.data }, (newSchedule) => { setState(prev => ({ )
  ...prev
  ...
  method: 'PUT'
      ...
      return data.data }, (updatedSchedule) => { setState(prev => ({ )
  ...prev
  ...
  method: 'DELETE';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to delete schedule') }, () => { setState(prev => ({ )
  ...prev
  ...
  const getScheduleWithStats = useCallback(async (id: string): Promise<ExportScheduleWithStats> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get schedule stats');
      return data.data });
  }, [handleApiCall]);
  // Share Actions
  const fetchShares = useCallback(async (jobId?: string) => {
    await handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to fetch shares');
      return data.data }, (shares) => {
      setState(prev => ({ ...prev, shares }));
    });
  }, [projectId, handleApiCall]);
  const createShare = useCallback(async (share: CreateExportShare): Promise<ExportShare> => { return handleApiCall(async () => {
  ...
  method: 'POST' }
      ...
      return data.data }, (newShare) => { setState(prev => ({ )
  ...prev
  ...
  method: 'PUT'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to update share');
      return data.data }, (updatedShare) => { setState(prev => ({ )
  ...prev
  ...
  method: 'DELETE';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to delete share') }, () => { setState(prev => ({ )
  ...prev
  ...
  method: 'POST'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to create analytics');
      return data.data }, (newAnalytics) => { setState(prev => ({ )
  ...prev
  ...
  const fetchFormatDefinitions = useCallback(async () => { await handleApiCall(async () => {
      const response = await fetch('/api/export/formats');
      const data = await response.json();
      if (!data.success) {
        throw new Error(data.error || 'Failed to fetch format definitions');
      return data.data }, (formatDefinitions) => {
  ...
  const getFormatDefinition = useCallback(async (formatName: string): Promise<ExportFormatDefinition> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get format definition');
      return data.data });
  }, [handleApiCall]);
  ...
  method: 'POST',
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to validate format options');
      return data.data });
  }, [handleApiCall]);
  // Statistics Actions
  const fetchStatistics = useCallback(async () => {
    await handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to fetch statistics');
      return data.data }, (statistics) => {
      setState(prev => ({ ...prev, statistics }));
    });
  }, [projectId, handleApiCall]);
  // Collaboration and Sharing Actions
  const getTemplates = useCallback(async (options: any = {}): Promise<ExportTemplate> => { return handleApiCall(async () => {
      const params = new URLSearchParams();
  ...
  method: 'PUT'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to share template') });
  }, [handleApiCall]);
  const previewTemplate = useCallback(async (template: ExportTemplate): Promise<any> => { return handleApiCall(async () => {
  ...
  method: 'POST' }
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to preview template');
      return data.data });
  }, [handleApiCall]);
  const getTemplateCollaborators = useCallback(async (id: string): Promise<any> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get template collaborators');
      return data.data });
  }, [handleApiCall]);
  const getTemplateActivity = useCallback(async (id: string): Promise<any> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get template activity');
      return data.data });
  }, [handleApiCall]);
  const getTemplateAnalytics = useCallback(async (id: string): Promise<any> => {
    return handleApiCall(async () => {
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to get template analytics');
      return data.data });
  }, [handleApiCall]);
  ...
  method: 'POST'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to invite collaborator');
      return data.data });
  }, [handleApiCall]);
  ...
  method: 'PUT'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to update collaborator role') });
  }, [handleApiCall]);
  ...
  method: 'DELETE';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to remove collaborator') });
  }, [handleApiCall]);
  ...
  method: 'PUT'
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to update share settings') });
  }, [handleApiCall]);
  ...
  method: 'POST';
      ...
      const data = await response.json();
      if (!data.success) { throw new Error(data.error || 'Failed to fork template');
      return data.data });
  }, [handleApiCall]);
  // Utility Actions
  const refetch = useCallback(async () => { await Promise.all([)
      fetchTemplates()
      fetchJobs()
      fetchSchedules()
      fetchShares()
