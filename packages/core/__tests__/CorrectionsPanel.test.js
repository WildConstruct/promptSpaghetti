...
beforeEach(() => {
    ...
    useCorrectionsStore.mockReturnValue(mockStore);
});
describe('CorrectionsPanel', () => {
    it('should not render when closed', () => {
        render(_jsx(CorrectionsPanel, { isOpen: false, onClose: () => { } }));
        expect(screen.queryByTestId('corrections-panel')).not.toBeInTheDocument();
    });
    it('should render when open', () => {
        render(_jsx(CorrectionsPanel, { isOpen: true, onClose: () => { } }));
    ...
    it('should call onClose when close button is clicked', () => {
        ...
        render(_jsx(CorrectionsPanel, { isOpen: true, onClose: mockOnClose }));
    ...
    it('should toggle rule when checkbox is clicked', async () => {
        ...
        const ruleCheckbox = checkboxes.find(checkbox => ruleSection?.contains(checkbox));
