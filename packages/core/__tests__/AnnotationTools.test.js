...
jest.mock('../components/ui/Switch', () => ({
    Switch: ({ checked, onCheckedChange, id, size }) => (_jsx("input", { type: "checkbox", checked: checked, onChange: (e) => onCheckedChange && onCheckedChange(e.target.checked), id: id, className: `switch ${size || ''}` }))
}));
...
const sampleDrawingUser = {
    id: 'user-001',
    name: 'John Director',
    role: 'director',
    color: '#ff7c00'
};
const sampleDrawingAnnotation = {
    id: 'drawing-001',
    type: 'arrow',
...
const sampleRegionUser = {
    id: 'user-001',
    name: 'John Director',
    role: 'director',
    color: '#ff7c00'
};
const sampleRegionAnnotation = {
    id: 'region-001',
...
describe('Annotation Tools Integration', () => {
    describe('NodeAnnotationSystem', () => {
        ...
        const mockOnReplyCreate = jest.fn();
        beforeEach(() => {
            jest.clearAllMocks();
        });
        it('should render node annotation system with statistics', () => {
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [sampleNodeAnnotation], currentUser: sampleVFXUser, onAnnotationCreate: mockOnAnnotationCreate, onAnnotationUpdate: mockOnAnnotationUpdate, onAnnotationDelete: mockOnAnnotationDelete, onReplyCreate: mockOnReplyCreate }));
        ...
        it('should handle annotation creation', async () => {
            ...
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [], currentUser: sampleVFXUser, onAnnotationCreate: mockOnAnnotationCreate, onAnnotationUpdate: mockOnAnnotationUpdate, onAnnotationDelete: mockOnAnnotationDelete, onReplyCreate: mockOnReplyCreate }));
            ...
            expect(mockOnAnnotationCreate).toHaveBeenCalledWith(expect.objectContaining({
                nodeId: 'node-001',
                type: 'review',
        ...
        it('should render in compact mode', () => {
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [sampleNodeAnnotation], currentUser: sampleVFXUser, onAnnotationCreate: mockOnAnnotationCreate, onAnnotationUpdate: mockOnAnnotationUpdate, onAnnotationDelete: mockOnAnnotationDelete, onReplyCreate: mockOnReplyCreate, compact: true }));
        ...
        it('should filter annotations by type and status', () => {
            ...
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: multipleAnnotations, currentUser: sampleVFXUser, onAnnotationCreate: mockOnAnnotationCreate, onAnnotationUpdate: mockOnAnnotationUpdate, onAnnotationDelete: mockOnAnnotationDelete, onReplyCreate: mockOnReplyCreate }));
        ...
        it('should handle replies to annotations', async () => {
            ...
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [annotationWithReplies], currentUser: sampleVFXUser, onAnnotationCreate: mockOnAnnotationCreate, onAnnotationUpdate: mockOnAnnotationUpdate, onAnnotationDelete: mockOnAnnotationDelete, onReplyCreate: mockOnReplyCreate }));
    ...
    describe('DrawingAnnotationsCanvas', () => {
        ...
        it('should render drawing canvas with toolbar', () => {
            render(_jsx(DrawingAnnotationsCanvas, { width: 800, height: 600, annotations: [sampleDrawingAnnotation], currentUser: sampleDrawingUser, onAnnotationsChange: mockOnAnnotationsChange, onSave: mockOnSave }));
        ...
        it('should show drawing tools in toolbar', () => {
            render(_jsx(DrawingAnnotationsCanvas, { width: 800, height: 600, annotations: [], currentUser: sampleDrawingUser, onAnnotationsChange: mockOnAnnotationsChange }));
        ...
        it('should handle readonly mode', () => {
            render(_jsx(DrawingAnnotationsCanvas, { width: 800, height: 600, annotations: [], currentUser: sampleDrawingUser, onAnnotationsChange: mockOnAnnotationsChange, readonly: true }));
        ...
        it('should export drawing as image', async () => {
            ...
            render(_jsx(DrawingAnnotationsCanvas, { width: 800, height: 600, annotations: [sampleDrawingAnnotation], currentUser: sampleDrawingUser, onAnnotationsChange: mockOnAnnotationsChange }));
    ...
    describe('RegionAnnotationSystem', () => {
        const mockOnRegionsChange = jest.fn();
        const mockOnRegionSelect = jest.fn();
        const mockOnNodesInRegion = jest.fn();
        beforeEach(() => {
            jest.clearAllMocks();
            // Mock canvas context
            const mockContext = {
        ...
        it('should render region annotation system with statistics', () => {
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [sampleRegionAnnotation], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange, onRegionSelect: mockOnRegionSelect, onNodesInRegion: mockOnNodesInRegion }));
        ...
        it('should show region types and tools', async () => {
            const user = userEvent.setup();
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange }));
        ...
        it('should display region details with metadata', () => {
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [sampleRegionAnnotation], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange, selectedRegion: "region-001" }));
        ...
        it('should filter regions by type and status', async () => {
            ...
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: multipleRegions, nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange }));
        ...
        it('should handle node containment detection', () => {
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [sampleRegionAnnotation], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange, onNodesInRegion: mockOnNodesInRegion }));
            // Region should contain nodes based on position
            expect(sampleRegionAnnotation.metadata.nodeCount).toBe(2);
        });
        it('should handle readonly mode', () => {
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [sampleRegionAnnotation], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: mockOnRegionsChange, readonly: true }));
            expect(screen.getByText('Read Only')).toBeInTheDocument();
    ...
    describe('Accessibility and Usability', () => {
        it('should provide proper ARIA labels and roles', () => {
            render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [sampleNodeAnnotation], currentUser: sampleVFXUser, onAnnotationCreate: jest.fn(), onAnnotationUpdate: jest.fn(), onAnnotationDelete: jest.fn(), onReplyCreate: jest.fn() }));
        ...
        it('should support keyboard navigation', async () => {
            const user = userEvent.setup();
            render(_jsx(DrawingAnnotationsCanvas, { width: 800, height: 600, annotations: [], currentUser: sampleDrawingUser, onAnnotationsChange: jest.fn() }));
        ...
        it('should provide clear visual feedback', () => {
            render(_jsx(RegionAnnotationSystem, { width: 800, height: 600, regions: [sampleRegionAnnotation], nodes: sampleNodes, currentUser: sampleRegionUser, onRegionsChange: jest.fn(), selectedRegion: "region-001" }));
    ...
    describe('Error Handling', () => {
        it('should handle missing required props gracefully', () => {
            ...
            expect(() => {
                render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [], currentUser: sampleVFXUser, onAnnotationCreate: jest.fn(), onAnnotationUpdate: jest.fn(), onAnnotationDelete: jest.fn(), onReplyCreate: jest.fn() }));
            }).not.toThrow();
        });
        it('should handle invalid canvas dimensions', () => {
            expect(() => {
                render(_jsx(DrawingAnnotationsCanvas, { width: 0, height: 0, annotations: [], currentUser: sampleDrawingUser, onAnnotationsChange: jest.fn() }));
            }).not.toThrow();
        });
        it('should handle malformed annotation data', () => {
            ...
            expect(() => {
                render(_jsx(NodeAnnotationSystem, { nodeId: "node-001", nodeName: "Test Node", nodeType: "weighted_choice", annotations: [malformedAnnotation], currentUser: sampleVFXUser, onAnnotationCreate: jest.fn(), onAnnotationUpdate: jest.fn(), onAnnotationDelete: jest.fn(), onReplyCreate: jest.fn() }));
            }).not.toThrow();
        });
    });
});
