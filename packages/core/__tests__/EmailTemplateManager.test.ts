...
describe('EmailTemplateManager', () => { let templateManager: EmailTemplateManager;
  beforeEach(() => {
  // Create template manager with test directory
  templateManager = new EmailTemplateManager() });
  describe('Template Loading', () => { test('should load all default templates', () => {
    ...
    test('should have valid template structure', () => { const verificationTemplate = templateManager.getTemplate('mfa-verification');
    ...
    test('should categorize templates correctly', () => { const verificationTemplates = templateManager.getTemplatesByCategory('verification');
  ...
  describe('Template Rendering', () => { const testVariables: TemplateVariables = {,
  ...
  trackingPixelUrl: 'https://analytics.promptscape.com/pixel.gif' }
    ...
    test('should render HTML template correctly', () => { const result = templateManager.renderTemplate('mfa-verification', testVariables, 'html');
    ...
    test('should render text template correctly', () => { const result = templateManager.renderTemplate('mfa-verification', testVariables, 'text');
      expect(result).toBeTruthy();
      expect(result!.subject).toContain('PromptScape');
      expect(result!.content).toContain('John Doe');
      expect(result!.content).toContain('123456');
      expect(result!.content).toContain('10 minutes') });
    test('should handle missing optional variables gracefully', () => { const minimalVariables: TemplateVariables = {,
  ...
  expiryMinutes: '5' }
    ...
    test('should return null for non-existent template', () => { const result = templateManager.renderTemplate('non-existent', testVariables);
      expect(result).toBeNull() });
    test('should validate variables when requested', () => { const incompleteVariables: Partial<TemplateVariables> = {
  displayName: 'Test User' }
  // Missing required variables
};
      expect(() => { templateManager.renderTemplate()
          'mfa-verification'
  ...
  describe('Template Validation', () => { test('should validate complete template successfully', () => {
    ...
    test('should detect missing required variables', () => { const incompleteVariables: Partial<TemplateVariables> = {
  displayName: 'Test User' }
  // Missing other required variables
    ...
    test('should detect unused variables', () => { const testVariables = {
  ...
  describe('Template Management', () => { test('should add new template', () => {
  ...
  subject: 'Test Subject' }
    ...
    test('should remove template', () => { const customTemplate: EmailTemplate = {,
  subject: 'Test Subject',
  ...
  category: 'notification' }
    ...
    test('should return false when removing non-existent template', () => { const removed = templateManager.removeTemplate('non-existent');
      expect(removed).toBe(false) });
  });
  describe('Template Preview', () => { test('should generate HTML preview', () => {
    ...
    test('should generate text preview', () => { const preview = templateManager.previewTemplate('mfa-verification', 'text');
      expect(preview).toBeTruthy();
      expect(preview).not.toContain('<!DOCTYPE html>');
      expect(preview).toContain('Alex Johnson'); // From test data
      expect(preview).toContain('alex.johnson@example.com') });
    test('should return null for non-existent template preview', () => { const preview = templateManager.previewTemplate('non-existent');
      expect(preview).toBeNull() });
  });
  describe('Rendering Options', () => { const testVariables = TemplateTestUtils.generateTestData();
    ...
    test('should strip comments when requested', () => { const withComments = templateManager.renderTemplate('mfa-verification', testVariables, 'html');
  ...
  describe('Template Engine Features', () => { test('should process helper functions', () => {
 ...
 as TemplateVariables);
    ...
    test('should handle nested conditionals', () => { const complexTemplate: EmailTemplate = {,
  subject: 'Test',
        htmlTemplate: ` }
          {{#if hasWarning}}
            <div class="warning">
 ...
 as TemplateVariables);
  ...
  describe('Security Considerations', () => { test('should not execute JavaScript in templates', () => {
 ...
 as TemplateVariables);
    ...
    test('should handle potentially dangerous variable content', () => { const testVariables = {
  ...
  describe('Performance Considerations', () => {
    ...
    test('should reuse template objects efficiently', () => { const template1 = templateManager.getTemplate('mfa-verification');
...
describe('TemplateTestUtils', () => {
  ...
  test('should test all templates successfully', () => { const templateManager = new EmailTemplateManager();
    const results = TemplateTestUtils.testAllTemplates(templateManager);
