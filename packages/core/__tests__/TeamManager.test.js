...
jest.mock('lucide-react', () => ({
    ...
    User: () => _jsx("div", { "data-testid": "user-icon" }),
    Eye: () => _jsx("div", { "data-testid": "eye-icon" }),
    ChevronRight: () => _jsx("div", { "data-testid": "chevron-right-icon" }),
    ChevronDown: () => _jsx("div", { "data-testid": "chevron-down-icon" }),
    UserPlus: () => _jsx("div", { "data-testid": "user-plus-icon" }),
    Settings: () => _jsx("div", { "data-testid": "settings-icon" }),
    Activity: () => _jsx("div", { "data-testid": "activity-icon" })
}));
describe('TeamManager', () => {
    ...
    it('renders the team manager interface', () => {
        render(_jsx(TeamManager, { teams: mockTeams, ...defaultProps }));
    ...
    it('handles team creation form submission', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, ...defaultProps, onCreateTeam: mockCreate }));
        // Open create modal
        const createButton = screen.getByText('Create Team');
        await user.click(createButton);
        // Fill form
    ...
    it('handles team update form submission', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, ...defaultProps, onUpdateTeam: mockUpdate }));
        // Open edit modal
        const editButtons = screen.getAllByTestId('edit-icon');
        await user.click(editButtons[0].closest('button'));
        // Update name
    ...
    it('handles team deletion', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, ...defaultProps, onDeleteTeam: mockDelete }));
    ...
    it('expands team to show members when clicked', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, ...defaultProps, onLoadMembers: mockLoadMembers }));
    ...
    it('displays team members when team is expanded', async () => {
        const user = userEvent.setup();
        const mockLoadMembers = jest.fn().mockResolvedValue(mockMembers);
        render(_jsx(TeamManager, { teams: mockTeams, members: { 'team-1': mockMembers }, ...defaultProps, onLoadMembers: mockLoadMembers }));
    ...
    it('shows add member modal when add member button is clicked', async () => {
        const user = userEvent.setup();
        render(_jsx(TeamManager, { teams: mockTeams, members: { 'team-1': mockMembers }, ...defaultProps }));
    ...
    it('handles add member form submission', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, members: { 'team-1': mockMembers }, ...defaultProps, onAddMember: mockAddMember }));
    ...
    it('handles member role update', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, members: { 'team-1': mockMembers }, ...defaultProps, onUpdateMemberRole: mockUpdateRole }));
    ...
    it('handles member removal', async () => {
        ...
        render(_jsx(TeamManager, { teams: mockTeams, members: { 'team-1': mockMembers }, ...defaultProps, onRemoveMember: mockRemoveMember }));
    ...
    it('displays empty state when no teams exist', () => {
        render(_jsx(TeamManager, { teams: [], ...defaultProps }));
