...
import { createSafeMathContext, createAuditedSafeMathContext, validateMathFunctionCall, MathFunctionAuditor, SAFE_MATH_FUNCTIONS, BLOCKED_MATH_FUNCTIONS, NUMERIC_LIMITS, isInSafeRange, safeNumberCoercion } from '../runtime/safe-math-context';
    ...
    describe('Utility Functions', () => {
        describe('isInSafeRange', () => {
            ...
            it('should reject non-numbers', () => {
                expect(isInSafeRange('42')).toBe(false);
                expect(isInSafeRange(null)).toBe(false);
                expect(isInSafeRange(undefined)).toBe(false);
                expect(isInSafeRange({})).toBe(false);
            });
        });
