...
describe('VariationList Integration with Editors', () => {
    ...
    it('renders WeightedChoiceEditor with enhanced VariationList', () => {
        render(_jsx(WeightedChoiceEditor, { nodeId: mockNodeData.id, nodeData: mockNodeData, schema: null, onChange: mockOnChange }));
    ...
    it('shows variation count in the interface', () => {
        ...
        render(_jsx(WeightedChoiceEditor, { nodeId: nodeDataWithChoices.id, nodeData: nodeDataWithChoices, schema: null, onChange: mockOnChange }));
