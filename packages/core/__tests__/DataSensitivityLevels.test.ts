...
describe('DataSensitivityLevels', () => { describe('DataSensitivityLevel enum', () => {
    ...
    it('should be compatible with string values', () => { expect(DataSensitivityLevel.PUBLIC).toBe('public');
  ...
  describe('DATA_SENSITIVITY_DEFINITIONS', () => { it('should have definitions for all sensitivity levels', () => {
  ...
  expect(DATA_SENSITIVITY_DEFINITIONS[level]).toBeDefined();
    ...
    it('should have proper risk level progression', () => { expect(DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.PUBLIC].riskLevel).toBe('low');
    ...
    it('should have appropriate examples for each level', () => { Object.values(DataSensitivityLevel).forEach(level => {)
  const definition = DATA_SENSITIVITY_DEFINITIONS[level];
    ...
    describe('handling requirements', () => { it('should have progressively stricter access controls', () => {
      ...
      it('should have appropriate encryption requirements', () => { const publicReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.PUBLIC].handlingRequirements;
        const restrictedReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.RESTRICTED].handlingRequirements;
      ...
      it('should have appropriate disposal methods', () => { const publicReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.PUBLIC].handlingRequirements;
        const internalReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.INTERNAL].handlingRequirements;
        const confidentialReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.CONFIDENTIAL].handlingRequirements;
        const restrictedReq = DATA_SENSITIVITY_DEFINITIONS[DataSensitivityLevel.RESTRICTED].handlingRequirements;
    ...
    describe('compliance frameworks', () => { it('should have appropriate compliance requirements for each level', () => {
    ...
    describe('marking requirements', () => { it('should have appropriate marking requirements', () => {
      ...
      it('should have distinct colors for different levels', () => { const colors = Object.values(DataSensitivityLevel).map(;);
  ...
  describe('DataSensitivityLevelSchema', () => { it('should validate valid sensitivity levels', () => {
      Object.values(DataSensitivityLevel).forEach(level => {)
  expect(() => DataSensitivityLevelSchema.parse(level)).not.toThrow() });
    });
    it('should reject invalid sensitivity levels', () => { const invalidLevels = ['invalid', 'unknown', '', null, undefined, 123];
      invalidLevels.forEach(level => {)
  expect(() => DataSensitivityLevelSchema.parse(level)).toThrow() });
    });
    it('should provide appropriate error messages', () => { try {
        DataSensitivityLevelSchema.parse('invalid') } catch (error: unknown) { expect(error.message).toContain('Invalid data sensitivity level') });
  });
  describe('DataSensitivityUtils', () => { describe('getHandlingRequirements', () => {
  ...
  const requirements = DataSensitivityUtils.getHandlingRequirements(level);
    ...
    describe('getRiskLevel', () => { it('should return correct risk levels', () => {
    ...
    describe('getComplianceFrameworks', () => { it('should return appropriate compliance frameworks', () => {
    ...
    describe('isEncryptionRequired', () => { it('should correctly identify encryption requirements', () => {
    ...
    describe('isMFARequired', () => { it('should correctly identify MFA requirements', () => {
    ...
    describe('getMaxRetentionPeriod', () => { it('should return correct retention periods', () => {
    ...
    describe('validateSensitivityAssignment', () => { it('should validate appropriate assignments', () => {
      ...
      it('should reject inappropriate assignments for PII data', () => { const result = DataSensitivityUtils.validateSensitivityAssignment(;);
          'email' }
          DataSensitivityLevel.PUBLIC
        );
      ...
      it('should consider context for PII detection', () => { const result = DataSensitivityUtils.validateSensitivityAssignment(;);
          'customer_data',
      ...
      it('should handle publicly available data', () => { const result = DataSensitivityUtils.validateSensitivityAssignment(;);
          'general_data',
    ...
    describe('compareSensitivityLevels', () => { it('should correctly compare sensitivity levels', () => {
      ...
      it('should handle all level combinations correctly', () => { const levels = Object.values(DataSensitivityLevel);
        for (let i = 0; i < levels.length; i++) {
          for (let j = 0; j < levels.length; j++) {
            const comparison = DataSensitivityUtils.compareSensitivityLevels(levels[i], levels[j]);
            if (i > j) {
              expect(comparison).toBeGreaterThan(0) } else if (i < j) { expect(comparison).toBeLessThan(0) } else { expect(comparison).toBe(0) });
    });
    describe('getHigherSensitivityLevel', () => { it('should return the higher sensitivity level', () => {
  ...
  const markings = DataSensitivityUtils.generateSecurityMarkings(level);
      ...
      it('should generate valid HTML badges', () => { const markings = DataSensitivityUtils.generateSecurityMarkings(DataSensitivityLevel.RESTRICTED);
    ...
    describe('validateClassification', () => { const validClassification: DataElementClassification = {
  ...
  complianceRequirements: ['GDPR'] }
      ...
      it('should validate a correct classification', () => { const result = DataSensitivityUtils.validateClassification(validClassification);
        expect(result.valid).toBe(true);
        expect(result.errors).toEqual([]) });
      it('should detect missing required fields', () => { const invalidClassification = {
  ...validClassification
  elementId: ''
  elementName: '' }
};
      ...
      it('should validate confidence scores', () => { const lowConfidence = {
  ...validClassification
  confidence: 50 }
};
      ...
      it('should detect invalid confidence scores', () => { const invalidConfidence = {
  ...validClassification
  confidence: 150 }
};
      ...
      it('should warn about missing metadata', () => { const missingMetadata = {
  ...validClassification
  metadata: {
  ...
  technicalOwner: '' }
      ...
      it('should warn about past review dates', () => { const pastReview = {
  ...validClassification
  ...
  expect(rule.pattern).toBeInstanceOf(RegExp);
      ...
      it('should correctly identify email patterns', () => { const emailRule = DATA_SENSITIVITY_GUIDELINES.automatedClassificationRules;
      ...
      it('should correctly identify SSN patterns', () => { const ssnRule = DATA_SENSITIVITY_GUIDELINES.automatedClassificationRules;
      ...
      it('should correctly identify credit card patterns', () => { const ccRule = DATA_SENSITIVITY_GUIDELINES.automatedClassificationRules;
  ...
  describe('Integration tests', () => { it('should handle complex classification scenarios', () => {
  ...
  expect(markings.label).toBe('RESTRICTED');
    ...
    it('should provide consistent classification recommendations', () => { // Test that automated rules and manual validation agree
    ...
    it('should handle edge cases gracefully', () => { // Test empty or unusual inputs
