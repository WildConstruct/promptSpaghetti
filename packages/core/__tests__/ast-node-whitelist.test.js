...
import { ASTNodeTypeRegistry, ASTNodeWhitelistFilter, NodeSafetyLevel, createConditionalNodeFilter, createGeneralExpressionFilter, createRestrictedExpressionFilter } from '../runtime/ast-node-whitelist';
...
describe('ASTNodeWhitelistFilter', () => {
    ...
    describe('Context-Specific Filtering', () => {
        ...
        it('should apply custom overrides', () => {
            ...
            const mockSafeNode = { type: 'TestNodeType' };
