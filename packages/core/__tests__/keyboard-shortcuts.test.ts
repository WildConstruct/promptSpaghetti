...
describe('Keyboard Shortcuts', () => { let handleSaveProject: jest.MockedFunction<() => void>;
  ...
  afterEach(() => { document.removeEventListener('keydown', keydownListener);
    jest.clearAllMocks() });
  test('Ctrl+S triggers save project', () => { const preventDefault = jest.fn<unknown, unknown>();
  ...
  test('Cmd+S triggers save project', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 's'
  metaKey: true }
});
  ...
  test('Ctrl+O triggers load project', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 'o'
  ctrlKey: true }
});
  ...
  test('Cmd+O triggers load project', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 'o'
  metaKey: true }
});
  ...
  test('Alt+S triggers settings modal (existing functionality preserved)', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 's'
  altKey: true }
});
  ...
  test('regular S key does not trigger save', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 's' }
});
    Object.defineProperty(event, 'preventDefault', { value: preventDefault });
  ...
  test('Shift+S does not trigger save', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 's'
  shiftKey: true }
});
  ...
  test('Ctrl+Shift+S does not trigger save (reserved for save as)', () => { const preventDefault = jest.fn<unknown, unknown>();
  const event = new KeyboardEvent('keydown', { )
  key: 's'
  ctrlKey: true
  shiftKey: true }
  ...
  test('Alt takes priority over Ctrl when both modifiers are present', () => { const preventDefault = jest.fn<unknown, unknown>();
