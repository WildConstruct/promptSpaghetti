...
import { createSafeMathContext, createAuditedSafeMathContext, SAFE_MATH_FUNCTIONS, BLOCKED_MATH_FUNCTIONS, validateMathFunctionCall, MathFunctionAuditor, isInSafeRange, safeNumberCoercion } from '../runtime/safe-math-context';
import { createConditionalNodeFilter, NodeSafetyLevel } from '../runtime/ast-node-whitelist';
...
describe('Comprehensive Security Test Suite', () => {
    ...
    describe('AST Node Security', () => {
        it('should enforce AST node whitelist', () => {
            ...
            for (const node of safeNodes) {
                const result = filter.filterAST(node);
        ...
        it('should enforce AST depth limits', () => {
            ...
            let deepNode = { type: 'Literal', value: 1 };
            for (let i = 0; i < 25; i++) {
                deepNode = {
    ...
    describe('Conditional Node Security', () => {
        it('should safely evaluate conditional expressions', () => {
            ...
            const conditional = new ConditionalNode('secure-conditional', [
        ...
        it('should block dangerous conditional expressions', () => {
            ...
            const dangerousConditional = new ConditionalNode('dangerous-conditional', [
        ...
        it('should handle non-strict mode gracefully', () => {
            const ctx = new AdvancedExecutionContext('test-seed');
            ctx.variables = { x: 5 };
            const nonStrictConditional = new ConditionalNode('non-strict', [
