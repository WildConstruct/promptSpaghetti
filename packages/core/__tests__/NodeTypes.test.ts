...
describe('NodeTypes Data Model', () => { describe('Factory Functions', () => {
    ...
    test('creates Concat node data correctly', () => { const nodeData = createConcatNodeData('concat-id');
    ...
    test('creates node data via dispatcher', () => { const choiceNode = createNodeData('WeightedChoice', 'choice-1');
  ...
  describe('Type Guards', () => { test('identifies runtime node types correctly', () => {
    ...
    test('identifies UI node types correctly', () => { expect(isUINodeType('Subject')).toBe(true);
  ...
  describe('Serialization', () => {
    ...
    test('returns null for UI-only nodes', () => { const subjectNode = createNodeData('Subject', 'subject-1');
      const runtime = serializeForRuntime(subjectNode);
      expect(runtime).toBeNull() });
    test('deserializes from runtime format', () => { const runtimeData = {
        id: 'choice-1',
  ...
  describe('Validation', () => {
    ...
    test('validates WeightedChoice specifics', () => { const invalidChoice = {
  id: 'test',
  type: 'WeightedChoice' as const,
  label: 'Test',
  choices: [] }
    ...
    test('validates valid node data', () => { const validNode = createWeightedChoiceNodeData('test', 'Test');
