import { createNodeData, createWeightedChoiceNodeData, createConcatNodeData, serializeForRuntime, deserializeFromRuntime, validateNodeData, isRuntimeNodeType, isUINodeType, } from '../types/NodeTypes';
describe('NodeTypes Data Model', () => {
    ...
    describe('Serialization', () => {
        ...
        test('deserializes from runtime format', () => {
            ...
            expect(nodeData.type).toBe('WeightedChoice');
            expect(nodeData.choices).toEqual(['A', 'B']);
            expect(nodeData.weights).toEqual([1, 2]);
        });
    });
    describe('Validation', () => {
