...
describe('EmailTemplateManager', () => {
    ...
    describe('Template Rendering', () => {
        ...
        test('should validate variables when requested', () => {
            ...
            expect(() => {
                templateManager.renderTemplate('mfa-verification', incompleteVariables, 'html', { validateVariables: true });
    ...
    describe('Template Validation', () => {
        ...
        test('should detect missing required variables', () => {
            ...
            const validation = templateManager.validateTemplate('mfa-verification', incompleteVariables);
    ...
    describe('Rendering Options', () => {
        ...
        test('should minify HTML when requested', () => {
            ...
            const minified = templateManager.renderTemplate('mfa-verification', testVariables, 'html', { minify: true });
        ...
        test('should strip comments when requested', () => {
            ...
            const withoutComments = templateManager.renderTemplate('mfa-verification', testVariables, 'html', { stripComments: true });
