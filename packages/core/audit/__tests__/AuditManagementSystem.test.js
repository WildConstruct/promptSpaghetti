...
import { AuditManagementSystem, AuditEventType, AuditSeverity, ComplianceFramework, AuditStatus, createAuditEvent, queryAuditEvents, generateAuditAnalytics } from '../AuditManagementSystem';
describe('AuditManagementSystem', () => {
    ...
    describe('Compliance Reporting', () => {
        ...
        it('should generate GDPR compliance report', () => {
            const report = auditSystem.generateComplianceReport(ComplianceFramework.GDPR, {
        ...
        it('should generate SOX compliance report', () => {
            ...
            const report = auditSystem.generateComplianceReport(ComplianceFramework.SOX, {
                start: new Date(Date.now() - 24 * 60 * 60 * 1000),
                end: new Date()
            });
