 ...
 */
import { z } from 'zod';
export declare enum AuditActivityType { COMPLIANCE_REVIEW = "compliance_review",
...
export declare const AuditScheduleSchema: z.ZodObject<{
    ...
    }, "strip", z.ZodTypeAny, { interval?: number | undefined;
        end_date?: Date | undefined;
        max_occurrences?: number | undefined;
        days_of_week?: number[] | undefined;
        day_of_month?: number | undefined;
        month_of_year?: number | undefined }, { interval?: number | undefined;
        end_date?: Date | undefined;
        max_occurrences?: number | undefined;
        days_of_week?: number[] | undefined;
        day_of_month?: number | undefined;
    ...
    prerequisites: z.ZodDefault<z.ZodArray<z.ZodObject<{ 
        ...
        description: z.ZodString;
        completed: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { description: string;
        type: "task_completion" | "document_approval" | "system_ready";
        completed: boolean }, { description: string;
        type: "task_completion" | "document_approval" | "system_ready";
        completed?: boolean | undefined }>, "many">>;
    notifications: z.ZodDefault<z.ZodArray<z.ZodObject<{ 
        ...
        channels: z.ZodArray<z.ZodEnum<["email", "slack", "sms", "dashboard"]>, "many"> }, "strip", z.ZodTypeAny, { channels: ("email" | "sms" | "slack" | "dashboard")[];
        timing: NotificationTiming;
        recipients: string[];
        message_template?: string | undefined }, { channels: ("email" | "sms" | "slack" | "dashboard")[];
        timing: NotificationTiming;
        recipients: string[];
        message_template?: string | undefined }>, "many">>;
    deliverables: z.ZodDefault<z.ZodArray<z.ZodObject<{ 
        ...
        file_path: z.ZodOptional<z.ZodString> }, "strip", z.ZodTypeAny, { name: string;
        type: "documentation" | "assessment" | "report" | "certificate";
        completed: boolean;
        due_date?: Date | undefined;
        file_path?: string | undefined }, { name: string;
        type: "documentation" | "assessment" | "report" | "certificate";
        completed?: boolean | undefined;
        due_date?: Date | undefined;
        file_path?: string | undefined }>, "many">>;
    resources: z.ZodOptional<z.ZodObject<{ 
        ...
        budget_allocated: z.ZodOptional<z.ZodNumber> }, "strip", z.ZodTypeAny, { personnel_count?: number | undefined;
        tools_required?: string[] | undefined;
        external_vendors?: string[] | undefined;
        budget_allocated?: number | undefined }, { personnel_count?: number | undefined;
        tools_required?: string[] | undefined;
        external_vendors?: string[] | undefined;
    ...
    progress: z.ZodOptional<z.ZodObject<{ 
        ...
        milestones: z.ZodDefault<z.ZodArray<z.ZodObject<{ }
            ...
            completed: boolean;
            due_date: Date;
            completion_date?: Date | undefined }, { name: string;
            due_date: Date;
            completed?: boolean | undefined;
            completion_date?: Date | undefined }>, "many">>;
        notes: z.ZodDefault<z.ZodArray<z.ZodObject<{ 
            timestamp: z.ZodDate;
            author: z.ZodString;
            content: z.ZodString }, "strip", z.ZodTypeAny, { author: string;
            content: string;
            timestamp: Date }, { author: string;
            content: string;
            timestamp: Date }>, "many">>;
    }, "strip", z.ZodTypeAny, { notes: {
            author: string;
            content: string;
            timestamp: Date }[];
        ...
        milestones?: { name: string;
            due_date: Date;
            completed?: boolean | undefined;
            completion_date?: Date | undefined }[] | undefined;
    }>>;
    ...
    prerequisites: { description: string;
        type: "task_completion" | "document_approval" | "system_ready";
        completed: boolean }[];
    ...
    resources?: { personnel_count?: number | undefined;
        tools_required?: string[] | undefined;
        external_vendors?: string[] | undefined;
        budget_allocated?: number | undefined } | undefined;
    reviewer_id?: string | undefined;
    actual_start?: Date | undefined;
    actual_end?: Date | undefined;
    recurrence_config?: { interval?: number | undefined;
        end_date?: Date | undefined;
        max_occurrences?: number | undefined;
        days_of_week?: number[] | undefined;
        day_of_month?: number | undefined;
        month_of_year?: number | undefined } | undefined;
    ...
    resources?: { personnel_count?: number | undefined;
        ...
        external_vendors?: string[] | undefined;
        budget_allocated?: number | undefined } | undefined;
    notifications?: { channels: ("email" | "sms" | "slack" | "dashboard")[];
        timing: NotificationTiming;
        recipients: string[];
        message_template?: string | undefined }[] | undefined;
...
export declare const CalendarViewConfigSchema: z.ZodObject<{ view_type: z.ZodEnum<["month", "week", "day", "agenda", "timeline"]>;
    ...
    }, "strip", z.ZodTypeAny, { compliance_frameworks?: string[] | undefined;
        activity_types?: AuditActivityType[] | undefined;
        priorities?: SchedulePriority[] | undefined;
        statuses?: ScheduleStatus[] | undefined;
        assignees?: string[] | undefined;
        mandatory_only?: boolean | undefined }, { compliance_frameworks?: string[] | undefined;
        activity_types?: AuditActivityType[] | undefined;
        priorities?: SchedulePriority[] | undefined;
        statuses?: ScheduleStatus[] | undefined;
        assignees?: string[] | undefined;
    ...
    display_options: z.ZodOptional<z.ZodObject<{ 
        ...
        group_by: z.ZodDefault<z.ZodEnum<["none", "assignee", "activity_type", "compliance_framework"]>> }, "strip", z.ZodTypeAny, {
...
}, "strip", z.ZodTypeAny, { start_date: Date;
    end_date: Date;
    ...
    filters?: {
        ...
        statuses?: ScheduleStatus[] | undefined;
        assignees?: string[] | undefined;
        mandatory_only?: boolean | undefined } | undefined;
    display_options?: {
        group_by: "none" | "assignee" | "activity_type" | "compliance_framework";
        show_completed: boolean;
        show_cancelled: boolean;
    ...
    filters?: {
        ...
        assignees?: string[] | undefined;
        mandatory_only?: boolean | undefined } | undefined;
    display_options?: { group_by?: "none" | "assignee" | "activity_type" | "compliance_framework" | undefined;
        show_completed?: boolean | undefined;
        show_cancelled?: boolean | undefined;
        color_by?: "priority" | "status" | "assignee" | "activity_type" | undefined } | undefined;
}>;
export type CalendarViewConfig = z.infer<typeof CalendarViewConfigSchema>;
export declare const SchedulingQuerySchema: z.ZodObject<{ start_date: z.ZodOptional<z.ZodDate>;
    end_date: z.ZodOptional<z.ZodDate>;
    activity_types: z.ZodOptional<z.ZodArray<z.ZodNativeEnum<typeof AuditActivityType>, "many">>;
    priorities: z.ZodOptional<z.ZodArray<z.ZodNativeEnum<typeof SchedulePriority>, "many">>;
    statuses: z.ZodOptional<z.ZodArray<z.ZodNativeEnum<typeof ScheduleStatus>, "many">>;
    ...
    limit: z.ZodDefault<z.ZodNumber> }, "strip", z.ZodTypeAny, { limit: number;
    page: number;
    ...
    upcoming_only?: boolean | undefined }, { limit?: number | undefined;
 ...
 */
export declare class AuditCalendarSystem { private schedules;
    ...
    completeSchedule(scheduleId: string, completionData: { )
        ...
        final_report_path?: string }): AuditSchedule;
    /**
     * Generate calendar view data
     */
    generateCalendarView(config: CalendarViewConfig): { events: Array<{
            id: string;
            title: string;
            start: Date;
            end: Date;
    ...
    generateScheduleAnalytics(dateRange: { )
        ...
        timeline_analysis: Array<{ date: string;
            scheduled: number;
            completed: number;
            overdue: number }>;
        resource_utilization: { by_assignee: Record<string, number>;
