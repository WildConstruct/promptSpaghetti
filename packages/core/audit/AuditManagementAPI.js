...
export class AuditManagementAPI {
     ...
     */
    async queryAuditEvents(request) {
        try {
     ...
     */
    async updateAuditEvent(eventId, request) {
        try {
    ...
    async generateComplianceReport(request) {
        try {
            ...
            const report = this.auditSystem.generateComplianceReport(validatedRequest.framework, {
...
export const createAuditEvent = (request) => auditManagementAPI.createAuditEvent(request);
export const queryAuditEvents = (request) => auditManagementAPI.queryAuditEvents(request);
export const generateComplianceReport = (request) => auditManagementAPI.generateComplianceReport(request);
