...
export declare const AuditAnalyticsRequest: z.ZodObject<{
    ...
    metrics: ("event_count" | "unique_users" | "risk_score_average" | "severity_distribution" | "compliance_violations" | "geographic_distribution" | "system_component_activity" | "trend_analysis" | "anomaly_detection")[];
