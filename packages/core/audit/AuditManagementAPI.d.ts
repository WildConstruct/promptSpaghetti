...
export declare const CreateAuditEventRequest: z.ZodObject<{ event_type: z.ZodNativeEnum<typeof AuditEventType>;
    ...
    tags: z.ZodDefault<z.ZodArray<z.ZodString, "many">> }, "strip", z.ZodTypeAny, { description: string;
    category: string;
    tags: string[];
    title: string;
    ...
    data_volume?: number | undefined }, { description: string;
    category: string;
    title: string;
    severity: AuditSeverity;
    event_type: AuditEventType;
...
export declare const AuditQueryRequest: z.ZodObject<{ page: z.ZodDefault<z.ZodNumber>;
    ...
    regulatory_impact_only: z.ZodOptional<z.ZodBoolean> }, "strip", z.ZodTypeAny, { limit: number;
    page: number;
    sort_field: string;
    sort_order: "asc" | "desc";
    ...
    regulatory_impact_only?: boolean | undefined }, { search?: string | undefined;
...
export declare const ComplianceReportRequest: z.ZodObject<{ framework: z.ZodNativeEnum<typeof ComplianceFramework>;
    start_date: z.ZodString;
    end_date: z.ZodString;
    include_details: z.ZodDefault<z.ZodBoolean>;
    export_format: z.ZodDefault<z.ZodEnum<["json", "pdf", "csv"]>> }, "strip", z.ZodTypeAny, {
    start_date: string;
    end_date: string;
...
export declare const AuditAnalyticsRequest: z.ZodObject<{ timeframe: z.ZodEnum<["hour", "day", "week", "month", "year"]>;
    start_date: z.ZodOptional<z.ZodString>;
    end_date: z.ZodOptional<z.ZodString>;
    ...
    filters: z.ZodOptional<z.ZodObject<{ }
        ...
        sensitive_data_only?: boolean | undefined;
        regulatory_impact_only?: boolean | undefined }>>;
}, "strip", z.ZodTypeAny, { metrics: ("anomaly_detection" | "trend_analysis" | "event_count" | "unique_users" | "risk_score_average" | "severity_distribution" | "compliance_violations" | "geographic_distribution" | "system_component_activity")[];
    ...
    filters?: {
        ...
        has_metadata?: boolean | undefined;
        sensitive_data_only?: boolean | undefined;
        regulatory_impact_only?: boolean | undefined } | undefined;
    start_date?: string | undefined;
    end_date?: string | undefined;
...
export declare const UpdateAuditEventRequest: z.ZodObject<{ status: z.ZodOptional<z.ZodNativeEnum<typeof AuditStatus>>;
    resolution_notes: z.ZodOptional<z.ZodString>;
    tags: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    metadata: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>> }, "strip", z.ZodTypeAny, { status?: AuditStatus | undefined;
    tags?: string[] | undefined;
    metadata?: Record<string, unknown> | undefined;
    resolution_notes?: string | undefined }, { status?: AuditStatus | undefined;
    tags?: string[] | undefined;
    metadata?: Record<string, unknown> | undefined;
 ...
 */
export declare class AuditManagementAPI { private auditSystem;
    /**
     ...
     */
    queryAuditEvents(request: AuditQueryRequestType): Promise<{ success: boolean;
        data?: unknown;
        error?: string }>;
    /**
     ...
     */
    getAuditEvent(eventId: string): Promise<{ success: boolean;
        event?: AuditEvent;
        error?: string }>;
    /**
     ...
     */
    updateAuditEvent(eventId: string, request: UpdateAuditEventRequestType): Promise<{ success: boolean;
        event?: AuditEvent;
        error?: string }>;
    /**
     ...
     */
    generateComplianceReport(request: ComplianceReportRequestType): Promise<{ success: boolean;
        report?: any;
        download_url?: string;
        error?: string }>;
    /**
     ...
     */
    generateAnalytics(request: AuditAnalyticsRequestType): Promise<{ success: boolean;
        analytics?: any;
        error?: string }>;
    /**
     ...
     */
    detectAnomalies(timeWindow?: number): Promise<{ success: boolean;
        patterns?: any[];
        error?: string }>;
    /**
     ...
     */
    getSystemHealth(): Promise<{ success: boolean;
        health?: any;
        error?: string }>;
    /**
     * Export audit data
    ...
    exportAuditData(request: { )
        ...
        include_metadata?: boolean }): Promise<{ success: boolean;
        download_url?: string;
        error?: string }>;
...
export declare const queryAuditEvents: (request: AuditQueryRequestType) => Promise<{ success: boolean;
    data?: unknown;
    error?: string }>;
export declare const generateComplianceReport: (request: ComplianceReportRequestType) => Promise<{ success: boolean;
    report?: any;
    download_url?: string;
    error?: string }>;
