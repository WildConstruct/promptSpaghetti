...
export class RunwayMLAdapter extends BaseAIModel {
    ...
    async generateTextToVideo(prompt, duration = 4, options) {
        const runwayOptions = {
            text_prompt: prompt,
            duration,
            mode: 'text_to_video',
    ...
    async generateImageToVideo(prompt, imageData, duration = 4, options) {
        const runwayOptions = {
            text_prompt: prompt,
    ...
    async generateVideoToVideo(prompt, videoData, options) {
        const runwayOptions = {
            text_prompt: prompt,
    ...
    async _processGenerationResult(task, prompt, options, generationTime) {
    ...
    async _makeRequest(endpoint, method = 'GET', payload) {
