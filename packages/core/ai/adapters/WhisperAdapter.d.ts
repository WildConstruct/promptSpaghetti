...
export declare class WhisperAdapter extends BaseAIModel {
    ...
    process(input: any, options?: WhisperRequestOptions): Promise<WhisperTranscriptionResult>;
    cleanup(): Promise<void>;
    estimate(input: any, options?: WhisperRequestOptions): Promise<CostEstimate>;
