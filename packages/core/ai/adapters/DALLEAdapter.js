...
export class DALLEAdapter extends BaseAIModel {
    ...
    async editImage(imageUrl, maskUrl, prompt, options) {
    ...
    static getModelCostPerRequest(modelName) {
        const costs = {
    ...
    _processImageResponse(response, optimization, payload, generationTime) {
