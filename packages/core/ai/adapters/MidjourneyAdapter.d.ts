...
export declare class MidjourneyAdapter extends BaseAIModel {
    ...
    process(input: any, options?: MidjourneyRequestOptions): Promise<MidjourneyGenerationResult>;
    cleanup(): Promise<void>;
    estimate(input: any, options?: MidjourneyRequestOptions): Promise<CostEstimate>;
