...
export interface ImprovementSuggestion { suggestion_id: string;
    ...
    expected_impact: { quality_improvement: number;
...
export interface ComplianceStatus { overall_compliant: boolean;
    ...
    regulatory_compliance: { data_protection: boolean;
        consumer_protection: boolean;
        advertising_standards: boolean;
        content_labeling: boolean };
    platform_standards: { quality_thresholds: boolean;
...
export interface SafetyAssessment { overall_safe: boolean;
    ...
    user_safety: { privacy_risk: number;
        security_risk: number;
        financial_risk: number;
        reputation_risk: number };
    community_safety: { disruption_potential: number;
...
export interface MarketplaceContentFilteringService { filterContent(request: ContentFilteringRequest): Promise<ContentFilteringResult>;
...
export interface QualityDistribution { excellent: number;
    good: number;
    average: number;
    poor: number;
    unacceptable: number }
