...
export interface ContentSafetyRequest { id: string;
    ...
    submission_context: { submitter_id: string;
    ...
    safety_config: { enable_filtering: boolean;
...
export interface AttachmentScanResult { virus_scan_clean: boolean;
    ...
    metadata_analysis: { personal_data_detected: boolean;
...
export interface SafetyAssessment { content_safety: {
    ...
    quality_safety: { accuracy_score: number;
        completeness_score: number;
        clarity_score: number;
        usefulness_score: number;
        originality_score: number };
    technical_safety: { security_score: number;
        privacy_score: number;
        accessibility_score: number;
        performance_score: number;
        compatibility_score: number };
    business_safety: { brand_alignment_score: number;
        legal_compliance_score: number;
        competitive_risk_score: number;
        revenue_protection_score: number };
    community_safety: { community_standards_score: number;
...
export interface BusinessImpactAssessment { revenue_impact: number;
    brand_impact: number;
...
export interface ContentSafetyService { processContentSafety(request: ContentSafetyRequest): Promise<ContentSafetyResult>;
