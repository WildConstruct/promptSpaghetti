...
export interface ContributionEngagement { total_views: number;
    unique_views: number;
    ...
    feedback_summary: { positive_feedback: string[];
...
export interface MonetizationConfiguration { monetization_enabled: boolean;
    ...
    revenue_sharing: { contributor_percentage: number;
...
export interface DetailedFeedback { content_quality: {
        accuracy: number;
        clarity: number;
        completeness: number;
        usefulness: number;
    ...
    technical_quality: { formatting: number;
        code_quality?: number;
        accessibility: number;
        seo_optimization: number };
    feedback_areas: FeedbackArea[];
    suggestions: { high_priority: string[];
        medium_priority: string[];
        low_priority: string[];
        nice_to_have: string[] };
    issues_found: { factual_errors: string[];
...
export interface FeedbackArea { section: string;
    line_number?: number;
...
export interface NotificationConfiguration { notify_contributors: boolean;
    ...
    timing: { immediate: boolean;
        daily_digest: boolean;
        weekly_summary: boolean;
        milestone_only: boolean };
    notification_types: { status_changes: boolean;
...
export interface ContributionRepository { submitContribution(submission: Omit<ContributionSubmission, 'id' | 'created_at' | 'updated_at'>): Promise<ContributionSubmission>;
...
export interface ContributionSystemMetrics { time_period: string;
    ...
    common_quality_issues: Array<{ issue_type: string;
        frequency: number;
        impact: string }>;
    publication_rate: number;
    featured_content_rate: number;
    content_longevity: number;
    community_participation: { active_contributors: number;
        active_reviewers: number;
        community_feedback_volume: number;
        collaboration_rate: number };
    processing_efficiency: { automated_approval_rate: number;
        quality_gate_pass_rate: number;
        escalation_rate: number;
        reviewer_workload_balance: number };

export declare const CONTRIBUTION_WORKFLOW_TEMPLATES: { readonly trusted_contributor: {
        readonly stages: readonly ["submission", "quality_check", "final_approval", "publication"];
        readonly quality_gates: readonly ["automated_quality", "plagiarism_check"];
        readonly review_requirements: {
            readonly min_reviewers: 1;
            readonly specialist_required: false };
        readonly auto_publish_threshold: 85;
    };
    readonly standard: { readonly stages: readonly ["submission", "intake_review", "quality_check", "editorial_review", "final_approval", "publication"];
        readonly quality_gates: readonly ["automated_quality", "editorial_review", "technical_review"];
        readonly review_requirements: {
            readonly min_reviewers: 2;
            readonly specialist_required: false };
        readonly auto_publish_threshold: 90;
    };
    readonly comprehensive: { readonly stages: readonly ["submission", "intake_review", "quality_check", "editorial_review", "technical_review", "community_review", "final_approval", "publication"];
        readonly quality_gates: readonly ["automated_quality", "editorial_review", "technical_review", "community_consensus"];
        readonly review_requirements: {
            readonly min_reviewers: 3;
            readonly specialist_required: true };
        readonly auto_publish_threshold: 95;
    };
    readonly express: { readonly stages: readonly ["submission", "quality_check", "editorial_review", "publication"];
...
export declare const QUALITY_GATE_PRESETS: { readonly automated_basic: {
        readonly minimum_score: 70;
        readonly required_checks: readonly ["grammar", "spelling", "readability"];
        readonly blocking_issues: readonly ["plagiarism_detected", "policy_violation"];
        readonly automated_thresholds: {
            readonly grammar_score: 80;
            readonly plagiarism_similarity: 15;
            readonly readability_score: 70 };
    };
    readonly automated_comprehensive: { readonly minimum_score: 80;
        readonly required_checks: readonly ["grammar", "spelling", "readability", "seo", "accessibility"];
        readonly blocking_issues: readonly ["plagiarism_detected", "policy_violation", "accessibility_violation"];
        readonly automated_thresholds: {
            readonly grammar_score: 85;
            readonly plagiarism_similarity: 10;
            readonly readability_score: 75;
            readonly seo_score: 70;
            readonly accessibility_score: 80 };
    };
    readonly editorial_standard: { readonly minimum_score: 75;
        readonly required_checks: readonly ["content_accuracy", "style_consistency", "target_audience"];
        readonly reviewer_consensus: 75;
        readonly automated_thresholds: {
