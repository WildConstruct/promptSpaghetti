...
export class OptimizedSerializer {
     ...
     */
    async serialize(projectData, options = { format: 'json' }) {
     ...
     */
    async serializeIncremental(projectData, projectId, options = { format: 'json', incremental: true }) {
    ...
    async serializeToJSON(projectData, options) {
    ...
    async serializeToBinary(projectData, options) {
    ...
    async serializeCompressed(projectData, options) {
        ...
        const compressed = await this.compressString(jsonResult.data, options.compression || 'gzip');
        return {
            data: compressed,
    ...
    async compressString(data, algorithm) {
