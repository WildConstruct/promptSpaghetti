...
export interface IAdminUserService { getUsers(): Promise<AdminUser>;
...
export interface ISecurityService { getSecurityAlerts(): Promise<SecurityAlert>;
...
export interface IApiManagementService { getApiKeys(): Promise<ApiKey>;
...
export interface ISystemMonitoringService { getSystemMetrics(): Promise<SystemMetrics>;
...
export interface IDashboardConfigService { getLayouts(): Promise<DashboardLayout>;
...
export interface IAdminDashboardDomain { // React Components
  components: {;
...
export const ADMIN_DOMAIN_EVENTS = { DASHBOARD_LOADED: 'admin:dashboard:loaded'
