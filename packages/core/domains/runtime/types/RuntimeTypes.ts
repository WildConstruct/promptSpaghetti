...
// Re-export existing runtime types
export * from '../../../runtime';
...
export interface RuntimeDomainState { executionQueue: ExecutionTask;
...
export interface ExecutionTask { id: string;
  graphId: string;
  graph: Graph;
  seeds: number;
...
export interface ExecutionInstance { taskId: string;
  executionId: string;
...
export interface ExecutionOptions { maxExecutionTime?: number;
...
export interface ExecutionError { nodeId: string;
  type: ErrorType;
  message: string;
  details?: any;
  timestamp: Date;
...
export interface ExecutionWarning { nodeId: string;
  type: WarningType;
  message: string;
  details?: any;
  timestamp: Date }
...
export type ErrorType = 
  ...
  | 'memory_error' | 'network_error' | 'security_error' | 'configuration_error';
...
export interface ExecutionMetrics { totalTime: number;
...
export interface ExecutionRecord { id: string;
  taskId: string;
  graphId: string;
  seed: number;
  result: any;
...
export interface RuntimeMetrics { totalExecutions: number;
...
export interface MemoryMetrics { currentUsage: number;
  peakUsage: number;
  averageUsage: number;
...
export interface PerformanceMetrics { executionsPerSecond: number;
...
export interface NodeDefinition { type: string;
...
export interface IOSpecification { name: string;
  type: IOType;
  description: string;
  required: boolean;
  defaultValue?: any;
...
export interface PropertySpecification { name: string;
  type: PropertyType;
  description: string;
  required: boolean;
  defaultValue?: any;
...
export interface PropertyOption { value: any;
  label: string;
  description?: string;
  disabled?: boolean }
...
export interface UISpecification { component?: string;
...
export interface LayoutSpec { width?: number | string;
...
export interface ConditionalSpec { property: string;
  operator: 'equals' | 'not_equals' | 'in' | 'not_in';
  value: any }



export interface NodeImplementation { execute: (inputs: any, context: ExecutionContext, node: Node) => Promise<any>;
...
export interface ValidationSpecification { inputValidation: ValidationRule;
...
export interface ValidationRule { type: ValidationType;
...
export interface CrossValidationRule { name: string;
  inputs: string;
...
export interface PerformanceSpecification { expectedExecutionTime: number;
  memoryUsage: number;
...
export interface SecuritySpecification { requiresElevatedPermissions: boolean;
...
export interface RuntimeConfig { execution: ExecutionConfig;
...
export interface ExecutionConfig { maxConcurrentExecutions: number;
...
export interface PerformanceConfig { enableCaching: boolean;
  cacheSize: number;
  cacheTTL: number;
...
export interface RuntimeSecurityConfig { sandboxExecution: boolean;
...
export interface PerformanceThresholds { maxExecutionTime: number;
  maxMemoryUsage: number;
  maxErrorRate: number;
...
export interface RuntimeDomainEvents { onExecutionStarted: (task: ExecutionTask) => void
...
export interface RuntimeDashboardProps { showMetrics?: boolean;
  showQueue?: boolean;
  showHistory?: boolean;
...
export interface ExecutionQueueProps { maxItems?: number;
...
export type { ExecutionContext
  ...
  NodeOutput 
 from '../../../runtime';
export type { AdvancedRuntimeNode
