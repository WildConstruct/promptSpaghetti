...
export interface LLMRandomizerWorkflow { // 1. Generate graph using LLM agent
...
export class LLMRandomizerSystem implements LLMRandomizerWorkflow {
  ...
  private normalizeParameters(request: any, provider: string): any { // Convert various request formats to RandomizerParameters
