...
import { ParameterValidator, defaultPresets } from '../parameters/parameter-schema';
import { RandomizerWorkflow } from '../workflow/randomizer-workflow';
describe('Epic 12 - Randomizer Generator System', () => {
    describe('ParameterValidator', () => {
        ...
        test('should provide appropriate warnings', () => {
            const parameters = {
        ...
        test('should suggest temperature based on style', () => {
            const parameters = {
                style: 'creative'
            };
            const suggestions = ParameterValidator.getSuggestions(parameters);
    ...
    describe('ParameterManager', () => {
        ...
        test('should organize presets by category', () => {
            const byCategory = manager.getPresetsByCategory();
        ...
        test('should create custom presets', () => {
            ...
            const preset = manager.createPreset('Test Preset', 'Test description', 'Testing', parameters, ['test']);
        ...
        test('should manage parameter history', () => {
            const parameters = {
        ...
        test('should find similar parameters in history', () => {
            const baseParams = {
    ...
    describe('RandomizerWorkflow', () => {
        ...
        test('should detect invalid workflow parameters', () => {
            const invalidParams = {
                purpose: 'Short', // Too short
                complexity: 'simple',
                nodeCount: 150, // Too high
        ...
        test('should create parameter variations', async () => {
            const baseParams = {
            ...
            const variations = workflow.createParameterVariations(baseParams, 3);
            expect(variations).toHaveLength(3);
            expect(variations.every((v) => v.purpose === baseParams.purpose)).toBe(true);
            expect(variations.some((v) => v.temperature !== baseParams.temperature)).toBe(true);
        });
        // Note: Full workflow testing would require mocking LLM services
        test('should prepare LLM request correctly', () => {
            const parameters = {
            ...
            const llmRequest = workflow.prepareLoLLMRequest(parameters);
