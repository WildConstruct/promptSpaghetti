 ...
 */
import { SessionPriorityManager, SessionPriority, EvictionPolicy, ConflictResolution } from '../SessionPriorityManager';
describe('SessionPriorityManager', () => {
    ...
    describe('Session Registration', () => {
        test('should register session successfully', () => {
            ...
            const result = manager.registerSession('session-1', 'user-1', 'device-1', SessionPriority.MEDIUM, factors);
