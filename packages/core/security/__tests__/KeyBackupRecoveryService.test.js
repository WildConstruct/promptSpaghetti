 ...
 */
import { KeyBackupRecoveryService, BackupType, RecoveryType, BackupStatus, RecoveryStatus, BackupStorageTier } from '../KeyBackupRecoveryService';
...
describe('KeyBackupRecoveryService', () => {
    ...
    describe('Backup Creation', () => {
        ...
        test('should handle backup creation errors', async () => {
            ...
            const invalidService = new KeyBackupRecoveryService(null, // Invalid key management service
            testConfig);
