 ...
 */
import { DeviceFingerprintingService, FingerprintType, RiskLevel, DeviceType } from '../DeviceFingerprintingService';
describe('DeviceFingerprintingService', () => {
    ...
    describe('Data Management', () => {
        ...
        test('should handle multiple concurrent fingerprint generations', async () => {
            ...
            const promises = contexts.map(context => service.generateFingerprint(context));
