...
describe('SecurityAlertingConfigurationUI', () => {
    ...
    describe('Rendering', () => {
        it('renders the main configuration interface', () => {
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks }));
        ...
        it('displays user role badge correctly', () => {
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "security_admin", complianceFrameworks: mockComplianceFrameworks }));
    ...
    describe('Validation', () => {
        ...
        it('displays validation results', async () => {
            ...
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: {
                    ...mockConfig,
                    enableRealTimeAnalytics: false
                }, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks }));
            // Trigger validation
    ...
    describe('Read-Only Mode', () => {
        it('disables all inputs when readOnly is true', () => {
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "security_analyst", complianceFrameworks: mockComplianceFrameworks, readOnly: true }));
    ...
    describe('Advanced Settings', () => {
        it('hides advanced settings when allowAdvancedSettings is false', () => {
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "security_analyst", complianceFrameworks: mockComplianceFrameworks, allowAdvancedSettings: false }));
        ...
        it('enables advanced settings when allowAdvancedSettings is true', () => {
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks, allowAdvancedSettings: true }));
            const mlCheckbox = screen.getByLabelText('Enable Machine Learning Analysis');
    ...
    describe('Theme Support', () => {
        it('applies cinema theme styles correctly', () => {
            const { container } = render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks, theme: "cinema" }));
        ...
        it('applies light theme styles correctly', () => {
            const { container } = render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks, theme: "light" }));
            const mainDiv = container.firstChild;
            expect(mainDiv).toHaveStyle('background: #ffffff');
        });
        it('applies dark theme styles correctly', () => {
            const { container } = render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks, theme: "dark" }));
            const mainDiv = container.firstChild;
    ...
    describe('Loading States', () => {
        it('shows validation loading state', async () => {
            ...
            mockOnValidateConfig.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve(mockValidationResult), 1000)));
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks }));
            const validateButton = screen.getByText('🔍 Validate Configuration');
        ...
        it('shows saving loading state', async () => {
            const user = userEvent.setup();
            // Mock slow save
            mockOnConfigChange.mockImplementation(() => new Promise(resolve => setTimeout(resolve, 1000)));
            render(_jsx(SecurityAlertingConfigurationUI, { currentConfig: mockConfig, onConfigChange: mockOnConfigChange, onValidateConfig: mockOnValidateConfig, userRole: "admin", complianceFrameworks: mockComplianceFrameworks }));
