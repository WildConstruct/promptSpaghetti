...
import { SecurityEventLoggingPolicyEngine, SecurityEventType, SecurityEventSeverity, SecurityEventStatus, ComplianceFramework, securityEventPolicyEngine, processSecurityEvent, registerSecurityPolicy, generateSecurityComplianceReport } from '../SecurityEventLoggingPolicies';
describe('SecurityEventLoggingPolicyEngine', () => {
    ...
    describe('Compliance Reporting', () => {
        ...
        it('should generate SOX compliance report', () => {
            const report = policyEngine.generateComplianceReport(ComplianceFramework.SOX, new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), // 7 days ago
            new Date());
        ...
        it('should generate GDPR compliance report', () => {
            const report = policyEngine.generateComplianceReport(ComplianceFramework.GDPR, new Date(Date.now() - 24 * 60 * 60 * 1000), // 1 day ago
            new Date());
        ...
        it('should provide appropriate recommendations', () => {
            const report = policyEngine.generateComplianceReport(ComplianceFramework.SOX, new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), new Date());
    ...
    describe('Integration with Utility Functions', () => {
        ...
        it('should work with compliance report generation utility', () => {
            const report = generateSecurityComplianceReport(ComplianceFramework.NIST, new Date(Date.now() - 24 * 60 * 60 * 1000), new Date());
    ...
    describe('Event Type Coverage', () => {
        it('should have policies for all critical event types', () => {
            ...
            for (const eventType of criticalEventTypes) {
                const hasPolicy = policies.some(policy => policy.event_types.includes(eventType));
    ...
    describe('Compliance Framework Coverage', () => {
        it('should support all major compliance frameworks', () => {
            ...
            for (const framework of supportedFrameworks) {
                const report = generateSecurityComplianceReport(framework, new Date(Date.now() - 24 * 60 * 60 * 1000), new Date());
