 ...
 */
import { DataProtectionEventLogger, DataProtectionEventType, DataSensitivityLevel, ComplianceFramework } from '../DataProtectionEventLogger';
...
describe('DataProtectionEventLogger', () => {
    ...
    describe('logDataProtectionEvent', () => {
        it('should log a data protection event successfully', async () => {
            ...
            expect(mockSecurityLogger.log).toHaveBeenCalledWith(expect.objectContaining({
            ...
            expect(mockAuditLogger.logEvent).toHaveBeenCalledWith(expect.objectContaining({
                userId: 'user-456',
                action: DataProtectionEventType.DATA_SUBJECT_ACCESS,
                resourceType: 'user_profile',
                resourceId: 'profile-123',
    ...
    describe('generateComplianceReport', () => {
        ...
        it('should generate GDPR compliance report', async () => {
            ...
            const report = await logger.generateComplianceReport(ComplianceFramework.GDPR, startDate, endDate);
        ...
        it('should generate CCPA compliance report', async () => {
            const startDate = new Date('2024-01-01');
            const endDate = new Date('2024-01-31');
            const report = await logger.generateComplianceReport(ComplianceFramework.CCPA, startDate, endDate);
        ...
        it('should calculate retention compliance metrics', async () => {
            ...
            const report = await logger.generateComplianceReport(ComplianceFramework.GDPR, new Date('2020-01-01'), new Date('2024-01-31'));
    ...
    describe('Event Validation', () => {
        ...
        it('should validate missing resource information', async () => {
            const invalidEvent = { ...mockDataProtectionEvent };
            delete invalidEvent.resourceType;
            await expect(logger.logDataProtectionEvent(invalidEvent))
