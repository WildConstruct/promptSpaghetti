 ...
 */
import { DeviceVerificationService,
  VerificationStep,
  ChallengeType,
  VerificationOutcome,
...
describe('DeviceVerificationService', () => { let service: DeviceVerificationService;
 ...
 as any as unknown as unknown as unknown as unknown);
    mockEmailTracker.sendEmail.mockResolvedValue('email-123' as unknown as unknown as unknown as unknown);
  ...
  challengeRequirements: { [RiskLevel.LOW]: [ChallengeType.EMAIL_CODE]
  ...
  describe('Verification Flow Start', () => { test('should start verification with low risk device', async () => {
  ...
  deviceName: 'Test Device' }
    ...
    test('should start verification with high risk device', async () => { // Mock high risk assessment
  mockFingerprintService.assessRisk.mockReturnValue({)
  deviceId: testFingerprint.id
  ...
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should emit verificationStarted event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  riskScore: 15 }
    ...
    test('should handle fingerprint service errors', async () => { mockFingerprintService.generateFingerprint.mockRejectedValue(new Error('Fingerprint error'));
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  ...
  describe('Challenge Handling', () => { let session: VerificationSession;
  beforeEach(async () => {
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  ...
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should submit valid email code challenge', async () => { const challenge = session.challenges.find(c => c.type === ChallengeType.EMAIL_CODE)!;
    ...
    test('should reject invalid challenge response', async () => { const challenge = session.challenges.find(c => c.type === ChallengeType.EMAIL_CODE)!;
      const result = await service.submitChallengeResponse(;);
        session.id
        challenge.id }
        'wrong-code'
    ...
    test('should fail challenge after max attempts', async () => { const challenge = session.challenges.find(c => c.type === ChallengeType.EMAIL_CODE)!;
    ...
    test('should emit challengeCompleted event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  userId: testUserId }
    ...
    test('should emit challengeFailed event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  attemptsRemaining: 2 }
    ...
    test('should handle challenge not found', async () => { await expect()
        service.submitChallengeResponse(session.id, 'invalid-challenge-id', '123456')
      ).rejects.toThrow('Challenge not found') });
    test('should handle expired session', async () => { // Fast forward past session expiration
  ...
  describe('Session Management', () => { test('should get verification session', async () => {
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should return null for non-existent session', () => { const session = service.getSession('non-existent-id');
  ...
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should cancel verification session', async () => { const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should emit verificationCancelled event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  describe('Admin Override', () => { test('should approve verification via admin override', async () => {
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should reject verification via admin override', async () => { const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should emit adminOverride event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  describe('Risk Assessment and Security Flags', () => { test('should detect VPN usage', async () => {
  ...
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should detect device spoofing', async () => { const spoofedContext: FingerprintContext = {
  ...testContext
  userAgent: 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) HeadlessChrome/91.0.4472.101 Safari/537.36' }
};
      const spoofedFingerprint: DeviceFingerprint = { ...testFingerprint
  basic: {
  ...testFingerprint.basic
  userAgent: spoofedContext.userAgent }
};
      mockFingerprintService.generateFingerprint.mockResolvedValue(spoofedFingerprint as unknown as unknown as unknown as unknown);
      const request: DeviceVerificationRequestData = { 
  userId: testUserId
  ...
  describe('Manual Review Process', () => { test('should require manual review for critical risk', async () => {
  ...
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should emit manualReviewRequired event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  describe('Device Registration', () => { test('should register trusted device on successful verification', async () => {
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  location: testLocation
  ...
  verificationMethod: VerificationMethod.EMAIL }
    ...
    test('should auto-verify registered device', async () => { const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should emit verificationCompleted event', async () => { const eventHandler = jest.fn<unknown, unknown>();
  ...
  describe('Cleanup and Maintenance', () => { test('should clean up expired sessions', async () => {
  ...
  userId: testUserId }
    ...
    test('should remove old completed sessions', async () => { const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
  ...
  describe('Error Handling', () => { test('should handle verification code generation failure', async () => {
  mockVerificationCodeManager.generateCode.mockResolvedValue(null as unknown as unknown as unknown as unknown);
  const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
    ...
    test('should handle device registration errors', async () => { const errorHandler = jest.fn<unknown, unknown>();
  ...
  error: 'Registration failed' }
    ...
    test('should handle session not found errors', async () => { await expect()
        service.submitChallengeResponse('invalid-session-id', 'challenge-id', 'response')
      ).rejects.toThrow('Verification session not found') });
    test('should handle completed session submission', async () => { const request: DeviceVerificationRequestData = {
  userId: testUserId
  fingerprintContext: testContext
  verificationMethod: VerificationMethod.EMAIL
  requestedTrustLevel: TrustLevel.FULL }
