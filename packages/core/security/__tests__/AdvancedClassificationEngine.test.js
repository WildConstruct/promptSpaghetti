 ...
 */
import { AdvancedClassificationEngine } from '../AdvancedClassificationEngine';
import { ClassificationLevel, DataCategory, ComplianceFramework } from '../DataClassifier';
describe('AdvancedClassificationEngine', () => {
    let engine;
    ...
    describe('Enhanced Classification', () => {
        test('should perform enhanced classification with context', async () => {
        ...
        test('should apply ML model predictions', async () => {
            const result = await engine.classifyWithContext(testDataElement, testContext);
        ...
        test('should analyze contextual factors', async () => {
            ...
            expect(result.contextualFactors).toContainEqual(expect.objectContaining({
        ...
        test('should determine review requirements', async () => {
            const sensitiveData = {
                ...testDataElement,
        ...
        test('should generate appropriate remediation actions', async () => {
            const result = await engine.classifyWithContext(testDataElement, testContext);
    ...
    describe('ML Model Management', () => {
        ...
        test('should train ML models', async () => {
            const eventHandler = jest.fn();
        ...
        test('should handle training non-existent models', async () => {
            ...
            await expect(engine.trainMLModel('non-existent-model', trainingData)).rejects.toThrow('ML model not found: non-existent-model');
        });
    });
    describe('Workflow Management', () => {
        test('should add classification workflows', () => {
            const eventHandler = jest.fn();
        ...
        test('should execute workflows based on triggers', async () => {
            ...
            expect(notificationHandler).toHaveBeenCalledWith(expect.objectContaining({
                recipient: 'security-team',
                subject: expect.stringContaining('Classification Alert'),
                priority: 'medium'
            }));
        });
        test('should execute workflows manually', async () => {
            ...
            expect(workflowHandler).toHaveBeenCalledWith(expect.objectContaining({
        ...
        test('should handle workflow execution errors', async () => {
            ...
            const invalidWorkflow = {
                ...
                triggers: [],
                actions: [{ type: 'invalid_action', parameters: {}, timeout: 5000 }],
                conditions: [],
                enabled: true,
                priority: 1
            };
    ...
    describe('Analytics and Reporting', () => {
        test('should track classification analytics', async () => {
        ...
        test('should generate compliance reports', async () => {
            await engine.classifyWithContext(testDataElement, testContext);
            const report = engine.generateComplianceReport(ComplianceFramework.GDPR, {
    ...
    describe('Error Handling', () => {
        ...
        test('should handle stream element errors', async () => {
            const errorHandler = jest.fn();
    ...
    describe('Event Emission', () => {
        test('should emit enhanced classification complete events', async () => {
            const eventHandler = jest.fn();
        ...
        test('should emit workflow-related events', async () => {
            const notificationHandler = jest.fn();
        ...
        test('should emit analytics update events', async () => {
