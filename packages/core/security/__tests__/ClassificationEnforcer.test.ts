...
describe('ClassificationEnforcer', () => { let enforcer: ClassificationEnforcer;
  ...
  describe('Constructor and Configuration', () => { it('should create enforcer with default configuration', () => {
      const enforcer = new ClassificationEnforcer();
      expect(enforcer).toBeInstanceOf(ClassificationEnforcer) });
    it('should create enforcer with custom configuration', () => { const config: Partial<ClassificationEnforcementConfig> = {
  strictMode: true
  ...
  gracePeriodDays: 0 }
    ...
    it('should create enforcers with different presets', () => { const devEnforcer = createClassificationEnforcer('development');
  ...
  describe('enforceClassification', () => { const baseOperation: OperationContext = {
  operation: 'read'
  userId: 'user123'
  ...
  requestId: 'req789' }
    ...
    it('should allow PUBLIC data access with minimal controls', async () => { const result = await enforcer.enforceClassification(;);
        'PUBLIC'
        baseOperation }
    ...
    it('should enforce INTERNAL data requirements', async () => { const result = await enforcer.enforceClassification(;);
        'INTERNAL'
        baseOperation }
        ['auth-standard']
      );
    ...
    it('should enforce CONFIDENTIAL data requirements', async () => { const result = await enforcer.enforceClassification(;);
        'CONFIDENTIAL'
        baseOperation }
        ['auth-mfa']
      );
    ...
    it('should enforce RESTRICTED data requirements strictly', async () => { const result = await enforcer.enforceClassification(;);
  'RESTRICTED'
  baseOperation }
  ['auth-standard']
  );
  ...
  expect(result.riskScore).toBeGreaterThan(70);
    ...
    it('should validate write operations require encryption', async () => { const writeOperation: OperationContext = {
  ...baseOperation
  operation: 'write' }
};
    ...
    it('should validate export operations', async () => { const exportOperation: OperationContext = {
  ...baseOperation
  operation: 'export' }
};
      const result = await enforcer.enforceClassification(;);
    ...
    it('should validate share operations', async () => { const shareOperation: OperationContext = {
  ...baseOperation
  operation: 'share' }
};
      const result = await enforcer.enforceClassification(;);
    ...
    it('should check environment restrictions', async () => { const devOperation: OperationContext = {
  ...baseOperation
  environment: 'development' }
    ...
    it('should allow operations in grace period', async () => { const gracePeriodEnforcer = new ClassificationEnforcer({)
  gracePeriodDays: 30
  blockViolations: true }
});
    ...
    it('should block operations in strict mode', async () => { const strictEnforcer = new ClassificationEnforcer({)
  strictMode: true }
});
    ...
    it('should handle exempted users', async () => { const exemptedEnforcer = new ClassificationEnforcer({)
  exemptions: {
  users: ['user123'] }
});
    ...
    it('should apply policy overrides', async () => { const overrideEnforcer = new ClassificationEnforcer({)
  ...
  exportRestrictions: false }
    ...
    it('should calculate risk scores appropriately', async () => { const publicResult = await enforcer.enforceClassification(;);
        'PUBLIC'
        baseOperation
        ['auth-standard', 'audit-standard']
      );
    ...
    it('should generate audit IDs', async () => { const result1 = await enforcer.enforceClassification(;);
        'INTERNAL'
        baseOperation
        []
      );
    ...
    it('should provide recommendations for violations', async () => { const result = await enforcer.enforceClassification(;);
        'CONFIDENTIAL'
        baseOperation }
        []
      );
    ...
    it('should handle enforcement errors gracefully', async () => { // Create operation that might cause internal errors
  ...
  describe('makeAccessDecision', () => { it('should grant access for properly authenticated users', async () => {
  ...
  expect(decision.expiresAt).toBeDefined();
    ...
    it('should deny access for insufficient authentication', async () => { const decision = await enforcer.makeAccessDecision(;);
        'user123'
        'data456'
        'RESTRICTED' }
        'read');
    ...
    it('should check time restrictions for sensitive operations', async () => { // Set time to outside business hours
  ...
  expect(decision.reason).toBe('Operation not allowed outside business hours');
    ...
    it('should check weekend restrictions', async () => { // Set time to Saturday
  ...
  expect(decision.reason).toBe('Operation not allowed on weekends');
    ...
    it('should check purpose limitations', async () => { const decision = await enforcer.makeAccessDecision(;);
  'user123'
  'data456'
  'RESTRICTED'
  'read' }
  ...
  expect(decision.reason).toBe('Purpose not allowed for this classification') });
    it('should set appropriate access expiration', async () => { const publicDecision = await enforcer.makeAccessDecision(;);
  'user123'
  'data456'
  'PUBLIC'
  'read');
  ...
  expect(restrictedExpiration).toBe(4 * 60 * 60 * 1000) });
    it('should include appropriate access conditions', async () => { const decision = await enforcer.makeAccessDecision(;);
  'user123'
  'data456'
  'RESTRICTED'
  'read' }
  ...
  describe('validateOperation', () => { const baseOperation: OperationContext = {
  operation: 'read'
  userId: 'user123'
  sessionId: 'session456'
  purpose: 'business'
  ...
  requestId: 'req789' }
    ...
    it('should validate read operations', async () => { const result = await enforcer.validateOperation(;);
        baseOperation
        'CONFIDENTIAL' }
        { id: 'data123' }
      );
    ...
    it('should validate write operations require encryption', async () => { const writeOp: OperationContext = {
  ...baseOperation
  operation: 'write' }
};
    ...
    it('should validate delete operations', async () => { const deleteOp: OperationContext = {
  ...baseOperation
  operation: 'delete' }
};
      const result = await enforcer.validateOperation(;);
    ...
    it('should validate export operations', async () => { const exportOp: OperationContext = {
  ...baseOperation
  operation: 'export' }
};
      const result = await enforcer.validateOperation(;);
    ...
    it('should validate share operations', async () => { const shareOp: OperationContext = {
  ...baseOperation
  operation: 'share' }
};
      const result = await enforcer.validateOperation(;);
    ...
    it('should check environment restrictions', async () => { const devOp: OperationContext = {
  ...baseOperation
  operation: 'write'
  environment: 'development' }
};
    ...
    it('should check third-party processing restrictions', async () => { const thirdPartyOp: OperationContext = {
  ...baseOperation
  source: 'third-party' }
};
      const result = await enforcer.validateOperation(;);
  ...
  describe('Audit Logging', () => { it('should log enforcement decisions', async () => {
  ...
  requestId: 'req789' }
    ...
    it('should log access denials', async () => { const strictEnforcer = new ClassificationEnforcer({)
  strictMode: true
  auditLogging: true }
});
  ...
  requestId: 'req789' }
    ...
    it('should include violation details in audit', async () => { await enforcer.enforceClassification()
  'CONFIDENTIAL'
  {
  operation: 'write'
  userId: 'user123'
  ...
  requestId: 'req789' }
    ...
    it('should clear audit log', () => { enforcer.clearAuditLog();
      const auditLog = enforcer.getAuditLog();
      expect(auditLog).toHaveLength(0) });
  });
  describe('Integration Scenarios', () => { it('should handle complete authentication flow', async () => {
  ...
  requestId: 'req791' }
    ...
    it('should handle data lifecycle operations', async () => { const dataId = 'data123';
