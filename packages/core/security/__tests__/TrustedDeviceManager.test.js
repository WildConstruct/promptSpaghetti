 ...
 */
import { TrustedDeviceManager, TrustStatus, TrustLevel, VerificationMethod } from '../TrustedDeviceManager';
...
describe('TrustedDeviceManager', () => {
    ...
    describe('Device Types', () => {
        test('should detect mobile device', async () => {
            ...
            mockFingerprintService.generateFingerprint.mockResolvedValue(mobileFingerprint);
            const request = {
                userId: testUserId,
        ...
        test('should detect tablet device', async () => {
            ...
            mockFingerprintService.generateFingerprint.mockResolvedValue(tabletFingerprint);
            const request = {
                userId: testUserId,
