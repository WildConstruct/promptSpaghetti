 ...
 */
import { VerificationCodeManager,
...
describe('VerificationCodeManager', () => { let manager: VerificationCodeManager;
  beforeEach(() => {
  ...
  describe('Code Generation', () => { test('should generate verification codes successfully', async () => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should generate codes with different formats', async () => { const customManager = new VerificationCodeManager({)
  ...
  [VerificationCodeType.TRANSACTION_APPROVAL]: CodeFormat.NUMERIC_6 }
      ...
      for (const { type, expectedLength } of requests) { const request: CodeGenerationRequest = { }
  userId: `user-${type}`}
          type,
          deliveryChannel: DeliveryChannel.EMAIL,
    ...
    test('should emit code generated event', (done) => { manager.on('codeGenerated', (data) => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should revoke existing codes when generating new ones', async () => { const request: CodeGenerationRequest = {,
  userId: 'user-revoke',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  deliveryChannel: DeliveryChannel.EMAIL,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should handle custom expiration times', async () => { const request: CodeGenerationRequest = {,
  ...
  describe('Code Validation', () => { test('should validate correct codes successfully', async () => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should reject invalid codes', async () => { const valRequest: CodeValidationRequest = {,
  userId: 'user-invalid',
  code: '999999',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  ipAddress: '192.168.1.1',
  userAgent: 'Mozilla/5.0' }
    ...
    test('should detect expired codes', async () => { const shortLivedManager = new VerificationCodeManager({)
  antiEnumerationDelay: 1,
  expirationTimes: {,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should track retry attempts and enforce limits', async () => { const limitedManager = new VerificationCodeManager({)
  antiEnumerationDelay: 1,
  retryLimits: {,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should calculate risk scores for security monitoring', async () => { const genRequest: CodeGenerationRequest = {,
  userId: 'user-risk',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  deliveryChannel: DeliveryChannel.EMAIL,
  ...
  describe('Code Usage', () => { test('should use valid codes successfully', async () => {
  const genRequest: CodeGenerationRequest = {,
  userId: 'user-use',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  deliveryChannel: DeliveryChannel.EMAIL,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should prevent reuse of used codes', async () => { const genRequest: CodeGenerationRequest = {,
  userId: 'user-reuse',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  deliveryChannel: DeliveryChannel.EMAIL,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should emit code used event', (done) => { manager.on('codeUsed', (data) => {
        expect(data.codeId).toBeDefined();
  ...
  describe('Code Revocation', () => { test('should revoke specific codes', async () => {
  const genRequest: CodeGenerationRequest = {,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should revoke all user codes of specific type', async () => { const userId = 'user-revoke-all';
  ...
  expect(smsCode?.status).toBe(CodeStatus.ACTIVE);
    ...
    test('should emit code revoked event', (done) => { manager.on('codeRevoked', (data) => {
        expect(data.codeId).toBeDefined();
  ...
  describe('Rate Limiting', () => { test('should enforce rate limiting by user', async () => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should enforce rate limiting by delivery address', async () => { const rateLimitedManager = new VerificationCodeManager({)
  rateLimitCount: 2,
  ...
  userId: 'user-delivery-limit-3' }
    ...
    test('should enforce rate limiting by IP address', async () => { const rateLimitedManager = new VerificationCodeManager({)
  rateLimitCount: 2,
  rateLimitWindow: 60000,
  antiEnumerationDelay: 1 }
});
  ...
  describe('Code Information and Management', () => { test('should get code information safely', async () => {
  const genRequest: CodeGenerationRequest = {,
  userId: 'user-info',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  deliveryChannel: DeliveryChannel.EMAIL,
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should get user active codes', async () => { const userId = 'user-active-codes';
  const requests: CodeGenerationRequest = [
  {
  userId,
  type: VerificationCodeType.EMAIL_VERIFICATION,
  ...
  expect(emailCodes[0].type).toBe(VerificationCodeType.EMAIL_VERIFICATION);
    ...
    test('should return null for non-existent code', () => { const codeInfo = manager.getCodeInfo('non-existent-code');
      expect(codeInfo).toBeNull() });
  });
  describe('Statistics and Analytics', () => { test('should provide comprehensive statistics', async () => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should handle empty statistics', () => { const stats = manager.getStatistics();
  ...
  describe('Security Events and Logging', () => { test('should emit security events', (done) => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should log invalid code attempts', async () => { let securityEventEmitted = false;
      manager.on('securityEvent', (event) => {
  ...
  describe('Configuration Management', () => { test('should update configuration and emit event', (done) => {
  ...
  retryLimit: 5 }
    ...
    test('should use custom configuration on initialization', () => { const customManager = new VerificationCodeManager({)
  ...
  describe('Cleanup and Destruction', () => { test('should perform cleanup and emit event', (done) => {
    ...
    test('should clean up expired codes', async () => { const quickCleanupManager = new VerificationCodeManager({)
  antiEnumerationDelay: 1,
  expirationTimes: {,
  [VerificationCodeType.EMAIL_VERIFICATION]: 1, // 1 millisecond,
  [VerificationCodeType.SMS_VERIFICATION]: 1,
  ...
  userAgent: 'Mozilla/5.0' }
      ...
      (quickCleanupManager as any).performCleanup = function() { const now = new Date();
  ...
  describe('Error Handling and Edge Cases', () => { test('should handle code generation errors gracefully', async () => {
  ...
  userAgent: 'Mozilla/5.0' }
    ...
    test('should handle validation errors gracefully', async () => { const valRequest: CodeValidationRequest = {,
  userId: 'user-error',
  code: '',
  type: VerificationCodeType.EMAIL_VERIFICATION,
  ipAddress: '192.168.1.1',
  userAgent: 'Mozilla/5.0' }
    ...
    test('should handle revocation of non-existent codes', async () => { const success = await manager.revokeCode('non-existent-code', 'test_revocation');
      expect(success).toBe(false) });
    test('should handle multiple revocations of same code', async () => { const genRequest: CodeGenerationRequest = {,
