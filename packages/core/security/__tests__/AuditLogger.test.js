 ...
 */
import { AuditLogger, createAuditLogger, AuditOperation, AuditLogLevel, InMemoryStorageBackend } from '../AuditLogger';
...
describe('AuditLogger', () => {
    ...
    describe('Basic Logging', () => {
        it('should log data access operations', async () => {
            ...
            await logger.logDataAccess(context, 'customer_records', 'cust_456', DataClassificationLevel.CONFIDENTIAL, true, { recordCount: 100 });
    ...
    describe('Security Features', () => {
        ...
        it('should mark sensitive access correctly', async () => {
            ...
            for (const log of logs) {
                const expected = classifications.find(c => log.resourceId === `test_${c.level}`);
    ...
    describe('Storage Backend', () => {
        it('should support custom storage backends', async () => {
            ...
            expect(customBackend.write).toHaveBeenCalledWith(expect.objectContaining({
                userId: 'user123',
                operation: AuditOperation.READ
            }));
