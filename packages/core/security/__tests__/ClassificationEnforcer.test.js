...
describe('ClassificationEnforcer', () => {
    ...
    describe('enforceClassification', () => {
        ...
        it('should allow PUBLIC data access with minimal controls', async () => {
            const result = await enforcer.enforceClassification('PUBLIC', baseOperation, ['auth-standard', 'audit-standard']);
        ...
        it('should enforce INTERNAL data requirements', async () => {
            const result = await enforcer.enforceClassification('INTERNAL', baseOperation, ['auth-standard']);
            expect(result.allowed).toBe(true);
            expect(result.classification).toBe('INTERNAL');
            expect(result.violations).toHaveLength(0);
        });
        it('should enforce CONFIDENTIAL data requirements', async () => {
            const result = await enforcer.enforceClassification('CONFIDENTIAL', baseOperation, ['auth-mfa']);
        ...
        it('should enforce RESTRICTED data requirements strictly', async () => {
            const result = await enforcer.enforceClassification('RESTRICTED', baseOperation, ['auth-standard']);
        ...
        it('should validate write operations require encryption', async () => {
            ...
            const result = await enforcer.enforceClassification('CONFIDENTIAL', writeOperation, ['auth-mfa']);
        ...
        it('should validate export operations', async () => {
            ...
            const result = await enforcer.enforceClassification('RESTRICTED', exportOperation, ['auth-strong_mfa']);
        ...
        it('should validate share operations', async () => {
            ...
            const result = await enforcer.enforceClassification('CONFIDENTIAL', shareOperation, ['auth-mfa']);
        ...
        it('should check environment restrictions', async () => {
            ...
            const result = await enforcer.enforceClassification('RESTRICTED', devOperation, ['auth-strong_mfa']);
        ...
        it('should allow operations in grace period', async () => {
            ...
            const result = await gracePeriodEnforcer.enforceClassification('RESTRICTED', baseOperation, []);
        ...
        it('should block operations in strict mode', async () => {
            ...
            const result = await strictEnforcer.enforceClassification('CONFIDENTIAL', baseOperation, []);
        ...
        it('should handle exempted users', async () => {
            ...
            const result = await exemptedEnforcer.enforceClassification('RESTRICTED', baseOperation, []);
            expect(result.allowed).toBe(true);
            expect(result.violations).toHaveLength(0);
        });
        it('should apply policy overrides', async () => {
            ...
            const result = await overrideEnforcer.enforceClassification('CONFIDENTIAL', baseOperation, ['auth-standard']);
            expect(result.allowed).toBe(true);
            expect(result.violations).toHaveLength(0);
        });
        it('should calculate risk scores appropriately', async () => {
            const publicResult = await enforcer.enforceClassification('PUBLIC', baseOperation, ['auth-standard', 'audit-standard']);
            const restrictedResult = await enforcer.enforceClassification('RESTRICTED', baseOperation, []);
        ...
        it('should generate audit IDs', async () => {
            const result1 = await enforcer.enforceClassification('INTERNAL', baseOperation, []);
            const result2 = await enforcer.enforceClassification('INTERNAL', baseOperation, []);
        ...
        it('should provide recommendations for violations', async () => {
            const result = await enforcer.enforceClassification('CONFIDENTIAL', baseOperation, []);
        ...
        it('should handle enforcement errors gracefully', async () => {
            ...
            const result = await enforcer.enforceClassification('CONFIDENTIAL', badOperation, []);
    ...
    describe('makeAccessDecision', () => {
        it('should grant access for properly authenticated users', async () => {
            const decision = await enforcer.makeAccessDecision('user123', 'data456', 'PUBLIC', 'read', {
        ...
        it('should deny access for insufficient authentication', async () => {
            const decision = await enforcer.makeAccessDecision('user123', 'data456', 'RESTRICTED', 'read', {});
        ...
        it('should check time restrictions for sensitive operations', async () => {
            ...
            const decision = await enforcer.makeAccessDecision('user123', 'data456', 'CONFIDENTIAL', 'export', {});
            expect(decision.granted).toBe(false);
        ...
        it('should check weekend restrictions', async () => {
            ...
            const decision = await enforcer.makeAccessDecision('user123', 'data456', 'CONFIDENTIAL', 'share', {});
            expect(decision.granted).toBe(false);
        ...
        it('should set appropriate access expiration', async () => {
            const publicDecision = await enforcer.makeAccessDecision('user123', 'data456', 'PUBLIC', 'read', {});
            const restrictedDecision = await enforcer.makeAccessDecision('user123', 'data456', 'RESTRICTED', 'read', {
    ...
    describe('validateOperation', () => {
        ...
        it('should validate read operations', async () => {
            const result = await enforcer.validateOperation(baseOperation, 'CONFIDENTIAL', { id: 'data123' });
        ...
        it('should validate write operations require encryption', async () => {
            ...
            const result = await enforcer.validateOperation(writeOp, 'CONFIDENTIAL', { id: 'data123' });
            expect(result.valid).toBe(true);
        ...
        it('should validate delete operations', async () => {
            ...
            const result = await enforcer.validateOperation(deleteOp, 'CONFIDENTIAL', { id: 'data123' });
        ...
        it('should validate export operations', async () => {
            ...
            const result = await enforcer.validateOperation(exportOp, 'RESTRICTED', { id: 'data123' });
            expect(result.valid).toBe(false);
        ...
        it('should validate share operations', async () => {
            ...
            const result = await enforcer.validateOperation(shareOp, 'CONFIDENTIAL', { id: 'data123' });
            expect(result.valid).toBe(false);
        ...
        it('should check environment restrictions', async () => {
            ...
            const result = await enforcer.validateOperation(devOp, 'RESTRICTED', { id: 'data123' });
            expect(result.valid).toBe(false);
        ...
        it('should check third-party processing restrictions', async () => {
            ...
            const result = await enforcer.validateOperation(thirdPartyOp, 'RESTRICTED', { id: 'data123' });
            expect(result.valid).toBe(false);
    ...
    describe('Audit Logging', () => {
        it('should log enforcement decisions', async () => {
            ...
            await auditingEnforcer.enforceClassification('CONFIDENTIAL', {
                operation: 'read',
                userId: 'user123',
                sessionId: 'session456',
                purpose: 'business',
        ...
        it('should log access denials', async () => {
            ...
            await strictEnforcer.enforceClassification('RESTRICTED', {
                operation: 'export',
                userId: 'user123',
                sessionId: 'session456',
                purpose: 'business',
        ...
        it('should include violation details in audit', async () => {
            await enforcer.enforceClassification('CONFIDENTIAL', {
                operation: 'write',
                userId: 'user123',
                sessionId: 'session456',
                purpose: 'business',
    ...
    describe('Integration Scenarios', () => {
        it('should handle complete authentication flow', async () => {
            ...
            let result = await enforcer.enforceClassification('INTERNAL', {
                operation: 'read',
                userId: 'user123',
                sessionId: 'session456',
                purpose: 'business',
            ...
            result = await enforcer.enforceClassification('CONFIDENTIAL', {
                operation: 'read',
                userId: 'user123',
                sessionId: 'session456',
                purpose: 'business',
