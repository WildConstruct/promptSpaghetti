...
describe('TrustedDeviceManager', () => {
  ...
  describe('Device Types', () => {
    test('should detect mobile device', async () => {
      ...
      mockFingerprintService.generateFingerprint.mockResolvedValue(mobileFingerprint as unknown);
    ...
    test('should detect tablet device', async () => {
      ...
      mockFingerprintService.generateFingerprint.mockResolvedValue(tabletFingerprint as unknown);
