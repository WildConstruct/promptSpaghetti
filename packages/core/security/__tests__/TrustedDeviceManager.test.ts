...
describe('TrustedDeviceManager', () => {
  ...
  beforeEach(() => {
    ...
    mockFingerprintService.assessRisk.mockReturnValue({
      ...
      factors: [],
      recommendations: [],
      timestamp: new Date( as unknown) as unknown as Date
    });
  ...
  describe('Device Types', () => {
    test('should detect mobile device', async () => {
      ...
      mockFingerprintService.generateFingerprint.mockResolvedValue(mobileFingerprint as unknown as unknown);
    ...
    test('should detect tablet device', async () => {
      ...
      mockFingerprintService.generateFingerprint.mockResolvedValue(tabletFingerprint as unknown as unknown);
