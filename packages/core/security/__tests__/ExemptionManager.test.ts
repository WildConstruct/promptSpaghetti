...
describe('ExemptionManager', () => { let manager: ExemptionManager;
  let mockDate: Date;
  beforeEach(() => {
  ...
  describe('Exemption Request Creation', () => { test('should create exemption request with approval required', async () => {
  ...
  statuses: [ExemptionStatus.PENDING_APPROVAL] }
    ...
    test('should auto-approve exemptions when policy allows', async () => { const request: ExemptionRequest = {
  type: ExemptionType.RATE_LIMITING
  ...
  statuses: [ExemptionStatus.ACTIVE] }
    ...
    test('should reject request from unauthorized role', async () => { const request: ExemptionRequest = {
  ...
  mitigations: [] }
    ...
    test('should reject request exceeding maximum duration', async () => { const request: ExemptionRequest = {
  type: ExemptionType.RATE_LIMITING
  scope: ExemptionScope.USER
  target: 'user123'
  reason: ExemptionReason.BUSINESS_CRITICAL
  ...
  describe('Exemption Approval Workflow', () => { let exemptionId: string;
  beforeEach(async () => {
  const request: ExemptionRequest = {
  ...
  mitigations: ['Additional monitoring'] }
    ...
    test('should approve pending exemption', async () => { const approved = await manager.approveExemption(;);
  exemptionId
  'approver1'
  ...
  statuses: [ExemptionStatus.ACTIVE] }
    ...
    test('should deny pending exemption', async () => { const denied = await manager.denyExemption(;);
  exemptionId
  'approver1'
  'approver@company.com'
  AdminRole.SECURITY_ADMIN
  ...
  statuses: [ExemptionStatus.DENIED] }
    ...
    test('should reject approval from unauthorized role', async () => { await expect(manager.approveExemption()
        exemptionId
        'unauthorized'
    ...
    test('should reject approval of non-pending exemption', async () => { // First approve the exemption
  ...
  describe('Exemption Checking and Usage', () => { let activeExemptionId: string;
  beforeEach(async () => {
  const request: ExemptionRequest = {
  type: ExemptionType.RATE_LIMITING
  scope: ExemptionScope.USER
  ...
  resetTime: new Date() }
    ...
    test('should grant exemption when conditions are met', () => { const context: ExemptionUsageContext = {
  ...
  requestId: 'req-123' }
    ...
    test('should deny exemption when IP not whitelisted', () => { const context: ExemptionUsageContext = {
  ...
  operation: 'api_call' }
    ...
    test('should deny exemption when no active exemption exists', () => { const result = manager.checkExemption(;);
        ExemptionType.RATE_LIMITING
        ExemptionScope.USER }
        'nonexistent-user'
      );
    ...
    test('should track usage when exemption is used', () => { const context: ExemptionUsageContext = {
  ipAddress: '192.168.1.100'
  operation: 'api_call' }
};
    ...
    test('should deny exemption when daily quota exceeded', () => { const context: ExemptionUsageContext = {
  ipAddress: '192.168.1.100'
  operation: 'api_call' }
};
      // Use exemption up to quota limit
      for (let i = 0; i < 10; i++) { manager.checkExemption(ExemptionType.RATE_LIMITING, ExemptionScope.USER, 'user789', context);
  ...
  describe('Emergency Exemptions', () => { test('should create emergency exemption with valid code', async () => {
  const request: ExemptionRequest = {,
  type: ExemptionType.ACCOUNT_LOCKOUT,
  scope: ExemptionScope.USER,
  ...
  activeOnly: true }
    ...
    test('should reject emergency exemption with invalid code', async () => { const request: ExemptionRequest = {,
  type: ExemptionType.ACCOUNT_LOCKOUT,
  scope: ExemptionScope.USER,
  target: 'emergency-user',
  reason: ExemptionReason.EMERGENCY_ACCESS,
  ...
  mitigations: [] }
    ...
    test('should reject emergency exemption for non-emergency type', async () => { const request: ExemptionRequest = {,
  ...
  describe('Exemption Revocation', () => { let activeExemptionId: string;
  beforeEach(async () => {
  ...
  mitigations: [] }
    ...
    test('should revoke active exemption', () => { const revoked = manager.revokeExemption(;);
  activeExemptionId,
  'revoker1',
  'revoker@company.com',
  AdminRole.SECURITY_ADMIN,
  ...
  statuses: [ExemptionStatus.REVOKED] }
    ...
    test('should reject revocation of non-active exemption', () => { // First revoke the exemption
  ...
  describe('Exemption Querying', () => { beforeEach(async () => {
  ...
  mitigations: [] }
    ...
    test('should query exemptions by type', () => { const result = manager.queryExemptions({)
  ...
  expect(ex.type).toBe(ExemptionType.RATE_LIMITING) });
    ...
    test('should query exemptions by scope', () => { const result = manager.queryExemptions({)
  ...
  expect(ex.scope).toBe(ExemptionScope.USER) });
    ...
    test('should query exemptions by priority', () => { const result = manager.queryExemptions({)
  priorities: [ExemptionPriority.HIGH] }
    ...
    test('should query active exemptions only', () => { const result = manager.queryExemptions({)
  activeOnly: true }
});
  ...
  expect(ex.status).toBe(ExemptionStatus.ACTIVE) });
    ...
    test('should support pagination', () => { const result = manager.queryExemptions({)
  limit: 2,
  offset: 0 }
});
  ...
  describe('Statistics and Reporting', () => {
    beforeEach(async () => {
      ...
      for (const req of requests) { const fullRequest: ExemptionRequest = {
          ...req }
  ...
  reason: ExemptionReason.BUSINESS_CRITICAL,
    ...
    test('should provide comprehensive statistics', () => { const stats = manager.getExemptionStatistics();
    ...
    test('should track usage statistics', () => { const stats = manager.getExemptionStatistics();
  ...
  describe('Event Emission', () => { test('should emit exemption requested event', (done) => {
  ...
  mitigations: [] }
    ...
    test('should emit exemption granted event for auto-approved', (done) => { manager.on('exemptionGranted', (exemption) => {
  ...
  mitigations: [] }
    ...
    test('should emit exemption used event', (done) => { manager.on('exemptionUsed', (data) => {
  ...
  describe('Error Handling', () => { test('should throw error for non-existent exemption', async () => {
  await expect(manager.approveExemption()
  'non-existent-id',
  'approver',
  'approver@company.com' }
  AdminRole.SUPER_ADMIN
    ...
    test('should throw error for non-existent policy', async () => { const request: ExemptionRequest = {,
