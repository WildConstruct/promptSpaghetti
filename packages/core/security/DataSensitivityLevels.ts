...
export interface DataHandlingRequirements { /** Minimum access control requirements */
  accessControl: {;
 ...
 */
const DATA_SENSITIVITY_DEFINITIONS: Record<DataSensitivityLevel, { level: DataSensitivityLevel;
  name: string;
  description: string;
...
> = { [DataSensitivityLevel.PUBLIC]: {
  ...
  [DataSensitivityLevel.INTERNAL]: { level: DataSensitivityLevel.INTERNAL
  name: 'Internal'
  ...
  [DataSensitivityLevel.CONFIDENTIAL]: { level: DataSensitivityLevel.CONFIDENTIAL
  name: 'Confidential'
  ...
  [DataSensitivityLevel.RESTRICTED]: { level: DataSensitivityLevel.RESTRICTED
  name: 'Restricted'
...
class DataSensitivityUtils {};
   ...
   */
  static compareSensitivityLevels(level1: DataSensitivityLevel, level2: DataSensitivityLevel): number { const levelOrder = [
      DataSensitivityLevel.PUBLIC
 ...
 */
const DATA_SENSITIVITY_GUIDELINES = { decisionTree: {,
  questions: [
  {
