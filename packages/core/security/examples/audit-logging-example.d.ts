 ...
 */
declare function basicAuditLogging(): Promise<void>;
declare function customStorageExample(): Promise<void>;
/**
 * Example 3: Integrated audit logging with classification and enforcement
 */
declare function integratedAuditExample(): Promise<void>;
/**
 * Example 4: Handling audit events and alerts
 */
declare function auditEventsExample(): Promise<void>;
/**
 * Example 5: Audit trail for workflows
 */
declare function workflowAuditExample(): Promise<void>;
export { basicAuditLogging, customStorageExample, integratedAuditExample, auditEventsExample, workflowAuditExample };
//# sourceMappingURL=audit-logging-example.d.ts.map
