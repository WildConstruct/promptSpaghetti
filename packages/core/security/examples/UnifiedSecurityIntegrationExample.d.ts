...
export declare function createQuickSecuritySetup(): { rateLimitingService: import("../RateLimitingService").RateLimitingService;
...
export declare function createCustomSecuritySetup(): { rateLimitingService: import("../RateLimitingService").RateLimitingService;
    throttlingEngine: import("..").AdaptiveThrottlingRules;
    integration: AdaptiveRateLimitingIntegration;
    analytics?: {
        usagePatterns?: import("../ApiUsagePatternQuotaRecommendations").ApiUsagePatternQuotaRecommendations;
...
export declare function handleSecurityRequest(integration: AdaptiveRateLimitingIntegration, requestData: { )
    ...
    method: string;
    userId?: string;
    userAgent: string }): Promise<import("../AdaptiveRateLimitingIntegration").UnifiedProtectionResult>;
export declare function monitorSecurityHealth(integration: AdaptiveRateLimitingIntegration): { config: import("../AdaptiveRateLimitingIntegration").IntegrationConfig;
    performance: any;
