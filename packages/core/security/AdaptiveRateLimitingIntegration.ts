...
export class AdaptiveRateLimitingIntegration extends EventEmitter {
   ...
   */
  private async applySequentialProtection()
    context: UnifiedProtectionContext,
  ): Promise<UnifiedProtectionResult> {
   ...
   */
  private async applyParallelProtection()
    context: UnifiedProtectionContext,
  ): Promise<UnifiedProtectionResult> {
   ...
   */
  private async applyConditionalProtection()
    context: UnifiedProtectionContext,
  ): Promise<UnifiedProtectionResult> {
   ...
   */
  private async applyHierarchicalProtection()
    context: UnifiedProtectionContext,
  ): Promise<UnifiedProtectionResult> {
