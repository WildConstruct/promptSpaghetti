...
export class SecurityAlertingConfigurationService extends EventEmitter {
     ...
     * Save configuration
     */
    async saveConfiguration(configId, config, metadata = {}) {
        try {
    ...
    async createBackup() {
        try {
            const backup = {
                ...
                metadata: Object.fromEntries(Array.from(this.metadata.entries()).map(([k, v]) => [k, {
                        ...v,
    ...
    async storeConfiguration(configId, config, metadata) {
