...
export interface ScalingThresholds { cpuUtilizationPercent: {
    ...
    memoryUtilizationPercent: { scaleUp: number;
        scaleDown: number };
    responseTimeMs: { scaleUp: number;
        scaleDown: number };
    throughputRps: { scaleUp: number;
        scaleDown: number };
    errorRatePercent: { scaleUp: number;
        scaleDown: number };
    queueDepth: { scaleUp: number;
        scaleDown: number };
    connectionCount: { scaleUp: number;
        scaleDown: number };
...
export interface ReservedInstanceConfig { enableReservedInstances: boolean;
...
export interface AutoShutdownConfig { enableAutoShutdown: boolean;
...
export interface PerformanceChange { responseTimeChange: number;
...
export interface Risk { riskId: string;
    description: string;
    likelihood: number;
    impact: number;
    riskLevel: RiskLevel }
...
export declare class ApiScalingAnalyticsIntegration extends EventEmitter { private config;
...
interface ScalingForecast { timestamp: Date;
    expectedLoad: number;
    confidence: number;
    factors: {
        seasonal: number;
