...
class DataSensitivityUtils {
     ...
     */
    static validateSensitivityAssignment(dataType, proposedLevel, context) {
        const reasons = [];
     ...
     */
    static compareSensitivityLevels(level1, level2) {
        const levelOrder = [
            DataSensitivityLevel.PUBLIC,
            DataSensitivityLevel.INTERNAL,
            DataSensitivityLevel.CONFIDENTIAL,
     ...
     */
    static getHigherSensitivityLevel(level1, level2) {
     ...
     */
    static generateSecurityMarkings(level) {
