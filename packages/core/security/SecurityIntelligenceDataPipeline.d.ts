...
export interface DataQualityThresholds { completeness: number;
    accuracy: number;
    consistency: number;
    timeliness: number;
    validity: number;
...
export interface DataTransformation { transformationId: string;
...
export interface ConnectionConfig { endpoint?: string;
    credentials?: {
        username?: string;
        password?: string;
        apiKey?: string;
...
export declare class SecurityIntelligenceDataPipeline extends EventEmitter { private config;
    private stages;
    private dataSources;
