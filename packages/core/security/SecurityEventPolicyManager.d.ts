...
export interface PolicyManagerConfig { enabled: boolean;
    ...
    notification_config: { channels: NotificationChannel[];
        escalation_delays: Record<SecurityEventSeverity, number>;
        retry_attempts: number };
    integration_config: { audit_system_enabled: boolean;
...
export interface AutomatedResponse { response_id: string;
 ...
 */
export declare class SecurityEventPolicyManager { private config;
