 ...
 */
export function createClassificationEnforcementMiddleware()
  config: Partial<ClassificationEnforcementMiddlewareConfig> = {}
 ...
 */
async function extractClassificationFromPath()
  req: Request,
): Promise<DataClassificationLevel | null> {
  // Common patterns
 ...
 */
async function detectClassificationFromData()
  data: any,
): Promise<DataClassificationLevel | null> {
