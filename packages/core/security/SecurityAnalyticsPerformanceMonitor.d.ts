...
export interface AnalyticsPerformanceProfile { id: string;
    ...
    resource_tracking: { cpu_monitoring: boolean;
    ...
    performance_dimensions: { throughput_tracking: ThroughputConfig;
...
export interface MonitoringScope { components: string[];
    operations: string[];
    data_sources: string[];
...
export interface ThroughputConfig { enabled: boolean;
    ...
    targets: { min_requests_per_second: number;
        min_events_per_minute: number;
        min_data_volume_gb_per_hour: number;
        max_queue_depth: number };
    bottleneck_detection: { enabled: boolean;
...
export interface AccuracyConfig { enabled: boolean;
    ...
    targets: { min_detection_accuracy_percent: number;
        ...
        min_f1_score: number };
    validation_methods: { ground_truth_comparison: boolean;
...
export interface PerformanceMetrics { profile_id: string;
    ...
    latency: { avg_response_time_ms: number;
    ...
    accuracy: { detection_accuracy_percent: number;
...
export interface PerformanceOptimizationRecommendation {
    ...
    implementation: { required_changes: string[];
    ...
    success_criteria: { performance_metrics: Record<string, number>;
...
export interface PerformanceBenchmark { id: string;
    ...
    expected_results: { baseline_metrics: Record<string, number>;
...
export interface BenchmarkExecution { id: string;
    ...
    comparison: { performance_change_percent: Record<string, number>;
...
export interface PerformanceReport { report_id: string;
    ...
    executive_summary: { overall_performance_score: number;
        performance_trend: 'improving' | 'stable' | 'degrading';
        key_achievements: string[];
        critical_issues: string[];
        recommendations_count: number };
    performance_analysis: { throughput_analysis: ThroughputAnalysis;
    ...
    anomaly_summary: { total_anomalies: number;
