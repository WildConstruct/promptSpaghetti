...
export const STANDARD_CLASSIFICATION_ROLES = {
  ...
  SYSTEM_ADMIN: {
    ...
    maxClassification: 'RESTRICTED' as DataClassificationLevel,
  ...
  COMPLIANCE_OFFICER: {
    ...
    maxClassification: 'CONFIDENTIAL' as DataClassificationLevel,
    category: 'ADMINISTRATIVE' as const,
  ...
  DATA_CUSTODIAN: {
    name: 'Data Custodian',
    maxClassification: 'INTERNAL' as DataClassificationLevel,
  ...
  VIEWER: {
    name: 'Read-Only User',
    maxClassification: 'PUBLIC' as DataClassificationLevel,
    category: 'FUNCTIONAL' as const,
    riskLevel: 'LOW' as const
  }
} as const;
