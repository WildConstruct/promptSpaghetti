...
export interface DataClassificationRole { id: string;
  name: string;
  description: string;
...
export interface TimeRange { start: string; // HH:MM format }
  end: string;
  daysOfWeek: number;
...
export interface ViolationAction { type: 'IMMEDIATE' | 'DELAYED' | 'MANUAL' }
