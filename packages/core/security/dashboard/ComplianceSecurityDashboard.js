...
(function (ComplianceStatus) {
    ...
    ComplianceStatus["IN_REMEDIATION"] = "in_remediation";
})(ComplianceStatus || (ComplianceStatus = {}));
/**
 * Compliance Security Dashboard Component
 */
export const ComplianceSecurityDashboard = ({ metrics, requirements, frameworks, auditCycles, theme = DashboardTheme.LIGHT, refreshInterval = 60, exportFormats = ['pdf', 'excel'], onRequirementUpdate, onGenerateReport, onScheduleAudit }) => {
        ...
        return (_jsxs("div", { style: {
                ...
                textAlign: 'center'
                        ...
                        textTransform: 'uppercase'
                            ...
                            }, children: [score, "%"] })] }), _jsxs("div", { style: {
                        fontSize: '11px',
                        color: themeStyles.textSecondary
                    }, children: [metrics.byFramework[framework]?.compliantRequirements || 0, "/", metrics.byFramework[framework]?.totalRequirements || 0, " compliant"] }), metrics.byFramework[framework]?.criticalGaps > 0 && (_jsxs("div", { style: {
                        marginTop: '4px',
                        fontSize: '10px',
                        color: themeStyles.error,
                        fontWeight: 500
                    }, children: [metrics.byFramework[framework].criticalGaps, " critical gaps"] }))] }));
    };
    // Render requirement item
    const renderRequirementItem = (requirement) => (_jsxs("div", { onClick: () => setSelectedRequirement(requirement), style: {
            background: themeStyles.surface,
            border: `1px solid ${themeStyles.border}`,
            ...
            transition: 'all 0.2s ease'
                    ...
                    marginBottom: '8px'
                                    ...
                                    textTransform: 'uppercase',
                                    whiteSpace: 'nowrap'
                                }, children: requirement.status.replace('_', ' ') }), requirement.riskLevel === 'critical' && (_jsx("span", { style: {
                                    fontSize: '10px',
                                    padding: '2px 6px',
                                    ...
                                    borderRadius: '4px',
                                    fontWeight: 600
                                }, children: "CRITICAL" }))] })] }), _jsxs("div", { style: {
                    display: 'flex',
                    justifyContent: 'space-between',
                    alignItems: 'center',
                    fontSize: '11px',
                    ...
                    borderRadius: '4px',
                    fontSize: '11px'
                }, children: [_jsxs("span", { style: { color: themeStyles.error, fontWeight: 500 }, children: [requirement.findings.length, " finding(s):"] }), _jsxs("span", { style: { color: themeStyles.textSecondary, marginLeft: '8px' }, children: [requirement.findings.filter(f => f.severity === 'critical').length, " critical,", requirement.findings.filter(f => f.severity === 'high').length, " high priority"] })] }))] }, requirement.id));
    return (_jsxs("div", { style: {
            background: themeStyles.background,
            color: themeStyles.text,
            minHeight: '100vh',
            fontFamily: 'Inter, system-ui, sans-serif'
                    ...
                    padding: '20px 24px'
                        ...
                        margin: '0 auto'
                                        ...
                                        fontSize: '12px',
                                        color: themeStyles.textSecondary
                                    }, children: ["Last updated: ", lastUpdate.toLocaleTimeString()] }), _jsx("div", { style: { display: 'flex', gap: '8px' }, children: exportFormats.map(format => (_jsxs("button", { onClick: () => selectedFramework !== 'all' && handleGenerateReport(selectedFramework, format), disabled: selectedFramework === 'all' || reportGenerating !== null, style: {
                                        ...
                                        }, children: [reportGenerating === `${selectedFramework}-${format}` ? '⏳' : '📊', " Export ", format.toUpperCase()] }, format))) })] })] }) }), _jsxs("div", { style: { padding: '24px', maxWidth: '1400px', margin: '0 auto' }, children: [_jsxs("div", { style: {
                            background: themeStyles.surface,
                            border: `1px solid ${themeStyles.border}`,
                            borderRadius: '8px',
                            padding: '24px',
                            ...
                            textAlign: 'center'
                                    ...
                                    fontSize: '14px',
                                    color: themeStyles.textSecondary
                                }, children: ["Based on ", frameworks.length, " compliance frameworks"] })] }), _jsx("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))',
                            gap: '16px',
                            marginBottom: '24px'
                        }, children: frameworks.map(framework => renderComplianceGauge(framework, metrics.byFramework[framework]?.score || 0)) }), _jsxs("div", { style: {
                            display: 'grid',
                            ...
                            marginBottom: '24px'
                                    ...
                                    padding: '16px'
                                        ...
                                        }, children: metrics.riskProfile.high })] }), _jsxs("div", { style: {
                                    background: themeStyles.surface,
                                    border: `1px solid ${themeStyles.border}`,
                                    borderRadius: '8px',
                                    padding: '16px'
                                            ...
                                            color: themeStyles.textSecondary,
                                            textTransform: 'uppercase'
                                        }, children: "Medium Risk Items" }), _jsx("div", { style: {
                                            fontSize: '28px',
                                            fontWeight: 700,
                                            color: themeStyles.warning
                                        }, children: metrics.riskProfile.medium })] }), _jsxs("div", { style: {
                                    background: themeStyles.surface,
                                    border: `1px solid ${themeStyles.border}`,
                                    borderRadius: '8px',
                                    padding: '16px'
                                            ...
                                            color: themeStyles.textSecondary,
                                            textTransform: 'uppercase'
                                        }, children: "Evidence Missing" }), _jsx("div", { style: {
                                            fontSize: '28px',
                                            fontWeight: 700,
                                            color: metrics.evidenceHealth.missing > 0 ? themeStyles.error : themeStyles.success
                                        }, children: metrics.evidenceHealth.missing })] }), _jsxs("div", { style: {
                                    background: themeStyles.surface,
                                    border: `1px solid ${themeStyles.border}`,
                                    borderRadius: '8px',
                                    padding: '16px'
                                            ...
                                            color: themeStyles.textSecondary,
                                            textTransform: 'uppercase'
                                        }, children: "Expiring Soon" }), _jsx("div", { style: {
                                            fontSize: '28px',
                                            fontWeight: 700,
                                            color: metrics.evidenceHealth.expiringWithin30Days > 0 ? themeStyles.warning : themeStyles.success
                                        }, children: metrics.evidenceHealth.expiringWithin30Days })] })] }), _jsxs("div", { style: {
                            display: 'flex',
                            gap: '16px',
                            marginBottom: '16px',
                            alignItems: 'center'
                                            ...
                                            fontWeight: 600,
                                            color: themeStyles.textSecondary
                                        }, children: "Framework:" }), _jsxs("select", { value: selectedFramework, onChange: (e) => setSelectedFramework(e.target.value), style: {
                                            background: themeStyles.surface,
                                            border: `1px solid ${themeStyles.border}`,
                                            borderRadius: '4px',
                                            padding: '6px 8px',
                                            color: themeStyles.text,
                                            fontSize: '12px'
                                        }, children: [_jsx("option", { value: "all", children: "All Frameworks" }), frameworks.map(framework => (_jsx("option", { value: framework, children: getFrameworkName(framework) }, framework)))] })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("label", { style: {
                                            fontSize: '12px',
                                            fontWeight: 600,
                                            color: themeStyles.textSecondary
                                        }, children: "Status:" }), _jsxs("select", { value: selectedStatus, onChange: (e) => setSelectedStatus(e.target.value), style: {
                                            background: themeStyles.surface,
                                            border: `1px solid ${themeStyles.border}`,
                                            borderRadius: '4px',
                                            padding: '6px 8px',
                                            color: themeStyles.text,
                                            fontSize: '12px'
                                        }, children: [_jsx("option", { value: "all", children: "All Statuses" }), Object.values(ComplianceStatus).map(status => (_jsx("option", { value: status, children: status.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }, status)))] })] }), _jsxs("div", { style: {
                                    fontSize: '12px',
                                    color: themeStyles.textSecondary,
                                    marginLeft: 'auto'
                                }, children: ["Showing ", filteredRequirements.length, " of ", requirements.length, " requirements"] })] }), _jsxs("div", { style: {
                            background: themeStyles.surface,
                            border: `1px solid ${themeStyles.border}`,
                            borderRadius: '8px',
                            padding: '20px'
                                    ...
                                    fontWeight: 600,
                                    color: themeStyles.text
                                }, children: "Compliance Requirements" }), filteredRequirements.length === 0 ? (_jsxs("div", { style: {
                                    textAlign: 'center',
                                    padding: '40px',
                                    color: themeStyles.textSecondary
                                }, children: [_jsx("div", { style: { fontSize: '48px', marginBottom: '16px' }, children: "\u2705" }), _jsx("div", { children: "No requirements match the current filters" })] })) : (_jsx("div", { style: { maxHeight: '600px', overflowY: 'auto' }, children: filteredRequirements.map(renderRequirementItem) }))] })] }), selectedRequirement && (_jsx("div", { style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
                    ...
                    zIndex: 1000
                        ...
                        overflowY: 'auto'
                                ...
                                marginBottom: '16px'
                                        ...
                                        color: themeStyles.textSecondary,
                                        lineHeight: 1.5
                                    }, children: selectedRequirement.description }), _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("strong", { children: "Business Impact:" }), " ", selectedRequirement.businessImpact] }), selectedRequirement.evidence.length > 0 && (_jsxs("div", { style: { marginBottom: '16px' }, children: [_jsxs("h5", { style: { margin: '0 0 8px 0', color: themeStyles.text }, children: ["Evidence (", selectedRequirement.evidence.length, ")"] }), selectedRequirement.evidence.map(evidence => (_jsxs("div", { style: {
                                                padding: '8px',
                                                background: themeStyles.surface,
                                                borderRadius: '4px',
                                                marginBottom: '4px',
                                                fontSize: '12px'
                                            }, children: [_jsx("strong", { children: evidence.title }), " - ", evidence.type, _jsxs("div", { style: { color: themeStyles.textSecondary }, children: ["Last updated: ", evidence.lastUpdated.toLocaleDateString()] })] }, evidence.id)))] })), selectedRequirement.findings.length > 0 && (_jsxs("div", { children: [_jsxs("h5", { style: { margin: '0 0 8px 0', color: themeStyles.text }, children: ["Findings (", selectedRequirement.findings.length, ")"] }), selectedRequirement.findings.map(finding => (_jsxs("div", { style: {
                                                padding: '12px',
                                                background: themeStyles.surface,
                                                ...
                                                marginBottom: '8px',
                                                fontSize: '12px'
                                            }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: '4px' }, children: finding.title }), _jsx("div", { style: { color: themeStyles.textSecondary, marginBottom: '8px' }, children: finding.description }), _jsxs("div", { style: { color: themeStyles.primary }, children: [_jsx("strong", { children: "Recommendation:" }), " ", finding.recommendation] })] }, finding.id)))] }))] }), _jsxs("div", { style: { display: 'flex', gap: '12px' }, children: [selectedRequirement.status !== ComplianceStatus.COMPLIANT && (_jsx("button", { onClick: () => {
                                        ...
                                        fontWeight: 500,
                                        cursor: 'pointer'
                                    }, children: "Mark Compliant" })), _jsx("button", { onClick: () => {
