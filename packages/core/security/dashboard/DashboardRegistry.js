...
export class DashboardRegistry {
     ...
     */
    getDashboardTemplates(type, role, category) {
     ...
     */
    getDashboardPresets(dashboardType, layout) {
     ...
     */
    getWidgetDefinitions(category, tags) {
     ...
     */
    createDashboardFromTemplate(templateId, overrides) {
     ...
     */
    createDashboardFromPreset(presetId, overrides) {
        ...
        const config = {
            ...
            widgets: preset.widgets.map(w => ({
                id: w.id,
                type: w.type,
                category: this.widgets.get(w.type)?.category || 'METRICS',
     ...
     */
    validateDashboardTemplate(template) {
