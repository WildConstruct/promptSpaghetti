...
export class SecurityDataPipelineMonitor extends EventEmitter {
  ...
  private initializeEventHandlers(): void {
    ...
    this.on('execution_completed', (execution: PipelineExecution) => {
      this.analyzeExecutionResults(execution);
    });
    this.on('alert_generated', (alert: PipelineAlert) => {
  ...
  private calculateDataQualityScore(execution: PipelineExecution): number {
  ...
  private stopPipelineMonitoring(pipelineId: string): void {
