...
export interface OperationModifier { requestMultiplier: number;
...
export declare const ENVIRONMENT_CONFIGURATIONS: {
    ...
    STAGING: { globalLimits: GlobalDataLimits;
        relaxedMode: boolean;
        debugLogging: boolean };
    PRODUCTION: { globalLimits: GlobalDataLimits;
        relaxedMode: boolean;
        debugLogging: boolean };
};
/**
 ...
 */
export declare const ROLE_EXEMPTION_TEMPLATES: { SYSTEM_ADMIN: {
    ...
    DATA_OWNER: { exemptionType: "QUOTA";
        reason: string;
        conditions: {
    ...
    SECURITY_OFFICER: { exemptionType: "CLASSIFICATION";
        reason: string;
        conditions: {
            type: "TIME_RANGE";
            specification: {
    ...
    COMPLIANCE_OFFICER: { exemptionType: "TIME_RESTRICTION";
        reason: string;
        conditions: {
            type: "OPERATION";
            specification: {
