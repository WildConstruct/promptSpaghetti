...
export interface RetentionPeriod { duration: number;
    reason: string;
...
export interface PrivacyScore { overall: number;
    categories: {
 ...
 */
export declare class UserAccessTransparencyService extends EventEmitter { private config;
