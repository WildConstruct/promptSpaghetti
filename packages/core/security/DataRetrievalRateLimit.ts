...
export class DataRetrievalRateLimit extends EventEmitter {
  ...
  private config: DataRetrievalConfig;
  private accessHistory: Map<string, DataAccessAttempt> = new Map();
  ...
  */
  ...
  operation: DataOperation,
  requestDetails: DataRequestDetails): Promise<DataRetrievalDecision> {,
  try {
