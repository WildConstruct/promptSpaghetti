...
export interface AuditIntegrationConfig { auditLogger: AuditLogger;
...
export declare class AuditIntegration {
    ...
    logBatchOperation(context: OperationContext, operation: AuditOperation, resources: Array<{ )
        type: string;
        id: string;
        classification?: DataClassificationLevel }>, success: boolean, metadata?: Record<string, any>): Promise<void>;
    /**
    ...
    generateComplianceReport(startDate: Date, endDate: Date, options?: { )
        ...
        includeDetails?: boolean }): Promise<ComplianceReport>;
/**
...
export interface ComplianceReport { period: {
    ...
    anomalies: number;
    riskMetrics: { averageRiskScore: number;
