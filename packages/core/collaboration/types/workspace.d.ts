...
export interface UserId extends String { readonly __brand: 'UserId' }
}
export interface ResourceId extends String { readonly __brand: 'ResourceId';
...
export interface ProjectSettings { visibility: 'private' | 'workspace' | 'public';
    ...
    collaboration: { max_concurrent_editors: number;
...
export interface NotificationData { action_url?: string;
...
export interface WorkspaceOperations { createWorkspace(data: Omit<Workspace, 'id' | 'created_at' | 'updated_at'>): Promise<Workspace>;
