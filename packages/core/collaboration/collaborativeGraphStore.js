...
export const useCollaborationEnabled = () => useCollaborativeGraphStore(state => state.collaborationEnabled);
export const useConnectedUsers = () => useCollaborativeGraphStore(state => state.connectedUsers);
export const useConnectionStatus = () => useCollaborativeGraphStore(state => state.connectionStatus);
export const useLocalPresence = () => useCollaborativeGraphStore(state => state.localPresence);
export const useCollaborativeGraph = () => useCollaborativeGraphStore(state => state.graph);
// Action hooks
export const useCollaborativeActions = () => useCollaborativeGraphStore(state => ({
