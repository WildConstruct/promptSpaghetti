...
export class ConstraintValidator {
    ...
    checkCulturalAppropriateness(constraint, nodes) {
        ...
        for (const node of nodes) {
            ...
            const culturalTags = node.metadata.tags.filter(tag => tag.includes('religious') ||
                tag.includes('sacred') ||
    ...
    checkRegionalAuthenticity(constraint, nodes) {
        ...
        for (const node of nodes) {
            ...
            const hasValidRegion = nodeRegions.some(region => constraintRegions.some(cRegion => region.toLowerCase().includes(cRegion.toLowerCase()) ||
