...
export class ConstraintSuggestionEngine {
     ...
     */
    generateSuggestions(validationResult, nodes, context) {
        const suggestions = [];
     ...
     */
    generateViolationSuggestions(violation, constraint, nodes, context) {
        const suggestions = [];
     ...
     */
    generateEraCompatibilitySuggestions(violation, affectedNodes, context) {
        const suggestions = [];
     ...
     */
    generateSocialClassSuggestions(violation, affectedNodes, context) {
        const suggestions = [];
     ...
     */
    generateMaterialAvailabilitySuggestions(violation, affectedNodes, context) {
        const suggestions = [];
        affectedNodes.forEach(node => {
     ...
     */
    generateCulturalSuggestions(violation, affectedNodes, context) {
        const suggestions = [];
        affectedNodes.forEach(node => {
     ...
     */
    generateTemporalSuggestions(violation, affectedNodes, context) {
        const suggestions = [];
     ...
     */
    generateRegionalSuggestions(violation, affectedNodes, context) {
        const suggestions = [];
        if (context.region) {
    ...
    // Helper methods
    findConstraintById(id) {
        // This would typically query a constraint database
        return null;
    }
    generateEraUnificationActions(nodes, targetEra) {
    ...
    getEraExampleReplacement(era, node) {
...
class HistoricalKnowledge {
    ...
    getSocialClassContext(socialClass, era) {
    ...
    getAvailableMaterials(era, region) {
