...
import { ProjectMetadata, ProjectSettings, createDefaultMetadata } from './schemas/psgSchema';
 ...
 */
async;
generateThumbnail(file, PSGFile);
Promise < string > {
     ...
     */
    getRecentFiles(limit = 10) { return this.recentFiles.slice(0, limit); }
    /**
     ...
     * Static method to save project to device (Story 6.1)
     */
    static async saveProjectToDevice(graphData, options, settings) {
        try {
            // Create metadata
