                                        ...
                                        if (options && asset.type === 'image') {
                                            ...
                                            if (options.quality) {
                                                ...
                                                if (options.format) {
                                                    ...
                                                    Promise < void  > { const: promises = assetIds.map(id => this.processAsset(id, options)),
                                                    ...
                                                    return { url, path };
                                                    async;
                                                    processImage(asset, MediaAsset, options ?  : MediaProcessingOptions['image']);
                                                    Promise < void  > {
                                                        ...
                                                        async processQueue() { },
                                                        : .processingQueue.size > 0 && this.isProcessing
                                                    };
                                                    {
                                                        ...
                                                        this.isProcessing = false;
                                                        terminateWorkers();
                                                        void { this: .processingWorkers.forEach(worker => worker.terminate()),
