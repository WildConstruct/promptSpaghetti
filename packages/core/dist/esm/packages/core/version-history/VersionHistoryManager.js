...
Promise < VersionSnapshot > { try: {
    ...
    return: snapshot,
        ...
        Promise < { snapshots: VersionSnapshot, total: number } > { try: {
            ...
            // Update local cache
            result, : .snapshots.forEach((snapshot) => { this.snapshots.set(snapshot.id, snapshot); }),
            return: result,
            catch(error) {
                    ...
                    Promise < any > {
                        ...
                        return: response.data,
                            ...
                            Promise < void  > {
                                ...
                                // Record change event
                                await, this: .recordChangeEvent({ event_type: 'snapshot_deleted' }, event_data, { snapshot_id: snapshotId }, affected_nodes, [], change_magnitude, 0)
                            };
                            ;
                            try {
                            }
                                                    ...
                                                    return: branch,
                                                        ...
                                                        Promise < { events: ChangeEvent, total: number } > { try: {
                                                            ...
                                                            annotation: {
                                                                ...
                                                                target_coordinates: { x: number, y: number }, Promise() {
                                                                    try {
