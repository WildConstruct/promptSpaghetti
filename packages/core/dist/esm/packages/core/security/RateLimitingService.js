...
(function (RateLimitStrategy) {
    ...
    RateLimitStrategy[RateLimitStrategy["export"] = void 0] = "export";
    RateLimitStrategy[RateLimitStrategy["enum"] = void 0] = "enum";
    RateLimitStrategy[RateLimitStrategy["BackoffStrategy"] = void 0] = "BackoffStrategy";
})(RateLimitStrategy || (RateLimitStrategy = {}));
{
    ...
    (function (EndpointCategory) {
        ...
        EndpointCategory[EndpointCategory["ThreatLevel"] = void 0] = "ThreatLevel";
    })(EndpointCategory || (EndpointCategory = {}));
    {
        ...
        export let RateLimitResult;
        (function (RateLimitResult) {
            RateLimitResult["ALLOWED"] = "allowed";
            RateLimitResult["BLOCKED"] = "blocked";
            RateLimitResult["WARNING"] = "warning";
            RateLimitResult[RateLimitResult["export"] = void 0] = "export";
            RateLimitResult[RateLimitResult["interface"] = void 0] = "interface";
            RateLimitResult[RateLimitResult["RateLimitConfig"] = void 0] = "RateLimitConfig";
...
adaptiveTriggers: {
    ...
    threatLevelAdjustments: Record; // multipliers,
}
;
;
;
    ...
    for (const attempt of attempts) {
        ...
        };
        {
            ...
            if (lastMinute.length >= limits.perMinute) {
                ...
                updateThreatContext(identifier, string, attempt, RateLimitAttempt);
                void {
