...
import { DeviceFingerprint, RiskLevel, FingerprintType } from './DeviceFingerprintingService';
...
export class TrustedDeviceManager extends EventEmitter {
    ...
    config = {
         ...
         */
        async checkDeviceTrust(userId, context, location) {
            try {
            ...
            return {
                 ...
                 */
                async registerTrustedDevice(request) {
                ...
                TrustDecision['factors'];
                {
                    ...
                    if (device.settings.requireLocationCheck && location) {
                        ...
                        if (location) {
                            ...
                            return factors;
                            makeTrustDecision((device, factors) => {
                            ...
                            }, private, calculateFingerprintSimilarity(((device, fingerprint) => {
