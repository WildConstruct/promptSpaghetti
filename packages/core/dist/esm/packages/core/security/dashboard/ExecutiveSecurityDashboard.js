...
;
export const ExecutiveSecurityDashboard = ({
    metrics,
    insights,
...
;
// Render KPI card
const renderKPICard = (title, value, subtitle, trend, onClick) => ();
;
...
'all 0.2s ease',
    ':hover';
onClick ? { transform: 'translateY(-2px)', boxShadow: '0 8px 25px rgba(0,0,0,0.15)' } : {};
    >
        _jsxs("div", { style: {
                display: 'flex',
                ...
                marginBottom: '8px',
                    ...
                    < span, " style=", { fontSize: '16px' }, ">", getTrendIcon(trend)] });
div >
    _jsx("div", { style: {
            fontSize: '32px',
            fontWeight: 700,
...
onDrillDown?.('incidents');
    >
        (_jsxs("h3", { style: {
                ...
                fontWeight: 500,
                color: themeStyles.textSecondary,
            }, children: ["Security Incidents (", selectedTimeframe, ")"] })
            ,
                _jsxs("div", { style: {
                        display: 'grid',
...
onDrillDown?.('financial');
    >
        (_jsxs("h3", { style: {
                ...
                fontWeight: 500,
                color: themeStyles.textSecondary,
            }, children: ["Security ROI (", selectedTimeframe, ")"] })
            ,
                _jsxs("div", { style: {
                        display: 'grid',
                        gridTemplateColumns: '1fr 1fr',
...
'24px';
 >
    _jsx("h3", { style: {
            ...
            fontWeight: 500,
            color: themeStyles.textSecondary,
        }, children: "Top Executive Insights" });
{
...
style = {};
{
 ...
 >
    ...
    borderLeft;
`4px solid ${insight.priority === 'critical' ? themeStyles.critical : themeStyles.error}`;
borderRadius: '8px',
    cursor;
'pointer';
onClick = {}();
onInsightAction?.(insight, 'view');
    >
        (_jsxs("div", { style: {
                display: 'flex',
                justifyContent: 'space-between',
                ...
                _jsx("p", { style: {
                    ...
                    ,
                        _jsxs("div", { style: {
                                fontSize: '11px',
                                color: themeStyles.textSecondary,
                            }, children: ["Impact: ", insight.impact, " \u2022 Cost: ", formatCurrency(insight.cost)] }));
div >
;
div >
;
...
_jsxs("div", { style: {
        ...
        fontFamily: 'Inter, system-ui, sans-serif',
                ...
                margin: '0 auto',
                                ...
                                fontSize: '16px',
                                color: themeStyles.textSecondary,
                            }, children: "Strategic security posture overview for executive decision-making" })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '16px' }, children: [_jsx("select", { value: selectedTimeframe, onChange: (e) => setSelectedTimeframe(e.target.value), style: {
                                padding: '8px 12px',
                                background: themeStyles.surface,
                                border: `1px solid ${themeStyles.border}`
...
style = {};
{
    display: 'grid',
        gridTemplateColumns;
    showBenchmarks ? '1fr 1fr 1fr 1fr' : '1fr 1fr 1fr',
        gap;
    '24px',
        marginBottom;
    '24px',
