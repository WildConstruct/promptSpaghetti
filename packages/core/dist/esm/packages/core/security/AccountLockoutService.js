...
})(LockoutStatus || (LockoutStatus = {}));
{
    ...
    })(UnlockMethod || (UnlockMethod = {}));
    {
        ...
        return lockout.id;
        async;
        adminUnlock((), lockoutId, string, unlockRequest, UnlockRequest);
...
AccountLockout | null;
{
    ...
    AccountLockout;
    {
                    ...
                    getLockoutStatistics(dateRange ?  : { start: Date, end: Date });
                    {
                        ...
                        if (dateRange) {
                            ...
                            if (lockout.unlockTime) {
                                ...
                                async;
                                requestUnlockApproval((), lockout, AccountLockout, unlockRequest, UnlockRequest);
                                Promise < { success: boolean, message: string, requiresApproval: boolean } > {
                        ...
                        async;
                        performUnlock((), lockout, AccountLockout, unlockRequest, UnlockRequest);
                        Promise < { success: boolean, message: string } > {
        ...
        ;
        async;
        sendNotification((), lockout, AccountLockout, notificationData, (Partial));
        Promise < void  > {
