...
(function (RateLimitStrategyType) {
    ...
    RateLimitStrategyType[RateLimitStrategyType["export"] = void 0] = "export";
    RateLimitStrategyType[RateLimitStrategyType["enum"] = void 0] = "enum";
    RateLimitStrategyType[RateLimitStrategyType["RateLimitScope"] = void 0] = "RateLimitScope";
            ...
            }
            {
                ...
                export class RateLimitStrategy {
                    ...
                    constructor(config, store) {
                        ...
                        this.store = store;
                        abstract;
                        checkLimit(key, string, context, RateLimitContext);
                        Promise;
                        abstract;
                        reset(key, string);
                        Promise;
                                            ...
                                            if (typeof this.config.message === 'function') {
                                                ...
                                                export class RateLimiter {
                                                    ...
                                                    createConfig(customConfig) {
                                                         ...
                                                         */
                                                        async;
                                                        checkLimit(context, RateLimitContext);
                                                        Promise < RateLimitResult > {
                                                            ...
                                                            */
                                                            async resetLimit(context) {
                                                                ...
                                                                */
                                                                async;
                                                                getCurrentInfo(context, RateLimitContext);
