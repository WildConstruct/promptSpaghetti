...
import { RateLimitStatus, ThreatLevel, BackoffStrategy } from './RateLimitingService';
...
(function (IntegrationMode) {
    ...
    IntegrationMode[IntegrationMode["export"] = void 0] = "export";
    IntegrationMode[IntegrationMode["enum"] = void 0] = "enum";
    IntegrationMode[IntegrationMode["CoordinationStrategy"] = void 0] = "CoordinationStrategy";
})(IntegrationMode || (IntegrationMode = {}));
{
    ...
    (function (FallbackBehavior) {
        ...
        FallbackBehavior[FallbackBehavior["export"] = void 0] = "export";
        FallbackBehavior[FallbackBehavior["interface"] = void 0] = "interface";
        FallbackBehavior[FallbackBehavior["UnifiedProtectionContext"] = void 0] = "UnifiedProtectionContext";
        FallbackBehavior[FallbackBehavior["extends"] = void 0] = "extends";
        FallbackBehavior[FallbackBehavior["ThrottlingContext"] = void 0] = "ThrottlingContext";
    ...
    async;
    applySequentialProtection(context, UnifiedProtectionContext);
    Promise < UnifiedProtectionResult > {
    ...
    };
    {
        ...
        if (rateLimitResult.result === 'blocked') {
            ...
            rateLimitResult,
                { action: 'allow', delay: 0, reason: 'Not applied', ruleId: 'none', metadata: { systemCondition: 'normal' } },
                'block',
                0,
                'rate_limiting',
            ...
            async;
            applyParallelProtection(context, UnifiedProtectionContext);
            Promise < UnifiedProtectionResult > {
            ...
            };
            {
                ...
                async;
                applyConditionalProtection(context, UnifiedProtectionContext);
                Promise < UnifiedProtectionResult > {
                ...
                {
                    identifier: context.ip, endpoint;
                    context.endpoint, result;
                    'allowed', remainingRequests;
                    100, resetTime;
                    new Date(), backoffLevel;
                    0, threatLevel;
                    context.threatLevel, adaptiveMultiplier;
                    1.0;
                }
                throttlingResult,
                ...
                ;
                async;
                applyHierarchicalProtection(context, UnifiedProtectionContext);
                Promise < UnifiedProtectionResult > {
                        ...
                        switch (this.config.coordinationStrategy) {
                            ...
                            default:
                                ...
                                rateLimitResult,
                                    ...
                                    confidence;
                                ;
                                applyMostRestrictive((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                {
                                    finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                    finalDelay: number;
                                    ...
                                    if (rateLimitResult.result === 'blocked') {
                                        ...
                                        if (throttlingResult.action === 'block') {
                                            ...
                                            if (throttlingResult.action === 'throttle') {
                                                ...
                                                applyLeastRestrictive((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                {
                                                    finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                                    finalDelay: number;
                                                    decisionSystem: string;
                                                ...
                                                }
                                                {
                                                    ...
                                                    if (rateLimitResult.result === 'allowed' || throttlingResult.action === 'allow') {
                                                        ...
                                                        applyWeightedAverage((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                        {
                                                            finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                                            finalDelay: number;
                                                            decisionSystem: string;
                                                    ...
                                                    ;
                                                    applyDynamicSelection((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                    {
                                                        finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                                        finalDelay: number;
                                                        decisionSystem: string;
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        if (rateLimitResult.threatLevel === ThreatLevel.HIGH || rateLimitResult.threatLevel === ThreatLevel.CRITICAL) {
                                                                ...
                                                                throttlingResult.metadata?.systemCondition === 'overload';
                                                            {
                                                                ...
                                                                applyConsensusBased((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                                {
                                                                    finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                                                    finalDelay: number;
                                                                    decisionSystem: string;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    if (rateLimitBlocks && throttlingBlocks) {
                                                                        ...
                                                                        if (!rateLimitBlocks && !throttlingBlocks) {
                                                                            ...
                                                                            applyFallbackBehavior((), rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                                            {
                                                                                finalAction: 'allow' | 'block' | 'throttle' | 'delay';
                                                                                finalDelay: number;
                                                                                decisionSystem: string;
                                                                            ...
                                                                            }
                                                                            {
                                                                                switch (this.config.fallbackBehavior) {
                                                                                    ...
                                                                                    default:
                                                                                        return this.applyMostRestrictive(rateLimitResult, throttlingResult);
                                                                                        createUnifiedResult(rateLimitResult, RateLimitStatus);
                                                                                        throttlingResult: ThrottlingResult,
                                                                                            action;
                                                                                        'allow' | 'block' | 'throttle' | 'delay',
                                                                                            delay;
                                                                                        number,
                                                                                            decisionSystem;
                                                                                        string,
                                                                                            ...
                                                                                            return {
                                                                                                ...
                                                                                                metadata: {
                                                                                                    ...
                                                                                                    async enhanceContext(context) {
                                                                                                        ...
                                                                                                        length || 0,
                                                                                                            backoffLevel;
                                                                                                        this.rateLimitingService.getBackoffDelay(context.ip, context.endpoint),
                                                                                                            threatAssessment;
                                                                                                        context.threatLevel,
                                                                                                            adaptiveMultiplier;
                                                                                                        1.0,
                                                                        ...
                                                                        shouldUseRateLimiting(context, UnifiedProtectionContext);
                                                                        boolean;
                                                                        {
                                                                            // Use rate limiting for high threat levels
                                                                            if (context.threatLevel === ThreatLevel.HIGH || context.threatLevel === ThreatLevel.CRITICAL) {
                                                                                ...
                                                                                if (context.endpoint.includes('/auth/') || context.endpoint.includes('/login')) {
                                                                                    ...
                                                                                    if (context.endpoint.includes('/api/') && context.systemLoad > 70) {
                                                                                        ...
                                                                                        return false;
                                                                                        shouldUpdateRules(rateLimitResult, RateLimitStatus, throttlingResult, ThrottlingResult);
                                                                                        boolean;
                                                                                        {
                                                                                            ...
                                                                                            calculateSystemHealth(system, 'rate_limiting' | 'throttling' | 'integration');
                                                                                            number;
                                                                                            {
                                                                                                switch (system) {
                                                                                                    case 'rate_limiting':
                                                                                                    ...
                                                                                                    default:
                                                                                                        ...
                                                                                                        if (currentPerformance.falsePositiveRate > 10) {
                                                                                                            ...
                                                                                                            CoordinationStrategy.LEAST_RESTRICTIVE,
                                                                                                                throttlingPriority;
                                                                                                            Math.max(50, this.config.throttlingPriority - 10),
                                                                                                            ;
                                                                                                        }
                                                                                                        ;
                                                                                                        this.learningData.integratedInsights.recommendedConfigurations = recommendations;
                                                                                                        async;
                                                                                                        recordDecision((), context, UnifiedProtectionContext, result, UnifiedProtectionResult);
                                                                                                        Promise < void  > {
