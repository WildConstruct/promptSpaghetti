...
throttlingInsights: {
    ...
    systemLoadCorrelations: Record;
    adaptationSuccessRates: Record;
...
async;
applyUnifiedProtection(context, UnifiedProtectionContext);
        ...
        };
        {
            ...
            }
            {
                ...
                UnifiedProtectionResult;
                {
                    ...
                    }((rateLimitResult, throttlingResult) => {
                     ...
                     * Create unified result object
                     */
                    private, createUnifiedResult(rateLimitResult, RateLimitStatus), throttlingResult, ThrottlingResult, action, 'allow' | 'block' | 'throttle' | 'delay', delay, number, decisionSystem, string, reasoning, string, confidence, number);
                    UnifiedProtectionResult;
                    {
                        return {
                            action,
