...
(function (RetryStrategy) {
    ...
    // Operation types
    RetryStrategy[RetryStrategy["export"] = void 0] = "export";
    RetryStrategy[RetryStrategy["enum"] = void 0] = "enum";
    RetryStrategy[RetryStrategy["MFAOperation"] = void 0] = "MFAOperation";
})(RetryStrategy || (RetryStrategy = {}));
{
    ...
    (function (FailureType) {
        ...
        FailureType[FailureType["export"] = void 0] = "export";
        FailureType[FailureType["enum"] = void 0] = "enum";
        FailureType[FailureType["CircuitBreakerStateEnum"] = void 0] = "CircuitBreakerStateEnum";
    ...
    for (let attempt = 1; attempt <= config.maxAttempts; attempt++) {
        ...
        if (delayMs > 0) {
            ...
            async;
            executeWithTimeout((), operationFn, () => Promise, timeoutMs, number);
            Promise < T > {
            ...
            ;
            calculateDelay(attempt, number, config, RetryConfig);
            number;
            {
                let delay;
                                                    ...
                                                    if (message.includes('service unavailable') || message.includes('server error')) {
                                                        ...
                                                        if (message.includes('authentication failed') || message.includes('unauthorized')) {
                                                            ...
                                                            if (message.includes('validation') || message.includes('invalid input')) {
                                                                ...
                                                                handleSuccess(operation, MFAOperation, context, OperationContext);
                                                                void {
                                                                    const: circuitBreaker = this.circuitBreakers.get(operation),
                                                                    if(circuitBreaker) {
                                                                        ...
                                                                        }[MFAOperation.SMS_VERIFICATION] } };
                                                                {
                                                                    ...
                                                                    5000,
                                                                        retryableErrors;
                                                                    [FailureType.NETWORK_ERROR, FailureType.TIMEOUT],
                                                                    ;
                                                                }
