...
(function (DeliveryStatus) {
    ...
    DeliveryStatus[DeliveryStatus["export"] = void 0] = "export";
    DeliveryStatus[DeliveryStatus["enum"] = void 0] = "enum";
    DeliveryStatus[DeliveryStatus["EmailType"] = void 0] = "EmailType";
})(DeliveryStatus || (DeliveryStatus = {}));
{
    ...
    (function (EmailProvider) {
        ...
        // Bounce types
        EmailProvider[EmailProvider["export"] = void 0] = "export";
        EmailProvider[EmailProvider["enum"] = void 0] = "enum";
        EmailProvider[EmailProvider["BounceType"] = void 0] = "BounceType";
    })(EmailProvider || (EmailProvider = {}));
    {
        ...
        // Bounce sub-types
        export let BounceSubType;
        (function (BounceSubType) {
            BounceSubType["GENERAL"] = "general";
            BounceSubType["NO_EMAIL"] = "no_email";
            BounceSubType["SUPPRESSED"] = "suppressed";
            BounceSubType["MAILBOX_FULL"] = "mailbox_full";
            BounceSubType["MESSAGE_TOO_LARGE"] = "message_too_large";
            BounceSubType["CONTENT_REJECTED"] = "content_rejected";
            BounceSubType["ATTACHMENT_REJECTED"] = "attachment_rejected";
            // Email metadata
            BounceSubType[BounceSubType["export"] = void 0] = "export";
            BounceSubType[BounceSubType["interface"] = void 0] = "interface";
            BounceSubType[BounceSubType["EmailMetadata"] = void 0] = "EmailMetadata";
...
export class EmailDeliveryTracker extends EventEmitter {
    ...
    */
     ...
     * Update email delivery status
     */
    updateStatus(emailId, status, additionalData) {
    ...
    if(record) { }, : .status === DeliveryStatus.DELIVERED };
{
    ...
    ;
    async;
    handleWebhook(provider, EmailProvider, payload, any);
    Promise < void  > {
        try: {
    ...
    500;
    ; // 500ms for sending
    addDeliveryAttempt(emailId, string, attempt, EmailDeliveryAttempt);
    void {
        const: record = this.deliveryRecords.get(emailId),
        if(record) {
        ...
        if (newStatus === DeliveryStatus.SPAM) {
            ...
            if (newStatus === DeliveryStatus.DELIVERED) {
                ...
                emailId: record.id,
                    record,
                    deliveryTime;
                record.deliveredAt.getTime() - record.createdAt.getTime(),
                ;
            }
            ;
            handleBounce(record, EmailDeliveryRecord);
            void {
            ...
            if (record.bounceInfo?.type === BounceType.HARD) {
                ...
                emailAddress: record.recipient,
                    reason;
                record.bounceInfo.reason,
                    timestamp;
                record.bouncedAt,
                ;
            }
            ;
            handleSpamReport(record, EmailDeliveryRecord);
            void {
            ...
            ;
            parseWebhookPayload(provider, EmailProvider, payload, any);
            any;
            {
                ...
                findEmailByMessageId(messageId, string);
                string | null;
                {
                    for (const [emailId, record] of this.deliveryRecords) {
                        if (record.messageId === messageId) {
                            return emailId;
                            return null;
                            processWebhookEvent(emailId, string, event, any);
                            void {
                                ...
                                if(previousStatus) { } } === DeliveryStatus.PENDING;
                            {
                                ...
                                switch (newStatus) {
                                    ...
                                    case DeliveryStatus.FAILED:
                                        ...
                                        async;
                                        generateMessageId(provider, EmailProvider);
                                        Promise < string > {
                                            return: `${provider}_msg_${Date.now()}_${Math.random().toString(36).substring(2, 15)}`
                                        };
                                        getSenderAddress(emailType, EmailType);
                                        string;
                                        {
