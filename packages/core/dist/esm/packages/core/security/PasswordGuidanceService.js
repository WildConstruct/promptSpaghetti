...
(userId, indicators) => {
    ...
    return session;
    getImmediateActions(compromiseType, CompromiseType);
    ...
    'Review Account Activity',
        description;
    'Check for any unauthorized access or suspicious activity in your account.',
        category;
    GuidanceCategory.IMMEDIATE_ACTIONS,
        priority;
    ActionPriority.IMMEDIATE,
                ...
                case CompromiseType.REUSED_PASSWORD:
                     ...
                     | null;
                    {
                        ...
                        calculateProgress(session, GuidanceSession);
                        {
                            ...
                            async;
                            updateUserSecurityProfile(((userId, indicators) => {
                            ...
                            if (!profile.mfaEnabled) {
                                ...
                                getUserSecurityDashboard(userId, string);
                                {
                                    ...
                                    getPersonalizedRecommendations(profile, UserSecurityProfile);
                                    SecurityRecommendation;
                                    {
                                        const recommendations = [];
                                        if (!profile.mfaEnabled) {
