...
(function (RiskLevel) {
    ...
    RiskLevel[RiskLevel["CompromiseType"] = void 0] = "CompromiseType";
})(RiskLevel || (RiskLevel = {}));
{
    ...
    (function (ActionPriority) {
        ...
        // Guidance Categories
        ActionPriority[ActionPriority["export"] = void 0] = "export";
        ActionPriority[ActionPriority["enum"] = void 0] = "enum";
        ActionPriority[ActionPriority["GuidanceCategory"] = void 0] = "GuidanceCategory";
    })(ActionPriority || (ActionPriority = {}));
    {
        ...
        Promise < GuidanceSession > {
            ...
            getImmediateActions(compromiseType) {
                ...
                'Change Your Password Immediately',
                    description;
                'Your password has been compromised and must be changed right now to secure your account.',
                    category;
                GuidanceCategory.IMMEDIATE_ACTIONS,
                    priority;
            ...
            compromiseType === CompromiseType.CREDENTIAL_STUFFING;
        {
            ...
            id: 'secure-other-accounts',
                title;
            'Secure Other Accounts Using Same Password',
                description;
            'Change passwords on all other accounts that used the same or similar password.',
                category;
            GuidanceCategory.IMMEDIATE_ACTIONS,
                priority;
        ...
        async;
        generateRecommendations((), indicators, CompromiseIndicator, riskLevel, RiskLevel);
        Promise < SecurityRecommendation > {
            const: recommendations, SecurityRecommendation = [],
            // Get immediate actions
            const: compromiseTypes = [...new Set(indicators.map(i => i.type))],
            for(, type, of, compromiseTypes) {
            ...
            */
            ...
            getMonitoringRecommendations(riskLevel) {
                ...
                'Enable Security Alerts',
                    description;
                'Set up notifications for suspicious account activity and login attempts.',
                    category;
                GuidanceCategory.MONITORING,
                    priority;
                ActionPriority.HIGH,
                    estimatedTime;
                '10 minutes',
            ...
            if(riskLevel) { }
        } === RiskLevel.HIGH || riskLevel === RiskLevel.CRITICAL;
        {
            recommendations.push({});
        ...
        SecurityRecommendation;
        {
            ...
            calculateRiskLevel(indicators, CompromiseIndicator);
            RiskLevel;
            {
                ...
                for (const indicator of indicators) {
                    ...
                    switch (indicator.type) {
                        ...
                        case CompromiseType.REUSED_PASSWORD:
                            ...
                            return RiskLevel.LOW;
                            prioritizeRecommendations((), recommendations, SecurityRecommendation, riskLevel, RiskLevel);
                            SecurityRecommendation;
                            {
                                ...
                                markActionCompleted(sessionId, string, actionId, string);
                                boolean;
                                {
                                     ...
                                     | null;
                                    {
                                        ...
                                        calculateProgress(session, GuidanceSession);
                                        {
                                            total: number;
                                            completed: number;
                                            percentage: number;
                                            ...
                                            async;
                                            updateUserSecurityProfile((), userId, string, indicators, CompromiseIndicator);
                                            Promise < void  > {
