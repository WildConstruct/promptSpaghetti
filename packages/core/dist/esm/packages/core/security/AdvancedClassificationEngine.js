...
(data, context) => {
    ...
    throw error;
    async;
    classifyStream(((dataStream, context) => {
...
;
async;
executeWorkflow(workflowId, string, result, EnhancedClassificationResult, context, ClassificationContext);
Promise < void  > {
                                                    ...
                                                    result.category === DataCategory.PII;
                                                {
                                                    ...
                                                    string;
                                                    {
                                                        ...
                                                        EnhancedClassificationResult['remediation'];
                                                        {
                                                            ...
                                                            return actions;
                                                            async;
                                                            triggerWorkflows(((result, context) => {
                                                            ...
                                                            }), private, evaluateTrigger(trigger, WorkflowTrigger), result, EnhancedClassificationResult, context, ClassificationContext);
                                                            boolean;
                                                            {
                                                                switch (trigger.type) {
