 ...
 */
const DATA_SENSITIVITY_DEFINITIONS, string;
description: string;
 ...
 > ;
{
    [DataSensitivityLevel.PUBLIC];
    {
        ...
        'Public',
            description;
        'Information that is intended for public disclosure and can be shared freely without restriction.',
            riskLevel;
        'low',
            examples;
        [
            ...
            handlingRequirements;
        {
            ...
            [DataSensitivityLevel.INTERNAL];
            {
                ...
                'Internal',
                    description;
                'Information intended for use within the organization and by authorized partners.',
                    riskLevel;
                'medium',
                    examples;
                [
                            ...
                            if (context?.containsPII && proposedLevel !== DataSensitivityLevel.RESTRICTED) {
                                ...
                                if (context?.publiclyAvailable && proposedLevel !== DataSensitivityLevel.PUBLIC) {
                                    ...
                                    number;
                                    {
                                        ...
                                        getHigherSensitivityLevel(((level1, level2) => {
