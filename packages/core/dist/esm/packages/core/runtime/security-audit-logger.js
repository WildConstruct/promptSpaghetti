...
(function (SecuritySeverity) {
    ...
    */
    SecuritySeverity[SecuritySeverity["export"] = void 0] = "export";
    SecuritySeverity[SecuritySeverity["enum"] = void 0] = "enum";
    SecuritySeverity[SecuritySeverity["SecurityEventCategory"] = void 0] = "SecurityEventCategory";
                    ...
                    if (filter.endTime !== undefined) {
                        ...
                        for (const event of this.events) {
                            ...
                            void {
                                 ...
                                 */
                                function: auditSecurityEvent((), severity, SecuritySeverity = SecuritySeverity.INFO, category, SecurityEventCategory = SecurityEventCategory.EXPRESSION_VALIDATION), MethodDecorator
                            };
                            {
                                return ;
