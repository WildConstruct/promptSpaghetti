...
CONDITIONAL_PATTERN = /\{\{#if\s+(\w+)\}\}([\s\S]*?)\{\{\/if\}\}/g;
HELPER_PATTERN = /\{\{(\w+)\s+([\w\s]+)\}\}/g;
render(template, string, variables, TemplateVariables);
string;
{
    ...
    return rendered;
    processConditionals(template, string, variables, TemplateVariables);
    string;
    {
        ...
        processHelpers(template, string, variables, TemplateVariables);
        string;
        {
            ...
            processVariables(template, string, variables, TemplateVariables);
            string;
            {
                    ...
                    while ((match = simplePattern.exec(template)) !== null) {
                        ...
                        while ((match = conditionalPattern.exec(template)) !== null) {
                            ...
                            while ((match = helperPattern.exec(template)) !== null) {
                                ...
                                validateVariables(template, string, variables, TemplateVariables);
                                string;
                                {
