...
validate(data, string | ArrayBuffer);
Promise;
getMetadata(data, string | ArrayBuffer);
Promise;
...
if (parsed.id && parsed.name) { // Direct template format
    return parsed;
}
else {
                                            ...
                                            return: [
                                                {
                                                    ...
                                                    async calculateChecksum(data) {
                                                        ...
                                                        export class ZipFormatProcessor {
                                                        }
