...
const baseNodeSchema = z.object({ label: z.string().default('Node'),
    id: z.string().default(''),
...
export const nodeSchemas = { Subject: baseNodeSchema.extend({
...
}, transitions, z.record(z.record(z.number())).default({}), currentState, z.string().default(''), maxIterations, z.number().default(100), terminationConditions, z.array(z.string()).optional());
;
