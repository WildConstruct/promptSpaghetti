 ...
 */
import { BaseAIModel, AIModelStatus } from './BaseAIModel';
    ...
    constructor(config) {
        ...
        BaseAIModel | null;
        {
            ...
            if (entry) {
                ...
                return entry.model;
                return null;
                set(modelId, string, model, BaseAIModel);
                void {
                    : .cache.size >= this.config.maxSize };
                {
                    this._evictModel();
                                    ...
                                    if (availableModels.length === 0) {
                                        ...
                                        switch (this.strategy) {
                                            ...
                                            default:
                                                ...
                                                updateMetrics(modelId, string, latency, number, cost, number, error ?  : boolean);
                                                void {
                                                                                                                            ...
                                                                                                                            for (const registration of registrations) {
                                                                                                                                try {
                                                                                                                                    ...
                                                                                                                                    if (this.warmupStrategy.enabled) {
                                                                                                                                        ...
                                                                                                                                        return pool;
                                                                                                                                        async;
                                                                                                                                        processRequest(poolId, string, request, AIRequest);
                                                                                                                                        Promise < AIResponse > {
                                                                                                                                            ...
                                                                                                                                            if(, model) {
                                                                                                                                                ...
                                                                                                                                                try {
                                                                                                                                                    ...
                                                                                                                                                    throw err;
                                                                                                                                                    async;
                                                                                                                                                    estimateRequest(poolId, string, request, AIRequest);
