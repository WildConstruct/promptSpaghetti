                        ...
                        if (filters.priorities?.length) {
                            ...
                            if (filters.status?.length) {
                                ...
                                if (filters.targetAudience?.length) {
                                    ...
                                    if (filters.confidenceMin !== undefined) {
                                        ...
                                        if (filters.impactMin !== undefined) {
                                            ...
                                            async;
                                            provideFeedback(suggestionId, string);
                                            feedback: {
                                                ;
                                                rating: number; // 1-5 }
                                                helpful: boolean;
                                            ...
                                            ;
                                            async;
                                            rejectSuggestions(suggestionIds, string, reason ?  : string);
                                            Promise < void  > { const: results = await Promise.allSettled(),
                                ...
                                };
                                {
                                    ...
                                    destroy();
                                    void { this: .stopAutomaticAnalysis(),
                                    ...
                                    }, private, async, createSuggestionFromOpportunity(opportunity, any), analysis, any, context, AnalysisContext);
                                    Promise < ImprovementSuggestion > {};
    ...
    if (filters.includeTypes.length > 0) {
        ...
        if (filters.excludeTypes.length > 0) {
            ...
            if (this.config.filtering.duplicateDetection) {
                ...
                return filtered;
                removeDuplicateSuggestions(suggestions, ImprovementSuggestion);
                ImprovementSuggestion;
                {
                    const seen = new Set();
                ...
                ;
                prioritizeSuggestions(suggestions, ImprovementSuggestion);
                ImprovementSuggestion;
                {
                    return suggestions.sort((a, b) => {
                    ...
                    calculatePriorityScore(suggestion, ImprovementSuggestion);
                    number;
                    {
                        ...
                        ;
                        getEffortScore(complexity, string);
                        number;
                        {
                            const scores = {
                                'trivial': 1.0,
                        ...
                        getUrgencyScore(priority, string);
                        number;
                        {
                            const scores = {
                                'critical': 1.0,
                        ...
                        async;
                        storeSuggestion(suggestion, ImprovementSuggestion);
                        Promise < string > { this: .suggestions.set(suggestion.id, suggestion),
                    ...
                    void { : .config.generation.enableAutomaticGeneration };
                    {
                        setInterval(() => {
