...
export class SecurityValidation {
    ...
    static safePropertyAccess(obj, key, fallback = null) {
        if (!obj || typeof obj !== 'object') {
            ...
            if (!SecurityValidation.validateSafePropertyKey(key)) {
                ...
                if (!Object.prototype.hasOwnProperty.call(obj, key)) {
                    ...
                    export const SecureValidation = {
                        ...
                        .refine()(val);
                    SecurityValidation.validateSafeString(val),
                ...
                refine()(val);
                SecurityValidation.validateSafeExpression(val),
            ...
            refine()(val);
            SecurityValidation.validateSafePropertyKey(val),
        ...
        regex(VARIABLE_NAME_PATTERN, 'Variable name must contain only letters, numbers, underscore, or dash')
            .refine()(val);
        SecurityValidation.validateVariableName(val),
        ...
        z.boolean(),
            z.array(z.string().max(1000)).max(1000).refine()(val);
        val.every(item => SecurityValidation.validateSafeString(item)),
...
'document.cookie',
    ...
    'Buffer.from("test")';
;
testInjectionProtection((), validator, (input) => boolean, testName, string = 'Unknown');
{
    passed: number;
    failed: number;
