...
return (_jsxs("div", { style: {
        ...
        transition: 'width 0.3s ease',
    }, "data-testid": "corrections-manager-panel", children: [_jsxs("div", { style: {
                padding: '12px 16px',
                ...
                minHeight: '48px',
            }, children: [!isCollapsed && (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("h2", { style: { margin: 0, fontSize: '16px', fontWeight: 600 }, children: "Corrections Manager" }), _jsxs("span", { style: {
                                        background: '#4a5568',
                                        padding: '2px 6px',
                                        borderRadius: '10px',
                                        fontSize: '11px',
                                        fontWeight: 500,
                                    }, children: [filteredAndSortedRules.length, "/", rules.length] })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("button", { onClick: () => setIsCollapsed(true), style: {
                                        background: 'none',
                                        border: 'none',
                                        color: '#a0aec0',
                                        cursor: 'pointer',
                                        ...
                                        borderRadius: '4px',
                                        fontSize: '16px',
                                    }, title: "Close panel", children: "\u00D7" })] })] })), isCollapsed && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }, children: [_jsx("button", { onClick: () => setIsCollapsed(false), style: {
                                background: 'none',
                                border: 'none',
                                color: '#a0aec0',
                                cursor: 'pointer',
                            ...
                            }, children: "Corrections" })] }))] }), !isCollapsed && (_jsxs("div", { style: { flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column' }, children: [_jsxs("div", { style: { padding: '16px', borderBottom: '1px solid #444' }, children: [_jsx("div", { style: { marginBottom: '12px' }, children: _jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search rules...", style: {
                                    width: '100%',
                                    padding: '8px 12px',
                                    background: '#2a2e37',
                                    color: '#fff',
                                ...
                                marginBottom: '12px',
                                flexWrap: 'wrap',
                            }, children: [_jsxs("select", { value: filterType, onChange: (e) => setFilterType(e.target.value), style: {
                                        padding: '6px 8px',
                                        background: '#2a2e37',
                                        color: '#fff',
                                        border: '1px solid #444',
                                        ...
                                        borderRadius: '4px',
                                        fontSize: '12px',
                                    }, children: [_jsx("option", { value: "priority", children: "Priority" }), _jsx("option", { value: "name", children: "Name" }), _jsx("option", { value: "created", children: "Created" }), _jsx("option", { value: "updated", children: "Updated" })] }), _jsxs("select", { value: viewMode, onChange: (e) => setViewMode(e.target.value), style: {
                                        padding: '6px 8px',
                                        background: '#2a2e37',
                                        color: '#fff',
                                        border: '1px solid #444',
                                        borderRadius: '4px',
                                        fontSize: '12px',
                                    }, children: [_jsx("option", { value: "list", children: "List" }), _jsx("option", { value: "grid", children: "Grid" }), _jsx("option", { value: "compact", children: "Compact" })] })] }), _jsxs("div", { style: { display: 'flex', gap: '8px', flexWrap: 'wrap' }, children: [_jsx("button", { onClick: handleSelectAll, style: {
                                        padding: '6px 12px',
                                        background: '#4a5568',
                                        color: '#fff',
                                        border: 'none',
                                        ...
                                        fontSize: '12px',
                                        cursor: 'pointer',
                                    }, children: selectedRules.size === filteredAndSortedRules.length ? 'Deselect All' : 'Select All' }), selectedRules.size > 0 && (_jsxs(_Fragment, { children: [_jsxs("button", { onClick: () => handleBulkAction('activate'), style: {
                                                padding: '6px 12px',
                                                background: '#38a169',
                                                color: '#fff',
                                                border: 'none',
                                                ...
                                                fontSize: '12px',
                                                cursor: 'pointer',
                                            }, children: ["Activate (", selectedRules.size, ")"] }), _jsxs("button", { onClick: () => handleBulkAction('deactivate'), style: {
                                                padding: '6px 12px',
                                                background: '#e53e3e',
                                                color: '#fff',
                                                border: 'none',
                                                ...
                                                fontSize: '12px',
                                                cursor: 'pointer',
                                            }, children: ["Deactivate (", selectedRules.size, ")"] }), _jsxs("button", { onClick: () => handleBulkAction('delete'), style: {
                                                padding: '6px 12px',
                                                background: '#e53e3e',
                                                color: '#fff',
                                                border: 'none',
                                                ...
                                                fontSize: '12px',
                                                cursor: 'pointer',
                                            }, children: ["Delete (", selectedRules.size, ")"] })] })), _jsx("button", { onClick: () => setShowImportExport(!showImportExport), style: {
                                        padding: '6px 12px',
                                        background: '#63b3ed',
                                        color: '#fff',
                                        border: 'none',
                                        ...
                                        fontSize: '12px',
                                        cursor: 'pointer',
                                    }, children: "Import/Export" }), _jsx("button", { onClick: () => setShowStats(!showStats), style: {
                                        padding: '6px 12px',
                                        background: '#9f7aea',
                                        color: '#fff',
                                        border: 'none',
                        ...
                        borderRadius: '6px',
                        marginBottom: '16px',
                    }, children: [_jsx("h3", { style: { fontSize: '14px', margin: '0 0 12px 0', fontWeight: 600 }, children: "Import/Export" }), _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("label", { style: { display: 'block', fontSize: '12px', marginBottom: '6px' }, children: "Export Format:" }), _jsxs("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: [_jsxs("select", { value: exportFormat, onChange: (e) => setExportFormat(e.target.value), style: {
                                                padding: '6px 8px',
                                                background: '#2a2e37',
                                                color: '#fff',
                                                border: '1px solid #444',
                                                ...
                                                fontSize: '12px',
                                                cursor: 'pointer',
                                            }, children: "Export" })] })] }), _jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontSize: '12px', marginBottom: '6px' }, children: "Import File:" }), _jsx("input", { type: "file", accept: ".json,.yaml,.yml,.csv", onChange: (e) => {
                                        ...
                                        fontSize: '12px',
                                        cursor: 'pointer',
                                    }, children: "Import" }))] })] })), _jsxs("div", { style: { padding: '16px', borderBottom: '1px solid #444' }, children: [_jsx("h3", { style: { fontSize: '14px', marginBottom: '8px', fontWeight: 600 }, children: "Test Corrections" }), _jsx("textarea", { value: testText, onChange: (e) => setTestText(e.target.value), placeholder: "Enter text to test corrections...", style: {
                                width: '100%',
                                minHeight: '60px',
                                padding: '8px',
                                background: '#2a2e37',
                                ...
                                resize: 'vertical',
                                fontSize: '14px',
                            } }), testText && (_jsxs("div", { style: { marginTop: '8px' }, children: [_jsx("strong", { style: { fontSize: '12px', color: '#a0aec0' }, children: "Result:" }), _jsx("div", { style: {
                                        padding: '8px',
                                        background: '#1e2228',
                                        border: '1px solid #444',
                                        borderRadius: '6px',
                                    ...
                                    }, children: handleTestCorrections() })] }))] }), _jsxs("div", { style: { flex: 1, overflow: 'auto', padding: '16px' }, children: [_jsxs("div", { style: {
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'space-between',
                                marginBottom: '16px',
                                                ...
                                                fontSize: '12px',
                                                cursor: 'pointer',
                                            }, children: "Clear All" })] })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [filteredAndSortedRules.map((rule) => ()
                                    ...
                                    transition: 'background 0.2s ease',
                                        ...
                                        marginBottom: '8px',
                                                    ...
                                                    }, style: { marginRight: '4px' } }), _jsx("input", { type: "checkbox", checked: rule.isActive, onChange: () => toggleRule(rule.id), style: { marginRight: '4px' } }), _jsx("strong", { style: { fontSize: '14px', fontWeight: 600 }, children: rule.name }), rule.isRegex && (_jsx("span", { style: {
                                                        background: '#4a5568',
                                                        color: '#fff',
                                                        padding: '2px 6px',
                                                        borderRadius: '2px',
                                                        ...
                                                        padding: '4px 8px',
                                                        borderRadius: '4px',
                                                    }, children: "Delete" })] })] }), rule.description && (_jsx("p", { style: {
                                        fontSize: '12px',
                                        color: '#a0aec0',
                                        margin: '4px 0 8px 0',
                                    }, children: rule.description })), _jsxs("div", { style: { fontSize: '12px', marginBottom: '4px' }, children: [_jsx("span", { style: { color: '#68d391', fontWeight: 500 }, children: "Find:" }), _jsx("code", { style: {
                                                background: '#1e2228',
                                                padding: '2px 4px',
                                                borderRadius: '2px',
                                                marginLeft: '4px',
                                            }, children: rule.findPattern })] }), _jsxs("div", { style: { fontSize: '12px' }, children: [_jsx("span", { style: { color: '#63b3ed', fontWeight: 500 }, children: "Replace:" }), _jsx("code", { style: {
                                                background: '#1e2228',
                                                padding: '2px 4px',
                                                borderRadius: '2px',
                                                marginLeft: '4px',
                                            }, children: rule.replaceWith })] })] }), "))}"] }), filteredAndSortedRules.length === 0 && (_jsxs("div", { style: {
                        textAlign: 'center',
                        padding: '40px',
                        color: '#a0aec0',
                    }, children: [_jsx("p", { children: "No correction rules found." }), searchQuery && (_jsx("p", { style: { fontSize: '12px' }, children: "Try adjusting your search or filter criteria." }))] }))] })) /* Add New Rule Section */, _jsxs("div", { style: {
                padding: '16px',
                borderTop: '1px solid #444',
                background: '#1e2228',
            }, children: [_jsx("h3", { style: { fontSize: '14px', marginBottom: '12px', fontWeight: 600 }, children: "Add New Rule" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsx("input", { type: "text", value: newRule.name, onChange: (e) => setNewRule(prev => ({ ...prev, name: e.target.value })), placeholder: "Rule name", style: {
                                padding: '8px',
                                background: '#2a2e37',
                                color: '#fff',
                                border: '1px solid #444',
