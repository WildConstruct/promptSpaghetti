    ...
    if (stats.subscriptions > 1000) {
        ...
        if (stats.historySize > 8000) {
            ...
            export const collectEventSystemMetrics = () => {
                ...
                (history.length / ((Date.now() - history[0].timestamp.getTime()) / 60000));
                0;
                return {
                    ...stats,
                    metrics: {
                ...
                export const EventSystemPresets = {
                    ...
                    analytics: () => {
                        ...
                        globalEventBus.use(createLoggingMiddleware({}), logLevel, 'info', filterCategories, [EventCategory.ANALYTICS]);
                    }
                };
