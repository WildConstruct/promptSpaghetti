...
export const PreviewModal = ({ open, loading, error, results, onClose, onCancel, onResultHover, onNodeHighlight, onResultAction, lockedResults = [], regeneratingResults = [], onVarianceSuggestion }) => {
    ...
    const handleExport = async (format, options) => {
        try {
            ...
            if (exportDialog.type === 'individual' && typeof exportDialog.individualIndex === 'number') {
                ...
                exportResult = await resultExportService.exportIndividualResult(result, exportDialog.individualIndex, results.length, options);
            }
    ...
    return (_jsxs("div", { role: "dialog", "aria-modal": "true", style: {
            ...
            justifyContent: 'center',
                    ...
                    color: professionalColors.text.primary,
                            ...
                            alignItems: 'center',
                            marginBottom: 16,
                        }, children: [_jsx("h2", { style: { margin: 0 }, children: "Generated Content" }), _jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: [hasExecutionPaths && (_jsx("button", { onClick: () => setShowExecutionPaths(!showExecutionPaths), style: {
                                            ...
                                            fontWeight: 500,
                                            cursor: 'pointer',
                                        }, children: showExecutionPaths ? '📊 Hide Paths' : '🔍 Show Paths' })), results.length >= 2 && (_jsx("button", { onClick: () => setShowVarianceAnalysis(!showVarianceAnalysis), style: {
                                            ...
                                            fontWeight: 500,
                                            cursor: 'pointer',
                                        }, children: showVarianceAnalysis ? '📈 Hide Variance' : '📊 Show Variance' })), _jsx("button", { onClick: () => {
                                            if (compareMode) {
                                                clearComparison();
                                            }
                                            else {
                                            ...
                                            fontWeight: 500,
                                            cursor: 'pointer',
                                        }, children: compareMode ? '⚖️ Exit Compare' : '⚖️ Compare' }), selectedForComparison.length > 0 && (_jsx("button", { onClick: () => setExportDialog({
                                            open: true,
                                            type: 'batch',
                                        }), style: {
                                            background: '#8b5cf6',
                                            ...
                                            fontWeight: 500,
                                            cursor: 'pointer',
                                        }, children: "\uD83D\uDCBE Export Selected" })), !compareMode && results.length > 1 && (_jsx("button", { onClick: () => setExportDialog({
                                            open: true,
                                            type: 'comparison',
                                        }), style: {
                                            background: '#6b7280',
                                            ...
                                            fontWeight: 500,
                                            cursor: 'pointer',
                                        }, children: "\uD83D\uDCCA Export All" })), compareMode && selectedForComparison.length > 0 && (_jsx("span", { style: {
                                            fontSize: 11,
                                            color: '#4a5568',
                                            padding: '4px 8px',
                                            background: '#f7fafc',
                                            borderRadius: 4,
                                        }, children: `${selectedForComparison.length} of 3 selected` }))] })] }), loading && _jsx("div", { style: { marginBottom: 12 }, children: "Generating content..." }), error && _jsxs("div", { style: { color: '#c00' }, children: ["Error: Something went wrong: ", error] }), !loading && !error && (_jsx("div", { children: showExecutionPaths && hasExecutionPaths && (_jsx("div", { style: { marginBottom: 20 } >
                                { /* Temporarily disabled ExecutionPathVisualization */}
                                < div > Placeholder })) }))] }), ")}", showVarianceAnalysis && results.length >= 2 && (_jsx("div", { style: { marginBottom: 20 } >
                    { /* Temporarily disabled VarianceAnalysis */}
                    < div > Variance, Analysis: true, would: true, go: true, here: true }))] }));
};
div >
;
{ /* Comparison View */ }
{
    compareMode && selectedForComparison.length >= 2 && (_jsx("div", { style: {
            marginBottom: 20,
            padding: 16,
            background: '#f0f9ff',
            ...
            (_jsx("h3", { style: { margin: '0 0 12px 0', color: '#0c4a6e', fontSize: 14 } > , Result: true, Comparison: true, h3: true, children: _jsx("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 } >
                ...
                ,
                    _jsx("div", { style: {
                            ...
                            { result, : .output?.substring(0, 100) }, div: true, children: ('executionTimeMs' in result) && (_jsx("div", { style: {
                                fontSize: 10,
                                color: '#6b7280',
                                marginTop: 4,
                            } >
                                { result, : .executionTimeMs }, ms: true })) })) }));
}
div >
;
;
...
;
{ /* Results List */ }
_jsx("ul", { style: { padding: 0, listStyle: 'none' } >
        { results, : .map((res, i) => {
                ...
                return (_jsxs("li", { onMouseEnter: () => onResultHover?.(i), style: {
                        ...
                        borderRadius: 12,
                        fontWeight: 600,
                    } > { res, : .seed }, span: true, children: [locked && (_jsx("span", { style: {
                                position: 'absolute',
                                top: -10,
                                left: 25,
                                background: '#f59e0b',
                ...
                , REGENERATING: true, span: true, children: [")}", _jsx("div", { style: {
                            position: 'absolute',
                            top: 8,
                            right: 8,
                            display: 'flex',
                            ...
                            { /* Compare selection */}, ...compareMode && (_jsx("button", { onClick: (e) => {
                                e.stopPropagation();
                                toggleComparisonSelection(i);
                            }, disabled: !selected && selectedForComparison.length >= 3, style: {
                                width: 20,
                                height: 20,
                                border: 'none',
                                borderRadius: 4,
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                        }, children: locked ? '🔒' : '🔓' }), _jsx("button", { onClick: (e) => {
                            e.stopPropagation();
                            if (!regenerating && !locked) {
                                handleResultAction('regenerate', i);
                            }
                        }, disabled: regenerating || locked, style: {
                            width: 20,
                            height: 20,
                            border: 'none',
                            borderRadius: 4,
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                        }, children: "\uD83D\uDCBE" })] })), { hasPath } && (_jsxs("div", { style: {
                    position: 'absolute',
                    top: -10,
                    right: -10,
                    background: '#10b981',
                    ...
                    PATH, div: true, children: [")}", regenerating && (_jsx("div", { style: {
                            position: 'absolute',
                            top: 0,
                            left: 0,
                            right: 0,
                            ...
                            _jsx("div", { style: { textAlign: 'center' } >
                                    _jsx("div", { style: { fontSize: 20, marginBottom: 4 } >  }) }) })), "\u27F3"] })
                ,
                    _jsx("div", { children: "Regenerating..." })), div >
            , div >
            ) }, ... })
    ,
        _jsxs("div", { style: { marginTop: 20, marginBottom: 8 } >
                { res, : .error ? (_jsxs("div", { style: { color: '#dc2626', fontSize: 14 } > , ...res.error, div: true, children: [") : (", _jsx("div", { style: {
                                    fontFamily: 'monospace',
                                    whiteSpace: 'pre-wrap',
                                    fontSize: 13,
                                    lineHeight: 1.4,
                                    ...
                                    { res, : .output || ('output' in res ? res.output : '') } })] })) :  }, div: true, children: [locked && (_jsx("div", { style: {
                        marginTop: 8,
                        padding: 6,
                        background: '#fef3c7',
                 ...
                 })), "\uD83D\uDD12 This result is locked and won't be affected by regeneration", lockedResults.find(l => l.index === i)?.note && (_jsx("div", { style: { marginTop: 2, fontStyle: 'italic' } >
                        Note })), ": ", lockedResults.find(l => l.index === i)?.note] });
div >
;
{ /* Execution metadata */ }
{
    hasPath && 'executionTimeMs' in res && (_jsx("div", { style: {
            marginTop: 8,
            padding: 6,
            background: '#e2e8f0',
            borderRadius: 4,
            ...
            Execution, ...res.executionTimeMs, ms: true, ...res.executionPath && (_jsx("span", { style: { marginLeft: 8 } >
            , ...res.executionPath.steps.length, steps: true, ...res.executionPath.randomizationPoints.length, random: true, points: true, span: true, children: ")}" })), ..., ...hasPath && 'weightChoices' in res && res.weightChoices && res.weightChoices.length > 0 && (_jsx("div", { style: {
                marginTop: 8,
                padding: 10,
                ...
                (_jsx("div", { style: {
                    ...
                    , Weight: true, Impact: true, Analysis: true })
                    ,
                        _jsx("span", { style: {
                                fontSize: 9,
                                fontWeight: 400,
    ...
    div >
        { res, : .weightChoices.map((choice, idx) => {
                ...
                return (_jsx("div", { style: {
                        ...
                        (_jsxs("div", { children: [_jsx("span", { style: { fontWeight: 600, color: '#1f2937' } >
                                        { choice, : .nodeId.slice(0, 12) } }), "..."] })
                            ,
                                _jsx("span", { style: { marginLeft: 4 } >
                                        "{choice.selectedOption}", span: true })), ...choice.selectionProbability && (_jsx("div", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 4,
                        } >
...
_jsx("div", { style: {
        ...
        _jsx("div", { style: { fontSize: 12, color: '#6b7280' } >
                { lockedResults, : .length > 0 && (_jsxs("span", { style: { marginRight: 16 } >
                        , ...lockedResults.length, locked: true, result: true, ...lockedResults.length !== 1 ? 's' : '', span: true, children: [")}", regeneratingResults.length > 0 && (_jsxs("span", { children: ["\u27F3 ", regeneratingResults.length, " regenerating"] }))] })
                        ,
                            _jsx("div", { style: { display: 'flex', gap: 8 } >
                                    { loading } && onCancel && (_jsx("button", { onClick: onCancel, style: {
                                        padding: '8px 16px',
                                        background: '#ef4444',
                                        color: '#fff',
                                        border: 'none',
                    ...
                    div } >
            , div: true, children: exportDialog.open && (_jsx("div", { children: "Export Options Dialog would go here" })) }), div: true, children: "); }; export default PreviewModal;" });
