                    ...
                    justifyContent: 'center',
                            ...
                            color: professionalColors.text.primary
                                    ...
                                    marginBottom: 16
                                                    ...
                                                    background: '#f7fafc',
                                                    borderRadius: 4
                                                }, children: [selectedForComparison.length, " of 3 selected"] }))] })] }), loading && _jsx("div", { style: { marginBottom: 12 }, children: "Generating content..." }), error && _jsxs("div", { style: { color: '#c00' }, children: ["Error: Something went wrong: ", error] }), !loading && !error && (_jsxs("div", { children: [showExecutionPaths && hasExecutionPaths && (_jsx("div", { style: { marginBottom: 20 }, children: _jsx("div", { children: "Placeholder" }) })), showVarianceAnalysis && results.length >= 2 && (_jsx("div", { style: { marginBottom: 20 }, children: _jsx("div", { children: "Variance Analysis would go here" }) })), compareMode && selectedForComparison.length >= 2 && (_jsxs("div", { style: {
                                            marginBottom: 20,
                                            padding: 16,
                                            background: '#f0f9ff',
                                            ...
                                            borderRadius: 8
                                                ...
                                                }) })] })), _jsxs("ul", { style: { padding: 0, listStyle: 'none' }, children: [results.map((res, i) => {
                                                ...
                                                return (_jsx("li", { onMouseEnter: () => onResultHover?.(i), style: {
                                                        marginBottom: 16,
                                                        padding: 12,
                                            ...
                                            }), ": 'absolute', top: -10, left: -10, background: res.error ? '#dc2626' : locked ? '#f59e0b' : '#4d7cff', color: '#fff', fontSize: 10, padding: '2px 6px', borderRadius: 12, fontWeight: 600 }} >", res.seed] }), locked && (_jsx("span", { style: {
                                            position: 'absolute',
                                            top: -10,
                                            left: 25,
                                            background: '#f59e0b',
                                            ...
                                            borderRadius: 6
                                                ...
                                                return (_jsx("div", { style: {
                                                        ...
                                                        alignItems: 'center'
                                                            >
                                                                _jsxs("div", { children: [_jsxs("span", { style: { fontWeight: 600, color: '#1f2937' }, children: [choice.nodeId.slice(0, 12), "..."] }), _jsxs("span", { style: { marginLeft: 4 }, children: ["\"", choice.selectedOption, "\""] })] })
                                                    }, ...choice.selectionProbability && (_jsxs("div", { style: {
                                                            display: 'flex',
                                                            alignItems: 'center',
                                                            gap: 4
...
{ /* Temporarily disabled ExportOptionsDialog */ }
{
    exportDialog.open && _jsx("div", { children: "Export Options Dialog would go here" });
}
div >
;
div >
