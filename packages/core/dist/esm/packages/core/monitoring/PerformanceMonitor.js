        ...
        AggregatedMetrics | null;
        {
            ...
            */
                ...
                */
                ...
                boolean;
                {
                        ...
                        */
                        ...
                        void {
                            ...
                            */
                            ...
                            } // Clean up every 1/10 of retention period
                            , // Clean up every 1/10 of retention period
                            getMemoryUsage() {
                            ...
                            : .metrics.size > this.config.maxMetricsHistory
                        };
                        {
                            ...
                            };
                            {
                                ...
                                metrics.nodeId,
                                    message;
                                `Very slow execution: ${metrics.duration.toFixed(2)}ms`;
                            }
                        }
                        details: {
                    ...
                    if (Math.abs(metrics.memoryUsage.delta) > this.config.memoryThreshold * 2) {
                        ...
                        metrics.nodeId,
                            message;
                        `High memory usage: ${(metrics.memoryUsage.delta / (1024 * 1024)).toFixed(2)}MB`;
                    }
                }
                details: {
            ...
            if (metrics.errors.length > 0) {
                ...
                metrics.nodeId,
                    message;
                `Node execution error: ${metrics.errors[0]}`;
            }
        }
        details: {
