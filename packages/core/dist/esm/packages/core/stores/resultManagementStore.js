...
recentActivity: Array < {
    ...
    resultId: string,
    details: string } > ;
getRecentResults: (limit) => SavedResult;
getTopRatedResults: (limit) => SavedResult;
...
set((state) => ({}), savedResults, {
    ...state.savedResults[id], savedResult
}, stats, { ...state.stats,
    recentActivity: [
        {
            type: 'save',
            ...
            setFilter: (filter) => {
                ...
                clearFilter: () => {
                    ...
                    setSorting: (sortBy, order) => {
                        ...
                        // Bulk Operations
                        bulkUpdateTags: (resultIds, tags) => { resultIds.forEach(id => get().tagResult(id, tags)); };
                        bulkUpdateWorkflow: (resultIds, workflow) => { resultIds.forEach(id => get().updateWorkflowStatus(id, workflow)); };
