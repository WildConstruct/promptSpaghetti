        ...
        class RateLimitService {
            ...
            constructor() {
                ...
                return {
                    ...
                    enforceComplexity(code, charset) {
                    ...
                    validateCodeFormat(code, format) {
                     ...
                     * Format code for user display
                     */
                    static formatCodeForDisplay(code, format) {
                        switch (format) {
