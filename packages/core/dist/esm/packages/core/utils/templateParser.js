...
}
{
    ...
    'Antagonist character',
        examples;
    ['sorcerer', 'criminal', 'monster'],
        priority;
    7,
        relatedVariables;
    ['threat', 'power', 'location'],
    ;
}
{
    name: 'hero',
    ...
    'Heroic character',
        examples;
    ['knight', 'space pilot', 'rebel leader'],
        priority;
    8,
    ;
}
{
    ...
    'Supporting character',
        examples;
    ['loyal friend', 'wise mentor', 'magical familiar'],
        priority;
    6,
    ;
}
...
// Settings (High Priority)
{
    ...
    'Where the scene takes place',
        examples;
    ['ancient forest', 'space station', 'city street'],
        priority;
    10,
        nodeTypes;
    ['output', 'concat'],
...
}
{
    ...
    'Type of landscape',
        examples;
    ['rocky mountains', 'desert', 'jungle'],
        priority;
    8,
        relatedVariables;
    ['weather', 'creature', 'danger'],
    ;
}
{
    name: 'setting',
    ...
    'Scene environment',
        examples;
    ['medieval castle', 'cyberpunk city', 'underwater'],
        priority;
    9,
        nodeTypes;
    ['output', 'concat'],
...
}
{
    ...
    'Weather conditions',
        examples;
    ['stormy night', 'bright sunshine', 'misty morning'],
        priority;
    7,
        relatedVariables;
    ['mood', 'time', 'location'],
...
}
{
    ...
    'Surrounding environment',
        examples;
    ['enchanted forest', 'alien world', 'post-apocalyptic wasteland'],
        priority;
    7,
    ;
}
{
    ...
    'Structure or building',
        examples;
    ['ancient temple', 'skyscraper', 'cottage'],
        priority;
    6,
    ;
}
// Actions (High Priority)
{
    ...
    'What is happening',
        examples;
    ['running', 'fighting', 'exploring'],
        priority;
    10,
        nodeTypes;
    ['output', 'concat'],
        relatedVariables;
    ['character', 'location', 'goal'],
    ;
}
{
    name: 'movement',
...
}
{
    ...
    'Struggle or conflict',
        examples;
    ['battle', 'argument', 'chase'],
        priority;
    7,
        relatedVariables;
    ['villain', 'hero', 'tension'],
    ;
}
{
    name: 'quest',
    ...
    'Mission or journey',
        examples;
    ['rescue mission', 'treasure hunt', 'pilgrimage'],
        priority;
    6,
        relatedVariables;
    ['goal', 'obstacle', 'location'],
    ;
}
// Moods and Atmosphere (Medium Priority)
{
    ...
    'Emotional atmosphere',
        examples;
    ['mysterious', 'romantic', 'tense'],
        priority;
    8,
        nodeTypes;
    ['output', 'concat'],
        relatedVariables;
    ['lighting', 'music', 'atmosphere'],
    ;
}
{
    name: 'tone',
...
}
{
    ...
    'Scene atmosphere',
        examples;
    ['eerie', 'peaceful', 'chaotic'],
        priority;
    7,
        relatedVariables;
    ['weather', 'lighting', 'sound'],
    ;
}
{
    name: 'emotion',
...
}
{
    ...
    'Level of suspense',
        examples;
    ['high suspense', 'calm before storm', 'explosive'],
        priority;
    6,
        relatedVariables;
    ['conflict', 'danger'],
...
// Objects (Medium Priority)
{
    ...
    'Important item',
        examples;
    ['magic sword', 'ancient book', 'spaceship'],
        priority;
    7,
        relatedVariables;
    ['character', 'power', 'quest'],
    ;
}
{
    name: 'prop',
...
}
{
    ...
    'Important relic',
        examples;
    ['ancient scroll', 'crystal orb', 'golden idol'],
        priority;
    5,
        relatedVariables;
    ['quest', 'power', 'mystery'],
...
// Cinematic (New Category)
{
    ...
    'Lighting condition',
        examples;
    ['golden hour', 'harsh shadows', 'soft moonlight'],
        priority;
    8,
        nodeTypes;
    ['output', 'concat'],
        relatedVariables;
    ['mood', 'time', 'atmosphere'],
    ;
}
{
    name: 'camera',
...
}
{
    ...
    'Visual composition',
        examples;
    ['rule of thirds', 'symmetrical', 'leading lines'],
        priority;
    6,
    ;
}
{
    ...
    'Color scheme',
        examples;
    ['warm tones', 'monochromatic blue', 'vibrant contrast'],
        priority;
    5,
    ;
}
// Temporal (New Category)
{
    ...
    'Time of day or period',
        examples;
    ['dawn', 'midnight', 'ancient times'],
        priority;
    7,
        relatedVariables;
    ['lighting', 'weather', 'mood'],
    ;
}
{
    name: 'era',
    ...
    'Historical period',
        examples;
    ['medieval times', 'far future', 'Victorian era'],
        priority;
    6,
        relatedVariables;
    ['setting', 'style'],
...
}
{
    ...
    'Season of the year',
        examples;
    ['spring bloom', 'winter frost', 'autumn colors'],
        priority;
    5,
        relatedVariables;
    ['weather', 'lighting'],
...
}
{
    ...
    'Length of time',
        examples;
    ['brief moment', 'eternal', 'fleeting seconds'],
        priority;
    4,
    ;
}
// Descriptive (New Category)
{
    ...
    'Scale or size',
        examples;
    ['massive', 'tiny', 'towering'],
        priority;
    6,
        relatedVariables;
    ['object', 'creature', 'building'],
    ;
}
{
    name: 'texture',
    ...
    'Surface quality',
        examples;
    ['rough stone', 'silky smooth', 'weathered wood'],
        priority;
    5,
        relatedVariables;
    ['object', 'setting'],
...
}
{
    ...
    'Color description',
        examples;
    ['crimson red', 'ethereal blue', 'golden yellow'],
        priority;
    6,
        relatedVariables;
    ['lighting', 'mood'],
...
// Narrative (New Category)
{
    ...
    'Objective or purpose',
        examples;
    ['save the kingdom', 'find the truth', 'escape danger'],
        priority;
    8,
        relatedVariables;
    ['character', 'quest', 'obstacle'],
    ;
}
{
    name: 'obstacle',
    ...
    'Challenge or barrier',
        examples;
    ['locked door', 'treacherous path', 'moral dilemma'],
        priority;
    7,
        relatedVariables;
    ['goal', 'conflict'],
...
}
{
    ...
    'Unknown element',
        examples;
    ['hidden secret', 'ancient curse', 'missing person'],
        priority;
    6,
        relatedVariables;
    ['goal', 'atmosphere'],
...
}
{
    ...
    'Plot revelation',
        examples;
    ['shocking truth', 'hidden identity', 'betrayal'],
        priority;
    5,
    ;
}
{
    ...
    'Central theme',
        examples;
    ['love conquers all', 'power corrupts', 'coming of age'],
        priority;
    6,
    ;
}
