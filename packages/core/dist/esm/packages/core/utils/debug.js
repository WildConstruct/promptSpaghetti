...
export const DEBUG_EPIC1 = DEBUG &&
    (process.env.REACT_APP_DEBUG_EPIC1 === 'true' ||
        (typeof window !== 'undefined' && window.localStorage?.getItem('DEBUG_EPIC1') === 'true'));
export const DEBUG_EXECUTION = DEBUG &&
    (process.env.REACT_APP_DEBUG_EXECUTION === 'true' ||
        (typeof window !== 'undefined' && window.localStorage?.getItem('DEBUG_EXECUTION') === 'true'));
/**
 ...
 */
export const debugLogEpic1 = (...args) => {
    if (DEBUG_EPIC1) {
        console.log(...args);
    }
};
 ...
 */
export const debugLogExecution = (...args) => {
    if (DEBUG_EXECUTION) {
        console.log(...args);
    }
};
