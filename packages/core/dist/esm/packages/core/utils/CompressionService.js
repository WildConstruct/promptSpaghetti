...
(function (CompressionAlgorithm) {
    ...
    CompressionAlgorithm[CompressionAlgorithm["export"] = void 0] = "export";
    CompressionAlgorithm[CompressionAlgorithm["enum"] = void 0] = "enum";
    CompressionAlgorithm[CompressionAlgorithm["CompressionLevel"] = void 0] = "CompressionLevel";
})(CompressionAlgorithm || (CompressionAlgorithm = {}));
{
    ...
    (function (DataType) {
        ...
        DataType[DataType["export"] = void 0] = "export";
        DataType[DataType["interface"] = void 0] = "interface";
        DataType[DataType["CompressionOptions"] = void 0] = "CompressionOptions";
    })(DataType || (DataType = {}));
    {
...
;
this.algorithmMap = new Map([])[CompressionAlgorithm.GZIP, new GzipProcessor()][CompressionAlgorithm.DEFLATE, new DeflateProcessor()][CompressionAlgorithm.BROTLI, new BrotliProcessor()][CompressionAlgorithm.NONE, new NoCompressionProcessor()];
;
// =============================================================================
...
compress(((data, options = {}) => {
    ...
    try: {
        ...
        if(metadata, checksum) {
             ...
             */
            async;
            compressJSON(data, object, level, CompressionLevel = CompressionLevel.BALANCED);
            Promise < CompressionResult > { return: this.compress(data, {}),
 ...
 */
async;
decompressJSON(data, Buffer, metadata ?  : CompressionMetadata);
Promise < any > { const: decompressed = await this.decompress(data, undefined, metadata),
 ...
 */
async;
decompressText(data, Buffer, algorithm ?  : CompressionAlgorithm);
Promise < string > { const: decompressed = await this.decompress(data, algorithm),
...
Promise < CompressionResult > { return: this.compress(css, {}),
    algorithm: CompressionAlgorithm.BROTLI,
 ...
 */
async;
compressJavaScript(js, string);
Promise < CompressionResult > { return: this.compress(js, {}),
    algorithm: CompressionAlgorithm.BROTLI,
    level: CompressionLevel.BALANCED,
...
if (compressedChunk.success) {
    ...
    if (opts.onProgress) {
         ...
         */
        async;
        selectOptimalAlgorithm(((data, dataType) => {
                        ...
                        */
                        ...
                        try {
                            ...
                            CompressionStats;
                            {
                                 ...
                                 */
                                resetStats();
                                void { this: .stats = this.initializeStats(),
                                    /**
        ...
        {
            abstract;
            compress(data, Buffer, options, CompressionOptions);
            Promise;
            abstract;
            decompress(data, Buffer);
            Promise;
