...
if (!this.componentDependencies.has(componentId)) {
    ...
    void {
                    ...
                    void {
                        ...
                        if(dependencies) {
                            for (const dep of dependencies) {
                                ...
                                batchUpdate(updates, StatePathUpdate);
                                void { const: allAffectedComponents = new Set(),
                            ...
                            StateSelector < T, R > {
                                ...
                                if(, memoize) {
                                    ...
                                    const memoizedSelector = (state) => {
                                        ...
                                        subscribe();
                                        selector: StateSelector;
                                        callback: (value, prevValue) => void options;
                                        {
                                            componentId ?  : string;
                                            immediate ?  : boolean;
        ...
        state: any,
        dependencies: (keyof), any, []: maxAge ?  : number,
        boolean
    };
    {
        // Check age
        if (maxAge && Date.now() - cached.timestamp > maxAge) {
            ...
            if (dependencies) {
                ...
                invalidateRelatedCaches(updates, StatePathUpdate);
                void {
                ...
                };
                {
                    ...
                    if (updates.some(update => key.includes(update.path))) {
                        ...
                        cleanupCache();
                        void {
                            : .selectorCache.size <= this.maxCacheSize, return: ,
