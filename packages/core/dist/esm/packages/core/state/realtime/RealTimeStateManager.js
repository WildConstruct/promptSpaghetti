                    ...
                    constructor(message, updateId) {
                        ...
                        export class RealTimeStateManager extends EventEmitter {
                            ...
                            constructor(config = {}) {
                                ...
                                Promise < void  > {
                                    : .connectionState.status === 'connected' || this.connectionState.status === 'connecting'
                                };
                                {
                                    return;
                            ...
                            async handleStateChangeMessage(message) {
                                ...
                                source: 'remote',
                                    optimistic;
                                syncMessage.payload.optimistic || false,
                                    clientId;
                                syncMessage.sessionId,
                                    timestamp;
