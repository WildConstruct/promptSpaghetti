...
export class StateDevTools extends EventEmitter {
    ...
    constructor(config = {}) {
        ...
        this.dependencyGraph = {
            ...
            }, : .stateHistory = this.stateHistory.slice(-this.config.maxHistorySize),
        ...
        StateValidationResult;
        {
            ...
            try {
                ...
                if (deep && typeof state === 'object') {
                    ...
                    createReplayEnvironment(changes, StateChange < any > []);
                    ReplayEnvironment;
                    {
                                    ...
                                    void {
                                        ...
                                        detectMemoryLeaks(state, domain, warnings) {
                                            ...
                                            if (size > 1024 * 1024) { // 1MB threshold
                                                ...
                                                path: 'root',
                                                    message;
                                                `Large state object detected in ${domain}`;
                                            }
                                        },
                                    ...
                                    number;
                                    {
                                            ...
                                            : .config.enablePerformanceTracking };
                                        {
                                            ...
                                            void {
                                                ...
                                                for(, [key, value], of, Object) { }, : .entries(metrics)
                                            };
                                            {
