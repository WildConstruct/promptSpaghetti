...
export class TimeTravel extends EventEmitter {
    ...
    constructor(config = {}) {
        ...
        recordStateSnapshot(snapshot, (StateSnapshot), domain, string, options, {});
        description ?  : string;
        tags ?  : string;
        marker ?  : Omit;
    }
...
return entryId;
recordStateChange(change, (StateChange), domain, string, options, {});
description ?  : string;
tags ?  : string;
{ }
string;
                        ...
                        boolean;
                        {
                            ...
                            boolean;
                            {
                                    ...
                                    metadata;
                                {
                                    ...
                                    false,
                                        color;
                                    options.color || this.generateRandomColor();
                                }
                            }
                            ;
...
boolean;
{
    ...
    if (session.autoPlay) {
        ...
        return true;
        stepReplay(sessionId, string, direction, 'forward' | 'backward', 'forward');
        boolean;
        { }
        const session = this.replaySessions.get(sessionId);
                    ...
                    if (!fromEntry || !toEntry) {
                        ...
                        boolean;
                        {
                            ...
                            if (removed) {
                                ...
                                return removed;
                                // Query and search
                                queryTimeline(query, TimelineQuery);
                                TimelineEntry;
                                {
                                                            ...
                                                            if(mainBranch) {
                                                                ...
                                                                any;
                                                                {
                                                                    ...
                                                                    void {
                                                                        ...
                                                                        const: globalTimeTravel = new TimeTravel()
                                                                    };
                                                                }
                                                            } };
                                                    } };
