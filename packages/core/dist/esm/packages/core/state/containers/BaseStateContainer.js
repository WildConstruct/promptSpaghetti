...
if (this.config.enablePersistence) {
    ...
    T;
    {
        ...
        setState(updater, (StateUpdater) | (Partial), changeInfo ?  : Partial);
        void {
            : .isUpdating
        };
        {
            ...
            finally // Profile the state update if performance profiling is enabled
             { }
            ;
            ...
            try { }
                ...
                void {
                    ...
                    clearHistory() { this.history = [this.history[this.history.length - 1]]; 
                            ...
                            if (!validation.valid) {
                                ...
                                if (this.config.enableHistory) {
                                    ...
                                    for (const middleware of this.middleware) {
                                        ...
                                        try { }
                                        catch (error) { // Run error middleware
                                            for (const middleware of this.middleware) {
