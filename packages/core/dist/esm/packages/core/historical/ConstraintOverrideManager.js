                        ...
                        if (override.expires_at && new Date(override.expires_at) < now) {
                            ...
                            */
                            ...
                            boolean;
                            {
                                ...
                                */
                                removeConstraintOverrides(constraintId, string);
                                number;
                                {
                                    let removed = 0;
                                    for (const [id, override] of this.overrides.entries()) {
                                            ...
                                            if (filters.constraintId && override.constraint_id !== filters.constraintId) {
                                                ...
                                                if (filters.userId && override.user_id !== filters.userId) {
                                                    ...
                                                    if (filters.fromDate && override.created_at < filters.fromDate) {
                                                         ...
                                                         */
                                                        calculateAuthenticityImpact(constraintIds, string);
                                                        number;
                                                        {
                                                            let totalImpact = 0;
                                                            ...
                                                            for (const constraintId of constraintIds) {
                                                                ...
                                                                else if (override) { // Default impact for overridden constraints
                                                                    totalImpact += 0.1;
                                                                ...
                                                                context: {
                                                                    ...
                                                                    {
                                                                        constraint: HistoricalConstraint, suggestedReason;
                                                                        OverrideReason;
                                                                    }
                                                                    [];
                                                                    {
                                                                        ...
                                                                        for (const constraint of constraints) { // Suggest overrides for less critical constraints in creative contexts
                                                                            if (constraint.enforcement === 'suggestion' || constraint.enforcement === 'warning') {
                                                                                ...
                                                                                ;
                                                                                if (context.narrativeNeeds?.includes('visual_impact') && constraint.rule === 'social_class_appropriateness') {
                                                                                    suggestedReason = {
                                                                                        category: 'narrative',
                                                                                ...
                                                                                ;
                                                                                if (constraint.rule === 'cultural_appropriateness' && context.creativeGoals?.includes('educational')) {
                                                                                    suggestedReason = {
                                                                                                                ...
                                                                                                                if (conditions.social_classes && context.socialClasses) {
                                                                                                                    ...
                                                                                                                    if (!classMatch) {
                                                                                                                        ...
                                                                                                                        boolean;
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            formatOverrideReason(reason, OverrideReason);
                                                                                                                            string;
                                                                                                                            {
