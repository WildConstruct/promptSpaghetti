...
export class NodeMetadataManager {
     ...
     * Get metadata for a specific node
     */
    getNodeMetadata(nodeId) { return this.nodeMetadata.get(nodeId); 
        /**
...
this.nodeMetadata.set(nodeId, metadata);
{
    ...
    void { const: metadata = this.getNodeMetadata(nodeId),
        if(metadata) {
...
if (isMatch) {
    ...
    EraTag;
    {
        ...
        getEraDefinition(id, string);
        EraTag | undefined;
        {
            return this.eraDefinitions.get(id);
            getErasByPeriod(year, number);
            EraTag;
            {
                ...
                GenreTag;
                {
                    ...
                    StyleTag;
                    {
                        ...
                        applyTagInheritance(sourceNodeId, string),
                            targetNodeId;
                        string,
                            sourceNodeType;
                        string,
                        ...
                        void {
                            ...
                            */
                            ...
                            return: true };
                        ;
                        applyTagTransformation(sourceMetadata, NodeMetadata),
                            targetNodeId;
                        string,
                            transformation;
                        TagTransformation;
                            ...
                            switch(transformation) { }, : .type };
                        {
                            ...
                            if (tagsToInherit.length > 0) {
                                this.addNodeTags(targetNodeId, tagsToInherit.map(tag => ({}), ...tag));
                            }
