 ...
 */
import { DataSource, HistoricalQuery, HistoricalQueryResult, UTDGNode } from UTDGNodeType;
from;
'../types/UTDG';
export class ExternalDataService {
    ...
    registerDataSource(dataSource) {
         ...
         */
        unregisterDataSource(sourceId, string);
        void { delete: this.dataSources[sourceId],
         ...
         */
        async;
        queryHistoricalData(query, HistoricalQuery, sourceIds ?  : string);
        Promise < HistoricalQueryResult > { const: startTime = performance.now(),
                    ...
                    try {
                        ...
                        if (rateLimiter && !rateLimiter.canMakeRequest()) {
                            ...
                            try {
                                 ...
                                 */
                                async;
                                importFromSource(sourceId, string, query, HistoricalQuery);
                                Promise < UTDGNode > {
                                    ...
                                    if(, source) {
                                        ...
                                        Promise < { valid: boolean, error: string, sample_data: any } > {
                                            const: source = this.dataSources[sourceId],
                                            if(, source) {
                                            ...
                                            clearCache(sourceId) {
                                                ...
                                                getCacheStats();
                                                {
                                                    total_entries: number, total_size;
                                                    number, hit_rate;
                                                    number;
                                                }
                                                {
