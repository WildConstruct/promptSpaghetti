...
export class MedievalDemoDatabase {
    ...
    */
    ...
    generateOutfit(criteria) {
        ...
        }).filter(item => item.medieval_specific.garment_type === 'chemise' ||
        ...
        if (undergarments.length > 0) {
            ...
            }).filter(item => item.medieval_specific.garment_type === 'tunic' ||
    ...
    */
    createMedievalClothing() {
        ...
        'A simple woolen tunic reaching to mid-thigh, made of coarse brown wool with minimal decoration. The sleeves are long and loose, practical for farm work.',
            description;
        'Basic peasant tunic for daily wear',
            metadata;
        {
            ...
            0.9,
                source;
            'Archaeological evidence from 12th-13th century England',
                tags;
            ['tunic', 'peasant', 'wool', 'brown', 'daily-wear'],
                social_class;
            ['peasant'],
                gender;
            'male',
        ...
        relationships: {
            compatible: ['medieval_peasant_braies_001', 'medieval_peasant_belt_001'],
                incompatible;
            ['medieval_noble_silk_001', 'medieval_royal_purple_001'],
                variations;
            [,
                {
            ...
            metadata;
        {
            ...
            0.95,
                source;
            'Court records and artistic depictions, 13th-14th century',
                tags;
            ['gown', 'noble', 'wool', 'blue', 'embroidered', 'formal'],
                social_class;
            ['noble'],
                gender;
            'female',
            ...
            metadata;
        {
            ...
            0.98,
                source;
            'Monastic rules and surviving garments',
                tags;
            ['robe', 'religious', 'wool', 'brown', 'simple', 'monastic'],
                social_class;
            ['clergy'],
                gender;
            'male',
        ...
        relationships: {
            compatible: ['medieval_rope_belt_001'],
                incompatible;
            ['medieval_noble_silk_001', 'medieval_bright_colors_001'],
                variations;
            [],
            ;
        }
    ...
    createMedievalMaterials() {
        ...
        'Coarse woolen cloth woven from sheep\'s wool, the most common fabric in medieval Europe. Available in natural colors and dyed with local plants.',
            description;
        'Basic wool fabric for medieval clothing',
            metadata;
        {
            ...
            0.95,
                source;
            'Archaeological textile remains and historical records',
                tags;
            ['wool', 'fabric', 'common', 'sheep', 'woven'],
                social_class;
...
UTDGNode;
{
    ...
    'accessory',
        content;
    'A sturdy leather belt with an iron buckle, used to cinch tunics and carry pouches or tools.',
        description;
    'Basic leather belt for medieval clothing',
        metadata;
    {
        era: [MEDIEVAL_PERIODS.HIGH_MEDIEVAL, MEDIEVAL_PERIODS.LATE_MEDIEVAL],
            authenticity;
