    ...
    try {
        ...
        if (!stored) {
            ...
            try { }
                ...
                return [];
                updateLastAccess(projectName, string);
                void {};
                try {
                    ...
                    try { }
                        ...
                        removeRecentProject(projectName, string);
                        void {};
                        try {
                            const recentProjects = this.getRecentProjects();
                            ...
                            try {
                                ...
                                generateThumbnail(nodes, any, edges, any);
                                string;
                                {
                                    try {
                                    ...
                                    for (const key in localStorage) {
                                        if (localStorage.hasOwnProperty(key)) {
                                            ...
                                            try {
                                                ...
                                                void { const: data, RecentProjectsData = {
                                                        projects,
                                                        version: this.STORAGE_VERSION }
                                                };
                                                localStorage.setItem(this.STORAGE_KEY, JSON.stringify(data));
                                                generateProjectId(name, string);
                                                string;
                                                {
