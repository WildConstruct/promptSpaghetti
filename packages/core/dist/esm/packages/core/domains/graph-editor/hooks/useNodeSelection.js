...
export const useNodeSelection = () => {
    ...
    const actions = useGraphEditorStore((state) => ({}), selectNodes, state.selectNodes, clearSelection, state.clearSelection, toggleNodeSelection, state.toggleNodeSelection);
};
