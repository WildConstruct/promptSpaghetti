...
initializeTracking();
void {
    : .conversionConfig.enableRealTimeStreaming
};
{
...
;
async;
trackTouchpoint(channel, string, source, string, medium, string, properties, (Record) = {});
Promise < boolean > {
