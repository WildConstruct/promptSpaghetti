...
(function (WSMessageType) {
    ...
    WSMessageType[WSMessageType["export"] = void 0] = "export";
    WSMessageType[WSMessageType["const"] = void 0] = "const";
    WSMessageType[WSMessageType["WSMessageSchema"] = WSMessageType.z.object({})] = "WSMessageSchema";
    WSMessageType[WSMessageType["type"] = void 0] = "type";
    WSMessageType[WSMessageType["z"] = void 0] = "z";
    WSMessageType[WSMessageType["nativeEnum"] = void 0] = "nativeEnum";
...
z.number().min(1).max(1000).default(1),
    batchTimeoutMs;
z.number().min(100).max(10000).default(1000),
    includeMetadata;
...
try { }
        ...
        } };
    {
        ...
        if (this.metricsTimer) {
            ...
            for (const client of this.clients.values()) {
                ...
                try { }
                    ...
                    */
                    ...
                    Promise < void  > {
                        ...
                        : .clients.size >= this.config.maxConnections };
                    {
                ...
                async;
                handleAuthentication(client, ClientConnection, payload, any);
                Promise < void  > {
                    try: {
                        const: { token } = payload,
                        if(, token) {
  ...
  error:`, error);
                        ...
                        */
                        ...
                        config: SubscriptionConfig, void:  > {
                            try: {
                    ...
                    if (!eventAuth.allowed) {
                        ...
                        if (eventAuth.filteredEvent) {
                            ...
                            Promise < void  > {
                                ...
                                payload: {
                                    subscriptionId,
                                    events: config.includeMetadata ? events : events.map(e => ({}), id, e.id, type, e.type, timestamp, e.timestamp, data, e.data)
                                },
                        ...
                        ;
                        eventMatchesFilter(event, UnifiedAnalyticsEvent, filter ?  : EventFilter);
                        boolean;
                        {
                            if (!filter)
                                return true;
                                                    ...
                                                    */
                                                    ...
                                                    getStats() {
                                                        ...
                                                        Array < {
                                                            ...
                                                            return: Array.from(this.clients.values()).map(client => ({}), id, client.id, isAuthenticated, client.isAuthenticated, subscriptions, client.subscriptions.size, lastHeartbeat, client.lastHeartbeat, ipAddress, client.ipAddress)
                                                        };
                                                        ;
                                                        /**
                                                         ...
                                                         */
                                                        async;
                                                        broadcastMessage(message, WSMessage, filter ?  : (client) => boolean);
                                                        Promise < void  > {
