...
(function (WebSocketMessageType) {
    WebSocketMessageType["ANALYTICS_UPDATE"] = "analytics_update";
    WebSocketMessageType["COST_ALERT"] = "cost_alert";
    WebSocketMessageType["BUDGET_ALERT"] = "budget_alert";
    WebSocketMessageType["PERFORMANCE_METRIC"] = "performance_metric";
    WebSocketMessageType["USER_ACTIVITY"] = "user_activity";
    WebSocketMessageType["SYSTEM_STATUS"] = "system_status";
    WebSocketMessageType["RECOMMENDATION"] = "recommendation";
    ...
    */
    WebSocketMessageType[WebSocketMessageType["export"] = void 0] = "export";
    WebSocketMessageType[WebSocketMessageType["interface"] = void 0] = "interface";
    WebSocketMessageType[WebSocketMessageType["WebSocketMessage"] = void 0] = "WebSocketMessage";
...
(function (ConnectionState) {
    ...
    ConnectionState[ConnectionState["class"] = void 0] = "class";
    ConnectionState[ConnectionState["WebSocketClient"] = void 0] = "WebSocketClient";
    ConnectionState[ConnectionState["extends"] = void 0] = "extends";
    ConnectionState[ConnectionState["EventEmitter"] = void 0] = "EventEmitter";
    ...
    constructor(config, (Partial) = {});
    {
                ...
                if (this.heartbeatTimer) {
                    ...
                    if (this.reconnectTimer) {
                        ...
                        if (this.socket) {
                            ...
                            */
                            subscribe(topic, string, config ?  : Partial);
                            Promise < void  > {
                                return: new Promise((resolve, reject) => {
        ...
        };
        {
            ...
            if (event.code !== 1000 && this.reconnectAttempts < this.config.maxReconnectAttempts) {
                ...
                {
                    WebSocketMessageType.ANALYTICS_UPDATE;
                    this.emit('analytics_update', message.data);
                    break;
                    WebSocketMessageType.COST_ALERT;
                    this.emit('cost_alert', message.data);
                    break;
                    WebSocketMessageType.BUDGET_ALERT;
                    ...
                    break;
                    WebSocketMessageType.RECOMMENDATION;
        ...
        } !== 'undefined';
        {
            ...
            export class AnalyticsWebSocketClient extends WebSocketClient {
                ...
                setupAnalyticsListeners() {
                     ...
                     */
                    export const createAnalyticsWebSocketClient = (config = {}) => {
