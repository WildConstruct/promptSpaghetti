  ...
  completed:`, {}, total, sourceData.length, migrated, migratedRecords, failed, failedRecords, duration, `${duration}ms`);
                        ...
                        try { }
                            ...
                            };
                            {
                                ...
                                ;
                                async;
                                transformRecord(((record, transformationRules) => {
                                    const transformed = {
                                        data: {},
                                        metadata: {}
                                    };
                                 ...
                                 * Apply individual transformation rule
                                 */
                                private, async, applyTransformationRule(((record, rule) => {
                                ...
                                try { }
                                    ...
                                    return false;
                                    async;
                                    validateTransformedEvent(((transformedEvent, originalRecord) => {
                                        const errors = [];
                                        // Basic validation
                                    ...
                                    async;
                                    performFinalValidation(((systemName, expectedCount) => {
                                        const errors = [];
                                        try {
                                                    ...
                                                    if (progress && progress.status === MigrationStatus.PAUSED) {
                                                        ...
                                                        void {
                                                            ...
                                                            getTransformationRules(systemName) {
                                                                 ...
                                                                 */
                                                                async;
                                                                migrateAllSystems(((systemsData, config = {}) => {
                                                                    const migrationIds = {};
