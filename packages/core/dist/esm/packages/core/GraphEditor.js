...
import { helpContentManager } from './components/ContextualHelp';
...
return (_jsxs(DemoModeManager, { initialConfig: {
        ...
        console.log('Demo mode changed:', config);
                    ...
                    }, children: selectedNode && (_jsx("div", { style: {
  ...
  opacity: 1;
      ...
      ` }), _jsx(DirectorPreviewToolbar, { nodes: nodes, edges: edges, isPreviewOpen: previewOpen, onPreviewToggle: () => {
            ...
            , enabled: true, autoTrigger: true, showProgressiveHints: true, onHelpContentViewed: contentId => {
                ...
                zIndex: 9999,
            }, children: _jsx(ProfessionalSpinner, { type: "dots", size: 48, color: "#ff7c00", message: isCreatingNode ? 'Creating node...' : 'Generating previews...' }) })), process.env.NODE_ENV === 'development' && (_jsxs("div", { className: "development-only", style: {
                position: 'fixed',
                top: 10,
                left: 10,
                ...
                gap: '8px',
                        ...
                        fontSize: '14px',
                        fontWeight: '500',
                    }, children: "\uD83D\uDCCA Analyze Graph" }), _jsx("button", { onClick: () => {
                        ...
                        fontSize: '14px',
                        fontWeight: '500',
                    }, children: "\u2699\uFE0F Settings" }), _jsx("button", { onClick: () => {
                        ...
                        fontSize: '14px',
                        fontWeight: '500',
                    }, children: "\uD83D\uDCC8 Monitor" })] })), nodeCreationAnimation && (_jsx("div", { className: "animate-node-create-overlay", style: {
                position: 'fixed',
                pointerEvents: 'none',
                zIndex: 1000,
                width: 200,
