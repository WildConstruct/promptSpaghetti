...
const injectSafeStyles = () => {
  ...
  const GraphEditorInner = ({ initialNodes, initialEdges, validateConnection }) => {
    ...
    const NodeRender = useMemo(() => {
      const NodeRenderComponent = props => {
        ...
        if (isPerformanceGood) {
          ...
          return _jsx(SmoothNodeWrapper, {
            id: props.id,
            data: props.data,
            selected: selectedNodeId === props.id,
            nodeType: props.data?.nodeType || 'default',
            isSelected: selectedNodeId === props.id,
            onNodeClick: setSelectedNodeId,
            children: _jsx(InnerNode, {
              id: props.id,
              data: props.data,
              selected: selectedNodeId === props.id,
        ...
        if (shouldUseVariablePorts) {
          return _jsx(VariablePortNodeRenderer, {
            id: props.id,
            data: props.data,
            selected: selectedNodeId === props.id,
            onSelect: setSelectedNodeId,
    ...
    const selectedSchema =
      selectedNode && selectedNode.data?.nodeType ? (nodeSchemas[selectedNode.data.nodeType] ?? null) : null;
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsxs(ReactFlow, {
                    ...
                    zoomOnScroll: true,
                    panOnDrag: [1, 2],
                    selectionOnDrag: nodes.length < 100,
                    ...
                    connectionLineType:
                      viewport.zoom > 0.5 ? ConnectionLineType.SmoothStep : ConnectionLineType.Straight,
                  ...
                  _jsx(StickyNotesManager, { disabled: false, readonly: false }),
                  _jsx(NodeLabelsManager, { disabled: false, readonly: false, selectedNodeId: selectedNodeId }),
                  _jsx(RegionGroupsManager, { disabled: false, readonly: false }),
                  _jsx(ConnectionAnnotationsLayer, { canEdit: true, showTooltips: true, visible: true }),
                  _jsxs('div', {
                    style: {
                      position: 'absolute',
                      bottom: 10,
                    ...
                    children: [
                      _jsxs('div', {
                        style: { fontWeight: 600, marginBottom: 4, color: '#e2e8f0' },
                        children: ['\uD83D\uDDB1\uFE0F Controls ', showControls ? '▼' : '▶'],
                      }),
                      showControls &&
                        _jsxs('div', {
                          ...
                          children: [
                            _jsxs('div', {
                              children: [_jsx('b', { children: 'Pan:' }), ' Left-click + drag on canvas'],
                            }),
                            _jsxs('div', {
                              children: [_jsx('b', { children: 'Zoom:' }), ' Mouse wheel / trackpad scroll'],
                            }),
                            _jsxs('div', { children: [_jsx('b', { children: 'Select:' }), ' Click node'] }),
                            _jsxs('div', {
                              children: [_jsx('b', { children: 'Multi-select:' }), ' Shift/Ctrl + Click'],
                            }),
                            _jsxs('div', { children: [_jsx('b', { children: 'Connect:' }), ' Drag from output port'] }),
                            _jsxs('div', {
                              children: [_jsx('b', { children: 'Delete:' }), ' Select + Delete/Backspace'],
                            }),
                            _jsxs('div', {
                              children: [_jsx('b', { children: 'Alternative Pan:' }), ' Middle-click + drag'],
                            }),
                          ],
                        }),
                    ],
              ...
              _jsx('div', {
                ...
                children:
                  ...
                  _jsx('div', {
                    ...
                    children: isPerformanceGood
                      ? _jsx(SmoothInspectorPanel, {
                          node: selectedNode,
      ...
      `,
          ...
          (previewLoading || isCreatingNode) &&
            _jsx('div', {
              ...
              children: _jsx(ProfessionalSpinner, {
                type: 'dots',
                size: 48,
                color: '#ff7c00',
          ...
          _jsx(SaveProjectDialog, {
            isOpen: saveDialogOpen,
            onClose: () => setSaveDialogOpen(false),
            onSave: handleSaveSuccess,
          }),
          _jsx(LoadProjectDialog, {
            isOpen: loadDialogOpen,
            onClose: () => setLoadDialogOpen(false),
            onLoad: handleLoadSuccess,
          }),
          _jsx(UnsavedChangesDialog, {
          ...
          _jsx(SaveTemplateDialog, {
            isOpen: saveTemplateDialogOpen,
            onClose: () => setSaveTemplateDialogOpen(false),
            onSave: handleTemplateSave,
          }),
          _jsx(TemplateBrowser, {
