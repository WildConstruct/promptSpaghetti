                                                ...
                                                };
                                                {
                                                    ...
                                                    if (updates.styling) {
                                                        ...
                                                        if (updates.behavior) {
                                                            ...
                                                            async;
                                                            destroy();
                                                            Promise < void  > { await: this.executeLifecycleHook('beforeDestroy'),
                                                                ...
                                                                : .analytics };
                                                            {
                                                                ...
                                                                if (this.iframe) {
                                                                    ...
                                                                    if (this.communicationChannel) {
                                                                        ...
                                                                        void { : .config.behavior.communication.enabled };
                                                                        {
                                                                            return;
                                                                            const message = {
                                                                                type,
                                                                                ...
                                                                                async updateData(data) {
                                                                                    if (!this.config.content.data) {
                                                                                        ...
                                                                                        void {
                                                                                            ...
                                                                                            : .config.behavior.lifecycle.persistState
                                                                                        };
                                                                                        {
                                                                                            this.persistState();
                                                                                            getState(key ?  : string);
  ...
  animation: ${animation.type} ${animation.duration}ms ${animation.easing};}
    ...
    if (this.container) {
        ...
        if (interaction.throttle) {
            ...
            createInteractionHandler(interaction, InteractionConfig);
            EventListener;
            {
                return (event) => {
                    ...
                    if (interaction.condition && !this.evaluateCondition(interaction.condition)) {
                        ...
                        ;
                        executeAction(action, InteractionAction, event, Event);
                        void { switch(action) { }, : .type };
                        {
                            'navigate';
                            if (action.params.url) {
                                ...
                                if (action.callback) {
                                    ...
                                    void { if(message) { }, : .embedId !== this.config.id };
                                    {
                                        return;
                                                ...
                                                if (this.container) {
                                                    ...
                                                    };
                                                    {
                                                        ...
                                                        if (this.config.security.rateLimit?.enabled) {
                                                            this.setupRateLimit();
                                                            async;
                                                            executeLifecycleHook(stage, LifecycleHook['stage']);
                                                            Promise < void  > {};
                                                            ...
                                                            for (const hook of hooks) {
                                                                try {
                                                                    ...
                                                                    try { }
                                                                        ...
                                                                        showLoadingState();
                                                                        void { const: loadingConfig = this.config.behavior.loading,
                                                                            if(loadingConfig) { }, : .skeleton?.enabled };
                                                                        {
                                                                            this.showSkeleton();
                                                                        }
                                                                        if (loadingConfig.spinner) {
                                                                            this.showSpinner();
                                                                        }
