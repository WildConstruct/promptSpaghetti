...
export var BaselineCategory;
(function (BaselineCategory) {
    BaselineCategory["CORE_ENGINE"] = "core_engine";
    BaselineCategory["API_PERFORMANCE"] = "api_performance";
    BaselineCategory["UI_RENDERING"] = "ui_rendering";
    BaselineCategory["MEMORY_USAGE"] = "memory_usage";
    BaselineCategory["NETWORK_IO"] = "network_io";
    BaselineCategory["DATABASE"] = "database";
    BaselineCategory["BUILD_PERFORMANCE"] = "build_performance";
    BaselineCategory["LOAD_TESTING"] = "load_testing";
    // Performance measurement types
    BaselineCategory[BaselineCategory["export"] = void 0] = "export";
    BaselineCategory[BaselineCategory["enum"] = void 0] = "enum";
    BaselineCategory[BaselineCategory["MeasurementType"] = void 0] = "MeasurementType";
})(BaselineCategory || (BaselineCategory = {}));
{
    ...
    (function (TestEnvironment) {
        ...
        TestEnvironment["CI_CD"] = "ci_cd";
        TestEnvironment["LOCAL"] = "local";
        // Performance baseline measurement schema
        TestEnvironment[TestEnvironment["export"] = void 0] = "export";
        TestEnvironment[TestEnvironment["const"] = void 0] = "const";
        TestEnvironment[TestEnvironment["PerformanceMeasurementSchema"] = TestEnvironment.z.object({})] = "PerformanceMeasurementSchema";
        TestEnvironment[TestEnvironment["id"] = void 0] = "id";
        TestEnvironment[TestEnvironment["z"] = void 0] = "z";
        TestEnvironment[TestEnvironment["string"] = void 0] = "string";
    })(TestEnvironment || (TestEnvironment = {}));
    (),
        name;
    z.string(),
        category;
    z.nativeEnum(BaselineCategory),
        type;
    z.nativeEnum(MeasurementType),
        value;
    z.number(),
        unit;
    z.string(),
...
z.string(),
    // Baseline thresholds
    target;
z.number(), // Target performance value,
    warning;
z.number(), // Warning threshold,
    critical;
z.number(), // Critical threshold,
    // Baseline statistics
    baseline;
z.number(), // Current baseline value,
    minimum;
z.number().optional(), // Minimum acceptable value,
    maximum;
z.number().optional(), // Maximum acceptable value,
    // Metadata
    environment;
z.nativeEnum(TestEnvironment),
    createdAt;
...
z.array(z.string()),
    // Historical data
    measurements;
z.array(PerformanceMeasurementSchema),
    // Configuration
    enabled;
z.boolean(),
    alerting;
...
z.nativeEnum(TestEnvironment),
    baselines;
z.array(PerformanceBaselineSchema),
    metadata;
z.object({});
...
}
{
     ...
     */
    addMeasurement(baselineId, string, measurement, (Omit));
    void {
         ...
         */
        updateBaselineStatistics(baselineId) {
            const baseline = this.baselines.get(baselineId);
            ...
            PerformanceBaseline | undefined;
            {
                 ...
                 */
                getBaselinesByCategory(category, BaselineCategory);
                PerformanceBaseline;
                {
...
isLowerBetter(category, BaselineCategory, type, MeasurementType);
boolean;
{
    ...
    switch (category) {
        ...
        default:
            ...
            getTrend(baselineId, string, days, number = 7);
            {
                            ...
                            metadata: {
                                ...
                                import(collection) {
                                    for (const baseline of collection.baselines) {
                                        ...
                                        */
                                        ...
                                        void {
                                            ...
                                            const: createDefaultBaselines = (manager) => {
                                                ...
                                                'Simple Graph Execution',
                                                    description;
                                                'Time to execute a simple graph with basic nodes',
                                                    category;
                                                BaselineCategory.CORE_ENGINE,
                                                    type;
                                                MeasurementType.DURATION,
                                                    unit;
                                                'ms',
                                        ...
                                        'Graph Execution Throughput',
                                            description;
                                        'Number of graph executions per second',
                                            category;
                                        BaselineCategory.CORE_ENGINE,
                                            type;
                                        MeasurementType.THROUGHPUT,
                                    ...
                                    'Preview API Response Time',
                                        description;
                                    'Time for preview endpoint to generate variants',
                                        category;
                                    BaselineCategory.API_PERFORMANCE,
                                        type;
                                    MeasurementType.DURATION,
                                        unit;
                                    'ms',
                ...
                'Heap Memory Usage',
                    description;
                'Peak heap memory usage during execution',
                    category;
                BaselineCategory.MEMORY_USAGE,
                    type;
                MeasurementType.MEMORY,
                    unit;
                'MB',
            ...
            'Graph Memory Storage',
                description;
            'Memory usage for storing large graphs',
                category;
            BaselineCategory.MEMORY_USAGE,
                type;
            MeasurementType.MEMORY,
    ...
    'TypeScript Compilation Time',
        description;
    'Time to compile TypeScript to JavaScript',
        category;
    BaselineCategory.BUILD_PERFORMANCE,
        type;
    MeasurementType.DURATION,
        unit;
    's',
...
'Production Bundle Size',
    description;
'Size of production JavaScript bundle',
    category;
BaselineCategory.BUILD_PERFORMANCE,
    type;
MeasurementType.BYTES,
...
'Requests Per Second',
    description;
'Maximum requests per second under load',
    category;
BaselineCategory.LOAD_TESTING,
    type;
MeasurementType.THROUGHPUT,
