...
import { PerformanceBudgetManager, PerformanceSnapshot, BudgetCheckResult } from defaultPerformanceBudget;
from;
'./PerformanceBudget';
;
          ...
          `;
                                                ...
                                                if (latestData.snapshot.memory.peak > 120) { // 120MB threshold
                                                    ...
                                                    'Optimize Memory Usage',
                                                        description;
                                                    'High memory usage detected. Implement memory optimization strategies to prevent performance degradation.',
                                                        estimatedImpact;
                                                    {
                                                        scoreImprovement: 10,
                                                            sizeReduction;
          ...
          `;
                                                ...
                                                if (latestData.snapshot.api.graphExecution > 800) { // 800ms threshold
                                                    ...
                                                    'Optimize Graph Execution Performance',
                                                        description;
                                                    'Graph execution is taking longer than expected. Implement caching and optimization strategies.',
                                                        estimatedImpact;
                                                    {
                                                        scoreImprovement: 20,
                                                            timeReduction;
            ...
            }, violations.forEach(violation => { }), this.createAlert({}), type, 'budget-violation', severity, 'critical')
        };
...
;
;
processAlerts(budgetResult, BudgetCheckResult);
void {
...
};
{
    ...
    type: 'performance-degradation',
        severity;
    budgetResult.score < 50 ? 'critical' : 'high',
        title;
...
autoResolvable: this.config.autoOptimize,
    actions;
this.getScoreImprovementActions();
;
...
void { const: alert, DashboardAlert = {},
...
if (this.alerts.length > 100) {
    ...
    AlertAction;
    {
        ...
        calculateSystemStatus(budgetResult, BudgetCheckResult);
        'healthy' | 'warning' | 'critical';
        {
            ...
            Promise < void  > { console, : .log('📊 Generating performance report...'),
