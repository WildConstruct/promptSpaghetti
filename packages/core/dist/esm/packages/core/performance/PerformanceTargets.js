...
multiplier_warning: , 1.5: multiplier_critical, 2.0:  }, staging: { // Production-like targets but slightly more lenient
multiplier_warning: , 1.2: multiplier_critical, 1.5:  }, production: { // Strict production targets
multiplier_warning: , 1.0: multiplier_critical, 1.0:  } };
/**
 * Device-specific adjustments
 */
export const deviceAdjustments = { 'high-end': {
