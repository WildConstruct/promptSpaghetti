...
export const corePerformanceKPIs = [
...
}
{
    ...
    'Time to Interactive',
        description;
    'Time until page is fully interactive and responsive',
        category;
    'runtime',
        unit;
    'milliseconds',
...
// === API PERFORMANCE KPIs ===
{
    ...
    'Graph Execution Time',
        description;
    'Time to execute prompt graph from start to completion',
        category;
    'api',
        unit;
    'milliseconds',
...
}
{
    ...
    'Preview Generation Time',
        description;
    'Time to generate preview results for graph execution',
        category;
    'api',
        unit;
    'milliseconds',
...
}
{
    ...
    'Graph Validation Time',
        description;
    'Time to validate graph structure and connections',
        category;
    'api',
        unit;
    'milliseconds',
...
}
{
    ...
    'API Request Throughput',
        description;
    'Number of API requests processed per second',
        category;
    'api',
        unit;
    'requests/second',
...
// === BUNDLE SIZE KPIs ===
{
    ...
    'Main Bundle Size',
        description;
    'Size of the main application bundle',
        category;
    'bundle',
        unit;
    'kilobytes',
...
}
{
    ...
    'Total Bundle Size',
        description;
    'Combined size of all application bundles',
        category;
    'bundle',
        unit;
    'kilobytes',
...
// === MEMORY KPIs ===
{
    ...
    'Peak Memory Usage',
        description;
    'Maximum memory consumption during typical usage',
        category;
    'memory',
        unit;
    'megabytes',
...
}
{
    ...
    'Memory Leak Rate',
        description;
    'Rate of memory growth indicating potential leaks',
        category;
    'memory',
        unit;
    'megabytes/hour',
...
// === NETWORK KPIs ===
{
    ...
    'Total Transfer Size',
        description;
    'Total bytes transferred for initial page load',
        category;
    'network',
        unit;
    'kilobytes',
...
}
{
    ...
    'Initial Request Count',
        description;
    'Number of network requests for initial page load',
        category;
    'network',
        unit;
    'requests',
...
// === BUILD PERFORMANCE KPIs ===
{
    ...
    'Build Time',
        description;
    'Time for complete application build',
        category;
    'build',
        unit;
    'seconds',
...
}
{
    ...
    'Test Execution Time',
        description;
    'Time to run complete test suite',
        category;
    'build',
        unit;
    'seconds',
...
// === USER EXPERIENCE KPIs ===
{
    id: 'ux_graph_creation_time',
        name;
    'Graph Creation Flow Time',
        description;
    'End-to-end time to create and test a new graph',
        category;
    'user-experience',
        unit;
    'seconds',
...
}
{
    ...
    'User-Facing Error Rate',
        description;
    'Percentage of user actions resulting in errors',
        category;
    'user-experience',
        unit;
    'percentage',
        ...
        runtime_cls: {
            ...
            api_throughput: {
                ...
                memory_peak_usage: {
                     ...
                     */
                    function: calculateKPIStatus(kpiId, string, value, number), 'excellent':  | 'good' | 'warning' | 'critical' } } }
