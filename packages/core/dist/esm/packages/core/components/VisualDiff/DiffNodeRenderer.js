...
const getLabel = () => {
    ...
    ;
    return;
    _jsxs("div", { style: getNodeStyle(), children: [getBadge(), _jsxs("div", { children: [_jsx("div", { className: "font-medium", children: getLabel() }), originalNode.type && ()
                        < div, " className=\"text-xs opacity-75 mt-1\">", originalNode.type, getChangesCount()] }), ")}", showMetadata && ()
                < div, " className=\"mt-2 text-xs\">", _jsxs("div", { className: "opacity-75", children: ["Side: ", side] }), originalNode.position && ()
                < div, " className=\"opacity-75\"> Position: (", Math.round(originalNode.position.x), ", ", Math.round(originalNode.position.y), ")"] });
};
div >
;
{ /* Change Details */ }
{
    ...
    className = "mt-2 text-xs" >
        (_jsx("div", { className: "font-medium opacity-75 mb-1", children: "Changes:" })
            ,
                _jsx("div", { className: "space-y-1", children: Object.entries(changeDetails).slice(0, 3).map(([key, change]) => ()
                        < div, key = { key }, className = "opacity-75" >
                        (_jsxs("span", { className: "font-medium", children: [key, ":"] })
                            ,
                                _jsx("span", { className: "ml-1", children: typeof change === 'object' && change !== null
