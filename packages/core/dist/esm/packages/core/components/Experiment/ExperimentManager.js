...
_jsxs("div", { className: "space-y-3", children: [filteredExperiments.map((experiment) => ()
            ...
            (_jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: state.selectedExperiments.includes(experiment.id), onChange: () => toggleExperimentSelection(experiment.id), className: "rounded" }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-2 mb-1", children: [_jsx("h3", { className: "font-semibold text-lg", children: experiment.name }), _jsx(Badge, { variant: getStatusVariant(experiment.status), children: experiment.status }), _jsx(Badge, { variant: "outline", children: experiment.type })] }), _jsx("p", { className: "text-sm text-gray-600 mb-2 line-clamp-2", children: experiment.hypothesis }), _jsxs("div", { className: "flex items-center space-x-4 text-xs text-gray-500", children: [_jsxs("span", { className: "flex items-center", children: [_jsx(Users, { className: "w-3 h-3 mr-1" }), experiment.variants.length, " variants"] }), _jsxs("span", { className: "flex items-center", children: [_jsx(BarChart, { className: "w-3 h-3 mr-1" }), experiment.metrics.length, " metrics"] }), _jsxs("span", { className: "flex items-center", children: [_jsx(Clock, { className: "w-3 h-3 mr-1" }), formatDuration(), "experiment.createdAt, experiment.status === 'completed' ? experiment.schedule?.endAt : undefined )}"] }), _jsxs("span", { className: "flex items-center", children: [_jsx(Calendar, { className: "w-3 h-3 mr-1" }), experiment.updatedAt.toLocaleDateString()] })] }), experiment.tags.length > 0 && ()
                                            ...
                                            { tag })] }), "))}"] }), ")}"] }) })
                ,
                    _jsxs("div", { className: "flex items-center space-x-2", children: [experiment.status === 'completed' && ()
                                < Button, " size=\"sm\" variant=\"outline\" onClick=", () => onViewResults(experiment.id), ">", _jsx(Eye, { className: "w-4 h-4 mr-1" }), "Results"] }))), experiment.status === 'draft' && ()
            < Button, " size=\"sm\" onClick=", () => onStartExperiment(experiment.id), ">", _jsx(Play, { className: "w-4 h-4 mr-1" }), "Start"] });
{
    ...
    variant = "outline";
    onClick = {}();
    onPauseExperiment(experiment.id);
}
 >
    _jsx(Pause, { className: "w-4 h-4 mr-1" });
Pause;
Button >
;
_jsx(Button, { size: "sm", variant: "outline", onClick: () => onEditExperiment(experiment.id), children: _jsx(Edit, { className: "w-4 h-4" }) })
    ,
        _jsx(Button, { size: "sm", variant: "outline", onClick: () => onDuplicateExperiment(experiment.id), children: _jsx(Copy, { className: "w-4 h-4" }) });
div >
;
div >
;
...
div >
    { filteredExperiments, : .length === 0 && ()
            < Card >
            _jsxs(CardContent, { className: "text-center py-8", children: [_jsx("div", { className: "text-gray-500", children: "No experiments found matching your criteria" }), _jsxs(Button, { className: "mt-4", onClick: () => onCreateExperiment(), children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Your First Experiment"] })] }),
        Card } >
;
TabsContent >
    { /* Templates Tab */}
...
value = "templates";
className = "space-y-4" >
    (_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Experiment Templates" }), _jsxs(Button, { variant: "outline", children: [_jsx(Upload, { className: "w-4 h-4 mr-2" }), "Import Template"] })] })
        ,
            _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: [templates.map((template) => ()
                        < Card, key = { template, : .id }, className = "hover:shadow-md transition-shadow cursor-pointer", onClick = {}()), " => onCreateExperiment(template)}>", _jsx(CardHeader, { className: "pb-3", children: _jsxs("div", { className: "flex justify-between items-start", children: [_jsx(CardTitle, { className: "text-base", children: template.name }), _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(Star, { className: "w-4 h-4 text-yellow-500" }), _jsxs("span", { className: "text-sm", children: [template.successRate.toFixed(1), "%"] })] })] }) }), _jsxs(CardContent, { children: [_jsx("p", { className: "text-sm text-gray-600 mb-3 line-clamp-2", children: template.description }), _jsxs("div", { className: "flex items-center justify-between text-xs text-gray-500", children: [_jsxs("span", { children: [template.variants.length, " variants"] }), _jsxs("span", { children: [template.timesUsed, " uses"] }), _jsx(Badge, { variant: "outline", children: template.category })] }), _jsxs("div", { className: "mt-3", children: [_jsx("div", { className: "text-xs text-gray-500 mb-1", children: "Avg Uplift" }), _jsx(Progress, { value: template.averageUplift, className: "h-2" }), _jsxs("div", { className: "text-xs text-gray-500 mt-1", children: ["+", template.averageUplift.toFixed(1), "%"] })] })] })] }));
div >
;
TabsContent >
    { /* Knowledge Base Tab */}
...
value = "knowledge";
className = "space-y-4" >
    (_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Experiment Insights & Learnings" }), _jsxs("div", { className: "flex space-x-2", children: [_jsxs(Select, { defaultValue: "all", children: [_jsx(SelectTrigger, { className: "w-40", children: _jsx(SelectValue, { placeholder: "Category" }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "all", children: "All Categories" }), _jsx(SelectItem, { value: "prompt", children: "Prompt Optimization" }), _jsx(SelectItem, { value: "performance", children: "Performance" }), _jsx(SelectItem, { value: "cost", children: "Cost Optimization" })] })] }), _jsx(Input, { placeholder: "Search insights...", className: "w-64" })] })] })
        ,
            _jsx("div", { className: "space-y-4", children: knowledgeBase.map((entry) => ()
                    < Card, key = { entry, : .id } >
                    (_jsx(CardHeader, { className: "pb-3", children: _jsxs("div", { className: "flex justify-between items-start", children: [_jsx(CardTitle, { className: "text-base", children: entry.title }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsxs(Badge, { variant: entry.impact === 'high' ? 'default' : 'secondary', children: [entry.impact, " impact"] }), _jsx(Badge, { variant: "outline", children: entry.category })] })] }) })
                        ,
                            _jsxs(CardContent, { children: [_jsx("p", { className: "text-sm text-gray-600 mb-3", children: entry.summary }), entry.insights.length > 0 && ()
                                        < div, " className=\"mb-3\">", _jsx("div", { className: "text-sm font-medium mb-1", children: "Key Insights:" }), _jsx("ul", { className: "text-sm text-gray-600 list-disc list-inside space-y-1", children: entry.insights.slice(0, 2).map((insight, index) => ()
                                            < li, key = { index } > { insight }) }), "))}"] }))) }));
_jsxs("div", { className: "flex items-center justify-between text-xs text-gray-500", children: [_jsxs("span", { children: ["Confidence: ", (entry.confidence * 100).toFixed(0), "%"] }), _jsx("span", { children: entry.createdAt.toLocaleDateString() }), _jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(ExternalLink, { className: "w-3 h-3 mr-1" }), "View Experiment"] })] });
CardContent >
;
Card >
;
...
value = "analytics";
className = "space-y-6" >
    _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Experiments Over Time" }) }), _jsx(CardContent, { children: _jsx("div", { className: "h-64 flex items-center justify-center text-gray-500", children: "Chart showing experiment creation and completion trends" }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Success Rate by Type" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [['prompt', 'graph', 'feature_flag'].map(type => { }), "const typeExperiments = experiments.filter(e => e.type === type); const successRate = typeExperiments.length > 0 ; ? (typeExperiments.filter(e => e.status === 'completed').length / typeExperiments.length) * 100 : 0; return;", _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("span", { className: "text-sm capitalize", children: type }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(Progress, { value: successRate, className: "w-20 h-2" }), _jsxs("span", { className: "text-sm text-gray-600 w-12", children: [successRate.toFixed(0), "%"] })] })] }, type), "); })}"] }) })] })] });
{ /* Additional Analytics Cards */ }
_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsx(Card, { children: _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-green-600", children: experiments.filter(e => e.status === 'completed').length }), _jsx("div", { className: "text-sm text-gray-600", children: "Successful Experiments" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "text-2xl font-bold text-blue-600", children: [Math.round(), "experiments.reduce((acc) exp ) => acc + exp.variants.length, 0) / experiments.length) || 0}"] }), _jsx("div", { className: "text-sm text-gray-600", children: "Avg Variants per Experiment" })] }) }) }), _jsx(Card, { children: _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-purple-600", children: templates.length }), _jsx("div", { className: "text-sm text-gray-600", children: "Available Templates" })] }) }) })] });
TabsContent >
;
Tabs >
;
