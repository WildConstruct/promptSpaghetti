        ...
        const renderFilters = () => {
            ...
            _jsxs("div", { style: {
                    ...
                    flexWrap: 'wrap'
                                    ...
                                    fontWeight: '500',
                                    color: '#374151'
                                }, children: "Sort:" }), _jsx("select", { value: sortOrder, onChange: (e) => setSortOrder(e.target.value), style: {
                                    padding: '6px 12px',
                                    border: '1px solid #d1d5db',
                                    borderRadius: '6px',
                                    fontSize: '14px',
                                    ...
                                    >
                                        (_jsx("option", { value: "trending", children: "\uD83D\uDD25 Trending" })
                                            ,
                                                _jsx("option", { value: "recent", children: "\uD83D\uDD52 Most Recent" })
                                                    ,
                                                        _jsx("option", { value: "top_rated", children: "\u2B50 Top Rated" })
                                                            ,
                                                                _jsx("option", { value: "controversial", children: "\uD83D\uDCAC Most Controversial" })
                                                                    ,
                                                                        _jsx("option", { value: "oldest", children: "\uD83D\uDCC5 Oldest First" })) })] })] });
            { /* Refresh Button */ }
            _jsx("button", { onClick: () => loadTrendingComments(), disabled: isLoading, style: {
                    padding: '6px 12px',
...
{ /* Load More Button */ }
{
 ...
 >
    _jsx("button", { onClick: handleLoadMore, disabled: isLoading, style: {
            ...
            >
                { isLoading, 'Loading...': 'Load More Comments' }, button: true });
div >
;
div >
;
