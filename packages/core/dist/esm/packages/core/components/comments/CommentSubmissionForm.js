...
style = {};
{
 ...
 >
    _jsxs("button", { onClick: handleCancel, disabled: isSubmitting, style: {
            padding: '8px 16px',
            backgroundColor: 'transparent',
            border: '1px solid #d1d5db',
            borderRadius: '6px',
            ...
            >
                Cancel, button: true, children: [_jsx("button", { onClick: handleSubmit, disabled: disabled || isSubmitting || !content.trim(), style: {
                    padding: '8px 16px',
...
const AttachmentPreview = ({ attachment, onRemove }) => {
    ...
    _jsxs("div", { style: {
            ...
            borderRadius: '6px',
            fontSize: '12px'
        }, children: [attachment.type === 'image' && attachment.preview ? ()
                < img
                :
            , "src=", attachment.preview, "alt=", attachment.name, "style=", {
                width: '24px',
                height: '24px',
                objectFit: 'cover',
                borderRadius: '4px'
                            ...
                            whiteSpace: 'nowrap'
                        }, children: attachment.name }), attachment.size && ()
                        < div, " style=", { color: '#6b7280', fontSize: '11px' }, ">", formatFileSize(attachment.size)] }), ")}"] });
    { /* Remove button */ }
