    ...
    (_jsxs("div", { style: {
            ...
            gap: '12px',
                    ...
                    cursor: 'pointer',
                        ...
                        }, onChange: (e) => handleSelectAll(e.target.checked), style: { margin: 0 } }), "Select all visible"] })] })
        ,
            _jsxs("div", { style: {
                    display: 'flex',
                    gap: '6px',
...
style = {};
{
    marginBottom: index < comments.length - 1 ? '12px' : 0;
}
/>;
div >
;
...
style = {};
{
 ...
 >
    (_jsxs("div", { children: ["Showing ", comments.length, " of ", stats.total, " comments"] })
        ,
            _jsxs("div", { children: ["Avg Quality: ", stats.avgQuality.toFixed(1), " \u2022 Avg Toxicity: ", (stats.avgToxicity * 100).toFixed(1), "%", stats.lastProcessed && (()), " \u2022 Updated ", stats.lastProcessed.toLocaleTimeString()] }));
div >
;
div >
;
            ...
            }, "> \u2705"] });
{
    hasPermission('moderation:reject') && ()
        < button;
    onClick = {}();
    onAction({ type: 'reject', reason: 'Manual rejection' });
}
style = {};
{
    padding: '2px 6px',
...
;
{
    hasPermission('moderation:flag') && ()
        < button;
    onClick = {}();
    onAction({ type: 'flag', reason: 'Manual flag' });
}
style = {};
{
    padding: '2px 6px',
...
style = {};
{
 ...
 >
    _jsx(TrendingCommentCard, { comment: comment, rank: 0, onEngagement: () => { }, showReplies: expanded, isReply: false });
div >
;
div >
;
