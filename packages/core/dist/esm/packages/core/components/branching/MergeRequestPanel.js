...
;
return;
_jsxs(Card, { size: "small", style: { marginBottom: '8px' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }, children: [_jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }, children: [_jsx(Text, { strong: true, children: mergeRequest.title }), _jsx(Tag, { color: getStatusColor(mergeRequest.status), children: mergeRequest.status.toUpperCase() })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '8px' }, children: [_jsxs(Space, { size: "small", children: [_jsx(BranchesOutlined, {}), _jsx(Text, { code: true, style: { fontSize: '11px' }, children: "source \u2192 target" })] }), _jsxs(Space, { size: "small", children: [_jsx(UserOutlined, {}), _jsx(Text, { type: "secondary", style: { fontSize: '11px' }, children: "Created by User" })] }), _jsxs(Space, { size: "small", children: [_jsx(ClockCircleOutlined, {}), _jsx(Text, { type: "secondary", style: { fontSize: '11px' }, children: formatDate(mergeRequest.createdAt) })] })] }), mergeRequest.description && ()
                            < Text, " type=\"secondary\" style=", { fontSize: '12px' }, ">", mergeRequest.description] }), ")}", _jsx("div", { style: { marginTop: '8px' }, children: _jsxs(Space, { children: [_jsx(Badge, { count: mergeRequest.commitsCount, size: "small", children: _jsx(Tag, { size: "small", children: "Commits" }) }), _jsx(Badge, { count: mergeRequest.filesChanged, size: "small", children: _jsx(Tag, { size: "small", children: "Files" }) }), _jsx(Badge, { count: mergeRequest.reviewers.length, size: "small", children: _jsx(Tag, { size: "small", children: "Reviewers" }) })] }) })] }), _jsx(Dropdown, { overlay: menu, trigger: ['click'], children: _jsx(Button, { type: "text", size: "small", icon: _jsx(MoreOutlined, {}) }) })] });
Card >
;
;
;
...
width = { 800:  }
    ...
    < div >
    (_jsx(Title, { level: 4, children: selectedMergeRequest.title })
        ,
            _jsx("div", { style: { marginBottom: '16px' }, children: _jsx(Tag, { color: getStatusColor(selectedMergeRequest.status), children: selectedMergeRequest.status.toUpperCase() }) })
                ,
                    _jsx(Text, { children: selectedMergeRequest.description })
                        ,
                            _jsx(Divider, {})
                                ,
                                    _jsxs("div", { children: [_jsx(Text, { strong: true, children: "Changes:" }), _jsx("div", { style: { marginTop: '8px' }, children: _jsxs(Space, { children: [_jsxs(Tag, { children: [selectedMergeRequest.commitsCount, " commits"] }), _jsxs(Tag, { children: [selectedMergeRequest.filesChanged, " files changed"] }), _jsxs(Tag, { children: ["+", selectedMergeRequest.additionsCount, " additions"] }), _jsxs(Tag, { children: ["-", selectedMergeRequest.deletionsCount, " deletions"] })] }) })] })
                                        ,
                                            _jsx(Divider, {})
                                                ,
                                                    _jsxs("div", { children: [_jsx(Text, { strong: true, children: "Reviews:" }), _jsxs("div", { style: { marginTop: '8px' }, children: [selectedMergeRequest.reviewers.length > 0 ? ()
                                                                        < Text > Reviews : , " pending from ", selectedMergeRequest.reviewers.length, " reviewers"] }), ") : ()", _jsx(Text, { type: "secondary", children: "No reviewers assigned" }), ")}"] }));
div >
;
div >
;
