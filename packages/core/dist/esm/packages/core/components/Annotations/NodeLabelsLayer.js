...
;
return;
_jsx("div", { ref: layerRef, "data-testid": "node-labels-layer", style: {
        position: 'absolute',
        top: 0,
        left: 0,
        width: '100%',
...
{ /* Instructions overlay when no labels exist */ }
{
    ...
    onMouseEnter = {}(e);
    {
        ...
        >
            (_jsx("div", { style: { fontWeight: 'bold', marginBottom: '4px' }, children: "Node Labels" })
                ,
                    _jsxs("div", { style: { lineHeight: 1.4 }, children: ["\u2022 Press ", _jsx("kbd", { style: { background: 'rgba(),
                                    255: ,
                                    255: ,
                                    255:  } }), "0.2 )', padding: '2px 4px', borderRadius: '3px' }}>L"] }));
    to;
    label;
    selected;
    node
