...
export const NodeAnnotationSystem = ({
    nodeId,
    nodeName,
    nodeType,
    annotations,
...
_jsxs(Card, { className: `annotation-card ${typeConfig.borderColor} ${expanded ? 'ring-2 ring-blue-200' : ''}`, children: ["}", _jsxs(CardHeader, { className: "pb-3", children: [_jsx("div", { className: "flex items-start justify-between", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "p-1.5 rounded-full", style: { backgroundColor: `${typeConfig.color}20`, color: typeConfig.color }, children: typeConfig.icon }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "font-medium text-gray-900", children: typeConfig.label }), _jsx(Badge, { variant: "secondary", className: `text-xs ${priorityConfig.bg}`, style: { color: priorityConfig.color }, children: priorityConfig.label })] }), _jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-500 mt-1", children: [_jsx("span", { children: annotation.author.name }), _jsx("span", { children: "\u2022" }), _jsx("span", { children: new Date(annotation.timestamp).toLocaleDateString() }), annotation.estimatedTime && ()
                                                ...
                                                (_jsx("span", { children: "\u2022" })
                                                    ,
                                                        _jsxs("span", { children: [annotation.estimatedTime, "h est."] }))] }), ")}"] })] }) }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs(Select, { value: annotation.status, onValueChange: (value) => handleStatusChange(annotation.id, value), children: [_jsx(SelectTrigger, { className: "w-32 h-8", children: _jsxs("div", { className: "flex items-center gap-1", children: [statusConfig.icon, _jsx("span", { className: "text-xs", children: statusConfig.label })] }) }), _jsx(SelectContent, { children: Object.entries(STATUS_CONFIGS).map(([status, config]) => ()
                                    < SelectItem, key = { status }, value = { status } >
                                    _jsxs("div", { className: "flex items-center gap-2", children: [config.icon, _jsx("span", { children: config.label })] })) }), "))}"] }) }), _jsx(Button, { variant: "ghost", size: "sm", onClick: () => setSelectedAnnotation(), selectedAnnotation: true }), " === annotation.id ? null : annotation.id )} >", _jsx(MoreHorizontal, { className: "w-4 h-4" })] })] });
div >
;
CardHeader >
    _jsxs(CardContent, { className: "pt-0", children: [_jsxs("div", { className: "space-y-3", children: [_jsx("div", { className: "text-sm text-gray-700 whitespace-pre-wrap", children: annotation.content }), annotation.tags.length > 0 && ()
                        < div, " className=\"flex flex-wrap gap-1\">", annotation.tags.map(tag => ()
...
{ /* Attachments */ }
{
    ...
    className = "flex flex-wrap gap-2" >
        { annotation, : .attachments.map(attachment => ()
                ...
                { attachment, : .type === 'image' && _jsx(ImageIcon, { className: "w-3 h-3" }) }, { attachment, : .type === 'link' && _jsx(Link, { className: "w-3 h-3" }) }
...
{ /* Assignee & Deadline */ }
{
    ...
    className = "flex items-center gap-4 text-xs text-gray-500" >
        { annotation, : .assignee && ()
                ...
                (_jsx(User, { className: "w-3 h-3" })
                    ,
                        _jsx("span", { children: annotation.assignee.name })),
            div } >
    ;
}
{
    ...
    className = "flex items-center gap-1" >
        (_jsx(Clock, { className: "w-3 h-3" })
            ,
                _jsx("span", { children: new Date(annotation.deadline).toLocaleDateString() }));
    div >
    ;
}
div >
...
{ /* Replies */ }
{
    ...
    className = "border-t pt-3" >
        _jsxs(Button, { variant: "ghost", size: "sm", onClick: () => setShowReplies(!showReplies), className: "text-xs", children: [showReplies ? 'Hide' : 'Show', " ", annotation.replies.length, " replies"] });
    {
        showReplies && ()
            < div;
        className = "mt-2 space-y-2" >
            { annotation, : .replies.map(reply => ()
                    ...
                    (_jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-500 mb-1", children: [_jsx("span", { className: "font-medium", children: reply.author.name }), _jsx("span", { children: new Date(reply.timestamp).toLocaleDateString() })] })
                        ,
                            _jsx("div", { className: "text-sm text-gray-700", children: reply.content })), div >
                ) };
        { /* Reply Input */ }
        _jsxs("div", { className: "flex gap-2 mt-3", children: [_jsx("input", { type: "text", placeholder: "Add a reply...", value: replyContent, onChange: (e) => setReplyContent(e.target.value), className: "flex-1 px-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500", onKeyDown: (e) => e.key === 'Enter' && handleReplySubmit() }), _jsx(Button, { size: "sm", onClick: handleReplySubmit, disabled: !replyContent.trim(), children: "Reply" })] });
        div >
        ;
    }
    div >
...
if (compact) {
    ...
    return;
    _jsxs("div", { className: `node-annotations-compact ${className}`, children: ["}", _jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(MessageCircle, { className: "w-4 h-4 text-gray-600" }), _jsxs("span", { className: "text-sm font-medium text-gray-900", children: ["Annotations (", filteredAndSortedAnnotations.length, ")"] })] }), _jsx(Button, { variant: "outline", size: "sm", onClick: () => setIsCreating(true), children: _jsx("span", { className: "text-xs", children: "Add" }) })] }), _jsx("div", { className: "space-y-2 max-h-64 overflow-y-auto", children: filteredAndSortedAnnotations.map(annotation => ()
                    < div, key = { annotation, : .id }, className = "p-2 border rounded text-xs" >
                    (_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [ANNOTATION_TYPES[annotation.type].icon, _jsx("span", { className: "font-medium", children: annotation.author.name }), _jsx(Badge, { variant: "secondary", className: "text-xs", children: annotation.status })] })
                        ,
                            _jsx("div", { className: "text-gray-600 line-clamp-2", children: annotation.content }))) }), "))}", filteredAndSortedAnnotations.length === 0 && ()
                < div, " className=\"text-xs text-gray-500 text-center py-4\"> No annotations found"] });
}
div >
;
div >
...
_jsxs("div", { className: `node-annotation-system ${className}`, children: ["}", _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(MessageCircle, { className: "w-5 h-5 text-blue-600" }), _jsx("span", { children: "Node Annotations" })] }), _jsx(Badge, { variant: "secondary", className: "px-2", children: nodeName })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { variant: "outline", size: "sm", onClick: () => setShowResolved(!showResolved), children: showResolved ? _jsx(EyeOff, { className: "w-4 h-4" }) : _jsx(Eye, { className: "w-4 h-4" }) }), _jsxs(Button, { variant: "default", size: "sm", onClick: () => setIsCreating(true), children: [_jsx(Edit3, { className: "w-4 h-4 mr-2" }), "New Annotation"] })] })] }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-3 mt-4", children: [_jsxs("div", { className: "bg-blue-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-blue-900", children: stats.total }), _jsx("div", { className: "text-xs text-blue-700", children: "Total" })] }), _jsxs("div", { className: "bg-amber-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-amber-900", children: stats.open }), _jsx("div", { className: "text-xs text-amber-700", children: "Open" })] }), _jsxs("div", { className: "bg-red-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-red-900", children: stats.critical }), _jsx("div", { className: "text-xs text-red-700", children: "Critical" })] }), _jsxs("div", { className: "bg-green-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-green-900", children: stats.myAnnotations }), _jsx("div", { className: "text-xs text-green-700", children: "Mine" })] }), _jsxs("div", { className: "bg-purple-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-purple-900", children: stats.assigned }), _jsx("div", { className: "text-xs text-purple-700", children: "Assigned" })] })] })] }), _jsxs(CardContent, { children: [_jsxs(Tabs, { defaultValue: "annotations", className: "w-full", children: [_jsxs(TabsList, { className: "grid w-full grid-cols-3", children: [_jsx(TabsTrigger, { value: "annotations", children: "Annotations" }), _jsx(TabsTrigger, { value: "create", children: "Create New" }), _jsx(TabsTrigger, { value: "filters", children: "Filters" })] }), _jsxs(TabsContent, { value: "annotations", className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2 text-sm", children: [_jsx("span", { children: "Sort by:" }), _jsxs(Select, { value: sortBy, onValueChange: (value) => setSortBy(value), children: [_jsx(SelectTrigger, { className: "w-32", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "timestamp", children: "Recent" }), _jsx(SelectItem, { value: "priority", children: "Priority" }), _jsx(SelectItem, { value: "status", children: "Status" })] })] })] }), _jsxs("div", { className: "space-y-3", children: [filteredAndSortedAnnotations.map(annotation => ()
    ...
    ,
        _jsxs(TabsContent, { value: "filters", className: "space-y-4", children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium mb-2", children: "Type" }), _jsxs(Select, { value: filterType, onValueChange: setFilterType, children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "all", children: "All Types" }), Object.entries(ANNOTATION_TYPES).map(([type, config]) => ()
                                            ...
                                            < SelectItem, key = { status }, value = { status } >
                                            _jsxs("div", { className: "flex items-center gap-2", children: [config.icon, _jsx("span", { children: config.label })] }))] }), "))}"] })] })] })
            ,
                _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium mb-2", children: "Priority" }), _jsxs(Select, { value: filterPriority, onValueChange: setFilterPriority, children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "all", children: "All Priorities" }), Object.entries(PRIORITY_CONFIGS).map(([priority, config]) => ()
                                            < SelectItem, key = { priority }, value = { priority } >
                                            _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2 h-2 rounded-full", style: { backgroundColor: config.color } }), _jsx("span", { children: config.label })] }))] }), "))}"] })] });
div >
;
div >
;
