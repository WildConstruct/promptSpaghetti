...
import { REGION_GROUP_COLORS } from '../../types/CollaborationTypes';
{
...
color: groupPreferences.defaultColor || defaultColor.primary,
    backgroundColor;
groupPreferences.defaultBackgroundColor || defaultColor.background,
    opacity;
groupPreferences.defaultOpacity,
    bounds;
groupBounds,
    nodeIds;
selectedNodes,
...
true,
    style;
groupPreferences.defaultStyle,
    visibility;
groupPreferences.defaultVisibility,
    borderWidth;
2,
    showLabel;
groupPreferences.showLabels,
    showNodeCount;
groupPreferences.showNodeCounts,
    isLocked;
false,
    zIndex;
regionGroups.length,
...
return;
_jsx(_Fragment, { children: _jsxs("div", { ref: layerRef, "data-testid": "region-groups-layer", style: {
            position: 'absolute',
            top: 0,
            left: 0,
            width: '100%',
