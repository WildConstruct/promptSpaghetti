    ...
    _jsxs("div", { style: {
            ...
            boxShadow: '0 10px 25px rgba(0, 0, 0, 0.5)'
                            ...
                            fontSize: 12
                                    ...
                                    color: '#e2e8f0',
                                    fontSize: 12
                                } })] }), _jsxs("div", { children: [_jsx("label", { style: { display: 'block', color: '#e2e8f0', fontSize: 12, marginBottom: 4 }, children: "Position" }), _jsx("select", { value: labelPosition, onChange: (e) => setLabelPosition(e.target.value), style: {
                                    width: '100%',
                                    padding: 6,
                                    background: '#1a202c',
                                    border: '1px solid #4a5568',
                                    ...
                                    >
                                        (_jsx("option", { value: "start", children: "Start" })
                                            ,
                                                _jsx("option", { value: "center", children: "Center" })
                                                    ,
                                                        _jsx("option", { value: "end", children: "End" })
                                                            ,
                                                                _jsx("option", { value: "25", children: "25%" })
                                                                    ,
                                                                        _jsx("option", { value: "75", children: "75%" })) })] })] })] })
        ,
            _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', color: '#e2e8f0', fontSize: 12, marginBottom: 4 }, children: "Text Color" }), _jsx("input", { type: "color", value: color, onChange: (e) => setColor(e.target.value), style: {
                                    width: '100%',
                                    padding: 2,
                                    background: '#1a202c',
                                    border: '1px solid #4a5568',
