...
_jsxs(_Fragment, { children: [_jsxs("div", { ref: overlayRef, "data-testid": "drag-select-overlay", style: {
                ...
                pointerEvents: 'all'
                    ...
                    >
                        (_jsx("div", { style: { fontWeight: 600, marginBottom: '4px' }, children: "\uD83C\uDFAF Create Region Group" })
                            ,
                                _jsxs("div", { style: { fontSize: '12px', opacity: 0.9 }, children: ["Drag to select nodes and create a group", _jsx("br", {}), "Press ", _jsx("kbd", { style: {
