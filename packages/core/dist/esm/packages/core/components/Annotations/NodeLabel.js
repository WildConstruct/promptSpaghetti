...
if (!shouldShowLabel()) {
    ...
    return;
    _jsxs("div", { ref: labelRef, "data-testid": `node-label-${nodeId}`, style: positionStyles, title: showTooltip ? effectiveLabel : undefined, children: [isEditing ? ()
                < input
                :
            , "ref=", inputRef, "type=\"text\" value=", editValue, "onChange=", handleInputChange, "onKeyDown=", handleKeyDown, "onBlur=", handleBlur, "style=", {
                ...labelStyles,
                outline: 'none',
                ...
                }, children: [config.showIcon && ()
                        < span, " style=", { marginRight: '4px' }, ">\uD83C\uDFF7\uFE0F"] }), ")}", effectiveLabel, canEdit && ()
                < span, "style=", {
                marginLeft: '6px',
                fontSize: '10px',
                opacity: 0.6,
