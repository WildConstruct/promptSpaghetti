...
const handleTemplateSelect = useCallback((template) => { setQuickLabelInput(template); }, []);
return;
_jsxs("div", { style: {
        position: 'fixed',
        top: 80,
        ...
        overflowY: 'auto'
                ...
                paddingBottom: 8
                        ...
                        color: '#a0aec0',
                        fontSize: 11
                    }, children: [visibleLabelsCount, " visible"] })] }), _jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("div", { style: {
                        display: 'grid',
                        ...
                        marginBottom: 8
                            ...
                            >
                                { showAllLabels, 'Hide All': 'Show All' } }) }), _jsx("button", { onClick: () => onSetLabelEditMode(!labelEditMode), style: {
                        padding: '6px 8px',
        ...
        _jsx("div", { style: {
                ...
                gap: 8
                    ...
                    >
                        Optimize }) })
            ,
                _jsx("button", { onClick: onClearAllLabels, style: {
                        padding: '6px 8px',
                        background: '#f56565',
                        border: 'none',
                        borderRadius: 4,
 ...
 >
    _jsx("div", { style: {
            ...
            marginBottom: 8
                ...
                fontSize: 11,
                gap: 4
            }, children: [_jsx("input", { type: "checkbox", checked: smartPositioning, onChange: (e) => onSetSmartPositioning(e.target.checked) }), "Smart Positioning"] }) });
div >
    { /* Quick Add Interface */};
{
    selectedEdgeId && ()
 ...
 >
    (_jsx("h4", { style: {
            ...
            fontSize: 12,
            margin: '0 0 8px 0'
        }, children: "Add Label to Selected Connection" })
        ,
            _jsx("div", { style: { marginBottom: 8 }, children: _jsx("input", { type: "text", value: quickLabelInput, onChange: (e) => setQuickLabelInput(e.target.value), onKeyDown: (e) => e.key === 'Enter' && handleQuickAddLabel(), placeholder: "Enter connection label...", style: {
                        width: '100%',
                        padding: 6,
                        background: '#2d3748',
                        border: '1px solid #4a5568',
...
_jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("label", { style: {
                ...
                fontSize: 10,
                marginBottom: 4
            }, children: "Style Preset" }), _jsx("select", { value: selectedPreset, onChange: (e) => setSelectedPreset(e.target.value), style: {
                width: '100%',
                padding: 4,
                background: '#2d3748',
                border: '1px solid #4a5568',
                ...
                >
                    (_jsx("option", { value: "dataFlow", children: "Data Flow" })
                        ,
                            _jsx("option", { value: "control", children: "Control" })
                                ,
                                    _jsx("option", { value: "dependency", children: "Dependency" })
                                        ,
    ...
    (_jsx("label", { style: {
        ...
        ,
            _jsxs("div", { style: {
                    ...
                    gap: 4
                }, children: [Object.values(labelTemplates).slice(0, 6).map(template => ()
                        < button, key = { template }, onClick = {}()), " => handleTemplateSelect(template)} style=", {
                        padding: '2px 4px',
                        background: '#4a5568',
                        border: 'none',
                        borderRadius: 2,
...
;
div >
    _jsx("div", { style: { display: 'flex', gap: 8 }, children: _jsx("button", { onClick: handleQuickAddLabel, disabled: !quickLabelInput.trim(), style: {
                flex: 1,
                padding: '6px 8px',
...
_jsxs("div", { children: [_jsxs("h4", { style: {
                color: '#e2e8f0',
                fontSize: 12,
                margin: '0 0 8px 0',
                borderBottom: '1px solid #4a5568',
                paddingBottom: 4
            }, children: ["Labeled Connections (", edgesWithLabels.length, ")"] }), edgesWithLabels.length === 0 ? ()
            < div : , " style=", {
            color: '#a0aec0',
            fontSize: 11,
            fontStyle: 'italic',
            textAlign: 'center',
            padding: '16px 8px'
        }, "> No labeled connections.", ' ', edges.length > 0 ? 'Select a connection to add labels.' : 'Create connections first.'] });
()
    < div;
style = {};
{
    maxHeight: 200, overflowY;
    'auto';
}
 >
    ...
    >
        (_jsxs("div", { style: {
                ...
                marginBottom: 4
                    ...
                    }, children: edge.showLabel ? 'Visible' : 'Hidden' })] })
            ,
                _jsxs("div", { style: {
                        fontSize: 9,
                        color: '#a0aec0',
                    ...
                    ,
                        _jsx("div", { style: { display: 'flex', gap: 4 }, children: _jsx("button", { onClick: (e) => {
                                    e.stopPropagation();
...
export const ConnectionAnnotationToolbar, boolean;
onToggle: () => void ;
labelEditMode: boolean;
onSetLabelEditMode: (enabled) => void ;
    ...
    _jsxs("div", { style: {
            ...
            zIndex: 999
                    ...
                    >
                        Edit, Mode: true })] })
        ,
            _jsx("button", { onClick: onToggle, style: {
                    padding: '4px 8px',
