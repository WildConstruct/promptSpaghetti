...
_jsxs("div", { style: {
        ...
        overflowY: 'auto',
                ...
                paddingBottom: 8,
                    ...
                    marginBottom: 8,
                        ...
                        fontSize: 11,
                        gap: 4,
                    }, children: [_jsx("input", { type: "checkbox", checked: smartPositioning, onChange: (e) => onSetSmartPositioning(e.target.checked) }), "Smart Positioning"] }) }) }), selectedEdgeId && ()
            < div, " style=", {
            background: '#1a202c',
            padding: 12,
            borderRadius: 6,
            marginBottom: 16,
                ...
                margin: '0 0 8px 0',
                    ...
                    fontSize: 11,
                        ...
                        fontSize: 10,
                        marginBottom: 4,
                    }, children: "Quick Templates" }), _jsxs("div", { style: {
                        display: 'grid',
    ...
    ,
        _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx("button", { onClick: handleQuickAddLabel, disabled: !quickLabelInput.trim(), style: {
                        flex: 1,
                        padding: '6px 8px',
                    ...
                    }, children: "Add Label" }), selectedEdge && ()
                    < button, "onClick=", handleOpenEditor, "style=", {
                    padding: '6px 8px',
                    background: '#9f7aea',
                    border: 'none',
                    borderRadius: 4,
        ...
        (_jsxs("div", { style: {
            ...
            ,
                _jsxs("div", { style: {
                    ...
                    ,
                        _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: (e) => {
                                        e.stopPropagation();
