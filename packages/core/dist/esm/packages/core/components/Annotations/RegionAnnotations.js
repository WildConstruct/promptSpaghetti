...
nodes ?  : Array;
currentUser: VFXUser;
onRegionsChange: (regions) => void ;
onRegionSelect ?  : (regionId) => void ;
onNodesInRegion ?  : (nodeIds) => void ;
...
false,
    priority;
newRegion.priority || 'medium',
    status;
'active',
    marsZone;
newRegion.marsZone,
    nodeIds;
getNodesInRegion({ ...newRegion, area }),
    tags;
[],
    metadata;
{
...
_jsxs("div", { className: `region-annotation-system ${className}`, children: ["}", _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Square, { className: "w-5 h-5 text-purple-600" }), _jsx("span", { children: "Region Annotations" }), _jsxs(Badge, { variant: "secondary", children: [filteredRegions.length, " regions"] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { variant: "outline", size: "sm", onClick: () => setShowRegionDetails(!showRegionDetails), children: _jsx(Settings, { className: "w-4 h-4" }) }), _jsxs(Button, { variant: isCreating ? 'default' : 'outline', size: "sm", onClick: () => setIsCreating(!isCreating), disabled: readonly, children: [_jsx(Edit3, { className: "w-4 h-4 mr-2" }), isCreating ? 'Cancel' : 'Create Region'] })] })] }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3 mt-4", children: [_jsxs("div", { className: "bg-blue-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-blue-900", children: stats.total }), _jsx("div", { className: "text-xs text-blue-700", children: "Total Regions" })] }), _jsxs("div", { className: "bg-green-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-green-900", children: stats.active }), _jsx("div", { className: "text-xs text-green-700", children: "Active" })] }), _jsxs("div", { className: "bg-red-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-red-900", children: stats.critical }), _jsx("div", { className: "text-xs text-red-700", children: "Critical" })] }), _jsxs("div", { className: "bg-purple-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-purple-900", children: stats.totalNodes }), _jsx("div", { className: "text-xs text-purple-700", children: "Nodes in Regions" })] })] })] }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-4", children: [isCreating && ()
                                < Card >
                                (_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-sm", children: "Create New Region" }) })
                                    ,
                                        _jsxs(CardContent, { className: "space-y-4", children: [_jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium mb-2", children: "Shape" }), _jsxs("div", { className: "flex gap-1", children: [Object.entries(REGION_TOOLS).map(([tool, config]) => ()
                                                                        < Button, key = { tool }, variant = { creationTool } === tool ? 'default' : 'outline'), "size=\"sm\" onClick=", () => setCreationTool(tool), ">", config.icon] }), "))}"] }) }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium mb-2", children: "Type" }), _jsxs(Select, { value: newRegion.type || 'selection', onValueChange: (value) => setNewRegion(prev => ({ ...prev, type: value })), children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, {}) }), _jsx(SelectContent, { children: Object.entries(REGION_TYPES).map(([type, config]) => ()
                                                                        < SelectItem, key = { type }, value = { type } >
                                                                        _jsxs("div", { className: "flex items-center gap-2", children: [config.icon, _jsx("span", { children: config.label })] })) }), "))}"] })] })] })
                                            ,
                                                _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium mb-2", children: "Priority" }), _jsxs(Select, { value: newRegion.priority || 'medium', onValueChange: (value) => setNewRegion(prev => ({ ...prev, priority: value })), children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "low", children: "Low" }), _jsx(SelectItem, { value: "medium", children: "Medium" }), _jsx(SelectItem, { value: "high", children: "High" }), _jsx(SelectItem, { value: "critical", children: "Critical" })] })] })] })), newRegion.type === 'mars_zone' && ()
                                < div >
                                (_jsx("label", { className: "block text-xs font-medium mb-2", children: "MARS Zone" })
                                    ,
                                        _jsxs(Select, { value: newRegion.marsZone || '', onValueChange: (value) => setNewRegion(prev => ({ ...prev, marsZone: value })), children: [_jsx(SelectTrigger, { children: _jsx(SelectValue, { placeholder: "Select zone..." }) }), _jsx(SelectContent, { children: Object.entries(MARS_ZONES).map(([zone, config]) => ()
                                                        < SelectItem, key = { zone }, value = { zone } >
                                                        _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: config.icon }), _jsx("span", { children: config.label })] })) }), "))}"] }))] }) }), ")}"] })] })
    ,
        _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium mb-2", children: "Name" }), _jsx("input", { type: "text", value: newRegion.name || '', onChange: (e) => setNewRegion(prev => ({ ...prev, name: e.target.value })), placeholder: "Region name...", className: "w-full px-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" })] })
            ,
                _jsxs("div", { className: "flex justify-end gap-2", children: [_jsx(Button, { variant: "outline", size: "sm", onClick: () => {
                                setIsCreating(false);
                                setCreationPoints([]);
                            }, children: "Cancel" }), _jsxs(Button, { size: "sm", onClick: completeRegionCreation, disabled: creationPoints.length < 2, children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), "Create Region"] })] })
                    ,
                        _jsx("div", { className: "text-xs text-gray-500", children: creationTool === 'rectangle' ? 'Click and drag to create rectangle' :
...
{ /* Readonly indicator */ }
{
    ...
    className = "absolute top-2 right-2" >
        _jsx(Badge, { variant: "secondary", children: "Read Only" });
    div >
    ;
}
div >
