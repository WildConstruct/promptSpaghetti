        ...
        }
        {
            ...
            const [regionAnnotations, setRegionAnnotations] = useState([]);
            {
                ...
                }
                {
                    ...
                    }, ...nodeAnnotations.map(a => a.author.id), ...drawingAnnotations.map(a => a.author.id), ...regionAnnotations.map(a => a.author.id));
                    size;
...
_jsxs("div", { className: `annotation-tools-demo ${className}`, children: ["}", _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Film, { className: "w-6 h-6 text-blue-600" }), _jsx("span", { children: title }), _jsx(Badge, { variant: "secondary", className: "text-xs", children: "Professional VFX Workflow" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowTeamPanel(!showTeamPanel), children: [_jsx(Users, { className: "w-4 h-4 mr-2" }), "Team (", TEAM_MEMBERS.length, ")"] }), _jsxs(Select, { value: currentUser.id, onValueChange: (userId) => setCurrentUser(TEAM_MEMBERS.find(u => u.id === userId) || DEFAULT_USER), children: [_jsx(SelectTrigger, { className: "w-48", children: _jsx(SelectValue, {}) }), _jsx(SelectContent, { children: TEAM_MEMBERS.map(user => ()
    ...
    ,
        _jsxs(CardContent, { children: [_jsx("div", { className: "space-y-6", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-sm flex items-center gap-2", children: [_jsx(Eye, { className: "w-4 h-4" }), "Annotation Visibility Controls"] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: Object.entries(globalVisibility).map(([key, visible]) => ()
            ...
            ,
                _jsxs(TabsContent, { value: "drawing", className: "space-y-4", children: [globalVisibility.drawingAnnotations && ()
                            < DrawingAnnotationsCanvas, "width=", 800, "height=", 400, "annotations=", drawingAnnotations, "currentUser=", currentUser, "onAnnotationsChange=", setDrawingAnnotations, "showGrid=", showGrid, "readonly=", readonly, "/> )}"] })
                    ,
                        _jsxs(TabsContent, { value: "region", className: "space-y-4", children: [globalVisibility.regionAnnotations && ()
                                    < RegionAnnotationSystem, "width=", 800, "height=", 400, "regions=", regionAnnotations, "nodes=", SAMPLE_NODES, "currentUser=", currentUser, "onRegionsChange=", setRegionAnnotations, "showGrid=", showGrid, "readonly=", readonly, "/> )}"] })
                            ,
                                _jsx(TabsContent, { value: "connection", className: "space-y-4", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-sm", children: "Connection Annotations" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "space-y-3", children: SAMPLE_CONNECTIONS.map(conn => ()
                                                            < div, key = { conn, : .id }, className = "flex items-center justify-between p-3 border rounded" >
                                                            (_jsxs("div", { children: [_jsxs("div", { className: "text-sm font-medium", children: [SAMPLE_NODES.find(n => n.id === conn.source)?.name, " \u2192 ", SAMPLE_NODES.find(n => n.id === conn.target)?.name] }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Connection ID: ", conn.id] })] })
                                                                ,
                                                                    _jsx(Button, { variant: "outline", size: "sm", children: "Add Label" }))) }), "))}"] })] }) });
TabsContent >
;
Tabs >
