...
export const ExtensionManagerPanel = ({ className = '',
    onClose });
...
;
const { installedExtensions, availableExtensions, isLoading, error, loadInstalledExtensions, loadAvailableExtensions, installExtension, uninstallExtension, enableExtension, disableExtension, updateExtension };
getExtensionStatus
...
const handleExtensionSelect = (extension) => { setSelectedExtension(extension); };
