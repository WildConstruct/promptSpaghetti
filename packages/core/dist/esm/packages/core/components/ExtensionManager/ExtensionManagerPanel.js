            ...
            const handleToggleExtension = async (extensionId) => {
                try {
                    ...
                    const handleUpdateExtension = async (extensionId) => {
                        ...
                        return;
                        _jsxs("div", { className: `extension-manager-panel ${className}`, children: ["}", _jsxs("div", { className: "extension-manager-header", children: [_jsxs("div", { className: "header-left", children: [_jsx("h2", { children: "Extension Manager" }), _jsxs("div", { className: "view-tabs", children: [_jsxs("button", { className: currentView === 'installed' ? 'active' : '', onClick: () => setCurrentView('installed'), children: ["Installed (", installedExtensions.length, ")"] }), _jsx("button", { className: currentView === 'marketplace' ? 'active' : '', onClick: () => setCurrentView('marketplace'), children: "Marketplace" }), _jsx("button", { className: currentView === 'settings' ? 'active' : '', onClick: () => setCurrentView('settings'), children: "Settings" })] })] }), _jsxs("div", { className: "header-right", children: [currentView === 'marketplace' && ()
                                                    < button, "className=\"install-from-file-btn\" onClick=", () => setShowInstallDialog(true), "> Install from File"] }), ")}", onClose && ()
...
div >
    { /* Content */}
    < div;
className = "extension-manager-content" >
    { error } && ()
    < div;
className = "error-banner" >
    (_jsx("span", { className: "error-icon", children: "\u26A0\uFE0F" })
        ,
            _jsx("span", { className: "error-message", children: error })
                ,
                    _jsx("button", { className: "dismiss-btn", onClick: () => useExtensionManagerStore.getState().clearError(), children: "\u2715" }));
div >
;
{
    ...
    className = "extension-settings" >
        (_jsx("h3", { children: "Extension System Settings" })
            ,
                _jsxs("div", { className: "settings-section", children: [_jsxs("label", { children: [_jsx("input", { type: "checkbox", defaultChecked: true }), "Auto-update extensions"] }), _jsxs("label", { children: [_jsx("input", { type: "checkbox", defaultChecked: true }), "Enable extension sandboxing"] }), _jsxs("label", { children: [_jsx("input", { type: "checkbox" }), "Allow development extensions"] })] }));
    div >
    ;
    ()
        < div;
    className = "extension-browser" >
        { /* Search and Filter */}
    ...
    viewMode = { currentView }
        ...
        { /* Main Content Area */}
        < div;
    className = "extension-content-area" >
        { /* Extension List */}
        < div;
    ...
    className = "loading-spinner" >
        (_jsx("div", { className: "spinner" })
            ,
                _jsx("span", { children: "Loading extensions..." }));
    div >
    ;
    ...
    { /* Extension Detail */};
{
    selectedExtension && ()
        < div;
    className = "extension-detail-container" >
        _jsx(ExtensionDetailView, { extension: selectedExtension, status: getExtensionStatus(selectedExtension.id), onToggle: () => handleToggleExtension(selectedExtension.id), onUninstall: () => handleUninstallExtension(selectedExtension.id), onUpdate: () => handleUpdateExtension(selectedExtension.id), onConfigure: () => handleConfigureExtension(selectedExtension), onClose: () => setSelectedExtension(null), viewMode: currentView });
    div >
    ;
}
div >
