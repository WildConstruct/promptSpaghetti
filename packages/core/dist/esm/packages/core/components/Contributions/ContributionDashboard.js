...
length,
    totalViews;
contributions.reduce((sum, c) => sum + c.views, 0),
    totalLikes;
contributions.reduce((sum, c) => sum + c.likes, 0),
    avgQualityScore;
...
_jsxs("div", { className: `contribution-dashboard ${className}`, children: ["}", _jsxs("div", { className: "dashboard-header", children: [_jsxs("div", { className: "header-main", children: [_jsx("h1", { children: "Contribution Dashboard" }), _jsx("p", { children: "Manage your templates, articles, tutorials, and community content" })] }), showCreateForm && ()
                    < button, "onClick=", () => setShowSubmissionForm(true), "className=\"btn-primary create-btn\" > + Create New Contribution"] }), ")}"] });
{ /* Stats Overview */ }
{
    contributorProfile && ()
        < div;
    className = "stats-overview" >
        (_jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.total }), _jsx("div", { className: "stat-label", children: "Total Contributions" })] })
            ,
                _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.published }), _jsx("div", { className: "stat-label", children: "Published" })] })
                    ,
                        _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.drafts }), _jsx("div", { className: "stat-label", children: "Drafts" })] })
                            ,
                                _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.underReview }), _jsx("div", { className: "stat-label", children: "Under Review" })] })
                                    ,
                                        _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.totalViews.toLocaleString() }), _jsx("div", { className: "stat-label", children: "Total Views" })] })
                                            ,
                                                _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: stats.totalLikes }), _jsx("div", { className: "stat-label", children: "Total Likes" })] })
                                                    ,
                                                        _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "stat-value", children: contributorProfile.level }), _jsx("div", { className: "stat-label", children: "Contributor Level" })] })
                                                            ,
                                                                _jsxs("div", { className: "stat-card", children: [_jsxs("div", { className: "stat-value", children: [stats.avgQualityScore, "%"] }), _jsx("div", { className: "stat-label", children: "Avg Quality Score" })] }));
    div >
    ;
}
{ /* Navigation Tabs */ }
_jsxs("div", { className: "dashboard-tabs", children: [_jsxs("button", { onClick: () => setActiveTab('my-contributions'), className: `tab-btn ${activeTab === 'my-contributions' ? 'active' : ''}`, children: ["All Contributions (", stats.total, ")"] }), _jsxs("button", { onClick: () => setActiveTab('drafts'), className: `tab-btn ${activeTab === 'drafts' ? 'active' : ''}`, children: ["Drafts (", stats.drafts, ")"] }), _jsxs("button", { onClick: () => setActiveTab('published'), className: `tab-btn ${activeTab === 'published' ? 'active' : ''}`, children: ["Published (", stats.published, ")"] }), _jsxs("button", { onClick: () => setActiveTab('under-review'), className: `tab-btn ${activeTab === 'under-review' ? 'active' : ''}`, children: ["Under Review (", stats.underReview, ")"] }), contributorProfile && ()
            < button, "onClick=", () => setActiveTab('profile'), "className=", `tab-btn ${activeTab === 'profile' ? 'active' : ''}`, "> Profile"] });
div >
    { /* Search and Filters */};
{
...
className = "filter-select"
    >
        (_jsx("option", { value: "", children: "All Types" })
            ,
                _jsx("option", { value: "template", children: "Templates" })
                    ,
                        _jsx("option", { value: "knowledge_article", children: "Knowledge Articles" })
                            ,
                                _jsx("option", { value: "tutorial", children: "Tutorials" })
                                    ,
                                        _jsx("option", { value: "case_study", children: "Case Studies" })
                                            ,
                                                _jsx("option", { value: "pattern_library", children: "Pattern Libraries" })
                                                    ,
                                                        _jsx("option", { value: "community_post", children: "Community Posts" }));
select >
    _jsxs("select", { value: filter.sortBy || 'created_at', onChange: (e) => setFilter(prev => ({}), ...prev, sortBy, e.target.value), className: "sort-select", children: [_jsx("option", { value: "created_at", children: "Latest First" }), _jsx("option", { value: "updated_at", children: "Recently Updated" }), _jsx("option", { value: "views", children: "Most Viewed" }), _jsx("option", { value: "likes", children: "Most Liked" }), _jsx("option", { value: "quality_score", children: "Highest Quality" })] });
div >
;
{ /* Content Area */ }
_jsxs("div", { className: "dashboard-content", children: [activeTab === 'profile' && contributorProfile ? ()
            < ContributorProfileManager
            :
        , "profile=", contributorProfile, "onProfileUpdate=", (updatedProfile) => setContributorProfile(updatedProfile), "/> ) : loading ? ()", _jsxs("div", { className: "loading-state", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading contributions..." })] }), ") : error ? ()", _jsxs("div", { className: "error-state", children: [_jsx("h3", { children: "Failed to load contributions" }), _jsx("p", { children: error }), _jsx("button", { onClick: loadContributions, className: "retry-button", children: "Try again" })] }), ") : filteredContributions.length === 0 ? ()", _jsxs("div", { className: "empty-state", children: [_jsx("h3", { children: "No contributions found" }), _jsx("p", { children: activeTab === 'my-contributions'
                        ? 'You haven\'t created any contributions yet.'
                        : `No ${activeTab.replace('-', ' ')} found.` }), showCreateForm && ()
                    < button, "onClick=", () => setShowSubmissionForm(true), "className=\"btn-primary\" > Create Your First Contribution"] }), ")}"] });
()
    < div;
className = "contributions-grid" >
    { filteredContributions, : .map((contribution) => ()
            < ContributionCard, key = { contribution, : .id }, contribution = { contribution }, onEdit = {}(), onContributionEdit?.(contribution.id)) };
onDelete = {}();
    ...
    { /* Submission Form Modal */};
{
 ...
 >
    _jsxs("div", { className: "modal-content", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "modal-header", children: [_jsx("h2", { children: "Create New Contribution" }), _jsx("button", { onClick: () => setShowSubmissionForm(false), className: "modal-close", children: "\u00D7" })] }), _jsx(ContributionSubmissionForm, { onSubmit: handleContributionSubmit, onCancel: () => setShowSubmissionForm(false) })] });
div >
;
_jsx("style", { children: `
