          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('span', { style: { fontWeight: '600' }, children: ['Current Session: ', currentSession.name] }),
            ...
            currentSession.description &&
              _jsx('div', {
                style: { color: styles.textSecondary, fontSize: '12px', marginBottom: '8px' },
                children: currentSession.description,
              }),
            _jsxs('div', {
              style: {
                display: 'flex',
              ...
              children: [
                _jsxs('span', { children: [currentSession.openFiles.length, ' files open'] }),
                _jsxs('span', { children: ['Last updated: ', formatDate(currentSession.timestamp)] }),
              ],
            }),
          ],
        }),
          ...
          sessions.length === 0
            ? _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('div', { style: { fontSize: '16px', marginBottom: '8px' }, children: 'No saved sessions' }),
                  _jsx('div', {
                    style: { fontSize: '14px' },
                    children: 'Create a session to save your current workspace',
                  }),
                ],
              })
            : _jsx('div', {
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                ...
                                children: [
                                  _jsxs('span', { children: [session.openFiles.length, ' files'] }),
                                  _jsx('span', { children: formatDate(session.timestamp) }),
                                ],
                              }),
                            ],
                          }),
