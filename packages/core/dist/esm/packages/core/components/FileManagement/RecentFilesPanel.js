          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                ...
                file.isFavorite && _jsx('span', { style: { fontSize: '12px' }, children: '\u2B50' }),
              ],
            }),
            !compact &&
              _jsxs('div', {
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('div', {
                  ...
                  children: favoriteFiles
                    .slice(0, 5)
                    .map(file => _jsx(FileItem, { file: file, compact: true }, file.id)),
                }),
              ],
            }),
          _jsxs('div', {
            children: [
              _jsxs('h3', {
                ...
                children: [_jsx('span', { children: '\uD83D\uDD50' }), ' Recent Files (', recentFiles.length, ')'],
              }),
              recentFiles.length === 0
                ? _jsxs('div', {
                    style: {
                    ...
                    children: [
                      ...
                      _jsx('div', { style: { fontSize: '16px', marginBottom: '8px' }, children: 'No recent files' }),
                      _jsx('div', { style: { fontSize: '14px' }, children: 'Open some projects to see them here' }),
                    ],
                  })
                : _jsx('div', {
                    style: {
                    ...
                    children: recentFiles.map(file =>
                      _jsx(FileItem, { file: file, compact: viewMode === 'list' }, file.id)
                    ),
                  }),
            ],
          }),
