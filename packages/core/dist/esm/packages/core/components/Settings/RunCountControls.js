...
const handlePresetSelect = useCallback((presetValue) => { onChange({}); }, ...settings, value, presetValue);
;
[settings, onChange];
;
// Handle performance warning toggle
const handleShowWarningChange = useCallback((showPerformanceWarning) => { onChange({}); }, ...settings);
...
_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                ...
                marginBottom: '16px'
                        ...
                        marginBottom: '6px'
                            ...
                            }, "border:": true }), " `1px solid $", perfInfo.color, "`} borderRadius: '6px' fontSize: '12px' color: perfInfo.color fontWeight: 500; }>", _jsx("span", { children: perfInfo.icon }), _jsx("span", { children: perfInfo.description }), _jsx(FiClock, { size: 12 }), _jsx("span", { children: perfInfo.estimatedTime })] })] }), _jsx("div", { style: {
                fontSize: '11px',
...
_jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("label", { style: {
                ...
                flexWrap: 'wrap'
                    ...
                    _jsx("button", { onClick: () => handlePresetSelect(presetValue), style: {
                            ...
                            ? `1px solid ${presetPerf.color}` :  }, index);
                }), ": `1px solid $", uiColors.ui.border, "`} borderRadius: '6px' cursor: 'pointer' transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)' minWidth: '60px'; title=", `${presetValue} variants - ${presetPerf.description}`, "onMouseEnter=", (e) => {
                    if (!isSelected) {
