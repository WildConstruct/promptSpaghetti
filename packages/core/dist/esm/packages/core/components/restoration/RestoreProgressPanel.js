...
}
{
 ...
 >
    (_jsx(Text, { type: "secondary", children: "Estimated time remaining: " })
        ,
            _jsx(Text, { strong: true, children: formatTime(progress.estimatedTimeRemaining) }));
div >
;
Card >
    { /* Statistics */}
            ...
            _jsx(Col, { span: 6, children: _jsx(Card, { children: _jsx(Statistic, { title: "Conflicts", value: progress.conflictsResolved, suffix: `/ ${progress.totalConflicts}`, prefix: _jsx(WarningOutlined, {}), valueStyle: {
                ...
                ,
                    _jsx(Col, { span: 6, children: _jsx(Card, { children: _jsx(Statistic, { title: "Progress", value: progress.progressPercentage, suffix: "%", prefix: _jsx(LoadingOutlined, {}) }) }) })
                        ,
                            _jsx(Col, { span: 6, children: _jsx(Card, { children: _jsx(Statistic, { title: "Status", value: progress.status.replace('_', ' ').toUpperCase(), prefix: getStatusIcon(progress.status) }) }) }));
Row >
    { /* Error Message */};
{
...
Button >
    >
        (_jsxs(Collapse, { children: [_jsx(Panel, { header: "Operation Progress", children: _jsx(List, { size: "small", dataSource: [
                            ...
                            < List.Item >
                            _jsxs(Space, { children: [_jsxs(Text, { type: "secondary", children: [item.label, ":"] }), _jsx(Text, { strong: true, children: item.value })] }) }) }, "operations"), ")} />"] })
            ,
                _jsx(Panel, { header: "Conflict Resolution", children: _jsx(List, { size: "small", dataSource: [
                            ...
                            < List.Item >
                            _jsxs(Space, { children: [_jsxs(Text, { type: "secondary", children: [item.label, ":"] }), _jsx(Text, { strong: true, children: item.value })] }) }) }, "conflicts"));
/>;
Panel >
    _jsx(Panel, { header: "System Information", children: _jsx(List, { size: "small", dataSource: [
                ...
                < List.Item >
                _jsxs(Space, { children: [_jsxs(Text, { type: "secondary", children: [item.label, ":"] }), _jsx(Text, { code: true, style: { fontSize: '12px' }, children: item.value })] }) }) }, "system");
/>;
Panel >
;
Collapse >
...
_jsx(Modal, { title: "Cancel Restoration", visible: showCancelModal, onOk: handleCancelConfirm, onCancel: () => setShowCancelModal(false), okText: "Yes, Cancel", cancelText: "No, Continue", okButtonProps: { danger: true }, children: _jsxs(Space, { direction: "vertical", size: "middle", style: { width: '100%' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx(ExclamationCircleOutlined, { style: { color: '#fa8c16', fontSize: '20px' } }), _jsx(Text, { strong: true, children: "Are you sure you want to cancel this restoration?" })] }), _jsx(Text, { type: "secondary", children: "Cancelling the restoration will stop the process and leave your project in its current state. Any changes that have already been applied will remain." }), _jsx("div", { style: { background: '#f5f5f5', padding: '12px', borderRadius: '4px' }, children: _jsxs(Text, { type: "secondary", children: ["Progress: ", progress.progressPercentage, "% complete (", progress.operationsCompleted, "/", progress.totalOperations, " operations)"] }) })] }) });
div >
;
;
;
