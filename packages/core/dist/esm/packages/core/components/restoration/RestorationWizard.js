        ...
        if (restorationAttempt && currentStep === 3) {
            ...
            const renderStepContent = () => {
                switch (currentStep) {
                    case 0:
                        return;
                        _jsxs(Form, { form: form, layout: "vertical", initialValues: config, onValuesChange: (changedValues) => {
...
style = {};
{
 ...
 >
    (_jsx(LoadingOutlined, { style: { fontSize: '48px', marginBottom: '16px' } })
        ,
            _jsx(Title, { level: 4, children: "Generating Preview..." })
                ,
                    _jsx(Text, { type: "secondary", children: "Please wait while we analyze the changes that will be made." }));
div >
;
;
2;
...
style = {};
{
 ...
 >
    (_jsx(LoadingOutlined, { style: { fontSize: '48px', marginBottom: '16px' } })
        ,
            _jsx(Title, { level: 4, children: "Starting Restoration..." })
                ,
                    _jsx(Text, { type: "secondary", children: "Please wait while we prepare the restoration process." }));
div >
;
;
return null;
