...
maxWidth ?  : number;
maxHeight ?  : number;
export const InlineNodeEditor = ({ node,
    isActive,
    onUpdate,
    onClose,
    onSubmit,
...
return (_jsxs("div", { ref: editorRef, className: "inline-node-editor", style: {
        ...
        borderBottom: '1px solid #4a5568'
                ...
                fontWeight: 600
                        ...
                        width: 20,
                        height: 20
                    }, title: "Cancel (Esc)", children: "\u00D7" })] })] })) /* Basic Properties */;
{ /* Basic Properties */ }
_jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("label", { style: {
                ...
                color: 'white',
                fontSize: 14
            }, placeholder: "Enter node label" }), errors.label && (_jsx("span", { style: { color: '#e53e3e', fontSize: 12, marginTop: 4 }, children: errors.label }))] });
{ /* Node-specific properties */ }
_jsx(NodeSpecificEditor, { nodeType: node.type, data: localData, onChange: handleInputChange, errors: errors, theme: "cinema" });
{ /* Footer */ }
_jsxs("div", { style: {
        display: 'flex',
        justifyContent: 'space-between',
...
const NodeSpecificEditor = ({ nodeType,
    data,
    onChange,
    errors });
theme = 'cinema';
