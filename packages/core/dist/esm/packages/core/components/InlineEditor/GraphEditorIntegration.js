...
export const GraphEditorWithInlineEditing = ({ nodes, edges, onNodesChange, onEdgesChange, onNodeUpdate, onConnect, className = '', theme = 'cinema', showMinimap = true, showControls = true, showBackground = true }) => {
