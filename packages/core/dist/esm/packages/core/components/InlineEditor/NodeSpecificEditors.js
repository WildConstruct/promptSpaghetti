...
_jsxs("div", { children: [_jsxs("div", { style: {
                ...
                marginBottom: 12
                ...
                }, "border: `1px solid $", colors.border, "`} borderRadius: 6 cursor: 'move'; >", _jsx("div", { style: {
                        width: 8,
                        height: 16,
                    ...
                    }, "border:": true }), " `1px solid $", colors.border, "`} borderRadius: 4 color: colors.text fontSize: 13; placeholder=\"Choice text\" />", _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 4 }, children: [_jsx("input", { type: "range", min: "0", max: "100", value: choice.weight, onChange: (e) => updateChoice(index, 'weight', parseInt(e.target.value)), style: { width: 80 } }), _jsx("input", { type: "number", value: choice.weight, onChange: (e) => updateChoice(index, 'weight', parseInt(e.target.value)), style: {
                                width: 50,
                                padding: 4,
                                background: colors.background
                            }, "border:": true }), " `1px solid $", colors.border, "`} borderRadius: 4 color: colors.text fontSize: 12 textAlign: 'center'; min=\"0\" />", _jsx("span", { style: { fontSize: 12, color: colors.text, opacity: 0.7 }, children: "%" })] }), _jsx("button", { onClick: () => removeChoice(index), style: {
        ...
        ,
            _jsxs("div", { style: {
                    ...
                    background: colors.border
                        ...
                        _jsx("div", { style: {
                                width: `${percentage}%`
                            }, "background:": true }, index);
                        `hsl(${(index * 137.5) % 360}, 70%, 60%)`;
                    }, minWidth), ": percentage > 0 ? 2 : 0; title=", `${choice.text}: ${choice.weight} (${percentage.toFixed(1)}%)`, "/> ); })}"] }));
div >
;
{
    errors.choices && ()
...
theme = 'cinema';
{
    ...
    return;
    _jsx("div", { children: _jsxs("div", { style: {
                display: 'flex',
                justifyContent: 'space-between',
                alignItems: 'center',
                marginBottom: 8
            }, children: [_jsx("label", { style: { fontSize: 14, fontWeight: 600 }, children: "Template" }), _jsx("div", { style: { display: 'flex', background: '#2d3748', borderRadius: 4, padding: 2 }, children: _jsx("button", { onClick: () => setPreviewMode('edit'), style: {
                            padding: '4px 8px',
                            ...
                            >
                                Edit }) }), _jsx("button", { onClick: () => setPreviewMode('preview'), style: {
                        padding: '4px 8px',
...
theme = 'cinema';
{
    ...
    _jsx("div", { children: _jsxs("div", { style: {
                ...
                alignItems: 'center',
                marginBottom: 8
            }, children: [_jsx("label", { style: { fontSize: 14, fontWeight: 600 }, children: "Variable Configuration" }), _jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: 12, opacity: 0.7 }, children: "Scope:" }), _jsx("select", { value: variableScope, onChange: (e) => setVariableScope(e.target.value), style: {
                                padding: '4px 8px',
                                background: '#4a5568',
                                border: '1px solid #718096',
                                borderRadius: 4,
                                ...
                                >
                                    (_jsx("option", { value: "local", children: "Local" })
                                        ,
                                            _jsx("option", { value: "global", children: "Global" })) })] })] }) })
        ,
...
theme = 'cinema';
{
    ...
    _jsxs("div", { children: [_jsxs("div", { style: {
                ...
                (_jsx("label", { style: {
                    ...
                    ,
                        _jsx("select", { onChange: (e) => onChange('condition', e.target.value), style: {
                                width: '100%',
                                padding: 8,
                                background: '#4a5568',
                                border: '1px solid #718096',
                                ...
                                >
                                    _jsx("option", { value: "", children: "Select a condition template..." }), ...commonConditions.map((cond, index) => ()
...
_jsxs("div", { style: {
        ...
        border: '1px solid #718096',
        borderRadius: 4
    }, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 4 }, children: "Test Condition:" }), _jsx("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: _jsx("button", { style: {
                    padding: '4px 8px',
                    background: '#38a169',
                    color: 'white',
                    border: 'none',
                    ...
                    >
                        Validate }) }), _jsx("span", { style: { fontSize: 12, color: '#a0aec0' }, children: "Test with sample data" })] });
div >
    { errors, : .condition && ()
            < span, style = {} };
{
...
_jsxs("div", { style: {
        ...
        border: '1px solid #718096',
        borderRadius: 4
    }, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 8 }, children: "Export Options:" }), _jsx("div", { style: { display: 'flex', gap: 8, flexWrap: 'wrap' }, children: _jsx("button", { style: {
                    padding: '4px 8px',
                    background: '#4299e1',
                    color: 'white',
                    border: 'none',
                    ...
                    >
                        Save, to: true, File: true }) }), _jsx("button", { style: {
                padding: '4px 8px',
                background: '#38a169',
                color: 'white',
                border: 'none',
