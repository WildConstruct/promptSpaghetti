...
});
{
 ...
 >
    _jsxs("div", { style: { maxWidth: '1400px', margin: '0 auto' }, children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: '48px' }, children: [_jsx("h1", { style: {
                        ...
                        } }), ", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', margin: '0 0 16px 0', letterSpacing: '-0.02em'; }}> \uD83C\uDFAC Wild Construct Demo"] }), _jsx("p", { style: {
                    fontSize: '20px',
                    opacity: 0.8,
                    maxWidth: '600px',
    ...
    (_jsx("h3", { style: {
        ...
        ,
            _jsxs("div", { style: {
                    ...
                    }, ", borderRadius: '12px', padding: '16px', textAlign: 'left', cursor: 'pointer', transition: 'all 0.3s ease', color: styles.text; }} >", _jsx("h4", { style: {
                            margin: '0 0 8px 0',
                            fontSize: '16px',
                            fontWeight: 600,
...
'14px',
    opacity;
isGenerating && index >= previewResults.length - 1 ? 0.5 : 1,
    transition;
'opacity 0.3s ease',
    animation;
isGenerating && index === previewResults.length - 1 ? 'fadeIn 0.3s ease' : 'none';
    >
        _jsxs("span", { style: {
