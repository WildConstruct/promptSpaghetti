...
{ // Demo scenarios for film industry use cases
    ...
    const scenarios = {
        ...
        'dialogue-styles': { title: '💬 Dialogue Style Variations',
        ...
        'scene-settings': { title: '🏙️ Scene Setting Selection',
        ...
        'plot-twists': { title: '🎲 Plot Twist Generation',
    ...
    React.useEffect(() => { setDemoOptions(scenarios[activeScenario].options); }, [activeScenario]);
    ...
    const handleOptionsChange = useCallback((newOptions) => { setDemoOptions(newOptions); }, []);
...
`linear-gradient(135deg, ${styles.background}, ${styles.secondary})`;
color: styles.text;
fontFamily: 'Inter, system-ui, sans-serif';
padding: '40px 20px';
 >
    _jsxs("div", { style: { maxWidth: '1400px', margin: '0 auto' }, children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: '48px' }, children: [_jsx("h1", { style: {
                            fontSize: '48px',
                            fontWeight: 800
                        }, "background:": true }), " `linear-gradient(135deg, $", styles.accent, ", $", styles.accent, "80)`} WebkitBackgroundClip: 'text' WebkitTextFillColor: 'transparent' backgroundClip: 'text' margin: '0 0 16px 0' letterSpacing: '-0.02em'; }> \uD83C\uDFAC Wild Construct Demo"] }), _jsx("p", { style: {
                    fontSize: '20px',
                    opacity: 0.8,
                    maxWidth: '600px',
                    margin: '0 auto 32px auto',
                    lineHeight: 1.6
                }, children: "Professional drag-to-reorder weight management for AI-powered film content generation" }), _jsx("div", { style: {
                    display: 'inline-flex',
                    gap: '12px',
                    padding: '12px',
                    background: styles.secondary
                }, "border:": true }), " `1px solid $", styles.border, "`} borderRadius: '12px'; }>", _jsx("span", { style: {
                    padding: '6px 12px',
...
marginBottom: '32px';
 >
    (_jsx("h3", { style: {
            ...
            fontWeight: 600,
            color: styles.accent
        }, children: "\uD83D\uDCCB Select Film Industry Scenario" })
        ,
            _jsxs("div", { style: {
                    display: 'grid',
                    gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))',
                    gap: '16px'
                }, children: [Object.entries(scenarios).map(([id, scenario]) => ()
                        < button, key = { id }, onClick = {}()), " => handleScenarioChange(id)} style=", {
                        background: activeScenario === id ? styles.accent + '20' : 'transparent'
                    }, "border: `2px solid $", activeScenario === id ? styles.accent : styles.border, "`} borderRadius: '12px' padding: '16px' textAlign: 'left' cursor: 'pointer' transition: 'all 0.3s ease' color: styles.text; >", _jsx("h4", { style: {
                            margin: '0 0 8px 0',
                            fontSize: '16px',
                            fontWeight: 600,
...
boxShadow: `0 8px 32px ${styles.accent}20`;
 >
    _jsx(DragReorderWeightManager, { options: demoOptions, onChange: handleOptionsChange, theme: theme, showWeights: true, showPercentages: true, allowWeightEditing: interactive, allowLocking: interactive, enableBulkOperations: interactive, showStatistics: true, showVisualWeights: true, enableCategories: true, style: {
...
opacity: 0.7;
 >
    (_jsxs("p", { style: { margin: '0 0 12px 0', fontSize: '16px' }, children: ["\uD83C\uDFAC ", _jsx("strong", { children: "Wild Construct" }), " \u2022 Film Industry AI Platform"] })
        ,
            _jsx("p", { style: { margin: 0, fontSize: '14px' }, children: "Epic 8.3 Task 3 Complete \u2022 Drag-to-Reorder Interface \u2022 $2.3B Industry Integration Ready" }));
div >
;
div >
    ({ /* CSS Animations */});
