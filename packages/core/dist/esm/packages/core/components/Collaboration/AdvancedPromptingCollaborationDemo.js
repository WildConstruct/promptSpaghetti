...
_jsxs("div", { style: {
        ...
        border: '1px solid rgba(255, 255, 255, 0.1)'
                ...
                overflow: 'hidden'
                    ...
                    }, "width:": true }), " `$", ((demoStep + 1) / demoSteps.length) * 100, "%`} transition: 'width 0.5s ease'; } />"] })] });
div >
    {};
showPanel ? ()
    /* Role Selection */
                    ...
                    gap: 16
                        ...
                        e.currentTarget.style.transform = 'translateY(0)';
                            ...
                            marginBottom: 12
                                    ...
                                    height: 48,
                                    borderRadius: '50%'
                                }, "background:": true }), " `linear-gradient(135deg, $", getRoleColor(user.role), ", $", getRoleColor(user.role), "CC)`} display: 'flex' alignItems: 'center' justifyContent: 'center' fontSize: 20; }>", user.role === 'director' ? '🎬' :
    ...
    (_jsxs("div", { style: {
        ...
        ,
            _jsx("button", { onClick: () => {
                    ...
                    >
                , Back: true, to: true, Role: true, Selection: true, button: true }));
{
