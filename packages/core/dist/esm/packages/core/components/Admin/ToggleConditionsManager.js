...
;
export const ToggleConditionsManager = ({
    conditionsService,
    toggleId,
    onConditionsChange,
    onClose
    ...
    const renderParameters = () => {
        ...
        switch (condition.conditionType) {
            case ConditionType.PERCENTAGE:
                return;
                _jsxs("div", { className: "text-sm", children: [_jsx("span", { className: "font-medium", children: "Rollout: " }), _jsxs("span", { children: [params.percentage, "%"] }), params.salt && _jsxs("span", { className: "text-gray-500 ml-2", children: ["(Salt: ", params.salt, ")"] })] });
        }
    };
};
;
...
return;
_jsxs("div", { className: "text-sm", children: [_jsx("span", { className: "font-medium", children: "Segments: " }), _jsx("span", { children: params.userSegments?.join(', ') || 'None' })] });
;
ConditionType.TIME_WINDOW;
return;
_jsx("div", { className: "text-sm space-y-1", children: params.startTime && ()
        < div >
        (_jsx("span", { className: "font-medium", children: "Start: " })
            ,
                _jsx("span", { children: params.startTime.toLocaleString() })) });
{
    params.endTime && ()
        < div >
