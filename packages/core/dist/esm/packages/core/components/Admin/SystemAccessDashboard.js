    ...
    const loadData = async () => {
        try {
            ...
            setAccessRequests([]);
            {
                ...
                'Need admin access for project management',
                    urgency;
                'medium',
                    status;
                'pending',
...
;
_jsxs("div", { className: "requests-section", children: [_jsxs("div", { className: "requests-header", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Pending Access Requests" }), _jsxs(Badge, { className: "bg-yellow-100 text-yellow-800", children: [accessRequests.filter(r => r.status === 'pending').length, " pending"] })] }), _jsxs("div", { className: "requests-list", children: [accessRequests.map(request => ()
                    < AccessRequestCard, key = { request, : .id }, request = { request }, onApprove = {}(id)), " => console.log('Approve:', id)} onReject=", (id) => console.log('Reject:', id), "/> ))}"] }), accessRequests.length === 0 && ()
            < div, " className=\"empty-state\">", _jsx(Clock, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No access requests" }), _jsx("p", { className: "text-gray-500", children: "All access requests have been processed." })] });
div >
;
;
...
;
{
    ...
    return;
    _jsxs(Card, { className: "user-card", children: [_jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "user-card-header", children: [_jsxs("div", { className: "user-info", children: [_jsx("div", { className: "user-name", children: user.displayName }), _jsx("div", { className: "user-email", children: user.email }), _jsxs("div", { className: "user-username", children: ["@", user.username] })] }), _jsxs("div", { className: "user-badges", children: [_jsxs(Badge, { className: statusConfig.color, children: [_jsx(StatusIcon, { className: "w-3 h-3 mr-1" }), user.status] }), _jsxs(Badge, { className: accessConfig.color, children: [_jsx(AccessIcon, { className: "w-3 h-3 mr-1" }), user.systemAccess] }), user.mfaEnabled && ()
                                    < Badge, " className=\"bg-green-100 text-green-800\">", _jsx(Shield, { className: "w-3 h-3 mr-1" }), "MFA"] }), ")}"] }) }), _jsxs("div", { className: "user-details", children: [_jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Roles:" }), _jsx("span", { className: "detail-value", children: user.roles.length > 0
...
;
{
    ...
    _jsxs("div", { className: "modal-overlay", children: [_jsxs("div", { className: "modal-content", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h2", { children: ["User Details: ", user.displayName] }), _jsx(Button, { onClick: onClose, variant: "outline", size: "sm", children: "\u2715" })] }), _jsxs("div", { className: "modal-body", children: [_jsxs("div", { className: "user-details-grid", children: [_jsxs("div", { className: "detail-section", children: [_jsx("h3", { children: "Basic Information" }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Display Name:" }), _jsx("span", { children: user.displayName })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Username:" }), _jsx("span", { children: user.username })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Email:" }), _jsx("span", { children: user.email })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Status:" }), _jsx(Badge, { className: STATUS_CONFIG[user.status].color, children: user.status })] })] }), _jsxs("div", { className: "detail-section", children: [_jsx("h3", { children: "Access Control" }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "System Access:" }), _jsx(Badge, { className: ACCESS_LEVEL_CONFIG[user.systemAccess].color, children: user.systemAccess })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Security Clearance:" }), _jsx("span", { children: user.securityClearance })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "MFA Enabled:" }), _jsx(Badge, { className: user.mfaEnabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800', children: user.mfaEnabled ? 'Yes' : 'No' })] })] }), _jsxs("div", { className: "detail-section", children: [_jsx("h3", { children: "Roles" }), _jsx("div", { className: "roles-list", children: user.roles.map(role => ()
                                                    ...
                                                    : 'Never' })] }), _jsxs("div", { className: "detail-item", children: [_jsx("label", { children: "Created:" }), _jsx("span", { children: user.createdAt.toLocaleString() })] })] })] })] }), _jsxs("div", { className: "modal-footer", children: [_jsx(Button, { onClick: onClose, variant: "outline", children: "Close" }), _jsx(Button, { onClick: () => { onUpdate(); onClose(); }, children: "Edit User" })] })] })
        ,
            _jsx("style", { children: `
        .modal-overlay {
          position: fixed;,
