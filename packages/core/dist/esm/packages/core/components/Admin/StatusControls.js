...
}, stopped, error, starting, stopping;
            ...
            try {
                setServices(prev => prev.map(service => ), service.id === serviceId
                    ? {
                        ...
                        action
                    } === 'stop' ? 'stopping' :  : , action === 'restart' ? 'starting' : , service.status);
            }
            finally {
            }
        };
...
;
_jsxs("div", { className: "services-section", children: [_jsxs("div", { className: "services-header", children: [_jsx("h3", { children: "System Services" }), _jsx("div", { className: "services-actions", children: _jsxs(Button, { onClick: () => handleSystemAction('restart_all'), variant: "outline", size: "sm", disabled: adminLevel !== 'super_admin', children: [_jsx(RotateCcw, { className: "w-4 h-4 mr-2" }), "Restart All"] }) })] }), _jsxs("div", { className: "services-grid", children: [services.map(service => ()
                    < ServiceCard, key = { service, : .id }, service = { service }, onAction = { handleServiceAction }, onSelect = { setSelectedService }, adminLevel = { adminLevel }
                    /  >
                ), ")}"] })] });
;
