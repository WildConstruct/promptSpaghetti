...
import { Calendar, Clock, PlayCircle, PauseCircle, 
// StopCircle, // Unused import
Edit, Eye, TrendingUp, Users, FileText, Image, Video, Megaphone, Archive, Trash2, Plus, Search, Download, RefreshCw, Settings, CheckCircle, XCircle, Globe, Target, Share2, Bell } from 'lucide-react';
...
gallery: {
    color: 'text-teal-600 bg-teal-100', icon;
    Image;
}
document: {
...
export const ContentSchedulingDashboard = ({
    className = '',
    userId,
    userRole
});
{
    ...
    ;
    div >
        _jsx("div", { className: "performance-section", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Top Performing Content" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "performance-list", children: stats.performanceMetrics.topPerformingContent.map(item => ()
                                    < div, key = { item, : .id }, className = "performance-item" >
                                    (_jsxs("div", { className: "item-info", children: [_jsx("div", { className: "item-title", children: item.title }), _jsxs("div", { className: "item-stats", children: [_jsxs("span", { children: [item.views.toLocaleString(), " views"] }), _jsxs("span", { children: [item.engagement.toFixed(1), "% engagement"] })] })] })
                                        ,
                                            _jsx("div", { className: "item-chart", children: _jsx("div", { className: "performance-bar", style: {
                                                        width: `${Math.min(), }
}
                            100,
...
;
_jsxs("div", { className: "content-section", children: [_jsxs("div", { className: "content-controls", children: [_jsxs("div", { className: "search-filters", children: [_jsxs("div", { className: "search-bar", children: [_jsx(Search, { className: "w-4 h-4 text-gray-400" }), _jsx(Input, { placeholder: "Search content...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "search-input" })] }), _jsxs(Select, { value: typeFilter, onValueChange: (value) => setTypeFilter(value), children: [_jsx("option", { value: "all", children: "All Types" }), _jsx("option", { value: "article", children: "Article" }), _jsx("option", { value: "blog_post", children: "Blog Post" }), _jsx("option", { value: "page", children: "Page" }), _jsx("option", { value: "product", children: "Product" }), _jsx("option", { value: "event", children: "Event" }), _jsx("option", { value: "announcement", children: "Announcement" }), _jsx("option", { value: "promotion", children: "Promotion" }), _jsx("option", { value: "newsletter", children: "Newsletter" }), _jsx("option", { value: "social_post", children: "Social Post" }), _jsx("option", { value: "video", children: "Video" }), _jsx("option", { value: "podcast", children: "Podcast" }), _jsx("option", { value: "gallery", children: "Gallery" }), _jsx("option", { value: "document", children: "Document" })] }), _jsxs(Select, { value: statusFilter, onValueChange: (value) => setStatusFilter(value), children: [_jsx("option", { value: "all", children: "All Statuses" }), _jsx("option", { value: "draft", children: "Draft" }), _jsx("option", { value: "scheduled", children: "Scheduled" }), _jsx("option", { value: "published", children: "Published" }), _jsx("option", { value: "unpublished", children: "Unpublished" }), _jsx("option", { value: "archived", children: "Archived" })] }), _jsxs(Select, { value: dateRange, onValueChange: (value) => setDateRange(value), children: [_jsx("option", { value: "today", children: "Today" }), _jsx("option", { value: "week", children: "Last Week" }), _jsx("option", { value: "month", children: "Last Month" }), _jsx("option", { value: "all", children: "All Time" })] })] }), _jsxs("div", { className: "action-buttons", children: [_jsxs(Button, { onClick: loadData, disabled: isLoading, variant: "outline", children: [_jsx(RefreshCw, { className: `w-4 h-4 ${isLoading ? 'animate-spin' : ''}` }), "} Refresh"] }), _jsxs(Button, { children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Content"] })] })] }), _jsxs("div", { className: "content-grid", children: [filteredContent.map(item => ()
                    < ContentCard, key = { item, : .id }, content = { item }, onSelect = { setSelectedContent }, onPublish = { handlePublishContent }, onUnpublish = { handleUnpublishContent }, onSchedule = { handleScheduleContent }, userRole = { userRole }
                    /  >
                ), ")}"] }), filteredContent.length === 0 && ()
            < div, " className=\"empty-state\">", _jsx(FileText, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No content found" }), _jsx("p", { className: "text-gray-500", children: "Try adjusting your filters or create new content." })] });
div >
;
;
const renderBatchOperations = () => ();
;
_jsxs("div", { className: "batch-section", children: [_jsxs("div", { className: "batch-header", children: [_jsx("h3", { children: "Batch Operations" }), _jsxs(Button, { children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Batch"] })] }), _jsxs("div", { className: "batch-list", children: [batches.map(batch => ()
                    < BatchCard, key = { batch, : .id }, batch = { batch }, onExecute = {}(id)), " => console.log('Execute batch:', id)} onCancel=", (id) => console.log('Cancel batch:', id), "/> ))}"] }), batches.length === 0 && ()
            < div, " className=\"empty-state\">", _jsx(Settings, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No batch operations" }), _jsx("p", { className: "text-gray-500", children: "Create a batch operation to manage multiple content items." })] });
div >
;
;
...
;
{
    ...
    return;
    _jsxs(Card, { className: "content-card", children: [_jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "content-card-header", children: [_jsxs("div", { className: "content-info", children: [_jsx("div", { className: "content-title", children: content.title }), _jsx("div", { className: "content-description", children: content.content.description || 'No description' })] }), _jsxs("div", { className: "content-badges", children: [_jsxs(Badge, { className: typeConfig.color, children: [_jsx(TypeIcon, { className: "w-3 h-3 mr-1" }), content.type] }), _jsxs(Badge, { className: statusConfig.color, children: [_jsx(StatusIcon, { className: "w-3 h-3 mr-1" }), content.status] })] })] }), _jsxs("div", { className: "content-details", children: [_jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Author:" }), _jsx("span", { className: "detail-value", children: content.createdBy })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Created:" }), _jsx("span", { className: "detail-value", children: content.createdAt.toLocaleDateString() })] }), content.scheduling.publishAt && ()
                                < div, " className=\"detail-item\">", _jsx("span", { className: "detail-label", children: "Scheduled:" }), _jsx("span", { className: "detail-value", children: content.scheduling.publishAt.toLocaleString() })] }), ")}", _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Views:" }), _jsx("span", { className: "detail-value", children: content.performance.views.toLocaleString() })] })] }), _jsxs("div", { className: "content-actions", children: [_jsxs(Button, { onClick: () => onSelect(content), variant: "outline", size: "sm", children: [_jsx(Eye, { className: "w-4 h-4 mr-1" }), "View"] }), canPublish && content.status === 'draft' && ()
                        < Button, "onClick=", () => onPublish(content.id), "size=\"sm\" >", _jsx(PlayCircle, { className: "w-4 h-4 mr-1" }), "Publish"] }), ")}", canPublish && content.status === 'published' && ()
                < Button, "onClick=", () => onUnpublish(content.id), "size=\"sm\" variant=\"outline\" >", _jsx(PauseCircle, { className: "w-4 h-4 mr-1" }), "Unpublish"] });
}
{
...
variant = "outline"
    >
        _jsx(Clock, { className: "w-4 h-4 mr-1" });
Schedule;
Button >
;
div >
...
0;
return;
_jsx(Card, { className: "batch-card", children: _jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "batch-header", children: [_jsxs("div", { className: "batch-info", children: [_jsx("div", { className: "batch-name", children: batch.name }), _jsx("div", { className: "batch-operation", children: batch.operation.type.replace('_', ' ').toUpperCase() })] }), _jsx(Badge, { className: getStatusColor(batch.status), children: batch.status.toUpperCase() })] }), _jsxs("div", { className: "batch-progress", children: [_jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: { width: `${progressPercentage}%` } }) }), _jsxs("div", { className: "progress-text", children: [batch.progress.completed, " / ", batch.progress.total, " completed"] })] }), _jsx("div", { className: "batch-actions", children: batch.status === 'pending' && ()
                    <  >
                    (_jsx(Button, { onClick: () => onExecute(batch.id), size: "sm", children: "Execute" })
                        ,
                            _jsx(Button, { onClick: () => onCancel(batch.id), size: "sm", variant: "outline", children: "Cancel" })) }), ")}", _jsxs(Button, { variant: "outline", size: "sm", children: [_jsx(Eye, { className: "w-4 h-4 mr-1" }), "Details"] })] }) })
    ,
        _jsx("style", { children: `
        .batch-card {
          transition: box-shadow 0.2s ease;
