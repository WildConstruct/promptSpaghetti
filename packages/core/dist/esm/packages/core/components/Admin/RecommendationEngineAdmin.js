...
import { Settings, Brain, Target, TrendingUp, BarChart3, Zap, Users, Eye, RefreshCw, Save, Activity, Database, Cpu, Network, } from 'lucide-react';
;
last_trained ?  : Date;
...
content_filters: {
    ...
    exclude_categories: string; // Changed to array,
    featured_categories_boost: Record;
    creator_tier_weights: Record;
}
;
rotation_settings: {
...
ab_testing: {
    enabled: boolean;
    variants: ABTestVariant; // Changed to array,
...
;
export const RecommendationEngineAdmin = ({ className = '' }) => {
...
const renderAlgorithmManagement = () => (_jsxs("div", { className: "algorithms-section", children: [_jsxs("div", { className: "algorithms-header", children: [_jsx("h3", { children: "Recommendation Algorithms" }), _jsxs("div", { className: "header-actions", children: [_jsxs(Button, { variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Retrain All"] }), _jsxs(Button, { children: [_jsx(Brain, { className: "w-4 h-4 mr-2" }), "Add Algorithm"] })] })] }), _jsx("div", { className: "algorithms-list", children: algorithms.map(algorithm => {
                const IconComponent = getAlgorithmTypeIcon(algorithm.type);
                return (_jsxs(Card, { className: "algorithm-card", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "algorithm-header", children: [_jsxs("div", { className: "algorithm-info", children: [_jsxs("div", { className: "algorithm-title", children: [_jsx(IconComponent, { className: "w-5 h-5 text-blue-500" }), _jsx("h4", { children: algorithm.name }), _jsx(Badge, { className: getStatusColor(algorithm.training_status), children: algorithm.training_status.toUpperCase() })] }), _jsx("p", { children: algorithm.description })] }), _jsxs("div", { className: "algorithm-controls", children: [_jsxs("div", { className: "weight-control", children: [_jsxs("label", { children: ["Weight: ", algorithm.weight] }), _jsx("input", { type: "range", min: "0", max: "1", step: "0.1", value: algorithm.weight, className: "weight-slider", readOnly: true })] }), _jsxs("label", { className: "enable-switch", children: [_jsx("input", { type: "checkbox", checked: algorithm.enabled, readOnly: true }), _jsx("span", { children: "Enabled" })] })] })] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "algorithm-metrics", children: _jsxs("div", { className: "metrics-grid", children: [_jsxs("div", { className: "metric-item", children: [_jsx("span", { className: "metric-label", children: "Precision" }), _jsxs("span", { className: "metric-value", children: [(algorithm.performance_metrics.precision * 100).toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-item", children: [_jsx("span", { className: "metric-label", children: "Recall" }), _jsxs("span", { className: "metric-value", children: [(algorithm.performance_metrics.recall * 100).toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-item", children: [_jsx("span", { className: "metric-label", children: "CTR" }), _jsxs("span", { className: "metric-value", children: [algorithm.performance_metrics.click_through_rate.toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-item", children: [_jsx("span", { className: "metric-label", children: "Conversion" }), _jsxs("span", { className: "metric-value", children: [algorithm.performance_metrics.conversion_rate.toFixed(1), "%"] })] })] }) }), _jsxs("div", { className: "algorithm-actions", children: [_jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(Settings, { className: "w-4 h-4 mr-1" }), "Configure"] }), _jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-1" }), "Retrain"] }), _jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(Eye, { className: "w-4 h-4 mr-1" }), "View Details"] })] })] })] }, algorithm.id));
            }) })] }));
const renderFeaturedContentConfig = () => (_jsxs("div", { className: "featured-config-section", children: [_jsxs("div", { className: "config-header", children: [_jsx("h3", { children: "Featured Content Configuration" }), _jsxs("div", { className: "header-actions", children: [_jsxs(Button, { variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Reset to Defaults"] }), _jsxs(Button, { className: "bg-green-600 hover:bg-green-700", children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), "Save Configuration"] })] })] }), _jsxs("div", { className: "config-sections", children: [_jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Algorithm Weights" }) }), _jsx(CardContent, { children: _jsx("div", { className: "weights-grid", children: Object.entries(featuredConfig.algorithm_weights).map(([key, value]) => (_jsxs("div", { className: "weight-control", children: [_jsx("label", { className: "weight-label", children: key.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }), _jsxs("div", { className: "weight-input-group", children: [_jsx("input", { type: "range", min: "0", max: "2", step: "0.1", value: value, onChange: e => setFeaturedConfig({
                                                        ...featuredConfig,
                                                        algorithm_weights: {},
                                                        ...featuredConfig.algorithm_weights,
                                                        [key]: parseFloat(e.target.value),
                                                    }) }), ") } className=\"weight-slider\" />", _jsx("span", { className: "weight-value", children: value.toFixed(1) })] })] }, key))) }) })] }), _jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Content Filters" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "filters-grid", children: [_jsxs("div", { className: "filter-item", children: [_jsx("label", { children: "Min Quality Score" }), _jsx("input", { type: "number", min: "0", max: "100", value: featuredConfig.content_filters.min_quality_score, onChange: e => setFeaturedConfig({
                                                    ...featuredConfig,
                                                    content_filters: {},
                                                    ...featuredConfig.content_filters,
                                                    min_quality_score: parseInt(e.target.value),
                                                }) }), ") } className=\"config-input\" />"] }), _jsxs("div", { className: "filter-item span-2", children: [_jsx("label", { children: "Category Boosts" }), _jsx("div", { className: "category-boosts", children: Object.entries(featuredConfig.content_filters.featured_categories_boost).map(([category, boost]) => (_jsxs("div", { className: "category-boost-item", children: [_jsx("span", { className: "category-name", children: category }), _jsx("input", { type: "number", min: "0", max: "2", step: "0.1", value: boost, onChange: e => setFeaturedConfig({
                                                                ...featuredConfig,
                                                                content_filters: {},
                                                                ...featuredConfig.content_filters,
                                                                featured_categories_boost: {},
                                                            ...
                                                            }) }), ", }) } className=\"boost-input\" />"] }, category))) })] })] }) })] }), _jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "section-title", children: [_jsx(Target, { className: "w-5 h-5 text-purple-500" }), "A/B Testing Configuration"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "ab-testing-config", children: [_jsxs("div", { className: "ab-header", children: [_jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: featuredConfig.ab_testing.enabled, onChange: e => setFeaturedConfig({
                                                            ...featuredConfig,
                                                            ab_testing: {},
                                                            ...featuredConfig.ab_testing,
                                                            enabled: e.target.checked,
                                                        }) }), ") } />", _jsx("span", { children: "Enable A/B Testing" })] }), _jsxs("div", { className: "traffic-allocation", children: [_jsxs("label", { children: ["Traffic Allocation: ", featuredConfig.ab_testing.traffic_allocation, "%"] }), _jsx("input", { type: "range", min: "0", max: "100", value: featuredConfig.ab_testing.traffic_allocation, onChange: e => setFeaturedConfig({
                                                            ...featuredConfig,
                                                            ab_testing: {},
                                                            ...featuredConfig.ab_testing,
                                                            traffic_allocation: parseInt(e.target.value),
                                                        }) }), ") } className=\"traffic-slider\" />"] })] }), featuredConfig.ab_testing.enabled && (_jsxs("div", { className: "variants-list", children: [_jsx("h5", { children: "Test Variants" }), featuredConfig.ab_testing.variants.map(variant => (_jsxs("div", { className: "variant-item", children: [_jsxs("div", { className: "variant-info", children: [_jsx("h6", { children: variant.name }), _jsxs("span", { className: "variant-allocation", children: [variant.allocation_percentage, "% allocation"] })] }), variant.performance_metrics && (_jsxs("div", { className: "variant-metrics", children: [_jsx("div", { className: "variant-metric", children: _jsxs("span", { children: ["CTR: ", variant.performance_metrics.ctr, "%"] }) }), _jsx("div", { className: "variant-metric", children: _jsxs("span", { children: ["Conv: ", variant.performance_metrics.conversion_rate, "%"] }) }), _jsx("div", { className: "variant-metric", children: _jsxs("span", { children: ["Rev/View: $", variant.performance_metrics.revenue_per_view] }) })] }))] }, variant.id)))] }))] }) })] })] })] }));
const renderPerformanceMetrics = () => (_jsxs("div", { className: "metrics-section", children: [_jsxs("div", { className: "metrics-header", children: [_jsx("h3", { children: "Performance Metrics" }), _jsxs("div", { className: "header-actions", children: [_jsxs(Button, { variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Refresh"] }), _jsxs(Button, { variant: "outline", children: [_jsx(BarChart3, { className: "w-4 h-4 mr-2" }), "Export Report"] })] })] }), _jsx("div", { className: "metrics-overview", children: _jsxs("div", { className: "overview-cards", children: [_jsx(Card, { className: "metric-card", children: _jsxs(CardContent, { children: [_jsxs("div", { className: "metric-header", children: [_jsx(Eye, { className: "w-6 h-6 text-blue-500" }), _jsxs("div", { className: "metric-trend positive", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), "+12.5%"] })] }), _jsxs("div", { className: "metric-content", children: [_jsx("div", { className: "metric-value", children: metrics.overall_performance.total_recommendations_served.toLocaleString() }), _jsx("div", { className: "metric-label", children: "Total Recommendations" })] })] }) }), _jsx(Card, { className: "metric-card", children: _jsxs(CardContent, { children: [_jsxs("div", { className: "metric-header", children: [_jsx(Target, { className: "w-6 h-6 text-green-500" }), _jsxs("div", { className: "metric-trend positive", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), "+8.2%"] })] }), _jsxs("div", { className: "metric-content", children: [_jsxs("div", { className: "metric-value", children: [metrics.overall_performance.click_through_rate.toFixed(2), "%"] }), _jsx("div", { className: "metric-label", children: "Click-Through Rate" })] })] }) }), _jsx(Card, { className: "metric-card", children: _jsxs(CardContent, { children: [_jsxs("div", { className: "metric-header", children: [_jsx(Zap, { className: "w-6 h-6 text-purple-500" }), _jsxs("div", { className: "metric-trend positive", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), "+15.7%"] })] }), _jsxs("div", { className: "metric-content", children: [_jsxs("div", { className: "metric-value", children: [metrics.overall_performance.conversion_rate.toFixed(1), "%"] }), _jsx("div", { className: "metric-label", children: "Conversion Rate" })] })] }) }), _jsx(Card, { className: "metric-card", children: _jsxs(CardContent, { children: [_jsxs("div", { className: "metric-header", children: [_jsx(Activity, { className: "w-6 h-6 text-orange-500" }), _jsxs("div", { className: "metric-trend positive", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), "+22.1%"] })] }), _jsxs("div", { className: "metric-content", children: [_jsxs("div", { className: "metric-value", children: ["$", metrics.overall_performance.revenue_impact.toLocaleString()] }), _jsx("div", { className: "metric-label", children: "Revenue Impact" })] })] }) })] }) }), _jsxs("div", { className: "detailed-metrics", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Algorithm Performance Comparison" }) }), _jsx(CardContent, { children: _jsx("div", { className: "algorithm-comparison", children: _jsxs("div", { className: "comparison-table", children: [_jsxs("div", { className: "table-header", children: [_jsx("div", { className: "header-cell", children: "Algorithm" }), _jsx("div", { className: "header-cell", children: "Precision" }), _jsx("div", { className: "header-cell", children: "Recall" }), _jsx("div", { className: "header-cell", children: "F1 Score" }), _jsx("div", { className: "header-cell", children: "Latency" }), _jsx("div", { className: "header-cell", children: "Cache Hit" })] }), Object.entries(metrics.algorithm_performance).map(([algId, perf]) => {
                                            ...
                                            return (_jsxs("div", { className: "table-row", children: [_jsxs("div", { className: "cell algorithm-name", children: [algorithm?.name || algId, algorithm?.enabled && _jsx(Badge, { className: "enabled-badge", children: "Active" })] }), _jsxs("div", { className: "cell metric-cell", children: [(perf.precision * 100).toFixed(1), "%"] }), _jsxs("div", { className: "cell metric-cell", children: [(perf.recall * 100).toFixed(1), "%"] }), _jsxs("div", { className: "cell metric-cell", children: [(perf.f1_score * 100).toFixed(1), "%"] }), _jsxs("div", { className: "cell metric-cell", children: [perf.latency_ms, "ms"] }), _jsxs("div", { className: "cell metric-cell", children: [(perf.cache_hit_rate * 100).toFixed(1), "%"] })] }, algId));
