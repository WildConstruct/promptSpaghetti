...
import { ComplianceFramework } from '../../security/SecurityEventLoggingPolicies';
...
`tab-trigger ${activeTab === 'overview' ? 'active' : ''}`;
onClick = {}();
setActiveTab('overview');
    >
        Overview;
button >
    (_jsx("button", { className: `tab-trigger ${activeTab === 'destinations' ? 'active' : ''}`, onClick: () => setActiveTab('destinations'), children: "Destinations" })
        ,
            _jsx("button", { className: `tab-trigger ${activeTab === 'events' ? 'active' : ''}`, onClick: () => setActiveTab('events'), children: "Event Types" })
                ,
                    _jsx("button", { className: `tab-trigger ${activeTab === 'alerts' ? 'active' : ''}`, onClick: () => setActiveTab('alerts'), children: "Alert Rules" })
                        ,
                            _jsx("button", { className: `tab-trigger ${activeTab === 'retention' ? 'active' : ''}`, onClick: () => setActiveTab('retention'), children: "Retention" })
                                ,
                                    _jsx("button", { className: `tab-trigger ${activeTab === 'performance' ? 'active' : ''}`, onClick: () => setActiveTab('performance'), children: "Performance" })
                                        ,
                                            _jsx("button", { className: `tab-trigger ${activeTab === 'compliance' ? 'active' : ''}`, onClick: () => setActiveTab('compliance'), children: "Compliance" }));
div >
