                                ...
                                boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)'
                                        ...
                                        marginBottom: '24px'
                                                ...
                                                justifyContent: 'center'
                                                        ...
                                                        borderRadius: '4px',
                                                        fontSize: '13px'
                                                    }, children: [_jsx("option", { value: "draft", children: "\uD83D\uDCDD Draft - Basic export" }), _jsx("option", { value: "standard", children: "\u2B50 Standard - Full metadata" }), _jsx("option", { value: "high", children: "\uD83D\uDC8E High - Complete with validation" })] })] })] })] }), _jsx("div", { style: { marginBottom: '16px' }, children: _jsx("button", { type: "button", onClick: generatePreview, disabled: isLoading, style: {
                                    padding: '8px 16px',
                                    border: '1px solid #ddd',
                                    ...
                                    >
                                        { isLoading, 'Loading...': '🔍 Preview Bundle' } }) }), previewData && ()
                            < div, " style=", {
                            background: '#f8f9fa',
...
style = {};
{
 ...
 >
    (_jsx("h4", { style: { margin: '0 0 8px 0', fontSize: '14px', color: '#0066cc' }, children: "\uD83D\uDCCB Export Information" })
        ,
            _jsxs("ul", { style: {
                    margin: '0',
                    paddingLeft: '16px',
                    ...
                    lineHeight: 1.4
                        ...
                        < li > CLI, " usage: ", _jsxs("code", { children: ["promptgraph exec ", formData.name, getFormatInfo(formData.format).extension] })] }));
{
