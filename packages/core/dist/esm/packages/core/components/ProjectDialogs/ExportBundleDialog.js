                ...
                boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)',
                        ...
                        marginBottom: '24px',
                                ...
                                justifyContent: 'center',
                                        ...
                                        fontSize: '13px',
                                        marginBottom: '8px',
                                    }, children: isLoading ? 'Loading...' : '🔍 Preview Bundle' }), previewData && (_jsxs("div", { style: {
                                        background: '#f8f9fa',
                                        ...
                                        maxHeight: '200px',
                                        overflowY: 'auto',
                                    }, children: [_jsx("strong", { children: "Bundle Preview:" }), _jsxs("pre", { style: { margin: '8px 0 0 0', whiteSpace: 'pre-wrap' }, children: [JSON.stringify(previewData, null, 2).substring(0, 500), JSON.stringify(previewData, null, 2).length > 500 ? '...' : ''] })] }))] }), _jsxs("div", { style: {
                                ...
                                marginBottom: '16px',
                                        ...
                                        color: '#0066cc',
                                        lineHeight: 1.4,
                                    }, children: [_jsxs("li", { children: ["Contains ", nodes.length, " nodes and ", edges.length, " connections"] }), _jsxs("li", { children: ["Format: ", getFormatInfo(formData.format).name] }), _jsxs("li", { children: ["Extension: ", getFormatInfo(formData.format).extension] }), formData.format === 'json' && (_jsxs("li", { children: ["CLI usage: ", _jsxs("code", { children: ["promptgraph exec ", formData.name, getFormatInfo(formData.format).extension] })] })), formData.format === 'graph' && (_jsx("li", { children: "Re-importable graph format for GraphEditor" })), (formData.format === 'yaml' || formData.format === 'xml') && (_jsx("li", { children: "Human-readable format for documentation and review" })), formData.format === 'csv' && (_jsx("li", { children: "Tabular format suitable for analysis tools" })), _jsxs("li", { children: ["Quality level: ", formData.exportQuality] })] })] }), error && (_jsxs("div", { style: {
                                backgroundColor: '#fee',
