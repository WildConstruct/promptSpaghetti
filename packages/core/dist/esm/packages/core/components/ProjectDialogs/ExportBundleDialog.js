        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('h2', {
              ...
              children: '\uD83D\uDCE6 Export GeneratorBundle',
            }),
            _jsx('button', {
              onClick: onClose,
              style: {
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('select', {
                  ...
                  children: [
                    _jsx('option', { value: 'json', children: '\uD83D\uDCE6 GeneratorBundle JSON - Standard format' }),
                    _jsx('option', {
                      value: 'compressed',
                      children: '\uD83D\uDDDC\uFE0F Compressed JSON - Smaller file size',
                    }),
                    _jsx('option', { value: 'yaml', children: '\uD83D\uDCCB YAML Format - Human readable' }),
                    _jsx('option', { value: 'xml', children: '\uD83C\uDFF7\uFE0F XML Format - Structured markup' }),
                    _jsx('option', { value: 'graph', children: '\uD83C\uDF10 Graph Format - Native .psg format' }),
                    _jsx('option', { value: 'csv', children: '\uD83D\uDCCA CSV Export - Tabular data' }),
                  ],
                }),
                _jsx('div', {
                  style: {
                  ...
                  children: getFormatInfo(formData.format).description,
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('label', { style: { fontSize: '13px', color: '#666' }, children: 'Export Quality:' }),
                    _jsxs('select', {
                      ...
                      children: [
                        _jsx('option', { value: 'draft', children: '\uD83D\uDCDD Draft - Basic export' }),
                        _jsx('option', { value: 'standard', children: '\u2B50 Standard - Full metadata' }),
                        _jsx('option', { value: 'high', children: '\uD83D\uDC8E High - Complete with validation' }),
                      ],
                    }),
                  ],
                }),
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('button', {
                  ...
                  children: isLoading ? 'Loading...' : '🔍 Preview Bundle',
                }),
                previewData &&
                  _jsxs('div', {
                    style: {
                    ...
                    children: [
                      _jsx('strong', { children: 'Bundle Preview:' }),
                      _jsxs('pre', {
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('ul', {
                  ...
                  children: [
                    _jsxs('li', { children: ['Contains ', nodes.length, ' nodes and ', edges.length, ' connections'] }),
                    _jsxs('li', { children: ['Format: ', getFormatInfo(formData.format).name] }),
                    _jsxs('li', { children: ['Extension: ', getFormatInfo(formData.format).extension] }),
                    formData.format === 'json' &&
                      _jsxs('li', {
                        children: [
                          'CLI usage: ',
                          _jsxs('code', {
                            children: ['promptgraph exec ', formData.name, getFormatInfo(formData.format).extension],
                          }),
                        ],
                      }),
                    formData.format === 'graph' &&
                      _jsx('li', { children: 'Re-importable graph format for GraphEditor' }),
                    (formData.format === 'yaml' || formData.format === 'xml') &&
                      _jsx('li', { children: 'Human-readable format for documentation and review' }),
                    formData.format === 'csv' && _jsx('li', { children: 'Tabular format suitable for analysis tools' }),
