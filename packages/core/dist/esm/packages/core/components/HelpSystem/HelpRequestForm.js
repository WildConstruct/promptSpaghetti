...
import { HelpRequestType, HelpCategory, HelpPriority } from RequestContext;
from;
...
const generateTitleSuggestions = useCallback(() => {
    const suggestions = {
        [HelpRequestType.QUESTION]: [
            ...
            'I need help with...'
        ][HelpRequestType.TECHNICAL_ISSUE], ['Unable to...']: 'Error when trying to...',
        'Feature not working...': 'Performance issue with...'
    };
});
