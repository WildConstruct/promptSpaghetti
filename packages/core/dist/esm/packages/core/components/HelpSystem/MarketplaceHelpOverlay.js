...
// Callbacks
onHelpInteraction ?  : (action, context) => void ;
onTourCompleted ?  : (tourId) => void ;
onFeedbackSubmitted ?  : (feedback) => void ;
export const MarketplaceHelpOverlay = ({
...
}
{
    ...
    'Finding the Right Template',
        content;
    'Use the search and filter system to discover templates that match your creative vision. Templates are organized by genre, complexity, and use case.',
        filmTerminology;
    'Like scouting locations or casting - find the right elements that match your creative vision.',
        actionItems;
    [
        ...
        relatedFeatures;
    ['Advanced Search', 'Category Navigation', 'Sort Options', 'Wishlist'],
        level;
    'beginner',
        context;
    {
    ...
    }
    {
        ...
        'Template Preview & Evaluation',
            content;
        'Preview templates to understand their structure and potential outputs. Each template shows example generations and explains the creative approach.',
            filmTerminology;
        'Like reading a script treatment - get a feel for the story structure and creative approach before committing.',
            actionItems;
        [
            ...
            relatedFeatures;
        ['Template Preview', 'Example Outputs', 'Complexity Indicators'],
            level;
        'beginner',
            context;
        {
        ...
        }
        {
            ...
            'Template Purchase Process',
                content;
            'Add templates to your cart and complete the purchase. You\'ll receive immediate access to download and use templates in your projects.',
                filmTerminology;
            'Like acquiring rights to a script - once purchased, you have full creative license to adapt and use.',
                actionItems;
            [
                ...
                relatedFeatures;
            ['Shopping Cart', 'Secure Checkout', 'License Management', 'Download System'],
                level;
            'beginner',
                context;
            {
            ...
            }
            {
                ...
                'Rating and Reviewing Templates',
                    content;
                'Share your experience with templates by rating and reviewing them. Help other creators discover quality content and provide feedback to template creators.',
                    filmTerminology;
                'Like film critics and audience reviews - your feedback guides others and improves the creative community.',
                    actionItems;
                [
                    ...
                    relatedFeatures;
                ['Rating System', 'Review Writing', 'Community Feedback'],
                    level;
                'intermediate',
                    context;
                {
                ...
                }
                {
                    ...
                    'Creator Dashboard Overview',
                        content;
                    'Manage your template creations, track sales performance, and engage with your audience. The creator dashboard provides all tools needed for template monetization.',
                        filmTerminology;
                    'Like a production office - track your projects, monitor performance, and manage your creative business.',
                        actionItems;
                    [
                        ...
                        relatedFeatures;
                    ['Template Upload', 'Analytics Dashboard', 'Revenue Tracking', 'Community Management'],
                        level;
                    'advanced',
                        context;
                    {
                    ...
                    }
                    {
                        ...
                        'Community & Forum Participation',
                            content;
                        'Connect with other creators, share techniques, ask questions, and participate in community discussions. Build your reputation and learn from experienced professionals.',
                            filmTerminology;
                        'Like industry networking events and creative guilds - connect, collaborate, and grow your professional network.',
                            actionItems;
                        [
                            ...
                            relatedFeatures;
                        ['Community Forum', 'User Profiles', 'Following System', 'Creative Challenges'],
                            level;
                        'intermediate',
                            context;
                        {
                        ...
                        }
                        {
                            ...
                            'Profile & Portfolio Management',
                                content;
                            'Create a compelling profile that showcases your work and builds trust with potential buyers. A well-crafted profile increases template visibility and sales.',
                                filmTerminology;
                            'Like your director\'s reel - showcase your best work and creative style to attract collaborators and opportunities.',
                                actionItems;
                            [
                                ...
                                relatedFeatures;
                            ['Profile Editor', 'Portfolio Gallery', 'Bio Management', 'Achievement System'],
                                level;
                            'intermediate',
                                context;
                            {
                            ...
                            }
                            {
                                ...
                                'monetization',
                                    title;
                                'Template Monetization Best Practices',
                                    content;
                                'Learn effective strategies for pricing, marketing, and optimizing your templates for maximum revenue. Understanding market trends and customer needs drives success.',
                                    filmTerminology;
                                'Like film distribution strategy - understand your audience, price appropriately, and market effectively.',
                                    actionItems;
                                [
                                    ...
                                    relatedFeatures;
                                ['Pricing Tools', 'Analytics Dashboard', 'SEO Optimization', 'Marketing Resources'],
                                    level;
                                'advanced',
                                    context;
                                {
                                    conditions: {
                                        isCreator: true, hasPublishedTemplates;
                                        true;
                                    }
                                }
                                marketplaceContext: {
            ...
            const handleFeedbackSubmit = useCallback((rating, comment) => {
                if (activeOverlay) {
                    ...
                    rating,
                        comment,
                        context;
                    `${activeOverlay.id} - ${currentMarketplaceContext.page}`;
                }
            });
        ...
        if (!showMarketplaceHelp)
            return null;
        return;
        _jsxs("div", { className: "marketplace-help-overlay", children: [isOverlayVisible && activeOverlay && ()
                    < div, "ref=", overlayRef, "className=", `marketplace-help-tooltip ${overlaySize}`, "style=", {
                    position: 'fixed',
                    left: `${overlayPosition.x}px`
                }, ", top: `$", overlayPosition.y, "px`} }, zIndex: 10001; }} >", _jsxs("div", { className: "overlay-header", children: [_jsxs("div", { className: "help-title", children: [_jsxs("span", { className: "help-icon", children: [activeOverlay.type === 'marketplace-discovery' && '🏪', activeOverlay.type === 'template-browsing' && '🔍', activeOverlay.type === 'template-preview' && '👁️', activeOverlay.type === 'purchase-flow' && '💳', activeOverlay.type === 'rating-system' && '⭐', activeOverlay.type === 'creator-onboarding' && '👨‍🎨', activeOverlay.type === 'community-features' && '👥', activeOverlay.type === 'profile-management' && '👤', activeOverlay.type === 'monetization' && '💰', !activeOverlay.type.includes('marketplace') && '💡'] }), _jsx("h3", { children: activeOverlay.title })] }), _jsxs("div", { className: "overlay-controls", children: [_jsx("button", { className: "size-toggle", onClick: () => setOverlaySize(overlaySize === 'compact' ? 'normal' : 'compact'), title: "Toggle size", children: overlaySize === 'compact' ? '⬆' : '⬇' }), _jsx("button", { className: "feedback-button", onClick: () => setShowFeedback(true), title: "Provide feedback", children: "\uD83D\uDCAC" }), _jsx("button", { className: "close-button", onClick: hideOverlay, title: "Close help", children: "\u00D7" })] })] }), _jsxs("div", { className: "overlay-content", children: [_jsx("p", { className: "help-description", children: activeOverlay.content }), activeOverlay.filmTerminology && overlaySize !== 'compact' && ()
                            < div, " className=\"marketplace-terminology\">", _jsx("span", { className: "terminology-icon", children: "\uD83C\uDFAD" }), _jsx("p", { children: activeOverlay.filmTerminology })] }), ")}", overlaySize === 'expanded' && activeOverlay.actionItems && ()
                    < div, " className=\"action-items\">", _jsx("h4", { children: "Quick Actions:" }), _jsx("ul", { children: activeOverlay.actionItems.map((action, index) => ()
                        < li, key = { index } > { action }) }), "))}"] });
        div >
        ;
    }
    {
        overlaySize === 'expanded' && activeOverlay.relatedFeatures && ()
            < div;
        className = "related-features" >
            (_jsx("h4", { children: "Related Features:" })
                ,
                    _jsx("div", { className: "feature-tags", children: activeOverlay.relatedFeatures.map((feature, index) => ()
                            < span, key = { index }, className = "feature-tag" > { feature }) }));
    }
    div >
    ;
    div >
    ...
    { /* Tour Navigation */};
{
    ...
    className = "tour-navigation" >
        (_jsxs("div", { className: "tour-progress", children: [_jsxs("div", { className: "progress-bar", children: [_jsx("div", { className: "progress-fill", style: {
                                width: `${((tourStep + 1) / marketplaceHelpDatabase.filter(h => h.type === currentTour).length) * 100}%`
                            } }), "} />"] }), _jsxs("span", { className: "step-text", children: ["Step ", tourStep + 1, " of ", marketplaceHelpDatabase.filter(h => h.type === currentTour).length] })] })
            ,
                _jsxs("div", { className: "tour-controls", children: [_jsx("button", { className: "tour-skip", onClick: hideOverlay, children: "Skip Tour" }), _jsx("button", { className: "tour-next", onClick: nextTourStep, children: tourStep === marketplaceHelpDatabase.filter(h => h.type === currentTour).length - 1 ? 'Finish' : 'Next →' })] }));
    div >
    ;
}
{ /* Feedback Form */ }
{
    ...
    className = "feedback-form" >
        (_jsx("h4", { children: "Was this helpful?" })
            ,
                _jsxs("div", { className: "feedback-rating", children: [[1, 2, 3, 4, 5].map(rating => ()
                            < button, key = { rating }, className = "rating-star", onClick = {}()), " => handleFeedbackSubmit(rating, '')} > \u2B50"] }));
}
div >
    _jsx("button", { className: "feedback-close", onClick: () => setShowFeedback(false), children: "Cancel" });
div >
;
div >
;
{ /* Tour Launcher for new users */ }
{
    userRole === 'new-user' && currentPage === 'marketplace' && !currentTour && enableGuidedTours && ()
        < div;
    className = "marketplace-tour-launcher" >
        _jsx("button", { className: "start-marketplace-tour", onClick: () => startGuidedTour('marketplace-discovery'), children: "\uD83D\uDE80 Take Marketplace Tour" });
    div >
    ;
}
_jsx("style", { children: `
