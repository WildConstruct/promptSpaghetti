...
;
// Start guided tour
const startGuidedTour = useCallback((tourType) => { const tourContent = marketplaceHelpDatabase.filter(help => ); });
help.type === tourType ||
...
return () => { delete window.marketplaceHelp; };
    ...
    { /* Tour Navigation */};
{
    ...
    className = "tour-navigation" >
        (_jsxs("div", { className: "tour-progress", children: [_jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: {
...
_jsx("style", { children: `
  ...
  transform: translateY(-3px);
        ...
        @keyframes marketplaceTourPulse { 0%, 100% { transform: scale(1) }
