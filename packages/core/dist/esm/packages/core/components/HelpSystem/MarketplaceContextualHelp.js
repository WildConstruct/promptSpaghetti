...
maxTriggers ?  : number;
export const MarketplaceContextualHelp = ({
    userId = 'anonymous',
    userRole = 'new-user',
    userLevel = 'beginner',
    currentPage,
...
// Search struggle detection
{
        ...
        conditions;
    {
            ...
            userBehavior;
        {
            searchRefinements: 3,
                timeWithoutProgress;
            30000; // 30 seconds without success,
        }
        helpContent: {
            id: 'search-help',
                type;
            ...
            'Having trouble finding what you need?',
                content;
            'Try these search strategies to find the perfect template for your project.',
                actionItems;
            [
        ...
        // Template preview hesitation
        {
                ...
                conditions;
            {
                ...
                helpContent: {
                    ...
                    'template-preview',
                        title;
                    'Click to Preview Templates',
                        content;
                    'Previewing templates is free and helps you understand how they work before purchasing. See example outputs and complexity levels.',
                        actionItems;
                    [
                ...
                // Purchase hesitation
                {
                        ...
                        conditions;
                    {
                        pagePattern: /\/template\/.*$/,
                            timeThreshold;
                        20000, // 20 seconds on template page
                            userBehavior;
                        {
                    ...
                    helpContent: {
                        ...
                        'Ready to Get Started?',
                            content;
                        'This template includes everything you need plus our satisfaction guarantee. You can download immediately after purchase.',
                            actionItems;
                        [
                    ...
                    // Creator dashboard first time
                    {
                        ...
                        helpContent: {
                            ...
                            'Welcome to Your Creator Dashboard',
                                content;
                            'This is your command center for managing templates, tracking sales, and building your creative business on the marketplace.',
                                actionItems;
                            [
                        ...
                        // Feature discovery triggers
                        {
                            ...
                            helpContent: {
                                ...
                                'Save Templates for Later',
                                    content;
                                'Add templates to your wishlist to save them for later. Get notified when they go on sale or when the creator releases updates.',
                                    actionItems;
                                [
                            ...
                            // Community engagement
                            {
                                ...
                                helpContent: {
                                    ...
                                    'Join the Conversation',
                                        content;
                                    'Our community is full of creators sharing tips, asking questions, and collaborating on projects. Your participation helps everyone grow.',
                                        actionItems;
                                    [
                                ...
                                // Error recovery help
                                {
                                    ...
                                    helpContent: {
                                        ...
                                        'Having Technical Issues?',
                                            content;
                                        'Don\'t worry! Most issues can be resolved quickly. Here are some common solutions.',
                                            actionItems;
                                        [
                                    ...
                                    const updateBehaviorContext = useCallback((updates) => {
                                        setUserBehavior(prev => ({}), ...prev, ...updates, timeOnPage, Date.now() - pageStartTime.current);
                                    });
                                }
                                [];
                                ;
                    ...
                    _jsx("div", { className: "marketplace-contextual-help", children: _jsx(MarketplaceHelpOverlay, { currentPage: currentPage, userRole: userRole, selectedTemplate: pageContext.template, cartItems: userBehavior.templatesAddedToCart, purchaseStage: pageContext.purchaseStage || 'browsing', forumContext: pageContext.forumContext, showMarketplaceHelp: !!activeHelp, enableGuidedTours: false, helpComplexity: userLevel === 'beginner' ? 'beginner' : 'advanced', onHelpInteraction: (action, context) => {
                                ...
                                { /* Debug Information (development only) */ }
                                {
                                    process.env.NODE_ENV === 'development' && ()
                                        < div;
                                    className = "contextual-help-debug" >
                                        _jsxs("div", { className: "debug-panel", children: [_jsx("h4", { children: "Contextual Help Debug" }), _jsxs("div", { className: "debug-info", children: [_jsxs("div", { children: ["Time on Page: ", Math.floor(userBehavior.timeOnPage / 1000), "s"] }), _jsxs("div", { children: ["Scroll Depth: ", Math.floor(userBehavior.scrollDepth), "%"] }), _jsxs("div", { children: ["Templates Viewed: ", userBehavior.templatesViewed] }), _jsxs("div", { children: ["Search Attempts: ", userBehavior.searchAttempts] }), _jsxs("div", { children: ["Struggling Areas: ", strugglingAreas.join(', ') || 'None'] }), _jsxs("div", { children: ["Active Help: ", activeHelp?.id || 'None'] }), _jsxs("div", { children: ["Triggered Rules: ", Array.from(triggeredRules).length] })] })] });
                                }
                            } }) });
                }
                _jsx("style", { children: `
