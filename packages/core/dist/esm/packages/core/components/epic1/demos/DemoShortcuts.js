...
import { getDemoGraphById } from './medievalDemoGraphs';
export const DemoShortcuts = ({ onLoadGraph, onClearGraph, onGeneratePreview, onToggleAssetLibrary, onStartDemo, additionalShortcuts = [], }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            backdropFilter: 'blur(10px)',
        }, children: [_jsx("h3", { style: { margin: '0 0 24px 0', fontSize: 24 }, children: "\uD83C\uDFAE Demo Shortcuts" }), _jsx("div", { style: { display: 'grid', gap: 12 }, children: allShortcuts.map((shortcut, index) => (_jsxs("div", { style: {
                        display: 'flex',
                        alignItems: 'center',
                        gap: 16,
                            ...
                            }, children: formatShortcut(shortcut) }), _jsx("span", { style: { fontSize: 14, opacity: 0.9 }, children: shortcut.description })] }, index))) }), _jsx("div", { style: {
                    marginTop: 24,
                    paddingTop: 24,
                    ...
                    opacity: 0.7,
                    textAlign: 'center',
                }, children: "Press ? or Escape to close" })] }));
};
