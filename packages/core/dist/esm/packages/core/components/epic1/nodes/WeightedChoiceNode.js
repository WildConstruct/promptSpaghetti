...
export const WeightedChoiceNode = memo((props) => {
    ...
    return (_jsx(BaseEditableNode, { ...props, className: "weighted-choice", minWidth: 280, minHeight: 120, data: {
            ...
            if (isEditing) {
                return (_jsxs("div", { className: "epic1-weighted-choice-editor", children: [_jsx("div", { className: "epic1-node-type-label", children: "Weighted Choice" }), _jsx("div", { className: "epic1-options-list nodrag nopan nowheel", onWheel: (e) => {
                                ...
                                e.stopPropagation();
                            }, children: options.map((option, index) => (_jsxs("div", { className: "epic1-option-row", children: [_jsx("input", { type: "text", className: "epic1-option-text nodrag", value: option.text, onChange: (e) => updateOptionText(index, e.target.value), placeholder: "Option text...", onClick: (e) => e.stopPropagation() }), _jsxs("div", { className: "epic1-weight-controls", children: [_jsx("input", { type: "range", className: "epic1-weight-slider nodrag", min: "0", max: "100", value: option.weight, onChange: (e) => {
                                                    updateOptionWeight(index, parseInt(e.target.value));
                                                }, onMouseDown: (e) => {
                                                    e.stopPropagation();
                                                }, style: { '--value': `${option.weight}%` } }), _jsxs("span", { className: "epic1-weight-value", children: [option.weight, "%"] }), options.length > 1 && (_jsx("button", { className: "epic1-remove-option nodrag", onClick: (e) => {
                                                    e.stopPropagation();
                                                    removeOption(index);
                                                }, title: "Remove option", children: "\u00D7" }))] })] }, index))) }), _jsxs("div", { className: "epic1-option-controls", children: [_jsx("button", { className: "epic1-add-option nodrag", onClick: (e) => {
                                        e.stopPropagation();
                                        e.preventDefault();
                                        addOption();
