...
{ /* Selected Files */ }
{
    ...
    className = "selected-files" >
        _jsxs("h4", { children: ["Selected Files (", selectedFiles.length, ")"] });
    {
        selectedFiles.map((file, index) => ()
            < div, key = { index }, className = "file-item" >
            (_jsxs("div", { className: "file-info", children: [_jsx("span", { className: "file-icon", children: getFileIcon(file.type) }), _jsxs("div", { className: "file-details", children: [_jsx("div", { className: "file-name", children: file.name }), _jsx("div", { className: "file-size", children: formatFileSize(file.size) })] })] })
                ,
                    _jsx("button", { type: "button", className: "remove-file", onClick: () => removeFile(index), disabled: disabled, title: "Remove file", children: "\u274C" })), div >
        );
    }
    div >
    ;
...
{ /* Existing Files */ }
{
    existingFiles.length > 0 && ()
        < div;
    className = "existing-files" >
        _jsxs("h4", { children: ["Previously Uploaded (", existingFiles.length, ")"] });
    {
        existingFiles.map((file) => ()
            < div, key = { file, : .id }, className = "file-item existing" >
            (_jsxs("div", { className: "file-info", children: [_jsx("span", { className: "file-icon", children: getFileIcon(file.type) }), _jsxs("div", { className: "file-details", children: [_jsx("div", { className: "file-name", children: file.name }), _jsx("div", { className: "file-size", children: formatFileSize(file.size) }), _jsxs("div", { className: "file-date", children: ["Uploaded ", file.uploadedAt.toLocaleDateString()] })] })] })
                ,
                    _jsx("div", { className: "file-status", children: "\u2705" })), div >
        );
    }
    div >
    ;
