...
import { projectManager } from '../../projectManager';
{
    ...
    _jsxs("div", { className: className, style: style, children: [_jsx("div", { style: {
                    ...
                    border: '1px solid #e5e5e5'
                        ...
                        >
                            Recent }) }), _jsx("button", { onClick: () => setCurrentView('favorites'), style: {
                    flex: 1,
                    padding: '8px 16px',
                    border: 'none',
    ...
    >
        _jsxs("div", { style: {
                ...
                cursor: 'pointer'
                        ...
                        fontSize: '16px'
                    }, title: projectManager.isFavorite(file.id) ? 'Remove from favorites' : 'Add to favorites', "aria-label": `${projectManager.isFavorite(file.id) ? 'Remove from' : 'Add to'} favorites`, children: projectManager.isFavorite(file.id) ? '⭐' : '☆' })] }), div >
);
div >
;
div >
