        ...
        zIndex: 1000
                ...
                boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)'
                        ...
                        justifyContent: 'space-between'
                                ...
                                cursor: 'pointer',
                                padding: '4px'
                            }, children: "\u00D7" })] }), _jsx("div", { style: { display: 'flex', flex: 1, overflow: 'hidden' }, children: _jsxs("div", { style: {
                            width: '250px',
                            ...
                            overflow: 'auto'
                                ...
                                fontWeight: '500',
                                color: '#374151'
                            }, children: "Sort By" }), _jsx("select", { value: browserState.sortBy, onChange: (e) => handleStateChange({ sortBy: e.target.value }), style: {
                                width: '100%',
                                padding: '6px 8px',
                                border: '1px solid #d1d5db',
                                borderRadius: '4px',
                                ...
                                >
                                    (_jsx("option", { value: "modified", children: "Recently Modified" })
                                        ,
                                            _jsx("option", { value: "created", children: "Recently Created" })
                                                ,
                                                    _jsx("option", { value: "name", children: "Name (A-Z)" })
                                                        ,
                                                            _jsx("option", { value: "rating", children: "Highest Rated" })
                                                                ,
                                                                    _jsx("option", { value: "usage", children: "Most Used" })) })] })] }), _jsx("div", { style: { marginBottom: '16px' }, children: _jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("input", { type: "checkbox", checked: browserState.showOnlyMyTemplates, onChange: (e) => handleStateChange({ showOnlyMyTemplates: e.target.checked }), style: { margin: 0 } }), _jsx("span", { style: { fontSize: '13px', color: '#374151' }, children: "Show only my templates" })] }) }), _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("div", { style: { display: 'flex', gap: '4px' }, children: _jsx("button", { onClick: () => handleStateChange({ viewMode: 'grid' }), style: {
                            padding: '4px 8px',
                            border: '1px solid #d1d5db',
                            ...
                            >
                                Grid }) }), _jsx("button", { onClick: () => handleStateChange({ viewMode: 'list' }), style: {
                        padding: '4px 8px',
                        border: '1px solid #d1d5db',
...
style = {};
{
 ...
 >
    (_jsx("h4", { style: { margin: '0 0 8px 0', fontSize: '13px', fontWeight: '500' }, children: "Apply Options" })
        ,
            _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px' }, children: [_jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '6px' }, children: [_jsx("input", { type: "checkbox", checked: instantiationOptions.preservePositions, onChange: (e) => setInstantiationOptions(prev => ({}), ...prev, preservePositions) }), ": e.target.checked } }))} style=", { margin: 0 }, "/>", _jsx("span", { style: { fontSize: '12px' }, children: "Preserve positions" })] }), _jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '6px' }, children: [_jsx("input", { type: "checkbox", checked: instantiationOptions.mergeWithCurrent, onChange: (e) => setInstantiationOptions(prev => ({}), ...prev, mergeWithCurrent) }), ": e.target.checked } }))} style=", { margin: 0 }, "/>", _jsx("span", { style: { fontSize: '12px' }, children: "Merge with current" })] }), !instantiationOptions.preservePositions && ()
                        < div, " style=", { paddingLeft: '18px', marginTop: '4px' }, ">", _jsxs("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: '11px', color: '#6b7280' }, children: "Offset:" }), _jsx("input", { type: "number", value: instantiationOptions.offsetX, onChange: (e) => setInstantiationOptions(prev => ({}), ...prev, offsetX) }), ": Number(e.target.value) } }))} style=", {
                                width: '50px',
                                padding: '2px 4px',
                                border: '1px solid #d1d5db',
                                borderRadius: '2px',
                                ...
                                /  >
                                _jsx("input", { type: "number", value: instantiationOptions.offsetY, onChange: (e) => setInstantiationOptions(prev => ({}), ...prev, offsetY) }), ": Number(e.target.value) } }))} style=", {
                                width: '50px',
                                padding: '2px 4px',
                                border: '1px solid #d1d5db',
                                borderRadius: '2px',
...
style = {};
{
 ...
 >
    (_jsx("div", { style: { fontSize: '48px', marginBottom: '16px' }, children: "\uD83D\uDCC1" })
        ,
            _jsx("div", { style: { fontSize: '14px', marginBottom: '8px' }, children: "No templates found" })
                ,
                    _jsx("div", { style: { fontSize: '12px' }, children: "Try adjusting your search criteria or create a new template" }));
div >
;
()
    < div;
            ...
            < div : , style = {} };
{
 ...
 >
    { filteredTemplates, : .map(template => ()
            < TemplateCard, key = { template, : .id }, template = { template }, onPreview = {}(), handlePreviewTemplate(template)) };
onApply = {}();
...
style = {};
{
 ...
 >
    { filteredTemplates, : .map(template => ()
            < TemplateListItem, key = { template, : .id }, template = { template }, onPreview = {}(), handlePreviewTemplate(template)) };
onApply = {}();
handleApplyTemplate(template);
onDelete = {}();
handleDeleteTemplate(template.id);
...
onApply = {}();
handleApplyTemplate(browserState.previewTemplate);
/>;
div >
;
;
...
({ template, onPreview, onApply, onDelete, showDelete }) => {
    ...
    _jsx("div", { style: {
            ...
            fontSize: '16px',
            padding: '4px'
        }, title: "Delete template", children: "\uD83D\uDDD1\uFE0F" });
};
_jsxs("div", { style: { marginBottom: '12px' }, children: [_jsx("h3", { style: {
                margin: '0 0 4px 0',
                fontSize: '16px',
                fontWeight: '600',
                color: '#1f2937',
    ...
    ,
        _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }, children: [_jsx("span", { style: {
                        padding: '2px 6px',
                    ...
                    }, children: template.category.replace('-', ' ') }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '4px' }, children: [_jsx("span", { style: { fontSize: '12px', color: '#f59e0b' }, children: "\u2605" }), _jsx("span", { style: { fontSize: '12px', color: '#6b7280' }, children: template.rating.toFixed(1) })] })] })
            ,
                _jsxs("div", { style: {
                        fontSize: '11px',
                        color: '#9ca3af',
                        marginBottom: '12px'
                    }, children: ["by ", template.author, " \u2022 ", template.metadata.nodeCount, " nodes"] })
                    ,
...
({ template, onPreview, onApply, onDelete, showDelete }) => {
    ...
    _jsx("div", { style: {
            ...
            onClick = { onPreview }
                >
                    (_jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }, children: [_jsx("h4", { style: { margin: 0, fontSize: '14px', fontWeight: '600', color: '#1f2937' }, children: template.name }), _jsx("span", { style: {
                                            padding: '1px 4px',
                                            backgroundColor: '#e5e7eb',
                                            borderRadius: '6px',
                                            fontSize: '10px',
                                    ...
                                    color: '#9ca3af',
                                    marginTop: '4px'
                                }, children: ["by ", template.author, " \u2022 ", template.metadata.nodeCount, " nodes \u2022 ", new Date(template.metadata.lastModified).toLocaleDateString()] })] })
                        ,
                            _jsx("div", { style: { display: 'flex', gap: '8px' }, children: _jsx("button", { onClick: (e) => {
                                        e.stopPropagation();
                                        onApply();
                                    }, style: {
                                        padding: '4px 8px',
