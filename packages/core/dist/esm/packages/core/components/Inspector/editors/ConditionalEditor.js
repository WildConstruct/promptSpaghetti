 ...
 */
export const defaultOutput = nodeData.defaultOutput || '';
...
_jsxs("div", { className: "conditional-editor", children: [_jsxs(ProgressiveDisclosureSection, { title: "Essential Settings", level: "basic", description: "Core conditional logic for smart storytelling", defaultExpanded: true, priority: "critical", fieldName: "name", children: [_jsx("div", { style: { marginBottom: 16 }, children: _jsx(TextFieldEditor, { label: "Decision Name", value: name, fieldKey: "name", zodType: null, onChange: handleNameChange, placeholder: "e.g., Character Response, Plot Branch, Scene Choice" }) }), _jsxs("div", { style: { marginBottom: 16 }, children: [_jsx(TextAreaEditor, { label: "Default Response", value: defaultOutput, fieldKey: "defaultOutput", zodType: null, onChange: handleDefaultOutputChange, placeholder: "What should happen when no specific conditions are met...", rows: 2 }), _jsx("div", { style: {
                                ...
                                marginBottom: 8
                                        ...
                                        color: '#fff',
                                        cursor: 'pointer'
                                    }, children: "Add Branch" })] }), branches.length === 0 ? ()
                            < div : , " style=", {
                            background: '#2d3748',
                            ...
                            fontSize: 12,
                            fontStyle: 'italic'
                        }, "> No conditional branches. Add a branch to start building logic."] }), ") : ()", _jsxs("div", { style: {
                        background: '#2d3748',
                        border: '1px solid #4a5568',
                        borderRadius: 4,
                        padding: 8
...
style = {};
{
 ...
 >
    (_jsx("div", { style: {
            ...
            color: '#e2e8f0',
            marginBottom: 4
        }, children: "Available Expression Functions:" })
        ,
            _jsxs("div", { style: {
                    fontSize: 10,
                    color: '#a0aec0',
                    fontFamily: 'monospace',
                    lineHeight: 1.4
                }, children: ["\u2022 Variable access: variable, hasVariable('name'), getVariable('name', 'default')", _jsx("br", {}), "\u2022 Comparisons: ===, !==, ", '>', ", ", '<', ", ", '>=', ", ", '<=', ", &&, ||, !", _jsx("br", {}), "\u2022 Strings: startsWith(str, 'prefix'), includes(str, 'substring'), isEmpty(str)", _jsx("br", {}), "\u2022 Arrays: includes(arr, item), length(arr)", _jsx("br", {}), "\u2022 Math: +, -, *, /, %, Math.min, Math.max, Math.abs", _jsx("br", {}), "\u2022 Regex: matches(str, 'pattern')"] }));
div >
;
...
style = {};
{
 ...
 >
    (_jsx("div", { style: {
            ...
            color: '#e2e8f0',
            marginBottom: 8
        }, children: "Expression Engine Settings:" })
        ,
            _jsxs("div", { style: { marginBottom: 12 }, children: [_jsxs("label", { style: {
                            ...
                            marginTop: 2,
                            marginLeft: 20
                        }, children: "Enable access to execution context variables in expressions" })] })
                ,
                    _jsxs("div", { style: { marginBottom: 12 }, children: [_jsxs("label", { style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    marginTop: 2,
                                    marginLeft: 20
                                }, children: "Throw errors on expression evaluation failures (otherwise treats as false)" })] }));
div >
...
style = {};
{
 ...
 >
    (_jsx("div", { style: {
        ...
        ,
            _jsxs("div", { style: { fontSize: 10, color: '#a0aec0', lineHeight: 1.4 }, children: [_jsxs("div", { children: ["Node ID: ", props.nodeId] }), _jsx("div", { children: "Type: Conditional" }), _jsxs("div", { children: ["Branches: ", branches.length] }), _jsxs("div", { children: ["Variable Access: ", allowVariableAccess ? 'Enabled' : 'Disabled'] }), _jsxs("div", { children: ["Strict Mode: ", strictMode ? 'Enabled' : 'Disabled'] })] }));
div >
    _jsxs("div", { style: {
            background: '#1a202c',
            border: '1px solid #4a5568',
            ...
            color: '#e2e8f0'
                ...
                < div : , " style=", { color: '#a0aec0', fontStyle: 'italic' }, "> Add conditional branches to see logic preview"] });
()
    < div >
    _jsx("div", { style: { marginBottom: 8, fontWeight: 500 }, children: "Execution Logic:" });
{
 ...
 >
    (_jsxs("div", { style: { fontWeight: 500, marginBottom: 2 }, children: [index === 0 ? 'IF' : 'ELSE IF', " ", branch.label || `Branch ${index + 1}`, ":}"] })
        ,
            _jsx("div", { style: {
                    fontFamily: 'monospace',
                    fontSize: 10,
                    color: '#90cdf4',
                    marginBottom: 2
                }, children: branch.condition || 'No condition' })
                ,
                    _jsxs("div", { style: { fontSize: 10, color: '#a0aec0' }, children: ["\u2192 \"", branch.output || 'No output', "\""] }));
div >
;
{
    defaultOutput && ()
 ...
 >
    (_jsx("div", { style: { fontWeight: 500, marginBottom: 2 }, children: "ELSE (Default):" })
        ,
            _jsxs("div", { style: { fontSize: 10, color: '#a0aec0' }, children: ["\u2192 \"", defaultOutput, "\""] }));
div >
;
div >
;
