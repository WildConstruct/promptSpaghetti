...
_jsxs("div", { style: {
        ...
        background: '#2d3748',
                ...
                fontStyle: 'italic',
                fontSize: 13,
            }, children: "No variations yet. Add some above." })) : (), "variations.map(([^=]*) => (", _jsxs("div", { draggable: true, onDragStart: (e) => handleDragStart(e, index), onDragOver: (e) => handleDragOver(e, index), onDrop: (e) => handleDrop(e, index), style: {
                display: 'flex',
                alignItems: 'center',
                padding: '8px 12px',
                ...
                cursor: 'move',
                    ...
                    fontSize: 14,
                    color: '#374151',
                }, "title=\"Click to edit\" >", variation] }, index), ")}", _jsx("button", { onClick: () => handleRemove(index), style: {
                background: 'none',
                border: 'none',
                color: '#ef4444',
                cursor: 'pointer',
