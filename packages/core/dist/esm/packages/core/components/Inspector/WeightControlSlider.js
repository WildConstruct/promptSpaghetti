...
;
{
 ...
 >
    (_jsxs("div", { style: {
        ...
        ,
            _jsx("input", { type: "range", min: "0", max: "100", value: option.weight, onChange: (e) => handleWeightChange(option.id, parseInt(e.target.value)), disabled: option.locked, style: {
                    width: '100%',
                    height: 6,
                    borderRadius: 3,
                    background: '#4a5568',
...
{ /* Weight Presets */ }
{
 ...
 >
    _jsx(WeightPresets, { options: localOptions, onApplyPreset: handleApplyPreset, onSaveCustomPreset: onSaveCustomPreset, customPresets: customPresets, compact: compactPresets, showCategories: !compactPresets });
div >
;
{
    onPreviewRequest && ()
