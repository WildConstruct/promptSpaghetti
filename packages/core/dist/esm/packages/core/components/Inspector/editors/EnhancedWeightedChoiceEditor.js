...
_jsxs("div", { className: "enhanced-weighted-choice-editor", children: [_jsxs(ProgressiveDisclosureSection, { title: "Essential Settings", level: "basic", description: "Core node configuration", defaultExpanded: true, children: [_jsx("div", { style: { marginBottom: 12 }, children: _jsx(TextFieldEditor, { label: "Name", value: name, onChange: handleNameChange, placeholder: "e.g., Character Emotion, Scene Type" }) }), _jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("label", { style: {
                    ...
                    < div, key = { index }, style = {}, { marginBottom: 8 }), ">", _jsxs("div", { style: {
                        ...
                        marginBottom: 4,
                                ...
                                minWidth: 40,
                                textAlign: 'right',
                            }, children: [((weights[index] || 1) / (weights.reduce((sum, w) => sum + (w || 1), 0)) * 100).toFixed(0), "%"] })] }), _jsx(WeightSlider, { value: weights[index] || 1, onChange: (weight) => handleWeightChange(index, weight), min: 0, max: 10, step: 0.1 })] })] });
div >
;
...
_jsxs("div", { style: {
        ...
        border: '1px solid #4a5568',
                ...
                fontSize: 10,
                color: '#a0aec0',
            }, children: [_jsxs("div", { children: ["Total Weights: ", weights.reduce((sum, w) => sum + (w || 1), 0).toFixed(1)] }), _jsxs("div", { children: ["Choices: ", choices.length] }), _jsxs("div", { children: ["Min Weight: ", Math.min(...weights.filter(w => w > 0)).toFixed(1) || 'N/A'] }), _jsxs("div", { children: ["Max Weight: ", Math.max(...weights).toFixed(1) || 'N/A'] })] })] });
