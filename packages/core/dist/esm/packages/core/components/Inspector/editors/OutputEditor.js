...
_jsx("div", { className: "output-editor", children: _jsxs(ProgressiveDisclosureSection, { title: "Essential Settings", level: "basic", description: "Core output configuration for prompt generation", defaultExpanded: true, priority: "critical", fieldName: "template", children: [wrapNameHelp()
                < TextFieldEditor, "label=\"Output Name\" value=", label, "fieldKey=\"label\" zodType=", null, "onChange=", (value) => handleFieldChange('label', value), "placeholder=\"Enter a name for this output...\" /> )}", wrapTemplateHelp()
...
/>;
_jsx(SelectEditor, { label: "Destination", value: destination, fieldKey: "destination", options: OUTPUT_DESTINATIONS, zodType: null, onChange: (value) => handleFieldChange('destination', value) })
    ,
                    ...
                    < div, " style=", { marginBottom: 4 }, ">", _jsx("span", { style: { color: '#a0aec0' }, children: "Transformations:" }), " ", transformations.filter(Boolean).join(' → ')] });
{
 ...
 >
    (_jsx("div", { style: { color: '#a0aec0', fontSize: 10, marginBottom: 4 }, children: "Template Preview:" })
        ,
            _jsx("div", { style: { fontFamily: 'monospace', fontSize: 11 }, children: template }));
div >
;
div >
