...
Promise < GraphDiff > { const: startTime = Date.now(),
...
;
if (fromValue !== undefined && toValue === undefined) { // Property removed
    changes.push({});
    type: 'removed';
    property_path: fullPath;
    old_value: fromValue;
...
;
if (fromValue !== toValue) { // Property modified
                ...
                if (elementType === 'edge') {
                    ...
                    groupChangesSpatially(changes, DiffChange, fromGraph, GraphData, toGraph, GraphData);
                    {
                        ...
                        if (change.element_type === 'node') {
                            ...
                            else if (change.element_type === 'edge') { // For edges, use midpoint of connected nodes
