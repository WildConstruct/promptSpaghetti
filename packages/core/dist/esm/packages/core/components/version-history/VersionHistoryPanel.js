...
const AnnotationsList = ({ annotations, formatTimeAgo }) => {
    const getAnnotationIcon = (type) => {
        ...
        const getPriorityColor = (priority) => {
            ...
            ;
            return;
            _jsxs("div", { className: "p-4", children: [annotations.length === 0 ? ()
                        < div : , " className=\"text-center py-8 text-gray-500\">", _jsx("div", { className: "text-4xl mb-2", children: "\uD83D\uDCAD" }), _jsx("h3", { className: "font-medium text-gray-900 mb-1", children: "No annotations yet" }), _jsx("p", { className: "text-sm", children: "Add comments and reviews to collaborate." })] });
        };
    };
};
()
...
className = "space-y-3" >
    { annotations, : .map(annotation => ()
            ...
            (_jsxs("div", { className: "flex items-start space-x-2 mb-2", children: [_jsx("span", { className: "text-lg", children: getAnnotationIcon(annotation.annotation_type) }), _jsxs("div", { className: "flex-1", children: [annotation.title && ()
                                < h5, " className=\"text-sm font-medium text-gray-900 mb-1\">", annotation.title] }), ")}", _jsx("p", { className: "text-sm text-gray-700", children: annotation.content_markdown })] })
                ,
                    _jsxs("span", { className: `text-xs ${getPriorityColor(annotation.priority)}`, children: ["}", annotation.priority] })), div >
            _jsxs("div", { className: "flex items-center justify-between text-xs text-gray-500", children: [_jsxs("span", { children: ["by ", annotation.author_id] }), _jsx("span", { children: formatTimeAgo(annotation.created_at) })] }), { annotation, : .status === 'resolved' && ()
                < div, className = "mt-2 text-xs text-green-600" >
            ,
            Resolved }, { annotation, : .resolved_at && `on ${formatTimeAgo(annotation.resolved_at)}` }, div >
        ) };
div >
;
div >
