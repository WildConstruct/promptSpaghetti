...
_jsxs("div", { children: [_jsxs("div", { style: {
                ...
                borderBottom: '1px solid #4a5568',
                            ...
                            < span, " style=", { fontSize: '11px', color: '#a0aec0' }, ">", selectedRules.size, " selected"] }), ")}"] }), selectedRules.size > 0 && ()
            < div, " style=", { display: 'flex', gap: '8px' }, ">", activeTab === 'pending' && ()
...
_jsxs("div", { style: {
        ...
        zIndex: 1001,
                ...
                color: '#fff',
                        ...
                        }, ">", tab, " (", rulesByStatus[tab].length, ")"] }), "))}"] }), renderTabContent(), showDeprecationDialog && currentRule && ()
            < div, " style=", {
            position: 'fixed',
            top: 0,
            left: 0,
