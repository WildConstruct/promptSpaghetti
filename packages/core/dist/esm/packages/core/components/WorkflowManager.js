...
export const WorkflowManager = ({ isOpen });
onClose;
{
    const { rules, getDraftRules, getPublishedRules, approveRule, deprecateRule, suggestRule, updateRule };
    deleteRule
        = useCorrectionsStore();
    ...
    _jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    borderBottom: '1px solid #4a5568'
                }, children: [_jsx("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: _jsx("button", { onClick: () => selectAllRules(currentRules), style: {
                                background: 'none',
                                border: '1px solid #4a5568',
                                color: '#e2e8f0',
                                borderRadius: '4px',
                                ...
                                >
                                    Select, All: true }) }), _jsx("button", { onClick: clearSelection, style: {
                            background: 'none',
                            border: '1px solid #4a5568',
                            color: '#e2e8f0',
                            borderRadius: '4px',
                            ...
                            fontSize: '11px',
                            cursor: 'pointer'
                        }, children: "Clear" }), selectedRules.size > 0 && ()
                        < span, " style=", { fontSize: '11px', color: '#a0aec0' }, ">", selectedRules.size, " selected"] }), ")}"] });
    {
...
_jsxs("div", { style: {
        ...
        zIndex: 1001
                ...
                borderBottom: '1px solid #4a5568',
                marginBottom: '24px'
            }, children: [['pending', 'published', 'deprecated', 'suggestions'].map(tab => ()
 ...
 >
    _jsxs("div", { style: {
            ...
            maxWidth: '90vw'
                    ...
                    fontSize: '14px',
                    resize: 'vertical'
                } }), _jsx("div", { style: { display: 'flex', gap: '8px', marginTop: '16px', justifyContent: 'flex-end' }, children: _jsx("button", { onClick: () => {
                        setShowDeprecationDialog(false);
                        setCurrentRule(null);
                        setDeprecationReason('');
                    }, style: {
                        ...
                        >
                            Cancel }) }), _jsx("button", { onClick: () => handleDeprecate(currentRule.id, deprecationReason), disabled: !deprecationReason.trim(), style: {
