...
import { ClockIcon, PlayIcon, PauseIcon, StopIcon, PlusIcon, TrashIcon, EyeIcon, CogIcon, ExclamationTriangleIcon, CheckCircleIcon, XCircleIcon, ChevronDownIcon } from ChevronRightIcon;
from;
...
`, title: schedule.enabled ? 'Disable' : 'Enable', children: schedule.enabled ? _jsx(PauseIcon, { className: "h-4 w-4" }) : _jsx(PlayIcon, { className: "h-4 w-4" }) }), _jsx("button", { onClick: () => setShowDeleteConfirm(schedule.id), className: "p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-colors", title: "Delete", children: _jsx(TrashIcon, { className: "h-4 w-4" }) })] })] })) }), "))}"] });
        {
            schedules.length === 0 && ()
                < div;
