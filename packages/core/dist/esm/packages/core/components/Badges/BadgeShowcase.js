...
import { Trophy, Star, Award, Target, TrendingUp, Users, Crown, Shield, Zap, Gift, Bell, X } from SortAsc;
from;
'lucide-react';
...
className = '';
{
    const { userBadges, availableBadges, recentUnlocks, getBadgesByCategory, getBadgesByTier, getNextBadges, getBadgeProgress, getStatistics, getLeaderboardPosition, markNotificationRead, clearAllNotifications, hasUnreadNotifications };
    isLoading
        = useBadgeSystem({});
    userId;
