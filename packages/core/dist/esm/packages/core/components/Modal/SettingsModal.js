...
const SETTINGS_GROUPS = [];
{
    ...
    'Execution Settings',
        description;
    'Control how graphs are executed and randomized',
        icon;
    FiPlayCircle,
        sections;
    ['seed', 'temperature', 'runCount'],
    ;
}
{
    id: 'batch',
    ...
    'Batch Processing',
        description;
    'Configure batch execution and output options',
        icon;
    FiPackage,
        sections;
    ['batch'],
