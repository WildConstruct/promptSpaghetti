...
import { InteractiveElementType, Epic16InteractiveElementsService } from QuickPreviewElement;
from;
...
;
onElementInteraction ?  : (elementId, interaction) => void ;
onAnalyticsUpdate ?  : (analytics) => void ;
{
...
const activationContext = useMemo(() => ({}), userId);
