...
const MenuItem = ({ label, shortcut, onClick, disabled = false, divider = false, submenu, }) => {
    ...
    return (_jsxs("div", { ref: itemRef, style: {
            position: 'relative',
            display: 'flex',
            alignItems: 'center',
            ...
            fontSize: '13px',
            fontWeight: 400,
        }, onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, onMouseOver: e => {
            if (!disabled) {
        ...
        }, children: [_jsx("span", { children: label }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [shortcut && (_jsx("span", { style: {
                            fontSize: '11px',
                            color: professionalColors.text.secondary,
                            fontFamily: 'SF Mono, Monaco, Inconsolata, Roboto Mono, monospace',
                        }, children: shortcut })), submenu && (_jsx("span", { style: {
                            fontSize: '10px',
                            color: professionalColors.text.secondary,
                        }, children: "\u25B6" }))] }), submenu && showSubmenu && (_jsx("div", { style: {
                    position: 'absolute',
                    top: 0,
                    left: '100%',
                    minWidth: '200px',
...
const Menu = ({ label, items, isOpen, onToggle, onClose }) => {
    ...
    return (_jsxs("div", { ref: menuRef, style: { position: 'relative' }, children: [_jsx("button", { onClick: onToggle, style: {
                ...
                }, children: label }), isOpen && (_jsx("div", { style: {
                    position: 'absolute',
                    top: '100%',
                    left: 0,
                    minWidth: '220px',
...
// File operations
onNew, onOpen, onSave, onSaveAs, onImport, onExport, onRecentFileLoad, onQuit, 
// Edit operations
onUndo, onRedo, onCut, onCopy, onPaste, onSelectAll, onFind, onPreferences, 
// View operations
onZoomIn, onZoomOut, onFitView, onToggleGrid, onToggleMinimap, onToggleInspector, onToggleFullscreen, onToggleTheme, 
// Debug operations
onDevTools, onValidateGraph, onPerformanceMonitor, onConsoleToggle, 
// Help operations
onDocumentation, onKeyboardShortcuts, onAbout, onSupport, onReportBug, 
// Application state
canUndo = false, canRedo = false, hasSelection = false, nodes = [], edges = [], theme = 'cinema', isFullscreen = false, gridVisible = true, minimapVisible = true, inspectorVisible = true, recentFiles = [], }) => {
