...
import { ChartBarIcon, ArrowTrendingUpIcon, FunnelIcon, GlobeAltIcon, MapPinIcon, UserGroupIcon, TrendingUpIcon, TrendingDownIcon, ArrowUpIcon, Squares2X2Icon, FlagIcon, XCircleIcon, FaceSmileIcon, SparklesIcon } from '@heroicons/react/24/outline';
export const ShareTrackingUtils = {
    ...
    aggregateShareData: (shares) => {
        ...
        if (!platformBreakdown[share.platform]) {
            ...
            1,
                views;
            share.analytics.views,
                clicks;
            share.analytics.clicks,
                conversions;
            share.analytics.conversions,
                revenue;
            share.analytics.revenue,
                platform;
            share.platform,
            ;
        }
...
// Main component
export const ShareTrackingManager = ({
    templateId,
    template,
    shares = [],
    onShareUpdate,
