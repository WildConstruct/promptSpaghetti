...
import { BookOpen, Trophy, Play, Target, TrendingUp, Award, Zap, CheckCircle } from ArrowRight;
from;
'lucide-react';
export const UserEngagementDemo = ({
...
new Date('2024-07-01');
{
    ...
    ];
    {
        ...
        'Build Your Template',
            description;
        'Create a professional template using advanced features',
            content;
        '<p>Now it\'s your turn! Create a template incorporating the principles and features you\'ve learned.</p>',
            type;
        'practice',
            duration;
        1200,
    ...
    'Add proper documentation';
    {
        ...
        'Publishing to Marketplace',
            description;
        'Learn how to publish and promote your template',
            content;
        '<p>Publishing your template makes it available to the community. Include good descriptions, tags, and examples.</p>',
            type;
        'demonstration',
            duration;
        400;
    }
    {
        ...
        'Template Master!',
            description;
        'You\'ve mastered advanced template creation',
            content;
        '<p>Excellent work! You\'re now ready to create professional-grade templates that will help users worldwide.</p>',
            type;
        'completion';
        completionRewards: {
            xp: 750,
    ...
    useEffect(() => {
        ...
        'getting-started-basics';
        {
            ...
            900,
                stepsCompleted;
            ['intro', 'browsing', 'downloading', 'completion'],
                score;
            95;
        }
    ...
    }
    {
        ...
        'Marketplace Explorer',
            description;
        'Download 10 templates from the marketplace',
            category;
        'usage',
            target;
        10,
...
const handleTutorialComplete = (tutorial, progress) => {
    setUserTutorialProgress(prev => ({}), ...prev, [tutorial.id], progress);
};
;
...
_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsx(Card, { children: _jsxs(CardContent, { className: "p-6 text-center", children: [_jsx(BookOpen, { className: "w-8 h-8 text-blue-600 mx-auto mb-3" }), _jsx("div", { className: "text-2xl font-bold", children: getCompletedTutorialsCount() }), _jsx("div", { className: "text-sm text-gray-600", children: "Tutorials Completed" })] }) }), _jsx(Card, { children: _jsxs(CardContent, { className: "p-6 text-center", children: [_jsx(Trophy, { className: "w-8 h-8 text-yellow-600 mx-auto mb-3" }), _jsx("div", { className: "text-2xl font-bold", children: achievements.filter(a => a.completed).length }), _jsx("div", { className: "text-sm text-gray-600", children: "Achievements Unlocked" })] }) }), _jsx(Card, { children: _jsxs(CardContent, { className: "p-6 text-center", children: [_jsx(Target, { className: "w-8 h-8 text-green-600 mx-auto mb-3" }), _jsx("div", { className: "text-2xl font-bold", children: Math.round(getTotalLearningTime() / 60) }), _jsx("div", { className: "text-sm text-gray-600", children: "Minutes Learned" })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Award, { className: "w-5 h-5 text-yellow-500" }), "Recent Achievements"] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "space-y-3", children: achievements.filter(a => a.completed).map((achievement) => ()
                                ...
                                (_jsx("div", { className: "text-2xl", children: achievement.icon })
                                    ,
                                        _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-medium", children: achievement.title }), _jsx("div", { className: "text-sm text-gray-600", children: achievement.description })] })
                                            ,
                                                _jsxs(Badge, { className: "bg-yellow-100 text-yellow-800", children: ["+", achievement.xpReward, " XP"] }))) }), "))}"] })] })] });
{ /* Recommended Tutorials */ }
_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Zap, { className: "w-5 h-5 text-purple-500" }), "Recommended for You"] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: getRecommendedTutorials().map((tutorial) => ()
                        < Card, key = { tutorial, : .id }, className = "hover:shadow-md transition-shadow" >
                        _jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx(Badge, { variant: "outline", children: tutorial.difficulty }), _jsxs("span", { className: "text-sm text-gray-500", children: [tutorial.estimatedTime, "min"] })] }), _jsx("h3", { className: "font-medium mb-2", children: tutorial.title }), _jsx("p", { className: "text-sm text-gray-600 mb-3 line-clamp-2", children: tutorial.description }), _jsxs(Button, { size: "sm", className: "w-full", onClick: () => handleStartTutorial(tutorial), children: [_jsx(Play, { className: "w-4 h-4 mr-1" }), "Start Tutorial"] })] })) }), "))}"] })] });
Card >
    { /* Continue Learning */}
    < Card >
    (_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(TrendingUp, { className: "w-5 h-5 text-blue-500" }), "Continue Learning"] }) })
        ,
            _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [Object.entries(userTutorialProgress)
...
;
return;
_jsxs("div", { className: `max-w-6xl mx-auto p-6 ${className}`, children: ["}", _jsxs("div", { className: "mb-6", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: "Learning & Progress Dashboard" }), _jsx("p", { className: "text-gray-600", children: "Track your progress and continue your learning journey with interactive tutorials and achievements." })] }), _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "space-y-6", children: [_jsxs(TabsList, { className: "grid grid-cols-4 w-full max-w-lg", children: [_jsx(TabsTrigger, { value: "overview", children: "Overview" }), _jsx(TabsTrigger, { value: "progress", children: "Progress" }), _jsx(TabsTrigger, { value: "tutorials", children: "Tutorials" }), _jsx(TabsTrigger, { value: "achievements", children: "Achievements" })] }), _jsx(TabsContent, { value: "overview", children: renderOverview() }), _jsx(TabsContent, { value: "progress", children: _jsx(ProgressTracker, { userId: userId, variant: "full", showDetailedMetrics: showFullFeatures, enableAnimations: true }) }), _jsx(TabsContent, { value: "tutorials", children: _jsx(TutorialBrowser, { tutorials: mockTutorials, onSelectTutorial: handleStartTutorial, onStartTutorial: handleStartTutorial, userProgress: userTutorialProgress }) }), _jsx(TabsContent, { value: "achievements", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "All Achievements" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: achievements.map((achievement) => ()
                                            < Card, key = { achievement, : .id }, className = { achievement, : .completed ? 'bg-green-50 border-green-200' : '' } >
                                            _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "text-2xl", children: achievement.icon }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("h3", { className: "font-medium", children: achievement.title }), achievement.completed && _jsx(CheckCircle, { className: "w-4 h-4 text-green-600" })] }), _jsx("p", { className: "text-sm text-gray-600 mb-2", children: achievement.description }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: "outline", children: achievement.tier }), _jsxs("span", { className: "text-sm text-gray-500", children: ["+", achievement.xpReward, " XP"] })] })] })] }) })) }), "))}"] })] }) })] })] });
