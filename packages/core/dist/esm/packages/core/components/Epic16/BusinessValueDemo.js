...
;
export const BusinessValueDemo = ({
    className = '',
    templateExample = {
...
;
return;
_jsxs("div", { className: `space-y-6 ${className}`, children: ["}", _jsx("div", { className: "bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 border border-blue-200", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-2", children: "Business Value Analysis" }), _jsxs("p", { className: "text-gray-600 mb-4", children: ["Analyze the ROI and cost savings for: ", _jsx("span", { className: "font-medium", children: templateExample.name })] }), _jsxs("div", { className: "flex items-center space-x-4 text-sm", children: [_jsx("span", { className: "px-3 py-1 bg-blue-100 text-blue-800 rounded-full", children: templateExample.category }), _jsxs("span", { className: "text-gray-600", children: ["Price: ", formatCurrency(templateExample.price / 100)] })] })] }), _jsxs("div", { className: "flex space-x-3", children: [_jsx("button", { onClick: generateReport, disabled: !roiResults || !savingsResults, className: `flex items-center space-x-2 px-4 py-2 rounded-lg font-medium ${roiResults && savingsResults
                                    ? 'bg-blue-600 text-white hover:bg-blue-700' : ,
                             }), ": 'bg-gray-300 text-gray-500 cursor-not-allowed', }`} >", _jsx(Download, { className: "w-4 h-4" }), _jsx("span", { children: "Export Report" })] })] }) })] });
{ /* Industry Preset Selector */ }
_jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-4", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-3", children: "Select Your Industry/Use Case" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [['individual', 'startup', 'agency', 'enterprise'].map((preset) => ()
                    < button, key = { preset }, onClick = {}()), " => setIndustryPreset(preset)} className=", `p-3 rounded-lg border text-sm font-medium transition-colors ${industryPreset === preset
