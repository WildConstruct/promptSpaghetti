...
`, children: [_jsx(Download, { className: "w-4 h-4" }), _jsx("span", { children: "Export Report" })] }) })] }) }), _jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-4", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-3", children: "Select Your Industry/Use Case" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [['individual', 'startup', 'agency', 'enterprise'].map((preset) => ()
...
{ /* Tab Navigation */ }
_jsxs("div", { className: "bg-white rounded-lg border border-gray-200 overflow-hidden", children: [_jsxs("nav", { className: "flex border-b border-gray-200", children: [_jsx("button", { onClick: () => setActiveTab('roi'), className: `flex-1 py-4 px-6 text-center font-medium ${activeTab === 'roi'
...
`, children: _jsxs("div", { className: "flex items-center justify-center space-x-2", children: [_jsx(PiggyBank, { className: "w-4 h-4" }), _jsx("span", { children: "Savings Estimation" })] }) }), _jsx("button", { onClick: () => setActiveTab('summary'), className: `flex-1 py-4 px-6 text-center font-medium ${activeTab === 'summary'
                        ...
                        : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}
`, children: _jsxs("div", { className: "flex items-center justify-center space-x-2", children: [_jsx(BarChart3, { className: "w-4 h-4" }), _jsx("span", { children: "Executive Summary" })] }) })] }), _jsxs("div", { className: "p-6", children: [activeTab === 'roi' && ()
