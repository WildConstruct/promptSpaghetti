...
className = "flex items-center justify-between" >
    ...
    < div;
className = "flex-1" >
    (_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("span", { className: "text-sm font-medium text-gray-700", children: "Progress" }), _jsxs("span", { className: "text-sm text-gray-500", children: [Math.round(progress), "%"] })] })
        ,
...
className = "flex items-center justify-between w-full" >
    (_jsxs("div", { className: "flex items-center space-x-4", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("svg", { className: "w-4 h-4 text-yellow-400 mr-1", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }), _jsx("span", { className: "text-sm text-gray-600", children: path.analytics.satisfactionRating.toFixed(1) })] }), _jsxs("span", { className: "text-sm text-gray-500", children: [path.analytics.completionRate.toFixed(0), "% completion"] })] })
        ,
            _jsx("button", { onClick: (e) => {
                    e.stopPropagation();
                    handleEnroll(path.id);
                }, className: "px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700", children: "Enroll" }));
div >
;
div >
;
...
if (loading) {
    return;
    _jsx("div", { className: "flex items-center justify-center h-64", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: "animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600" }), _jsx("span", { className: "text-gray-600", children: "Loading learning paths..." })] }) });
    ;
    return;
    _jsxs("div", { className: "learning-path-dashboard h-full flex flex-col", children: [_jsx("div", { className: "bg-white border-b border-gray-200 px-6 py-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Learning Paths" }), _jsx("p", { className: "text-sm text-gray-600", children: "Epic 16 Marketplace & Community Learning System" })] }), _jsxs("div", { className: "flex items-center space-x-3", children: [userRole !== 'user' && ()
                                    < button, " className=\"px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700\"> Create Path"] }), ")}", _jsx("button", { onClick: resetFilters, className: "px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200", children: "Clear Filters" })] }) }), error && ()
...
{ /* Navigation Tabs */ }
_jsxs("div", { className: "mt-4", children: [_jsxs("nav", { className: "flex space-x-8", children: [[
...
_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Target Audience" }), _jsxs("div", { className: "space-y-2 max-h-32 overflow-y-auto", children: [Object.values(TargetAudience).map((audience) => ()
                    ...
                    _jsx("input", { type: "checkbox", checked: filters.audience.includes(audience), onChange: (e) => {
...
div >
    ...
    < div >
    _jsxs("label", { className: "flex items-center", children: [_jsx("input", { type: "checkbox", checked: filters.certification === true, onChange: (e) => setFilters({ ...filters, certification: e.target.checked ? true : null }), className: "rounded border-gray-300 text-blue-600 focus:ring-blue-500" }), _jsx("span", { className: "ml-2 text-sm text-gray-700", children: "Certification available" })] });
div >
;
div >
;
...
;
{ /* Main Content */ }
_jsxs("div", { className: "flex-1 overflow-y-auto p-6", children: [view === 'discover' && ()
            < div >
            (_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("h2", { className: "text-lg font-semibold text-gray-900", children: ["All Learning Paths (", filteredPaths.length, ")"] }), _jsxs("select", { className: "px-3 py-2 border border-gray-300 rounded-md text-sm", children: [_jsx("option", { children: "Sort by Popularity" }), _jsx("option", { children: "Sort by Rating" }), _jsx("option", { children: "Sort by Duration" }), _jsx("option", { children: "Sort by Newest" })] })] })
                ,
                    _jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6", children: filteredPaths.map((path) => renderPathCard(path)) })), filteredPaths.length === 0 && ()
            < div, " className=\"text-center py-12\">", _jsx("svg", { className: "mx-auto h-12 w-12 text-gray-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a9 9 0 117.072 0l-.548.547A3.374 3.374 0 0014.846 21H9.154a3.374 3.374 0 00-2.322-1.1l-.548-.547z" }) }), _jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No learning paths found" }), _jsx("p", { className: "mt-1 text-sm text-gray-500", children: "Try adjusting your search criteria or browse all available paths." })] });
div >
;
{
    view === 'my-learning' && ()
        < div >
        _jsx("div", { className: "flex items-center justify-between mb-6", children: _jsxs("h2", { className: "text-lg font-semibold text-gray-900", children: ["My Learning (", userPaths.length, ")"] }) });
    {
        userPaths.length === 0 ? ()
            < div : ;
        className = "text-center py-12" >
            (_jsx("svg", { className: "mx-auto h-12 w-12 text-gray-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" }) })
                ,
                    _jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No enrolled learning paths" })
                        ,
                            _jsx("p", { className: "mt-1 text-sm text-gray-500", children: "Start learning by enrolling in a path from the discover section." })
                                ,
                                    _jsx("div", { className: "mt-6", children: _jsx("button", { onClick: () => setView('discover'), className: "inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700", children: "Discover Paths" }) }));
        div >
        ;
        ()
            < div;
...
}
{
    view === 'recommendations' && ()
        < div >
        _jsx("div", { className: "flex items-center justify-between mb-6", children: _jsxs("h2", { className: "text-lg font-semibold text-gray-900", children: ["Recommended for You (", recommendations.length, ")"] }) });
    {
        ...
        className = "text-center py-12" >
            (_jsx("svg", { className: "mx-auto h-12 w-12 text-gray-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a9 9 0 117.072 0l-.548.547A3.374 3.374 0 0014.846 21H9.154a3.374 3.374 0 00-2.322-1.1l-.548-.547z" }) })
                ,
                    _jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No recommendations available" })
                        ,
                            _jsx("p", { className: "mt-1 text-sm text-gray-500", children: "Complete some learning paths to get personalized recommendations." }));
        div >
        ;
        ()
            < div;
