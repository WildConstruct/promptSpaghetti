...
if (notifications.length === 0) {
    ...
    _jsxs("div", { className: "space-y-2", children: [filteredNotifications.map((notification) => ()
            ...
            `), ">", _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-start space-x-3 flex-1", children: [_jsx("div", { className: "flex-shrink-0 mt-1", children: getNotificationIcon(notification.notification_type) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("h4", { className: "text-sm font-medium text-gray-900", children: notification.title }), !notification.read_at && ()
                                                < span, " className=\"h-2 w-2 bg-blue-500 rounded-full\">"] }), ")}"] }), _jsx("p", { className: "text-sm text-gray-600 mt-1", children: notification.message }), _jsxs("div", { className: "flex items-center space-x-4 mt-2 text-xs text-gray-500", children: [_jsxs("span", { children: ["Resource: ", notification.resource_id.substring(0, 8), "..."] }), _jsx("span", { children: formatRelativeTime(notification.sent_at) }), _jsx("span", { className: "capitalize", children: notification.notification_type.replace('_', ' ') })] }), notification.action_url && ()
                                < a, "href=", notification.action_url, "className=\"text-sm text-blue-600 hover:text-blue-800 mt-2 inline-block\" > View Details \u2192"] }), ")}"] })] })
        ,
            _jsxs("div", { className: "flex items-center space-x-2", children: [!notification.read_at && ()
                        < button, "onClick=", () => onMarkAsRead(notification.id), "className=\"p-1 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded\" title=\"Mark as read\" >", _jsx(Check, { className: "h-4 w-4" })] });
}
_jsx("span", { className: "text-xs text-gray-400", children: new Date(notification.sent_at).toLocaleString() });
div >
;
div >
;
