...
`), ">", _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("p", { className: "font-medium text-gray-900", children: [alert.metric, " (", alert.framework, ")"] }), _jsx("p", { className: "text-sm text-gray-600 mt-1", children: alert.predictedIssue })] }), _jsxs("div", { className: "text-right", children: [_jsxs("span", { className: `inline-flex px-2 py-1 text-xs font-semibold rounded-full ${alert.risk === 'high' ? 'text-red-800 bg-red-100' :
                                                        alert.risk === 'medium' ? 'text-yellow-800 bg-yellow-100' : }
  'text-blue-800 bg-blue-100'
`, children: [alert.risk, " risk"] }), _jsx("p", { className: "text-sm text-gray-600 mt-1", children: alert.timeframe })] })] })] }));
        }
        div >
        ;
        div >
...
className = "bg-white rounded-lg shadow" >
  ...
  'text-blue-600'
`, children: frameworkTrends[selectedFramework].summary.improvementTrend === 'positive' ? '↗️' :
