    ...
    (_jsx("button", { onClick: handleSelectAll, style: {
        ...
        ,
            _jsxs("button", { onClick: handleClearSelection, disabled: selectedResults.size === 0, style: {
                ...
                }, children: ["Clear (", selectedResults.size, ")"] }));
{
    enableExport && ()
        < button;
    ...
    style = {};
    {
        ...
        6,
            cursor;
        selectedResults.size === 0 ? 'not-allowed' : 'pointer',
            fontSize;
        13,
            fontWeight;
        500,
            opacity;
        selectedResults.size === 0 ? 0.5 : 1,
        ;
    }
}
    >
...
style = {};
{
    ...
    '#e5e5e5',
        maxHeight;
    expandedResult === result.id ? 'none' : 150,
        overflow;
    'hidden',
        position;
    'relative',
    ...
    { result, : .output };
{
    ...
    style = {};
    {
        ...
        40,
            background;
        'linear-gradient(transparent, rgba(45, 45, 45, 0.9))',
            display;
        'flex',
            alignItems;
        'end',
...
style = {};
{
    ...
    'none',
        color;
    (result.metadata?.rating || 0) >= star ? '#fbbf24' : '#666',
        cursor;
    'pointer',
        fontSize;
    16,
    ...
    (_jsx("div", { style: { fontSize: 12, color: '#b0b0b0', fontStyle: 'italic' }, children: result.metadata?.notes || 'No notes' })
        ,
            _jsxs("button", { onClick: () => {
                    ...
                    cursor: 'pointer',
                    fontSize: 11,
                }, children: ["\uD83D\uDCDD ", result.metadata?.notes ? 'Edit' : 'Add', " Note"] }));
div >
;
div >
;
