...
};
{
    ...
    'Final Draft',
        description;
    'Final Draft compatible XML format',
        extension;
    'fdx',
        category;
    'script',
...
// VFX Formats
{
    ...
    'ControlNet JSON',
        description;
    'ControlNet-compatible export for AI generation',
        extension;
    'json',
        category;
    'vfx',
...
}
{
    id: 'stable-diffusion',
        name;
    'Stable Diffusion Bundle',
        description;
    'Complete Stable Diffusion pipeline export',
        extension;
    'zip',
        category;
    'vfx',
...
}
{
    ...
    'Scene Data JSON',
        description;
    'Camera, lighting, and environment data',
        extension;
    'json',
        category;
    'vfx',
...
// Data Formats
{
    ...
    'CSV Analysis',
        description;
    'Spreadsheet-ready analytics data',
        extension;
    'csv',
        category;
    'data',
...
}
{
    ...
    'Complete JSON',
        description;
    'Full result data with metadata',
        extension;
    'json',
        category;
    'data',
...
}
{
    ...
    'Creative Brief',
        description;
    'Director-focused creative document',
        extension;
    'docx',
        category;
    'report',
