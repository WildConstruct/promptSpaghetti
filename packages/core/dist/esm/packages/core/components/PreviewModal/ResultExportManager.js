...
className = '';
{
    ...
    const categoryLabels = { script: '🎬 Screenplay Formats',
        vfx: '🤖 VFX Pipeline',
        data: '📊 Data Exports',
...
if (selectedFormat.extension === 'zip' || selectedFormat.extension === 'pdf') {
    ...
    {
        operation: 'export_results', format;
        selectedFormat.id;
    }
    ;
    try {
        ...
        ,
            _jsx("div", { style: {
                    ...
                    gap: 12
                                ...
                                color: '#6b7280',
                                marginBottom: 4
                            }, children: "Target Pipeline" }), _jsx("select", { value: exportOptions?.vfxOptions?.targetPipeline || 'stable-diffusion', onChange: (e) => setExportOptions(prev => prev ? {} : ) }), "...prev vfxOptions: ", ...prev.vfxOptions, "targetPipeline: e.target.value as any } : null)} style=", {
                            width: '100%',
                            padding: '6px 8px',
                            border: '1px solid #d1d5db',
                            borderRadius: 4,
                            ...
                            >
                                (_jsx("option", { value: "stable-diffusion", children: "Stable Diffusion" })
                                    ,
                                        _jsx("option", { value: "midjourney", children: "Midjourney" })
                                            ,
                ...
                ,
                    _jsxs("div", { children: [_jsx("label", { style: {
                                ...
                                } }), "...prev vfxOptions: ", ...prev.vfxOptions, "resolution: [width, height] } : null); } style=", {
                                width: '100%',
                                padding: '6px 8px',
                                border: '1px solid #d1d5db',
                                borderRadius: 4,
                                ...
                                >
                                    (_jsx("option", { value: "1920x1080", children: "1920\u00D71080 (HD)" })
                                        ,
                                            _jsx("option", { value: "2560x1440", children: "2560\u00D71440 (QHD)" })
                                                ,
                                                    _jsx("option", { value: "3840x2160", children: "3840\u00D72160 (4K)" })
                                                        ,
                                                            _jsx("option", { value: "1024x1024", children: "1024\u00D71024 (Square)" }))] }));
div >
;
div >
;
            ...
            ,
                _jsxs("div", { style: {
                        ...
                        gap: 12
                                ...
                                cursor: 'pointer',
                                fontSize: 13
                            }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.filmOptions?.includeCharacterNotes || false, onChange: (e) => setExportOptions(prev => prev ? {} : ) }), "...prev filmOptions: ", ...prev.filmOptions, "includeCharacterNotes: e.target.checked } : null)} style=", { accentColor: '#3b82f6' }, "/> Character Notes"] }), _jsxs("label", { style: {
                                display: 'flex',
                                alignItems: 'center',
                                gap: 6,
                                cursor: 'pointer',
                                fontSize: 13
                            }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.filmOptions?.includeDirectorNotes || false, onChange: (e) => setExportOptions(prev => prev ? {} : ) }), "...prev filmOptions: ", ...prev.filmOptions, "includeDirectorNotes: e.target.checked } : null)} style=", { accentColor: '#3b82f6' }, "/> Director Notes"] })] }));
    div >
    ;
}
div >
...
_jsxs("div", { style: {
    ...
    ,
        _jsxs("button", { onClick: handleExport, disabled: isExporting, style: {
                ...
                _jsx("div", { style: {
                    ...
                    } }), Exporting: true, children: [") : ()", _jsxs(_Fragment, { children: ["\uD83D\uDCE4 Export ", selectedResults.length, " Result", selectedResults.length !== 1 ? 's' : ''] }), ")}"] });
div >
;
div >
;
...
((results, options) => {
    ...
    const basePayload = { results: results.map(result => ({}), id, result.id, seed, result.seed, output, result.output) };
