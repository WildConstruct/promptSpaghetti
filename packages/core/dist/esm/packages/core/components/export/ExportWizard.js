...
import { ExportFormat, CreateExportJob } from validateExportOptions;
from;
'../../types/export';
import { useExport } from '../../hooks/useExport';
import { FiChevronLeft, FiChevronRight, FiX, FiFile, FiSettings, FiFilter, FiCheck, FiDownload } from FiInfo;
from;
'react-icons/fi';
...
`, ">", _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("span", { className: "text-2xl mr-3", children: format.icon }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: format.label }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300", children: format.description })] })] }), exportData.export_format === format.value && ()
                                ...
                                ,
                                    _jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: "Export Type" }), _jsxs("div", { className: "space-y-3", children: [EXPORT_TYPES.map((type) => ()
                                                        ...
                                                        ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20'
                                                        : 'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'}
`, ">", _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: type.label }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300", children: type.description })] }), exportData.export_type === type.value && ()
                                                                < FiCheck, " className=\"w-5 h-5 text-blue-600\" /> )}"] })] }), "))}"] });
                        }
                        finally {
                        }
...
const renderOptionsStep = () => {
    ...
    _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: "Export Options" }), _jsx("div", { className: "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6", children: _jsxs("div", { className: "flex items-center", children: [_jsx(FiInfo, { className: "w-5 h-5 text-blue-600 mr-2" }), _jsxs("p", { className: "text-sm text-blue-800 dark:text-blue-200", children: ["Configure format-specific options for ", exportData.export_format?.toUpperCase(), " export"] })] }) })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white", children: "Content Options" }), [
                                ...
                                _jsx("input", { type: "checkbox", checked: exportData.export_options?.[option.key] || false, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) })), ": ", ...prev.export_options[option.key], ": e.target.checked } }))} className=\"mt-1 rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: option.label }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300", children: option.description })] })] }), "))}"] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white", children: "Format Options" }), exportData.export_format === 'json' && ()
                        < div, " className=\"space-y-3\">", _jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.export_options?.pretty || false, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "pretty: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Pretty Print JSON" })] }), _jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.export_options?.include_schema || false, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "include_schema: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Include JSON Schema" })] })] }), ")}", exportData.export_format === 'csv' && ()
                < div, " className=\"space-y-3\">", _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Delimiter" }), _jsx("select", { value: exportData.export_options?.delimiter || ',', onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "delimiter: e.target.value } }))} className=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500\" >", _jsx("option", { value: ",", children: "Comma ()" }), _jsx("option", { value: ";", children: "Semicolon (;)" }), _jsx("option", { value: "\\t", children: "Tab" }), _jsx("option", { value: "|", children: "Pipe (|)" })] })] })
        ,
            _jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.export_options?.include_headers || false, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "include_headers: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Include Headers" })] });
};
div >
;
{
    exportData.export_format === 'pdf' && ()
        < div;
    className = "space-y-3" >
        _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Page Size" }), _jsx("select", { value: exportData.export_options?.page_size || 'A4', onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "page_size: e.target.value } }))} className=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500\" >", _jsx("option", { value: "A4", children: "A4" }), _jsx("option", { value: "A3", children: "A3" }), _jsx("option", { value: "Letter", children: "Letter" }), _jsx("option", { value: "Legal", children: "Legal" })] });
    div >
        _jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.export_options?.include_images || false, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "include_images: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Include Images" })] });
    div >
    ;
}
{
    exportData.export_format === 'vfx' && ()
        < div;
    className = "space-y-4" >
        _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Export Quality" }), _jsx("select", { value: exportData.export_options?.quality || 'production', onChange: (e) => setExportData(prev => ({}), ...prev, export_options) }), ": ", ...prev.export_options, "quality: e.target.value } }))} className=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500\" >", _jsx("option", { value: "production", children: "Production" }), _jsx("option", { value: "preview", children: "Preview" }), _jsx("option", { value: "debug", children: "Debug" })] });
    div >
        _jsxs("div", { className: "space-y-3", children: [_jsx("h5", { className: "font-medium text-gray-900 dark:text-white", children: "VFX Features" }), [
                    ...
                    < label, key = { option, : .key }, className = "flex items-start space-x-3" >
                    _jsx("input", { type: "checkbox", checked: exportData.export_options?.[option.key] ?? true, onChange: (e) => setExportData(prev => ({}), ...prev, export_options) })), ": ", ...prev.export_options[option.key], ": e.target.checked } }))} className=\"mt-1 rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: option.label }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300", children: option.description })] })] });
}
div >
...
;
_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: "Content Filters" }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300 mb-6", children: "Apply filters to customize what data is included in your export" })] }), _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-3", children: "Date Range" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Start Date" }), _jsx("input", { type: "date", value: exportData.custom_filters?.date_range?.start || '', onChange: (e) => setExportData(prev => ({}), ...prev, custom_filters) }), ": ", ...prev.custom_filters, "date_range: ", ...prev.custom_filters?.date_range, "start: e.target.value } }))} className=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500\" />"] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "End Date" }), _jsx("input", { type: "date", value: exportData.custom_filters?.date_range?.end || '', onChange: (e) => setExportData(prev => ({}), ...prev, custom_filters) }), ": ", ...prev.custom_filters, "date_range: ", ...prev.custom_filters?.date_range, "end: e.target.value } }))} className=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500\" />"] })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-3", children: "Output Options" }), _jsxs("div", { className: "space-y-3", children: [_jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.custom_filters?.compress_output || false, onChange: (e) => setExportData(prev => ({}), ...prev, custom_filters) }), ": ", ...prev.custom_filters, "compress_output: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Compress Output" })] }), _jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: exportData.custom_filters?.encrypt_output || false, onChange: (e) => setExportData(prev => ({}), ...prev, custom_filters) }), ": ", ...prev.custom_filters, "encrypt_output: e.target.checked } }))} className=\"rounded border-gray-300 text-blue-600 focus:ring-blue-500\" />", _jsx("span", { className: "text-gray-900 dark:text-white", children: "Encrypt Output" })] })] })] })] })] });
;
