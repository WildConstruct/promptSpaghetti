...
if (!visible)
    return null;
return;
_jsx("div", { className: `template-collaboration-panel ${className}`, style: {
        position: 'fixed',
        inset: '60px',
        background: 'white',
...
_jsxs("div", { style: {
        ...
        borderBottom: '1px solid #e2e8f0',
        background: '#f8fafc',
    }, children: [_jsxs("div", { style: { display: 'flex', gap: '8px' }, children: [[
...
{ /* Collaborators Tab */ }
{
    ...
    { /* Collaborators List */ }
    _jsxs("div", { children: [_jsxs("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: ["Current Collaborators (", collaborators.length, ")"] }), collaborators.length === 0 ? ()
                < div
                :
            , "style=", {
                padding: '40px',
                textAlign: 'center',
                color: '#9ca3af',
            }, ">", _jsx("div", { style: { fontSize: '32px', marginBottom: '8px' }, children: "\uD83D\uDC65" }), _jsx("div", { children: "No collaborators yet. Invite team members to get started!" })] });
    ()
        < div;
    style = {};
    {
...
div >
    _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [_jsx("span", { style: {
                    padding: '4px 8px',
                ...
                }, children: collaborator.role }), collaborator.role !== 'owner' && ()
                <  >
 ...
 >
    ...
    >
        (_jsx("div", { style: {
            ...
            ,
                _jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { fontSize: '14px', color: '#374151' }, children: [_jsx("strong", { children: activity.userEmail }), " ", activity.details] }), _jsx("div", { style: { fontSize: '12px', color: '#6b7280' }, children: formatDate(activity.timestamp) })] }));
div >
;
div >
;
...
{ /* Sharing Tab */ }
{
    activeTab === 'sharing' && ()
        ...
        (_jsx("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: "Public Sharing Settings" })
            ,
                _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '20px' }, children: [_jsx("div", { style: {
                                padding: '16px',
                                background: '#f8fafc',
                                border: '1px solid #e2e8f0',
                                borderRadius: '8px',
...
style = {};
{
    ...
    >
        (_jsx("div", { style: { display: 'flex', gap: '12px' }, children: _jsx("button", { onClick: handleForkTemplate, disabled: loading, style: {
                    padding: '8px 16px',
                    background: '#f3f4f6',
                    border: '1px solid #e2e8f0',
                    borderRadius: '6px',
