...
// Hooks
const { getTemplateCollaborators, getTemplateActivity, getTemplateAnalytics, inviteCollaborator, updateCollaboratorRole, removeCollaborator, updateShareSettings, generateShareLink };
forkTemplate
    = useExport(projectId);
...
if (!visible)
    return null;
return;
_jsxs("div", { className: `template-collaboration-panel ${className}`, style: {
        position: 'fixed',
        inset: '60px',
        background: 'white',
        ...
        color: 'white'
    }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [_jsxs("div", { children: [_jsx("h2", { style: { margin: 0, fontSize: '20px', fontWeight: '600' }, children: "\uD83D\uDC65 Template Collaboration" }), _jsxs("div", { style: { fontSize: '14px', opacity: 0.9, marginTop: '4px' }, children: [template.name, " \u2022 ", collaborators.length, " collaborators"] })] }), onClose && ()
...
style = {};
{
    ...
    >
        _jsxs("div", { style: { display: 'flex', gap: '8px' }, children: [[
...
{ /* Collaborators Tab */ }
{
    ...
    _jsxs("div", { style: {
            ...
            marginBottom: '24px'
                                    ...
                                    borderRadius: '6px',
                                    fontSize: '14px'
                                }, children: [_jsx("option", { value: "viewer", children: "Viewer" }), _jsx("option", { value: "editor", children: "Editor" })] })] }), _jsx("button", { onClick: handleInviteCollaborator, disabled: loading || !inviteEmail.trim(), style: {
                            padding: '8px 16px',
    ...
    div >
        { /* Collaborators List */}
        < div >
        _jsxs("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: ["Current Collaborators (", collaborators.length, ")"] });
    {
        ...
        >
            (_jsx("div", { style: { fontSize: '32px', marginBottom: '8px' }, children: "\uD83D\uDC65" })
                ,
                    _jsx("div", { children: "No collaborators yet. Invite team members to get started!" }));
    div >
    ;
    ()
        < div;
 ...
 >
    ...
    >
        (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [_jsx("div", { style: {
                        width: '40px',
                        height: '40px',
                        borderRadius: '50%',
...
div >
    _jsx("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: _jsx("span", { style: {
                padding: '4px 8px',
                    ...
                    { collaborator, : .role } }) });
{
    collaborator.role !== 'owner' && ()
        <  >
        (_jsxs("select", { value: collaborator.role, onChange: (e) => handleRoleChange(collaborator.id, e.target.value), style: {
                padding: '4px 8px',
                border: '1px solid #e2e8f0',
                borderRadius: '4px',
                fontSize: '12px'
            }, children: [_jsx("option", { value: "viewer", children: "Viewer" }), _jsx("option", { value: "editor", children: "Editor" })] })
            ,
                _jsx("button", { onClick: () => handleRemoveCollaborator(collaborator.id), style: {
                        padding: '4px 8px',
                        background: '#fee2e2',
                        border: '1px solid #fecaca',
                        borderRadius: '4px',
...
{ /* Activity Tab */ }
{
    activeTab === 'activity' && ()
        < div >
        _jsx("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: "Recent Activity" });
    {
        activities.length === 0 ? ()
            < div
            :
        ...
        style = {};
        {
            ...
            >
                (_jsx("div", { style: { fontSize: '32px', marginBottom: '8px' }, children: "\uD83D\uDCC8" })
                    ,
                        _jsx("div", { children: "No activity yet. Use the template to see activity here!" }));
        div >
        ;
        ()
            < div;
     ...
     >
        ...
        >
            _jsx("div", { style: {
                    ...
                    /  >
                    _jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { fontSize: '14px', color: '#374151' }, children: [_jsx("strong", { children: activity.userEmail }), " ", activity.details] }), _jsx("div", { style: { fontSize: '12px', color: '#6b7280' }, children: formatDate(activity.timestamp) })] }), div: true, children: "))}" });
}
div >
;
{ /* Analytics Tab */ }
{
    activeTab === 'analytics' && ()
        < div >
        _jsx("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: "Usage Analytics" });
    {
        !analytics ? ()
            < div
            :
        ...
        style = {};
        {
            ...
            >
                (_jsx("div", { style: { fontSize: '32px', marginBottom: '8px' }, children: "\uD83D\uDCCA" })
                    ,
                        _jsx("div", { children: "Loading analytics..." }));
        div >
        ;
        ()
            < div;
        ...
        style = {};
        {
            ...
            >
                (_jsx("div", { style: { fontSize: '24px', fontWeight: '600' }, children: formatUsageCount(analytics.totalUses) })
                    ,
                        _jsx("div", { style: { fontSize: '12px', opacity: 0.9 }, children: "Total Uses" }));
        div >
            (_jsxs("div", { style: {
                    padding: '16px',
                    ...
                    color: 'white',
                    borderRadius: '8px'
                }, children: [_jsx("div", { style: { fontSize: '24px', fontWeight: '600' }, children: analytics.uniqueUsers }), _jsx("div", { style: { fontSize: '12px', opacity: 0.9 }, children: "Unique Users" })] })
                ,
                    _jsxs("div", { style: {
                            padding: '16px',
                            ...
                            color: 'white',
                            borderRadius: '8px'
                        }, children: [_jsxs("div", { style: { fontSize: '24px', fontWeight: '600' }, children: [Math.round(analytics.successRate * 100), "%"] }), _jsx("div", { style: { fontSize: '12px', opacity: 0.9 }, children: "Success Rate" })] })
                        ,
                            _jsxs("div", { style: {
                                    padding: '16px',
                                    ...
                                    color: 'white',
                                    borderRadius: '8px'
                                }, children: [_jsx("div", { style: { fontSize: '24px', fontWeight: '600' }, children: analytics.forkCount }), _jsx("div", { style: { fontSize: '12px', opacity: 0.9 }, children: "Forks" })] }));
        div >
        ;
    }
    div >
...
{ /* Sharing Tab */ }
{
    activeTab === 'sharing' && ()
        < div >
        (_jsx("h4", { style: { margin: '0 0 16px', fontSize: '16px', fontWeight: '600' }, children: "Public Sharing Settings" })
            ,
                _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '20px' }, children: _jsx("div", { style: {
                            padding: '16px',
                            background: '#f8fafc',
                            border: '1px solid #e2e8f0',
                            borderRadius: '8px'
                            ...
                            >
                                _jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }, children: [_jsx("input", { type: "checkbox", checked: shareSettings.isPublic, onChange: (e) => handleShareSettingsUpdate({ isPublic: e.target.checked }) }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: '14px', fontWeight: '500' }, children: "Make Template Public" }), _jsx("div", { style: { fontSize: '12px', color: '#6b7280' }, children: "Allow anyone to discover and use this template" })] })] }) }) }));
    { /* Additional Settings */ }
    {
        ...
        _jsx("div", { style: {
                ...
                border: '1px solid #e2e8f0',
                borderRadius: '8px'
            }, children: _jsxs("div", { style: { marginBottom: '12px' }, children: [_jsx("div", { style: { fontSize: '14px', fontWeight: '500', marginBottom: '8px' }, children: "Share Link" }), shareSettings.shareLink ? ()
                        < div : , " style=", { display: 'flex', gap: '8px' }, ">", _jsx("input", { type: "text", value: shareSettings.shareLink, readOnly: true, style: {
                            flex: 1,
                            padding: '8px 12px',
                            border: '1px solid #e2e8f0',
                            borderRadius: '6px',
...
style = {};
{
    ...
    >
        _jsxs("div", { style: { display: 'flex', gap: '12px' }, children: [_jsx("button", { onClick: handleForkTemplate, disabled: loading, style: {
                        padding: '8px 16px',
                        background: '#f3f4f6',
                        border: '1px solid #e2e8f0',
                        borderRadius: '6px',
...
div >
    _jsxs("div", { style: { display: 'flex', gap: '12px' }, children: [onClose && ()
                < button, "onClick=", onClose, "style=", {
                padding: '8px 16px',
