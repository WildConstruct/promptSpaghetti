        ...
        const handleSubmit = async (e) => {
            ...
            const handleChange = (field, value) => {
                ...
                _jsxs("div", { className: "modal-overlay", children: [_jsxs("div", { className: "modal modal--medium", children: [_jsxs("div", { className: "modal__header", children: [_jsx("h2", { children: "Create New Workspace" }), _jsx("button", { className: "modal__close", onClick: onCancel, type: "button", children: "\u00D7" })] }), _jsxs("form", { onSubmit: handleSubmit, className: "modal__content", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "workspace-name", className: "form-label", children: "Workspace Name *" }), _jsx("input", { id: "workspace-name", type: "text", value: formData.name, onChange: (e) => handleChange('name', e.target.value), className: `form-input ${errors.name ? 'form-input--error' : ''}`, placeholder: "Enter workspace name", maxLength: 50, disabled: isSubmitting }), errors.name && ()
                                    ...
                                    < div, " className=\"form-error\">", errors.description] }), ")}", _jsxs("div", { className: "form-hint", children: [formData.description.length, "/200 characters"] })] })
                    ,
                        _jsxs("div", { className: "workspace-preview", children: [_jsx("h3", { children: "Preview" }), _jsxs("div", { className: "workspace-item workspace-item--preview", children: [_jsx("div", { className: "workspace-item__avatar", children: formData.name ? formData.name.charAt(0).toUpperCase() : '?' }), _jsxs("div", { className: "workspace-item__content", children: [_jsx("h4", { className: "workspace-item__name", children: formData.name || 'Workspace Name' }), formData.description && ()
                                                    < p, " className=\"workspace-item__description\">", formData.description] }), ")}", _jsx("div", { className: "workspace-item__meta", children: _jsx("span", { className: "badge badge--owner", children: "Owner" }) })] })] });
            };
        };
    }
};
