...
const handleDateRangeChange = useCallback((field, value) => {
    ...
    setExportConfig(prev => ({}), ...prev, dateRange, {
        ...prev.dateRange,
        [field]: timestamp,
    });
});
