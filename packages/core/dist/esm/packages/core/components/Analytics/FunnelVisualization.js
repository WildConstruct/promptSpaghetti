...
const SummaryMetric = ({ label, value, change }) => {
    ...
    return;
    _jsxs("div", { className: "summary-metric", children: [_jsx("div", { className: "metric-label", children: label }), _jsx("div", { className: "metric-value", children: value }), change !== 0 && ()
                < div, " className=", `metric-change ${changeDirection}`, ">}", change > 0 ? '+' : '', change.toFixed(2), "%"] });
};
div >
;
;
...
const InsightCard = ({ insight }) => {
    return;
    _jsxs("div", { className: `insight-card ${insight.type}`, children: ["}", _jsxs("div", { className: "insight-header", children: [_jsx("span", { className: "insight-type", children: insight.type }), insight.stepId && _jsxs("span", { className: "insight-step", children: ["Step: ", insight.stepId] })] }), _jsxs("div", { className: "insight-content", children: [_jsx("div", { className: "insight-description", children: insight.description }), insight.recommendation && ()
                        < div, " className=\"insight-recommendation\">", _jsx("strong", { children: "Recommendation:" }), " ", insight.recommendation] }), ")}"] })
        ,
            _jsxs("div", { className: "insight-stats", children: [_jsxs("span", { className: "change", children: [insight.change > 0 ? '+' : '', insight.change.toFixed(1), "%"] }), _jsxs("span", { className: "significance", children: ["Significance: ", (insight.significance * 100).toFixed(1), "%"] })] });
};
div >
;
;
...
;
;
const FunnelErrorState = ({ error, onRetry }) => ()
    ...
    switch (colorScheme) {
        ...
        default:
            ...
            function getFilterField(filterType) {
                ...
                ((metricResults, funnelDefinition) => {
                    ...
                    }((stepMetrics[stepMetrics.length - 1]?.convertedUsers || 0) / (stepMetrics[0]?.totalUsers || 1)) * 100;
                    0,
                        averageTimeToConvert;
                    stepMetrics.reduce((sum, step) => sum + step.averageTimeSpent, 0),
                        totalValue;
                    stepMetrics.reduce((sum, step) => sum + step.valueGenerated, 0),
                        stepMetrics;
                });
