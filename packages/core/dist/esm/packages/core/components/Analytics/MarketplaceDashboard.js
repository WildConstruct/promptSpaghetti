...
const renderTopCategories = () => {
    if (!dashboardData?.trends.topCategories)
        return null;
    return;
    _jsxs(Card, { className: "top-categories-card", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Top Performing Categories" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "categories-list", children: dashboardData.trends.topCategories.map((category, index) => ()
                            < div, key = { category, : .category }, className = "category-item" >
                            (_jsxs("div", { className: "category-info", children: [_jsxs("div", { className: "category-rank", children: ["#", index + 1] }), _jsxs("div", { className: "category-details", children: [_jsx("div", { className: "category-name", children: category.category }), _jsx("div", { className: "category-revenue", children: formatCurrency(category.revenue) })] })] })
                                ,
                                    _jsx("div", { className: "category-growth", children: _jsxs(Badge, { variant: category.growth > 0 ? 'default' : 'secondary', children: [category.growth > 0 ? '+' : '', category.growth.toFixed(1), "%"] }) }))) }), "))}"] })] });
};
Card >
;
;
...
const renderTopTemplates = () => {
    return;
    _jsxs(Card, { className: "top-templates-card", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "templates-header", children: [_jsx(CardTitle, { children: "Top Performing Templates" }), _jsxs(Select, { value: selectedMetric, onValueChange: (value) => setSelectedMetric(value), children: [_jsx(SelectTrigger, { className: "w-48", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "revenue", children: "By Revenue" }), _jsx(SelectItem, { value: "downloads", children: "By Downloads" }), _jsx(SelectItem, { value: "rating", children: "By Rating" })] })] })] }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "templates-list", children: [topTemplates.map((template, index) => ()
                                < div, key = { template, : .templateId }, className = "template-item" >
                                (_jsxs("div", { className: "template-rank", children: ["#", index + 1] })
                                    ,
                                        _jsxs("div", { className: "template-info", children: [_jsx("div", { className: "template-name", children: template.name }), _jsx("div", { className: "template-category", children: _jsx(Badge, { variant: "outline", children: template.category }) })] })
                                            ,
                                                _jsxs("div", { className: "template-metrics", children: [selectedMetric === 'revenue' && ()
                                                            < div, " className=\"metric-primary\">", formatCurrency(template.metrics.revenue.total)] }))), selectedMetric === 'downloads' && ()
                                < div, " className=\"metric-primary\">", formatNumber(template.metrics.downloads)] }), ")}", selectedMetric === 'rating' && ()
                        < div, " className=\"metric-primary\">", template.metrics.ratings.average.toFixed(1), " \u2605"] }), ")}", _jsxs("div", { className: "metric-secondary", children: [_jsxs("span", { children: [formatNumber(template.metrics.views), " views"] }), _jsxs("span", { children: [template.metrics.favorites, " \u2665"] })] })] });
};
div >
;
div >
...
const renderSearchAnalytics = () => {
    if (!searchData)
        return null;
    return;
    _jsxs("div", { className: "search-analytics", children: [_jsxs(Card, { className: "search-overview", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { children: [_jsx(Search, { className: "w-5 h-5" }), "Search Analytics"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "search-metrics", children: [_jsxs("div", { className: "search-stat", children: [_jsx("div", { className: "stat-value", children: formatNumber(searchData.totalSearches || 0) }), _jsx("div", { className: "stat-label", children: "Total Searches" })] }), _jsxs("div", { className: "search-stat", children: [_jsxs("div", { className: "stat-value", children: [searchData.averageCTR?.toFixed(1) || 0, "%"] }), _jsx("div", { className: "stat-label", children: "Average CTR" })] })] }) })] }), _jsxs(Card, { className: "top-queries", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Top Search Queries" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "queries-list", children: searchData.topQueries?.slice(0, 8).map((query, index) => ()
                                    < div, key = { query, : .query }, className = "query-item" >
                                    (_jsxs("div", { className: "query-rank", children: ["#", index + 1] })
                                        ,
                                            _jsxs("div", { className: "query-info", children: [_jsxs("div", { className: "query-text", children: ["\"", query.query, "\""] }), _jsxs("div", { className: "query-stats", children: [_jsxs("span", { children: [query.count, " searches"] }), _jsxs("span", { children: [query.ctr.toFixed(1), "% CTR"] })] })] }))) }), "))}"] })] })] });
};
div >
;
;
...
const renderInsights = () => {
    return;
    _jsxs(Card, { className: "insights-card", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Marketplace Insights" }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "insights-list", children: [insights.map((insight, index) => ()
                                < div, key = { index }, className = {} `insight-item ${insight.impact}`), ">}", _jsxs("div", { className: "insight-icon", children: [insight.type === 'opportunity' && _jsx(TrendingUp, { className: "w-5 h-5" }), insight.type === 'trend' && _jsx(Target, { className: "w-5 h-5" }), insight.type === 'optimization' && _jsx(Users, { className: "w-5 h-5" })] }), _jsxs("div", { className: "insight-content", children: [_jsxs("div", { className: "insight-header", children: [_jsx("div", { className: "insight-title", children: insight.title }), _jsxs(Badge, { variant: insight.impact === 'high' ? 'default' : insight.impact === 'medium' ? 'secondary' : 'outline', children: [insight.impact, " impact"] })] }), _jsx("div", { className: "insight-description", children: insight.description }), _jsx("div", { className: "insight-action", children: _jsx(Button, { variant: "outline", size: "sm", children: insight.action }) })] })] }), "))}"] })] });
};
Card >
;
;
...
if (isLoading) {
    return;
    _jsxs("div", { className: "marketplace-dashboard loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading marketplace analytics..." })] });
    ;
    return;
