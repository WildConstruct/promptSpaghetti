...
export const ExportOptionsDialog = ({ open, onClose, results, selectedIndices = [], exportType, individualIndex, onExport, sourceGraph }) => {
                        ...
                        color: professionalColors.text.primary,
                                ...
                                fontSize: 12,
                                        ...
                                        gap: 8,
                                                ...
                                                ? '2px solid #4d7cff'
                                                : '1px solid #e5e7eb',
                                                borderRadius) }, format.format))), ": 6, cursor: 'pointer', background: selectedFormat === format.format ? '#f0f4ff' : '#fff', transition: 'all 0.2s', }} >", _jsxs("div", { style: {
                                                display: 'flex',
                                                justifyContent: 'space-between',
