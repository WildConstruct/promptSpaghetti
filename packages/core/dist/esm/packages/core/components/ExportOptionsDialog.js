...
export const ExportOptionsDialog = ({ open,
    onClose,
    results,
    selectedIndices = [],
    exportType,
...
sourceGraph;
{
    ...
    const [selectedFormat, setSelectedFormat] = useState('json-simple');
        ...
        _jsxs("div", { style: {
                ...
                justifyContent: 'center'
                        ...
                        color: professionalColors.text.primary
                                ...
                                marginBottom: 20,
                                paddingBottom: 16
                            }, "borderBottom:": true }), " `1px solid $", professionalColors.border.subtle, "` }>", _jsx("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 }, children: "Export Options" }), _jsxs("div", { style: {
                                display: 'flex',
                                alignItems: 'center',
                                gap: 12,
                                fontSize: 12,
                        ...
                        fontSize: 12
                                ...
                                gap: 8
                            }, children: availableFormats.map((format) => (_jsx("div", { onClick: () => handleFormatChange(format.format), style: {
                                    padding: 12,
                                    ...
                                    >
                                        _jsxs("div", { style: {
                                                ...
                                                marginBottom: 4
                                                        ...
                                                        { format, : .category.toUpperCase() } })] }) }, format.format))) }), _jsx("div", { style: {
                                fontSize: 11,
                                color: professionalColors.text.secondary,
                                lineHeight: 1.4
...
`1px solid ${professionalColors.border.subtle}`;
 >
    (_jsx("div", { style: {
            fontSize: 11,
            color: professionalColors.text.secondary
        ...
        ,
            _jsx("div", { style: { display: 'flex', gap: 12 }, children: _jsx("button", { onClick: onClose, disabled: isExporting, style: {
                        padding: '8px 16px',
                        ...
                        >
                            Cancel }) })
                ,
                    _jsxs("button", { onClick: handleExport, disabled: isExporting || validationErrors.length > 0, style: {
                            padding: '8px 16px',
                            ...
                            _jsx("div", { style: {
                                ...
                                } }), Exporting: true, children: [") : (", _jsxs(_Fragment, { children: ["\uD83D\uDCBE Export ", formatInfo?.name] }), ")}"] }));
div >
;
div >
;
