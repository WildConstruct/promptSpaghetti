...
selectedPlatform = 'opengraph';
{
    ...
    _jsxs("div", { style: {
            ...
            fontFamily: 'system-ui, -apple-system, sans-serif'
                ...
                width: '100%',
                height: '200px'
            }, "backgroundImage: `url($", shareConfig.thumbnailUrl, ")`} }, backgroundSize: 'cover', backgroundPosition: 'center'; }>"] });
}
...
_jsxs("div", { style: {
        ...
        fontFamily: 'Whitney, "Helvetica Neue", Helvetica, Arial, sans-serif'
                ...
                paddingLeft: '12px'
                    ...
                    maxWidth: '400px',
                    height: '200px'
                }, "backgroundImage: `url($", shareConfig.thumbnailUrl, ")`} }, backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '4px'; }>"] }), ")}"] });
div >
;
;
...
_jsxs("div", { style: {
        ...
        border: '1px solid #e5e7eb'
                ...
                flexWrap: 'wrap'
                    ...
                    padding: '8px 12px'
                }, "border: `1px solid $", activePreview === option.id ? '#3b82f6' : '#d1d5db', "`} backgroundColor: activePreview === option.id ? '#eff6ff' : 'white' color: activePreview === option.id ? '#3b82f6' : '#6b7280' borderRadius: '6px' cursor: 'pointer' fontSize: '13px' fontWeight: '500' display: 'flex' alignItems: 'center' gap: '6px'; >", _jsx("span", { children: option.icon }), option.label] }), "))}"] });
{ /* Preview Content */ }
_jsx("div", { style: {
        display: 'flex',
        justifyContent: 'center',
