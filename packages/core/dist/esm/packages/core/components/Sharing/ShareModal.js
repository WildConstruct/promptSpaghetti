                            ...
                            boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)'
                                ...
                                < div, " style=", { display: 'flex', flexDirection: 'column', gap: '20px' }, ">", _jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Title" }), _jsx("input", { type: "text", value: customTitle, onChange: (e) => setCustomTitle(e.target.value), style: {
                                            ...
                                            /  >
                                                ...
                                                padding: '8px 12px'
                                            }, "border: `1px solid $", selectedPlatforms.includes(platform) ? '#3b82f6' : '#d1d5db', "`} backgroundColor: selectedPlatforms.includes(platform as SocialPlatform) ? '#eff6ff' : 'white' borderRadius: '6px' cursor: 'pointer' fontSize: '12px' textTransform: 'capitalize' color: selectedPlatforms.includes(platform as SocialPlatform) ? '#3b82f6' : '#6b7280'; >", platform] }), "))}"] })] })] });
        }
        finally {
        }
    };
...
{ /* Share Link */ }
_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Share Link" }), _jsx("div", { style: { display: 'flex', gap: '8px' }, children: _jsx("input", { type: "text", value: shareResponse.shareLink.shortUrl, readOnly: true, style: {
                    flex: 1,
                    padding: '8px 12px',
                    border: '1px solid #d1d5db',
                    borderRadius: '6px',
            ...
            ,
                _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [Object.entries(shareResponse.socialLinks).map(([platform, url]) => ()
                            < div, key = { platform }, style = {}, { display: 'flex', gap: '8px', alignItems: 'center' }), ">", _jsxs("span", { style: {
                                ...
                                minWidth: '80px',
                                color: '#6b7280'
                            }, children: [platform, ":"] }), _jsx("a", { href: url, target: "_blank", rel: "noopener noreferrer", style: {
                                color: '#3b82f6',
                                textDecoration: 'none',
                                fontSize: '14px'
                            }
                ...
                _jsx("textarea", { value: shareResponse.embedCodes.responsive, readOnly: true, rows: 4, style: {
                    ...
                    ,
                        _jsx("button", { onClick: () => copyToClipboard(shareResponse.embedCodes.responsive), style: {
                                ...
                                >
                                    Copy, Embed: true, Code: true, button: true }));
}
div >
;
div >
