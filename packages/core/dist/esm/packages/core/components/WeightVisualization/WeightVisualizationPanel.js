...
export const WeightVisualizationPanel = ({
    options,
...
});
{
    ...
    ;
    _jsxs("div", { style: { display: 'flex', gap: 4, marginBottom: 12 }, children: [[
            ...
            }, ">", _jsx("span", { style: { fontSize: 12 }, children: icon }), _jsx("span", { children: label })] });
}
div >
;
;
...
;
_jsxs("div", { style: { marginBottom: 12 }, children: [_jsx("label", { style: { fontSize: 11, color: '#9ca3af', marginBottom: 6, display: 'block' }, children: "Color Scheme" }), _jsxs("select", { value: colorScheme, onChange: (e) => setColorScheme(e.target.value), style: {
                width: '100%',
                padding: '6px 8px',
                fontSize: 11,
...
const content = ();
;
_jsx("div", { style: { padding: '0 4px' }, children: showChartControls && ()
        <  >
        (_jsx(ChartTypeSelector, {})
            ,
                _jsx(ColorSchemeSelector, {})
                    ,
                        _jsx(DisplayOptions, {})) });
{ /* Main Chart */ }
_jsx("div", { style: { display: 'flex', justifyContent: 'center', marginBottom: 8 }, children: _jsx(WeightDistributionChart, { options: options, type: chartType, width: 240, height: chartType === 'bar' ? Math.min(300, Math.max(160, options.length * 32 + 60)) : 240, showLabels: showLabels, showPercentages: showPercentages, colorScheme: colorScheme, onOptionHover: onOptionHover, onOptionClick: onOptionClick }) });
{ /* Statistics */ }
_jsx(StatisticsDisplay, {});
div >
;
;
...
if (!onCollapseChange) {
    return;
    _jsxs("div", { className: className, style: style, children: [_jsx("div", { style: {
                    marginBottom: 12,
                    paddingBottom: 8,
    ...
    // Collapsible version
    return;
    _jsx("div", { className: className, style: style, children: _jsx(CollapsibleSection, { title: `📊 ${title}`, collapsed: collapsed, onToggle: onCollapseChange, className: "weight-visualization-panel", children: content }) });
    ;
}
;
