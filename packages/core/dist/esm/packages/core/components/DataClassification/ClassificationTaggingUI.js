...
new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year from now
    approvals;
[], // Will be populated by approval workflow
    metadata;
{
...
div >
    ...
    < div;
className = "mb-6" >
    (_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Classification Rationale *" })
        ,
            _jsx("textarea", { value: formData.rationale, onChange: (e) => handleFieldChange('rationale', e.target.value), placeholder: "Explain why this classification level is appropriate...", disabled: readonly, className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100", rows: 3 }));
div >
    { /* Data Owner */}
    < div;
className = "mb-6" >
    (_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Data Owner *" })
        ,
...
div >
    ...
    < div;
className = "mb-6" >
    (_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Business Justification" })
        ,
            _jsx("textarea", { value: formData.businessJustification, onChange: (e) => handleFieldChange('businessJustification', e.target.value), placeholder: "Describe the business need for this data and classification", disabled: readonly, className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100", rows: 2 }));
div >
    { /* Risk Assessment (required for sensitive data) */};
{
    (['CONFIDENTIAL', 'RESTRICTED'].includes(formData.classification)) && ()
        < div;
    className = "mb-6" >
        (_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Risk Assessment *" })
            ,
                _jsx("textarea", { value: formData.riskAssessment, onChange: (e) => handleFieldChange('riskAssessment', e.target.value), placeholder: "Assess potential risks of data exposure or misuse", disabled: readonly, className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100", rows: 2 }));
    div >
    ;
}
...
{ /* Validation Messages */ }
{
    ...
    className = "mb-6 space-y-2" >
        { validation, : .errors.map((error, index) => ()
                ...
                _jsx("svg", { className: "w-4 h-4 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z", clipRule: "evenodd" }) }), { error }, div >
            ) };
    {
        validation.warnings.map((warning, index) => ()
            < div, key = { index }, className = "flex items-center text-yellow-600 text-sm" >
            _jsx("svg", { className: "w-4 h-4 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z", clipRule: "evenodd" }) }), { warning }, div >
        );
    }
    {
        validation.recommendations.map((recommendation, index) => ()
            < div, key = { index }, className = "flex items-center text-blue-600 text-sm" >
            _jsx("svg", { className: "w-4 h-4 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", clipRule: "evenodd" }) }), { recommendation }, div >
        );
    }
    div >
    ;
...
{ /* Handling Requirements */ }
{
    showHandlingRequirements && formData.classification && ()
        < div;
    className = "mb-6" >
        _jsxs("button", { type: "button", onClick: () => setShowRequirements(!showRequirements), className: "flex items-center text-sm font-medium text-gray-700 hover:text-gray-900", children: [_jsxs("svg", { className: `w-4 h-4 mr-2 transform transition-transform ${showRequirements ? 'rotate-90' : ''}`, fill: "currentColor", viewBox: "0 0 20 20", children: ["}", _jsx("path", { fillRule: "evenodd", d: "M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z", clipRule: "evenodd" })] }), "View Handling Requirements for ", formData.classification] });
    {
        showRequirements && ()
            < div;
...
{ /* Action Buttons */ }
{
    ...
    className = "flex justify-end space-x-3" >
        (_jsx("button", { type: "button", className: "px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500", children: "Cancel" })
            ,
                _jsx("button", { type: "button", onClick: handleSubmit, disabled: !validation.valid || !formData.classification, className: "px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed", children: "Apply Classification" }));
    div >
    ;
}
{ /* Existing Classification Display */ }
{
    ...
    className = "border-t pt-4" >
        (_jsx("h4", { className: "font-medium text-gray-900 mb-2", children: "Classification Details" })
            ,
                _jsxs("div", { className: "text-sm text-gray-600 space-y-1", children: [_jsxs("p", { children: ["Classified by: ", existingClassification.classifiedBy] }), _jsxs("p", { children: ["Date: ", existingClassification.classificationDate.toLocaleDateString()] }), _jsxs("p", { children: ["Review Date: ", existingClassification.reviewDate.toLocaleDateString()] })] }));
    div >
    ;
}
div >
