            ...
            fontFamily: 'var(--font-family-primary)'
                    ...
                    cursor: 'pointer'
                            ...
                            gap: '8px',
                                            ...
                                            fontSize: '12px',
                                        }, children: [selectedNodes.length, " nodes, ", selectedEdges.length, " edges"] })] })] }), _jsx("span", { style: {
                            color: styles.textSecondary,
                            fontSize: '12px',
                            transform: isExpanded ? 'rotate(180deg)' : 'rotate(0deg)',
                            transition: 'transform var(--transition-fast)',
                        }, children: "\u25BC" })] }), isExpanded && (_jsxs("div", { style: { padding: '16px' }, children: [_jsxs("div", { style: {
                            display: 'flex',
                            gap: '8px',
                            marginBottom: '16px',
                            flexWrap: 'wrap',
                                    ...
                                    letterSpacing: '0.5px',
                                }, children: "Selected Nodes" }), _jsx("div", { style: {
                                    maxHeight: '120px',
                                    overflowY: 'auto',
                                    border: `1px solid ${styles.border}`,
                                    borderRadius: '4px',
                                    background: styles.secondary
                                        ...
                                        gap: '8px'
                                                ...
                                                background: styles.accent,
                                                        ...
                                                        color: styles.textSecondary,
                                                        fontSize: '11px',
                                                    }, children: [node.type, " \u2022 ", Math.round(node.position.x), ", ", Math.round(node.position.y)] })] })] }, node.id))) })] })), _jsxs("div", { style: {
                            padding: '8px 12px',
                            background: styles.secondary,
                            borderRadius: '4px',
                            border: `1px solid ${styles.border}`
