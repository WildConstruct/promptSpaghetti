    ...
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', { style: { opacity: 0.7 }, children: '|' }),
          _jsx('span', { children: 'Press \u2318K for commands' }),
        ],
      }),
      nodes.length === 0 &&
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('h2', {
              ...
              children: 'Professional Graph Editor',
            }),
            _jsx('p', {
              style: {
                fontSize: '16px',
              ...
              children: 'Create professional prompt generation workflows with Cinema 4D-inspired tools and shortcuts.',
            }),
            _jsxs('div', {
              style: {
                display: 'flex',
              ...
              children: [
                ...
                _jsx('div', { children: '\u2022' }),
                _jsx('div', { children: 'Drag nodes from the palette' }),
                _jsx('div', { children: '\u2022' }),
                _jsxs('div', {
                  children: [
                    'Press ',
