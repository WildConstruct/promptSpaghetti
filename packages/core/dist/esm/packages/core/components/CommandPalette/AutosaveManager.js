    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', { style: { color: styles.text, fontWeight: '500' }, children: getStatusText() }),
          lastSave && _jsx('span', { style: { color: styles.textSecondary }, children: formatTime(lastSave) }),
          _jsxs('div', {
                              ...
                              'div',
                              {
                                ...
                                children: [
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      _jsxs('div', {
                                        ...
                                        children: ['Version ', version.version, ' ', isLatest && '(Latest)'],
                                      }),
                                      _jsx('div', {
                                        style: {
                                          color: styles.textSecondary,
                                  ...
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      _jsxs('span', { children: [version.metadata.nodeCount, ' nodes'] }),
                                      _jsxs('span', { children: [version.metadata.edgeCount, ' edges'] }),
                                      _jsxs('span', {
                                        children: [
                                          'Modified: ',
                                  ...
                                  version.metadata.sessionId !== autosaveSystem['sessionId'] &&
                                    _jsx('div', {
                                      ...
                                      children: '\u26A0\uFE0F Modified in different session',
                                    }),
                                ],
                              },
                              version.version
