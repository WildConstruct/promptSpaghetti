  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('button', {
        ...
        children: [_jsx('span', { style: { fontSize: '16px' }, children: '\u21B6' }), 'Undo'],
      }),
      _jsxs('button', {
        onClick: handleRedo,
        disabled: !canRedo,
        ...
        children: [_jsx('span', { style: { fontSize: '16px' }, children: '\u21B7' }), 'Redo'],
      }),
      _jsx('button', {
        ...
        children: _jsx('span', { style: { fontSize: '16px' }, children: '\uD83D\uDCCB' }),
      }),
      showHistory &&
        _jsxs('div', {
          ref: historyRef,
          ...
          children: [
            _jsxs('div', {
              ...
              children: ['History (', undoSystem.getHistory().length, ' states)'],
            }),
            _jsx('div', {
              style: { maxHeight: '300px', overflow: 'auto' },
              children: undoSystem.getHistory().map((state, index) => {
            ...
            _jsx('div', {
              ...
              children: 'Click any state to jump to it',
            }),
          ],
        }),
      showHistory &&
