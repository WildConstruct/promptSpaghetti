...
const GenerationWizard = ({ flow, currentStep, params, onParamsChange, onStepChange, onExecute, onCancel, theme }) => {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('span', { style: { fontSize: '24px' }, children: flow.icon }),
              _jsx('h2', {
                style: { margin: 0, fontSize: '20px', fontWeight: 600, color: styles.text },
                children: flow.name,
              }),
              _jsx('span', {
                style: {
      ...
      _jsxs('div', {
        style: { padding: '24px', maxHeight: '400px', overflow: 'auto' },
        children: [
          _jsx('h3', {
            style: {
              margin: '0 0 8px 0',
                  ...
                  _jsxs('label', {
                    ...
                    children: [
                      ...
                      field.validation?.required &&
                        _jsx('span', { style: { color: '#ef4444', marginLeft: '4px' }, children: '*' }),
                    ],
                  }),
                  field.type === 'text' &&
                    _jsx('input', {
  ...
  return _jsx(_Fragment, {
    children: _jsxs('div', {
      ...
      children: [
                          ...
                          actions.map((action, actionIndex) => {
                            ...
                            return _jsxs(
                              'div',
                              {
                                ...
                                children: [
                                  _jsx('span', { style: { fontSize: '20px' }, children: action.icon }),
                                  _jsxs('div', {
                                    style: { flex: 1 },
                                    children: [
                                      _jsx('div', {
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('div', {
                          ...
                          children: 'Try searching for "generate", "create", or "export"',
                        }),
                      ],
                    }),
                ],
        ...
        showGenerationWizard &&
          activeGenerationFlow &&
          _jsx(GenerationWizard, {
