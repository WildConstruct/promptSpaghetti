...
import React, { useState, useCallback } from 'react';
{
    ...
    'Spam',
        description;
    'Content is spam, promotional, or repetitive',
        severity;
    'medium',
        category;
    'spam',
...
}
{
    ...
    'Harassment',
        description;
    'Content contains harassment, bullying, or personal attacks',
        severity;
    'high',
        category;
    'harassment',
...
}
{
    ...
    'Security Issue',
        description;
    'Content contains security vulnerabilities or malicious code',
        severity;
    'critical',
        category;
    'security',
...
}
{
    ...
    'Privacy Violation',
        description;
    'Content exposes private or personal information',
        severity;
    'high',
        category;
    'legal',
...
}
{
    ...
    'Low Quality',
        description;
    'Content is low quality, incomplete, or not useful',
        severity;
    'low',
        category;
    'content',
...
}
{
    ...
    'Off Topic',
        description;
    'Content is not relevant to the platform or category',
        severity;
    'low',
        category;
    'content',
