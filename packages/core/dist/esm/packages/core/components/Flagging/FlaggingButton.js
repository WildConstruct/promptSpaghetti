...
;
{
    ...
    _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("label", { style: {
                    ...
                    >
                        (_jsx("input", { type: "radio", name: "reason", value: reason.id, checked: selectedReason === reason.id, onChange: (e) => setSelectedReason(e.target.value), style: { marginTop: '2px' } })
                            ,
...
_jsx("div", { style: {
        ...
        borderTop: '1px solid #e5e7eb'
            ...
            >
                Cancel }) })
    ,
        _jsx("button", { onClick: handleSubmitFlag, disabled: !selectedReason || loading, style: {
                padding: '8px 16px',
