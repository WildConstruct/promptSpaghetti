...
export const NotificationSystem = ({ position = 'top-right',
    maxVisible = 5 });
...
if (visibleNotifications.length === 0) {
  ...
  opacity: 1;
        @keyframes fadeOut {
          ...
          to {
            opacity: 0;
      ` }), _jsxs("div", { style: getPositionStyles(), children: [visibleNotifications.map((notification) => ()
                        < div, key = { notification, : .id }, style = { getNotificationStyles(notification) { }, : .type }), ">", _jsxs("div", { style: { display: 'flex', alignItems: 'flex-start', gap: '8px', flex: 1 }, children: [_jsx("div", { style: {
                                    fontSize: '16px',
                                    marginTop: '2px',
                                    flexShrink: 0
                            ...
                            opacity: 0.7,
                            flexShrink: 0
                        }, title: "Dismiss", children: "\u00D7" })] }), "))}", notifications.length > maxVisible && ()
                < div, " style=", {
                padding: '8px 12px',
                background: '#2d3748',
                ...
                justifyContent: 'space-between',
                alignItems: 'center'
            }, ">", _jsxs("span", { children: ["+", notifications.length - maxVisible, " more notifications"] }), _jsx("button", { onClick: clearNotifications, style: {
                    background: 'none',
                    border: 'none',
                    color: '#63b3ed',
                    cursor: 'pointer',
