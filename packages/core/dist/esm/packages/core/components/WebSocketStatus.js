...
export const WebSocketStatusIcon, ConnectionState;
onClick ?  : () => void ;
 > ;
...
export const WebSocketDetails, ConnectionState;
...
}
{
    ...
    className = "flex flex-col" >
        (_jsx("span", { className: "text-gray-600 mb-1", children: "Error:" })
            ,
                _jsx("span", { className: "text-red-600 text-xs bg-red-50 p-2 rounded", children: connectionState.error }));
    div >
    ;
}
div >
    _jsxs("div", { className: "flex space-x-2 pt-2 border-t", children: [canReconnect && onReconnect && ()
                < button, "onClick=", onReconnect, "className=\"flex-1 px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600\" > Reconnect"] });
{
