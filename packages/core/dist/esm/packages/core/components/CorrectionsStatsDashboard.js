...
good_rules: number;
poor_rules: number;
export const CorrectionsStatsDashboard = ({ isOpen });
onClose;
{
    ...
    const fetchMetrics = async () => {
                ...
                zIndex: 1001
                    ...
                    >
                        _jsxs("div", { style: {
                                ...
                                alignItems: 'center',
                                marginBottom: '24px'
                            }, children: [_jsx("h2", { style: { margin: 0, fontSize: '20px', fontWeight: 600 }, children: "Corrections Statistics" }), _jsx("div", { style: { display: 'flex', alignItems: 'center', gap: '16px' }, children: _jsx("select", { value: selectedPeriod, onChange: (e) => setSelectedPeriod(e.target.value), style: {
                                            padding: '6px 12px',
                                            background: '#2a2e37',
                                            color: '#fff',
                                                ...
                                                (_jsx("option", { value: "7", children: "Last 7 days" })
                                                    ,
                                                        _jsx("option", { value: "30", children: "Last 30 days" })
                                                            ,
                                                                _jsx("option", { value: "90", children: "Last 90 days" })) }) }), _jsx("button", { onClick: onClose, style: {
                                        background: 'none',
                                        border: 'none',
                                        color: '#a0aec0',
                                        cursor: 'pointer',
        ...
        {
            metrics && !loading && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '24px' }, children: [_jsxs("div", { style: {
                            display: 'grid',
                            ...
                            gap: '16px'
                                    ...
                                    overflow: 'hidden'
                                        ...
                                        }, children: [_jsx("div", { children: "Rule Name" }), _jsx("div", { children: "Applications" }), _jsx("div", { children: "Quality" }), _jsx("div", { children: "Impact" }), _jsx("div", { children: "Avg Time" }), _jsx("div", { children: "Success Rate" }), _jsx("div", { children: "Trend" })] }), metrics.most_used_rules.slice(0, 10).map((rule) => (_jsx("div", { style: {
                                            display: 'grid',
                                            gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 1fr 1fr',
                                            gap: '12px',
                                            padding: '12px 16px',
                                                                                ...
                                                                                _jsxs("div", { children: [rule.average_execution_time.toFixed(1), "ms"] })
                                                                                    ,
                                                                                        _jsxs("div", { style: {
                                                                                            ...
                                                                                            ,
                                                                                                _jsx("div", { children: _jsx("span", { style: {
                                                                                                            color: rule.usage_trend === 'increasing' ? '#68d391' :
                                                                                                                rule.usage_trend === 'decreasing' ? '#e53e3e' : '#a0aec0',
                                                                                                            fontSize: '12px'
                                                                                                        }, children: rule.usage_trend === 'increasing' ? '↗' :
                                                                                                            rule.usage_trend === 'decreasing' ? '↘' : '→' }) })) }, rule.rule_id)))] }), "))}"] })] })) /* Performance Trends */;
            { /* Performance Trends */ }
            _jsxs("div", { children: [_jsx("h3", { style: { fontSize: '16px', fontWeight: 600, marginBottom: '16px' }, children: "Performance Trends" }), _jsx("div", { style: {
                            background: '#2a2e37',
                            borderRadius: '8px',
                            border: '1px solid #444',
                            padding: '16px'
            ...
            { /* Rule Distribution */ }
            _jsxs("div", { children: [_jsx("h3", { style: { fontSize: '16px', fontWeight: 600, marginBottom: '16px' }, children: "Rule Effectiveness Distribution" }), _jsxs("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))',
                            gap: '16px',
                            marginBottom: '24px'
            ...
            { /* Actions */ }
            _jsx("div", { style: { display: 'flex', gap: '12px', justifyContent: 'flex-end' }, children: _jsx("button", { onClick: fetchMetrics, style: {
                        padding: '8px 16px',
                        background: '#63b3ed',
                        color: '#fff',
                        border: 'none',
