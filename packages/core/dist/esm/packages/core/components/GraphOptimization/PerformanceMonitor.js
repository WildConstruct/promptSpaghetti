...
if (!isVisible) {
    return;
    _jsxs("div", { onClick: onToggle, style: {
            position: 'fixed',
            bottom: '20px',
            right: '20px',
            width: '60px',
            ...
            >
        , div: true, children: ["); const performanceStatus = getPerformanceStatus(); return;", _jsx("div", { style: {
                    position: 'fixed',
                    bottom: '20px',
                    right: '20px',
                    width: '360px',
                    ...
                    overflow: 'hidden'
                        ...
                        alignItems: 'center'
                                ...
                                fontWeight: '600',
                                color: '#333'
                            }, children: "\uD83D\uDCCA Performance Monitor" }), _jsx("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: _jsx("button", { onClick: () => setIsCollecting(!isCollecting), style: {
                                    padding: '4px 12px',
                                    ...
                                    >
                                        { isCollecting, 'Stop': 'Start' } }) }), _jsx("button", { onClick: onToggle, style: {
                                background: 'none',
                                border: 'none',
                                fontSize: '18px',
                                cursor: 'pointer',
                    ...
                    padding: '16px',
                    textAlign: 'center'
                }, "backgroundColor:": true }), " `$", performanceStatus.color, "11`} borderBottom: '1px solid #e9ecef'; }>", _jsx("div", { style: {
                    fontSize: '24px',
                    fontWeight: 'bold',
