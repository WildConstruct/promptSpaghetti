import { WSMessage, WSMessageSchema, GraphUpdatePayload, PresenceUpdatePayload } from WSMessageType;
from;
'../../../server/src/websocket/types';
...
Promise < void  > { : .state.status === 'connecting' || this.state.status === 'connected' };
{
        ...
        };
        {
            ...
            */
            ...
            boolean;
            {
                return this.sendMessage({
                    type: 'cursor_update'
                }, payload, { x, y, nodeId, viewportBounds }, timestamp, Date.now(), documentId, this.documentId || undefined, userId, this.userId || undefined);
            }
            ;
            /**
            ...
            boolean;
            {
                ...
                }, payload, { nodeIds, edgeIds, selectionBox }, timestamp, Date.now(), documentId, this.documentId || undefined, userId, this.userId || undefined);
            }
            ;
            /**
            ...
            boolean;
            {
                ...
                }, payload, { currentTool, isTyping, focusedNodeId }, timestamp, Date.now(), documentId, this.documentId || undefined, userId, this.userId || undefined);
            }
            ;
            /**
            ...
            boolean;
            {
                ...
                }, payload, {}, timestamp, Date.now(), documentId, this.documentId || undefined, userId, this.userId || undefined);
            }
            ;
            /**
                                                        ...
                                                        if (!this.sendMessage(message)) {
                                                            ...
                                                            };
                                                            {
                                                                ...
                                                                this.heartbeatInterval = window.setInterval(() => {
                                                                    this.sendMessage({
                                                                        type: 'ping'
                                                                    }, payload, { timestamp: Date.now() }, timestamp, Date.now());
                                                                });
                                                            }
