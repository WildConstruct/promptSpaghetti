...
endSession: (sessionId) => Promise;
updatePrivacySettings: (request) => Promise;
getPrivacySettings: (projectId) => Promise;
cleanupOldData: (projectId) => Promise;
getResourceAttribution: (projectId, resourceType, resourceId) => Promise;
getAuthorAttribution: (projectId, authorId, dateRange) => Promise;
recordBatchAttributions: (projectId, attributions, batchId) => Promise;
// Utility
clearError: () => void ;
