...
any = [];
{
    ...
    const editorContext = useMemo(() => ({}), nodes, initialNodes, edges, initialEdges, selectedNodeId, isLoading, hasUnsavedChanges, graphStore.hasUnsavedChanges, validationErrors);
}
                                        ...
                                        unregister: (hookId) => {
                                            ...
                                            if (hook) {
                                                ...
                                                getHooks: () => getSortedHooks(),
                                                    getHook;
                                                (hookId) => providerRegistry.get(hookId),
                                                    executeHooks;
                                                async(),
                                                    hookName;
                                                T,
