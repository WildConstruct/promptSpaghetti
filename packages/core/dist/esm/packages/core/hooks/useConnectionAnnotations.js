...
import { AnnotatedEdge, createAnnotatedEdge, updateEdgeLabel, toggleEdgeLabel } from optimizeLabelPositions;
from;
'../components/Annotations/ConnectionAnnotations';
    ...
    dataFlow: {
        ...
        control: {
            ...
            dependency: {
                ...
                const: labelTemplates = { success: 'Success',
                    failure: 'Failure',
                    fallback: 'Fallback',
                    optional: 'Optional',
                    required: 'Required',
