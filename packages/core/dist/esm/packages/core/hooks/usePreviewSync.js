...
GraphChangeAnalysis => {
                    ...
                    if (oldNode && newNode) {
                        ...
                        const performanceMetricsCalc = useMemo(() => {
                            ...
                            return {
                                ...
                                : 0,
                                successRate;
                            data.totalAttempts > 0 ? data.successCount / data.totalAttempts : 1,
                                cacheHitRate;
    ...
    if (enablePerformanceTracking) {
        ...
        performanceMetricsCalc.avgSyncTime,
            lastExecutionCount;
        performanceMetrics.lastExecutionCount + 1,
        ;
    }
    ;
    performanceDataRef.current.successCount++;
