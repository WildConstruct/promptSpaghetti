                    ...
                    if (!userId) {
                        ...
                        Promise;
                        {
                            if (!userId) {
                                ...
                                try {
                                    ...
                                    userId,
                                        ...
                                        { professionalCredentials: { portfolio: portfolioData } },
                                        { requestSource: 'manual_request' };
                                    ;
                                    await loadUserData();
                                    return {
                                ...
                                const getRecommendedVerificationSteps = useCallback(() => {
                                    ...
                                    if (missing.includes('email_verification')) {
                                        ...
                                        'Verify Email Address',
                                            description;
                                        'Confirm your email address to enable account security features',
                                            priority;
                                        'high',
                                            requiredFor;
                                        'Basic verification',
                                ...
                                if (missing.includes('phone_verification')) {
                                    ...
                                    'Verify Phone Number',
                                        description;
                                    'Add two-factor authentication and account recovery options',
                                        priority;
                                    'high',
                                        requiredFor;
                                    'Account security',
                                ...
                                if (missing.includes('professional_credentials')) {
                                    ...
                                    'Add Professional Credentials',
                                        description;
                                    'Showcase your education, certifications, and industry experience',
                                        priority;
                                    'medium',
                                        requiredFor;
                                ...
                                if (missing.includes('portfolio_verification')) {
                                    ...
                                    'Verify Portfolio',
                                        description;
                                    'Link your professional work to build credibility',
                                        priority;
                                    'medium',
                                        requiredFor;
                                    'Creator marketplace',
                                ...
                                if (missing.includes('social_media_verification')) {
                                    ...
                                    'Connect Social Profiles',
                                        description;
                                    'Link your LinkedIn, IMDb, or other professional profiles',
                                        priority;
                                    'low',
                                        requiredFor;
                                    'Community features',
                                ...
                                if (missing.includes('government_id')) {
                                    ...
                                    'Government ID Verification',
                                        description;
                                    'Complete identity verification for premium features',
                                        priority;
                                    'medium',
                                        requiredFor;
                                    'Payment processing',
                            ...
                            return {
                             ...
                             || false,
                                canSellTemplates;
                            (userTrustScore?.tier && ['professional', 'expert'].includes(userTrustScore.tier)) || false,
