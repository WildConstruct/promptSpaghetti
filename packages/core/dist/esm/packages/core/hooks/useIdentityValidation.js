...
import { identityValidationService, IdentityValidationData } from IdentityValidationRequest;
from;
'../auth/IdentityValidation';
 ...
 */
const checkValidationStatus = useCallback((requestId) => { return identityValidationService.getValidationStatus(requestId); }, []);
/**
 * Get validation result
 */
const getValidationResult = useCallback((requestId) => { return identityValidationService.getValidationResult(requestId); }, []);
/**
 ...
 */
const hasVerification = useCallback((type) => { return validationSummary?.completedValidations?.includes(type) || false; }, [validationSummary]);
/**
