...
const getTemplateAnalytics = useCallback((templateId) => {
    return marketplaceMetrics.getTemplateAnalytics(templateId);
}, []);
const getCreatorAnalytics = useCallback((creatorId) => {
...
return {
    ...
    trackCustomEvent: useCallback((), eventType, MarketplaceEventType, properties, (Record) = {}, entityId ?  : string, entityType ?  : 'template' | 'creator' | 'category' | 'collection', value ?  : number)
};
{
