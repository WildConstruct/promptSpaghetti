    ...
    string;
    {
        ...
        string;
        {
            ...
            Promise;
            {
                ...
                timestamp: new Date(),
                    userId;
                evaluationOptions.userId,
                    entityType;
                evaluationOptions.entityType,
                    entityId;
                evaluationOptions.entityId,
                    sessionData;
                {
                ...
                operation: {
                    type: evaluationOptions.operation.type,
                        parameters;
                    evaluationOptions.operation.parameters,
                        riskLevel;
                    evaluationOptions.operation.riskLevel || 'MEDIUM',
                    ;
                }
                contentContext: evaluationOptions.contentContext,
                    additionalContext;
                evaluationOptions.additionalContext || {};
            }
            ;
