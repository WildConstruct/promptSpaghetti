 ...
 */
import { GraphOperation, OperationType, HistoryEntry, GraphSnapshot, UndoResult, RedoResult, NodeAddOperation, NodeDeleteOperation, NodeUpdateOperation, NodeMoveOperation, EdgeAddOperation, EdgeDeleteOperation, VariationAddOperation, VariationDeleteOperation, VariationUpdateOperation } from VariationReorderOperation;
from;
'./types';
/**
        ...
        boolean;
        {
            ...
            HistoryEntry;
            {
                ...
                HistoryEntry | null;
                {
                    ...
                    canCreateInverseOperation(operation, GraphOperation);
                    boolean;
                    { // Some operations cannot be easily reversed
                        ...
                        NodeDeleteOperation;
                        {
                            ...
                            };
                            {
                                ...
                                createNodeUpdateInverse(operation, NodeUpdateOperation);
                                id: string;
                                timestamp: Date;
                                NodeUpdateOperation;
                                {
                                    ...
                                    createNodeMoveInverse(operation, NodeMoveOperation);
                                    id: string;
                                    timestamp: Date;
                                    NodeMoveOperation;
                                    {
                                        ...
                                        createEdgeDeleteInverse(operation, EdgeAddOperation);
                                        id: string;
                                        timestamp: Date;
                                        EdgeDeleteOperation;
                                        {
                                            ...
                                            createEdgeAddInverse(operation, EdgeDeleteOperation);
                                            id: string;
                                            timestamp: Date;
                                            EdgeAddOperation;
                                            {
                                                ...
                                                createVariationDeleteInverse(operation, VariationAddOperation);
                                                id: string;
                                                timestamp: Date;
                                                VariationDeleteOperation;
                                                {
                                                    ...
                                                    createVariationAddInverse(operation, VariationDeleteOperation);
                                                    id: string;
                                                    timestamp: Date;
                                                    VariationAddOperation;
                                                    {
                                                        ...
                                                        createVariationUpdateInverse(operation, VariationUpdateOperation);
                                                        id: string;
                                                        timestamp: Date;
                                                        VariationUpdateOperation;
                                                        {
                                                            ...
                                                            createVariationReorderInverse(operation, VariationReorderOperation);
                                                            id: string;
                                                            timestamp: Date;
