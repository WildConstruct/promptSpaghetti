...
import { GraphOperation, CollaborativeMessage, UserPresence, ConflictResult, MutationEngineConfig } from AnyGraphOperation;
from;
'./types';
...
Promise < void  > { : .ws };
{
    ...
    };
    {
        ...
        };
        {
            ...
            Promise < void  > {
                        ...
                        */
                        ...
                        };
                        {
                            ...
                            try {
                                ...
                                Promise < void  > { : .currentUser || !this.webSocketService.isConnected() };
                                {
                                    return;
                                    this.currentUser = {
                                        ...this.currentUser,
                ...
                setupWebSocketHandlers() {
                    this.webSocketService.on('message', (message) => { }, this.handleRemoteMessage(message));
                },
        ...
        ;
        async;
        handleCursorUpdate(message, CollaborativeMessage);
        Promise < void  > { const: user = this.connectedUsers.get(message.userId),
        ...
        async;
        handleSelectionChange(message, CollaborativeMessage);
        Promise < void  > { const: user = this.connectedUsers.get(message.userId),
        ...
        async;
        handlePresenceUpdate(message, CollaborativeMessage);
        Promise < void  > {
        ...
        };
        {
            ...
            ;
            async;
            checkMutationConflicts(remoteOperation, GraphOperation);
