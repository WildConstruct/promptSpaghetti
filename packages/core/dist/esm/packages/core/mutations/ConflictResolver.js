...
import { GraphOperation, OperationType, ConflictResult, OperationConflict, ConflictType, ConflictResolutionStrategy, ConflictResolutionOption, GraphState } from AnyGraphOperation;
from;
'./types';
/**
...
export class ConflictResolver extends EventEmitter {
    ...
    constructor(config) {
        ...
        */
        ...
        }(operation, GraphOperation, currentState, GraphState);
        ...
        };
        {
            ...
            for (const remoteOp of operations) {
                 ...
                 */
                async;
                resolve(((operation, conflictResult) => {
...
return options;
async;
detectConflict(localOp, GraphOperation);
remoteOp: GraphOperation;
state: GraphState;
Promise < OperationConflict | null > {
                                                        ...
                                                        default:
                                                            ...
                                                            boolean;
                                                            {
                                                                ...
                                                                resolveLastWriterWins((operation, conflictResult) => {
                                                                    ...
                                                                    return operation;
                                                                }, private, async, resolveOperationalTransform((operation, conflictResult) => {
                                                                ...
                                                                }, private, async, resolveMerge((operation, conflictResult) => {
                                                                ...
                                                                }, private, async, mergeNodeUpdates((localOp, remoteOp) => {
