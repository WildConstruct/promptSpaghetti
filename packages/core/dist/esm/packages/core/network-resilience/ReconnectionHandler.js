    ...
    async startReconnection() {
            ...
            this.state === ReconnectionState.BACKING_OFF;
        {
            ...
            if (this.isCircuitBreakerOpen) {
                 ...
                 */
                stopReconnection();
                void { console, : .log('Stopping reconnection process'),
                    this: .clearAllTimers(),
...
handleReconnectionSuccess(duration, number);
void {
...
;
this.setState(ReconnectionState.IDLE);
handleReconnectionFailure(error, Error, duration, number);
void {
...
void { this: .updateFailureStats(0),
...
this.clearAllTimers();
tripCircuitBreaker();
void { console, : .log('Circuit breaker tripped due to consecutive failures'),
