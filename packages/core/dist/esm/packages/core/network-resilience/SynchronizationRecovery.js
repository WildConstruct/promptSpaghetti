        ...
        ConflictInfo;
        {
            ...
            */
            ...
            try {
                ...
                throw error;
                async;
                validateDependencies(operation, DocumentOperation, appliedOperations, DocumentOperation);
                Promise < void  > {
                ...
                };
                {
                    ...
                    for (const depId of operation.dependencies) {
                        ...
                        async;
                        validateOperations(operations, DocumentOperation);
                        Promise < void  > {
                            ...
                            async backupDocumentState(documentId, state) {
                                ...
                                finally // Store in localStorage as fallback
                                 { }
                                ;
                            ...
                            */
                            ...
                            calculateChecksum(state) {
                                ...
                                operations: state.operations.map(op => ({}), id, op.id, type, op.type, targetId, op.targetId, version, op.version);
                            }
                        };
                    }
                    ;
                    ...
                    for (let i = 0; i < str.length; i++) {
                        ...
                        };
                        {
                            ...
                            if (this.config.progressReporting) {
                                ...
                                void { this: .stats.successfulRecoveries++,
                            ...
                            void { this: .stats.failedRecoveries++,
                                this: .stats.lastRecoveryTime = Date.now(),
