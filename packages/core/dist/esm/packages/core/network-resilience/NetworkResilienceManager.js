 ...
 */
async;
initialize(documentId, string, userId, string);
Promise < void  > {
    : .isInitialized
};
{
...
if (this.config.persistence.enabled) {
     ...
     */
    async;
    connect(websocketUrl, string, authToken ?  : string);
    Promise < void  > {
        : .isInitialized
    };
    {
    ...
    try {
        ...
        if (this.config.reconnection) {
             ...
             */
            disconnect(reason, string = 'User requested');
            void {
            ...
            if (this.websocket) {
                ...
                */
                ...
                async;
                forceSync();
                Promise < SyncDelta | null > { : .isInitialized || !this.documentId };
                {
                    ...
                    if (this.syncInProgress) {
                                        ...
                                        try {
                                            ...
                                            this.websocket.onopen = () => {
                                                ...
                                                if (authToken && this.documentId && this.userId) {
                                                    this.websocket?.send(JSON.stringify({}), type, 'auth_request', payload, {
                                                        token: authToken,
                        ...
                        try {
                            ...
                            startReconnection();
                            Promise < void  > {
                                : .isEnabled || this.reconnectionHandler.isReconnecting()
                            };
                            {
                                return;
                                ...
                                Promise < void  > {
                                    : .connectionState.isOnline() || this.syncInProgress
                                };
                                {
                                    return;
                                    ...
                                    for (const operation of batch) {
                                        ...
                                        async;
                                        sendOperationToServer(operation, QueuedOperation);
                                        Promise < void  > { : .websocket || this.websocket.readyState !== WebSocket.OPEN };
                                        {
                                            ...
                                            handleRemoteGraphUpdate(payload, any);
                                            void {
                                                ...
                                                */
                                                startPersistence() { },
                                                : .config.persistence.enabled, return: ,
