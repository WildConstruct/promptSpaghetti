                                    ...
                                    if (this.syncInProgress) {
                                        ...
                                        try {
                                            ...
                                            delta.conflicts.length,
                                                duration;
                                            Date.now() - (this.lastSyncTime - 1000); // Approximate,
                                        }
                                        finally { }
                                        ;
                                        return delta;
                                    ...
                                    try { }
                                        ...
                                        ResilienceMetrics;
                                        {
                                            ...
                                            void {
                                                ...
                                                default: console.log('Unhandled message type:', message.type)
                                            };
                                            try { }
                                            catch (error) {
