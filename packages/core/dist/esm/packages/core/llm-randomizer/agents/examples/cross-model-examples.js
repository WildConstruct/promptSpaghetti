...
;
const claudeRequest = { ...openAIRequest,
    userContext: baseRequest.context };
;
const geminiRequest = { ...openAIRequest,
...
number;
{
    ...
    for (let i = 0; i < graphs.length; i++) {
        ...
        storyGenerator: {
            ...
            20,
                nodeTypes;
            ['WeightedChoice', 'Conditional', 'Sequential', 'Markov', 'Output'],
                specificRequirements;
            [
                ...
                focusAreas;
            ['narrative structure', 'character development', 'plot progression'],
                style;
            'creative',
                domain;
            'creative writing',
        ...
        dataProcessor: {
            ...
            25,
                nodeTypes;
            ['PythonTransform', 'Conditional', 'Sequential', 'WeightedChoice', 'Output'],
                specificRequirements;
            [
                ...
                focusAreas;
            ['data quality', 'analysis accuracy', 'performance optimization'],
                style;
            'logical',
                domain;
            'data science';
