...
export class AnthropicGraphAgent {
    ...
    constructor(config) {
         ...
         */
        async;
        generateGraph(request, ClaudeGenerationRequest);
...
}
{
    ...
    if (reasoningMatch) {
        ...
        if (graphMatch) {
        ...
        else { // Fallback: look for code blocks }
            ...
            if (codeBlockMatch) {
                ...
                if (versionMatch) {
                    ...
                    async;
                    callAnthropic(userPrompt, string, temperature, number);
                    Promise < {
                        success: boolean,
                        content: string,
                        error: string,
...
---END---
                             ...
                             */
                            function: generateGraphWithClaude(((request, config = {}) => {
