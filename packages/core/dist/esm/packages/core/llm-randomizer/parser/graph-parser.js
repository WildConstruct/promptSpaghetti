    ...
    async parse(content) {
        ...
        try {
            ...
            if (this.shouldStopOnErrors(result)) {
                 ...
                 */
                async;
                parseBatch(contents, string);
                Promise < ParserResult > { const: results = await Promise.all(),
                 ...
                 */
                async;
                parseWithProfiling(content, string);
                Promise < ParserResult & {
                    ...
                    > {
                        ...
                        finalizeResult(result, startTime) {
                             ...
                             */
                            generateErrorReport(result, ParserResult);
                            string;
                            {
