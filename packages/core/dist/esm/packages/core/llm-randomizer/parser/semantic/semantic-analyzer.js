                ...
                for (const node of ast.nodes) {
                    if (node.inputs) {
                        for (const inputId of node.inputs) {
                            ...
                            addEdgeToContext(source, string, target, string);
                            void {
                                : .context.edgeMap.has(source)
                            };
                            {
                                ...
                                if (!this.context.reverseEdgeMap.has(target)) {
                                    ...
                                    validateSemantics(ast, GraphAST);
                                    void {
                                        // Validate version
                                        ...
                                        for (const edge of ast.edges) {
                                            ...
                                            };
                                            {
                                                ...
                                                void {
                                                     ...
                                                     * Helper methods
                                                     */
                                                    isValidNodeId(id) { return /^[a-zA-Z0-9_-]+$/.test(id); },
                                                    hasBlockingErrors() {
                                                ...
                                                ;
                                                addWarning(errorCode, string, message, string, nodeId ?  : string);
                                                void { this: .warnings.push({}),
                                                    errorCode,
                                                    message,
                                                    nodeId };
                                                position: {
