...
import { defaultPresets, RandomizerParametersSchema } from './parameter-schema';
                                                ...
                                                ParameterHistory;
                                                {
                                                    ...
                                                    */
                                                    ...
                                                    void {
                                                        ...
                                                        : .history.length > this.options.maxHistorySize };
                                                    {
                                                        ...
                                                        try {
                                                            ...
                                                            if (preset.id && preset.name && preset.parameters) {
                                                                ...
                                                                if (!this.presets.has(preset.id)) {
                                                                    ...
                                                                    preset,
                                                                        isDefault;
                                                                    false, // Imported presets are never default,
                                                                        updatedAt;
