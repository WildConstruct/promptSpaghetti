...
import { RandomizerParameters, ParameterPreset, ValidationResult, ParameterValidator, defaultPresets } from RandomizerParametersSchema;
from;
'./parameter-schema';
...
loadDefaultPresets();
void { for(, preset, of, defaultPresets) {
    ...
    */
    ...
    localStorage, : .setItem(this.options.storageKey, JSON.stringify(data)),
        ...
        * Validate parameters
        */
        validateParameters(parameters, (Partial));
        ValidationResult;
        {
            ...
            */
            getSuggestions(parameters, (Partial));
            {
                ...
                */
                createCompleteParameters(partial, (Partial));
            ...
            */
            ...
            ParameterPreset | undefined;
            {
                ...
                */
                 ...
                 */
                updatePreset(id, string, updates, (Partial));
                boolean;
                {
                 ...
                 */
                findSimilarInHistory(parameters, (Partial));
                ParameterHistory;
                {
