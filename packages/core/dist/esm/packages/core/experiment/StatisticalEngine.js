                                                                ...
                                                                if (result.significant && result.practicallySignificant && isImprovement) {
                                                                    ...
                                                                    if (confidence > maxConfidence) {
                                                                        ...
                                                                        return {
                                                                            ...
                                                                            'Improvements detected but not statistically significant': 'No significant improvements detected',
                                                                        };
                    ...
                    if (primaryMetric) {
                        ...
                        if (winnerDetection.winner) {
                            ...
                            'Statistical Winner Detected',
                                description;
                            `Variant ${winnerDetection.winner} shows significant improvement`;
                        }
                    }
                    severity: 'high',
                        actionable;
                ...
                for (const variant of variants) {
                    if (variant.totalCost && controlVariant.totalCost) {
                        ...
                        if (costIncrease > 0.5) { // 50% cost increase
                            ...
                            type: 'cost_anomaly',
                                title;
                            'High Cost Increase Detected',
                                description;
                            `Variant ${variant.variantId} shows ${(costIncrease * 100).toFixed(1)}% cost increase`;
                        }
                    }
                    severity: 'high',
                        actionable;
                    ...
                    if (variant.averageLatency && controlVariant.averageLatency) {
                        ...
                        if (latencyIncrease > 0.2) { // 20% latency increase
                            ...
                            'Performance Degradation Detected',
                                description;
                            `Variant ${variant.variantId} shows ${(latencyIncrease * 100).toFixed(1)}% latency increase`;
                        }
                    }
                    severity: 'medium',
                        actionable;
                    ...
                    SampleSizeCalculation;
                    {
                        ...
                        number;
                        {
                            ...
                            number;
                            {
                                ...
                                calculateTTestPValue(tStat, number, df, number, twoTailed, boolean);
                                number;
                                {
                                    ...
                                    calculateChiSquarePValue(chiSquare, number, df, number);
                                    number;
                                    {
                                        ...
                                        number;
                                        {
                                            ...
                                            number;
                                            {
                                                ...
                                                return sign * y;
                                                getZStatistic(probability, number);
                                                number;
                                                {
                                                    ...
                                                    if (probability >= 0.80)
                                                        return 1.28;
                                                    return 0;
                                                    getTStatistic(probability, number, df, number);
                                                    number;
                                                    {
                                                        ...
                                                        calculateCohensH(p1, number, p2, number);
                                                        number;
                                                        {
                                                            return 2 * (Math.asin(Math.sqrt(p1)) - Math.asin(Math.sqrt(p2)));
                                                            betaRandom(alpha, number, beta, number);
                                                            number;
                                                            {
                                                                            ...
                                                                            if (v > 0) {
                                                                                ...
                                                                                if (u < 1 - 0.0331 * Math.pow(x, 4) ||
                                                                                    ...
                                                                                    number;
                                                                                    {
                                                                                        ...
                                                                                        betaCredibleInterval(alpha, number, beta, number, probability, number);
                                                                                        [number, number];
                                                                                        {
