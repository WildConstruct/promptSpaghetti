...
import { AssignmentRequest, AssignmentResponse, UserAssignment, Experiment, ExperimentVariant, AllocationError } from AllocationServiceConfig;
from;
'../types/experiment';
                                ...
                                if (variant) {
                                    ...
                                    if (this.isUserExcluded(request.userId, experiment)) {
                                        ...
                                        experimentIds.forEach((experimentId, index) => {
                                            ...
                                            else { // Return control assignment on error
                                        ...
                                        }(request, AssignmentRequest, experiment, Experiment), Promise < AssignmentResponse > {
                                    ...
                                    createSuccessResponse(assignment, UserAssignment);
                                    ...
                                    AssignmentResponse;
                                    {
                                        ...
                                        createControlResponse(experiment, Experiment, reason, string);
                                        AssignmentResponse;
                                        {
                                            const controlVariant = this.getControlVariant(experiment);
                                            return {
                                        ...
                                        ;
                                        getCacheKey(userId, string, experimentId, string);
                                        string;
                                        {
                                            return `ab:assignment:${userId}:${experimentId}`;
                                        }
                                        async;
                                        updateCache(cacheKey, string, assignment, UserAssignment);
                                        Promise < void  > { try: {
