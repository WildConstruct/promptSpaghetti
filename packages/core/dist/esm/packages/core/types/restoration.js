...
export const RestorationAttemptSchema = z.object({ id: z.string().uuid(),
    ...
    errorMessage: z.string().optional() }, metadata, z.record(z.unknown()).default({}), createdAt, z.date(), updatedAt, z.date(), completedAt, z.date().optional());
;
...
export const RestorationPreviewSessionSchema = z.object({ id: z.string().uuid(),
    ...
    previewData: z.record(z.unknown()) }, conflictSummary, z.record(z.unknown()).default({}), expiresAt, z.date(), createdAt, z.date());
;
// Bookmark types
...
;
// Validation helpers
export const validateRestorationConfig = (config) => { return RestorationConfigSchema.parse(config); };
export const validateRestorationAttempt = (attempt) => { return RestorationAttemptSchema.parse(attempt); };
export const validateConflictResolution = (resolution) => { return ConflictResolutionRequestSchema.parse(resolution); };
// Constants
