...
([]);
sharesOverTime: z.array(z.object({}), timestamp, z.date(), value, z.number());
([]);
engagementOverTime: z.array(z.object({}), timestamp, z.date(), value, z.number());
([]);
({});
;
...
export const validateCreateShareRequest = (data) => { return CreateShareRequestSchema.parse(data); };
export const validateShareConfig = (data) => { return ShareConfigSchema.parse(data); };
export const validateShareAnalyticsEvent = (data) => { return ShareAnalyticsEventSchema.parse(data); };
...
export { ShareableResourceTypeSchema, ShareTargetSchema, ShareFormatSchema };
