...
deselectNote: (id) => void ;
clearSelection: () => void ;
startEditing: (id) => void ;
stopEditing: () => void ;
// Content editing
updateContent: (id, content) => void ;
updateAppearance: (id, appearance) => void ;
// Grouping
createGroup: (noteIds, name) => string;
addToGroup: (groupId, noteId) => void ;
removeFromGroup: (groupId, noteId) => void ;
...
lockNote: (id) => void ;
unlockNote: (id) => void ;
addComment: (noteId, comment) => void ;
resolveComment: (noteId, commentId) => void ;
// Settings
