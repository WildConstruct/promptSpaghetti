 ...
 */
import { z } from 'zod';
import { ResourceTypeSchema, ChangeTypeSchema, AuthorTypeSchema, ChangeAttributionSchema } from AttributionFilterSchema;
from;
'./attribution';
// =============================================================================
...
export const CreateAttributionClaimRequestSchema = z.object({ templateId: z.string().uuid(),
    ...
    evidenceUrls: z.array(z.string().url()).default([]) }, metadata, z.record(z.unknown()).default({}));
;
...
// Validation Helpers
// =============================================================================
export const validateCreateTemplateAttributionRequest = (request) => { return CreateTemplateAttributionRequestSchema.parse(request); };
export const validateCreateAttributionClaimRequest = (request) => { return CreateAttributionClaimRequestSchema.parse(request); };
export const validateUpdateRevenueAttributionRequest = (request) => { return UpdateRevenueAttributionRequestSchema.parse(request); };
export const validateMarketplaceAttributionFilter = (filter) => { return MarketplaceAttributionFilterSchema.parse(filter); };
