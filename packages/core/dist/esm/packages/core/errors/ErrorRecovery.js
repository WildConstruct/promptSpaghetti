                        ...
                        for (const { operation, name, priority } of sortedOps) {
                            ...
                            if (hasCriticalFailure && priority === 'optional') {
                                ...
                                try {
                                    ...
                                    context: string;
                                    recoveryFn ?  : () => Promise;
                                    Promise < T > { const: timeoutPromise = new Promise((_, reject) => {
                                            setTimeout(() => {
                                                reject(ErrorFactory.createAPIError(), 408);
                                ...
                                try {
                                    ...
                                    withCleanup();
                                    operation: () => Promise;
                                    resourceAcquirer: () => (Promise) | R;
                                    resourceReleaser: (resource) => (Promise) | void context;
                                    string;
                                    Promise < T > {
                                        ...
                                        try: {
                                            ...
                                            return: await operation()
                                        }, catch(error) { throw ErrorFactory.wrapUnknownError(error, context); }, finally: { if(resource) { } } !== undefined
                                    };
                                    {
                                        try {
                                        ...
                                        delay(ms, number);
                                        Promise < void  > { return: new Promise(resolve => setTimeout(resolve, ms)) }(name, string, options, CircuitBreakerOptions);
                                        CircuitBreakerState;
                                        {
