...
(function (ErrorCode) {
    ...
    ErrorCode[ErrorCode["export"] = void 0] = "export";
    ErrorCode[ErrorCode["enum"] = void 0] = "enum";
    ErrorCode[ErrorCode["ErrorSeverity"] = void 0] = "ErrorSeverity";
})(ErrorCode || (ErrorCode = {}));
{
    LOW = 'low',
        MEDIUM = 'medium',
        ...
        constructor(message, string, context ?  : Partial);
        {
                ...
                };
            {
                constructor(message, string, context ?  : Partial);
                {
                    ...
                    {
                        constructor(message, string, mfaType ?  : string, context ?  : Partial);
                        {
                            super();
                            message,
                                ErrorCode.MFA_ERROR,
                                ...
                                { ...context, metadata: { mfaType } },
                                {
                                     ...
                                     */
                                    class: ProjectLockedError, extends: BaseError
                                };
                            {
                                constructor(projectId ?  : string, context ?  : Partial);
                                {
                                    super();
                                    'Project is locked and cannot be modified',
                                        ...
                                        { ...context, metadata: { projectId } },
                                        {
                                             ...
                                             */
                                            class: WorkflowStateError, extends: BaseError
                                        };
                                    {
                                        constructor(message, string, context ?  : Partial);
                                        {
