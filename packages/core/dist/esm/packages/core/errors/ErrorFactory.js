...
DatabaseConnectionError;
{
    ...
    createConnectionFactoryError((), message, string = 'No connection factory set', options, ErrorFactoryOptions = {});
    ConnectionFactoryError;
    {
        ...
        createAuthenticationError((), message, string, options, ErrorFactoryOptions = {});
        AuthenticationError;
        {
            ...
            MFAError;
            {
                ...
                createMFAVerificationError((), type, 'expired' | 'invalid_code' | 'too_many_attempts' | 'method_not_active' | 'rate_limit', options, ErrorFactoryOptions = {});
                MFAError;
                {
                    const messages = {
        ...
        ValidationError;
        {
            ...
            createEntropyError((), codeType, string, options, ErrorFactoryOptions = {});
            ValidationError;
            {
