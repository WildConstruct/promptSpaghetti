        ...
        string;
        {
                    ...
                    if (comp.startsWith('~')) {
                        ...
                        };
                        {
                            ...
                            return {
                                ...
                                instance: ExtensionVersionManager,
                                versionCache: (Map) = new Map(),
                                compatibilityCache: (Map) = new Map(),
                                constructor() { },
                                static getInstance() {
            ...
            }
            {
                ...
                if (!systemCheck.compatible) {
                    ...
                    'error',
                        message;
                    systemCheck.message || 'System version incompatible',
                        currentVersion;
                    systemVersion,
                        requiredVersion;
                    extension.dependencies?.system || '1.0.0',
                    ;
                }
                ;
