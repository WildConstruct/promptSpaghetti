...
try {
    ...
    async;
    parseManifestFromFile(filePath, string);
    Promise < ParseResult < ExtensionManifest >> { try: {
            : .cache.has(filePath)
        } };
    {
        return {
    ...
    try { }
        ...
        validateDependencies(manifest, ExtensionManifest);
        ...
        ExtensionValidationResult;
        {
             ...
             * Validate manifest security settings
             */
            private, validateSecurity(manifest, ExtensionManifest), ExtensionValidationResult, {
                const: errors, string = [],
