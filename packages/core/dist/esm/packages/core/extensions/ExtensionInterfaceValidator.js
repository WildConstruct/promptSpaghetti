            ...
            ExtensionValidationResult;
            {
                ...
                for (const [methodName, signature] of Object.entries(expectedSignatures)) {
                    ...
                    if (signature.returnType) {
                        ...
                        validateExtensionConfiguration(extension, any);
                                                ...
                                                if (!extension.dependencies || extension.dependencies.length === 0) {
                                                    ...
                                                    for (const dependency of extension.dependencies) {
                                                        ...
                                                        if (dependencyVersion && extensionVersion) {
                                                            ...
                                                            validateExtensionPermissions((), extension, any, grantedPermissions, string);
                                                            ExtensionValidationResult;
                                                            {
                                                                const errors = [];
                                                                const warnings = [];
                                                                if (!extension.permissions || extension.permissions.length === 0) {
                                                                    ...
                                                                    for (const permission of extension.permissions) {
                                                                        ...
                                                                        generateValidationReport(extension, any);
                                                                        ExtensionValidationReport;
                                                                        {
                                                                            ...
                                                                            const validations = [];
                                                                            {
                                                                                name: 'Type Validation', result;
                                                                                extensionTypeChecker.validateExtensionType(extension);
                                                                            }
                                                                            {
                                                                                name: 'Interface Validation', result;
                                                                                this.validateInterfaceCompatibility(extension, 'BaseExtension');
                                                                            }
                                                                            {
                                                                                name: 'Configuration Validation', result;
                                                                                this.validateExtensionConfiguration(extension);
                                                                            }
                                                                            {
                                                                                name: 'Method Signatures', result;
                                                                                this.validateMethodSignatures(extension, this.getBaseMethodSignatures());
                                                                            }
                                                                            ;
                                                                            ...
                                                                            if (!validation.result.valid) {
                                                                                ...
                                                                                };
                                                                                {
                                                                                    ...
                                                                                    RuntimeTypeInfo;
                                                                                    {
                                                                                        ...
                                                                                        validateMethod(obj, any, methodName, string, expectedSignature, MethodSignature);
                                                                                        boolean;
                                                                                        {
                                                                                            ...
                                                                                            if (typeof method !== 'function') {
                                                                                                ...
                                                                                                if (expectedSignature.parameterCount !== undefined && method.length !== expectedSignature.parameterCount) {
                                                                                                    ...
                                                                                                    if (expectedSignature.async !== undefined && this.isAsyncFunction(method) !== expectedSignature.async) {
                                                                                                        return false;
                                                                                                        return true;
                                                                                                        createTypeGuard(interfaceName, string);
                                                                                                        (obj) => obj;
                                                                                                        is;
                                                                                                        T;
                                                                                                        {
                                                                                                            ...
                                                                                                            performInterfaceCheck(obj, any, interfaceName, string);
                                                                                                            boolean;
                                                                                                            {
