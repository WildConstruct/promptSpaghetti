...
export class ExtensionPointRegistry {
     ...
     * Get extension point by ID
     */
    get(id) { return this.extensionPoints.get(id); }
    /**
     * Get all extension points
     */
    getAll() { return Array.from(this.extensionPoints.values()); }
    /**
     ...
     */
    getByPriority(priority) { return this.getAll().filter(ep => ep.priority === priority); }
    /**
     * Get extension points by lifecycle status
     */
    getByLifecycle(lifecycle) { return this.getAll().filter(ep => ep.lifecycle === lifecycle); }
    /**
    ...
    Object;
    values(ExtensionPointPriority) { }
    Object;
    values(ExtensionPointLifecycle) { }
}
// Count
