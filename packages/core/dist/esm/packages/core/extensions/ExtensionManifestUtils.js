    ...
    capabilities;
{
    provides: packageJson.capabilities?.provides || [],
        requires;
    packageJson.capabilities?.requires || [],
        optional;
    packageJson.capabilities?.optional || [];
}
metadata: {
    ...
    packageJson.homepage,
        bugs;
    packageJson.bugs?.url || packageJson.bugs,
        keywords;
...
if (packageJson.ui) {
    ...
    if (packageJson.runtime) {
        ...
        if (packageJson.security) {
            ...
            return manifest;
            convertManifestToPackageJson(manifest, ExtensionManifest);
            any;
            {
                const packageJson = {
                    name: manifest.id,
        ...
        manifest.metadata?.categories || [],
            platforms;
        manifest.compatibility?.platforms || ['web'];
    }
    ;
    // Add optional fields
                ...
                if (manifest.ui) {
                    ...
                    if (manifest.runtime) {
                        ...
                        if (manifest.security) {
                            ...
                            return packageJson;
                            mergeManifests(base, ExtensionManifest, override, (Partial));
                            ExtensionManifest;
                            {
                                ...
                                if (override.author) {
                                    ...
                                    if (override.dependencies) {
                                        ...
                                        ;
                                        return merged;
                                        validateManifestDependencies(manifest, ExtensionManifest);
                                        {
                                            valid: boolean;
                                            errors: string;
                                            warnings: string;
                                                    ...
                                                    if (manifest.dependencies.extensions) {
                                                        for (const [depId, versionRange] of Object.entries(manifest.dependencies.extensions)) {
                                                            ...
                                                            if (manifest.dependencies.npm) {
                                                                ...
                                                                ;
                                                                getManifestSize(manifest, ExtensionManifest);
                                                                ManifestSizeInfo;
                                                                {
                                                                ...
                                                                ;
                                                                extractMetadata(manifest, ExtensionManifest);
                                                                ManifestMetadata;
                                                                {
                                                                    return {
                                                                        id: manifest.id,
                                                                ...
                                                                ;
                                                                compareManifests(manifest1, ExtensionManifest, manifest2, ExtensionManifest);
                                                                ManifestComparison;
                                                                {
                                                                    const comparison = {
                                                                        identical: false,
                                                        ...
                                                        ;
                                                        return comparison;
                                                        generateManifestDiff(oldManifest, ExtensionManifest, newManifest, ExtensionManifest);
                                                        string;
                                                        {
