...
export class ExtensionPointVisualizer {
     ...
     * Generate extension point relationship map
     */
    generateRelationshipMap(options = {}) {
...
return mermaid;
generateHierarchy(options, VisualizationOptions = {});
string;
{
    const registry = extensionPointRegistry;
    let mermaid = 'graph TD\n';
...
mermaid += this.generateMermaidStyling(options);
return mermaid;
generateArchitectureOverview(options, VisualizationOptions = {});
string;
{
    ...
    mermaid += this.generateMermaidStyling(options);
    return mermaid;
    buildGraph(options, VisualizationOptions);
    ExtensionPointGraph;
    {
        const registry = extensionPointRegistry;
        const extensionPoints = registry.getAll();
...
generateMermaid(graph, ExtensionPointGraph, options, VisualizationOptions);
string;
{
    let mermaid = 'graph TD\n';
    if (options.groupByCategory) {
...
mermaid += this.generateMermaidStyling(options);
return mermaid;
generateGraphviz(graph, ExtensionPointGraph, options, VisualizationOptions);
string;
{
...
dot += '}\n';
return dot;
generateJSON(graph, ExtensionPointGraph, options, VisualizationOptions);
string;
{
    const visualization = {
        version: '1.0.0',
