                                                ...
                                                }
                                                {
                                                    ...
                                                    for (const depId of deps) {
                                                        ...
                                                        Promise < PrerequisiteResult > {
                                                            ...
                                                            try: { const: result = await check.check() }, catch(error) {
                                                                        ...
                                                                        if (criticalFailures > 0) {
                                                                            ...
                                                                            if (failedChecks > totalChecks * 0.5) {
                                                                                ...
                                                                                if (this.config.autoFixEnabled && failedChecks > 0) {
                                                                                    ...
                                                                                    async;
                                                                                    checkEpic11Auth();
                                                                                    Promise < PrerequisiteResult > { try: {
                                                                                    ...
                                                                                    Promise < boolean > { return: false, // Manual setup required
                                                                                    ...
                                                                                    Promise < PrerequisiteResult > { try: {
                                                                                        ...
                                                                                        'Elasticsearch cluster is unhealthy': timestamp, new: Date(),
