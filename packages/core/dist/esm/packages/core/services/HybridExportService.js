...
{
    async;
    extractMARSTags(prompt, string, variables, (Record));
    Promise < MARSFrameworkTags > {
        ...
        inferDepthOfField(prompt, variables) {
            ...
            // Additional extraction methods would continue here...
        } // Default shallow DOF for cinematic look
        // Additional extraction methods would continue here...
        , // Default shallow DOF for cinematic look
        // Additional extraction methods would continue here...
        ...
        } // Default background blur for cinematic look
        , // Default background blur for cinematic look
        ...
        class: ZadaNaturalLanguageGenerator };
    {
        ...
        'storyboard',
            content;
        this.convertToStoryboardStyle(prompt, variables),
            accessibility_level;
        'cinematographer',
    ...
    'shot_list',
        content;
    this.convertToShotListStyle(prompt, variables),
        accessibility_level;
    'general_crew',
        human_readable_score;
    7,
...
'director_note',
    content;
this.convertToDirectorNotes(prompt, variables),
    accessibility_level;
'director',
    human_readable_score;
10,
