...
export class Epic16HelpIntegrationArchitecture {
    ...
    constructor(graphHelpManager) {
        ...
        */
        async;
        getIntegratedHelpContent((context, userProfile) => {
            const helpContent = [];
...
(context, userProfile) => {
    ...
    if (userProfile.level === 'beginner' && context.isFirstVisit) {
        ...
        if (onboardingContent) {
            ...
            async;
            getTransitionHelpContent((transitionContext, userProfile) => {
                ...
                if (content) {
                    ...
                    HelpContent;
                    {
                        ...
                        boolean;
                        {
                            ...
                            }), private, generateEscalationDescription(session, HelpSession), additionalContext ?  : Record);
                            string;
                            {
                                return `
