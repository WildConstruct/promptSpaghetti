...
if (policy.requirements.approvalWorkflow && !this.hasPreapproval(request)) {
     ...
     * Check if user has required authentication level
     */
    private, hasRequiredAuthentication(profile, UserAccessProfile, requirements, AccessRequirements), boolean, {
        const: authLevels
    }, {
        STANDARD: 1,
        MFA: 2,
                    ...
                    async updateUserClearance(userId, clearanceLevel) {
                        ...
                        if (!profile) {
                            ...
                            AccessControlPolicy | undefined;
                            {
                                 ...
                                 */
                                async;
                                updateAccessPolicy(((classification, updates) => {
                                     ...
                                     */
                                    getAuditEvents(userId ?  : string, dataId ?  : string);
                                 ...
                                 */
                                async;
                                validateAccessConditions(conditions, AccessCondition, context, OperationContext);
