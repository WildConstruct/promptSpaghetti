...
(function (LearningCategory) {
    ...
    LearningCategory[LearningCategory["export"] = void 0] = "export";
    LearningCategory[LearningCategory["enum"] = void 0] = "enum";
    LearningCategory[LearningCategory["DifficultyLevel"] = void 0] = "DifficultyLevel";
})(LearningCategory || (LearningCategory = {}));
{
    ...
    (function (TargetAudience) {
        ...
        TargetAudience[TargetAudience["export"] = void 0] = "export";
        TargetAudience[TargetAudience["enum"] = void 0] = "enum";
        TargetAudience[TargetAudience["ContentStatus"] = void 0] = "ContentStatus";
    })(TargetAudience || (TargetAudience = {}));
    {
        ...
        (function (ModuleType) {
            ...
            ModuleType[ModuleType["export"] = void 0] = "export";
            ModuleType[ModuleType["interface"] = void 0] = "interface";
            ModuleType[ModuleType["ModuleContent"] = void 0] = "ModuleContent";
        ...
        (function (ContentType) {
            ...
            ContentType[ContentType["ContentMetadata"] = void 0] = "ContentMetadata";
        ...
        (function (ActivityType) {
            ...
            ActivityType[ActivityType["interface"] = void 0] = "interface";
            ActivityType[ActivityType["ActivityConfig"] = void 0] = "ActivityConfig";
        ...
        (function (QuestionType) {
            ...
            QuestionType[QuestionType["export"] = void 0] = "export";
            QuestionType[QuestionType["interface"] = void 0] = "interface";
            QuestionType[QuestionType["QuestionOption"] = void 0] = "QuestionOption";
        ...
        (function (BloomLevel) {
            ...
            BloomLevel[BloomLevel["export"] = void 0] = "export";
            BloomLevel[BloomLevel["interface"] = void 0] = "interface";
            BloomLevel[BloomLevel["LearningResource"] = void 0] = "LearningResource";
        ...
        (function (ResourceType) {
            ...
            ResourceType[ResourceType["Assessment"] = void 0] = "Assessment";
        ...
        (function (AssessmentType) {
            ...
            AssessmentType[AssessmentType["export"] = void 0] = "export";
            AssessmentType[AssessmentType["interface"] = void 0] = "interface";
            AssessmentType[AssessmentType["AssessmentItem"] = void 0] = "AssessmentItem";
        ...
        (function (SkillCategory) {
            ...
            SkillCategory[SkillCategory["export"] = void 0] = "export";
            SkillCategory[SkillCategory["enum"] = void 0] = "enum";
            SkillCategory[SkillCategory["SkillLevel"] = void 0] = "SkillLevel";
        })(SkillCategory || (SkillCategory = {}));
        {
            ...
            (function (InteractiveType) {
                ...
                InteractiveType[InteractiveType["export"] = void 0] = "export";
                InteractiveType[InteractiveType["interface"] = void 0] = "interface";
                InteractiveType[InteractiveType["InteractiveConfig"] = void 0] = "InteractiveConfig";
            ...
            (function (BadgeRarity) {
                ...
                BadgeRarity[BadgeRarity["export"] = void 0] = "export";
                BadgeRarity[BadgeRarity["interface"] = void 0] = "interface";
                BadgeRarity[BadgeRarity["BadgeCriteria"] = void 0] = "BadgeCriteria";
            ...
            export let AchievementCategory;
            (function (AchievementCategory) {
                ...
                AchievementCategory[AchievementCategory["export"] = void 0] = "export";
                AchievementCategory[AchievementCategory["interface"] = void 0] = "interface";
                AchievementCategory[AchievementCategory["AchievementCriteria"] = void 0] = "AchievementCriteria";
            ...
            (function (ChallengeType) {
                ...
                ChallengeType[ChallengeType["export"] = void 0] = "export";
                ChallengeType[ChallengeType["interface"] = void 0] = "interface";
                ChallengeType[ChallengeType["ChallengeReward"] = void 0] = "ChallengeReward";
            ...
            (function (EnrollmentStatus) {
                ...
                EnrollmentStatus[EnrollmentStatus["export"] = void 0] = "export";
                EnrollmentStatus[EnrollmentStatus["interface"] = void 0] = "interface";
                EnrollmentStatus[EnrollmentStatus["UserProgress"] = void 0] = "UserProgress";
            ...
            (function (NotificationType) {
                ...
                NotificationType[NotificationType["LearningPreferences"] = void 0] = "LearningPreferences";
            ...
            (function (LearningStyle) {
                ...
                LearningStyle[LearningStyle["export"] = void 0] = "export";
                LearningStyle[LearningStyle["interface"] = void 0] = "interface";
                LearningStyle[LearningStyle["StudyTimePreference"] = void 0] = "StudyTimePreference";
            })(LearningStyle || (LearningStyle = {}));
            {
                day: string;
                startTime: string;
            ...
            export class Epic16LearningPathService extends EventEmitter {
                ...
                constructor() {
                     ...
                     */
                    async;
                    createLearningPath(pathData, (Omit));
                                        ...
                                        if (filters.difficulty) {
                                            ...
                                            if (filters.audience) {
                                                ...
                                                if (filters.certification) {
                                                     ...
                                                     */
                                                    async;
                                                    getAnalytics(pathId ?  : string, userId ?  : string);
                                                    Promise < any > {
                                                        if(pathId) { }
                                                    } && userId;
                                                    {
