...
async;
deleteContent(contentId, string, deletedBy, string);
Promise < boolean > { const: content = this.content.get(contentId),
                        ...
                        if (filter.types?.length) {
                            ...
                            if (filter.statuses?.length) {
                                ...
                                if (filter.categories?.length) {
                                        ...
                                        if (filter.authors?.length) {
                                            ...
                                            if (filter.searchQuery) {
                                                ...
                                                if (filter.hasSchedule !== undefined) {
                                                    ...
                                                    map(([dateStr, items]) => ({}), date, new Date(dateStr), count, items.length);
                                                }
                                                items;
                                            }
                                    ...
                                    getBatches(status ?  : ScheduleBatch['status']);
                                    ScheduleBatch;
                                    {
                                        ...
                                        if (status) {
                                            ...
                                            */
                                            ...
                                            };
                                            {
                                                ...
                                                void { const: delay = batch.schedule.executeAt.getTime() - Date.now(),
                                                    if(delay) { } } > 0;
                                                {
                                                    setTimeout(() => {
                                                        this.executeBatch(batch.id);
