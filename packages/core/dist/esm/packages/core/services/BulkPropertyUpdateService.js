...
export class BulkPropertyUpdateService {
    ...
    static getInstance() {
        if (!BulkPropertyUpdateService.instance) {
            ...
            */
            registerEntityProvider(targetType, TargetType, provider, EntityProvider);
            void {
                ...
                createdBy: string, Promise() {
                    ...
                    return operation;
                    async;
                    validateOperation(operationId, string);
                    Promise < ValidationResult > {
                        ...
                        try: {
                            ...
                            for(, target, of, operation) { }, : .targets
                        }
                    };
                    {
                        ...
                        try { }
                            ...
                            throw error;
                            async;
                            executeOperation(operationId, string);
                            Promise < boolean > {
                                const: operation = this.operations.get(operationId),
                                if(, operation) {
                                    throw new Error(`Operation ${operationId} not found`);
                                        ...
                                        try {
                                            ...
                                            for (const result of successfulResults) {
                                                if (result.backup) {
                                                     ...
                                                     * Data Retrieval
                                                     */
                                                    getOperations(filter ?  : BulkUpdateFilter);
                                                    BulkUpdateOperation;
                                                    {
                                                                ...
                                                                if (filter.createdBy?.length) {
                                                                    ...
                                                                    if (filter.searchQuery) {
                                                                        ...
                                                                        if (filter.hasErrors !== undefined) {
                                                                            ...
                                                                            getTemplates(targetType ?  : TargetType);
                                                                            BulkUpdateTemplate;
                                                                            {
                ...
                const: successRateByType, Record() { total: number; successful: number; rate: number; } } > ;
            { }
            as;
            any;
...
return {
    ...
    subscribe(listenerId, callback) {
        ...
        }(target, BulkUpdateTarget, operation, BulkUpdateOperation);
    ...
    switch (transformation.type) {
        ...
        default:
            ...
            Promise < TargetValidationResult > {
                ...
                try: {
                    ...
                    if(, provider) {
                        ...
                        type: 'not_found',
                            message;
                        `No entity provider registered for type: ${target.type}`;
                    }
                },
                return: result,
            ...
            if (validation.constraints) {
                ...
                ;
                return result;
                validatePropertyConstraint(entity, (Record));
                ...
                T[];
                {
                    ...
                    for (let i = 0; i < array.length; i += size) {
                        ...
                        any,
                            createdBy;
                        string;
                        bulkPropertyUpdateService.createOperation(name, targets, updates, options, createdBy);
