from;
'../../../server/src/services/security/SecurityDashboardPolicies';
from;
'../../../server/src/services/trust/AutomatedEnforcementService';
...
(function (PolicyDomain) {
    ...
    PolicyDomain[PolicyDomain["export"] = void 0] = "export";
    PolicyDomain[PolicyDomain["enum"] = void 0] = "enum";
    PolicyDomain[PolicyDomain["PolicyType"] = void 0] = "PolicyType";
})(PolicyDomain || (PolicyDomain = {}));
{
    ...
    (function (PolicyStatus) {
        ...
        PolicyStatus[PolicyStatus["export"] = void 0] = "export";
        PolicyStatus[PolicyStatus["enum"] = void 0] = "enum";
        PolicyStatus[PolicyStatus["ComplianceFramework"] = void 0] = "ComplianceFramework";
 ...
 */
async;
deletePolicy(policyId, string, deletedBy, string);
Promise < void  > {
 ...
 */
async;
evaluatePolicies(context, PolicyEvaluationContext);
...
// VFX and Content-Specific Policy Logic
// =============================================================================
private, async, evaluateRuleContext(((context, evaluationContext) => {
    const results = {};
...
}), private, async, evaluateTimeBasedRule(((rule, context) => {
...
}), private, async, evaluateLocationBasedRule(((rule, context) => {
    const contentContext = context.contentContext;
    ...
    if (rule.culturalConsiderations.length > 0) {
        ...
        private, initializeDefaultPolicies(), void {
            ...
            timeBasedRules: [{},
                ...
                seasonality, false,
                historicalContext, true] }, contentBasedRules, [{},
                ...
                */
                ...
                UnifiedPolicy | null;
                {
                    ...
                    */
                    ...
                    async;
                    validatePolicy(policy, UnifiedPolicy);
                    Promise < { valid: boolean, errors: string } > { const: errors, string = [],
                        if(, policy) { }, : .name || policy.name.trim() === '' };
                    {
                        ...
                        ;
                        findPoliciesDependingOn(policyId, string);
                        UnifiedPolicy;
                        {
                            return Array.from(this.policies.values()).filter(policy => );
                            policy.dependencies?.requiredPolicies?.includes(policyId);
                            ;
                            getApplicablePolicies(context, PolicyEvaluationContext);
                            UnifiedPolicy;
                            {
                                return Array.from(this.policies.values()).filter(policy => );
                                ...
                                ;
                                isPolicyApplicable(policy, UnifiedPolicy, context, PolicyEvaluationContext);
                                boolean;
                                {
                                    // Check scope filters
                                    if (policy.scope.contentTypes && context.contentContext) {
                                        ...
                                        async;
                                        evaluateExceptions(((policy) => ));
                                    }
                                    context: PolicyEvaluationContext;
                                    Promise < Array < { exceptionId: string, exceptionName: string, scope: string } >> { return: [] }((policy) => );
                                }
                                context: PolicyEvaluationContext;
                                Promise < Array < { conditionId: string, conditionName: string, result: 'MET' | 'NOT_MET' | 'ERROR', details: any } >> { return: [],
                                    ruleResults: any };
                                ...
                                }
                                {
                                    ...
                                    if (failedRules > 0) {
                                        ...
                                        Promise < any > {
                                            ...
                                            shouldRequireReview(policy, result) { return policy.enforcement.reviewRequired || result.result === 'DENY'; },
                                        ...
                                        async;
                                        recordViolation(policy, UnifiedPolicy);
                                        result: PolicyEvaluationResult;
                                        context: PolicyEvaluationContext;
                                        Promise < void  > {
