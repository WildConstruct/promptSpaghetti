...
})(KnowledgeCategory || (KnowledgeCategory = {}));
{
    ...
    (function (SectionType) {
        ...
        SectionType[SectionType["export"] = void 0] = "export";
        SectionType[SectionType["interface"] = void 0] = "interface";
        SectionType[SectionType["ArticleAttachment"] = void 0] = "ArticleAttachment";
...
(function (AccessibilityType) {
    ...
    AccessibilityType["TRANSCRIPT"] = "transcript";
    AccessibilityType[AccessibilityType["export"] = void 0] = "export";
    AccessibilityType[AccessibilityType["interface"] = void 0] = "interface";
    AccessibilityType[AccessibilityType["InteractiveKBElement"] = void 0] = "InteractiveKBElement";
...
(function (SuggestionType) {
    ...
    SuggestionType["POPULAR_SEARCH"] = "popular_search";
    // AI and recommendation interfaces
    SuggestionType[SuggestionType["export"] = void 0] = "export";
    SuggestionType[SuggestionType["interface"] = void 0] = "interface";
    SuggestionType[SuggestionType["AIRecommendation"] = void 0] = "AIRecommendation";
...
(function (RecommendationReason) {
    ...
    RecommendationReason["PERSONALIZED"] = "personalized";
    RecommendationReason[RecommendationReason["export"] = void 0] = "export";
    RecommendationReason[RecommendationReason["interface"] = void 0] = "interface";
    RecommendationReason[RecommendationReason["RecommendationContext"] = void 0] = "RecommendationContext";
...
export var PersonalizationType;
(function (PersonalizationType) {
    ...
    PersonalizationType["TIME_OF_DAY"] = "time_of_day";
    // Knowledge base management interfaces
    PersonalizationType[PersonalizationType["export"] = void 0] = "export";
    PersonalizationType[PersonalizationType["interface"] = void 0] = "interface";
    PersonalizationType[PersonalizationType["KnowledgeBaseConfig"] = void 0] = "KnowledgeBaseConfig";
            ...
            if (userId) {
                ...
                Promise < KnowledgeBaseSearch > {
                    ...
                    if(userId) {
                        ...
                        return searchResult;
                        async;
                        getPopularArticles(category ?  : KnowledgeCategory, limit = 10);
                        Promise < KnowledgeBaseArticle > {
                                    ...
                                    for(, article, of, articles) {
                                        ...
                                        if (score >= this.config.aiConfig.confidenceThreshold) {
                                            ...
                                            articleId: article.id,
                                                score,
                                                reason;
                                            this.determineRecommendationReason(article, context),
                                                context,
                                                personalizedFactors;
                                            this.getPersonalizationFactors(context),
                                            ;
                                        }
                                        ;
                                        ...
                                        for (const [articleId, terms] of this.searchIndex.entries()) {
                                            ...
                                            if (score > 0) {
                                                ...
                                                article,
                                                    score,
                                                    matchedSections;
                                                this.findMatchedSections(queryTerms, article),
                                                    highlightedContent;
                                                this.generateHighlightedContent(queryTerms, article),
                                                    relevanceReason;
                                                this.generateRelevanceReasons(queryTerms, article),
                                                ;
                                            }
                                            ;
                                    ...
                                    async generateSearchSuggestions(query) {
                                        ...
                                        for (const completion of completions) {
                                            if (completion.startsWith(query.toLowerCase())) {
                                                ...
                                                text: completion,
                                                    type;
                                                SuggestionType.QUERY_COMPLETION,
                                                    score;
                                                0.8,
                                                ;
                                            }
