        ...
        Promise < NavigationPreferences > {
            ...
            async toggleFavorite(userId, itemId) {
                ...
                if (isFavorite) {
                     ...
                     */
                    async;
                    togglePin(userId, string, itemId, string);
                    Promise < boolean > {
                        const: prefs = await this.getUserPreferences(userId),
                        ...
                        if(isPinned) {
                             ...
                             */
                            async toggleSectionExpansion(userId, sectionId) {
                                const prefs = await this.getUserPreferences(userId);
                                ...
                                if (isExpanded) {
                                     ...
                                     */
                                    async;
                                    searchNavigation(options, NavigationSearchOptions);
                                                        ...
                                                        if (item.label.toLowerCase() === searchTerm) {
                                                            ...
                                                            if (!categories || categories.includes(item.category)) {
                                                                ...
                                                                item,
                                                                    ...
                                                                    matchType,
                                                                    highlightedText;
                                                                this.highlightMatch(item.label, searchTerm),
                                                                ;
                                                            }
                                                            ;
                                                            // Sort by score
