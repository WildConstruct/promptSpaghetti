            ...
            Promise < ActivityEvent > {
                ...
                context: {
                    ...
                    Promise() {
                        ...
                        'graph_editing',
                            action,
                            title;
                        this.generateGraphOperationTitle(action, details),
                            description;
                        this.generateGraphOperationDescription(action, details),
                            details,
                            userId,
                            impact;
                        this.calculateGraphOperationImpact(details),
                            tags;
                        this.generateGraphOperationTags(action, details),
                        ;
                    },
                    ...context
                },
                ...
                Promise() {
                    ...
                    type: 'user_interaction',
                        category;
                    this.categorizeUserInteraction(action),
                        action,
                        title;
                    `${action} ${element}`;
                }
...
userId: userId || 'system',
    impact;
this.calculatePerformanceImpact(duration, success),
    tags;
['performance', operation, success ? 'success' : 'error'];
;
/**
                                                                    ...
                                                                    if (filter.hasChildren !== undefined) {
                                                                        ...
                                                                        if (filter.offset || filter.limit) {
                                                                            ...
                                                                            ActivityEvent;
                                                                            {
                                                                                ...
                                                                                ['collaboration'],
                                                                                    workspaceIds;
                                                                                workspaceId ? [workspaceId] : filter?.workspaceIds,
                                                                                ;
                                                                            }
                                                                            ;
                                                                            /**
                                                                            ...
                                                                            };
                                                                            {
                                                                                ...
                                                                                ActivitySession | null;
                                                                                {
                                                                                    ...
                                                                                    'session_ended',
                                                                                        title;
                                                                                    `User session ended (${Math.round(session.duration / 1000 / 60)}m)`;
                                                                                }
                                                                            }
