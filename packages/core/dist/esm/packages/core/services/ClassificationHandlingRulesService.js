                ...
                if (requirements.approvedLocations.length > 0 && !requirements.approvedLocations.includes('any')) {
                    ...
                    if (requirements.backupEncryption) {
                        ...
                        if (!hasBackupEncryption) {
                            ...
                            validateTransmissionRequirements(((requirements, context) => {
                                const errors = [];
                                const warnings = [];
                                // Check TLS version
                             ...
                             * Validate processing requirements
                             */
                            private, validateProcessingRequirements(((requirements, context) => {
                                const errors = [];
                                const warnings = [];
                             ...
                             * Validate monitoring requirements
                             */
                            private, validateMonitoringRequirements(((requirements, context) => {
                                const errors = [];
                                const warnings = [];
                             ...
                             * Record handling rule violations
                             */
                            private, async, recordViolations(dataId, string), classification, DataClassificationLevel, errors, string, context, OperationContext), Promise < void  > {
                                for(, error, of, errors) {
                                    const violation = {
