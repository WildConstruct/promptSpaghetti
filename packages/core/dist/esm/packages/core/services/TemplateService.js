                                                    ...
                                                    export class TemplateService {
                                                        ...
                                                        constructor(storage) {
                                                            ...
                                                            };
                                                            {
                                                                ...
                                                                graphData.edges = graphData.edges.map(edge => ({}), ...edge, id, `${edge.id}_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`);
                                                            }
                                                        }
                                                        source;
                                                        edge;
