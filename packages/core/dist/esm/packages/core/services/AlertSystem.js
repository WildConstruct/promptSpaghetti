            ...
            if (existingAlertId) {
                ...
                if (rule.escalation?.enabled) {
                    ...
                    */
                     ...
                     */
                    suppressAlert(alertId, string, suppressedBy, string, durationMinutes, number, reason ?  : string);
                    boolean;
                    {
                        const alert = this.alerts.get(alertId);
                        if (!alert) {
                                                            ...
                                                            if (filter.dateRange) {
                                                                ...
                                                                if (filter.searchQuery) {
                                                                    ...
                                                                    */
                                                                     ...
                                                                     */
                                                                    subscribe(listenerId, string, callback, (alert) => void );
                                                                    ...
                                                                    createNewAlert(rule, AlertRule, context, (Record), overrides ?  : Partial);
                                                                    Alert;
                                                                    {
                                                                        const now = new Date();
                                                                    ...
                                                                    ;
                                                                    async;
                                                                    executeActions(actions, AlertAction, alert, Alert);
                                                                    Promise < void  > { for(, action, of, actions) { }, : .filter(a => a.enabled) };
                                                                    {
                                                                        try {
                                                                        ...
                                                                        async;
                                                                        executeAction(action, AlertAction, alert, Alert);
                                                                        Promise < void  > {
                                                                            switch(action) { }, : .type
                                                                        };
                                                                        {
                                                                        ...
                                                                        scheduleEscalation(alert, Alert, escalation, AlertEscalation);
                                                                        void { escalation, : .stages.forEach((stage, index) => {
                                                                        ...
                                                                        ;
                                                                        shouldEscalate(alert, Alert, stage, AlertEscalationStage);
                                                                        boolean;
                                                                        {
                                                                            switch (stage.condition) {
                                                                                ...
                                                                                default:
                                                                                    ...
                                                                                    void { const: alert = this.alerts.get(alertId),
                                                                                    ...
                                                                                    void { this: .listeners.forEach(callback => { }),
                                                                                        try: {}, catch(error) { console.error('Error in alert listener:', error); },
                                                                            ...
                                                                            mapSeverityToPriority(severity, AlertSeverity);
                                                                            AlertPriority;
                                                                            {
                                                                                switch (severity) {
