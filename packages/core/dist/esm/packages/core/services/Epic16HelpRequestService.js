    ...
    })(HelpPriority || (HelpPriority = {}));
    {
        ...
        export class Epic16HelpRequestService extends EventEmitter {
            ...
            constructor(config = {}) {
                 ...
                 */
                async;
                submitHelpRequest(requestData, (Omit));
                Promise < HelpRequest > {
                ...
                };
                {
                    ...
                    'auto',
                        content;
                    this.generateAutoSuggestionMessage(request.suggestedArticles),
                        author;
                    'system',
                        visibility;
                    'public',
            ...
            async attemptAutoResolution(request) {
                ...
                if (bestArticle.relevanceScore >= this.config.autoResolution.confidenceThreshold) {
                    ...
                    'auto',
                        content;
                    `This request has been automatically resolved using our knowledge base. Please review the suggested article: "${bestArticle.title}". If this doesn't resolve your issue, the request will be routed to our support team.`;
                }
            }
            author;
            visibility;
