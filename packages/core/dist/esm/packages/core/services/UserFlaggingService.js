 ...
 */
async;
getUserFlagReports(userId, string),
    options;
{
    ...
    try {
        ...
        throw error;
        validateFlagSubmission(submission, FlagSubmission);
        void {
                ...
                if (!submission.reasonId) {
                    ...
                    if (!submission.reporterId) {
                        ...
                        if (this.config.requireJustification.includes(submission.reasonId) && !submission.details) {
                            ...
                            async;
                            checkForDuplicates(submission, FlagSubmission);
                            ...
                            ;
                            async;
                            createFlagReport(submission, FlagSubmission);
                            Promise < UserFlagReport > {
                            ...
                            ;
                            mapContentStatusToFlaggingStatus(status, 'clean' | 'under_review' | 'violations_found' | 'content_removed');
                            'none' | 'pending' | 'reviewed' | 'resolved' | 'dismissed';
                            {
                                switch (status) {
                                    ...
                                    default:
                                        return 'none';
                                        getLatestResolutionDate(contentId, string);
                                        Date | undefined;
                                        {
                                            ...
                                            getLatestModeratorNote(contentId, string);
                                            string | undefined;
                                            {
                                                const reports = Array.from(this.flagReports.values());
                                                filter(report => );
                                                ...
                                                getSeverityForReason(reasonId, string);
                                                ...
                                                getCategoryForReason(reasonId, string);
                                                'content' | 'security' | 'legal' | 'spam' | 'harassment' | 'other';
                                                {
                                                    const categoryMap = {
                                                ...
                                                calculateEstimatedResolution(report, UserFlagReport);
                                                number;
                                                ...
                                                determineContentStatus(summary, ContentFlagSummary);
                                                'clean' | 'under_review' | 'violations_found' | 'content_removed';
                                                {
                                                    ...
                                                    calculateModerationPriority(summary, ContentFlagSummary);
                                                    'low' | 'medium' | 'high' | 'urgent';
                                                    {
                                                        ...
                                                        if (summary.totalFlags >= 1)
                                                            return 'medium';
                                                        return 'low';
                                                        calculateUserAccuracy(userId, string, reports, UserFlagReport);
                                                        number;
                                                        {
                                                            ...
                                                            aggregateByField((items, field) => { });
                                                            return items.reduce((acc, item) => {
                                                                const key = String(item[field]);
                                                                acc[key] = (acc[key] || 0) + 1;
                                                                return acc;
                                                            }, {});
                                                            calculateResolutionStats(reports, UserFlagReport);
                                                            any;
                                                            {
                                                            ...
                                                            ;
                                                            calculateTopReporters(reports, UserFlagReport);
                                                            any;
                                                            {
