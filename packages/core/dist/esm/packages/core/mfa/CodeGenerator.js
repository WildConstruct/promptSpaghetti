    ...
    try { }
        ...
        if (opts.constantTimeValidation) {
            ...
            if (delay > 0) {
                ...
                ;
                return codes;
                validateCodeFormat((), code, string, expectedFormat, CodeGenerationOptions['format'] = 'numeric');
                {
                    valid: boolean;
                    reason ?  : string;
                }
                {
                    if (!code || typeof code !== 'string') {
                        ...
                        for (const char of cleanCode.toUpperCase()) {
                            ...
                            return { valid: true };
                            validateGenerationOptions(options, CodeGenerationOptions);
                            void {
                                                        ...
                                                        if (!valid && reason) {
                                                            ...
                                                            };
                                                            {
                                                                ...
                                                                constructor();
                                                                {
                                                                     ...
                                                                     */
                                                                    async;
                                                                    createEmailVerificationCode((), userId, string, email, string);
