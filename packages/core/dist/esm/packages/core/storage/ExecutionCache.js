        ...
        if (age > this.MAX_CACHE_AGE) {
            ...
            if (currentInputs && !this.inputsMatch(cached.inputs, currentInputs)) {
                ...
                if (currentSeed !== undefined && cached.seed !== currentSeed) {
                     ...
                     */
                    invalidateByNodes(changedNodeIds, string);
                    void {
                    ...
                    };
                    {
                        ...
                        for (const depId of cached.dependencies) {
                            ...
                            CacheMetrics;
                            {
                                 ...
                                 */
                                clearAll();
                                void { this: .graphStateCache.clear(),
                                 ...
                                 */
                                cleanupIfNeeded();
                                void { const: currentMemory = this.estimateMemoryUsage(),
...
for (let i = 0; i < combined.length; i++) {
    ...
    addToResultCache(key, string, entry, CachedExecutionResult);
    void {
        : .resultCache.has(key)
    };
    {
        ...
        while (this.resultCache.size > this.MAX_RESULT_CACHE_SIZE) {
            ...
            if (oldestKey) {
                ...
                } > 0;
                {
                    ...
                    {
                        this.resultCacheOrder.splice(index, 1);
                        inputsMatch(cached, any, current, any);
                        boolean;
                        {
                            if (cached === current)
                                return true;
                            ...
                            if (typeof cached === 'object' && cached !== null && current !== null) {
                                ...
                                return false;
                                areDependenciesValid(dependencies, (Set));
                                boolean;
                                {
