...
// ====================================
async;
discoverPersonalizedTutorials((), userId, string, context, LearningContext);
    ...
    try: {
        ...
        Promise < LearningSessionResult > {
            try: {
                ...
                throw error;
                async;
                trackLearningProgress((), sessionId, string, progressData, LearningProgressData);
                Promise < LearningProgressResult > {
                    try: {
                        ...
                        throw error;
                        async;
                        completeLearningExperience((), sessionId, string, completionData, LearningCompletionData);
                            ...
                            try: {
                                ...
                                Promise < PersonalizedLearningInsights > {
                                    try: {
                                        ...
                                        throw error;
                                        async;
                                        getContentPerformanceInsights((), contentId, string, timeRange, TimeRange);
                                        Promise < ContentPerformanceInsights > {
                                            try: {
                                                ...
                                                throw error;
                                                async;
                                                getCommunityEngagementInsights((), communityId, string, timeRange, TimeRange);
