...
// Presence updates
updateLocalPresence: (presence) => void ;
updateUserCursor: (nodeId, position) => void ;
updateUserSelection: (nodeIds) => void ;
// Sync operations
applyRemoteUpdate: (update) => void ;
