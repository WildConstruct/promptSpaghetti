                ...
                channels;
            {
                in_app: {
                    ...
                    subject: 'Invited to {{project_name}}',
                        body;
                    '{{actor_name}} invited you to collaborate on {{project_name}}.';
                }
                email: {
                    ...
                    channels;
                {
                    in_app: {
                        ...
                        subject: '{{actor_name}} mentioned you',
                            body;
                        '{{actor_name}} mentioned you in a comment on {{resource_name}}.';
                    }
                    email: {
                        ...
                        channels;
                    {
                        in_app: {
                            ...
                            subject: 'Reply to your comment',
                                body;
                            '{{actor_name}} replied to your comment on {{resource_name}}.';
                        }
                        email: {
                            ...
                            channels;
                        {
                            in_app: {
                                ...
                                subject: '{{resource_name}} shared with you',
                                    body;
                                '{{actor_name}} shared {{resource_name}} with you.';
                            }
                            email: {
                                ...
                                channels;
                            {
                                in_app: {
                                    ...
                                    subject: 'Your role has been updated',
                                        body;
                                    'Your role in {{workspace_name}} has been changed to {{new_role}}.';
                                }
                                email: {
                                    ...
                                    channels;
                                {
                                    in_app: {
                                        ...
                                        subject: 'Activity digest for {{workspace_name}}',
                                            body;
                                        'Here\'s what happened in {{workspace_name}} since your last visit.';
                                    }
                                    email: {
                                        subject: 'Activity digest for {{workspace_name}}',
                                            body;
...
The Team`;
                                    ...
                                    async;
                                    setUserPreferences(preferences, NotificationPreferences);
                                    Promise < void  > {
                                        ...
                                        getDefaultPreferences(userId) {
                                            return {
                                                ...
                                                async notifyWorkspaceInvite(context) {
                                                    ...
                                                    async;
                                                    notifyProjectInvite(context, NotificationContext);
                                                    Promise < void  > {
                                                        ...
                                                        async notifyCommentMention(context) {
                                                            ...
                                                            async;
                                                            notifyCommentReply(context, NotificationContext);
                                                            Promise < void  > {
                                                                ...
                                                                async notifyResourceShared(context) {
                                                                    ...
                                                                    async;
                                                                    notifyRoleChanged(context, NotificationContext);
                                                                    Promise < void  > {
                                                                    ...
                                                                    }, private, shouldSendNotification(type, NotificationType), context, NotificationContext, preferences, NotificationPreferences);
                                                                    boolean;
                                                                    {
                                        ...
                                        ,
                                        // This would send HTTP POST to configured webhook URL
                                        renderTemplate(template, context, _userId) {
...
void  > {
    const: context, NotificationContext = {
        ...
        data: {
            ...
            activities: notifications.map(n => ({}), description, n.message, actor_name, 'User', // Would fetch from database,
