        ...
        if(, link) {
            ...
            Promise < boolean > {
                ...
                if(, link) {
                    ...
                    Promise < ShareLink | null > { return: this.links.get(linkId) || null,
                                                                ...
                                                                Promise < BulkOperation > {
                                                                    ...
                                                                    async generatePreview(url) {
                                                                        if (!this.config.features.preview.enabled) {
                                                                            ...
                                                                            // Scheduled Sharing
                                                                            async;
                                                                            scheduleShare((request, schedule) => {
                                                                            ...
                                                                            void {
                                                                                ...
                                                                                getConfig() {
                                                                                    ...
                                                                                    async;
                                                                                    getSystemStats();
                                                                                    Promise < SystemStats > { const: allClicks = Array.from(this.clicks.values()).flat(),
