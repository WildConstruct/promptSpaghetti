...
export const ResponsiveCorrectionsPanel = ({ isOpen, onClose }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      isMobile
        ? _jsx(MobileCorrectionsPanel, { isOpen: isOpen, onClose: onClose })
        : _jsx(CorrectionsManagerPanel, { isOpen: isOpen, onClose: onClose }),
      showStats && _jsx(CorrectionsStatsDashboard, { isOpen: showStats, onClose: () => setShowStats(false) }),
    ],
  });
};
