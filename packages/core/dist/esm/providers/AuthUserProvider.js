...
import { retryWithBackoff, TokenRefreshScheduler, AuthStateBroadcaster, OfflineAuthQueue, transformAuthError, AuthDebugLogger } from '../utils/authHelpers';
...
export function AuthUserProvider({ children }) {
    ...
    // Utilities
    const tokenScheduler = useRef(null);
    const broadcaster = useRef(null);
    const offlineQueue = useRef(null);
