...
export const PlayfulLoadingStates = ({ isLoading, loadingType = 'general', customMessages = [], }) => {
    ...
    // Typewriter effect
    useEffect(() => {
        if (!currentMessage || currentMessage.animation !== 'typewriter')
            return;
    ...
    return (_jsxs("div", { className: "playful-loading-container", style: {
            display: 'flex',
            alignItems: 'center',
            ...
            position: 'relative',
            overflow: 'hidden',
        }, children: [_jsx("span", { className: getAnimationClass(currentMessage.animation), style: { fontSize: 32 }, children: currentMessage.emoji }), _jsx("span", { style: {
                    fontSize: 16,
                    color: '#333',
                    fontWeight: 500,
                    letterSpacing: '0.02em',
                }, children: displayMessage }), _jsx("div", { className: "loading-shimmer", style: {
                    position: 'absolute',
                    top: 0,
                    left: '-100%',
                    width: '100%',
...
export const InlineLoadingSpinner = ({ size = 16 }) => {
    ...
    return (_jsx("span", { style: {
        ...
        }, children: spinners[frame] }));
};
// Fun progress bar
export const PlayfulProgressBar = ({ progress, message = 'Loading magic...', showPercentage = true }) => {
    ...
    return (_jsxs("div", { style: { width: '100%', padding: 16 }, children: [_jsxs("div", { style: {
                    display: 'flex',
                    justifyContent: 'space-between',
                    marginBottom: 8,
                    fontSize: 14,
                }, children: [_jsx("span", { children: message }), showPercentage && _jsxs("span", { children: [Math.round(progress), "%"] })] }), _jsxs("div", { style: {
                    width: '100%',
                    height: 8,
                    background: '#e0e0e0',
                    borderRadius: 4,
              ...
              rgba(255,255,255,0.1) 20px
                            ...
                            } }) }), sparkles.map(sparkle => (_jsx("div", { style: {
                            position: 'absolute',
                            left: `${sparkle.left}%`,
                            top: '50%',
