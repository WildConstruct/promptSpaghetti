...
export const EasterEggManager = ({ onWeirdModeToggle, onDebugModeToggle, onExpertModeToggle, onPresetsShuffled, onPrecisionModeToggle, }) => {
    ...
    const triggerCelebration = (eggId) => {
    ...
    useEffect(() => {
        const handleMouseDown = (e) => {
            // Only on canvas area
            if (e.target.closest('.react-flow__viewport')) {
    ...
    if (debugMode) {
        return (_jsx(_Fragment, { children: _jsxs("div", { style: {
                    ...
                    zIndex: 9998,
                    maxWidth: 300,
                }, children: [_jsx("h4", { style: { margin: '0 0 8px 0' }, children: "\uD83D\uDC1B Debug Info" }), _jsxs("div", { children: ["Nodes: ", nodes.length] }), _jsxs("div", { children: ["Edges: ", edges.length] }), _jsxs("div", { children: ["Weird Mode: ", weirdMode ? 'ON' : 'OFF'] }), _jsxs("div", { children: ["Expert Mode: ", expertMode ? 'ON' : 'OFF'] }), _jsxs("div", { children: ["Precision Mode: ", precisionMode ? 'ON' : 'OFF'] }), _jsxs("div", { children: ["Discovered Eggs: ", discoveredEggs.size, "/5"] }), _jsx("div", { style: { marginTop: 8, opacity: 0.7 }, children: "Hold again to close" })] }) }));
    }
