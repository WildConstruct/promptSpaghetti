...
export const simpleCharacterGraph = {
    id: 'simple-character',
...
export const combatEncounterGraph = {
    id: 'combat-encounter',
...
export const medievalDemoGraphs = [
