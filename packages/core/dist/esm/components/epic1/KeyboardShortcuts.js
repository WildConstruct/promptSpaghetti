 ...
 */
export const KeyboardShortcuts = ({ onSave, onLoad, onExport, onDelete, onDuplicate, onSelectAll, onGroup, onUngroup, additionalHandlers = {}, }) => {
    ...
    const selectedEdges = useStore((state) => state?.edges?.filter(edge => edge.selected) || []);
