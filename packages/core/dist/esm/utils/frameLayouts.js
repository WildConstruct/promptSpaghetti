 ...
 */
export function rectangularFrameLayout(index, total, options) {
    const { viewportWidth, viewportHeight, nodeWidth = 200, nodeHeight = 100, padding = 80 } = options;
 ...
 */
export function ellipticalFrameLayout(index, total, options) {
    const { viewportWidth, viewportHeight, nodeWidth = 200, nodeHeight = 100, padding = 10 // Minimal padding from absolute edge
     } = options;
 ...
 */
export function diamondFrameLayout(index, total, options) {
    const { viewportWidth, viewportHeight, nodeWidth = 200, nodeHeight = 100, padding = 100 } = options;
 ...
 */
export function spiralFrameLayout(index, total, options) {
    const { viewportWidth, viewportHeight, nodeWidth = 200, nodeHeight = 100, padding = 80 } = options;
    const centerX = viewportWidth / 2;
    const centerY = viewportHeight / 2;
    // Spiral parameters
 ...
 */
export function starFrameLayout(index, total, options) {
    const { viewportWidth, viewportHeight, nodeWidth = 200, nodeHeight = 100, padding = 100 } = options;
    const centerX = viewportWidth / 2;
    const centerY = viewportHeight / 2;
 ...
 */
export function getFrameLayout(layoutType = 'elliptical') {
    switch (layoutType) {
        case 'rectangular':
 ...
 */
export function autoFrameLayout(nodes, viewportWidth, viewportHeight, layoutType = 'elliptical') {
