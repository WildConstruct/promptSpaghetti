...
export interface UserSkillProfile {
    user_id: string;
    skill_levels: Record<SkillDomain, {}, current_level>;
    SkillLevel: any;
    confidence: number;
...
export declare const SKILL_LEVEL_DEFINITIONS: {
    beginner: {
        ...
        typical_time_investment: string;
        success_indicators: string[];
    };
    intermediate: {
        description: string;
    ...
    expert: {
        ...
        readonly characteristics: readonly [any, "Deep, comprehensive knowledge", "Can handle ambiguous or novel problems", "Ready for research-level content", "Can contribute to the field", "Benefits from peer collaboration and discussion"];
        readonly typical_time_investment: "20+ hours per topic";
        readonly success_indicators: readonly [any, "Can contribute original insights", "Can handle undefined problems", "Can teach and lead others effectively"];
    };
    const: {
        gradual: {
            level_progression: string[];
            overlap_percentage: number;
            reinforcement_frequency: number;
