...
export const { rules, addRule, updateRule, deleteRule, toggleRule, clearAllRules, applyCorrections } = useCorrectionsStore();
        ...
        flexDirection: 'column'
                ...
                justifyContent: 'space-between'
                        ...
                        padding: '4px 8px'
                                ...
                                borderRadius: '4px',
                                resize: 'vertical'
                            } }), testText && (_jsxs("div", { style: { marginTop: '8px' }, children: [_jsx("strong", { children: "Result:" }), _jsx("div", { style: {
                                        padding: '8px',
                                        background: '#1e2228',
                                        border: '1px solid #444',
                                        borderRadius: '4px',
                                        marginTop: '4px',
                                        fontSize: '14px'
                                    }, children: handleTestCorrections() })] }))] }), _jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }, children: [_jsxs("h3", { style: { fontSize: '16px', margin: 0 }, children: ["Correction Rules (", rules.length, ")"] }), _jsxs("div", { children: [_jsx("button", { onClick: handleLoadDefaults, style: {
                                                background: '#4a5568',
                                                color: '#fff',
                                                border: 'none',
                                                padding: '6px 12px',
                                                ...
                                                fontSize: '12px',
                                                marginRight: '8px'
                                            }, children: "Load Defaults" }), _jsx("button", { onClick: clearAllRules, style: {
                                                background: '#e53e3e',
                                                color: '#fff',
                                                border: 'none',
                                                padding: '6px 12px',
                                                ...
                                                cursor: 'pointer',
                                                fontSize: '12px'
                                            }, children: "Clear All" })] })] }), rules.map((rule) => (_jsxs("div", { style: {
                                background: '#2a2e37',
                                border: '1px solid #444',
                                borderRadius: '4px',
                                padding: '12px',
                                marginBottom: '8px'
                                        ...
                                        justifyContent: 'space-between',
                                        marginBottom: '8px'
                                    }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center' }, children: [_jsx("input", { type: "checkbox", checked: rule.isActive, onChange: () => toggleRule(rule.id), style: { marginRight: '8px' } }), _jsx("strong", { style: { fontSize: '14px' }, children: rule.name }), rule.isRegex && (_jsx("span", { style: {
                                                        background: '#4a5568',
                                                        color: '#fff',
                                                        padding: '2px 6px',
                                                        borderRadius: '2px',
                                                        fontSize: '10px',
                                                        marginLeft: '8px'
                                                    }, children: "REGEX" }))] }), _jsxs("div", { children: [_jsx("button", { onClick: () => setEditingRule(rule), style: {
                                                        background: 'none',
                                                        border: 'none',
                                                        color: '#63b3ed',
                                                        cursor: 'pointer',
                                                        ...
                                                        cursor: 'pointer',
                                                        fontSize: '12px'
                                                    }, children: "Delete" })] })] }), rule.description && (_jsx("p", { style: { fontSize: '12px', color: '#a0aec0', margin: '4px 0' }, children: rule.description })), _jsxs("div", { style: { fontSize: '12px', color: '#68d391' }, children: ["Find: ", _jsx("code", { style: { background: '#1e2228', padding: '2px 4px' }, children: rule.findPattern })] }), _jsxs("div", { style: { fontSize: '12px', color: '#63b3ed' }, children: ["Replace: ", _jsx("code", { style: { background: '#1e2228', padding: '2px 4px' }, children: rule.replaceWith })] })] }, rule.id)))] }), _jsxs("div", { style: { marginBottom: '24px' }, children: [_jsx("h3", { style: { fontSize: '16px', marginBottom: '16px' }, children: "Add New Rule" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsx("input", { type: "text", value: newRule.name, onChange: (e) => setNewRule(prev => ({ ...prev, name: e.target.value })), placeholder: "Rule name", style: {
                                        padding: '8px',
                                        background: '#2a2e37',
                                        color: '#fff',
                                        border: '1px solid #444',
                ...
                zIndex: 1001
                    ...
                    width: '400px',
                    maxWidth: '90vw'
                }, children: [_jsx("h3", { style: { marginBottom: '16px' }, children: "Edit Rule" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsx("input", { type: "text", value: editingRule.name, onChange: (e) => setEditingRule(prev => prev ? ({ ...prev, name: e.target.value }) : null), placeholder: "Rule name", style: {
                                    padding: '8px',
                                    background: '#2a2e37',
                                    color: '#fff',
                                    border: '1px solid #444',
