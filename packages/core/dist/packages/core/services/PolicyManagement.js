...
for (const policy of applicablePolicies) {
  ...
  ms: ${results.length} results`);
        ...
        return results;
        async;
        evaluatePolicy((), policy, UnifiedPolicy, context, PolicyEvaluationContext);
        Promise < PolicyEvaluationResult > {
    ...
    return results;
    async;
    evaluateRule((), rule, PolicyRule, context, PolicyEvaluationContext);
            ...
            switch (logic.operator) {
                ...
                case 'CUSTOM':
                    if (logic.customFunction) {
                        ...
                        async;
                        evaluateRuleContext((), context, (NonNullable), evaluationContext, PolicyEvaluationContext);
                                                                        ...
                                                                        for (const contentRule of context.contentBasedRules) {
                                                                            ...
                                                                            if (!contentResult.valid) {
                                                                                ...
                                                                                if (contentRule.historicalAccuracy) {
                                                                                    ...
                                                                                    async;
                                                                                    evaluateTimeBasedRule((), rule, TimeBasedRule, context, PolicyEvaluationContext);
                                                                                    ...
                                                                                    };
                                                                                    {
                                                                                        ...
                                                                                        if (validRegions.length === 0) {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                                ...
                                                                                                return { valid: true, score: 1.0, details: {} };
                                                                                                async;
                                                                                                evaluateRoleBasedRule((), rule, RoleBasedRule, context, PolicyEvaluationContext);
                                                                                                Promise < { valid: boolean, score: number, details: any } > {
