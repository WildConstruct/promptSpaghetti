...
(function (ArticleType) {
    ...
    ArticleType["BEST_PRACTICE"] = "best_practice";
    ArticleType["CASE_STUDY"] = "case_study";
    ArticleType["VIDEO_GUIDE"] = "video_guide";
    ArticleType["API_DOC"] = "api_doc";
    ArticleType["CHANGELOG"] = "changelog";
...
export class Epic16KnowledgeBaseService extends EventEmitter {
    ...
    async searchArticles(query, filters, userId) {
    ...
    async getPopularArticles(category, limit = 10) {
