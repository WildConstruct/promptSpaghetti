...
})(ConditionType || (ConditionType = {}));
{
                                                        ...
                                                        Promise < Role > {
                                                            ...
                                                            async addPermission(permission) {
                                                                ...
                                                                Promise < EvaluatedCondition > {
                                                                    ...
                                                                    for(, condition, of, policy) { }, : .conditions
                                                                };
                                                                {
                                                                    const startTime = Date.now();
                                                                    let result = false;
    ...
    }
    {
        ...
        evaluateIpBasedCondition((), condition, PolicyCondition, context, AuthorizationContext);
        {
            result: boolean;
            value: any;
            reason: string;
        }
        {
            ...
            evaluateContextBasedCondition((), condition, PolicyCondition, context, AuthorizationContext);
            {
                result: boolean;
                value: any;
                reason: string;
            }
            {
                ...
                async;
                checkDirectPermissions(context, AuthorizationContext);
                Promise < boolean > {
                ...
                ;
                generateDecisionReason(decision, string);
                ...
                generateRecommendations(context, AuthorizationContext, decision, string);
                string;
                {
                    ...
                    if (decision === 'deny') {
                        ...
                        generateAlternatives(context, AuthorizationContext);
                        AlternativeAction;
                        {
                            // Generate alternative actions the user might be able to perform
                            return [];
                            async;
                            auditAuthorizationDecision((), context, AuthorizationContext, result, AuthorizationResult);
                            Promise < void  > {
