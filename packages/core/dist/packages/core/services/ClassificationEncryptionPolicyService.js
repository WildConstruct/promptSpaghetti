...
boolean;
{
     ...
     */
    getEncryptionPolicy(classification, DataClassificationLevel);
    EncryptionPolicy | undefined;
    {
        ...
        if (encryptionStatus.encrypted && encryptionStatus.algorithm) {
            ...
            if (!algorithmValid.valid) {
                ...
                if (encryptionStatus.encrypted && encryptionStatus.lastRotationDate) {
                    ...
                    context.userId,
                        algorithm;
                    encryptionStatus.algorithm || 'unknown',
                        keyId;
                    'unknown',
                        result;
                                            ...
                                            EncryptionAuditEvent;
                                            {
                                                ...
                                                if (classification) {
                                                    ...
                                                    if (eventType) {
                                                         ...
                                                         */
                                                        async;
                                                        updateEncryptionPolicy((), classification, DataClassificationLevel, updates, (Partial));
                                                        Promise < void  > {
