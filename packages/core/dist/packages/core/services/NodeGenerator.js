...
export class NodeGenerator {
    ...
    generateFromAnalysis(request) {
        ...
        try {
            ...
            // Generate layout
            const layoutResult = this.calculateLayout(request.selectedSuggestions, request.options.layout, request.canvasPosition, request.options.spacing);
            // Create nodes
            const nodes = this.createNodes(request.selectedSuggestions, layoutResult.positions);
            // Generate connections
            const connectionResult = this.generateConnections(request.selectedSuggestions, nodes, request.options.connectionPattern);
     ...
     */
    calculateLayout(suggestions, layoutType, startPosition, spacing) {
     ...
     */
    createNodes(suggestions, positions) {
     ...
     */
    generateConnections(suggestions, nodes, pattern) {
        const edges = [];
