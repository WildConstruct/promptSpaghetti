...
}
{
    ...
    'Action Sequence Pattern',
        description;
    'High-energy action scenes with dynamic camera work',
        pattern;
    '{cinematography} follows {characters} as they {actions} through {locations}, with {timeAndSetting} creating urgency',
        methodology;
    'zada',
        filmGenre;
        ...
        elements;
    {
        timeAndSetting: 'nighttime during a thunderstorm',
            actions;
        'chase through crowded market streets',
            locations;
        'narrow alleyways and rooftops',
            characters;
        'protagonist being pursued by antagonists',
            cinematography;
        'handheld camera with rapid cuts and dynamic angles',
        ;
    }
    accessibility: {
        directorFriendly: true,
    ...
    }
    {
        id: 'zada-mars-hybrid',
            name;
        'Hybrid MARS-Zada Pattern',
            description;
        'Combines natural language accessibility with technical precision',
            pattern;
        '[CAM:{cinematography}] captures {characters} in {locations} as they {actions} during {timeAndSetting} [FX:atmospheric-enhancement] !FOCAL[primary-subject]',
            methodology;
        'hybrid',
            filmGenre;
            ...
            elements;
        {
            timeAndSetting: 'golden hour in futuristic cityscape',
                actions;
            'make a crucial discovery about their mission',
                locations;
            'high-tech laboratory with panoramic windows',
                characters;
            'research team led by brilliant scientist',
                cinematography;
            'smooth dolly movement with lens flares',
            ;
        }
        accessibility: {
            directorFriendly: true,
        ...
        // Session Management
        async;
        createCollaborationSession(title, string);
