...
'Complex Graph Execution',
    description;
'Time to execute complex graphs with advanced nodes',
    category;
...
'ms',
    target;
50, // Based on performance analysis,
    warning;
150,
    critical;
300,
...
'Graph Memory Usage',
    description;
'Memory usage for storing and processing graphs',
    category;
...
'Peak Heap Usage',
    description;
'Peak heap memory usage during intensive operations',
    category;
BaselineCategory.MEMORY_USAGE,
    type;
MeasurementType.MEMORY,
...
'MB',
    target;
30, // Based on current system performance,
    warning;
60,
    critical;
100,
...
's',
    target;
8, // Based on current build performance (30s actual / ~4 = 8s target),
    warning;
20,
    critical;
45,
