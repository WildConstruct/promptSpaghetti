...
import { NODE_CATEGORIES, SPECIAL_CATEGORIES, getAllCategories, getNodeCategories, getCategoryById, getCategoryColor } from './NodeCategory';
 ...
 */
export const TabbedPalette = ({ nodes, collapsed, onToggle, onDragStart, defaultActiveTab = 'content', showSearch = true, showFavorites = true, maxSearchResults = 20 }) => {
    // State management
    ...
    // Managers
    const [favoritesManager] = useState(() => getFavoritesManager());
    const [searchEngine] = useState(() => createPaletteSearch(nodes));
    ...
    const renderNodeItem = useCallback((node, showCategory = false) => {
        ...
        return (_jsxs("div", { role: "button", tabIndex: 0, draggable: true, "aria-label": `${node.label} - ${node.tooltip}`.trim(), "aria-describedby": `tooltip-${node.id}`, "aria-grabbed": "false", onDragStart: (e) => {
                ...
                if (e.key === 'Enter' || e.key === ' ') {
                    onDragStart?.(node.id);
                        ...
                        height: 1,
                        overflow: 'hidden'
                    }, children: node.tooltip }), _jsx("span", { style: {
                        fontSize: collapsed ? 18 : 20,
                        width: collapsed ? 20 : 24,
                        textAlign: 'center',
                        flexShrink: 0
                    }, children: node.icon }), !collapsed && (_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: {
                                fontSize: 12,
                                fontWeight: 500,
                                color: uiColors.text.primary,
                                marginBottom: 2
                            }, children: node.label }), _jsx("div", { style: {
                                fontSize: 10,
                                ...
                                whiteSpace: 'nowrap'
                            }, children: node.tooltip })] })), !collapsed && showCategory && primaryCategory && (_jsx("div", { style: {
                        padding: '2px 6px',
                        borderRadius: 3,
                        ...
                        letterSpacing: '0.3px'
                    }, children: getCategoryById(primaryCategory)?.name.split(' ')[0] })), !collapsed && showFavorites && (_jsx("button", { onClick: (e) => handleFavoriteToggle(node.id, e), style: {
                        background: 'none',
                        border: 'none',
                        padding: 4,
                        cursor: 'pointer',
                    ...
                    }, title: isFavorited ? 'Remove from favorites' : 'Add to favorites', children: _jsx(FiStar, { size: 12, fill: isFavorited ? 'currentColor' : 'none' }) }))] }, node.id));
    ...
    const renderCategorySection = useCallback((category) => {
        ...
        if (categoryNodes.length === 0)
            return null;
        return (_jsxs("div", { style: { marginBottom: 12 }, children: [_jsxs("div", { role: "button", tabIndex: 0, onClick: () => category.collapsible && handleCategoryToggle(category.id), onKeyDown: (e) => {
                        ...
                        e.currentTarget.style.backgroundColor = 'transparent';
                    }, children: [category.collapsible && (_jsx("div", { style: { width: 12, display: 'flex', justifyContent: 'center' }, children: isCollapsed ? (_jsx(FiChevronRight, { size: 10, color: uiColors.text.secondary })) : (_jsx(FiChevronDown, { size: 10, color: uiColors.text.secondary })) })), _jsx(CategoryIcon, { size: 12, color: category.color }), _jsx("div", { style: {
                                fontSize: 10,
                                fontWeight: 600,
                                color: uiColors.text.secondary,
                                textTransform: 'uppercase',
                                ...
                                minWidth: 16,
                                textAlign: 'center'
                            }, children: categoryNodes.length })] }), !isCollapsed && (_jsx("div", { style: { marginLeft: category.collapsible ? 18 : 0 }, children: categoryNodes.map(node => renderNodeItem(node, isSearchResults)) }))] }, category.id));
    }, [getNodesForCategory, collapsedCategories, handleCategoryToggle, renderNodeItem]);
    return (_jsxs("aside", { "aria-label": "Enhanced Node Palette", style: {
            ...
            flexDirection: 'column'
                    ...
                    background: uiColors.background.secondary
                            ...
                            e.currentTarget.style.backgroundColor = 'transparent';
                        }, children: collapsed ? '»' : '«' }), !collapsed && (_jsx("div", { style: {
                            flex: 1,
                            marginLeft: 8,
                            fontSize: 12,
                            fontWeight: 600,
                            color: uiColors.text.primary
                        }, children: "Node Palette" }))] }), !collapsed && showSearch && (_jsx("div", { style: {
                    padding: '8px',
                    borderBottom: `1px solid ${uiColors.ui.border}`,
                    background: uiColors.background.secondary
                }, children: _jsxs("div", { style: {
                        ...
                        alignItems: 'center'
                                ...
                                alignItems: 'center',
                                justifyContent: 'center'
                            }, children: _jsx(FiX, { size: 12 }) }))] }) })), !collapsed && availableCategories.length > 1 && (_jsx("div", { style: {
                    display: 'flex',
                    overflowX: 'auto',
                    borderBottom: `1px solid ${uiColors.ui.border}`,
                    background: uiColors.background.secondary,
                    scrollbarWidth: 'thin'
                }, children: availableCategories.slice(0, 4).map((category) => {
                    const isActive = activeTab === category.id;
                    const CategoryIcon = category.icon;
                    return (_jsxs("button", { onClick: () => setActiveTab(category.id), style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 4,
                            padding: '6px 8px',
                            ...
                            transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
                            whiteSpace: 'nowrap'
                        }, title: category.description, children: [_jsx(CategoryIcon, { size: 12 }), _jsx("span", { children: category.name.split(' ')[0] })] }, category.id));
                }) })), _jsx("div", { style: {
                    flex: 1,
                    overflowY: 'auto',
