...
export const updateVariationInNode = (nodeData) => index, number, newValue, NodeData;
{
    const currentVariations = nodeData.variations || [];
...
;
export const reorderVariationsInNode = (nodeData) => fromIndex, number, toIndex, NodeData;
{
    const currentVariations = nodeData.variations || [];
    const updatedVariations = [...currentVariations];
