 ...
 */
export function createAnimationStyle(property, duration = animationDurations.normal, easing = easingFunctions.cinema4d.professional) {
    return {
 ...
 */
export function createSmoothTransition(properties, duration = animationDurations.normal, easing = easingFunctions.cinema4d.professional) {
    return {
 ...
 */
export function smoothScrollTo(element, top, duration = animationDurations.smooth) {
 ...
 */
export function useSmoothHover(duration = animationDurations.micro) {
...
export const AnimatedContainer = ({ children, className, style, animationType = 'fade', duration = animationDurations.normal, delay = 0, isVisible = true }) => {
