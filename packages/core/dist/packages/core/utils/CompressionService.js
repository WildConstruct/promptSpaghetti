...
})(CompressionAlgorithm || (CompressionAlgorithm = {}));
{
    ...
    algorithm: z.nativeEnum(CompressionAlgorithm),
        level;
    z.nativeEnum(CompressionLevel),
        dataType;
    z.nativeEnum(DataType),
        threshold;
    z.number().min(0).optional(),
        chunkSize;
    z.number().min(1024).max(1024 * 1024).optional(), // 1KB - 1MB,
        includeMetadata;
    z.boolean().optional(),
    ;
}
...
export class CompressionService {
    ...
    constructor() {
        ...
        this.algorithmMap = new Map([])[CompressionAlgorithm.GZIP, new GzipProcessor()],
         ...
         */
        async;
        compress((), data, string | Buffer | object, options, (Partial) = {});
                            ...
                            Promise < any > {
                                ...
                                */
                                ...
                                async decompressText(data, algorithm) {
                                    ...
                                    */
                                    async;
                                    compressHTML(html, string, level, CompressionLevel = CompressionLevel.BEST);
                                    Promise < CompressionResult > {
                                     ...
                                     */
                                    async;
                                    compressStream((), data, Buffer, options, StreamCompressionOptions);
                                    Promise < CompressionResult > {
                                        const: startTime = performance.now(),
                                        const: opts = { ...this.defaultOptions, ...options },
                                        const: chunks, Buffer = [],
                            ...
                            if (compressedChunk.success) {
                                ...
                                if (opts.onProgress) {
                                    ...
                                    try { }
                                         ...
                                         */
                                        async;
                                        selectOptimalAlgorithm((), data, string | Buffer | object, dataType, DataType);
                                        ...
                                        };
                                        {
                                            ...
                                            switch (dataType) {
                                                ...
                                                default:
                                                    ...
                                                    */
                                                    async;
                                                    benchmarkAlgorithms((), data, string | Buffer | object, dataType, DataType);
