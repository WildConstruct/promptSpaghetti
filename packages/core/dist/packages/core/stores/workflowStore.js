...
// Create the store
export const useWorkflowStore = create()(devtools((set, get) => ({
    states: [],
    selectedState: null,
    isExecuting: false,
    executionResults: {},
    ...
    transitionResourceState: async (resourceId, toStateId, actorId, options = {}) => {
        try {
            set({ loading: true, error: null });
    ...
    acquireLock: async (resourceId, userId, lockType = 'edit', options = {}) => {
        try {
            set({ loading: true, error: null });
