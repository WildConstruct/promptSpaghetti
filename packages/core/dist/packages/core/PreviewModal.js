            ...
            const handleExport = async (format, options) => {
                try {
                    ...
                    if (exportDialog.type === 'individual' && typeof exportDialog.individualIndex === 'number') {
                        ...
                        exportResult = await resultExportService.exportComparison(results, options);
                    }
                            ...
                            justifyContent: 'center',
                                ...
                                color: professionalColors.text.primary,
                                        ...
                                        marginBottom: 16,
                                                        ...
                                                        fontWeight: 500,
                                                        cursor: 'pointer',
                                                    }, children: "\uD83D\uDCCA Export All" })), compareMode && selectedForComparison.length > 0 && (_jsxs("span", { style: {
                                                        fontSize: 11,
                                                        color: '#4a5568',
                                                        padding: '4px 8px',
                                                        background: '#f7fafc',
                                                        borderRadius: 4,
                                                    }, children: [selectedForComparison.length, "/3 selected"] }))] })] }), loading && _jsx("div", { style: { marginBottom: 12 }, children: "\u2728 Generating content..." }), error && _jsxs("div", { style: { color: '#c00' }, children: ["\u26A0\uFE0F Something went wrong: ", error] }), !loading && !error && (_jsxs("div", { children: [showExecutionPaths && hasExecutionPaths && (_jsx("div", { style: { marginBottom: 20 }, children: _jsx(ExecutionPathVisualization, { results: results, onNodeHighlight: onNodeHighlight, config: {
                                                    showExecutionOrder: true,
                                                    showRandomChoices: true,
                                                    showPerformanceMetrics: true,
                                                } }) })), showVarianceAnalysis && results.length >= 2 && (_jsx("div", { style: { marginBottom: 20 }, children: _jsx(VarianceAnalysis, { results: results, onSuggestionClick: onVarianceSuggestion }) })), compareMode && selectedForComparison.length >= 2 && (_jsxs("div", { style: {
                                                marginBottom: 20,
                                                padding: 16,
                                                background: '#f0f9ff',
                                                border: '1px solid #0ea5e9',
                                                borderRadius: 8,
                                            }, children: [_jsx("h3", { style: { margin: '0 0 12px 0', color: '#0c4a6e', fontSize: 14 }, children: "\u2696\uFE0F Result Comparison" }), _jsx("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }, children: selectedForComparison.map(index => {
                                                        ...
                                                        return (_jsxs("div", { style: {
                                                                ...
                                                                border: '1px solid #bae6fd',
                                                                        ...
                                                                        color: '#0c4a6e',
                                                                        marginBottom: 4,
                                                                    }, children: ["Seed ", result.seed] }), _jsxs("div", { style: {
                                                                        fontSize: 11,
                                                                    ...
                                                                    }, children: [result.output?.substring(0, 100), "..."] }), ('executionTimeMs' in result) && (_jsxs("div", { style: {
                                                                        fontSize: 10,
                                                                        color: '#6b7280',
                                                                        marginTop: 4,
                                                                    }, children: [result.executionTimeMs, "ms"] }))] }, index));
                                                ...
                                                return (_jsxs("li", { onMouseEnter: () => onResultHover?.(i), style: {
                                                        ...
                                                        opacity: regenerating ? 0.7 : 1,
                                                                ...
                                                                borderRadius: 12,
                                                                fontWeight: 600,
                                                            }, children: res.seed }), locked && (_jsx("span", { style: {
                                                                position: 'absolute',
                                                                top: -10,
                                                                left: 25,
                                                                background: '#f59e0b',
                                                                ...
                                                                borderRadius: 8,
                                                                fontWeight: 600,
                                                            }, children: "\uD83D\uDD12 LOCKED" })), regenerating && (_jsx("span", { style: {
                                                                position: 'absolute',
                                                                top: -10,
                                                                left: locked ? 75 : 25,
                                                                background: '#8b5cf6',
                                                            ...
                                                            }, children: "\u27F3 REGENERATING" })), _jsxs("div", { style: {
                                                                position: 'absolute',
                                                                top: 8,
                                                                right: 8,
                                                                display: 'flex',
                                                                gap: 4,
                                                                opacity: 0.8,
                                                            }, children: [compareMode && (_jsx("button", { onClick: (e) => {
                                                                        e.stopPropagation();
                                                                        ...
                                                                        alignItems: 'center',
                                                                        justifyContent: 'center',
                                                                    }, children: "\uD83D\uDCBE" })] }), hasPath && (_jsx("div", { style: {
                                                                position: 'absolute',
                                                                top: -10,
                                                                right: -10,
                                                                background: '#10b981',
                                                                ...
                                                                borderRadius: 8,
                                                                fontWeight: 500,
                                                            }, children: "PATH" })), regenerating && (_jsx("div", { style: {
                                                                position: 'absolute',
                                                                top: 0,
                                                                left: 0,
                                                                right: 0,
                                                                ...
                                                                color: '#8b5cf6',
                                                                fontWeight: 600,
                                                            }, children: _jsxs("div", { style: { textAlign: 'center' }, children: [_jsx("div", { style: { fontSize: 20, marginBottom: 4 }, children: "\u27F3" }), _jsx("div", { children: "Regenerating..." })] }) })), _jsx("div", { style: { marginTop: 20, marginBottom: 8 }, children: res.error ? (_jsxs("div", { style: { color: '#dc2626', fontSize: 14 }, children: ["\u26A0\uFE0F ", res.error] })) : (_jsx("div", { style: {
                                                                    fontFamily: 'monospace',
                                                                    whiteSpace: 'pre-wrap',
                                                                    fontSize: 13,
                                                                    lineHeight: 1.4,
                                                                    color: '#374151',
                                                                }, children: res.output || ('output' in res ? res.output : '') })) }), locked && (_jsxs("div", { style: {
                                                                marginTop: 8,
                                                                padding: 6,
                                                                background: '#fef3c7',
                                                                ...
                                                                fontSize: 11,
                                                                color: '#92400e',
                                                            }, children: ["\uD83D\uDD12 This result is locked and won't be affected by regeneration", lockedResults.find(l => l.index === i)?.note && (_jsxs("div", { style: { marginTop: 2, fontStyle: 'italic' }, children: ["Note: ", lockedResults.find(l => l.index === i)?.note] }))] })), hasPath && 'executionTimeMs' in res && (_jsxs("div", { style: {
                                                                marginTop: 8,
                                                                padding: 6,
                                                                background: '#e2e8f0',
                                                                borderRadius: 4,
                                                                ...
                                                                borderRadius: 6,
                                                                        ...
                                                                        alignItems: 'center',
                                                                        gap: 6,
                                                                    }, children: ["\uD83C\uDFAC Weight Impact Analysis", _jsx("span", { style: {
                                                                                fontSize: 9,
                                                                                fontWeight: 400,
                                                                                opacity: 0.8,
                                                                                ...
                                                                                padding: '1px 4px',
                                                                                borderRadius: 8,
                                                                            }, children: "Epic 8.5" })] }), res.weightChoices.map((choice, idx) => {
                                                                    ...
                                                                    return (_jsxs("div", { style: {
                                                                            ...
                                                                            justifyContent: 'space-between',
                                                                            alignItems: 'center'
                                                                        }, children: [_jsxs("div", { children: [_jsxs("span", { style: { fontWeight: 600, color: '#1f2937' }, children: [choice.nodeId.slice(0, 12), "..."] }), _jsxs("span", { style: { marginLeft: 4 }, children: ["\"", choice.selectedOption, "\""] })] }), choice.selectionProbability && (_jsxs("div", { style: {
                                                                                    display: 'flex',
                                                                                    alignItems: 'center',
                                                                                    gap: 4,
                                                                                            ...
                                                                                            fontWeight: 600,
                                                                                            fontSize: 9,
                                                                                        }, children: [probabilityPercent, "%"] })] }))] }, idx));
                                                                }), _jsx("div", { style: {
                                                                        marginTop: 6,
                                                                        fontSize: 9,
                                                                        color: '#6b7280',
                                                                        fontStyle: 'italic',
                                                                    }, children: "Real-time weight impact from Story 8.3 controls" })] }))] }, i));
                                            }) })] })), _jsxs("div", { style: {
                                        display: 'flex',
                                        justifyContent: 'space-between',
                                        alignItems: 'center',
                                        ...
                                        borderTop: '1px solid #e5e7eb',
                                    }, children: [_jsxs("div", { style: { fontSize: 12, color: '#6b7280' }, children: [lockedResults.length > 0 && (_jsxs("span", { style: { marginRight: 16 }, children: ["\uD83D\uDD12 ", lockedResults.length, " locked result", lockedResults.length !== 1 ? 's' : ''] })), regeneratingResults.length > 0 && (_jsxs("span", { children: ["\u27F3 ", regeneratingResults.length, " regenerating"] }))] }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [loading && onCancel && (_jsx("button", { onClick: onCancel, style: {
                                                        padding: '8px 16px',
                                                        background: '#ef4444',
                                                        color: '#fff',
                                                        border: 'none',
                                                        ...
                                                        cursor: 'pointer',
                                                        fontSize: 12,
                                                    }, children: "Cancel" })), _jsx("button", { onClick: onClose, style: {
                                                        padding: '8px 16px',
                                                        background: '#4b5563',
                                                        color: '#fff',
                                                        border: 'none',
                                                        ...
                                                        cursor: 'pointer',
                                                        fontSize: 12,
                                                    }, children: "Close" })] })] }), _jsx(ExportOptionsDialog, { open: exportDialog.open, onClose: () => setExportDialog({ open: false, type: 'individual' }), results: results, selectedIndices: exportDialog.type === 'batch' ? selectedForComparison : [], exportType: exportDialog.type, individualIndex: exportDialog.individualIndex, onExport: handleExport })] }) }));
                };
