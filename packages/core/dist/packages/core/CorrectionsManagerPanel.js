                    ...
                    minHeight: '48px'
                            ...
                            marginBottom: '16px'
                                    ...
                                    marginBottom: '16px'
                                                    ...
                                                    fontSize: '12px',
                                                    cursor: 'pointer'
                                                }, children: "Clear All" })] })] }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: filteredAndSortedRules.map((rule) => (_jsxs("div", { style: {
                                        ...
                                        transition: 'background 0.2s ease'
                                                ...
                                                margin: '4px 0 8px 0'
                                                        ...
                                                        borderRadius: '2px',
                                                        marginLeft: '4px'
                                                    }, children: rule.replaceWith })] })] }, rule.id))) }), filteredAndSortedRules.length === 0 && (_jsxs("div", { style: {
                                    textAlign: 'center',
                                    padding: '40px',
                                    color: '#a0aec0'
                                }, children: [_jsx("p", { children: "No correction rules found." }), searchQuery && (_jsx("p", { style: { fontSize: '12px' }, children: "Try adjusting your search or filter criteria." }))] }))] }), _jsxs("div", { style: {
                            padding: '16px',
                            ...
                            background: '#1e2228'
                                            ...
                                            fontSize: '14px',
                                            fontWeight: 500
                                        }, children: "Add Rule" })] })] })] })), editingRule && (_jsx("div", { style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
