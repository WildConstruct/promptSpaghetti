...
(function (ContentType) {
    ...
    ContentType["COMMUNITY_POST"] = "community_post";
...
export var ForumPostType;
(function (ForumPostType) {
    ForumPostType["DISCUSSION"] = "discussion";
    ForumPostType["QUESTION"] = "question";
    ForumPostType["ANNOUNCEMENT"] = "announcement";
    ForumPostType["TUTORIAL"] = "tutorial";
    ForumPostType["SHOWCASE"] = "showcase";
    ForumPostType["FEEDBACK"] = "feedback";
...
export function validateContentModel(type, data) {
    return Epic16ContentSchemas[type].parse(data);
}
export function isValidContentModel(type, data) {
    try {
