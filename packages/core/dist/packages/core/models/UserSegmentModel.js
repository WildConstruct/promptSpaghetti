...
export class SegmentUtils {
     ...
     */
    static evaluateUserForSegment(userAttributes, segment, behaviorHistory) {
        ...
        switch (segment.joinLogic) {
            ...
            case 'any':
                ...
                break;
            case 'complex':
                segmentMatches = this.evaluateComplexLogic(segment.complexLogicExpression || '', segment.conditions, matchingConditions);
                break;
            default:
     ...
     */
    static evaluateCondition(userAttributes, condition, behaviorHistory) {
     ...
     */
    static getFieldValue(userAttributes, field, behaviorHistory) {
     ...
     */
    static evaluateComplexLogic(expression, conditions, matchingConditionIds) {
     ...
     */
    static generateSegmentInsights(segment, analytics) {
        const insights = [];
