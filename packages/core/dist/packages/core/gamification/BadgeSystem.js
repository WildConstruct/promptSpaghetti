...
// Marketplace Badges
{
    ...
    requirements: ['Sell your first template'],
        unlockMessage;
    'Congratulations on your first sale! Welcome to the marketplace.',
        rarity;
    'common',
        points;
    200,
...
}
{
    ...
    'Bestseller',
        description;
    'Template reached 1000+ downloads',
        category;
    'marketplace',
        tier;
    'gold',
        ...
        criteria;
    {
        ...
        'max_template_downloads', target;
        1000;
    }
    requirements: ['Have a template with 1000+ downloads'],
        unlockMessage;
    'Bestseller status achieved! Your template is a community favorite.',
        rarity;
    'rare',
        points;
    1000,
...
// Community Badges
{
    ...
    {
        type: 'count', metric;
        'helpful_reviews', target;
        50;
    }
    requirements: ['Give 50 helpful reviews'],
        unlockMessage;
    'Thank you for being a helpful community member!',
        rarity;
    'uncommon',
        points;
    400,
...
}
{
    ...
    requirements: ['Complete 100 mentoring sessions'],
        unlockMessage;
    'Community Mentor status! You\'re making a real difference.',
        rarity;
    'epic',
        points;
    1500,
...
// Achievement Badges
{
    ...
    'Early Adopter',
        description;
    'Joined during the platform beta',
        category;
    'special',
        tier;
    'diamond',
        ...
        criteria;
    {
        type: 'completion',
            conditions;
        {
            joined_before: Date.now() + (30 * 24 * 60 * 60 * 1000);
        } // 30 days from now
    }
    requirements: ['Join during the beta period'],
        unlockMessage;
    'Welcome, Early Adopter! Thank you for believing in our vision.',
        rarity;
    'legendary',
        points;
    1000,
...
}
{
    ...
    'Collaboration King',
        description;
    'Completed 25+ successful collaborations',
        category;
    'collaboration',
        tier;
    'gold',
    ...
    requirements: ['Complete 25 collaborative projects'],
        unlockMessage;
    'Collaboration King! You excel at working with others.',
        rarity;
    'rare',
        points;
    800,
...
// Milestone Badges
{
    ...
    requirements: ['Reach level 10'],
        unlockMessage;
    'Level 10 achieved! You\'re becoming an experienced creator.',
        rarity;
    'common',
        points;
    500,
...
}
{
    ...
    requirements: ['Reach level 50'],
        unlockMessage;
    'Master Creator status! You\'re among the platform elite.',
        rarity;
    'legendary',
        points;
    2500,
        ...
        if (badge.prerequisites) {
            ...
            if (this.checkBadgeCriteria(badge, userProgress)) {
                ...
                if (unlockEvent) {
                    ...
                    checkBadgeCriteria(badge, Badge, userProgress, UserBadgeProgress);
                    boolean;
                    {
                        ...
                        switch (criteria.type) {
                            ...
                            default:
                                return false;
                                checkVerificationCriteria(metric, string, userId, string);
                                boolean;
                                {
                                    ...
                                    getStatisticValue(metric, string, userProgress, UserBadgeProgress);
                                    number;
                                    {
                                        ...
                                        switch (metric) {
                                            ...
                                            default:
                                                return 0;
                                                checkCompletionCriteria(conditions, (Record), userProgress, UserBadgeProgress);
                                                boolean;
                                                {
                                                                ...
                                                                BadgeUnlockEvent | null;
                                                                {
                                                                    ...
                                                                    if (isLevelUp) {
                                                                        ...
                                                                        number;
                                                                        {
                                                                            ...
                                                                            triggerBadgeUnlockEvent(event, BadgeUnlockEvent);
                                                                            void {
