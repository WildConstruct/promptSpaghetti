...
// ========================================
export const RateLimitingAnalyticsDashboardComponent = ({ analyticsDashboard, className = '', theme = 'light', refreshInterval = 10, enableRealTimeUpdates = true, showAdvancedFeatures = true }) => {
    // Component state
    ...
    // Render Helpers
    // ========================================
    const renderMetricCard = (metric) => (_jsx("div", { className: `
      ...
      `, children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-sm font-medium text-gray-600 dark:text-gray-400", children: metric.title }), _jsxs("div", { className: "flex items-baseline space-x-2 mt-2", children: [_jsx("p", { className: `text-3xl font-semibold ${metric.status === 'critical' ? 'text-red-600 dark:text-red-400' :
                                        metric.status === 'warning' ? 'text-yellow-600 dark:text-yellow-400' :
                                            'text-gray-900 dark:text-white'}`, children: metric.value }), metric.unit && (_jsx("span", { className: "text-sm text-gray-500 dark:text-gray-400", children: metric.unit }))] }), _jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 mt-1", children: metric.description })] }), _jsxs("div", { className: "flex flex-col items-end space-y-2", children: [_jsxs("div", { className: `
          ...
          ` })] })] }) }, metric.id));
    const renderAlertPanel = () => (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsxs("h3", { className: "text-lg font-medium text-gray-900 dark:text-white", children: ["Active Alerts (", alertSummary.total, ")"] }) }), _jsx("div", { className: "p-6", children: alertSummary.total === 0 ? (_jsxs("div", { className: "text-center py-8", children: [_jsx("div", { className: "text-4xl mb-2", children: "\u2705" }), _jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "No active alerts" })] })) : (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("h4", { className: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "By Type" }), Object.entries(alertSummary.byType).map(([type, count]) => (_jsxs("div", { className: "flex justify-between text-sm", children: [_jsxs("span", { className: "text-gray-600 dark:text-gray-400 capitalize", children: [type.replace('_', ' '), ":"] }), _jsx("span", { className: "font-medium", children: count })] }, type)))] }), _jsxs("div", { children: [_jsx("h4", { className: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "By Severity" }), Object.entries(alertSummary.bySeverity).map(([severity, count]) => (_jsxs("div", { className: "flex justify-between text-sm", children: [_jsxs("span", { className: `capitalize ${severity === 'critical' ? 'text-red-600 dark:text-red-400' :
                                                        severity === 'error' ? 'text-red-500 dark:text-red-400' :
                                                            severity === 'warning' ? 'text-yellow-600 dark:text-yellow-400' :
                                                                'text-blue-600 dark:text-blue-400'}`, children: [severity, ":"] }), _jsx("span", { className: "font-medium", children: count })] }, severity)))] })] }), _jsxs("div", { children: [_jsx("h4", { className: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Recent Alerts" }), _jsx("div", { className: "space-y-2", children: alertSummary.recent.map((alert) => (_jsx("div", { className: `
                    ...
                    `, children: _jsx("div", { className: "flex justify-between items-start", children: _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: alert.message }), _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400 mt-1", children: [alert.type, " \u2022 ", alert.timestamp.toLocaleString()] })] }) }) }, alert.id))) })] })] })) })] }));
    const renderThreatAnalysis = () => {
        if (!securityAnalytics)
            return null;
        return (_jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white", children: "Attack Patterns" }) }), _jsx("div", { className: "p-6", children: securityAnalytics.threatAnalysis.attackPatterns.length === 0 ? (_jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "No attack patterns detected" })) : (_jsx("div", { className: "space-y-4", children: securityAnalytics.threatAnalysis.attackPatterns.map((pattern) => (_jsxs("div", { className: `
                    ...
                    `, children: [_jsxs("div", { className: "flex justify-between items-start mb-2", children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white capitalize", children: pattern.patternType.replace('_', ' ') }), _jsx("span", { className: `
                      ...
                      `, children: pattern.severity })] }), _jsxs("div", { className: "text-sm text-gray-600 dark:text-gray-400 space-y-1", children: [_jsxs("div", { children: ["Frequency: ", pattern.frequency, " occurrences"] }), _jsxs("div", { children: ["Affected: ", pattern.affectedEndpoints.join(', ')] }), _jsxs("div", { children: ["Source IPs: ", pattern.sourceIPs.join(', ')] })] }), _jsxs("div", { className: "mt-3", children: [_jsx("p", { className: "text-xs font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Countermeasures:" }), _jsx("ul", { className: "text-xs text-gray-600 dark:text-gray-400 space-y-1", children: pattern.countermeasures.map((measure, index) => (_jsxs("li", { children: ["\u2022 ", measure] }, index))) })] })] }, pattern.patternId))) })) })] }), _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white", children: "Geographic Threats" }) }), _jsx("div", { className: "p-6", children: _jsx("div", { className: "space-y-4", children: securityAnalytics.threatAnalysis.geographicThreats.map((threat, index) => (_jsxs("div", { className: "flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg", children: [_jsxs("div", { children: [_jsxs("p", { className: "font-medium text-gray-900 dark:text-white", children: [threat.country, " ", threat.region !== 'Various' && `(${threat.region})`] }), _jsxs("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: [threat.threatCount, " threats \u2022 ", threat.suspiciousActivities.join(', ')] })] }), _jsx("div", { className: `
                  ...
                  `, children: threat.threatLevel })] }, index))) }) })] })] }));
    };
    const renderPredictiveInsights = () => {
        if (!predictiveInsights || !showAdvancedFeatures)
            return null;
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white", children: "Threat Predictions" }) }), _jsx("div", { className: "p-6", children: predictiveInsights.threatPredictions.length === 0 ? (_jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "No threat predictions available" })) : (_jsx("div", { className: "space-y-4", children: predictiveInsights.threatPredictions.map((prediction) => (_jsxs("div", { className: `
    ...
    return (_jsx("div", { className: `p-6 ${className} ${theme === 'dark' ? 'dark' : ''}`, children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white", children: "Security Analytics Dashboard" }), _jsx("p", { className: "text-gray-600 dark:text-gray-400 mt-2", children: "Comprehensive security intelligence and predictive analytics platform" })] }), renderControls(), selectedView === 'overview' && (_jsxs("div", { className: "space-y-6", children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4", children: metricCards.map(renderMetricCard) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsx("div", { className: "lg:col-span-1", children: renderAlertPanel() }), _jsx("div", { className: "lg:col-span-2", children: renderThreatAnalysis() })] })] })), selectedView === 'security' && renderThreatAnalysis(), selectedView === 'predictive' && renderPredictiveInsights(), selectedView === 'performance' && (_jsx("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6", children: _jsxs("div", { className: "text-center py-12", children: [_jsx("div", { className: "text-4xl mb-4", children: "\u26A1" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "Performance Analytics" }), _jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Detailed performance metrics and analysis coming soon" })] }) })), selectedView === 'business' && (_jsx("div", { className: "bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6", children: _jsxs("div", { className: "text-center py-12", children: [_jsx("div", { className: "text-4xl mb-4", children: "\uD83D\uDCBC" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "Business Intelligence" }), _jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Business impact analysis and ROI metrics coming soon" })] }) }))] }) }));
};
// ========================================
// Utility Functions
// ========================================
