...
})(IssueCategory || (IssueCategory = {}));
{
    DETECTED = 'DETECTED',
        ...
        RESOLVED = 'RESOLVED',
        IGNORED = 'IGNORED';
    export let RollbackTriggerType;
        ...
        }
        {
            ...
            if (this.config.defaultValidations.length > 0) {
                ...
                Promise < PreviewValidationResult > {
                    ...
                    for(, validationType, of, validationTypes) {
                ...
                async;
                cleanupStagingDeployments(preview, PolicyPreview);
                Promise < void  > { /* Implementation */};
                async;
                executeRollback(deployment, StagingDeployment);
                Promise < void  > { /* Implementation */};
                startPeriodicTasks();
                void { /* Implementation for cleanup, monitoring, etc. */};
