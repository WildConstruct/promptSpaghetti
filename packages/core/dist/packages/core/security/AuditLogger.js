            ...
            emit(event, string, ...args, unknown);
            {
                ...
                if (listeners) {
                    ...
                    (function (AuditOperation) {
                        ...
                        */
                        AuditOperation[AuditOperation["export"] = void 0] = "export";
                        AuditOperation[AuditOperation["interface"] = void 0] = "interface";
                        AuditOperation[AuditOperation["AuditLoggerConfig"] = void 0] = "AuditLoggerConfig";
                    ...
                    (function (AuditLogLevel) {
                        ...
                        */
                        AuditLogLevel[AuditLogLevel["export"] = void 0] = "export";
                        AuditLogLevel[AuditLogLevel["class"] = void 0] = "class";
                        AuditLogLevel[AuditLogLevel["AuditLogger"] = void 0] = "AuditLogger";
                        AuditLogLevel[AuditLogLevel["extends"] = void 0] = "extends";
                        AuditLogLevel[AuditLogLevel["BrowserEventEmitter"] = void 0] = "BrowserEventEmitter";
                                            ...
                                            checkForAnomalies(entry) {
                                                ...
                                                if (!entry.success && thresholds.failedAccessAttempts) {
                                                    ...
                                                    type: 'REPEATED_FAILURES',
                                                        entry,
                                                        threshold;
                                                    thresholds.failedAccessAttempts,
                                                    ;
                                                }
                                                ;
                                                ...
                                                if (entry.sensitiveAccess && thresholds.sensitiveDataAccess) {
                                                    ...
                                                    type: 'EXCESSIVE_SENSITIVE_ACCESS',
                                                        entry,
                                                        threshold;
                                                    thresholds.sensitiveDataAccess,
                                                    ;
                                                }
                                                ;
                                                /**
