                                ...
                                if (!req.user?.id) {
                                    ...
                                    if (!classification) {
                                        ...
                                        if (!decision.granted) {
                                            ...
                                            decision.requiredAuthentication,
                                                requiredAuthorization;
                                            decision.requiredAuthorization,
                                            ;
                                        }
                                        ;
                                                    ...
                                                    try {
                                                        ...
                                                        if (!classification) {
                                                            ...
                                                            req: ClassificationAwareRequest,
                                                                config;
                                                            ClassificationEnforcementMiddlewareConfig,
                                                            ;
                                                                                                                    ...
                                                                                                                    if (req.secure || req.headers['x-forwarded-proto'] === 'https') {
                                                                                                                        ...
                                                                                                                        if (headerControls) {
                                                                                                                            ...
                                                                                                                            error: 'Classification enforcement error',
                                                                                                                                message;
                                                                                                                            config.detailedErrors ? error.message : 'Internal server error',
                                                                                                                            ;
                                                                                                                        }
                                                                                                                        ;
                                                                                                                        /**
