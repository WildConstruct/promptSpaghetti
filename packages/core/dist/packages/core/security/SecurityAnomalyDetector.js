...
})(AnomalyType || (AnomalyType = {}));
{
    ...
    (function (AlertType) {
        ...
        AlertType[AlertType["export"] = void 0] = "export";
        AlertType[AlertType["interface"] = void 0] = "interface";
        AlertType[AlertType["NotificationChannel"] = void 0] = "NotificationChannel";
    })(AlertType || (AlertType = {}));
    {
    ...
    (function (DetectionModelType) {
        ...
        DetectionModelType[DetectionModelType["export"] = void 0] = "export";
        DetectionModelType[DetectionModelType["interface"] = void 0] = "interface";
        DetectionModelType[DetectionModelType["SecurityMetric"] = void 0] = "SecurityMetric";
    ...
    if (!baseline) {
            ...
            }
            {
                ...
                }
                {
                    ...
                    if (recentValues.length < 20) {
                        ...
                        async;
                        handleAnomaly(anomaly, SecurityAnomaly);
                        Promise < void  > {
                            // Store anomaly
                            this: .detectedAnomalies.set(anomaly.id, anomaly),
                            : .config.enableCorrelationAnalysis
                        };
                        {
                            ...
                            if (anomaly.confidence >= this.config.alertThreshold) {
                                ...
                                console.log() `🔍 SECURITY ANOMALY: ${anomaly.anomalyType} in ${anomaly.affectedSystems.join()}
        ',
        '
                            ...
                            async;
                            performCorrelationAnalysis(anomaly, SecurityAnomaly);
                            Promise < void  > {
                                ...
                                if (timeDiff <= timeWindow) {
                                    ...
                                    if (systemOverlap || this.calculateCorrelationScore(anomaly, otherAnomaly) > 0.7) {
                                        ...
                                        if (correlatedAnomalies.length >= 3) {
                                            ...
                                            calculateCorrelationScore(anomaly1, SecurityAnomaly, anomaly2, SecurityAnomaly);
                                            number;
                                            {
                                                let score = 0;
                                                ...
                                                async;
                                                generateAlert(anomaly, SecurityAnomaly);
                                                Promise < void  > {
                                        ...
                                        break;
                                        scheduleEscalation(alert, SecurityAlert);
                                        void {
                        ...
                        try { }
                            ...
                            async;
                            updateBaseline(metric, SecurityMetric);
                            Promise < void  > {
                                const: metricKey = `${metric.systemName}:${metric.metricName}`
                            };
                            ...
                            if (!baseline) {
                                ...
                                if (recentValues.length >= 30) { // Minimum data points for meaningful baseline
                                    ...
                                    if (this.config.enableAdaptiveThresholds) {
                                        ...
                                        createNewBaseline(metric, SecurityMetric);
                                        MetricBaseline;
                                        {
                                            return {
                                            ...
                                            updateSeasonalPatterns(baseline, MetricBaseline, values, number);
                                            void {
                                            ...
                                            { // 1 week of hourly data
                                                ...
                                                storeMetric(metric, SecurityMetric);
                                                void {
                                                    const: metricKey = `${metric.systemName}:${metric.metricName}`
                                                };
                                                if (!this.metricHistory.has(metricKey)) {
                                                    ...
                                                    if (history.length > maxHistory) {
                                                        ...
                                                        getRecentMetricValues(metricKey, string, count, number);
                                                        number;
                                                        {
                                                            const history = this.metricHistory.get(metricKey) || [];
                                                            ...
                                                            number;
                                                            {
                                                                ...
                                                                calculateStandardDeviation(values, number, mean, number);
                                                                number;
                                                                {
                                                                    ...
                                                                    number;
                                                                    {
                                                                        ...
                                                                        number;
                                                                        {
                                                                            ...
                                                                            calculateHourlyPattern(values, number);
                                                                            number;
                                                                            {
                                                                                ...
                                                                                calculatePatternStrength(pattern, number);
                                                                                number;
                                                                                {
                                                                                ...
                                                                                ;
                                                                                calculateAnomalySeverity(deviationMagnitude, number, confidence, number);
                                                                                AnomalySeverity;
                                                                                {
                                                                                    ...
                                                                                    AnomalyRiskAssessment;
                                                                                    {
                                                                                        ...
                                                                                        return {
                                                                                            ...
                                                                                            estimatedDowntime;
                                                                                        Math.min(240, baseRisk * 2.4), // minutes,
                                                                                            affectedUserCount;
                                                                                        Math.min(10000, baseRisk * 50),
                                                                                            dataExposureRisk;
                                                                                        Math.min(100, baseRisk * 0.7),
                                                                                        ;
                                                                                    }
                                                                                    ;
                                                                                    mapModelToAnomalyType(modelType, DetectionModelType);
                                                                                    AnomalyType;
                                                                                    {
                                                                                        const mapping = {
                                                                                        ...
                                                                                        mapAnomalyToAlertType(anomalyType, AnomalyType);
                                                                                        AlertType;
                                                                                        {
                                                                                            const mapping = {
                                                                                            ...
                                                                                            escalateSeverity(severity, AnomalySeverity);
                                                                                            AnomalySeverity;
                                                                                            {
                                                                                                const escalation = {
                                                                                                ...
                                                                                                generateAlertTitle(anomaly, SecurityAnomaly);
                                                                                                string;
                                                                                                {
      ...
      ' '
                                                                                                ...
                                                                                                generateAlertDescription(anomaly, SecurityAnomaly);
                                                                                                string;
                                                                                                {
                                                                                        ...
                                                                                        getTargetChannels(severity, AnomalySeverity);
                                                                                        NotificationChannel;
                                                                                        {
                                                                                            ...
                                                                                            async;
                                                                                            isRateLimited(channel, NotificationChannel, alert, SecurityAlert);
                                                                                            Promise < boolean > {
