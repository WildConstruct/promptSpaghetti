...
(function (SessionPriority) {
    ...
    SessionPriority[SessionPriority["export"] = void 0] = "export";
    SessionPriority[SessionPriority["enum"] = void 0] = "enum";
    SessionPriority[SessionPriority["EvictionPolicy"] = void 0] = "EvictionPolicy";
})(SessionPriority || (SessionPriority = {}));
{
    ...
    (function (ConflictResolution) {
        ...
        ConflictResolution[ConflictResolution["export"] = void 0] = "export";
        ConflictResolution[ConflictResolution["interface"] = void 0] = "interface";
        ConflictResolution[ConflictResolution["SessionPriorityConfig"] = void 0] = "SessionPriorityConfig";
                    ...
                    if (userSessions && userSessions.size >= this.config.maxSessionsPerUser) {
                        ...
                        if (deviceSessionIds && deviceSessionIds.size >= this.config.maxSessionsPerDevice) {
                            ...
                            if (this.sessions.size >= this.config.maxTotalSessions) {
                                ...
                                ;
                                return conflicts;
                                resolveConflict(conflict, SessionConflict);
                                {
                                    resolved: boolean;
                                    evicted ?  : string;
                                    gracePeriod ?  : number;
                                }
                                {
                                    switch (conflict.recommendedResolution) {
                                                                    ...
                                                                    if (resolution.evicted) {
                                                                        ...
                                                                        PrioritySessionData;
                                                                        {
                                                                            ...
                                                                            const conflict = {
                                                                                ...
                                                                                : .config.evictionPolicy }, { case: EvictionPolicy, LRU: , sessionToEvict = sessions.reduce((oldest, current) => current.lastActivity < oldest.lastActivity ? current : oldest) };
                                                                            break;
                                                                        }
                                                                    }
                                                                }
                                        ...
                                        default:
                                            ...
                                            calculateHybridScore(session, PrioritySessionData);
                                            number;
                                            {
                                                ...
                                                evictOldestSession(sessionIds, string);
                                                {
                                                    resolved: boolean;
                                                    evicted ?  : string;
                                                }
                                                {
                                                    ...
                                                    evictLowestPrioritySession(sessionIds, string);
                                                    {
                                                        resolved: boolean;
                                                        evicted ?  : string;
                                                    }
                                                    {
                                                        ...
                                                        if (lowestPriority.evictionProtection) {
                                                            ...
                                                            offerUserChoice(conflict, SessionConflict);
                                                            {
                                                                resolved: boolean;
                                                                gracePeriod ?  : number;
                                                            }
                                                            {
                                                                ...
                                                                updateUserSessions(userId, string, sessionId, string);
                                                                void {
                                                                ...
                                                                };
                                                                {
                                                                    ...
                                                                    updateDeviceSessions(deviceId, string, sessionId, string);
                                                                    void {
                                                                        : .deviceSessions.has(deviceId) };
                                                                    {
                                                                        ...
                                                                        void {
                                                                            ...
                                                                            : .userSessions.get(session.userId)?.size === 0 };
                                                                        {
