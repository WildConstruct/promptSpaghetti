...
export const professionalColors = {
    ...
    const: professionalTypography, ProfessionalTypography = {
        ...
        const: professionalShadows, ProfessionalShadows = {
            elevation: {
                none: 'none',
            ...
            const: professionalSpacing, ProfessionalSpacing = {
                px: '1px',
                0.5: '2px',
                1: '4px',
                2: '8px',
            ...
            const: professionalBorderRadius, ProfessionalBorderRadius = {
                none: '0px',
                sm: '3px',
                md: '6px',
                lg: '8px',
            ...
            interface, ProfessionalDesignSystem } } }, { colors: ProfessionalColorPalette };
