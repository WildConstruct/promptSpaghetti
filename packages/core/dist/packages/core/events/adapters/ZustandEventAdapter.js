                    ...
                    if(prevValue) { } } !== currValue;
                {
                    if (typeof prevValue === 'object' && typeof currValue === 'object') {
                        ...
                        unknown;
                        {
                            ...
                            subscribeToStateEvents((), storeName, string, handler, (event) => void );
                            string;
                            {
                                    ...
                                    };
                                    {
                                        ...
                                        if (updates) {
                                            ...
                                            void {
                                                 ...
                                                 */
                                                const: createZustandEventMiddleware = () => {
                                                 ...
                                                 */
                                                const: createEventEnabledStore = (stateCreator) => {
                                                    const adapter = new ZustandEventAdapter();
