...
export const DependencyGraphPanel = ({ dependencyGraph, onGenerateGraph, selectedDomain, onDomainChange }) => {
    ...
    const renderGraph = () => {
        if (!dependencyGraph || dependencyGraph.nodes.length === 0) {
            return (_jsxs("div", { className: "empty-graph", children: [_jsx("span", { children: "\uD83D\uDD17" }), _jsx("p", { children: "No dependency graph generated" }), _jsx("button", { className: "generate-btn", onClick: onGenerateGraph, children: "Generate Graph" })] }));
        }
        ...
        return (_jsxs("svg", { ref: svgRef, width: svgWidth, height: svgHeight, viewBox: `0 0 ${svgWidth} ${svgHeight}`, style: { transform: `scale(${zoom})` }, className: "dependency-graph-svg", children: [_jsx("rect", { width: svgWidth, height: svgHeight, fill: "var(--devtools-bg, #1e1e1e)" }), _jsx("defs", { children: _jsx("pattern", { id: "grid", width: "20", height: "20", patternUnits: "userSpaceOnUse", children: _jsx("path", { d: "M 20 0 L 0 0 0 20", fill: "none", stroke: "var(--devtools-border, #333)", strokeWidth: "0.5", opacity: "0.3" }) }) }), _jsx("rect", { width: svgWidth, height: svgHeight, fill: "url(#grid)" }), _jsx("g", { className: "edges", children: filteredEdges.map(edge => {
                        ...
                        return (_jsxs("g", { children: [_jsx("line", { x1: fromNode.position.x, y1: fromNode.position.y, x2: toNode.position.x, y2: toNode.position.y, stroke: strokeColor, strokeWidth: strokeWidth, opacity: opacity, markerEnd: "url(#arrowhead)" }), filters.showLabels && edge.label && (_jsx("text", { x: (fromNode.position.x + toNode.position.x) / 2, y: (fromNode.position.y + toNode.position.y) / 2, fill: "var(--devtools-text-secondary, #aaa)", fontSize: "10", textAnchor: "middle", className: "edge-label", children: edge.label }))] }, edge.id));
                    }) }), _jsx("defs", { children: _jsx("marker", { id: "arrowhead", markerWidth: "10", markerHeight: "7", refX: "9", refY: "3.5", orient: "auto", children: _jsx("polygon", { points: "0 0, 10 3.5, 0 7", fill: "#61dafb" }) }) }), _jsx("g", { className: "nodes", children: filteredNodes.map(node => {
                        const nodeSize = getNodeSize(node);
                        const nodeColor = getNodeColor(node.type);
                        const isSelected = selectedNode === node.id;
                        const strokeWidth = isSelected ? 3 : 1;
                        const strokeColor = isSelected ? '#fff' : nodeColor;
                        return (_jsxs("g", { className: "node", onClick: () => handleNodeClick(node.id), children: [_jsx("circle", { cx: node.position.x, cy: node.position.y, r: nodeSize, fill: nodeColor, stroke: strokeColor, strokeWidth: strokeWidth, opacity: 0.9, className: "node-circle" }), filters.showLabels && (_jsx("text", { x: node.position.x, y: node.position.y + nodeSize + 15, fill: "var(--devtools-text, #fff)", fontSize: "10", textAnchor: "middle", className: "node-label", children: node.label })), filters.showMetrics && (_jsx("text", { x: node.position.x, y: node.position.y - nodeSize - 5, fill: "var(--devtools-text-secondary, #aaa)", fontSize: "8", textAnchor: "middle", className: "node-metric", children: node.metadata.accessCount }))] }, node.id));
                    }) })] }));
    };
    const selectedNodeData = selectedNode && dependencyGraph?.nodes.find(n => n.id === selectedNode);
    return (_jsxs("div", { className: "dependency-graph-panel", children: [_jsxs("div", { className: "graph-controls", children: [_jsx("div", { className: "control-group", children: _jsxs("label", { children: ["Domain:", _jsxs("select", { value: selectedDomain, onChange: (e) => onDomainChange(e.target.value), children: [_jsx("option", { value: "all", children: "All Domains" }), dependencyGraph?.nodes &&
                                            [...new Set(dependencyGraph.nodes.map(node => node.domain))].map(domain => (_jsx("option", { value: domain, children: domain }, domain)))] })] }) }), _jsx("div", { className: "control-group", children: _jsxs("label", { children: ["Layout:", _jsxs("select", { value: layout, onChange: (e) => setLayout(e.target.value), children: [_jsx("option", { value: "hierarchical", children: "Hierarchical" }), _jsx("option", { value: "force", children: "Force-directed" }), _jsx("option", { value: "circular", children: "Circular" })] })] }) }), _jsxs("div", { className: "control-group", children: [_jsx("span", { children: "Filters:" }), _jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: filters.includeComponents, onChange: (e) => handleFilterChange('includeComponents', e.target.checked) }), "Components"] }), _jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: filters.includeSelectors, onChange: (e) => handleFilterChange('includeSelectors', e.target.checked) }), "Selectors"] }), _jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: filters.includeCrossDomainLinks, onChange: (e) => handleFilterChange('includeCrossDomainLinks', e.target.checked) }), "Cross-domain"] })] }), _jsxs("div", { className: "control-group", children: [_jsx("span", { children: "Display:" }), _jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: filters.showLabels, onChange: (e) => handleFilterChange('showLabels', e.target.checked) }), "Labels"] }), _jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: filters.showMetrics, onChange: (e) => handleFilterChange('showMetrics', e.target.checked) }), "Metrics"] })] }), _jsxs("div", { className: "control-group", children: [_jsx("span", { children: "Zoom:" }), _jsx("button", { className: "zoom-btn", onClick: handleZoomOut, children: "\u2212" }), _jsxs("span", { className: "zoom-level", children: [Math.round(zoom * 100), "%"] }), _jsx("button", { className: "zoom-btn", onClick: handleZoomIn, children: "+" }), _jsx("button", { className: "zoom-btn", onClick: handleResetZoom, children: "Reset" })] }), _jsx("button", { className: "regenerate-btn", onClick: onGenerateGraph, children: "Regenerate" })] }), _jsxs("div", { className: "graph-content", children: [_jsx("div", { className: "graph-viewer", children: renderGraph() }), selectedNodeData && (_jsxs("div", { className: "node-details", children: [_jsx("h4", { children: "Node Details" }), _jsxs("div", { className: "detail-section", children: [_jsx("h5", { children: "Basic Info" }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "ID:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.id })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Type:" }), _jsx("span", { className: "detail-value", style: { color: getNodeColor(selectedNodeData.type) }, children: selectedNodeData.type })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Domain:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.domain })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Label:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.label })] })] }), _jsxs("div", { className: "detail-section", children: [_jsx("h5", { children: "Dependencies" }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Dependencies:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.metadata.dependencies.length })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Dependents:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.metadata.dependents.length })] })] }), _jsxs("div", { className: "detail-section", children: [_jsx("h5", { children: "Performance" }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Access Count:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.metadata.accessCount })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Avg Execution:" }), _jsx("span", { className: "detail-value", children: formatPerformanceMetric(selectedNodeData.metadata.performance.averageExecutionTime) })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Total Executions:" }), _jsx("span", { className: "detail-value", children: selectedNodeData.metadata.performance.totalExecutions })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Error Count:" }), _jsx("span", { className: "detail-value error-count", children: selectedNodeData.metadata.performance.errorCount })] })] }), _jsxs("div", { className: "detail-section", children: [_jsx("h5", { children: "Relationships" }), _jsxs("div", { className: "relationship-list", children: [selectedNodeData.metadata.dependencies.map(depId => (_jsxs("div", { className: "relationship-item dependency", children: [_jsx("span", { className: "relationship-arrow", children: "\u2190" }), _jsx("span", { className: "relationship-id", children: depId })] }, depId))), selectedNodeData.metadata.dependents.map(depId => (_jsxs("div", { className: "relationship-item dependent", children: [_jsx("span", { className: "relationship-arrow", children: "\u2192" }), _jsx("span", { className: "relationship-id", children: depId })] }, depId)))] })] })] }))] }), dependencyGraph && (_jsxs("div", { className: "graph-stats", children: [_jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Nodes:" }), _jsx("span", { className: "stat-value", children: dependencyGraph.metadata.totalNodes })] }), _jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Edges:" }), _jsx("span", { className: "stat-value", children: dependencyGraph.metadata.totalEdges })] }), _jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Complexity:" }), _jsx("span", { className: "stat-value", children: dependencyGraph.metadata.complexity })] }), _jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Circular Dependencies:" }), _jsx("span", { className: "stat-value circular-deps", children: dependencyGraph.metadata.circularDependencies.length })] })] })), _jsx("style", { jsx: true, children: `
