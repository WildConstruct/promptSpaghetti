import { Workspace, Project, Resource, WorkspaceMember, ProjectMember, ActivityEvent, Comment, Notification, WorkspaceRole, ProjectRole, ResourceType } from '../types/workspace';
                                                                                        ...
                                                                                        if(result) { }, : .rows.length === 0 };
                                                                                    {
                                                                                        ...
                                                                                        Promise < ProjectMember > {
                                                                                            ...
                                                                                            async logActivity(event) {
                                                                                                ...
                                                                                                return result.rows[0];
                                                                                                async;
                                                                                                getWorkspaceActivity(workspaceId, WorkspaceId);
                                                                                                limit: number = 50,
                                                                                                    offset;
                                                                                                number = 0;
