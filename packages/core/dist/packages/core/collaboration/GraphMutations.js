...
(function (OperationPriority) {
     ...
     */
    OperationPriority[OperationPriority["export"] = 5] = "export";
    OperationPriority[OperationPriority["interface"] = 6] = "interface";
    OperationPriority[OperationPriority["NodeAddOperation"] = 7] = "NodeAddOperation";
    OperationPriority[OperationPriority["extends"] = 8] = "extends";
    OperationPriority[OperationPriority["BaseMutationOperation"] = 9] = "BaseMutationOperation";
    ...
    */
    ...
    (function (ConflictType) {
        ...
        */
        ...
        ConflictType[ConflictType["ResolutionStrategy"] = void 0] = "ResolutionStrategy";
    ...
    z.string().optional(),
        operationVector;
    VersionVectorSchema.optional(),
        dependencies;
    z.array(z.string()).optional(),
        priority;
    z.nativeEnum(OperationPriority).optional(),
    ;
}
;
/**
...
z.string().optional(),
    edgeType;
z.enum(['data', 'control', 'conditional']),
    metadata;
z.record(z.unknown()).optional(),
    timestamp;
z.number().positive(),
