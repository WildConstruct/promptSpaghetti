import { SemanticVersion, UpgradePath, extensionVersionManager } from './ExtensionVersionManager';
                                                    ...
                                                    if (context.featurePriority) {
                                                        ...
                                                        VersionRecommendation;
                                                        {
                                                            ...
                                                            if (latestPatch) {
                                                                ...
                                                                'high',
                                                                    reason;
                                                                'Latest patch version with bug fixes and security updates',
                                                                    risk;
                                                                'low',
                                                                    benefits;
                                                            ...
                                                            if (latestMinor && latestMinor.minor > currentVersion.minor) {
                                                                ...
                                                                'medium',
                                                                    reason;
                                                                'Latest minor version with new features',
                                                                    risk;
                                                                'low',
                                                                    benefits;
                                                            ...
                                                            VersionRecommendation;
                                                            {
                                                                ...
                                                                if (latestStable && latestStable.major > currentVersion.major) {
                                                                    ...
                                                                    'medium',
                                                                        reason;
                                                                    'Latest stable major version with significant improvements',
                                                                        risk;
                                                                    'medium',
                                                                        benefits;
                                                                    ['Major improvements', 'New features', 'Performance gains'],
                                                                        effort;
                                                                    'medium',
                                                                    ;
                                                                }
                                                                ...
                                                                VersionRecommendation;
                                                                {
                                                                    ...
                                                                    if (latestVersion && latestVersion.isPrerelease()) {
                                                                        ...
                                                                        'low',
                                                                            reason;
                                                                        'Latest prerelease version with cutting-edge features',
                                                                            risk;
                                                                        'high',
                                                                            benefits;
                                                                        ['Latest features', 'Early access to improvements'],
                                                                            effort;
                                                                        'high',
                                                                        ;
                                                                    }
                                                                    ...
                                                                    MigrationTask;
                                                                    {
                                                                        ...
                                                                        'Backup current extension',
                                                                            description;
                                                                        'Create backup of current extension and data',
                                                                            type;
                                                                        'preparation',
                                                                            required;
                                                                        true,
                                                                ...
                                                                for (const rule of rules) {
                                                                        ...
                                                                        UpgradeRisk;
                                                                        {
                                                                            ...
                                                                            if (breakingChanges.hasBreakingChanges) {
                                                                                ...
                                                                                type: 'breaking-changes',
                                                                                    severity;
                                                                                breakingChanges.impactLevel,
                                                                                    description;
                                                                                `${breakingChanges.changes.length} breaking changes detected`;
                                                                            }
                                                                        }
                                                                    ...
                                                                    'Potential conflicts with existing dependencies',
                                                                        mitigation;
                                                                    'Validate all dependencies before upgrade',
                                                                        probability;
                                                                    'medium',
                                                                    ;
                                                                }
                                                                ...
                                                                if (this.requiresDataBackup(currentExtension, { version: targetVersion })) {
                                                                    ...
                                                                    'high',
                                                                        description;
                                                                    'Potential data loss during upgrade',
                                                                        mitigation;
                                                            ...
                                                            'Aggressive',
                                                                description;
                                                            'Prioritizes latest features over stability',
                                                                maxMajorVersionJump;
                                                            999,
                                                                allowPrerelease;
                                                            true,
                                                        ...
                                                        ;
                                                        calculateImpactLevel(changes, BreakingChange);
                                                        'low' | 'medium' | 'high';
                                                        {
                                                            if (changes.length === 0)
                                                                return 'low';
                                                            ...
                                                            DependencyConflict;
                                                            {
                                                                ...
                                                                return conflicts;
                                                                analyzePermissionChanges((), currentExtension, ExtensionManifest, targetExtension, ExtensionManifest);
                                                                PermissionChange;
                                                                {
                                                                    const changes = [];
                                                                    // Implementation would analyze permission differences
                                                                    return changes;
                                                                    requiresRestart(currentExtension, ExtensionManifest, targetExtension, ExtensionManifest);
                                                                    boolean;
                                                                    {
                                                                        // Check if upgrade requires system restart
                                                                        return currentExtension.extension_type !== targetExtension.extension_type;
                                                                        requiresDataBackup(currentExtension, ExtensionManifest, targetExtension, ExtensionManifest);
                                                                        boolean;
                                                                        {
                                                                            ...
                                                                            estimateUpgradeEffort(tasks, MigrationTask, risks, UpgradeRisk);
                                                                            EffortEstimate;
                                                                            {
                                                                                ...
                                                                                if (totalTasks <= 3 && highRiskTasks === 0) {
                                                                                    ...
                                                                                    if (totalTasks <= 6 && highRiskTasks <= 1) {
                                                                                        ...
                                                                                        generateUpgradeTimeline(path, UpgradePath, tasks, MigrationTask);
                                                                                        UpgradeTimeline;
                                                                                        {
                                                                                            return {
                                                                                                phases: [,
                                                                                            ...
                                                                                            generateMigrationPhases(analysis, UpgradeAnalysis);
                                                                                            MigrationPhase;
                                                                                            {
                                                                                                return [
                                                                                                    {
                                                                                                ...
                                                                                                generateRollbackPlan(currentExtension, ExtensionManifest, targetVersion, string);
                                                                                                RollbackPlan;
                                                                                                {
                                                                                                    return {
                                                                                                        steps: [,
                                                                                                    ...
                                                                                                    generateTestingPlan(currentExtension, ExtensionManifest, targetVersion, string);
                                                                                                    TestingPlan;
                                                                                                    {
                                                                                                        return {
                                                                                                            preUpgradeTests: [,
                                                                                                        ...
                                                                                                        identifyPrerequisites(currentExtension, ExtensionManifest, targetVersion, string, context, UpgradeContext);
                                                                                                        string;
                                                                                                        {
                                                                                                            const prerequisites = [];
