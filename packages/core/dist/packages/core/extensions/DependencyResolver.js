 ...
 */
buildDependencyGraph(manifests, ExtensionManifest);
DependencyGraph;
{
    const graph = {
        nodes: new Map(),
                ...
                for (const [nodeId, node] of graph.nodes) {
                    for (const depId of node.dependencies) {
                        ...
                        if (depNode) {
                             ...
                             */
                            resolveLoadOrder(graph, DependencyGraph);
                            LoadOrder;
                            {
                                if (!graph.resolved) {
                                                    ...
                                                    for (const nodeId of startNodes) {
                                                        ...
                                                        for (const nodeId of graph.nodes.keys()) {
                                                            if (!visited.has(nodeId)) {
                                                                ...
                                                                */
                                                                detectCircularDependencies(graph, DependencyGraph);
                                                                CircularDependency;
                                                                {
                                                                    ...
                                                                    const dfs = (nodeId) => {
                                                                        if (recursionStack.has(nodeId)) {
                                                                            ...
                                                                            cycle,
                                                                                breakable,
                                                                                suggestions;
                                                                            this.generateCircularDependencySuggestions(cycle),
                                                                            ;
                                                                        }
                                                                        ;
                                                                        return true;
                                                                                    ...
                                                                                    if (graph.nodes.has(depId)) {
                                                                                        ...
                                                                                        for (const nodeId of graph.nodes.keys()) {
                                                                                            if (!visited.has(nodeId)) {
                                                                                                ...
                                                                                                */
                                                                                                detectVersionConflicts(manifests, ExtensionManifest);
                                                                                                DependencyConflict;
                                                                                                {
                                                                                                    const conflicts = [];
                                                                                                            ...
                                                                                                            for (const [depId, versionRange] of Object.entries(manifest.dependencies)) {
                                                                                                                ...
                                                                                                                for (const [depId, requirements] of dependencyVersions) {
                                                                                                                    if (requirements.length > 1) {
                                                                                                                         ...
                                                                                                                         */
                                                                                                                        resolveConflicts(graph, DependencyGraph, manifests, ExtensionManifest);
                                                                                                                        void {
                                                                                                                            for(, conflict, of, graph) { }, : .conflicts
                                                                                                                        };
                                                                                                                        {
                                    ...
                                    areVersionRangesCompatible(ranges, string);
                                    boolean;
                                    {
                                        if (ranges.length <= 1)
                                            return true;
                                        try {
                                            ...
                                            for (let i = 1; i < ranges.length; i++) {
                                                ...
                                                try { }
                                                    ...
                                                    return false;
                                                    intersectVersionRanges(range1, string, range2, string);
                                                    string | null;
                                                    {
                                                        try {
                                                            ...
                                                            try { }
                                                                ...
                                                                return null;
                                                                resolveVersionConflict((), conflict, DependencyConflict, manifests, ExtensionManifest);
                                                                        ...
                                                                        switch (this.options.resolutionStrategy) {
                                                                            ...
                                                                            case 'conservative':
                                                                                ...
                                                                                if (selectedVersion) {
                                                                                    ...
                                                                                    return null;
                                                                                    isCycleBreakable(graph, DependencyGraph, cycle, string);
                                                                                    boolean;
                                                                                    {
                                                                                        for (let i = 0; i < cycle.length - 1; i++) {
                                                                                            ...
                                                                                            if (this.isOptionalEdge(graph, from, to)) {
                                                                                                return true;
                                                                                                return false;
                                                                                                isOptionalEdge(graph, DependencyGraph, from, string, to, string);
                                                                                                boolean;
                                                                                                {
                                                                                                    return graph.edges.some(edge => );
                                                                                                    edge.from === from && edge.to === to && edge.optional;
                                                                                                    ;
                                                                                                    generateCircularDependencySuggestions(cycle, string);
                                                                                                    string;
                                                                                                    {
                                                                                                        const suggestions = [];
                                                                                                    ...
                                                                                                    return suggestions;
                                                                                                    getAvailableVersions(packageId, string);
                                                                                                    string;
                                                                                                    {
