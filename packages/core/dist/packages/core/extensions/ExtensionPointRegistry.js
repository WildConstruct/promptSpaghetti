...
(function (ExtensionPointCategory) {
    ...
    ExtensionPointCategory[ExtensionPointCategory["export"] = void 0] = "export";
    ExtensionPointCategory[ExtensionPointCategory["enum"] = void 0] = "enum";
    ExtensionPointCategory[ExtensionPointCategory["ExtensionPointLifecycle"] = void 0] = "ExtensionPointLifecycle";
})(ExtensionPointCategory || (ExtensionPointCategory = {}));
{
    ...
    export let ExtensionPointPriority;
    (function (ExtensionPointPriority) {
        ...
        ExtensionPointPriority[ExtensionPointPriority["export"] = void 0] = "export";
        ExtensionPointPriority[ExtensionPointPriority["const"] = void 0] = "const";
        ExtensionPointPriority[ExtensionPointPriority["ExtensionPointSchema"] = ExtensionPointPriority.z.object({})] = "ExtensionPointSchema";
        ExtensionPointPriority[ExtensionPointPriority["id"] = void 0] = "id";
        ExtensionPointPriority[ExtensionPointPriority["z"] = void 0] = "z";
        ExtensionPointPriority[ExtensionPointPriority["string"] = void 0] = "string";
    ...
    z.string(),
        category;
    z.nativeEnum(ExtensionPointCategory),
        priority;
    z.nativeEnum(ExtensionPointPriority),
        lifecycle;
    z.nativeEnum(ExtensionPointLifecycle),
        version;
    z.string(),
        location;
    z.object({});
...
interfaces: z.array(z.object({}), name, z.string(), description, z.string(), parameters, z.array(z.object({}), name, z.string(), type, z.string(), required, z.boolean(), description, z.string(), defaultValue, z.any().optional())),
    returnType;
z.string(),
    examples;
...
dependencies: z.array(z.string()).optional(),
    examples;
z.array(z.object({}), name, z.string(), description, z.string(), code, z.string(), language, z.string());
optional(),
    constraints;
z.object({});
...
constraints: {
    ...
    id: 'runtime.node.advanced',
        name;
    'Advanced Runtime Node',
        description;
    'Create advanced nodes with state management and caching',
        category;
    ExtensionPointCategory.RUNTIME,
        priority;
    ExtensionPointPriority.HIGH,
        lifecycle;
    ExtensionPointLifecycle.STABLE,
        version;
    '1.0.0',
        location;
    {
...
'Inspector Node Editor',
    description;
'Create custom editors for node configuration',
    category;
ExtensionPointCategory.UI,
    priority;
ExtensionPointPriority.HIGH,
    lifecycle;
ExtensionPointLifecycle.STABLE,
...
'Node Schema Validation',
    description;
'Add validation schemas for new node types',
    category;
ExtensionPointCategory.SCHEMA,
    priority;
ExtensionPointPriority.HIGH,
    lifecycle;
ExtensionPointLifecycle.STABLE,
...
'Add new API endpoints to the server',
    category;
ExtensionPointCategory.API,
    priority;
ExtensionPointPriority.MEDIUM,
    lifecycle;
ExtensionPointLifecycle.STABLE,
    version;
'1.0.0',
