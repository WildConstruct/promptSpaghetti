...
import { GraphOperation, OperationType, ConflictType, ConflictResolutionStrategy, ConflictResolutionOption } from './types';
/**
...
export class ConflictResolver extends EventEmitter {
    ...
    constructor(config) {
        ...
        */
        recordOperation(operation, GraphOperation);
        void {
            ...
            : .recentOperations.entries() };
        {
            ...
            for (const remoteOp of operations) {
                ...
                if (conflict) {
                     ...
                     */
                    async;
                    resolve((), operation, GraphOperation, conflictResult, ConflictResult);
                    ...
                    };
                    {
                        ...
                        switch (this.config.strategy) {
                            ...
                            default:
                                ...
                                */
                                getResolutionOptions(conflictResult, ConflictResult);
                                ConflictResolutionOption;
                                {
                                    ...
                                    if (conflictResult.canAutoResolve) {
                                        ...
                                        strategy: ConflictResolutionStrategy.LAST_WRITER_WINS,
                                            description;
                                        'Accept your changes and overwrite conflicting changes',
                                            automated;
                                        true,
                                            confidence;
                                        0.8,
                                    ...
                                    strategy: ConflictResolutionStrategy.FIRST_WRITER_WINS,
                                        description;
                                    'Reject your changes and keep existing changes',
                                        automated;
                                    true,
                                        confidence;
                                    0.7,
    ...
    if(timeDiff) { } } > this.maxOperationAge;
{
    ...
    if (!conflictType) {
        ...
        getConflictType(localOp, GraphOperation, remoteOp, GraphOperation);
        ConflictType | null;
        {
                            ...
                            if (localOp.type === OperationType.NODE_MOVE && this.isModifyOperation(remoteOp)) {
                                ...
                                if (remoteOp.type === OperationType.NODE_MOVE && this.isModifyOperation(localOp)) {
                                    ...
                                    if (this.hasStructuralConflict(localOp, remoteOp)) {
                                        ...
                                        return null;
                                        operationsAffectSameElement(op1, GraphOperation, op2, GraphOperation);
                                        boolean;
                                        {
                                            ...
                                            if (node1Id && node2Id && node1Id === node2Id) {
                                                ...
                                                if (edge1Id && edge2Id && edge1Id === edge2Id) {
                                                    return true;
                                                    return false;
                                                    getAffectedNodeId(operation, GraphOperation);
                                                    string | null;
                                                    {
                                                        switch (operation.type) {
                                                            ...
                                                            default:
                                                                return null;
                                                                getAffectedEdgeId(operation, GraphOperation);
                                                                string | null;
                                                                {
                                                                    switch (operation.type) {
                                                                        ...
                                                                        default:
                                                                            ...
                                                                            boolean;
                                                                            {
                                                                                ...
                                                                                boolean;
                                                                                {
                                                                                    ...
                                                                                    hasStructuralConflict(op1, GraphOperation, op2, GraphOperation);
                                                                                    boolean;
                                                                                    {
                                                                                        ...
                                                                                        if (op1.type === OperationType.NODE_DELETE && op2.type === OperationType.EDGE_ADD) {
                                                                                            ...
                                                                                            if (op2.type === OperationType.NODE_DELETE && op1.type === OperationType.EDGE_ADD) {
                                                                                                ...
                                                                                                return false;
                                                                                                getAffectedElements(localOp, GraphOperation, remoteOp, GraphOperation);
                                                                                                string;
                                                                                                {
                                                                        ...
                                                                        case ConflictType.MOVE_MODIFY:
                                                                            ...
                                                                            strategy: ConflictResolutionStrategy.OPERATIONAL_TRANSFORM,
                                                                                description;
                                                                            'Apply both changes using transformation',
                                                                                automated;
                                                                            true,
                                                                                confidence;
                                                                            0.9,
                                                                    ...
                                                                    break;
                                                                    return options;
                                                                    canAutoResolveConflict(conflict, OperationConflict);
                                                                    boolean;
                                                                    {
                                                                        ...
                                                                        resolveLastWriterWins((), operation, GraphOperation, conflictResult, ConflictResult);
                                                                        GraphOperation;
                                                                        {
                                                                            ...
                                                                            return operation;
                                                                            async;
                                                                            resolveOperationalTransform((), operation, GraphOperation, conflictResult, ConflictResult);
                                                                            Promise < GraphOperation > {
                                                                                let, transformedOperation = operation,
                                                                                for(, conflict, of, conflictResult) { }, : .conflicts };
                                                                            {
                                                                                ...
                                                                                async;
                                                                                resolveMerge((), operation, GraphOperation, conflictResult, ConflictResult);
                                                                                Promise < GraphOperation > {
                                                                                    ...
                                                                                    for(, conflict, of, conflictResult) { }, : .conflicts };
                                                                                {
                                                                                    if (conflict.conflictType === ConflictType.CONCURRENT_EDIT) {
                                                                                        ...
                                                                                        async;
                                                                                        transformOperation((), localOp, GraphOperation, remoteOp, GraphOperation);
                                                                                        Promise < GraphOperation > {
                                                                                            ...
                                                                                            if(localOp) { }, : .type === OperationType.NODE_MOVE && remoteOp.type === OperationType.NODE_UPDATE };
                                                                                        {
                                                                                            ...
                                                                                            if (localOp.type === OperationType.NODE_UPDATE && remoteOp.type === OperationType.NODE_MOVE) {
                                                                                                ...
                                                                                                return localOp;
                                                                                                async;
                                                                                                mergeNodeUpdates((), localOp, NodeUpdateOperation, remoteOp, NodeUpdateOperation);
                                                                                                Promise < GraphOperation > {
