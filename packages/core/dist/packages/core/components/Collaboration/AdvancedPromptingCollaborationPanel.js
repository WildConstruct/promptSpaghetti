...
_jsxs("div", { style: { padding: 20 }, children: [_jsxs("div", { style: {
                ...
                border: '1px solid rgba(59, 130, 246, 0.2)',
                    ...
                    < button
                    :
                , "onClick=", () => setIsCreatingSession(true), "style=", {
...
div >
    { /* Active Sessions */}
    < div >
    _jsx("h4", { style: { margin: '0 0 16px 0', color: '#1e293b', fontSize: 16 }, children: "Active Collaboration Sessions" });
{
    sessions.length === 0 ? ()
        < div : ;
    style = {};
 ...
 >
    (_jsx("div", { style: { fontSize: 24, marginBottom: 8 }, children: "\uD83E\uDD1D" })
        ,
            _jsx("div", { children: "No active collaboration sessions" })
                ,
                    _jsx("div", { style: { fontSize: 12, marginTop: 4 }, children: "Create a new session to start collaborating with your team" }));
div >
;
()
    < div;
...
const ZadaTab = () => ();
;
_jsxs("div", { style: { padding: 20 }, children: [_jsx("h4", { style: { margin: '0 0 16px 0', color: '#1e293b', fontSize: 16 }, children: "\uD83D\uDCAC Zada Prompt Patterns" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 16 }, children: [zadaPatterns.map(pattern => ()
...
const WorkflowsTab = () => ();
;
_jsxs("div", { style: { padding: 20 }, children: [_jsx("h4", { style: { margin: '0 0 16px 0', color: '#1e293b', fontSize: 16 }, children: "\uD83C\uDFAC Film Industry Workflows" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 16 }, children: [workflowTemplates.map(workflow => ()
...
const ExportTab = () => ();
;
_jsxs("div", { style: { padding: 20 }, children: [_jsx("h4", { style: { margin: '0 0 16px 0', color: '#1e293b', fontSize: 16 }, children: "\uD83D\uDE80 VFX Pipeline Export" }), !currentSession ? ()
            < div : , " style=", {
            padding: 24,
            textAlign: 'center',
            color: '#6b7280',
...
style = {};
{
    minHeight: 400, overflowY;
    'auto';
}
 >
    { activeTab } === 'sessions' && _jsx(SessionsTab, {});
{
    activeTab === 'mars' && _jsx(MARSTab, {});
}
{
    activeTab === 'zada' && _jsx(ZadaTab, {});
}
{
    activeTab === 'workflows' && _jsx(WorkflowsTab, {});
}
{
    activeTab === 'export' && _jsx(ExportTab, {});
}
div >
;
div >
