...
export const EnhancedPreviewModal = ({ isOpen, onClose, results, graph, seeds, onRegenerateRequest, onSaveResult, onCancel, onResultHover, onResultSelect, onResultSave, onResultExport, onResultRate, onResultTag, onResultNote, enableSelection = false, enableRating = false, enableNotes = false, enableExport = false, maxResults = 10 }) => {
