...
export const IndividualResultManager = ({ visible = true, onClose, className = '', enableComparison = true, enableAnalytics = true, maxDisplayResults = 10 }) => {
    // Store hooks
    const { results, isLoading, error, lockedResults, regeneratingResults, lockResult, unlockResult, setRegeneratingResult } = usePreviewStateStore();
    ...
    const calculateAnalytics = useCallback((content, index) => {
        ...
        const readabilityScore = Math.max(0, Math.min(100, 206.835 - (1.015 * avgWordsPerSentence) - (84.6 * averageWordLength)));
    ...
    if (!visible)
        return null;
    return (_jsxs("div", { className: `individual-result-manager ${className}`, style: {
            position: 'fixed',
            left: '20px',
            top: '20px',
            width: '600px',
            ...
            fontFamily: 'system-ui, -apple-system, sans-serif'
                    ...
                    borderBottom: '1px solid #e2e8f0',
                    background: '#f8fafc'
                }, children: _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }, children: [enableComparison && (_jsxs("button", { onClick: toggleComparisonMode, style: {
                                padding: '6px 12px',
                                ...
                                fontSize: '12px',
                                cursor: 'pointer'
                            }, children: ["\uD83D\uDD0D Compare (", selectedResults.size, ")"] })), enableAnalytics && (_jsx("button", { onClick: () => setShowAnalytics(!showAnalytics), style: {
                                padding: '6px 12px',
                                ...
                                fontSize: '12px',
                                cursor: 'pointer'
                            }, children: "\uD83D\uDCCA Analytics" })), _jsx("button", { onClick: () => setSelectedResults(new Set()), disabled: selectedResults.size === 0, style: {
                                padding: '6px 12px',
                            ...
                            }, children: "\uD83D\uDDD1\uFE0F Clear Selection" })] }) }), comparisonMode.enabled && comparisonSummary && (_jsxs("div", { style: {
                    padding: '12px 20px',
                    borderBottom: '1px solid #e2e8f0',
                    background: '#f0f9ff',
                    fontSize: '12px'
                }, children: [_jsx("div", { style: { fontWeight: '600', marginBottom: '8px' }, children: "Comparison Summary" }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '8px' }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Results:" }), " ", comparisonSummary.count] }), _jsxs("div", { children: [_jsx("strong", { children: "Avg Words:" }), " ", comparisonSummary.avgWordCount] }), _jsxs("div", { children: [_jsx("strong", { children: "Readability:" }), " ", comparisonSummary.avgReadability] }), _jsxs("div", { children: [_jsx("strong", { children: "Sentiment:" }), " ", comparisonSummary.dominantSentiment] })] }), comparisonSummary.topics.length > 0 && (_jsxs("div", { style: { marginTop: '8px' }, children: [_jsx("strong", { children: "Common Topics:" }), " ", comparisonSummary.topics.slice(0, 5).join(', ')] }))] })), _jsxs("div", { style: {
                    ...
                    padding: '12px 0'
                            ...
                            color: '#dc2626',
                            fontSize: '14px'
                        }, children: [_jsx("strong", { children: "Error:" }), " ", error] })), results.length === 0 && !isLoading && (_jsxs("div", { style: {
                            padding: '40px 20px',
                            textAlign: 'center',
                            color: '#9ca3af'
                        }, children: [_jsx("div", { style: { fontSize: '32px', marginBottom: '12px' }, children: "\uD83D\uDCCB" }), _jsx("div", { children: "No results to manage" })] })), results.slice(0, maxDisplayResults).map((result, index) => {
                        const analytics = resultAnalytics.get(index);
                        ...
                        return (_jsxs("div", { style: {
                                ...
                                transition: 'all 0.2s ease'
                            }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [comparisonMode.enabled && (_jsx("input", { type: "checkbox", checked: isSelected, onChange: () => handleResultAction({ type: 'compare', resultIndex: index }), style: { margin: 0 } })), _jsxs("span", { style: {
                                                    ...
                                                    }, children: ["Seed ", result.seed] }), result.executionTimeMs && (_jsxs("span", { style: { fontSize: '11px', color: '#6b7280' }, children: [result.executionTimeMs, "ms"] })), result.locked && (_jsx("span", { title: `Locked: ${result.lockedNote || 'No note'}`, style: { fontSize: '14px' }, children: "\uD83D\uDD12" })), isRegenerating && (_jsx("span", { style: { fontSize: '14px', animation: 'spin 1s linear infinite' }, children: "\u27F3" }))] }), _jsx("button", { onClick: () => setActionMenuIndex(actionMenuIndex === index ? null : index), style: {
                                                background: 'none',
                                                border: 'none',
                                                fontSize: '16px',
                                                cursor: 'pointer',
                                                ...
                                                borderRadius: '4px',
                                                color: '#6b7280'
                                            }, children: "\u22EF" })] }), _jsx("div", { style: { fontSize: '14px', lineHeight: '1.4', marginBottom: showAnalytics ? '12px' : '0' }, children: result.error ? (_jsx("div", { style: { color: '#dc2626', fontStyle: 'italic' }, children: result.error })) : (_jsx("div", { style: { color: '#374151' }, children: result.output || 'No output' })) }), showAnalytics && analytics && (_jsxs("div", { style: {
                                        padding: '8px',
                                        background: '#f8fafc',
                                        borderRadius: '4px',
                                        fontSize: '12px',
