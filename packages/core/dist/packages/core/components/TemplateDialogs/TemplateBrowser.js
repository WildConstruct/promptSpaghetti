                        ...
                        justifyContent: 'space-between',
                                ...
                                overflow: 'auto',
                                            ...
                                            boxSizing: 'border-box',
                                                ...
                                                backgroundColor: 'white',
                                                boxSizing: 'border-box',
                                            }, children: TEMPLATE_CATEGORIES.map(cat => ()
                                ...
                                borderTop: '1px solid #e5e7eb',
                                            ...
                                            < div, " style=", { paddingLeft: '18px', marginTop: '4px' }, ">", _jsxs("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: '11px', color: '#6b7280' }, children: "Offset:" }), _jsx("input", { type: "number", value: instantiationOptions.offsetX, onChange: (e) => setInstantiationOptions(prev => ({}), ...prev, offsetX) }), ": Number(e.target.value), }))} style=", {
                                                    ...
                                                    borderRadius: '2px',
                                                    fontSize: '11px',
                                                }, "/>"] })] }), ")}"] })] })] }), _jsxs("div", { style: { flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }, children: [error && ()
                    < div, " style=", {
                    margin: '16px',
                    padding: '12px',
...
({ template, onPreview, onApply, onDelete, showDelete }) => {
    ...
    _jsxs("div", { style: {
        ...
        }, onClick: onPreview, children: [showDelete && ()
                < button, "onClick=", (e) => {
                e.stopPropagation();
                onDelete();
            }, "style=", {
