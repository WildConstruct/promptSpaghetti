...
export const LearningPathViewer = ({ path, learningService, userId, enrollment, onProgress, onComplete }) => {
    // State management
    ...
    const handleActivityComplete = useCallback(async (activityId) => {
        ...
        setError(null);
        try {
            const updatedProgress = await learningService.updateProgress(userId, path.id, currentModule.id, activityId);
            if (updatedProgress) {
    ...
    const getModuleStatus = useCallback((module) => {
        ...
        const prerequisitesMet = module.prerequisites.every(prereqId => enrollment.progress.completedModules.includes(prereqId));
    ...
    const renderModuleSidebar = () => (_jsxs("div", { className: "w-80 bg-white border-r border-gray-200 flex flex-col", children: [_jsxs("div", { className: "p-6 border-b border-gray-200", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h2", { className: "text-lg font-semibold text-gray-900", children: path.title }), _jsx("button", { onClick: () => setSidebarOpen(false), className: "md:hidden p-2 text-gray-400 hover:text-gray-600", children: _jsx("svg", { className: "h-5 w-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] }), _jsxs("div", { className: "mb-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("span", { className: "text-sm font-medium text-gray-700", children: "Overall Progress" }), _jsxs("span", { className: "text-sm text-gray-500", children: [Math.round(overallProgress), "%"] })] }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2", children: _jsx("div", { className: "bg-blue-600 h-2 rounded-full transition-all duration-300", style: { width: `${overallProgress}%` } }) })] }), _jsxs("div", { className: "flex items-center space-x-4 text-sm text-gray-500", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("svg", { className: "w-4 h-4 mr-1", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }) }), Math.floor(path.estimatedDuration / 60), "h ", path.estimatedDuration % 60, "m"] }), _jsxs("div", { className: "flex items-center", children: [_jsx("svg", { className: "w-4 h-4 mr-1", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" }) }), path.modules.length, " modules"] })] })] }), _jsx("div", { className: "flex-1 overflow-y-auto", children: _jsx("div", { className: "p-4 space-y-2", children: path.modules.map((module, index) => {
                        const status = getModuleStatus(module);
                        const isActive = currentModule?.id === module.id;
                        const progress = enrollment?.progress.moduleProgress[module.id];
                        return (_jsx("div", { className: `rounded-lg border p-4 cursor-pointer transition-all ${isActive
                                ? 'bg-blue-50 border-blue-200'
                                : status === 'locked'
                                    ? 'bg-gray-50 border-gray-200 opacity-50 cursor-not-allowed'
                                    : 'bg-white border-gray-200 hover:border-gray-300'}`, onClick: () => status !== 'locked' && handleModuleSelect(module), children: _jsxs("div", { className: "flex items-start space-x-3", children: [_jsxs("div", { className: "flex-shrink-0 mt-1", children: [status === 'completed' && (_jsx("div", { className: "w-6 h-6 bg-green-500 rounded-full flex items-center justify-center", children: _jsx("svg", { className: "w-4 h-4 text-white", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z", clipRule: "evenodd" }) }) })), status === 'in_progress' && (_jsx("div", { className: "w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center", children: _jsx("div", { className: "w-2 h-2 bg-white rounded-full" }) })), status === 'available' && (_jsx("div", { className: "w-6 h-6 border-2 border-gray-300 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-sm font-medium text-gray-500", children: index + 1 }) })), status === 'locked' && (_jsx("div", { className: "w-6 h-6 bg-gray-300 rounded-full flex items-center justify-center", children: _jsx("svg", { className: "w-4 h-4 text-gray-500", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z", clipRule: "evenodd" }) }) }))] }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h4", { className: "text-sm font-medium text-gray-900 truncate", children: module.title }), _jsx("p", { className: "text-xs text-gray-500 mt-1 line-clamp-2", children: module.description }), _jsxs("div", { className: "flex items-center justify-between mt-2", children: [_jsxs("div", { className: "flex items-center space-x-2 text-xs text-gray-500", children: [_jsxs("span", { children: [module.duration, "min"] }), _jsx("span", { children: "\u2022" }), _jsxs("span", { children: [module.activities.length, " activities"] }), module.quiz && (_jsxs(_Fragment, { children: [_jsx("span", { children: "\u2022" }), _jsx("span", { children: "Quiz" })] }))] }), progress && (_jsxs("span", { className: "text-xs text-gray-500", children: [Math.round(progress.progress), "%"] }))] }), progress && progress.progress > 0 && (_jsx("div", { className: "mt-2", children: _jsx("div", { className: "w-full bg-gray-200 rounded-full h-1", children: _jsx("div", { className: "bg-blue-600 h-1 rounded-full transition-all duration-300", style: { width: `${progress.progress}%` } }) }) }))] })] }) }, module.id));
                    }) }) }), _jsxs("div", { className: "p-4 border-t border-gray-200", children: [path.certification && (_jsx("div", { className: "bg-yellow-50 border border-yellow-200 rounded-md p-3 mb-3", children: _jsxs("div", { className: "flex items-center", children: [_jsx("svg", { className: "w-5 h-5 text-yellow-400 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z", clipRule: "evenodd" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-yellow-800", children: "Certification Available" }), _jsx("p", { className: "text-xs text-yellow-700", children: path.certification.name })] })] }) })), _jsx("button", { className: "w-full px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200", children: "View Path Details" })] })] }));
    // Render main content
