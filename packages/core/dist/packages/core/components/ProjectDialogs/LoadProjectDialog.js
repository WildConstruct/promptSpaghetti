                        ...
                        zIndex: 1000,
                                ...
                                boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)',
                                        ...
                                        marginBottom: '24px',
                                                ...
                                                alignItems: 'center',
                                                justifyContent: 'center',
                                            }, disabled: isLoading, children: "\u00D7" })] }), showUnsavedWarning && ()
                                    < div, " style=", {
                                    ...
                                    marginBottom: '24px',
                                                ...
                                                cursor: 'pointer',
                                                fontSize: '14px',
                                            }, children: "Discard Changes & Load" })] })] }), ")}", !showUnsavedWarning && ()
                            <  >
                            _jsxs("div", { style: {
                                    textAlign: 'center',
                                    padding: '32px 16px',
                                ...
                                marginBottom: '24px',
                                        ...
                                        color: '#0066cc',
                                        lineHeight: 1.4,
                                    }, children: [_jsx("li", { children: ".psg files created by this application" }), _jsx("li", { children: "Contains graph nodes, connections, and project metadata" }), _jsx("li", { children: "Automatically validates file format and compatibility" })] })] }), error && ()
                            < div, " style=", {
                            backgroundColor: '#fee',
