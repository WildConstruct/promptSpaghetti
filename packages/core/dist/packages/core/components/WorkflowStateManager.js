            ...
            { pendingApprovals, : .map(approval => ()
                    ...
                    >
                        (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(ClockIcon, { className: "h-4 w-4 text-yellow-500" }), _jsx("span", { className: "text-sm font-medium", children: "Approval Required" })] }), _jsx("span", { className: `px-2 py-1 rounded text-xs ${approval.priority === 'high' ? 'bg-red-100 text-red-800' : ,
                                                ...
                                                'bg-green-100 text-green-800'}`, children: approval.priority })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("button", { onClick: () => handleApprovalAction(approval.id, 'approve'), className: "px-3 py-1 bg-green-600 text-white text-sm rounded hover:bg-green-700", children: "Approve" }), _jsx("button", { onClick: () => handleApprovalAction(approval.id, 'reject'), className: "px-3 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-700", children: "Reject" })] })] })
                            ,
