                  ...
                  {submissions.map((submission) => ()
                    <div key={submission.id} className="submission-row">
                      ...
                      <div className="submission-actions">
                        ...
                        <Button
                          size="sm"
                          onClick={() => window.open(` / admin / submissions / $;
{
    submission.id;
}
`, '_blank')}
...
$;
{
    Math.min(reviewer.active_reviews * 10, 100);
}
 % `}}
                    />
                  </div>
                                                                                                                                ...
                                                                                                                                reviewer - name;
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    reviewer - stats;
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        workload - bar;
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            {
                                                                                                                                                height: 100 % ;
                                                                                                                                                background: linear - gradient(90, deg, #, 10, b981, #f59e0b, #ef4444);
                                                                                                                                                transition: width;
                                                                                                                                                0.3;
                                                                                                                                                s;
                                                                                                                                                analytics - grid;
                                                                                                                                                {
                                                                                                                                                    display: grid;
                                                                                                                                                    grid - template - columns;
                                                                                                                                                    repeat(auto - fit, minmax(300, px, 1, fr));
                                                                                                                                                    gap: 16;
                                                                                                                                                    px;
                                                                                                                                                    trend - metrics;
                                                                                                                                                    {
