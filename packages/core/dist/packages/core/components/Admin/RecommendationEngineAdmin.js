                        ...
                        algorithm_performance: {
                            ...
                            _jsxs("div", { className: "featured-config-section", children: [_jsxs("div", { className: "config-header", children: [_jsx("h3", { children: "Featured Content Configuration" }), _jsxs("div", { className: "header-actions", children: [_jsxs(Button, { variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Reset to Defaults"] }), _jsxs(Button, { className: "bg-green-600 hover:bg-green-700", children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), "Save Configuration"] })] })] }), _jsx("div", { className: "config-sections", children: _jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Algorithm Weights" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "weights-grid", children: Object.entries(featuredConfig.algorithm_weights).map(([key, value]) => ()
                                                                ...
                                                                (_jsx("label", { className: "weight-label", children: key.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) })
                                                                    ,
                                                                        _jsxs("div", { className: "weight-input-group", children: [_jsx("input", { type: "range", min: "0", max: "2", step: "0.1", value: value, onChange: (e) => setFeaturedConfig({}) }), "...featuredConfig, algorithm_weights: ", (,
                                                                                ), "...featuredConfig.algorithm_weights, [key]: parseFloat(e.target.value), })} className=\"weight-slider\" />", _jsx("span", { className: "weight-value", children: value.toFixed(1) })] }))) }), "))}"] })] }) }), _jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Content Filters" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "filters-grid", children: [_jsxs("div", { className: "filter-item", children: [_jsx("label", { children: "Min Quality Score" }), _jsx("input", { type: "number", min: "0", max: "100", value: featuredConfig.content_filters.min_quality_score, onChange: (e) => setFeaturedConfig({}) }), "...featuredConfig, content_filters: ", (,
                                                                ), "...featuredConfig.content_filters, min_quality_score: parseInt(e.target.value), })} className=\"config-input\" />"] }), _jsxs("div", { className: "filter-item span-2", children: [_jsx("label", { children: "Category Boosts" }), _jsxs("div", { className: "category-boosts", children: [Object.entries(featuredConfig.content_filters.featured_categories_boost).map(([category, boost]) => ()
                                                                            < div, key = { category }, className = "category-boost-item" >
                                                                            (_jsx("span", { className: "category-name", children: category })
                                                                                ,
                                                                                    _jsx("input", { type: "number", min: "0", max: "2", step: "0.1", value: boost, onChange: (e) => setFeaturedConfig({}) })), ...featuredConfig, content_filters), ": ", (,
                                                                        ), "...featuredConfig.content_filters, featured_categories_boost: ", (,
                                                                        ), "...featuredConfig.content_filters.featured_categories_boost, [category]: parseFloat(e.target.value), })} className=\"boost-input\" />"] }), "))}"] })] }) })] })] });
                            { /* A/B Testing */ }
                            _jsxs(Card, { className: "config-section", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "section-title", children: [_jsx(Target, { className: "w-5 h-5 text-purple-500" }), "A/B Testing Configuration"] }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "ab-testing-config", children: [_jsxs("div", { className: "ab-header", children: [_jsxs("label", { className: "checkbox-label", children: [_jsx("input", { type: "checkbox", checked: featuredConfig.ab_testing.enabled, onChange: (e) => setFeaturedConfig({}) }), "...featuredConfig, ab_testing: ", (,
                                                                    ), "...featuredConfig.ab_testing, enabled: e.target.checked, })} />", _jsx("span", { children: "Enable A/B Testing" })] }), _jsxs("div", { className: "traffic-allocation", children: [_jsxs("label", { children: ["Traffic Allocation: ", featuredConfig.ab_testing.traffic_allocation, "%"] }), _jsx("input", { type: "range", min: "0", max: "100", value: featuredConfig.ab_testing.traffic_allocation, onChange: (e) => setFeaturedConfig({}) }), "...featuredConfig, ab_testing: ", (,
                                                                    ), "...featuredConfig.ab_testing, traffic_allocation: parseInt(e.target.value), })} className=\"traffic-slider\" />"] })] }), featuredConfig.ab_testing.enabled && ()
