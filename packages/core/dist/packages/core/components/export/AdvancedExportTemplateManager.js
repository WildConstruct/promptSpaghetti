...
if (!visible)
    return null;
return;
_jsx("div", { className: `advanced-export-template-manager ${className}`, style: {
        position: 'fixed',
        inset: '20px',
        background: 'white',
...
_jsxs("div", { style: {
        ...
        borderBottom: '1px solid #e2e8f0',
        background: '#f8fafc',
    }, children: [_jsxs("div", { style: { display: 'flex', gap: '8px', marginBottom: '16px' }, children: [[
    ...
    (_jsx("input", { type: "text", placeholder: "Search templates...", value: filter.search || '', onChange: (e) => setFilter(prev => ({ ...prev, search: e.target.value })), style: {
        ...
        ,
            _jsxs("select", { value: filter.format || '', onChange: (e) => setFilter(prev => ({ ...prev, format: e.target.value || undefined })), style: {
                    ...
                    borderRadius: '6px',
                    fontSize: '14px',
                }, children: [_jsx("option", { value: "", children: "All Formats" }), _jsx("option", { value: "json", children: "JSON" }), _jsx("option", { value: "yaml", children: "YAML" }), _jsx("option", { value: "xml", children: "XML" }), _jsx("option", { value: "csv", children: "CSV" }), _jsx("option", { value: "markdown", children: "Markdown" }), _jsx("option", { value: "pdf", children: "PDF" }), _jsx("option", { value: "html", children: "HTML" }), _jsx("option", { value: "zip", children: "ZIP" }), _jsx("option", { value: "vfx", children: "VFX Pipeline" })] })
                ,
                    _jsxs("select", { value: filter.type || '', onChange: (e) => setFilter(prev => ({ ...prev, type: e.target.value || undefined })), style: {
                            padding: '8px 12px',
                            border: '1px solid #e2e8f0',
                            borderRadius: '6px',
                            fontSize: '14px',
                        }, children: [_jsx("option", { value: "", children: "All Types" }), _jsx("option", { value: "full", children: "Full Export" }), _jsx("option", { value: "summary", children: "Summary" }), _jsx("option", { value: "diff", children: "Differential" }), _jsx("option", { value: "custom", children: "Custom" })] })
                        ,
...
div >
    _jsxs("select", { value: `${sortBy}-${sortOrder}`, onChange: (e) => {
...
style = {};
{
    background: selectedTemplate?.id === template.id ? '#f0f9ff' : 'white',
        border;
    `2px solid ${selectedTemplate?.id === template.id ? '#0ea5e9' : '#e2e8f0'}`;
}
borderRadius: '8px',
    padding;
'16px',
...
style = {};
{
    padding: '6px 12px',
        background;
    template.is_public ? '#fee2e2' : '#f0fdf4',
        border;
    '1px solid #e2e8f0',
        borderRadius;
    '4px',
    ...
    '12px',
        color;
    template.is_public ? '#dc2626' : '#16a34a',
    ;
}
    >
    ...
    (_jsx("h5", { style: { margin: '0 0 8px', fontSize: '14px', fontWeight: '600', color: '#374151' }, children: "Format Options" })
        ,
            _jsx("div", { style: {
                    ...
                    overflow: 'auto',
                    maxHeight: '150px',
                }, children: _jsx("pre", { style: { margin: 0 }, children: JSON.stringify(selectedTemplate.format_options, null, 2) }) }));
div >
;
{ /* Actions */ }
_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsx("button", { onClick: () => handleSelectTemplate(selectedTemplate), style: {
                ...
                cursor: 'pointer',
                fontSize: '14px',
            }, children: "\uD83D\uDD27 Customize Template" }), !selectedTemplate.is_system_template && ()
            < button, "onClick=", () => {
