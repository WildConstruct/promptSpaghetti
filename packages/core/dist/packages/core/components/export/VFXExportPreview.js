...
import { FiCheck, FiX, FiAlertTriangle, FiInfo, FiEye, FiCode, FiSettings, FiFile, FiClock, FiTarget } from 'react-icons/fi';
{
    ...
    };
    {
        format: 'vfx-pipeline-v1',
            quality;
        exportData.export_options?.quality || 'production',
            includeDebugInfo;
        exportData.export_options?.include_debug_info || false,
            includeHistoricalData;
        exportData.export_options?.include_historical_data || true,
        ;
    }
    compatibility: {
        ...
        ['stable-diffusion-xl', 'midjourney-v6'],
            animationFramework;
        exportData.export_options?.enable_animation_framework || true,
            billboardProjection;
        true,
        ;
    }
    prompt: {
            ...
            components;
        {
            ...
            ['perched majestically'],
                setting;
            ['crumbling stone ruins', 'ancient temple'],
                mood;
            ['dramatic', 'golden hour lighting', 'mist swirling'],
                technical;
            ['cinematic composition', 'depth of field', '8K resolution'],
                style;
            ['photorealistic rendering'],
            ;
        }
                    ...
                    marsMetadataTags: {
                        '[CAM]';
                        {
                            tag: '[CAM:WIDE_LOW_ANGLE]',
                                description;
                            'Wide shot with low angle for dramatic perspective',
                                ...
                                marsMetadataTags: {
                                    '[SUBJ]';
                                    {
                                        tag: '[SUBJ:DRAGON_ANCIENT_RED]',
                                            description;
                                        'Primary creature subject - ancient red dragon with majestic presence',
                                            controlNetParameters;
                                        {
                                            pose: {
                                                enabled: true, strength;
                                        ...
                                        marsMetadataTags: {
                                            '[FX]';
                                            {
                                                tag: '[FX:ATMOSPHERIC_MIST_GOLDEN]',
                                                    description;
                                                'Atmospheric mist effects with golden hour lighting',
                                                    controlNetParameters;
                                                {
                                                    depth: {
                                                        enabled: true, strength;
                                                ...
                                                style: {
                                                    ...
                                                    influences: {
                                                        ...
                                                        ['Peter Jackson', 'Denis Villeneuve'],
                                                            period;
                                                        ['epic fantasy', 'classical mythology'],
                                                            artMovement;
                                                        ['romanticism'],
                                                        ;
                                                    }
                                                            ...
                                                            creative: {
                                                                    ...
                                                                    alternativeVersions;
                                                                {
                                                                    'director_preferred';
                                                                    {
                                                                        seed: 1024576,
                                                                            description;
                                                                        'Director\'s preferred composition and lighting',
                                                                            approvalStatus;
                                                                        'approved',
                                                                            notes;
                                                                        'Final approved version for production',
                                                                        ;
                                                                    }
                                                                    'alternate_angle';
                                                                    {
                                                                        seed: 1024577,
                                                                            description;
                                                                        'Alternative low-angle approach',
                                                                            approvalStatus;
                                                                        'review',
                                                                            notes;
                                                                        'Backup option if main version needs adjustment',
                                                                        ;
                                                                    }
                                                                    qa: {
                                                                    ...
                                                                    reproducibility: {
                                                                        ...
                                                                        new Date().toISOString(),
                                                                            validationNotes;
                                                                        'Validated on reference hardware configuration';
                                                                    }
                                                                    compliance: {
                                                                    ...
                                                                    humanReadable: {
                                                                        executiveSummary: {
                                                                            description: 'An epic establishing shot featuring a majestic dragon positioned on ancient temple ruins during golden hour. The scene conveys power, wisdom, and the passage of time through the juxtaposition of the eternal dragon and crumbling human architecture.',
                                                                                keyElements;
                                                                            ['Ancient dragon creature', 'Temple ruins', 'Golden hour lighting', 'Atmospheric mist'],
                                                                                creativeIntent;
                                                                        ...
                                                                        creativeTeam: {
                                                                            director: {
                                                                                vision: 'Epic fantasy with emotional resonance - the dragon represents wisdom and the continuity of nature versus the temporary nature of civilization',
                                                                                    references;
                                                                                ['Smaug from The Hobbit', 'Drogon from Game of Thrones', 'Classical dragon mythology'],
                                                                                    priorities;
                                                                                ['Dragon\'s regal presence', 'Cinematic lighting', 'Photorealistic integration'],
                                                                                    concerns;
                                                                                ['Dragon must feel real and lived-in', 'Avoid making it too threatening', 'Lighting must feel natural'],
                                                                                ;
                                                                            }
                                                                            cinematographer: {
                                                                                ...
                                                                                'Static wide shot with low angle to emphasize dragon\'s majesty, deep focus for environmental context',
                                                                                    technicalChallenges;
                                                                                ['Matching CG dragon to practical lighting', 'Integrating atmospheric effects', 'Maintaining detail in shadows'],
                                                                                ;
                                                                            }
                                                                            vfxSupervisor: {
                                                                                vfxApproach: 'Photorealistic creature animation with practical lighting integration and atmospheric enhancement',
                                                                                    practicalElements;
                                                                                ['Temple ruins set piece', 'Practical mist/fog effects', 'Reference lighting'],
                                                                                    digitalElements;
                                                                                ['Hero dragon asset', 'Enhanced atmospheric effects', 'Digital matte painting extensions'],
                                                                                    integrationNotes;
                                                                                ['Match dragon scales to practical lighting', 'Integrate CG mist with practical fog', 'Ensure consistent color temperature'],
                                                                                ;
                                                                            }
                                                                            production: {
                                                                                schedule: {
                                                                                    prep: '2 weeks for asset creation and lighting tests',
                                                                                        shoot;
                                                                                    '1 day for plates and reference',
                                                                                        post;
                                                                                    '3-4 weeks for final creature animation and compositing',
                                                                                    ;
                                                                                }
                                                                                resources: {
                                                                                    crew: ['VFX Supervisor', 'Creature Animator', 'Lighting TD', 'Compositor'],
                                                                                        equipment;
                                                                                    ['Creature motion capture system', 'High-res cameras for reference', 'Atmospheric effects units'],
                                                                                        locations;
                                                                                    ['Temple ruins backlot or suitable location'],
                                                                                        talent;
                                                                                    ['N/A - full CG creature'],
                                                                                    ;
                                                                                }
                                                                                dependencies: {
                                                                                    prerequisites: ['Dragon asset modeling complete', 'Ruins set construction', 'Lighting tests approved'],
                                                                                        deliverables;
                                                                                    ['Hero creature animation', 'Final composited shot', 'Reference materials for future shots'],
                                                                                        approvals;
                                                                                    ['Director creative approval', 'VFX budget approval', 'Schedule sign-off'],
                                                                                    ;
                                                                                }
                                                                                approval: {
                                                                                    reviewStages: {
                                                                                        'concept';
                                                                                        {
                                                                                            reviewers: ['Director', 'Producer', 'VFX Supervisor'],
                                                                                                criteria;
                                                                                            ['Creative vision alignment', 'Technical feasibility', 'Budget compliance'],
                                                                                                deliverables;
                                                                                            ['Concept art', 'Technical breakdown', 'Budget estimate'],
                                                                                                timeline;
                                                                                            '3-5 days',
                                                                                            ;
                                                                                        }
                                                                                        'previs';
                                                                                        {
                                                                                            reviewers: ['Director', 'Cinematographer', 'VFX Supervisor'],
                                                                                                criteria;
                                                                                            ['Composition', 'Camera work', 'Creature performance'],
                                                                                                deliverables;
                                                                                            ['Animated previs', 'Lighting tests', 'Camera breakdown'],
                                                                                                timeline;
                                                                                            '1 week',
                                                                                            ;
                                                                                        }
                                                                                        'final';
                                                                                        {
                                                                                            reviewers: ['Director', 'Producer', 'VFX Supervisor', 'Editor'],
                                                                                                criteria;
                                                                                            ['Final image quality', 'Story integration', 'Technical delivery'],
                                                                                                deliverables;
                                                                                            ['Final rendered shot', 'Technical documentation', 'Archive materials'],
                                                                                                timeline;
                                                                                            '2-3 days',
                                                                                            ;
                                                                                        }
                                                                                        ...
                                                                                        notes: {
                                                                                            directorNotes: ['Needs to feel epic but not threatening', 'Golden hour lighting is crucial'],
                                                                                                producerNotes;
                                                                                            ['Watch render times and budget', 'Coordinate with creature team'],
                                                                                                clientNotes;
                                                                                            [],
                                                                                                technicalNotes;
                                                                                            ['Test atmospheric integration early', 'Plan for multiple render passes'],
                                                                                            ;
                                                                                        }
                                                                                        documentation: {
                                                                                            projectDocuments: ['Dragon design bible', 'Lighting reference guide', 'VFX pipeline documentation'],
                                                                                                referenceImages;
                                                                                            ['Classical dragon artwork', 'Temple architecture references', 'Golden hour photography'],
                                                                                                testFootage;
                                                                                            ['Dragon movement tests', 'Lighting studies', 'Atmospheric effect tests'],
                                                                                                alternativeVersions;
                                                                                            ['Night version', 'Stormy weather variant', 'Different dragon poses'],
                                                                                                archiveNotes;
                                                                                            ...
                                                                                            camera: {
                                                                                                'wide_low_angle';
                                                                                                {
                                                                                                    ...
                                                                                                    integration: {
                                                                                                        ...
                                                                                                        new Date().toISOString(),
                                                                                                            validationNotes;
                                                                                                        ['Camera parameters validated for epic fantasy composition'],
                                                                                                        ;
                                                                                                    }
                                                                                                    subjects: {
                                                                                                        'dragon_ancient_red';
                                                                                                        {
                                                                                                            ...
                                                                                                            integration: {
                                                                                                                ...
                                                                                                                new Date().toISOString(),
                                                                                                                    validationNotes;
                                                                                                                ['Creature rigging verified', 'Animation controls tested', 'Material complexity approved'],
                                                                                                                ;
                                                                                                            }
                                                                                                            effects: {
                                                                                                                'atmospheric_mist_golden';
                                                                                                                {
                                                                                                                    ...
                                                                                                                    integration: {
                                                                                                                        ...
                                                                                                                        new Date().toISOString(),
                                                                                                                            validationNotes;
                                                                                                                        ['Atmospheric effects validated for golden hour lighting', 'Volumetric rendering tested'],
                                                                                                                        ;
                                                                                                                    }
                                                                                                                    marsIntegration: {
                                                                                                                        enabled: true,
                                                                                                                        ...
                                                                                                                        tagProcessingOrder: ['[CAM:WIDE_LOW_ANGLE]', '[SUBJ:DRAGON_ANCIENT_RED]', '[FX:ATMOSPHERIC_MIST_GOLDEN]'];
                                                                                                                    }
                                                                                                                    ;
                                                                                                                    // Simulate validation
                                                                                                                    const mockValidation = {
                                                                                                                        ...
                                                                                                                        : [], compatibility, enable_controlnet_support;
                                                                                                                     || true,
                                                                                                                        animation;
                                                                                                                    exportData.export_options?.enable_animation_framework || true,
                                                                                                                        rendering;
                                                                                                                    exportData.export_options?.include_rendering_data || true,
                                                                                                                        reproducibility;
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        true,
                                                                                                                            configPreserved;
                                                                                                                        exportData.export_options?.preserve_node_configuration || true,
                                                                                                                            weightsPreserved;
                                                                                                                        true,
                                                                                                                        ;
                                                                                                                    }
                                                                                                                ...
                                                                                                                if (loading) {
                                                                                                                    ...
                                                                                                                    if (!previewData || !validation) {
                                                                                                                        ...
                                                                                                                        className = "bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700" >
                                                                                                                            (_jsx("h4", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-3", children: "Pipeline Compatibility" })
                                                                                                                                ,
                                                                                                                                    _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [[
                                                                                                                                                ...
                                                                                                                                                { item, : .compatible ? ()
                                                                                                                                                 ...
                                                                                                                                                 }), " : ()", _jsx(FiX, { className: "w-5 h-5 text-red-600" }), ")}", _jsx("span", { className: `${item.compatible
                                                                                                                                                    ? 'text-gray-900 dark:text-white' : ,
                                                                                                                                             }), ": 'text-gray-500 dark:text-gray-400', }`}>", item.label] }));
                                                                                                                        div >
                                                                                                                        ;
                                                                                                                    }
                                                                                                                    div >
                                                                                                                    ...
                                                                                                                    ;
                                                                                                                    _jsxs("div", { className: "space-y-6", children: [_jsx("div", { className: `rounded-lg p-4 ${validation.isValid
                                                                                                                                    ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : ,
                                                                                                                             }), ": 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800', }`}>", _jsxs("div", { className: "flex items-center", children: [validation.isValid ? ()
                                                                                                                                        < FiCheck : , " className=\"w-6 h-6 text-green-600 mr-3\" /> ) : ()", _jsx(FiX, { className: "w-6 h-6 text-red-600 mr-3" }), ")}", _jsxs("div", { children: [_jsx("h4", { className: `text-lg font-semibold ${validation.isValid ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200',
                                                                                                                    ...
                                                                                                                    { /* Errors */ }
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        className = "bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4" >
                                                                                                                            (_jsxs("div", { className: "flex items-center mb-3", children: [_jsx(FiX, { className: "w-5 h-5 text-red-600 mr-2" }), _jsx("h4", { className: "font-semibold text-red-800 dark:text-red-200", children: "Errors" })] })
                                                                                                                                ,
                                                                                                                                    _jsx("ul", { className: "list-disc list-inside space-y-1", children: validation.errors.map((error, index) => ()
                                                                                                                ...
                                                                                                                { /* Warnings */ }
                                                                                                                {
                                                                                                                    ...
                                                                                                                    className = "bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4" >
                                                                                                                        (_jsxs("div", { className: "flex items-center mb-3", children: [_jsx(FiAlertTriangle, { className: "w-5 h-5 text-yellow-600 mr-2" }), _jsx("h4", { className: "font-semibold text-yellow-800 dark:text-yellow-200", children: "Warnings" })] })
                                                                                                                            ,
                                                                                                                                _jsx("ul", { className: "list-disc list-inside space-y-1", children: validation.warnings.map((warning, index) => ()
                                                                                                            ...
                                                                                                            _jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700", children: [_jsx("h4", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: "Compatibility Analysis" }), _jsxs("div", { className: "space-y-4", children: [[
                                                                                                                                {
                                                                                                                            ...
                                                                                                                            ].map((item) => (), _jsxs("div", { className: "flex items-start space-x-3", children: [item.status ? ()
                                                                                                                                        < FiCheck : , " className=\"w-5 h-5 text-green-600 mt-0.5\" /> ) : ()", _jsx(FiX, { className: "w-5 h-5 text-red-600 mt-0.5" }), ")}", _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900 dark:text-white", children: item.label }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300", children: item.description })] })] }, item.label)), ")}"] })] });
                                                                                                            div >
                                                                                                            ;
                                                                                                            ;
                                                                                                            const renderJsonTab = () => ();
                                                                                                            ;
                                                                                                            _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h4", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: "Export JSON Preview" }), _jsxs("div", { className: "flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300", children: [_jsx(FiInfo, { className: "w-4 h-4" }), _jsx("span", { children: "Showing first 50 lines" })] })] }), _jsx("div", { className: "bg-gray-900 rounded-lg p-4 overflow-x-auto", children: _jsx("pre", { className: "text-sm text-gray-300", children: _jsxs("code", { children: [JSON.stringify(previewData, null, 2).split('\n').slice(0, 50).join('\n'), JSON.stringify(previewData, null, 2).split('\n').length > 50 ? '\n  ...' : ''] }) }) })] });
                                                                                                            ;
                                                                                                            return;
                                                                                                            _jsx("div", { className: "vfx-export-preview", children: _jsxs("div", { className: "border-b border-gray-200 dark:border-gray-700 mb-6", children: [_jsxs("nav", { className: "flex space-x-8", children: [[
                                                                                                                                    { id: 'preview', label: 'Preview', icon: FiEye },
                                                                                                                                    { id: 'validation', label: 'Validation', icon: FiCheck },
                                                                                                                                    { id: 'json', label: 'JSON', icon: FiCode }
                                                                                                                                ].map((tab) => ()
                                                                                                                                    < button, key = { tab, : .id }, onClick = {}()), " => setActiveTab(tab.id as any)} className=", `flex items-center space-x-2 py-2 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === tab.id
                                                                                                            ...
                                                                                                            { /* Tab Content */ }
                                                                                                            _jsxs("div", { className: "max-h-96 overflow-y-auto", children: [activeTab === 'preview' && renderPreviewTab(), activeTab === 'validation' && renderValidationTab(), activeTab === 'json' && renderJsonTab()] });
                                                                                                            div >
                                                                                                            ;
                                                                                                            ;
                                                                                                        }
