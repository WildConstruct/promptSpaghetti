                ...
                flexDirection: 'column',
                    ...
                    borderBottom: `1px solid ${styles.border}`
                            ...
                            color: styles.text,
                                ...
                                borderRadius), ": '4px', color: styles.textSecondary, fontSize: '12px', cursor: 'pointer' }} > Clear All"] }), ")}"] }) })) /* Content */;
        { /* Content */ }
        _jsxs("div", { style: { flex: 1, overflow: 'auto', padding: '16px' }, children: [showFavorites && favoriteFiles.length > 0 && ()
                    < div, " style=", { marginBottom: '24px' }, ">", _jsxs("h3", { style: {
                        margin: '0 0 12px 0',
                        fontSize: '14px',
                        fontWeight: '600',
                        color: styles.accent,
                        ...
                        alignItems: 'center',
                        gap: '8px',
                    }, children: [_jsx("span", { children: "\u2B50" }), " Favorites (", favoriteFiles.length, ")"] }), _jsxs("div", { style: {
                        display: 'flex',
                        flexDirection: 'column',
                        gap: '4px',
