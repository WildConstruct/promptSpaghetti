...
}, name, file.name.replace('.psg', ' Copy.psg'), metadata, {
    ...file.metadata,
...
_jsxs("div", { style: {
        ...
        fontSize: '14px',
            ...
            } }), ", gap: '12px'; }}>", _jsxs("div", { style: { flex: 1, maxWidth: '300px' }, children: [_jsx("input", { type: "text", placeholder: "Search projects...", value: viewState.filterText, onChange: (e) => setViewState(prev => ({ ...prev, filterText: e.target.value })), style: {
                        width: '100%',
                        padding: '8px 12px',
