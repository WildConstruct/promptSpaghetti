...
{ /* Test Tab */ }
{
 ...
 >
    (_jsx("h3", { style: { fontSize: '18px', marginBottom: '16px' }, children: "Test Corrections" })
        ,
            _jsx("textarea", { value: testText, onChange: (e) => setTestText(e.target.value), placeholder: "Enter text to test corrections...", style: {
                    width: '100%',
                    minHeight: '120px',
                    padding: '12px',
                    background: '#2a2e37',
                ...
                } }));
{
 ...
 >
    (_jsx("strong", { style: { fontSize: '16px', color: '#a0aec0' }, children: "Result:" })
        ,
            _jsx("div", { style: {
                    padding: '12px',
                    background: '#1e2228',
...
{ /* Settings Tab */ }
{
 ...
 >
    (_jsx("h3", { style: { fontSize: '18px', marginBottom: '16px' }, children: "Settings" })
        ,
