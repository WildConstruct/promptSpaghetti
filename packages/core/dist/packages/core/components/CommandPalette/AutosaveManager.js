                    ...
                    zIndex: 10000,
                        ...
                        boxShadow: 'var(--shadow-xl)'
                                ...
                                overflowY: 'auto',
                                    ...
                                    padding: '40px',
                                    color: styles.textSecondary,
                                }, children: [_jsx("div", { style: { fontSize: '48px', marginBottom: '16px' }, children: "\uD83D\uDCC4" }), _jsx("div", { children: "No autosaved versions available" })] })) : (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '12px' }, children: availableVersions.slice().reverse().map((version, index) => {
