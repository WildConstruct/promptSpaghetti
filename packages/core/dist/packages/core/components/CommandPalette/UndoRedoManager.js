    ...
    constructor(maxSize = 50) {
                ...
                GraphState | null;
                {
                                            ...
                                            clear() {
                                                ...
                                                });
                                                {
                                                    ...
                                                    const getThemeStyles = () => {
                                                        ...
                                                        }, undo, handleUndo, redo, handleRedo, canUndo, () => canUndo, canRedo, () => canRedo, clear, () => undoSystem.clear());
                                                    }, [undoSystem, handleUndo, handleRedo, canUndo, canRedo];
                                                    return;
                                                    _jsxs("div", { style: { position: 'relative', display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("button", { onClick: handleUndo, disabled: !canUndo, title: "Undo (\u2318Z)", style: {
                                                                    padding: '8px 12px',
                                                                    background: styles.background,
                                                                    border: `1px solid ${styles.border}`
                                                                } }), ", borderRadius: '6px', color: canUndo ? styles.text : styles.disabled, cursor: canUndo ? 'pointer' : 'not-allowed', opacity: canUndo ? 1 : 0.5, fontSize: '14px', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '6px', transition: 'all var(--transition-normal)', fontFamily: 'var(--font-family-primary)'; }} >", _jsx("span", { style: { fontSize: '16px' }, children: "\u21B6" }), "Undo"] });
                                                    { /* Redo Button */ }
                                                    ...
                                                    '6px',
                                                        color;
                                                    canRedo ? styles.text : styles.disabled,
                                                        cursor;
                    ...
                    >
                        _jsx("div", { style: {
                            ...
                            }, "background:styles": true, secondary: true, "fontSize:": true });
                '14px',
                    fontWeight;
                '600',
                    color;
        ...
        div >
            _jsxs("div", { style: { maxHeight: '300px', overflow: 'auto' }, children: [undoSystem.getHistory().map((state, index) => {
                        ...
                        return;
                        _jsx("div", { onClick: () => handleHistorySelect(index), style: {
                                padding: '12px 16px',
                                cursor: 'pointer',
                            ...
                            borderBottom;
                    }), ": `1px solid $", styles.border, "`} }, transition: 'all var(--transition-fast)'; }} >", _jsx("div", { style: {
                            fontSize: '13px',
                        ...
                        }, children: [relativeTime, " \u2022 ", state.nodes.length, " nodes, ", state.edges.length, " edges"] })] });
        ;
    }
}
div >
