...
export const WeightPresets = ({ options, onApplyPreset, onSaveCustomPreset, customPresets = [], className = '', showCategories = true, compact = false }) => {
    ...
    if (compact) {
        return (_jsxs("div", { className: `weight-presets compact ${className}`, style: {
                display: 'flex',
                gap: '4px',
                flexWrap: 'wrap'
            }, children: [BUILT_IN_PRESETS.slice(0, 4).map(preset => (_jsxs("button", { onClick: () => handleApplyPreset(preset), title: preset.description, style: {
                        padding: '4px 8px',
                        fontSize: '10px',
                        background: '#4a5568',
                        border: 'none',
                        ...
                        alignItems: 'center',
                        gap: '2px'
                    }, children: [preset.icon, " ", preset.name] }, preset.id))), _jsx("button", { onClick: resetToEqual, title: "Reset to equal weights", style: {
                        padding: '4px 8px',
                        fontSize: '10px',
                        background: '#e53e3e',
                        border: 'none',
    ...
    return (_jsxs("div", { className: `weight-presets ${className}`, style: {
            background: '#2d3748',
            borderRadius: 6,
            padding: 16,
            color: '#e2e8f0'
                    ...
                    marginBottom: 16
                                    ...
                                    color: 'white',
                                    cursor: 'pointer'
                                }, children: "\uD83D\uDD04 Reset" })] })] }), showCategories && (_jsx("div", { style: {
                    display: 'flex',
                    gap: '4px',
                    marginBottom: 12,
                    flexWrap: 'wrap'
                        ...
                        alignItems: 'center',
                        gap: '4px'
                    }, children: [category.icon, " ", category.name] }, category.id))) })), _jsx("div", { style: {
                    display: 'grid',
                    gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))',
                    gap: '8px'
                }, children: filteredPresets.map(preset => (_jsxs("button", { onClick: () => handleApplyPreset(preset), style: {
                        padding: '8px',
                        background: '#4a5568',
                        ...
                        e.currentTarget.style.borderColor = '#718096';
                                ...
                                marginBottom: 4,
                                lineHeight: 1.3
                            }, children: preset.description }), preset.preview && (_jsx("div", { style: {
                                fontSize: '8px',
                                color: '#68d391',
                                fontFamily: 'monospace'
                            }, children: preset.preview }))] }, preset.id))) }), showSaveDialog && (_jsx("div", { style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
