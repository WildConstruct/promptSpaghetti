 ...
 */
export const UIControls = ({ settings, onChange }) => {
    // Handle theme change
    ...
    return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: '16px'
                        ...
                        }, children: "Interface & Accessibility Settings" })] }), _jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    gap: '12px',
                    marginBottom: '20px',
                ...
                }, children: [_jsx(currentThemeInfo.Icon, { size: 16, color: currentThemeInfo.color }), _jsxs("div", { style: {
                            fontSize: '14px',
                            fontWeight: 500,
                            color: uiColors.text.primary
                        }, children: ["Current Theme: ", themeOptions.find(opt => opt.value === settings.theme)?.label] }), _jsx("div", { style: {
                            fontSize: '12px',
                            color: uiColors.text.secondary,
                            marginLeft: 'auto'
                        }, children: settings.highContrast && (_jsxs("span", { style: {
                                display: 'inline-flex',
                                alignItems: 'center',
                                gap: '4px',
                                padding: '2px 6px',
                                ...
                                fontSize: '10px',
                                fontWeight: 500
                            }, children: [_jsx(FiContrast, { size: 10 }), "High Contrast"] })) })] }), uiSections.map((section) => {
                ...
                return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                                ...
                                marginBottom: '12px'
                                        ...
                                        fontWeight: 600,
                                        color: uiColors.text.primary
                                    }, children: section.title })] }), section.content === 'theme-selector' && (_jsx("div", { style: {
                                marginLeft: '24px',
                                display: 'grid',
                                ...
                                return (_jsxs("button", { onClick: () => handleThemeChange(option.value), style: {
                                        display: 'flex',
                                    ...
                                    }, children: [_jsx(Icon, { size: 20, color: isSelected ? uiColors.accent.primary : uiColors.text.secondary, style: { marginBottom: '6px' } }), _jsx("div", { style: {
                                                fontSize: '13px',
                                                fontWeight: 500,
                            ...
                            }) })), section.settings && (_jsx("div", { style: {
                                marginLeft: '24px',
                                display: 'flex',
                                flexDirection: 'column',
                                gap: '12px'
                                ...
                                return (_jsxs("div", { style: {
                                        ...
                                        borderRadius: '6px',
                                        transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)'
                                    }, children: [_jsx(SettingIcon, { size: 16, color: setting.enabled
                                                ? uiColors.accent.primary
                                                : uiColors.text.secondary, style: { marginTop: '2px' } }), _jsxs("div", { style: { flex: 1 }, children: [_jsxs("label", { style: {
                                                        display: 'flex',
                                                        alignItems: 'center',
                                                        gap: '8px',
                                                        cursor: 'pointer',
                                                        ...
                                                        color: uiColors.text.secondary,
                                                        marginLeft: '24px'
                                                    }, children: setting.description })] })] }, setting.key));
                            }) }))] }, section.id));
            }), (settings.reduceAnimations || settings.highContrast) && (_jsxs("div", { style: {
                    padding: '12px',
                    ...
                    marginTop: '16px'
                            ...
                            color: '#6366f1',
                            marginBottom: '6px'
                        }, children: [_jsx(FiContrast, { size: 14 }), "Accessibility Mode Active"] }), _jsx("div", { style: {
                            fontSize: '11px',
                            color: uiColors.text.secondary,
                            lineHeight: 1.4
                        }, children: "You have accessibility options enabled. The interface has been optimized for better visibility and reduced motion." })] })), _jsxs("div", { style: {
                    padding: '12px',
                    backgroundColor: uiColors.ui.hover,
                    borderRadius: '6px',
                    border: `1px solid ${uiColors.ui.border}`,
                    marginTop: '16px'
                            ...
                            fontWeight: 500,
                            color: uiColors.text.primary
                        }, children: [_jsx(FiEye, { size: 14 }), "Interface Configuration Summary"] }), _jsxs("div", { style: {
                            display: 'grid',
