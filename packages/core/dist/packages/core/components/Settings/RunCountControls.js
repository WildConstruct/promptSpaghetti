 ...
 */
export const RunCountControls = ({ settings, onChange }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: '16px'
                            ...
                            marginBottom: '6px'
                                    ...
                                    fontWeight: 500
                                }, children: [_jsx("span", { children: perfInfo.icon }), _jsx("span", { children: perfInfo.description }), _jsx(FiClock, { size: 12 }), _jsx("span", { children: perfInfo.estimatedTime })] })] }), _jsx("div", { style: {
                            fontSize: '11px',
                            color: uiColors.text.secondary,
                            marginTop: '4px'
                        }, children: "Higher counts provide more variation but take longer to generate" })] }), _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("label", { style: {
                            display: 'block',
                            fontSize: '13px',
                            fontWeight: 500,
                            color: uiColors.text.primary,
                            ...
                            return (_jsxs("button", { onClick: () => handlePresetSelect(presetValue), style: {
                                    display: 'flex',
                                    ...
                                    minWidth: '60px'
                                }, title: `${presetValue} variants - ${presetPerf.description}`, onMouseEnter: (e) => {
                                    if (!isSelected) {
                                    ...
                                    if (!isSelected) {
                                        ...
                                        }, children: presetPerf.icon })] }, index));
                        }) })] }), settings.value > 10 && settings.showPerformanceWarning && (_jsxs("div", { style: {
                    display: 'flex',
                    ...
                    borderRadius: '6px',
                    marginBottom: '16px'
                }, children: [_jsx(FiAlertTriangle, { size: 16, color: "#f59e0b", style: { marginTop: '2px' } }), _jsxs("div", { children: [_jsx("div", { style: {
                                    fontSize: '12px',
                                    fontWeight: 500,
                                    color: '#f59e0b',
                                    marginBottom: '4px'
                                    ...
                                    color: uiColors.text.secondary,
                                    lineHeight: 1.4
                                }, children: ["Higher run counts (", settings.value, " variants) may take longer to generate and could impact UI responsiveness. Consider using fewer variants for faster iteration."] })] })] })), _jsxs("div", { style: { marginBottom: '16px' }, children: [_jsxs("label", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: '8px',
                            cursor: 'pointer',
                            ...
                            marginTop: '2px',
                            marginLeft: '24px'
                        }, children: "Displays warnings when run count may impact performance" })] }), _jsx("div", { style: {
                    padding: '12px',
