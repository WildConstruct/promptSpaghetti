 ...
 */
export const PerformanceControls = ({ settings, onChange }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: '16px'
                        ...
                        }, children: "Performance & Debug Settings" })] }), _jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    gap: '12px',
                    marginBottom: '20px',
                    ...
                    border: `1px solid ${uiColors.ui.border}`
                            ...
                            color: enabledCount <= 2
                                ...
                                : enabledCount <= 3
                                    ? '#f59e0b'
                                    : '#ef4444'
                        }, children: enabledCount <= 2 ? (_jsxs(_Fragment, { children: [_jsx(FiEye, { size: 12 }), "Optimized"] })) : enabledCount <= 3 ? (_jsxs(_Fragment, { children: [_jsx(FiActivity, { size: 12 }), "Balanced"] })) : (_jsxs(_Fragment, { children: [_jsx(FiEyeOff, { size: 12 }), "Debug Mode"] })) })] }), performanceSections.map((section) => {
                ...
                return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                                        ...
                                        transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)'
                                                ...
                                                : uiColors.text.secondary, style: { marginTop: '2px' } }), _jsxs("div", { style: { flex: 1 }, children: [_jsxs("label", { style: {
                                                        ...
                                                        fontWeight: 500
                                                            ...
                                                            } }), setting.impact] })] })] }, setting.key));
                            }) })] }, section.id));
            }), enabledCount > 2 && (_jsxs("div", { style: {
                    padding: '12px',
                    ...
                    marginTop: '16px'
                            ...
                            color: '#f59e0b',
                            marginBottom: '6px'
                        }, children: [_jsx(FiActivity, { size: 14 }), "Performance Recommendation"] }), _jsx("div", { style: {
                            fontSize: '11px',
                            color: uiColors.text.secondary,
                            lineHeight: 1.4
                        }, children: enabledCount > 3 ? ('Multiple debug options are enabled. This may significantly impact execution performance. Consider disabling some options for production use.') : ('Some performance monitoring options are enabled. This may have a moderate impact on execution speed.') })] })), _jsxs("div", { style: {
                    padding: '12px',
                    backgroundColor: uiColors.ui.hover,
                    borderRadius: '6px',
                    border: `1px solid ${uiColors.ui.border}`,
                    marginTop: '16px'
                            ...
                            fontWeight: 500,
                            color: uiColors.text.primary
                        }, children: [_jsx(FiMonitor, { size: 14 }), "Performance Configuration Summary"] }), _jsxs("div", { style: {
                            display: 'grid',
                            ...
                            color: uiColors.text.secondary
                                    ...
                                    color: enabledCount <= 2
                                        ...
                                        : enabledCount <= 3
                                            ...
                                            : '#ef4444',
                                    fontWeight: 500
                                }, children: enabledCount <= 2 ? 'Optimized' : enabledCount <= 3 ? 'Balanced' : 'Debug Mode' })] })] })] }));
};
