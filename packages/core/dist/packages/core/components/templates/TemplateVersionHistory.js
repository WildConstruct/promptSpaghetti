...
export const TemplateVersionHistory = ({ _____templateId, onVersionSelect }) => {
    ...
    const renderTimelineView = () => (_jsx("div", { className: "space-y-4", children: versions.map((version, index) => (_jsxs("div", { className: `relative flex items-start space-x-4 p-4 rounded-lg border-2 transition-colors cursor-pointer ${selectedVersions.has(version.id)
                ? 'border-blue-500 bg-blue-50'
                : 'border-gray-200 bg-white hover:border-gray-300'}`, onClick: (e) => handleVersionSelect(version, e.metaKey || e.ctrlKey), children: [index < versions.length - 1 && (_jsx("div", { className: "absolute left-6 top-12 w-0.5 h-16 bg-gray-300" })), _jsx("div", { className: `flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${version.status === 'published' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-600'}`, children: _jsx(FiTag, { className: "w-4 h-4" }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsxs("h3", { className: "text-lg font-semibold text-gray-900", children: ["v", version.version_number] }), _jsx("span", { className: `px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(version.status)}`, children: version.status }), _jsx("span", { className: `text-sm font-medium ${getCompatibilityColor(version.compatibility_level)}`, children: version.compatibility_level }), version.migration_required && (_jsx("span", { className: "px-2 py-1 text-xs font-medium text-orange-600 bg-orange-100 rounded-full", children: "Migration Required" }))] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("button", { onClick: (e) => {
                                                e.stopPropagation();
                                            ...
                                            }, className: "p-1 text-gray-400 hover:text-green-600 transition-colors", title: "Restore version", children: _jsx(FiUpload, { className: "w-4 h-4" }) }), _jsx("button", { className: "p-1 text-gray-400 hover:text-gray-600 transition-colors", children: _jsx(FiMoreVertical, { className: "w-4 h-4" }) })] })] }), version.title && (_jsx("h4", { className: "text-sm font-medium text-gray-700 mt-1", children: version.title })), version.description && (_jsx("p", { className: "text-sm text-gray-600 mt-1", children: version.description })), _jsxs("div", { className: "flex items-center space-x-4 mt-2 text-xs text-gray-500", children: [_jsxs("span", { className: "flex items-center", children: [_jsx(FiClock, { className: "w-3 h-3 mr-1" }), new Date(version.created_at).toLocaleDateString()] }), _jsxs("span", { className: "flex items-center", children: [_jsx(FiGitBranch, { className: "w-3 h-3 mr-1" }), version.branch_name] }), _jsxs("span", { children: [version.download_count, " downloads"] }), _jsxs("span", { children: [version.usage_count, " uses"] }), _jsxs("span", { className: "flex items-center", children: ["\u2B50 ", version.rating.toFixed(1)] })] }), version.changelog && (_jsxs("details", { className: "mt-2", children: [_jsx("summary", { className: "text-sm text-blue-600 cursor-pointer hover:text-blue-700", children: "View changelog" }), _jsx("div", { className: "mt-2 p-2 bg-gray-50 rounded text-sm text-gray-700 whitespace-pre-line", children: version.changelog })] }))] })] }, version.id))) }));
    const renderTableView = () => (_jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: _jsx("input", { type: "checkbox", className: "rounded border-gray-300", onChange: (e) => {
                                    ...
                                    } }) }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Version" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Title" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Branch" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Status" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Created" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Usage" }), _jsx("th", { className: "px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Actions" })] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: versions.map((version) => (_jsxs("tr", { className: `hover:bg-gray-50 cursor-pointer ${selectedVersions.has(version.id) ? 'bg-blue-50' : ''}`, onClick: (e) => handleVersionSelect(version, e.metaKey || e.ctrlKey), children: [_jsx("td", { className: "px-3 py-4 whitespace-nowrap", children: _jsx("input", { type: "checkbox", checked: selectedVersions.has(version.id), onChange: () => { }, className: "rounded border-gray-300" }) }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: _jsxs("div", { className: "flex items-center", children: [_jsxs("span", { className: "text-sm font-medium text-gray-900", children: ["v", version.version_number] }), _jsx("span", { className: `ml-2 text-xs font-medium ${getCompatibilityColor(version.compatibility_level)}`, children: version.compatibility_level })] }) }), _jsxs("td", { className: "px-6 py-4", children: [_jsx("div", { className: "text-sm text-gray-900", children: version.title || '-' }), _jsx("div", { className: "text-sm text-gray-500 truncate max-w-xs", children: version.description || '-' })] }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: _jsxs("span", { className: "flex items-center text-sm text-gray-900", children: [_jsx(FiGitBranch, { className: "w-3 h-3 mr-1" }), version.branch_name] }) }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: _jsx("span", { className: `px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(version.status)}`, children: version.status }) }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: new Date(version.created_at).toLocaleDateString() }), _jsxs("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: [_jsxs("div", { children: [version.download_count, " DL"] }), _jsxs("div", { children: [version.usage_count, " uses"] })] }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium", children: _jsxs("div", { className: "flex items-center justify-end space-x-2", children: [_jsx("button", { onClick: (e) => {
                                                e.stopPropagation();
                                                onVersionExport?.(version);
