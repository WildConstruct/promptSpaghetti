...
;
_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex flex-wrap gap-2", children: [_jsx(Button, { variant: selectedCategory === 'all' ? 'default' : 'outline', size: "sm", onClick: () => setSelectedCategory('all'), children: "All Milestones" }), ['discovery', 'usage', 'creation', 'social', 'learning', 'special'].map((category) => ()
                    < Button, key = { category }, variant = { selectedCategory } === category ? 'default' : 'outline'), "size=\"sm\" onClick=", () => setSelectedCategory(category), "className=\"flex items-center gap-1\" >", getCategoryIcon(category), category.charAt(0).toUpperCase() + category.slice(1)] }), "))}"] });
{ /* Milestone List */ }
_jsx("div", { className: "space-y-3", children: getFilteredMilestones().map((milestone) => ()
        < Card, key = { milestone, : .id }, className = { milestone, : .completed ? 'bg-green-50 border-green-200' : '' } >
        _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: `p-2 rounded-lg ${milestone.completed ? 'bg-green-200 text-green-700' : 'bg-gray-100 text-gray-600'}`, children: ["}", getMilestoneIcon(milestone.icon)] }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("h3", { className: "font-medium", children: milestone.title }), _jsx(Badge, { className: getTierColor(milestone.tier), children: milestone.tier }), milestone.completed && ()
                                        < CheckCircle, " className=\"w-4 h-4 text-green-600\" /> )}"] }), _jsx("p", { className: "text-sm text-gray-600 mb-2", children: milestone.description }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsxs("span", { className: "text-sm font-medium", children: [milestone.current, " / ", milestone.target] }), _jsxs("span", { className: "text-sm text-gray-500", children: [Math.round((milestone.current / milestone.target) * 100), "%"] })] }), _jsx(Progress, { value: (milestone.current / milestone.target) * 100, className: "h-2" })] }), _jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "text-sm font-medium", children: ["+", milestone.xpReward, " XP"] }), milestone.completedAt && ()
                                                < div, " className=\"text-xs text-gray-500\">", milestone.completedAt.toLocaleDateString()] }), ")}"] })] })] }) })) });
Card >
;
div >
;
