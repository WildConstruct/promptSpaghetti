...
_jsxs("div", { style: containerStyle, ref: dropdownRef, children: [_jsxs("label", { htmlFor: inputId, style: labelStyle, children: [label, error && ()
    ...
    ,
        _jsxs("div", { style: selectStyle, onClick: () => !disabled && setIsOpen(!isOpen), onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), tabIndex: disabled ? -1 : 0, children: [_jsx("span", { style: { flex: 1 }, children: getDisplayValue() }), _jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: isOpen ? '▲' : '▼' })] });
{
    isOpen && ()
        < div;
    style = { dropdownStyle } >
 ...
 >
    _jsx("input", { type: "text", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), placeholder: "Search options...", style: {
            width: '100%',
            padding: 4,
            border: '1px solid #4a5568',
            borderRadius: 2,
...
;
{
    groupOptions.map((option) => {
        ...
        return;
        _jsxs("div", { style: optionStyle(selected, option.disabled || false), onClick: () => !option.disabled && handleSelect(option.value), children: [multiple && ()
                    < span, " style=", { marginRight: 8 }, ">", selected ? '☑' : '☐'] }, option.value);
    });
}
{
    option.label;
...
style = {};
{
 ...
 >
    (_jsx("input", { type: "text", value: customValue, onChange: (e) => setCustomValue(e.target.value), placeholder: "Enter custom value...", style: {
            flex: 1,
            padding: 4,
            border: '1px solid #4a5568',
            borderRadius: 2,
