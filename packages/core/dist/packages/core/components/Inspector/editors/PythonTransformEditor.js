...
;
{
 ...
 >
    _jsx("div", { style: { color: '#ed8936', fontSize: 10, fontWeight: 500, marginBottom: 4 }, children: "Validation Warnings:" });
{
...
;
{
 ...
 >
    _jsx("div", { style: { color: '#38b2ac', fontSize: 10, fontWeight: 500 }, children: "\u2713 Code validation passed" });
div >
;
div >
;
...
fieldName = "resources"
    >
        (_jsx(SelectEditor, { label: "Memory Limit", value: memoryLimit, fieldKey: "memoryLimit", options: MEMORY_LIMIT_OPTIONS, zodType: null, onChange: (value) => handleFieldChange('memoryLimit', value) })
            ,
                _jsx(SelectEditor, { label: "Timeout", value: timeout.toString(), fieldKey: "timeout", options: TIMEOUT_OPTIONS, zodType: null, onChange: (value) => handleFieldChange('timeout', parseInt(value)) })
                    ,
                        _jsx("div", { style: {
                                fontSize: 10,
                                color: '#a0aec0',
                ...
                _jsxs("div", { style: { marginBottom: 16 }, children: [_jsxs("label", { style: {
                    ...
                    ,
                        _jsx(TextFieldEditor, { label: "Executor URL (Optional)", value: executorUrl, fieldKey: "executorUrl", zodType: null, onChange: (value) => handlePythonConfigChange('executorUrl', value), placeholder: "http://localhost:8001" })
                            ,
                                _jsx(TextFieldEditor, { label: "Retry Attempts", value: retryAttempts.toString(), fieldKey: "retryAttempts", zodType: null, onChange: (value) => handlePythonConfigChange('retryAttempts', parseInt(value) || 0), placeholder: "3" })
                                    ,
                                        _jsx(SelectEditor, { label: "Fallback Behavior", value: fallbackBehavior, fieldKey: "fallbackBehavior", options: FALLBACK_BEHAVIOR_OPTIONS, zodType: null, onChange: (value) => handlePythonConfigChange('fallbackBehavior', value) }));
{
    ...
    zodType = { null: as, any };
    onChange = {}(value);
    handlePythonConfigChange('defaultOutput', value);
}
placeholder = "Enter default output to use when execution fails...";
rows = { 3:  }
    /  >
;
_jsxs("div", { style: { marginTop: 16 }, children: [_jsxs("div", { style: {
                background: '#1a202c',
                border: '1px solid #4a5568',
                borderRadius: 4,
                padding: 12,
