...
export const PythonTransformEditor = (props) => {
    ...
    return (_jsxs("div", { className: "python-transform-editor", children: [_jsx(ProgressiveDisclosureSection, { title: "Python Code", level: "basic", description: "Write Python functions to transform your story data", defaultExpanded: true, priority: "critical", fieldName: "code", children: _jsxs("div", { style: { marginBottom: 8 }, children: [_jsxs("div", { style: {
                                display: 'flex',
                                        ...
                                        marginBottom: 8
                                                ...
                                                cursor: 'pointer'
                                                    ...
                                                    color: '#e2e8f0'
                                                            ...
                                                            width: 12,
                                                            height: 12
                                                        }, children: "\u2715" })] }, module))) })] })] }) })] }), _jsxs(ProgressiveDisclosureSection, { title: "Technical Configuration & Debug", level: "debug", description: "Advanced Python execution settings and debugging tools", defaultExpanded: false, priority: "supplementary", fieldName: "debug", children: [_jsxs("div", { style: { marginBottom: 16 }, children: [_jsxs("label", { style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: 8,
                                    fontSize: 12,
