...
0.7;
 >
    (_jsx("div", { style: { fontSize: '48px', marginBottom: '16px' }, children: "\uD83C\uDFB2" })
        ,
            _jsx("h4", { style: { margin: '0 0 8px 0', fontSize: '18px', fontWeight: 600 }, children: "No Choices Yet" })
                ,
                    _jsx("p", { style: { margin: '0 0 20px 0', fontSize: '14px' }, children: "Add some choices to get started with weighted random selection" }));
{
    !disabled && ()
        < button;
    onClick = {}();
...
0.6;
 >
    (_jsx("div", { children: "Wild Construct \u2022 Weighted Choice Editor" })
        ,
            _jsx("div", { children: theme === 'cinema' && '🎬 Cinema Mode Enabled' }));
div >
;
div >
;
