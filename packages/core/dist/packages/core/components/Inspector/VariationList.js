...
const handleDrop = (e, index) => {
    ...
    _jsxs("div", { style: { marginBottom: 16 }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: 12,
                            ...
                            fontWeight: 600,
                            color: '#e2e8f0',
                        }, children: ["Variations (", variations.length, ")"] }), allowQuickEntry && ()
                        < button, "onClick=", () => setQuickEntryMode(!quickEntryMode), "style=", {
                        background: 'none',
                        ...
                        cursor: 'pointer',
                        color: '#6b7280',
                    }, "title=\"Quick entry (comma-separated)\" >", quickEntryMode ? 'List' : 'Quick'] }), ")}"] });
    {
        quickEntryMode ? ()
            < div : ;
        style = {};
     ...
     >
        (_jsx("textarea", { value: quickEntryText, onChange: (e) => setQuickEntryText(e.target.value), placeholder: "Enter variations separated by commas...", style: {
                width: '100%',
                height: 80,
                padding: '8px 12px',
                border: '1px solid #4a5568',
...
variations.map((variation, index) => ()
    < div, key = { index }, draggable, onDragStart = {}(e), handleDragStart(e, index), onDragOver = {}(e), handleDragOver(e, index), onDrop = {}(e), handleDrop(e, index), style = {}, {
    display: 'flex',
    alignItems: 'center',
    padding: '8px 12px',
    ...
    < input
    :
, ref = { editInputRef }, type = "text", value = { editingValue }, onChange = {}(e), setEditingValue(e.target.value), onKeyDown = {}(e), {
    if(e) { }, : .key === 'Enter'
});
{
    e.preventDefault();
