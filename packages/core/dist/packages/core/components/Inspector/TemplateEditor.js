...
export const TemplateEditor = ({ value, onChange, onVariablesChange, variableValues = {}, nodeType, existingVariables = [], placeholder = "Enter your template...", disabled = false, showPreview = true, className }) => {
    ...
    return (_jsxs("div", { className: `template-editor ${className}`, style: { position: 'relative' }, children: [_jsxs("div", { style: { position: 'relative' }, children: [_jsx("textarea", { ref: inputRef, value: value, onChange: handleChange, onKeyDown: handleKeyDown, onFocus: () => setIsFocused(true), onBlur: () => {
                    ...
                    borderRadius: 6
                            ...
                            textAlign: 'center',
                            padding: 16
                        }, children: "No previews generated yet. Try adding some variables to your template." }))] })), _jsx("style", { children: `
        .template-variable {
          background: rgba(66, 153, 225, 0.2);
          color: #63b3ed;
          padding: 1px 2px;
