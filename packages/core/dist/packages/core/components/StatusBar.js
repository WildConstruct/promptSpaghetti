...
export const StatusBar = ({ statusMessage, errors, onPreview, onSaveJson, onExportBundle, onSaveProject, onLoadProject, onLoadRecentProject, onNewProject, hasUnsavedChanges = false, currentProjectName, onCorrections, correctionsEnabled = false, correctionsOpen = false, onStats, statsOpen = false, wsConnectionState, wsOnConnect, wsOnDisconnect, onWSDetails, encryptionState, onEncrypt, onDecrypt, onChangeAlgorithm, onOptimization, optimizationEnabled = false, onSaveTemplate, onBrowseTemplates }) => {
