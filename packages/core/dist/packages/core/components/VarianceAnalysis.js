...
const CompactVarianceDisplay = ({ analysis, varianceInfo }) => (_jsxs("div", { style: {
        ...
        borderRadius: 6,
        fontSize: 11
    }, children: [_jsx("span", { children: varianceInfo.icon }), _jsxs("span", { style: { fontWeight: 500, color: varianceInfo.color }, children: [analysis.overallVariance.toUpperCase(), " VARIANCE"] }), _jsx("div", { style: {
                width: 30,
                height: 4,
                background: '#e5e7eb',
                borderRadius: 2,
