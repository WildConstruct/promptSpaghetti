...
});
{
    ...
    ;
    return;
    _jsxs("div", { className: "extension-list-view", children: [_jsxs("div", { className: "extension-list-header", children: [_jsx("span", { className: "header-icon", children: "Type" }), _jsx("span", { className: "header-name", children: "Name" }), _jsx("span", { className: "header-version", children: "Version" }), _jsx("span", { className: "header-status", children: "Status" }), _jsx("span", { className: "header-actions", children: "Actions" })] }), _jsx("div", { className: "extension-list-items", children: extensions.map((extension) => {
                    ...
                    _jsxs("div", { className: "extension-version", children: [_jsx("span", { className: "current-version", children: extension.version }), status.availableVersion && ()
                        ...
                        < div, " className=\"error-details\" title=", status.lastError, "> \u26A0\uFE0F ", status.lastError.substring(0, 50), "..."] }), ")}"] });
    { /* Actions */ }
