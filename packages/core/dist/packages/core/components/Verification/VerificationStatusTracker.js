...
export const VerificationStatusTracker = ({ userId, onRefresh, onRequestVerification }) => {
    ...
    if (isLoading) {
        return (_jsxs("div", { className: "verification-status-tracker loading", children: [_jsx("div", { className: "loading-spinner", children: "Loading verification status..." }), _jsx("style", { children: `
