...
export const RealTimePreviewIntegration = ({ nodes, edges, enableRealTime = true, previewCount = 3, autoRefresh = true, showVarianceAnalysis = true, onPreviewUpdate, onHighlightPath, onError }) => {
    ...
    return (_jsxs("div", { className: "real-time-preview-integration", children: [_jsxs("div", { className: `preview-panel ${isExpanded ? 'expanded' : 'compact'}`, children: [_jsxs("div", { className: "preview-header", children: [_jsxs("div", { className: "header-title", children: [_jsx("span", { className: "preview-icon", children: "\u26A1" }), _jsx("h3", { children: "Live Preview" }), realTimeGenerating && (_jsx("div", { className: "generating-indicator", children: _jsx("div", { className: "spinner" }) }))] }), _jsxs("div", { className: "header-controls", children: [_jsx("button", { className: "expand-btn", onClick: () => setIsExpanded(!isExpanded), title: isExpanded ? 'Collapse' : 'Expand', children: isExpanded ? '▼' : '▶' }), _jsx("button", { className: "detailed-btn", onClick: handleOpenEnhancedModal, disabled: variants.length === 0, title: "Open Detailed Analysis", children: "\uD83D\uDCCA Analysis" })] })] }), displayMetrics && (_jsxs("div", { className: "performance-metrics", children: [_jsxs("div", { className: "metric", children: [_jsx("span", { className: "metric-value", children: displayMetrics.totalVariants }), _jsx("span", { className: "metric-label", children: "Variants" })] }), _jsxs("div", { className: "metric", children: [_jsxs("span", { className: "metric-value", children: [displayMetrics.averageExecutionTime, "ms"] }), _jsx("span", { className: "metric-label", children: "Speed" })] }), _jsxs("div", { className: "metric", children: [_jsxs("span", { className: "metric-value", children: [displayMetrics.successRate, "%"] }), _jsx("span", { className: "metric-label", children: "Success" })] })] })), isExpanded && (_jsx("div", { className: "variants-container", children: variants.length === 0 ? (_jsx("div", { className: "no-variants", children: _jsx("p", { children: "Modify your graph to see live previews" }) })) : (_jsx("div", { className: "variants-list", children: variants.map((variant, index) => (_jsxs("div", { className: `variant-item ${selectedVariant?.id === variant.id ? 'selected' : ''}`, onClick: () => handleVariantClick(variant), children: [_jsxs("div", { className: "variant-header", children: [_jsxs("span", { className: "variant-number", children: ["#", index + 1] }), _jsxs("span", { className: "variant-seed", children: ["Seed: ", variant.seed] }), _jsxs("span", { className: "variant-time", children: [variant.executionTime, "ms"] })] }), _jsx("div", { className: "variant-content", children: variant.result.length > 100
                                            ? `${variant.result.substring(0, 100)}...`
                                            : variant.result }), _jsxs("div", { className: "variant-stats", children: [_jsxs("span", { children: [variant.result.length, " chars"] }), _jsxs("span", { children: [variant.result.split(/\s+/).length, " words"] })] })] }, variant.id))) })) })), realTimeError && (_jsxs("div", { className: "error-display", children: [_jsx("span", { className: "error-icon", children: "\u26A0\uFE0F" }), _jsx("span", { className: "error-text", children: realTimeError })] }))] }), _jsx(EnhancedPreviewModal, { open: showEnhancedModal, loading: enhancedLoading, error: enhancedError, results: enhancedResults.length > 0 ? enhancedResults : convertedResults, varianceAnalysis: varianceAnalysis, onClose: () => setShowEnhancedModal(false), onCancel: cancelPreview, onResultHover: (index) => {
