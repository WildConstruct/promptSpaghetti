...
export const RegionGroup = ({ group, onAction, selected = false, canEdit = true, canMove = true, canResize = true, showLabel = true, showNodeCount = true, nodeCount = 0, zoom = 1 }) => {
    ...
    // Get color theme
    const colorKey = Object.keys(REGION_GROUP_COLORS).find(key => REGION_GROUP_COLORS[key].primary === group.color) || 'blue';
    ...
    return (_jsxs("div", { ref: groupRef, "data-testid": `region-group-${group.id}`, style: {
            position: 'absolute',
            left: group.bounds.x,
            top: group.bounds.y,
            width: group.bounds.width,
            ...
            fontFamily: 'system-ui, -apple-system, sans-serif'
        }, onMouseDown: handleMouseDown, onDoubleClick: startEditingLabel, children: [(showLabel || group.showLabel !== false) && (_jsxs("div", { style: {
                    position: 'absolute',
                    top: -25,
                    left: 0,
                    right: 0,
                    ...
                    cursor: 'default'
                }, onMouseDown: (e) => e.stopPropagation(), children: [_jsx("button", { onClick: handleToggleCollapse, style: {
                            background: 'none',
                            border: 'none',
                            color: 'white',
                            fontSize: 12,
                        ...
                        }, title: group.collapsed ? 'Expand group' : 'Collapse group', children: group.collapsed ? '▶' : '▼' }), isEditingLabel ? (_jsx("input", { ref: labelInputRef, type: "text", value: editLabelValue, onChange: (e) => setEditLabelValue(e.target.value), onKeyDown: handleLabelKeyDown, onBlur: saveLabel, style: {
                            flex: 1,
                            ...
                            fontWeight: 600,
                            borderRadius: 3
                        }, maxLength: 50 })) : (_jsx("span", { style: {
                            flex: 1,
                            cursor: canEdit ? 'pointer' : 'default',
                            textOverflow: 'ellipsis',
                            overflow: 'hidden',
                            whiteSpace: 'nowrap'
                        }, onDoubleClick: startEditingLabel, title: group.label, children: group.label })), (showNodeCount || group.showNodeCount !== false) && (_jsx("span", { style: {
                            fontSize: 10,
                            opacity: 0.9,
                            ...
                            minWidth: 16,
                            textAlign: 'center'
                        }, title: `${nodeCount} node${nodeCount !== 1 ? 's' : ''}`, children: nodeCount })), group.isLocked && (_jsx("span", { style: { fontSize: 10, opacity: 0.8 }, title: "Group is locked", children: "\uD83D\uDD12" }))] })), canResize && selected && !group.isLocked && (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                            position: 'absolute',
                            bottom: -4,
                            right: -4,
                            width: 8,
                        ...
                        }, onMouseDown: (e) => handleResizeMouseDown(e, 'se') }), _jsx("div", { style: {
                            position: 'absolute',
                            bottom: -4,
                            left: -4,
                            width: 8,
                            ...
                            cursor: 'sw-resize',
                            boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)'
                        }, onMouseDown: (e) => handleResizeMouseDown(e, 'sw') }), _jsx("div", { style: {
                            position: 'absolute',
                            top: -4,
                            right: -4,
                            width: 8,
                            ...
                            cursor: 'ne-resize',
                            boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)'
                        }, onMouseDown: (e) => handleResizeMouseDown(e, 'ne') }), _jsx("div", { style: {
                            position: 'absolute',
                            top: -4,
                            left: -4,
                            width: 8,
                            ...
                            cursor: 'nw-resize',
                            boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)'
                        }, onMouseDown: (e) => handleResizeMouseDown(e, 'nw') })] })), group.description && (_jsx("div", { style: {
                    position: 'absolute',
                    bottom: '100%',
                    left: '50%',
                    ...
                    zIndex: 1000
                }, className: "group-description-tooltip" })), group.collapsed && (_jsx("div", { style: {
                    position: 'absolute',
                    top: '50%',
                    left: '50%',
