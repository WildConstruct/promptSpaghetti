...
export const ConnectionLabel = ({ label, onAction, canEdit = true, showTooltip = true, isHighlighted = false, connectionPath }) => {
    ...
    return (_jsxs("div", { ref: labelRef, "data-testid": `connection-label-${label.id}`, style: {
            position: 'absolute',
            ...
            ...(isDragging && {
                ...
                boxShadow: `0 8px 20px ${labelStyles.color}40`
        ...
        }, onMouseDown: handleMouseDown, onDoubleClick: handleDoubleClick, title: showTooltip ? label.content : undefined, children: [isEditing ? (_jsx("input", { ref: inputRef, type: "text", value: editValue, onChange: handleInputChange, onKeyDown: handleKeyDown, onBlur: handleBlur, style: {
                    ...labelStyles,
                    outline: 'none',
                    ...
                    maxWidth: '200px',
                    background: 'white'
                }, placeholder: "Enter label...", maxLength: 100 })) : (_jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    gap: '4px'
                }, children: [label.showIcon && label.icon && (_jsx("span", { style: { fontSize: '12px' }, children: label.icon })), _jsx("span", { children: label.content }), canEdit && (_jsx("span", { style: {
                            fontSize: '8px',
                            opacity: 0.6,
                            marginLeft: '2px'
                        }, children: "\u270F\uFE0F" }))] })), canEdit && !isEditing && (_jsx("button", { style: {
                    position: 'absolute',
                    top: '-8px',
                    right: '-8px',
                    width: '16px',
                ...
                }, title: "Remove label", children: "\u00D7" })), label.style === 'arrow' && (_jsx("div", { style: {
                    position: 'absolute',
                    bottom: '-6px',
                    left: '50%',
                ...
                } })), label.style === 'highlight' && (_jsx("div", { style: {
                    position: 'absolute',
                    inset: '-4px',
