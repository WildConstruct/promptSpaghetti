...
className = "quality-visualization" >
    _jsxs("div", { className: "score-circle", children: [_jsx("div", { className: "score-fill", style: {
                ...
                } }), "} >", _jsxs("div", { className: "score-inner", children: [_jsx("div", { className: "score-number", children: formatScore(qualityMetrics.overallQualityScore) }), _jsx("div", { className: "score-label", children: "Quality Score" })] })] });
div >
