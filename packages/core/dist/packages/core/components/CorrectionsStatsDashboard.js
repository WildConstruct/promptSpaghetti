...
style = {};
{
 ...
 >
    (_jsxs("div", { style: {
            ...
            borderRadius: '8px',
            border: '1px solid #444',
        }, children: [_jsx("h3", { style: { fontSize: '14px', color: '#a0aec0', margin: '0 0 8px 0' }, children: "Total Rules" }), _jsx("div", { style: { fontSize: '24px', fontWeight: 600, color: '#63b3ed' }, children: metrics.total_rules }), _jsxs("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: [metrics.active_rules, " active"] })] })
        ,
            _jsxs("div", { style: {
                    background: '#2a2e37',
                    padding: '16px',
                    borderRadius: '8px',
                    border: '1px solid #444',
                }, children: [_jsx("h3", { style: { fontSize: '14px', color: '#a0aec0', margin: '0 0 8px 0' }, children: "Total Executions" }), _jsx("div", { style: { fontSize: '24px', fontWeight: 600, color: '#68d391' }, children: metrics.total_executions.toLocaleString() }), _jsxs("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: ["Last ", selectedPeriod, " days"] })] })
                ,
                    _jsxs("div", { style: {
                            background: '#2a2e37',
                            padding: '16px',
                            borderRadius: '8px',
                            border: '1px solid #444',
                        }, children: [_jsx("h3", { style: { fontSize: '14px', color: '#a0aec0', margin: '0 0 8px 0' }, children: "Avg Execution Time" }), _jsxs("div", { style: { fontSize: '24px', fontWeight: 600, color: '#9f7aea' }, children: [metrics.average_execution_time.toFixed(1), "ms"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: "Per rule application" })] })
                        ,
                            _jsxs("div", { style: {
                                    background: '#2a2e37',
                                    padding: '16px',
                                    ...
                                    border: '1px solid #444',
                                        ...
                                        }, children: [metrics.error_rate.toFixed(1), "%"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: metrics.error_rate > 5 ? 'Needs attention' : 'Good performance' })] })
                                ,
                                    _jsxs("div", { style: {
                                            background: '#2a2e37',
                                            padding: '16px',
                                            ...
                                            border: '1px solid #444',
                                                ...
                                                }, children: [metrics.overall_quality_score.toFixed(0), "/100"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: "Overall effectiveness" })] })
                                        ,
                                            _jsxs("div", { style: {
                                                    background: '#2a2e37',
                                                    padding: '16px',
                                                    ...
                                                    border: '1px solid #444',
                                                        ...
                                                        }, children: [metrics.average_impact_rating.toFixed(1), "/5"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: "Average significance" })] })
                                                ,
                                                    _jsxs("div", { style: {
                                                            background: '#2a2e37',
                                                            padding: '16px',
                                                            ...
                                                            border: '1px solid #444',
                                                                ...
                                                                }, children: metrics.total_characters_saved.toLocaleString() }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: "Text optimization" })] })
                                                        ,
                                                            _jsxs("div", { style: {
                                                                    background: '#2a2e37',
                                                                    padding: '16px',
                                                                    ...
                                                                    border: '1px solid #444',
                                                                        ...
                                                                        }, children: [metrics.false_positive_rate.toFixed(1), "%"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: metrics.false_positive_rate <= 5 ? 'Excellent accuracy' : 'Needs improvement' })] }));
div >
    { /* Most Used Rules */}
    < div >
    (_jsx("h3", { style: { fontSize: '16px', fontWeight: 600, marginBottom: '16px' }, children: "Most Used Rules" })
        ,
            _jsxs("div", { style: {
                    background: '#2a2e37',
                    borderRadius: '8px',
                    ...
                    overflow: 'hidden',
                        ...
                        }, children: [_jsx("div", { children: "Rule Name" }), _jsx("div", { children: "Applications" }), _jsx("div", { children: "Quality" }), _jsx("div", { children: "Impact" }), _jsx("div", { children: "Avg Time" }), _jsx("div", { children: "Success Rate" }), _jsx("div", { children: "Trend" })] }), metrics.most_used_rules.slice(0, 10).map((rule) => ()
                        ...
                        borderBottom: '1px solid #444',
                        fontSize: '14px',
                    }), ">", _jsx("div", { style: { fontWeight: 500 }, children: rule.rule_name }), _jsx("div", { children: rule.total_applications.toLocaleString() }), _jsx("div", { style: {
...
div >
    { /* Performance Trends */}
    < div >
    (_jsx("h3", { style: { fontSize: '16px', fontWeight: 600, marginBottom: '16px' }, children: "Performance Trends" })
        ,
            _jsxs("div", { style: {
                    background: '#2a2e37',
                    borderRadius: '8px',
                    border: '1px solid #444',
                    padding: '16px',
                }, children: [metrics.performance_trends.length > 0 ? ()
                        < div : , " style=", {
                        display: 'grid',
...
div >
    { /* Rule Distribution */}
    < div >
    (_jsx("h3", { style: { fontSize: '16px', fontWeight: 600, marginBottom: '16px' }, children: "Rule Effectiveness Distribution" })
        ,
            _jsxs("div", { style: {
                    display: 'grid',
                    ...
                    marginBottom: '24px',
                        ...
                        borderRadius: '8px',
                        border: '1px solid #444',
                    }, ">", _jsx("h4", { style: { fontSize: '14px', color: '#a0aec0', margin: '0 0 8px 0' }, children: "User Satisfaction" }), _jsxs("div", { style: {
                            fontSize: '24px',
                            fontWeight: 600,
                            color: metrics.user_satisfaction_score >= 4 ? '#68d391' : ,
                            metrics, : .user_satisfaction_score >= 3 ? '#fbb040' : '#e53e3e',
                        }, children: [metrics.user_satisfaction_score.toFixed(1), "/5"] }), _jsx("div", { style: { fontSize: '12px', color: '#a0aec0', marginTop: '4px' }, children: "Average user rating" })] }));
div >
;
div >
    { /* Actions */}
...
style = {};
{
 ...
 >
    (_jsx("button", { onClick: fetchMetrics, style: {
            padding: '8px 16px',
            background: '#63b3ed',
            color: '#fff',
            border: 'none',
