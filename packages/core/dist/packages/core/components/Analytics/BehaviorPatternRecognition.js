...
const generateMockSessionBehaviorData = () => {
    ...
    return {
        ...
        navigationPath: Array.from({ length: Math.floor(Math.random() * 8) + 1 }, () => ({
            ...
            timestamp: timestamp + Math.random() * duration,
            method: ['link', 'button', 'form', 'back'][Math.floor(Math.random() * 4)],
        ...
        features: {
            ...
            behavioral: {
                ...
                decisionMakingStyle: ['quick', 'deliberate', 'explorative'][Math.floor(Math.random() * 3)],
                intentSignals: [],
        ...
        context: {
            ...
            user: {
                userId,
                userType: ['new', 'returning', 'premium'][Math.floor(Math.random() * 3)],
            ...
            temporal: {
                ...
                relativeTime: ['morning', 'afternoon', 'evening', 'night'][Math.floor(Math.random() * 4)]
            }
        }
    };
};
...
// Main component
export const BehaviorPatternRecognition = ({ analyticsInfrastructure, patternConfig, sessionData, realTimeMode = true, onPatternDetected, onAnomalyDetected, onInsightGenerated, onExport }) => {
