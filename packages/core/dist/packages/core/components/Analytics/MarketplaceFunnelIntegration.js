    ...
    try {
        ...
        if (marketplaceContext.templateContext) {
            query.filters?.push();
            {
                ...
                'eq',
                    value;
                marketplaceContext.templateContext.templateId;
            }
        }
    }
    finally {
...
if (marketplaceContext.creatorContext) {
    query.filters?.push();
    {
        ...
        'eq',
            value;
        marketplaceContext.creatorContext.creatorId;
    }
    ;
    ...
    };
    {
        ...
        if (loading) {
            return;
            _jsxs("div", { className: "marketplace-integration-loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading marketplace integration..." })] });
            ;
            if (error) {
                return;
                _jsxs("div", { className: "marketplace-integration-error", children: [_jsx("h3", { children: "Integration Error" }), _jsx("p", { className: "error-message", children: error }), _jsx("button", { onClick: loadIntegrationData, className: "retry-button", children: "Retry" })] });
                ;
                if (!integrationData) {
