 ...
 */
export const DropoffHeatmap = ({ funnelDefinition, analyticsInfrastructure, timeRange, segments = [], cohorts = [], heatmapMode = 'relative', showRecoveryAnalysis = true, realTimeUpdates = false, onDropoffPointClick, onExport }) => {
    ...
    const loadAnalysisData = useCallback(async () => {
        try {
            ...
            const processedData = await processDropoffAnalysisData(funnelDefinition, results, segments, cohorts, timeRange);
    ...
    if (error || !analysisData) {
        return (_jsx(DropoffAnalysisErrorState, { error: error || 'No data available', onRetry: loadAnalysisData }));
    }
    return (_jsxs("div", { className: "dropoff-heatmap", ref: heatmapRef, children: [_jsx(DropoffHeatmapHeader, { funnelDefinition: funnelDefinition, heatmapMode: heatmapMode, analysisData: analysisData, onExport: handleExport }), _jsx("div", { className: "heatmap-container", children: _jsx(HeatmapVisualization, { analysisData: analysisData, heatmapMode: heatmapMode, colorScale: colorScale, hoveredCell: hoveredCell, selectedStep: selectedStep, onCellHover: handleCellHover, onStepClick: handleStepClick }) }), _jsxs("div", { className: "analysis-panels", children: [selectedStep && (_jsx(StepDetailPanel, { stepId: selectedStep, analysisData: analysisData, onClose: () => setSelectedStep(null) })), showRecoveryAnalysis && (_jsx(RecoveryOpportunityPanel, { opportunities: analysisData.recoveryOpportunities })), _jsx(DropoffInsightsPanel, { insights: analysisData.overallInsights, rootCauses: analysisData.rootCauseAnalysis })] }), analysisData.temporalPatterns.length > 0 && (_jsx(TemporalPatternsPanel, { patterns: analysisData.temporalPatterns }))] }));
};
const DropoffHeatmapHeader = ({ funnelDefinition, heatmapMode, analysisData, onExport }) => {
...
const HeatmapLegend = ({ heatmapMode, colorScale }) => {
    ...
    return (_jsxs("div", { className: "heatmap-legend", children: [_jsxs("div", { className: "legend-title", children: [heatmapMode.replace('_', ' ').toUpperCase(), " Scale"] }), _jsxs("div", { className: "legend-gradient", children: [_jsxs("svg", { width: "200", height: "20", children: [_jsx("defs", { children: _jsx("linearGradient", { id: "heatmap-gradient", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: gradientStops.map(stop => (_jsx("stop", { offset: stop.offset, stopColor: stop.color }, stop.offset))) }) }), _jsx("rect", { x: "0", y: "0", width: "200", height: "20", fill: "url(#heatmap-gradient)" })] }), _jsxs("div", { className: "legend-labels", children: [_jsx("span", { children: colorScale.min.toFixed(1) }), _jsx("span", { children: ((colorScale.min + colorScale.max) / 2).toFixed(1) }), _jsx("span", { children: colorScale.max.toFixed(1) })] })] })] }));
};
const StepDetailPanel = ({ stepId, analysisData, onClose }) => {
    ...
    if (!stepAnalysis || !rootCause || !recovery)
        return null;
    return (_jsxs("div", { className: "step-detail-panel", children: [_jsxs("div", { className: "panel-header", children: [_jsxs("h4", { children: [stepAnalysis.stepName, " - Detailed Analysis"] }), _jsx("button", { onClick: onClose, className: "close-button", children: "\u00D7" })] }), _jsxs("div", { className: "detail-sections", children: [_jsxs("div", { className: "overview-section", children: [_jsx("h5", { children: "Overview" }), _jsxs("div", { className: "metrics-grid", children: [_jsxs("div", { className: "metric", children: [_jsx("span", { children: "Drop-off Count:" }), _jsx("span", { children: stepAnalysis.dropOffCount.toLocaleString() })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { children: "Drop-off Rate:" }), _jsxs("span", { children: [stepAnalysis.dropOffRate.toFixed(2), "%"] })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { children: "Severity:" }), _jsx("span", { className: `severity ${stepAnalysis.dropOffSeverity}`, children: stepAnalysis.dropOffSeverity.toUpperCase() })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { children: "Recovery Potential:" }), _jsxs("span", { children: [stepAnalysis.recoveryPotential.toFixed(1), "%"] })] })] })] }), _jsxs("div", { className: "root-cause-section", children: [_jsx("h5", { children: "Root Cause Analysis" }), _jsx("div", { className: "primary-causes", children: rootCause.primaryCauses.slice(0, 3).map((cause, index) => (_jsxs("div", { className: "cause-item", children: [_jsxs("div", { className: "cause-header", children: [_jsx("span", { className: "category", children: cause.category }), _jsxs("span", { className: "impact", children: [cause.impact, "% impact"] })] }), _jsx("p", { className: "cause-description", children: cause.description }), _jsxs("div", { className: "mitigation", children: [_jsx("strong", { children: "Complexity:" }), " ", cause.mitigationComplexity, _jsx("strong", { children: "Expected Improvement:" }), " ", cause.expectedImprovement, "%"] })] }, index))) })] }), _jsxs("div", { className: "recovery-section", children: [_jsx("h5", { children: "Recovery Opportunities" }), recovery.quickWins.length > 0 && (_jsxs("div", { className: "quick-wins", children: [_jsx("h6", { children: "Quick Wins" }), recovery.quickWins.slice(0, 3).map((win, index) => (_jsxs("div", { className: "quick-win-item", children: [_jsx("h6", { children: win.title }), _jsx("p", { children: win.description }), _jsxs("div", { className: "win-metrics", children: [_jsxs("span", { children: ["Effort: ", win.effort] }), _jsxs("span", { children: ["Impact: ", win.expectedImpact, "%"] }), _jsxs("span", { children: ["Time: ", win.implementationTime, "h"] })] })] }, index)))] })), recovery.strategicInitiatives.length > 0 && (_jsxs("div", { className: "strategic-initiatives", children: [_jsx("h6", { children: "Strategic Initiatives" }), recovery.strategicInitiatives.slice(0, 2).map((initiative, index) => (_jsxs("div", { className: "strategic-item", children: [_jsx("h6", { children: initiative.title }), _jsx("p", { children: initiative.description }), _jsxs("div", { className: "initiative-metrics", children: [_jsxs("span", { children: ["Effort: ", initiative.effort] }), _jsxs("span", { children: ["Impact: ", initiative.expectedImpact, "%"] }), _jsxs("span", { children: ["Time: ", initiative.implementationTime, " days"] })] })] }, index)))] }))] })] })] }));
};
const RecoveryOpportunityPanel = ({ opportunities }) => {
    ...
    return (_jsxs("div", { className: "recovery-opportunity-panel", children: [_jsx("h4", { children: "Recovery Opportunities" }), _jsxs("div", { className: "recovery-summary", children: [_jsxs("div", { className: "summary-metric", children: [_jsx("span", { className: "label", children: "Total Potential" }), _jsxs("span", { className: "value", children: ["$", totalRecoveryValue.toLocaleString()] })] }), _jsxs("div", { className: "summary-metric", children: [_jsx("span", { className: "label", children: "High Confidence" }), _jsx("span", { className: "value", children: highConfidenceOpportunities.length })] })] }), _jsx("div", { className: "opportunities-list", children: opportunities
                    .sort((a, b) => b.recoveryValue - a.recoveryValue)
                    .slice(0, 5)
                    .map(opportunity => (_jsxs("div", { className: "opportunity-item", children: [_jsxs("div", { className: "opportunity-header", children: [_jsx("h5", { children: opportunity.stepName }), _jsxs("span", { className: "recovery-value", children: ["$", opportunity.recoveryValue.toLocaleString()] })] }), _jsxs("div", { className: "opportunity-metrics", children: [_jsxs("div", { className: "metric", children: [_jsx("span", { children: "Potential:" }), _jsxs("span", { children: [opportunity.recoveryPotential, "%"] })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { children: "Time to Impact:" }), _jsxs("span", { children: [opportunity.timeToImpact, " days"] })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { children: "Confidence:" }), _jsxs("span", { children: [(opportunity.confidenceLevel * 100).toFixed(0), "%"] })] })] }), opportunity.quickWins.length > 0 && (_jsxs("div", { className: "quick-actions", children: [_jsx("strong", { children: "Quick Actions:" }), _jsx("ul", { children: opportunity.quickWins.slice(0, 2).map((win, index) => (_jsx("li", { children: win.title }, index))) })] }))] }, opportunity.stepId))) })] }));
};
const DropoffInsightsPanel = ({ insights, rootCauses }) => {
    ...
    return (_jsxs("div", { className: "dropoff-insights-panel", children: [_jsx("h4", { children: "Key Insights" }), _jsx("div", { className: "insights-list", children: criticalInsights.slice(0, 5).map((insight, index) => (_jsxs("div", { className: `insight-item ${insight.severity}`, children: [_jsxs("div", { className: "insight-header", children: [_jsx("h5", { children: insight.title }), _jsx("span", { className: `severity-badge ${insight.severity}`, children: insight.severity.toUpperCase() })] }), _jsx("p", { className: "insight-description", children: insight.description }), _jsxs("div", { className: "insight-metrics", children: [_jsxs("span", { children: ["Impact: ", insight.impact, "%"] }), _jsxs("span", { children: ["Confidence: ", (insight.confidence * 100).toFixed(0), "%"] }), _jsxs("span", { children: ["Timeframe: ", insight.timeframe] })] }), insight.recommendations.length > 0 && (_jsxs("div", { className: "insight-recommendations", children: [_jsx("strong", { children: "Recommendations:" }), _jsx("ul", { children: insight.recommendations.slice(0, 2).map((rec, recIndex) => (_jsx("li", { children: rec }, recIndex))) })] }))] }, index))) })] }));
};
const TemporalPatternsPanel = ({ patterns }) => {
    return (_jsxs("div", { className: "temporal-patterns-panel", children: [_jsx("h4", { children: "Temporal Drop-off Patterns" }), _jsx("div", { className: "patterns-grid", children: patterns.map((pattern, index) => (_jsxs("div", { className: "pattern-item", children: [_jsxs("h5", { children: [pattern.period.toUpperCase(), " ", pattern.periodValue] }), _jsx("div", { className: "pattern-rates", children: pattern.dropOffRates.slice(0, 3).map((rate, rateIndex) => (_jsxs("div", { className: "rate-item", children: [_jsx("span", { className: "step-name", children: rate.stepName }), _jsxs("span", { className: "rate-value", children: [rate.dropOffRate.toFixed(1), "%"] }), _jsx("span", { className: `trend ${rate.trend}`, children: rate.trend === 'increasing' ? '↗' :
                                            rate.trend === 'decreasing' ? '↘' : '→' })] }, rateIndex))) }), pattern.insights.length > 0 && (_jsx("div", { className: "pattern-insights", children: pattern.insights.slice(0, 2).map((insight, insightIndex) => (_jsx("p", { className: "pattern-insight", children: insight }, insightIndex))) }))] }, index))) })] }));
};
// Loading and Error States
const DropoffAnalysisLoadingState = () => (_jsxs("div", { className: "dropoff-analysis-loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Analyzing drop-off patterns..." })] }));
const DropoffAnalysisErrorState = ({ error, onRetry }) => (_jsxs("div", { className: "dropoff-analysis-error", children: [_jsxs("div", { className: "error-message", children: [_jsx("h3", { children: "Error Loading Analysis" }), _jsx("p", { children: error })] }), _jsx("button", { onClick: onRetry, className: "retry-button", children: "Retry Analysis" })] }));
// Utility Functions
...
function getHeatmapColor(value, colorScale, type) {
    if (!colorScale)
        return '#f3f4f6';
...
async function processDropoffAnalysisData(funnelDefinition, metricResults, segments, cohorts, timeRange) {
    // Simplified implementation - in production would process actual metrics
    const stepAnalysis = funnelDefinition.steps.map((step, index) => ({
        stepId: step.id,
        stepName: step.name,
    ...
    const rootCauseAnalysis = stepAnalysis.map(step => ({
        stepId: step.stepId,
    ...
    const recoveryOpportunities = stepAnalysis.map(step => ({
        stepId: step.stepId,
        stepName: step.stepName,
