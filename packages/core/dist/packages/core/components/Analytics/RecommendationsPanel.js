...
};
{
    ...
    const getImpactIcon = (impact) => {
        ...
        ;
        return;
        _jsxs(Card, { className: `recommendation-item ${priorityClass} border-l-4`, children: ["}", _jsx(CardHeader, { className: "pb-2", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx(IconComponent, { className: "w-5 h-5 mt-1 flex-shrink-0" }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx(Badge, { variant: recommendation.priority === 'high' ? 'destructive' : recommendation.priority === 'medium' ? 'warning' : 'secondary', children: recommendation.priority }), _jsx("span", { className: "text-sm text-gray-600", children: recommendation.type.replace('_', ' ') })] }), _jsx("div", { className: "font-medium", children: recommendation.title }), _jsx("div", { className: "text-sm text-gray-600 mt-1", children: recommendation.description })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [getImpactIcon(recommendation.impact), _jsx(Button, { size: "sm", variant: "ghost", onClick: () => setIsExpanded(!isExpanded), children: isExpanded ? 'Less' : 'More' })] })] }) }), isExpanded && ()
                    < CardContent >
                    _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "text-2xl font-bold text-green-600", children: ["$", recommendation.estimatedSavings?.toFixed(2) || '0.00'] }), _jsx("div", { className: "text-sm text-gray-600", children: "Estimated Savings" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-blue-600", children: recommendation.affectedUsers || 0 }), _jsx("div", { className: "text-sm text-gray-600", children: "Affected Users" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-orange-600", children: recommendation.impact }), _jsx("div", { className: "text-sm text-gray-600", children: "Impact Level" })] })] }), recommendation.actionItems && recommendation.actionItems.length > 0 && ()
                                < div, " className=\"space-y-2\">", _jsx("div", { className: "font-medium", children: "Action Items:" }), _jsx("ul", { className: "space-y-1", children: recommendation.actionItems.map((item, index) => ()
                                    < li, key = { index }, className = "flex items-start gap-2 text-sm" >
                                    (_jsx(ArrowRight, { className: "w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" })
                                        ,
...
{ /* Implementation Progress */ }
{
    recommendation.implementationProgress && ()
        < div;
    className = "space-y-2" >
        (_jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-sm font-medium", children: "Implementation Progress" }), _jsxs("span", { className: "text-sm text-gray-600", children: [recommendation.implementationProgress, "%"] })] })
            ,
                _jsx(Progress, { value: recommendation.implementationProgress, className: "h-2" }));
    div >
    ;
}
{ /* Action Buttons */ }
_jsxs("div", { className: "flex justify-between items-center pt-2", children: [_jsxs("div", { className: "flex gap-2", children: [onApply && ()
                    < Button, "size=\"sm\" onClick=", handleApply, "disabled=", isProcessing, "className=\"flex items-center gap-2\" >", _jsx(CheckCircle, { className: "w-4 h-4" }), isProcessing ? 'Applying...' : 'Apply'] }), ")}", onDismiss && ()
            < Button, "size=\"sm\" variant=\"outline\" onClick=", handleDismiss, "disabled=", isProcessing, "className=\"flex items-center gap-2\" >", _jsx(XCircle, { className: "w-4 h-4" }), "Dismiss"] });
div >
    { /* Feedback Buttons */};
{
    onFeedback && ()
    ...
    className = "flex gap-2" >
        (_jsxs(Button, { size: "sm", variant: "ghost", onClick: () => handleFeedback('positive'), className: `flex items-center gap-1 ${feedback === 'positive' ? 'text-green-600' : ''}`, children: [_jsx(ThumbsUp, { className: "w-4 h-4" }), "Helpful"] })
            ,
                _jsxs(Button, { size: "sm", variant: "ghost", onClick: () => handleFeedback('negative'), className: `flex items-center gap-1 ${feedback === 'negative' ? 'text-red-600' : ''}`, children: [_jsx(ThumbsDown, { className: "w-4 h-4" }), "Not Helpful"] }));
    div >
    ;
}
div >
