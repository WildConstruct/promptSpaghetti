...
// Main component
export const RecommendationEffectivenessTracking = ({ analyticsInfrastructure, trackingConfig, onEffectivenessAlert, onPerformanceInsight, onExport }) => {
