...
// Main component
export const UserPreferenceLearningSystem = ({ analyticsInfrastructure, learningConfig, modelingConfig, onModelUpdate, onLearningInsight, onExport }) => {
    ...
    return (_jsxs("div", { className: "preference-learning-system", children: [_jsxs("div", { className: "system-header", children: [_jsxs("div", { className: "header-section", children: [_jsx("h2", { children: "User Preference Learning & Modeling" }), _jsxs("div", { className: "system-stats", children: [_jsxs("div", { className: "stat", children: [_jsx("span", { className: "stat-value", children: systemStats.totalUsers }), _jsx("span", { className: "stat-label", children: "Users" })] }), _jsxs("div", { className: "stat", children: [_jsxs("span", { className: "stat-value", children: [systemStats.avgConfidence, "%"] }), _jsx("span", { className: "stat-label", children: "Avg Confidence" })] }), _jsxs("div", { className: "stat", children: [_jsx("span", { className: "stat-value", children: systemStats.totalModels }), _jsx("span", { className: "stat-label", children: "Models" })] }), _jsxs("div", { className: "stat", children: [_jsxs("span", { className: "stat-value", children: [systemStats.bestAccuracy, "%"] }), _jsx("span", { className: "stat-label", children: "Best Accuracy" })] })] })] }), _jsxs("div", { className: "header-controls", children: [_jsxs("div", { className: "view-selector", children: [_jsx("button", { className: selectedView === 'profiles' ? 'active' : '', onClick: () => setSelectedView('profiles'), children: "User Profiles" }), _jsx("button", { className: selectedView === 'models' ? 'active' : '', onClick: () => setSelectedView('models'), children: "Models" }), _jsx("button", { className: selectedView === 'learning' ? 'active' : '', onClick: () => setSelectedView('learning'), children: "Learning Process" }), _jsx("button", { className: selectedView === 'insights' ? 'active' : '', onClick: () => setSelectedView('insights'), children: "Insights" })] }), _jsx("button", { className: "train-btn", onClick: handleTrainModel, disabled: loading, children: loading ? '🧠 Training...' : '🚀 Train Model' }), _jsx("button", { className: "export-btn", onClick: handleExport, children: "\uD83D\uDCCA Export Data" })] })] }), _jsxs("div", { className: "system-content", children: [loading && (_jsxs("div", { className: "loading-overlay", children: [_jsx("div", { className: "loading-spinner", children: "\uD83E\uDDE0" }), _jsx("div", { className: "loading-text", children: "Training preference learning model..." })] })), selectedView === 'profiles' && (_jsxs("div", { className: "profiles-view", children: [_jsxs("div", { className: "users-list", children: [_jsx("h3", { children: "User Preference Profiles" }), _jsx("div", { className: "user-items", children: userProfiles.slice(0, 12).map(profile => (_jsxs("div", { className: `user-item ${selectedUser === profile.userId ? 'active' : ''}`, onClick: () => setSelectedUser(profile.userId), children: [_jsxs("div", { className: "user-header", children: [_jsx("div", { className: "user-id", children: profile.userId.slice(-8) }), _jsxs("div", { className: "confidence-score", children: [Math.round(profile.confidenceMetrics.overall * 100), "% confidence"] })] }), _jsx("div", { className: "preference-summary", children: profile.preferenceVector.dimensions.slice(0, 2).map((dim, index) => (_jsxs("div", { className: "dimension-item", children: [_jsx("span", { className: "dim-name", children: dim.dimension.replace('_', ' ') }), _jsxs("span", { className: "dim-value", children: [Math.round(dim.value * 100), "%"] })] }, index))) }), _jsxs("div", { className: "last-updated", children: ["Updated: ", new Date(profile.lastUpdated).toLocaleDateString()] })] }, profile.userId))) })] }), selectedUserProfile && (_jsxs("div", { className: "profile-details", children: [_jsxs("h3", { children: ["Preference Profile: ", selectedUserProfile.userId.slice(-8)] }), _jsxs("div", { className: "profile-overview", children: [_jsxs("div", { className: "confidence-metrics", children: [_jsx("h4", { children: "Confidence Metrics" }), _jsxs("div", { className: "confidence-grid", children: [_jsxs("div", { className: "confidence-item", children: [_jsx("span", { children: "Overall:" }), _jsxs("span", { children: [Math.round(selectedUserProfile.confidenceMetrics.overall * 100), "%"] })] }), _jsxs("div", { className: "confidence-item", children: [_jsx("span", { children: "Temporal:" }), _jsxs("span", { children: [Math.round(selectedUserProfile.confidenceMetrics.temporal * 100), "%"] })] })] })] }), _jsxs("div", { className: "preference-dimensions", children: [_jsx("h4", { children: "Preference Dimensions" }), selectedUserProfile.preferenceVector.dimensions.map((dim, index) => (_jsxs("div", { className: "dimension-detail", children: [_jsxs("div", { className: "dimension-header", children: [_jsx("span", { className: "dimension-name", children: dim.dimension.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }), _jsxs("span", { className: "dimension-confidence", children: [Math.round(dim.confidence * 100), "%"] })] }), _jsx("div", { className: "dimension-bar", children: _jsx("div", { className: "dimension-fill", style: { width: `${dim.value * 100}%` } }) }), _jsxs("div", { className: "dimension-value", children: [Math.round(dim.value * 100), "%"] }), _jsxs("div", { className: "dimension-trend", children: ["Trend: ", dim.temporal.trend, dim.temporal.seasonality && ' • Seasonal patterns detected'] })] }, index)))] }), _jsxs("div", { className: "embedding-visualization", children: [_jsx("h4", { children: "Preference Embedding" }), _jsxs("div", { className: "embedding-preview", children: ["\uD83D\uDCCA 50-dimensional embedding visualization", _jsx("br", {}), "Top features: ", selectedUserProfile.preferenceVector.weights
                                                                .map((w, i) => ({ weight: w, index: i }))
                                                                .sort((a, b) => b.weight - a.weight)
                                                                .slice(0, 3)
                                                                .map(f => `Feature ${f.index}`)
                                                                .join(', ')] })] })] })] }))] })), selectedView === 'models' && (_jsx("div", { className: "models-view", children: _jsx("div", { className: "models-grid", children: models.map(model => (_jsxs("div", { className: "model-card", children: [_jsxs("div", { className: "model-header", children: [_jsx("h4", { children: model.type.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }), _jsx("span", { className: "model-version", children: model.version })] }), _jsxs("div", { className: "model-performance", children: [_jsx("h5", { children: "Performance Metrics" }), _jsxs("div", { className: "performance-grid", children: [_jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "Accuracy:" }), _jsxs("span", { children: [Math.round(model.performance.accuracy * 100), "%"] })] }), _jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "Precision:" }), _jsxs("span", { children: [Math.round(model.performance.precision * 100), "%"] })] }), _jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "Recall:" }), _jsxs("span", { children: [Math.round(model.performance.recall * 100), "%"] })] }), _jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "F1 Score:" }), _jsxs("span", { children: [Math.round(model.performance.f1Score * 100), "%"] })] }), _jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "NDCG:" }), _jsx("span", { children: model.performance.ndcg.toFixed(3) })] }), _jsxs("div", { className: "perf-item", children: [_jsx("span", { children: "AUC:" }), _jsx("span", { children: model.performance.auc.toFixed(3) })] })] })] }), _jsxs("div", { className: "model-architecture", children: [_jsx("h5", { children: "Architecture" }), _jsxs("div", { className: "arch-info", children: [_jsxs("div", { children: ["Layers: ", model.architecture.layers] }), _jsxs("div", { children: ["Parameters: ", (model.architecture.parameters / 1000000).toFixed(1), "M"] }), _jsxs("div", { children: ["Input Dim: ", model.architecture.inputDimensions] }), _jsxs("div", { children: ["Output Dim: ", model.architecture.outputDimensions] })] })] }), _jsxs("div", { className: "model-training", children: [_jsx("h5", { children: "Training Info" }), _jsxs("div", { className: "training-info", children: [_jsxs("div", { children: ["Dataset: ", (model.training.datasetSize / 1000).toFixed(0), "K samples"] }), _jsxs("div", { children: ["Training Time: ", model.training.trainingTime, "h"] }), _jsxs("div", { children: ["Epochs: ", model.training.epochs] }), _jsxs("div", { children: ["Status: ", model.training.convergence ? '✅ Converged' : '⚠️ In Progress'] }), _jsxs("div", { children: ["Last Trained: ", new Date(model.training.lastTrained).toLocaleDateString()] })] })] })] }, model.modelId))) }) })), selectedView === 'learning' && (_jsx("div", { className: "learning-view", children: _jsxs("div", { className: "learning-placeholder", children: [_jsx("h3", { children: "Learning Process Analytics" }), _jsx("p", { children: "Learning process monitoring will be implemented here, including:" }), _jsxs("ul", { children: [_jsx("li", { children: "Real-time learning event streaming" }), _jsx("li", { children: "Model convergence tracking" }), _jsx("li", { children: "Feature importance evolution" }), _jsx("li", { children: "Learning rate optimization" }), _jsx("li", { children: "Data drift detection" }), _jsx("li", { children: "Active learning recommendations" })] })] }) })), selectedView === 'insights' && (_jsx("div", { className: "insights-view", children: _jsxs("div", { className: "insights-placeholder", children: [_jsx("h3", { children: "Learning Insights" }), _jsx("p", { children: "Advanced learning insights will be displayed here, including:" }), _jsxs("ul", { children: [_jsx("li", { children: "User preference evolution patterns" }), _jsx("li", { children: "Model performance trends" }), _jsx("li", { children: "Feature effectiveness analysis" }), _jsx("li", { children: "Prediction accuracy improvements" }), _jsx("li", { children: "Personalization impact metrics" }), _jsx("li", { children: "Learning optimization recommendations" })] })] }) }))] })] }));
};
