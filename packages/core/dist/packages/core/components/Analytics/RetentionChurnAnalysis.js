...
// Main component
export const RetentionChurnAnalysis = ({ analyticsInfrastructure, retentionConfig, churnPredictionConfig, onChurnAlert, onRetentionInsight, onExport }) => {
    ...
    return (_jsxs("div", { className: "retention-churn-analysis", children: [_jsxs("div", { className: "analysis-header", children: [_jsxs("div", { className: "header-section", children: [_jsx("h2", { children: "Retention Analysis & Churn Prediction" }), _jsxs("div", { className: "key-metrics", children: [retentionStats && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-label", children: "Day 1 Retention" }), _jsxs("div", { className: "metric-value", children: [retentionStats.day1Retention, "%"] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-label", children: "Day 30 Retention" }), _jsxs("div", { className: "metric-value", children: [retentionStats.day30Retention, "%"] })] })] })), churnStats && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-label", children: "High Risk Users" }), _jsx("div", { className: "metric-value critical", children: churnStats.highRisk })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-label", children: "Avg Churn Risk" }), _jsxs("div", { className: "metric-value", children: [churnStats.averageChurnProbability, "%"] })] })] }))] })] }), _jsxs("div", { className: "header-controls", children: [_jsxs("div", { className: "view-selector", children: [_jsx("button", { className: selectedView === 'retention' ? 'active' : '', onClick: () => setSelectedView('retention'), children: "Retention Analysis" }), _jsx("button", { className: selectedView === 'churn' ? 'active' : '', onClick: () => setSelectedView('churn'), children: "Churn Prediction" }), _jsx("button", { className: selectedView === 'insights' ? 'active' : '', onClick: () => setSelectedView('insights'), children: "Insights" })] }), _jsx("button", { className: "analyze-btn", onClick: handleAnalyzeChurn, disabled: loading, children: loading ? '🔮 Analyzing...' : '🎯 Analyze Churn' }), _jsx("button", { className: "export-btn", onClick: handleExport, children: "\uD83D\uDCCA Export Analysis" })] })] }), _jsxs("div", { className: "analysis-content", children: [loading && (_jsxs("div", { className: "loading-overlay", children: [_jsx("div", { className: "loading-spinner", children: "\uD83D\uDD2E" }), _jsx("div", { className: "loading-text", children: "Analyzing retention and churn patterns..." })] })), selectedView === 'retention' && (_jsxs("div", { className: "retention-view", children: [_jsxs("div", { className: "cohorts-list", children: [_jsx("h3", { children: "Cohort Retention Analysis" }), _jsx("div", { className: "cohort-items", children: retentionData.map(cohort => (_jsxs("div", { className: `cohort-item ${selectedCohort === cohort.cohortId ? 'active' : ''}`, onClick: () => setSelectedCohort(cohort.cohortId), children: [_jsxs("div", { className: "cohort-header", children: [_jsx("div", { className: "cohort-name", children: cohort.cohortName }), _jsxs("div", { className: "cohort-size", children: [cohort.cohortSize, " users"] })] }), _jsxs("div", { className: "retention-summary", children: [_jsxs("div", { className: "retention-item", children: [_jsx("span", { children: "Day 1:" }), _jsxs("span", { children: [Math.round((cohort.retentionRates[0]?.retentionRate || 0) * 100), "%"] })] }), _jsxs("div", { className: "retention-item", children: [_jsx("span", { children: "Day 7:" }), _jsxs("span", { children: [Math.round((cohort.retentionRates[6]?.retentionRate || 0) * 100), "%"] })] }), _jsxs("div", { className: "retention-item", children: [_jsx("span", { children: "Day 30:" }), _jsxs("span", { children: [Math.round((cohort.retentionRates.find(r => r.period === 30)?.retentionRate || 0) * 100), "%"] })] })] })] }, cohort.cohortId))) })] }), selectedCohortData && (_jsxs("div", { className: "cohort-details", children: [_jsxs("h3", { children: ["Retention Curve: ", selectedCohortData.cohortName] }), _jsx("div", { className: "retention-chart", children: _jsxs("div", { className: "chart-placeholder", children: ["\uD83D\uDCC8 Retention curve chart will be rendered here", _jsx("br", {}), "Cohort size: ", selectedCohortData.cohortSize, " users", _jsx("br", {}), "Acquisition: ", new Date(selectedCohortData.acquisitionDate).toLocaleDateString()] }) }), _jsxs("div", { className: "retention-table", children: [_jsx("h4", { children: "Retention Breakdown" }), _jsxs("div", { className: "table-header", children: [_jsx("div", { children: "Period" }), _jsx("div", { children: "Retained Users" }), _jsx("div", { children: "Retention Rate" }), _jsx("div", { children: "vs Benchmark" })] }), selectedCohortData.retentionRates.slice(0, 8).map(rate => (_jsxs("div", { className: "table-row", children: [_jsxs("div", { children: ["Day ", rate.period] }), _jsx("div", { children: rate.retainedUsers }), _jsxs("div", { children: [Math.round(rate.retentionRate * 100), "%"] }), _jsxs("div", { className: rate.retentionRate > rate.benchmark ? 'positive' : 'negative', children: [rate.retentionRate > rate.benchmark ? '+' : '', Math.round((rate.retentionRate - rate.benchmark) * 100), "%"] })] }, rate.period)))] })] }))] })), selectedView === 'churn' && (_jsxs("div", { className: "churn-view", children: [_jsxs("div", { className: "risk-distribution", children: [_jsx("h3", { children: "Churn Risk Distribution" }), _jsx("div", { className: "distribution-chart", children: churnStats && Object.entries(churnStats.riskDistribution).map(([level, count]) => (_jsxs("div", { className: `risk-bar ${level}`, children: [_jsx("div", { className: "risk-label", children: level.toUpperCase() }), _jsx("div", { className: "risk-visual", children: _jsx("div", { className: "risk-fill", style: { width: `${(count / churnStats.totalUsers) * 100}%` } }) }), _jsxs("div", { className: "risk-count", children: [count, " (", Math.round((count / churnStats.totalUsers) * 100), "%)"] })] }, level))) })] }), _jsxs("div", { className: "high-risk-users", children: [_jsx("h3", { children: "High Risk Users" }), _jsx("div", { className: "risk-users-list", children: churnPredictions.filter(p => p.riskLevel === 'high' || p.riskLevel === 'critical').slice(0, 10).map(user => (_jsxs("div", { className: `risk-user ${user.riskLevel}`, children: [_jsxs("div", { className: "user-header", children: [_jsx("div", { className: "user-id", children: user.userId.slice(-8) }), _jsx("div", { className: "risk-level", children: user.riskLevel }), _jsxs("div", { className: "churn-probability", children: [Math.round(user.churnProbability * 100), "%"] })] }), _jsx("div", { className: "risk-factors", children: user.riskFactors.slice(0, 2).map((factor, index) => (_jsxs("div", { className: "risk-factor", children: [_jsx("span", { className: "factor-name", children: factor.factor.replace(/_/g, ' ') }), _jsxs("span", { className: "factor-impact", children: [Math.round(factor.impact * 100), "% impact"] })] }, index))) }), _jsx("div", { className: "recommended-actions", children: user.recommendedActions.slice(0, 1).map((action, index) => (_jsxs("div", { className: `action ${action.priority}`, children: [action.action.replace(/_/g, ' '), " (Impact: ", Math.round(action.expectedImpact * 100), "%)"] }, index))) })] }, user.userId))) })] })] })), selectedView === 'insights' && (_jsx("div", { className: "insights-view", children: _jsxs("div", { className: "insights-placeholder", children: [_jsx("h3", { children: "Retention & Churn Insights" }), _jsx("p", { children: "Advanced insights will be displayed here, including:" }), _jsxs("ul", { children: [_jsx("li", { children: "Retention trend analysis and forecasting" }), _jsx("li", { children: "Churn risk factor correlation analysis" }), _jsx("li", { children: "Intervention effectiveness tracking" }), _jsx("li", { children: "Cohort comparison and benchmarking" }), _jsx("li", { children: "Predictive model performance metrics" }), _jsx("li", { children: "Actionable recommendations for retention improvement" })] })] }) }))] })] }));
};
