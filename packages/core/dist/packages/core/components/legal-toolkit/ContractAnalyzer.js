...
export const ContractAnalyzer = ({ document, onClauseIdentified, onAnalysisComplete, analysisType = 'basic', className = '' }) => {
    ...
    const generateRecommendations = (clauses, riskAssessment, complianceChecks) => {
    ...
    if (isAnalyzing) {
        return (_jsxs("div", { className: `contract-analyzer analyzing ${className}`, children: [_jsx("style", { children: `
            .contract-analyzer {
              background: white;
              border-radius: 8px;
              padding: 2rem;
    ...
    if (!analysis) {
        return (_jsx("div", { className: `contract-analyzer ${className}`, children: _jsx("div", { style: { textAlign: 'center', padding: '2rem' }, children: _jsx("p", { children: "No analysis available. Please upload a contract document." }) }) }));
    }
    return (_jsxs("div", { className: `contract-analyzer ${className}`, children: [_jsx("style", { children: `
          .contract-analyzer {
            background: white;
            border-radius: 8px;
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
        ...
        ` }), _jsxs("div", { className: "analyzer-header", children: [_jsx("h2", { className: "analyzer-title", children: "Contract Analysis Results" }), _jsxs("div", { className: "analyzer-meta", children: [_jsxs("span", { children: ["Document: ", document.title] }), _jsxs("span", { children: ["Analysis Type: ", analysisType] }), _jsxs("span", { children: ["Processing Time: ", analysis.processingTime, "ms"] }), _jsxs("span", { children: ["Confidence: ", analysis.confidence, "%"] })] })] }), _jsx("div", { className: "view-tabs", children: ['overview', 'clauses', 'risks', 'compliance'].map(tab => (_jsxs("button", { className: `view-tab ${viewMode === tab ? 'active' : ''}`, onClick: () => setViewMode(tab), children: [tab.charAt(0).toUpperCase() + tab.slice(1), tab === 'clauses' && ` (${analysis.clauses.length})`, tab === 'compliance' && analysis.complianceChecks.length > 0 && ` (${analysis.complianceChecks.length})`] }, tab))) }), _jsxs("div", { className: "analyzer-content", children: [viewMode === 'overview' && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "overview-grid", children: [_jsxs("div", { className: "overview-card", children: [_jsx("div", { className: "card-title", children: "Risk Assessment" }), _jsxs("div", { className: "risk-indicator", children: [_jsx("div", { className: "risk-dot", style: { backgroundColor: getRiskColor(analysis.riskAssessment.overallRisk) } }), analysis.riskAssessment.overallRisk.toUpperCase(), " RISK"] }), _jsxs("div", { style: { fontSize: '0.9rem', color: '#718096' }, children: ["Risk Score: ", analysis.riskAssessment.score, "/100"] })] }), _jsxs("div", { className: "overview-card", children: [_jsx("div", { className: "card-title", children: "Analysis Confidence" }), _jsxs("div", { className: "confidence-score", children: [analysis.confidence, "%"] }), _jsx("div", { style: { fontSize: '0.9rem', color: '#718096' }, children: "Based on document completeness and clause identification" })] })] }), _jsxs("div", { className: "overview-card", children: [_jsx("div", { className: "card-title", children: "Key Recommendations" }), _jsx("ul", { className: "recommendations-list", children: analysis.recommendations.slice(0, 5).map((rec, index) => (_jsx("li", { className: "recommendation-item", children: rec }, index))) })] })] })), viewMode === 'clauses' && (_jsx("div", { className: "clause-list", children: analysis.clauses.map(clause => (_jsxs("div", { className: `clause-item ${selectedClause?.id === clause.id ? 'selected' : ''}`, onClick: () => setSelectedClause(clause), children: [_jsxs("div", { className: "clause-header", children: [_jsx("div", { className: "clause-title", children: clause.title }), _jsx("div", { className: "clause-risk", style: { backgroundColor: getRiskColor(clause.riskLevel) }, children: clause.riskLevel.toUpperCase() })] }), _jsx("div", { className: "clause-content", children: clause.content }), clause.suggestions && (_jsxs("div", { className: "clause-suggestions", children: ["Suggestions: ", clause.suggestions.join(', ')] }))] }, clause.id))) })), viewMode === 'compliance' && (_jsx("div", { className: "compliance-list", children: analysis.complianceChecks.map(check => (_jsxs("div", { className: "compliance-item", children: [_jsxs("div", { className: "compliance-header", children: [_jsx("div", { className: "compliance-regulation", children: check.regulation }), _jsx("div", { className: "compliance-status", style: { backgroundColor: getComplianceColor(check.status) }, children: check.status.replace('_', ' ').toUpperCase() })] }), _jsx("div", { style: { fontSize: '0.9rem', color: '#4a5568', marginBottom: '0.5rem' }, children: check.description }), check.remediation && (_jsxs("div", { style: { fontSize: '0.8rem', color: '#718096' }, children: ["Remediation: ", check.remediation.join(', ')] }))] }, check.id))) }))] })] }));
};
