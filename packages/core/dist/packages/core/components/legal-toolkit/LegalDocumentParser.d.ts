...
import { LegalDocumentParserProps } from './types';
export declare const LegalDocumentParser: React.FC<LegalDocumentParserProps>;
export default LegalDocumentParser;
//# sourceMappingURL=LegalDocumentParser.d.ts.map