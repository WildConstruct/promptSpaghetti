...
export const SharePreview = ({ shareConfig, shareLink, selectedPlatform = 'opengraph' }) => {
    ...
    const renderOpenGraphPreview = () => (_jsxs("div", { style: {
        ...
        }, children: [shareConfig.thumbnailUrl && (_jsx("div", { style: {
                    width: '100%',
                    height: '200px',
    ...
    const renderTwitterPreview = () => (_jsxs("div", { style: {
    ...
    const renderLinkedInPreview = () => (_jsxs("div", { style: {
    ...
    const renderDiscordPreview = () => (_jsx("div", { style: {
            ...
            fontFamily: 'Whitney, "Helvetica Neue", Helvetica, Arial, sans-serif'
                ...
                paddingLeft: '12px'
                        ...
                        marginBottom: '12px',
                        lineHeight: '1.3'
                    }, children: shareLink.socialTags.openGraph.description }), shareConfig.thumbnailUrl && (_jsx("div", { style: {
                        width: '100%',
                        maxWidth: '400px',
                        height: '200px',
                        backgroundImage: `url(${shareConfig.thumbnailUrl})`,
    ...
    const renderEmbedPreview = () => (_jsxs("div", { style: {
    ...
    return (_jsxs("div", { style: {
            ...
            border: '1px solid #e5e7eb'
                    ...
                    fontWeight: '600',
                    color: '#111827'
                }, children: "Share Preview" }), _jsx("div", { style: {
                    display: 'flex',
                    gap: '8px',
                    marginBottom: '24px',
                    flexWrap: 'wrap'
                }, children: previewOptions.map(option => (_jsxs("button", { onClick: () => setActivePreview(option.id), style: {
                        padding: '8px 12px',
                        ...
                        alignItems: 'center',
                        gap: '6px'
                    }, children: [_jsx("span", { children: option.icon }), option.label] }, option.id))) }), _jsx("div", { style: {
                    display: 'flex',
                    justifyContent: 'center',
                    padding: '20px',
