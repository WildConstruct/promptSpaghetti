...
export const CreativeVarianceAnalyzer = ({ results, varianceAnalysis, className = '' }) => {
    ...
    const advancedMetrics = useMemo(() => {
        ...
        const allWords = validResults.flatMap(r => r.output?.toLowerCase().split(/\s+/).filter(w => w.length > 2) || []);
        ...
        const conceptWords = allWords.filter(word => word.length > 4 && !['that', 'with', 'have', 'this', 'will', 'your', 'from', 'they', 'know', 'want', 'been', 'good', 'much', 'some', 'time', 'very', 'when', 'come', 'here', 'just', 'like', 'long', 'make', 'many', 'over', 'such', 'take', 'than', 'them', 'well'].includes(word));
        ...
        const industryReadiness = Math.min(100, (vocabularyRichness * 0.3) +
            (readingComplexity * 0.2) +
            (ideaDensity * 0.3) +
            (semanticCoherence * 0.2));
        const clientPresentability = Math.min(100, (narrativeConsistency * 0.4) +
            ((100 - repetitionIndex) * 0.3) +
            (industryReadiness * 0.3));
        const revisionPotential = Math.min(100, (varianceAnalysis?.uniquenessScore || 0) * 0.4 +
            (conceptualLeaps * 0.3) +
            (ideaDensity * 0.3));
        return {
    ...
    if (!varianceAnalysis || results.length < 2) {
        return (_jsxs("div", { className: `creative-variance-analyzer ${className}`, style: {
                background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)',
                borderRadius: 12,
                border: '1px solid #e2e8f0',
                padding: 24,
                textAlign: 'center'
            }, children: [_jsx("div", { style: { fontSize: 24, marginBottom: 12 }, children: "\uD83D\uDCCA" }), _jsx("div", { style: { fontSize: 16, fontWeight: 600, color: '#1e293b', marginBottom: 8 }, children: "Variance Analysis Unavailable" }), _jsx("div", { style: { fontSize: 14, color: '#64748b' }, children: "Generate at least 2 results to enable creative variance analysis" })] }));
    }
    const MetricCard = ({ title, value, suffix = '', description, color, onClick }) => (_jsxs("div", { style: {
            background: 'white',
            borderRadius: 8,
            ...
            ':hover': onClick ? {
                ...
                boxShadow: `0 4px 12px ${color}20`
                    ...
                    marginBottom: 8
                            ...
                            fontWeight: 700,
                            color: color
                        }, children: [value, suffix] })] }), _jsx("div", { style: {
                    fontSize: 12,
                    color: '#6b7280',
                    lineHeight: 1.4
    ...
    return (_jsxs("div", { className: `creative-variance-analyzer ${className}`, style: {
            ...
            overflow: 'hidden'
                    ...
                    background: 'rgba(255, 255, 255, 0.8)'
                            ...
                            alignItems: 'center',
                            gap: 8
                        }, children: "\uD83D\uDCCA Creative Variance Analysis" }), _jsxs("div", { style: {
                            fontSize: 14,
                            color: '#64748b',
                            marginTop: 4
                        }, children: ["Professional insights for ", results.length, " generated results"] })] }), _jsx("div", { style: {
                    display: 'flex',
                    borderBottom: '1px solid #e2e8f0',
                    ...
                    { id: 'professional', label: '💼 Professional Assessment', icon: '💼' }
                        ...
                        cursor: 'pointer',
                        transition: 'all 0.2s'
                    }, children: tab.label }, tab.id))) }), _jsxs("div", { style: { padding: 20 }, children: [activeTab === 'overview' && (_jsxs("div", { children: [_jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("h4", { style: {
                                            margin: '0 0 12px 0',
                                            fontSize: 14,
                                            fontWeight: 600,
                                            color: '#374151'
                                        }, children: "\uD83D\uDD0D Key Creative Insights" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: creativeInsights.slice(0, 3).map((insight, index) => (_jsxs("div", { style: {
                                                padding: 12,
                                                background: insight.type === 'positive' ? '#dcfce7' :
                                                    insight.type === 'warning' ? '#fef3c7' :
                                                        insight.type === 'suggestion' ? '#dbeafe' : '#f3f4f6',
                                                borderRadius: 6,
                                                borderLeft: `4px solid ${insight.type === 'positive' ? '#10b981' :
                                                    insight.type === 'warning' ? '#f59e0b' :
                                                        ...
                                                        color: '#4b5563',
                                                        lineHeight: 1.4
                                                    }, children: insight.description })] }, index))) })] }), _jsxs("div", { style: {
                                    display: 'grid',
                                    gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))',
                                    gap: 12
                                }, children: [_jsx(MetricCard, { title: "Uniqueness", value: varianceAnalysis.uniquenessScore, suffix: "%", description: "Content variation across results", color: "#10b981" }), _jsx(MetricCard, { title: "Creativity", value: varianceAnalysis.creativityScore, suffix: "%", description: "Creative potential and originality", color: "#8b5cf6" }), _jsx(MetricCard, { title: "Industry Ready", value: advancedMetrics.industryReadiness, suffix: "%", description: "Professional quality assessment", color: "#3b82f6" }), _jsx(MetricCard, { title: "Client Ready", value: advancedMetrics.clientPresentability, suffix: "%", description: "Presentation readiness", color: "#f59e0b" })] })] })), activeTab === 'content' && (_jsxs("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))',
                            gap: 16
                        }, children: [_jsx(MetricCard, { title: "Word Count Variance", value: Math.round(varianceAnalysis.wordCountVariance), description: "Variation in content length", color: "#6366f1" }), _jsx(MetricCard, { title: "Length Distribution", value: Math.round(varianceAnalysis.lengthDistribution.avg), suffix: " chars", description: `Range: ${varianceAnalysis.lengthDistribution.min}-${varianceAnalysis.lengthDistribution.max}`, color: "#10b981" }), _jsx(MetricCard, { title: "Reading Complexity", value: advancedMetrics.readingComplexity, suffix: "%", description: "Text complexity and readability", color: "#f59e0b" }), _jsx(MetricCard, { title: "Vocabulary Richness", value: advancedMetrics.vocabularyRichness, suffix: "%", description: "Unique words vs total words", color: "#8b5cf6" }), _jsx(MetricCard, { title: "Repetition Index", value: advancedMetrics.repetitionIndex, suffix: "%", description: "Content repetition across results", color: "#ef4444" }), _jsx(MetricCard, { title: "Diversity Index", value: Math.round(varianceAnalysis.diversityIndex * 100), suffix: "%", description: "Content type diversity", color: "#06b6d4" })] })), activeTab === 'creative' && (_jsxs("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))',
                            gap: 16
                        }, children: [_jsx(MetricCard, { title: "Idea Density", value: advancedMetrics.ideaDensity, suffix: "%", description: "Concept richness per 100 words", color: "#8b5cf6" }), _jsx(MetricCard, { title: "Conceptual Leaps", value: advancedMetrics.conceptualLeaps, suffix: "%", description: "Thematic variety and innovation", color: "#06b6d4" }), _jsx(MetricCard, { title: "Narrative Consistency", value: advancedMetrics.narrativeConsistency, suffix: "%", description: "Story coherence across results", color: "#10b981" }), _jsx(MetricCard, { title: "Tone Variation", value: varianceAnalysis.toneVariation, suffix: "%", description: "Emotional range across content", color: "#f59e0b" }), _jsx(MetricCard, { title: "Semantic Coherence", value: advancedMetrics.semanticCoherence, suffix: "%", description: "Meaning consistency", color: "#3b82f6" }), _jsx(MetricCard, { title: "Revision Potential", value: advancedMetrics.revisionPotential, suffix: "%", description: "Foundation for further development", color: "#ef4444" })] })), activeTab === 'professional' && (_jsxs("div", { children: [_jsxs("div", { style: {
                                    display: 'grid',
                                    ...
                                    marginBottom: 24
                                            ...
                                            fontWeight: 600,
                                            color: '#374151'
                                        }, children: "\uD83D\uDCBC Professional Recommendations" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: creativeInsights.filter(insight => ['industryReadiness', 'clientPresentability', 'professionalSuitability'].includes(insight.metric)).map((insight, index) => (_jsxs("div", { style: {
                                                padding: 12,
                                                background: 'white',
                                                borderRadius: 6,
