...
import { projectManager } from '../../projectManager';
{
    ...
    return;
    _jsxs("div", { className: className, style: style, children: [_jsxs("div", { style: {
                    display: 'flex',
                    marginBottom: '16px',
                    borderRadius: '6px',
                    overflow: 'hidden',
                    border: '1px solid #e5e5e5',
                            ...
                            fontSize: '14px',
                            fontWeight: '500',
                        }, children: "Favorites" })] }), _jsxs("div", { style: {
                    display: 'flex',
                    flexDirection: 'column',
                    gap: '8px',
                }, children: [filesToDisplay.length === 0 ? ()
                        < div : , " style=", {
                        textAlign: 'center',
                        padding: '32px 16px',
                        color: '#999',
                        fontSize: '14px',
                    }, ">", currentView === 'recent' ? 'No recent files' : 'No favorite files'] }), ") : () filesToDisplay.map((file) => ()", _jsx("div", { style: {
                    border: '1px solid #e5e5e5',
                    borderRadius: '8px',
                    overflow: 'hidden',
