...
export declare const ADMIN_DOMAIN_EVENTS: {
    readonly DASHBOARD_LOADED: "admin:dashboard:loaded";
    readonly LAYOUT_CHANGED: "admin:layout:changed";
    readonly WIDGET_ADDED: "admin:widget:added";
    readonly WIDGET_REMOVED: "admin:widget:removed";
    readonly WIDGET_UPDATED: "admin:widget:updated";
    readonly USER_CREATED: "admin:user:created";
    readonly USER_UPDATED: "admin:user:updated";
    readonly USER_DELETED: "admin:user:deleted";
    readonly USER_SUSPENDED: "admin:user:suspended";
    readonly PERMISSION_CHANGED: "admin:permission:changed";
    readonly SECURITY_ALERT: "admin:security:alert";
    readonly SECURITY_SCAN_COMPLETED: "admin:security:scan:completed";
    readonly API_KEY_CREATED: "admin:api:key:created";
    readonly API_KEY_REVOKED: "admin:api:key:revoked";
    readonly SYSTEM_HEALTH_CHANGED: "admin:system:health:changed";
    readonly CONFIG_UPDATED: "admin:config:updated";
};
export type AdminDomainEventType = typeof ADMIN_DOMAIN_EVENTS[keyof typeof ADMIN_DOMAIN_EVENTS];
//# sourceMappingURL=AdminDashboardDomain.d.ts.map