...
export const useGraphOperations = () => {
    const actions = useGraphEditorStore((state) => ({}), addNode, state.addNode, removeNode, state.removeNode, updateNode, state.updateNode, moveNode, state.moveNode, duplicateNode, state.duplicateNode, addEdge, state.addEdge, removeEdge, state.removeEdge, getNodeById, state.getNodeById);
};
// Node operations
