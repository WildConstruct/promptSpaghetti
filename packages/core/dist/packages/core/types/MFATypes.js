...
})(MFAMethodType || (MFAMethodType = {}));
{
    ...
    z.string().uuid(),
        methodType;
    z.literal(MFAMethodType.TOTP),
        status;
    z.nativeEnum(MFAMethodStatus),
        isPrimary;
    z.boolean(),
        displayName;
    ...
    z.enum(['SHA1', 'SHA256']),
        digits;
    z.union([z.literal(6), z.literal(8)]),
        period;
    z.literal(30),
...
z.string().uuid(),
    methodType;
z.nativeEnum(MFAMethodType),
    success;
z.boolean(),
    result;
z.nativeEnum(MFAVerificationResult),
    ipAddress;
z.string().ip(),
    userAgent;
z.string().min(1),
