...
RestorationTypeSchema,
    restorationStrategy;
RestorationStrategySchema,
    status;
RestorationStatusSchema,
    progressPercentage;
...
z.record(z.unknown()).optional(),
    resolutionStrategy;
ResolutionStrategySchema.optional(),
    resolvedValue;
z.record(z.unknown()).optional(),
    resolvedBy;
z.string().uuid().optional(),
...
z.array(z.string()).optional(),
    conflictResolution;
z.record(ResolutionStrategySchema).optional(),
...
z.number().int(),
    mostCommonConflicts;
z.array(z.object({}), conflictType, ConflictTypeSchema, count, z.number().int());
...
z.string().uuid().optional(),
    status;
RestorationStatusSchema.optional(),
    restorationType;
RestorationTypeSchema.optional(),
    dateFrom;
z.date().optional(),
    dateTo;
z.date().optional(),
