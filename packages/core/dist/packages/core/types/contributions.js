...
z.string().optional(),
    revisionRequests;
z.array(z.object({}), id, z.string(), moderatorId, z.string(), moderatorName, z.string(), reason, z.string(), details, z.string(), requestedAt, z.date(), resolvedAt, z.date().optional());
([]),
    // Metrics
    views;
...
z.string().default('1.0.0'),
    versionHistory;
z.array(z.object({}), version, z.string(), changes, z.string(), changedAt, z.date(), changedBy, z.string());
([]),
    createdAt;
z.date(),
    updatedAt;
...
z.array(z.string()).default([]),
    externalLinks;
z.array(z.object({}), title, z.string(), url, z.string().url(), description, z.string().optional());
([]);
;
// =============================================================================
...
z.array(z.object({}), name, z.string(), type, z.string(), url, z.string().url(), description, z.string().optional());
([]);
;
// =============================================================================
...
([]),
    mediaGallery;
z.array(z.object({}), type, z.enum(['before_after', 'screenshot', 'video', 'diagram']), url, z.string().url(), caption, z.string(), order, z.number().int());
([]);
;
// =============================================================================
...
([]),
    // Related Patterns
    relatedPatterns;
z.array(z.object({}), patternId, z.string(), relationship, z.enum(['uses', 'used_by', 'similar_to', 'alternative_to']), description, z.string());
([]);
;
// =============================================================================
...
z.number().min(0).max(100).default(0),
    // Recognition
    badges;
z.array(z.object({}), id, z.string(), name, z.string(), description, z.string(), iconUrl, z.string().url(), earnedAt, z.date());
([]),
    achievements;
z.array(z.object({}), id, z.string(), name, z.string(), description, z.string(), progress, z.number().min(0).max(100), completedAt, z.date().optional());
([]),
    // Preferences
