...
import { AnalyticsEvent, AnalyticsEventInput, AnalyticsQueryInput, TemplateMetrics, CreatorDashboard, CustomReport, CustomReportInput, AnalyticsInsight, TimeRange } from './analytics.types';
export declare class AnalyticsService {
    ...
    getTemplateMetrics(templateId: string, timeRange: TimeRange, startDate?: Date, endDate?: Date): Promise<TemplateMetrics>;
    getCreatorDashboard(creatorId: string, timeRange: TimeRange, startDate?: Date, endDate?: Date): Promise<CreatorDashboard>;
