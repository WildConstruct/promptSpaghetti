...
export const SPECIAL_CATEGORIES = { FAVORITES: 'favorites',
 ...
 */
export const NODE_CATEGORIES: Record<string, NodeCategory> = { // Content creation nodes
  content: {
  id: 'content'
  ...
  // Special categories
  [SPECIAL_CATEGORIES.FAVORITES]: { id: SPECIAL_CATEGORIES.FAVORITES
  name: 'Favorites'
  ...
  [SPECIAL_CATEGORIES.SEARCH_RESULTS]: { id: SPECIAL_CATEGORIES.SEARCH_RESULTS
  name: 'Search Results'
  ...
  [SPECIAL_CATEGORIES.ALL]: { id: SPECIAL_CATEGORIES.ALL
  name: 'All Nodes'
 ...
 */
export const NODE_CATEGORY_MAPPING: Record<string, string> = { // Content Building Blocks
  'Subject': ['content']
  'Connector': ['content']
  'Attribute': ['content']
  'Action': ['content']
 ...
 */
export function getNodeCategories(nodeId: string): string { return NODE_CATEGORY_MAPPING[nodeId] || ['content'];
  /**
