...
export class ExtensionDocumentationGenerator {
     ...
     */
    generateMarkdownExtensionPoint(ep, options) {
     ...
     */
    generateHTML(extensionPoints, options) {
...
<body>
     ...
     */
    generateHTMLExtensionPoint(ep, options) {
        let html = `
     ...
     */
    generateJSON(extensionPoints, options) {
        const doc = {
            version: '1.0.0',
            generated: new Date().toISOString(),
            count: extensionPoints.length,
