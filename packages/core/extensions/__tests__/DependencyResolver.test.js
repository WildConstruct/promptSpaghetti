...
describe('Epic 24.2 - Dependency Resolver Unit Tests', () => {
    let dependencyResolver; // Mock implementation
    let mockPlugins;
    let mockAvailablePlugins;
    beforeEach(() => {
        jest.clearAllMocks();
    ...
    describe('1. Dependency Graph Resolution', () => {
        it('should resolve linear dependency chain correctly', async () => {
            ...
            dependencyResolver.resolveDependencies.mockImplementationOnce(async (plugins) => {
        ...
        it('should build complete dependency graph with all relationships', () => {
            ...
            dependencyResolver.buildDependencyGraph.mockReturnValue(expectedGraph);
        ...
        it('should handle missing dependencies gracefully', async () => {
            ...
            dependencyResolver.resolveDependencies.mockRejectedValueOnce(new Error('Dependency not found: nonexistent-plugin'));
    ...
    describe('2. Version Constraint Validation', () => {
        it('should validate semantic version constraints correctly', () => {
            ...
            dependencyResolver.validateVersionConstraints.mockImplementation((plugin, available) => {
        ...
        it('should reject incompatible version constraints', () => {
            ...
            dependencyResolver.validateVersionConstraints.mockReturnValue(false);
        ...
        it('should handle peer dependencies validation', () => {
            ...
            dependencyResolver.checkCompatibility.mockImplementation((plugin, available) => {
                if (!plugin.peerDependencies)
                    return true;
                const availableMap = new Map(available.map(p => [p.id, p]));
                return Object.keys(plugin.peerDependencies).every(peerId => availableMap.has(peerId));
            });
            const result = dependencyResolver.checkCompatibility(pluginWithPeers, ecosystem);
            expect(result).toBe(true);
        });
        it('should validate engine requirements', () => {
            const pluginWithEngines = {
            ...
            dependencyResolver.checkCompatibility.mockImplementation((plugin) => {
                if (!plugin.engines)
                    return true;
    ...
    describe('3. Circular Dependency Detection', () => {
        it('should detect simple circular dependencies', () => {
            ...
            dependencyResolver.detectCircularDependencies.mockReturnValue(['plugin-a', 'plugin-b', 'plugin-a']);
    ...
    describe('4. Dependency Conflict Resolution', () => {
        it('should resolve version conflicts by choosing highest compatible version', () => {
            ...
            dependencyResolver.resolveConflicts.mockReturnValue(expectedResolution);
    ...
    describe('5. Installation Order Generation', () => {
        it('should generate correct installation order for complex dependency tree', () => {
            ...
            dependencyResolver.getInstallationOrder.mockReturnValue(expectedOrder);
        ...
        it('should handle optional dependencies in installation order', () => {
            ...
            dependencyResolver.getInstallationOrder.mockImplementation((plugins) => {
    ...
    describe('6. Performance and Edge Cases', () => {
        it('should handle large dependency graphs efficiently', async () => {
            ...
            dependencyResolver.resolveDependencies.mockImplementation(async (plugins) => {
        ...
        it('should handle empty dependency lists', async () => {
            dependencyResolver.resolveDependencies.mockResolvedValue([]);
        ...
        it('should handle plugins with no dependencies', async () => {
            ...
            dependencyResolver.resolveDependencies.mockResolvedValue(independentPlugins);
        ...
        it('should validate malformed dependency specifications', () => {
            ...
            dependencyResolver.validateVersionConstraints.mockImplementation((plugin) => {
                if (!plugin.dependencies)
                    return true;
