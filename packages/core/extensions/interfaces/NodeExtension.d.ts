...
export interface NodeUIConfiguration { icon?: string;
    color?: string;
...
export interface NodeEditorConfiguration { component?: React.ComponentType<NodeEditorProps>;
...
export interface NodePaletteConfiguration { group?: string;
    order?: number;
    visible?: boolean;
...
export interface NodePreviewConfiguration { component?: React.ComponentType<NodePreviewProps>;
...
export interface NodeRuntimeConfiguration { timeout?: number;
    retries?: number;
...
export interface NodeValidation { configValidation?: (config: any) => ExtensionValidationResult;
...
export interface NodeRegistry { register(definition: NodeDefinition): void;
...
export interface NodeFactory { create(nodeType: string, nodeId: string, config: any): RuntimeNode<any>;
...
export interface NodeExecutionContextExtensions { nodeExtensions: Map<string, any>;
    performanceTracking: {
        startTime: number;
        endTime?: number;
    ...
    cachingContext: { enabled: boolean;
        cacheKey?: string;
        cacheHit?: boolean;
        cacheSize?: number };
...
export interface NodeExecutionMonitor { onExecutionStart(node: RuntimeNode<any>, context: ExtendedExecutionContext): void;
