...
export interface ExtensionUIContext { // Component registration
...
export interface ExtensionAPIContext { // HTTP client
...
export enum ExtensionLifecycleState { UNINITIALIZED = 'uninitialized'
...
export enum ExtensionErrorType { INITIALIZATION_ERROR = 'initialization_error'
...
// Extension Error
export class ExtensionError extends Error { constructor(
  public readonly type: ExtensionErrorType
  public readonly extensionId: string
  message: string }
  public readonly cause?: Error) { super(message);
...
export const ExtensionManifestSchema = z.object({ id: z.string().regex(/^[a-zA-Z0-9-_.]+$/)
  name: z.string().min(1)
