...
export const validateAnalyzeSentimentRequest = (data: unknown): AnalyzeSentimentRequest => {
  return AnalyzeSentimentRequestSchema.parse(data);
};

export const validateSentimentAnalysis = (data: unknown): SentimentAnalysis => {
  return SentimentAnalysisSchema.parse(data);
};

export const validateSentimentAnalytics = (data: unknown): SentimentAnalytics => {
