...
export declare enum PromotionStrategy {
...
export declare enum ContentSelectionMethod {
...
export declare enum UserValueTier {
    LOW_VALUE = "low_value",
    MEDIUM_VALUE = "medium_value",
    HIGH_VALUE = "high_value",
    VIP_VALUE = "vip_value"

export declare enum UserEngagementLevel {
    PASSIVE = "passive",
    CASUAL = "casual",
    ENGAGED = "engaged",
...
export declare enum SessionStage {
    ENTRY = "entry",
