...
export declare export interface UTDGNode { id: string;
...
export interface ConstraintSuggestion { constraint_id: string;
    node_ids: string[];
    message: string;
...
export interface MeteorData { weather_patterns: string[];
    seasonal_conditions: string[];
    time_of_day_preferences: string[] }
}
}
export interface DataQualityMetrics { completeness: number;
    consistency: number;
