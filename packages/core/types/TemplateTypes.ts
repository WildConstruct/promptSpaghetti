...
export interface TemplateMetadata { created: string;
  lastModified: string;
  usageCount: number;
  tags: string;
...
export interface TemplateSharing { isPublic: boolean;
...
export interface TemplateOperations { // CRUD operations
...
export interface TemplateBrowserState { isOpen: boolean;
  viewMode: 'grid' | 'list';
