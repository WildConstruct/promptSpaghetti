...
export const CommentEngagementSchema = z.object({ )
  ...
  engagementType: z.enum(['like', 'dislike', 'reply', 'share', 'helpful', 'report']),
  timestamp: z.date() }
...
export const TrendingCommentSchema = z.object({ )
  ...
  moderationStatus: z.enum(['approved', 'pending', 'flagged', 'removed']).default('approved')
...
export const validateGetTrendingCommentsRequest = (data: unknown): GetTrendingCommentsRequest => { return GetTrendingCommentsRequestSchema.parse(data) };

export const validateTrendingComment = (data: unknown): TrendingComment => { return TrendingCommentSchema.parse(data) };

export const validateCommentScore = (data: unknown): CommentScore => { return CommentScoreSchema.parse(data) };
...
export { CommentEngagementSchema,
  CommentScoreSchema,
  TrendingCommentSchema,
  TrendingAlgorithmConfigSchema,
  TrendingResultsSchema,
  CommentAnalyticsSchema,
  GetTrendingCommentsRequestSchema }
