...
export const validateGetTrendingCommentsRequest = (data: unknown): GetTrendingCommentsRequest => {
  return GetTrendingCommentsRequestSchema.parse(data);
};

export const validateTrendingComment = (data: unknown): TrendingComment => {
  return TrendingCommentSchema.parse(data);
};

export const validateCommentScore = (data: unknown): CommentScore => {
