...
export interface PlacementDimensions { width?: number;
    height?: number;
    aspectRatio?: string;
    maxWidth?: number;
    maxHeight?: number;
...
export interface SchedulePattern { frequency?: 'daily' | 'weekly' | 'monthly' | 'yearly';
    interval?: number;
...
export interface RecurrenceRules { count?: number;
    until?: Date;
    byWeekDay?: number[];
    byMonthDay?: number[];
    byMonth?: number[];
...
export interface CampaignBudget { totalBudget?: number;
    dailyBudget?: number;
    currency: string;
...
export interface PlacementSlotMetrics { slotId: string;
...
export interface BulkPlacementOperation { operationId: string;
