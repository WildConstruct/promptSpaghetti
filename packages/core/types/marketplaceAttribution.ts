...
export const validateCreateTemplateAttributionRequest = (request: unknown): CreateTemplateAttributionRequest => {
  return CreateTemplateAttributionRequestSchema.parse(request);
};

export const validateCreateAttributionClaimRequest = (request: unknown): CreateAttributionClaimRequest => {
  return CreateAttributionClaimRequestSchema.parse(request);
};

export const validateUpdateRevenueAttributionRequest = (request: unknown): UpdateRevenueAttributionRequest => {
  return UpdateRevenueAttributionRequestSchema.parse(request);
};

export const validateMarketplaceAttributionFilter = (filter: unknown): MarketplaceAttributionFilter => {
