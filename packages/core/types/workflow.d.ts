...
export interface WorkflowScheduleFilter { workspace_id?: string;
    resource_id?: string;
    schedule_type?: 'cron' | 'interval' | 'once';
    enabled?: boolean;
    overdue?: boolean }
...
export interface WorkflowComponentProps { workspaceId: string;
...
export declare const WORKFLOW_COLORS: { readonly draft: "#6B7280";
