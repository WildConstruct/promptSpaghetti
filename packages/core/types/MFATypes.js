...
export var MFAMethodStatus;
(function (MFAMethodStatus) {
    MFAMethodStatus["PENDING"] = "pending";
    MFAMethodStatus["ACTIVE"] = "active";
    MFAMethodStatus["DISABLED"] = "disabled";
    MFAMethodStatus["REVOKED"] = "revoked"; // Permanently removed
})(MFAMethodStatus || (MFAMethodStatus = {}));
export var MFAVerificationResult;
