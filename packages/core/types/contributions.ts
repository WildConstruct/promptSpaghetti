...
export const validateCreateContributionRequest = (request: unknown): CreateContributionRequest => { return CreateContributionRequestSchema.parse(request) };

export const validateUpdateContributionRequest = (request: unknown): UpdateContributionRequest => { return UpdateContributionRequestSchema.parse(request) };

export const validateContributionReviewRequest = (request: unknown): ContributionReviewRequest => { return ContributionReviewRequestSchema.parse(request) };

export const validateContributionFilter = (filter: unknown): ContributionFilter => { return ContributionFilterSchema.parse(filter) };

export const validateContributorProfile = (profile: unknown): ContributorProfile => { return ContributorProfileSchema.parse(profile) };
