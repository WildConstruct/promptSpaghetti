...
export declare const RestorationAttemptSchema: z.ZodObject<{ id: z.ZodString;
    ...
    targetSnapshotId?: string | undefined }, { id: string;
    createdAt: Date;
    updatedAt: Date;
    status: "pending" | "completed" | "failed" | "cancelled" | "in_progress";
    projectId: string;
...
export declare const RestorationConflictSchema: z.ZodObject<{ id: z.ZodString;
    ...
    resolvedValue?: Record<string, unknown> | undefined }, { id: string;
    createdAt: Date;
    resourceId: string;
    resourceType: "node" | "property" | "edge";
    conflictType: "node_modified" | "node_deleted" | "edge_deleted" | "edge_modified" | "position_conflict" | "property_conflict";
...
export declare const RestorationOperationSchema: z.ZodObject<{ id: z.ZodString;
    restorationAttemptId: z.ZodString;
    ...
    errorMessage?: string | undefined;
    executedAt?: Date | undefined }, { id: string;
    createdAt: Date;
    status: "pending" | "failed" | "skipped" | "executed";
    resourceId: string;
    resourceType: "node" | "property" | "edge";
...
export declare const RestorationPreviewSessionSchema: z.ZodObject<{ id: z.ZodString;
    projectId: z.ZodString;
    sourceSnapshotId: z.ZodString;
    targetSnapshotId: z.ZodOptional<z.ZodString>;
...
export declare const RestorationBookmarkSchema: z.ZodObject<{ id: z.ZodString;
    projectId: z.ZodString;
    name: z.ZodString;
...
export declare const RestorationConfigSchema: z.ZodObject<{ restorationType: z.ZodEnum<["full", "partial", "selective"]>;
    restorationStrategy: z.ZodEnum<["replace", "merge", "selective"]>;
    ...
    notifyOnCompletion: z.ZodDefault<z.ZodBoolean> }, "strip", z.ZodTypeAny, { createBackup: boolean;
    restorationType: "full" | "partial" | "selective";
    restorationStrategy: "replace" | "merge" | "selective";
    ...
    selectedEdges?: string[] | undefined }, { restorationType: "full" | "partial" | "selective";
    restorationStrategy: "replace" | "merge" | "selective";
...
export declare const CreateRestorationAttemptRequestSchema: z.ZodObject<{ projectId: z.ZodString;
    sourceSnapshotId: z.ZodString;
    targetSnapshotId: z.ZodOptional<z.ZodString>;
    config: z.ZodObject<{ }
        restorationType: z.ZodEnum<["full", "partial", "selective"]>;
    ...
    }, "strip", z.ZodTypeAny, { createBackup: boolean;
        restorationType: "full" | "partial" | "selective";
        restorationStrategy: "replace" | "merge" | "selective";
        preserveCurrentChanges: boolean;
        notifyOnCompletion: boolean;
...
export declare const RestorationPreviewRequestSchema: z.ZodObject<{ projectId: z.ZodString;
    sourceSnapshotId: z.ZodString;
    targetSnapshotId: z.ZodOptional<z.ZodString>;
    config: z.ZodObject<{ }
        restorationType: z.ZodEnum<["full", "partial", "selective"]>;
...
export declare const ConflictResolutionRequestSchema: z.ZodObject<{ restorationAttemptId: z.ZodString;
    conflictId: z.ZodString;
    resolutionStrategy: z.ZodEnum<["keep_source", "keep_target", "keep_current", "merge", "skip", "manual"]>;
    resolvedValue: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>> }, "strip", z.ZodTypeAny, { resolutionStrategy: "skip" | "manual" | "merge" | "keep_source" | "keep_target" | "keep_current";
    restorationAttemptId: string;
    conflictId: string;
    resolvedValue?: Record<string, unknown> | undefined }, { resolutionStrategy: "skip" | "manual" | "merge" | "keep_source" | "keep_target" | "keep_current";
    restorationAttemptId: string;
    conflictId: string;
    resolvedValue?: Record<string, unknown> | undefined }>;
export declare const RestorationBookmarkRequestSchema: z.ZodObject<{ projectId: z.ZodString;
    name: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    sourceSnapshotId: z.ZodString;
    targetSnapshotId: z.ZodOptional<z.ZodString>;
...
export declare const RestorationPreviewResponseSchema: z.ZodObject<{ sessionId: z.ZodString;
    preview: z.ZodObject<{ }
    ...
    conflicts: z.ZodArray<z.ZodObject<{ 
        ...
        conflictDescription?: string | undefined;
        sourceValue?: Record<string, unknown> | undefined;
        resolvedValue?: Record<string, unknown> | undefined }>, "many">;
    summary: z.ZodObject<{ ,
        totalChanges: z.ZodNumber;
        totalConflicts: z.ZodNumber;
        estimatedDuration: z.ZodNumber;
        riskLevel: z.ZodEnum<["low", "medium", "high"]> }, "strip", z.ZodTypeAny, { riskLevel: "low" | "medium" | "high";
        estimatedDuration: number;
        totalChanges: number;
        totalConflicts: number }, { riskLevel: "low" | "medium" | "high";
        estimatedDuration: number;
        totalChanges: number;
    ...
    expiresAt: z.ZodDate;
        ...
        totalChanges: number;
        totalConflicts: number };
    preview: { nodesToAdd: Record<string, unknown>[];
        nodesToUpdate: Record<string, unknown>[];
        nodesToDelete: string[];
        edgesToAdd: Record<string, unknown>[];
        edgesToUpdate: Record<string, unknown>[];
...
export declare const RestorationProgressResponseSchema: z.ZodObject<{ restorationAttemptId: z.ZodString;
    status: z.ZodEnum<["pending", "in_progress", "completed", "failed", "cancelled"]>;
    progressPercentage: z.ZodNumber;
    ...
    totalConflicts: z.ZodNumber;
    errorMessage: z.ZodOptional<z.ZodString>;
    estimatedTimeRemaining: z.ZodOptional<z.ZodNumber> }, "strip", z.ZodTypeAny, { status: "pending" | "completed" | "failed" | "cancelled" | "in_progress";
    ...
    currentOperation?: string | undefined }, { status: "pending" | "completed" | "failed" | "cancelled" | "in_progress";
    totalOperations: number;
    progressPercentage: number;
    restorationAttemptId: string;
    totalConflicts: number;
...
export declare const RestorationStatsResponseSchema: z.ZodObject<{ totalAttempts: z.ZodNumber;
    ...
    recentAttempts: z.ZodArray<z.ZodObject<{ 
        ...
        errorMessage?: string | undefined;
        completedAt?: Date | undefined;
        targetSnapshotId?: string | undefined }>, "many">;
}, "strip", z.ZodTypeAny, {
...
export interface RestorationResult { success: boolean;
    restorationAttemptId: string;
...
export declare const RestorationFilterSchema: z.ZodObject<{
    ...
    restorationType?: "full" | "partial" | "selective" | undefined }, { status?: "pending" | "completed" | "failed" | "cancelled" | "in_progress" | undefined;
    projectId?: string | undefined;
...
export declare export declare export declare export declare const RESTORATION_DEFAULTS: { readonly PREVIEW_EXPIRY_MINUTES: 30;
    readonly MAX_OPERATIONS_PER_BATCH: 100;
    readonly MAX_CONFLICTS_PER_SESSION: 1000;
    readonly PROGRESS_UPDATE_INTERVAL: 1000;
    readonly BACKUP_RETENTION_DAYS: 30 };
export declare const CONFLICT_DESCRIPTIONS: { readonly node_modified: "Node properties have been modified in both versions";
...
export declare const RESOLUTION_STRATEGY_DESCRIPTIONS: { readonly keep_source: "Keep the value from the source snapshot";
