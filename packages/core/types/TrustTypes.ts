...
export interface TrustScore { score: number; // 0-100 overall trust score;
  grade: TrustGrade;
  status: TrustStatus;
  lastUpdated: Date;
  version: string;
...
export interface DimensionScore { score: number; // 0-100;
...
export interface CreatorTrustScore { score: number; // 0-100;
...
export interface BuyerTrustScore { score: number; // 0-100 }
...
export interface TemplateQualityAssessment { overallQuality: number; // 0-100;
  codeQuality: number;
...
export interface TemplateSafetyAssessment { overallSafety: number; // 0-100 }
...
export interface DataQualityScore { completeness: number; // % of required data present;
...
export interface ReputationMetrics { overallReputation: number; // 0-100 }
...
export interface SatisfactionMetrics { customerSatisfactionScore: number; // 0-100;
...
export interface ComplianceMetrics { complianceScore: number; // 0-100 }
...
export interface CommunityContributionMetrics { helpfulnessScore: number; // 0-100 }
...
export interface TrustThresholds { excellent: number; // 90+;
  good: number;      // 80+;
  fair: number;      // 70+;
  warning: number;   // 60+;
  critical: number;  // <60;
...
export interface UpdateFrequencyConfig { realTime: string; // which scores update in real-time }
  hourly: string;
  daily: string;
  weekly: string;
  // =============================================================================
