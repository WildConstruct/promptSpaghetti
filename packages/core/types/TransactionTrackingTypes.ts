...
export interface TransactionAmount { gross: number; // Total transaction amount;
...
export interface TransactionRiskAssessment { score: number; // 0-100, higher = more risky;
...
export interface TransactionSearchQuery { // Basic filters
  status?: TransactionStatus;
  type?: TransactionType;
...
export interface MonitoringThresholds { highVolumeAlert: number; // transactions per minute;
