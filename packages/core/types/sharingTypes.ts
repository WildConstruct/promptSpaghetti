...
export const validateCreateShareRequest = (data: unknown): CreateShareRequest => { return CreateShareRequestSchema.parse(data) };

export const validateShareConfig = (data: unknown): ShareConfig => { return ShareConfigSchema.parse(data) };

export const validateShareAnalyticsEvent = (data: unknown): ShareAnalyticsEvent => { return ShareAnalyticsEventSchema.parse(data) };
