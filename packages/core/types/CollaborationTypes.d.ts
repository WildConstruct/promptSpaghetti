...
export declare export type ConnectionLabelStyle = 'default' | 'badge' | 'arrow' | 'highlight' | 'minimal';
...
export declare export type NodeLabelPosition = 'top' | 'bottom' | 'left' | 'right' | 'center';
...
export declare     onDelete?: () => void;
    onChangeColor?: (color: StickyNoteColor) => void;
    onDuplicate?: () => void;
}
export declare const STICKY_NOTE_COLORS: Record<StickyNoteColor, StickyNoteColorInfo>;
export declare const DEFAULT_STICKY_NOTE: Omit<StickyNote, 'id' | 'timestamp'>;
export declare const STICKY_NOTE_CONSTRAINTS: {
