...
export interface CompositeConfig { checks: string[];
...
export interface ParameterDefinition { name: string;
...
export interface NotificationCondition { severity: 'info' | 'warning' | 'error' | 'critical';
...
export interface ExecutionMetadata { hostname: string;
    environment: string;
    version: string;
    userId?: string;
...
export interface ErrorCondition extends SuccessCondition { export declare enum ComparisonOperator {
    EQUALS = "equals"
