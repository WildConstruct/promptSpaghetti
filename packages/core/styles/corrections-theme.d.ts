...
interface CorrectionsThemeProviderProps { children: ReactNode;
...
export declare const mediaQueries: { mobile: string;
    tablet: string;
    desktop: string };
export declare const animations: { fadeIn: {
        from: {
            opacity: number };
        to: { opacity: number };
    };
