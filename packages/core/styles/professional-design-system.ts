...
export interface ProfessionalColorPalette { // Primary Dark Theme (inspired by Cinema 4D R25 + Substance Designer)
  background: {;
...
export interface ProfessionalShadows { // Elevation System (inspired by Material Design + VFX tools)
  elevation: {;
  none: string;
...
export interface ProfessionalSpacing { // Spacing Scale (8px base grid)
  px: string;           // 1px;
  0.5: string;          // 2px;
  1: string;            // 4px;
  2: string;            // 8px;
...
export interface ProfessionalBorderRadius { none: string;         // 0px;
  sm: string;           // 3px;
  md: string;           // 6px;
  lg: string;           // 8px;
  xl: string;           // 12px;
...
export const generateCSSCustomProperties = ({ colors = professionalColors,
  shadows = professionalShadows,
  spacing = professionalSpacing }
  borderRadius = professionalBorderRadius
 = {}) => { return {
