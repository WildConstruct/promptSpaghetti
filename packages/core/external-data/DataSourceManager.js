...
export class DataSourceManager extends EventEmitter {
     ...
     */
    async queryJSONFile(source, query) {
     ...
     */
    async queryCSVFile(source, query) {
        // Simulate file reading delay
     ...
     */
    async queryXMLFile(source, query) {
     ...
     */
    generateMockItemName(category, era) {
        const prefixes = {
    ...
    generateMockMaterials(category) {
        const materials = {
