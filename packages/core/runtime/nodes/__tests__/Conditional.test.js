...
import { ConditionalNode, createConditionalNode, ConditionPresets, ConditionalBuilder, conditional } from '../Conditional.js';
...
describe('Conditional Node', () => {
    ...
    describe('Validation', () => {
        ...
        test('should warn about undefined outputs', () => {
            const undefinedBranches = [
                { condition: 'true', output: undefined }
            ];
    ...
    describe('Factory Functions', () => {
        test('should create node via factory function', () => {
            const branches = [{ condition: 'true', output: 'factory' }];
