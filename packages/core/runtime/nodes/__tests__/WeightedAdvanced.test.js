...
import { WeightedAdvancedNode, createWeightedAdvancedNode, DistributionPresets } from '../WeightedAdvanced.js';
...
describe('WeightedAdvanced Node', () => {
    ...
    describe('Weight Edge Cases', () => {
        ...
        test('should apply minimum weight threshold', () => {
            const minWeightConfig = {
                type: 'linear',
                minWeight: 1,
                normalize: false
            };
            const thresholdChoices = [
    ...
    describe('Factory Functions', () => {
        test('should create node via factory function', () => {
            const choices = [{ value: 'factory', weight: 1 }];
