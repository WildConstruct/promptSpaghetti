import { RuntimeNode, WeightedChoiceNode, ConcatNode, OutputNode, IncludeNode, SetVariableNode, GetVariableNode } from '../index';
// Mock seedrandom
...
describe('Runtime Engine - Comprehensive Coverage', () => {
    ...
    describe('WeightedChoiceNode - Edge Cases', () => {
        ...
        it('should handle non-numeric weights', () => {
            const node = new WeightedChoiceNode('non-numeric-weights', [
                { weight: 'invalid', value: 'first' },
                { weight: null, value: 'second' },
                { weight: undefined, value: 'third' }
            ]);
    ...
    describe('IncludeNode - Edge Cases', () => {
        ...
        it('should handle null template name', () => {
            const node = new IncludeNode('null-template', null, { template: 'value' });
            expect(node.run()).toBeUndefined();
        });
    ...
    describe('GetVariableNode - Edge Cases', () => {
        ...
        it('should handle null context variables', () => {
            const nullCtx = { variables: null, seed: '123' };
    ...
    describe('ExecutionContext - Edge Cases', () => {
        ...
        it('should handle context with numeric seed conversion', () => {
            const numCtx = { variables: {}, seed: 12345 };
