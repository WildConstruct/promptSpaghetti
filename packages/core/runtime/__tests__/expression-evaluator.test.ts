...
describe('SafeExpressionEvaluator', () => { const createSafeContext = () => ({)
  x: 10,
  y: 5,
  name: 'test',
  active: true,
  ...
  describe('Basic Expression Evaluation', () => { it('should evaluate numeric literals', () => {
    ...
    it('should evaluate string literals', () => { const context = createSafeContext();
    ...
    it('should evaluate boolean literals', () => { const context = createSafeContext();
    ...
    it('should evaluate identifiers from context', () => { const context = createSafeContext();
  ...
  describe('Arithmetic Operations', () => { it('should evaluate binary arithmetic expressions', () => {
      const context = createSafeContext();
    ...
    it('should respect operator precedence', () => { const context = createSafeContext();
    ...
    it('should evaluate unary expressions', () => { const context = createSafeContext();
      expect(SafeExpressionEvaluator.evaluate('-x', context)).toBe(-10);
      expect(SafeExpressionEvaluator.evaluate('+x', context)).toBe(10);
      expect(SafeExpressionEvaluator.evaluate('!active', context)).toBe(false) });
  });
  describe('Comparison Operations', () => { it('should evaluate comparison expressions', () => {
      const context = createSafeContext();
  ...
  describe('Logical Operations', () => { it('should evaluate logical expressions', () => {
      const context = createSafeContext();
      ...
      expect(SafeExpressionEvaluator.evaluate('x > 5 || y > 10', context)).toBe(true) });
    it('should short-circuit logical operators', () => { const context = createSafeContext();
  ...
  describe('Conditional (Ternary) Operations', () => { it('should evaluate ternary expressions', () => {
  const context = createSafeContext();
  ...
  describe('Member Access', () => { it('should evaluate dot notation member access', () => {
      const context = createSafeContext();
    ...
    it('should evaluate computed member access', () => { const context = createSafeContext();
      expect(SafeExpressionEvaluator.evaluate('user[\"id\"]', context)).toBe(123);
      expect(SafeExpressionEvaluator.evaluate('user[\"status\"]', context)).toBe('active') });
  });
  describe('Function Calls', () => { it('should evaluate safe function calls', () => {
      const context = createSafeContext();
  ...
  describe('Security Tests', () => { it('should block dangerous identifiers', () => {
      const context = createSafeContext();
    ...
    it('should block dangerous property access', () => { const context = createSafeContext();
    ...
    it('should block dangerous function calls', () => { const context = createSafeContext();
    ...
    it('should block dangerous string literals', () => { const context = createSafeContext();
      ...
      expect(() => SafeExpressionEvaluator.evaluate('\"<script>alert(1)</script>\"', context))
        .toThrow(/String literal contains dangerous pattern/) });
    it('should block dangerous node types', () => { const context = createSafeContext();
    ...
    it('should handle syntax errors gracefully', () => { const context = createSafeContext();
    ...
    it('should only allow whitelisted functions', () => { const context = {
  ...createSafeContext(),
  ...
  describe('Complex Expressions', () => { it('should evaluate complex nested expressions', () => {
  const context = createSafeContext();
  ...
  expect(SafeExpressionEvaluator.evaluate(expression, context)).toBe(true) });
    it('should handle multiple levels of member access', () => { const context = {
  data: {,
  user: {,
  profile: {,
  settings: {,
  ...
  describe('Error Cases', () => { it('should throw error for undefined variables', () => {
  const context = createSafeContext();
  expect(() => SafeExpressionEvaluator.evaluate('undefinedVariable', context))
  .toThrow(/Undefined variable: undefinedVariable/) });
    it('should throw error for unknown operators', () => { // This would be caught by the parser, but let's test anyway
      const context = createSafeContext();
      expect(() => SafeExpressionEvaluator.evaluate('x ** y', context))
        .toThrow(/Expression syntax error/) });
  });
});
describe('ASTNodeWhitelistFilter', () => { it('should create conditional node filter with correct configuration', () => {
    const filter = createConditionalNodeFilter();
    expect(filter).toBeDefined() });
  it('should block dangerous nodes', () => { const filter = createConditionalNodeFilter();
