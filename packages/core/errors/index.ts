...
export enum ErrorCode { // Graph Execution Errors
...
export abstract class BaseError extends Error { public readonly code: ErrorCode;
  ...
  */
   ...
   */
  getUserMessage(): string { return this.userMessage || this.message;
  /**
 ...
 */
export class ConfigurationError extends BaseError { constructor(message: string, configKey?: string, context?: Partial<ErrorContext>) {
    super();
      message
