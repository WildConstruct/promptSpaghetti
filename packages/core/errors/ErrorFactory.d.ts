...
export declare class ErrorFactory {
     ...
     */
    static createGraphExecutionError(message: string, cause?: Error, options?: ErrorFactoryOptions): GraphExecutionError;
    /**
     * Create a node execution error with specific node context
     */
    static createNodeExecutionError(nodeId: string, operation: string, message: string, cause?: Error, options?: ErrorFactoryOptions): NodeExecutionError;
    /**
     * Create a database connection error with retry logic
     */
    static createDatabaseConnectionError(message: string, cause?: Error, options?: ErrorFactoryOptions): DatabaseConnectionError;
    /**
     ...
     */
    static createMFAConfigurationError(type: 'already_configured' | 'invalid_email' | 'unsuitable_email' | 'invalid_config', details?: string, options?: ErrorFactoryOptions): MFAError;
    /**
     * Create MFA verification errors
     */
    static createMFAVerificationError(type: 'expired' | 'invalid_code' | 'too_many_attempts' | 'method_not_active' | 'rate_limit', options?: ErrorFactoryOptions): MFAError;
    /**
     * Create project locked error with lock context
     */
    static createProjectLockedError(projectId?: string, lockedBy?: string, options?: ErrorFactoryOptions): ProjectLockedError;
    /**
     * Create permission denied errors
     */
    static createPermissionDeniedError(resource: string, action: string, options?: ErrorFactoryOptions): AuthenticationError;
    /**
     * Create workflow state transition errors
     */
    static createWorkflowStateError(message?: string, fromState?: string, toState?: string, options?: ErrorFactoryOptions): WorkflowStateError;
    /**
     * Create API errors from HTTP responses
     */
    static createAPIError(statusCode: number, message: string, endpoint?: string, responseBody?: any, options?: ErrorFactoryOptions): APIError;
    /**
     * Create network/fetch errors
     */
    static createNetworkError(message: string, endpoint?: string, cause?: Error, options?: ErrorFactoryOptions): APIError;
    /**
     * Create validation errors for fields
     */
    static createValidationError(field: string, value: any, expected: string, options?: ErrorFactoryOptions): ValidationError;
    /**
     ...
     */
    static createConfigurationError(message: string, configKey?: string, options?: ErrorFactoryOptions): ConfigurationError;
    /**
     ...
     */
    static createRecoverableError(message: string, operation: string, recoveryFn?: () => Promise<void>, options?: ErrorFactoryOptions): GraphExecutionError;
}
