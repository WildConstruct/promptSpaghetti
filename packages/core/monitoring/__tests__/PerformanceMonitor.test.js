...
describe('PerformanceMonitor', () => {
    ...
    describe('Performance Analysis', () => {
        it('should identify slow executions', () => {
            ...
            const metrics = monitor.endExecution(trackingId, context);
            expect(metrics.warnings).toContainEqual(expect.stringContaining('Slow execution: 150.00ms'));
        });
        it('should track context size warnings', () => {
            ...
            mockTime += 50;
            const metrics = monitor.endExecution(trackingId, context);
            expect(metrics.warnings).toContainEqual(expect.stringContaining('Large context size: 120 items'));
        });
        it('should track deep evaluation warnings', () => {
            ...
            mockTime += 30;
            const metrics = monitor.endExecution(trackingId, context);
            expect(metrics.warnings).toContainEqual(expect.stringContaining('Deep evaluation depth: 15 levels'));
        });
    });
    ...
    describe('Configuration', () => {
        ...
        it('should handle custom thresholds', () => {
            ...
            try {
                ...
                expect(metrics.warnings).toContainEqual(expect.stringContaining('Large context size: 6 items'));
            }
            finally {
