...
export class GraphValidator extends EventEmitter {
     ...
     */
    async validate(operation, currentState) {
        const errors = [];
        const warnings = [];
        try {
    ...
    async validateSpecificOperation(operation, currentState) {
    ...
    async validateNodeAdd(operation, state) {
        const errors = [];
    ...
    async validateNodeDelete(operation, state) {
        const errors = [];
    ...
    async validateNodeUpdate(operation, state) {
        const errors = [];
    ...
    async validateEdgeAdd(operation, state) {
        const errors = [];
        ...
        const isDuplicate = state.edges.some(e => e.source === edge.source &&
    ...
    async validateEdgeDelete(operation, state) {
        const errors = [];
    ...
    async validateVariationAdd(operation, state) {
        const errors = [];
    ...
    async validateVariationDelete(operation, state) {
        const errors = [];
    ...
    async validateVariationUpdate(operation, state) {
        const errors = [];
    ...
    async validateVariationReorder(operation, state) {
        const errors = [];
    ...
    async validateOperationSchema(operation, state) {
        const errors = [];
    ...
    async validateStructuralConstraints(operation, state) {
        const errors = [];
    ...
    async validateGraphState(state) {
        const errors = [];
    ...
    simulateOperation(operation, state) {
