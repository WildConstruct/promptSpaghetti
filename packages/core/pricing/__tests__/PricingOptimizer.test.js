...
describe('PricingOptimizer', () => {
    ...
    describe('Model Management', () => {
        test('should add pricing models successfully', () => {
            const testOptimizer = new PricingOptimizer();
            const modelAddedPromise = new Promise((resolve) => {
    ...
    describe('Demand Forecasting', () => {
        ...
        test('should throw error for unknown model in forecast', async () => {
            await expect(optimizer.generateDemandForecast('unknown-model', 30)).rejects.toThrow('Model not found: unknown-model');
        });
        test('should require analytics for forecast', async () => {
            ...
            await expect(optimizer.generateDemandForecast('new-forecast-model', 30)).rejects.toThrow('Analytics not available for model: new-forecast-model');
        });
    });
    describe('Competitive Analysis', () => {
        ...
        test('should throw error for unknown model in competitive analysis', async () => {
            await expect(optimizer.getCompetitiveAnalysis('unknown-model')).rejects.toThrow('Model not found: unknown-model');
        });
    });
