...
export declare const SegmentConditionSchema: z.ZodObject<{
    ...
    weight: number;
    operator: "between" | "regex" | "in" | "equals" | "contains" | "exists" | "percentile" | "not_equals" | "greater_than" | "less_than" | "not_contains" | "not_in" | "greater_equal" | "less_equal" | "starts_with" | "ends_with" | "not_exists" | "not_between" | "within_days" | "not_within_days" | "relative_to_now" | "moving_average" | "trend_up" | "trend_down" | "custom_function";
    field: string;
    evaluationCount: number;
    matchRate: number;
