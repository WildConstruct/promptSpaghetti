...
import { Settings, Shield, Eye, MessageSquare, Cookie, History, AlertCircle, CheckCircle, Clock, RefreshCw, Globe } from 'lucide-react';
export const ConsentPreferenceCenter = ({ userId, onConsentUpdate, onDataRequest, showDataRights = true, showHistory = true, jurisdiction = 'US' }) => {
    ...
    const updateCommunicationPreference = (channel, updates) => {
        setSettings(prev => ({
            ...prev,
            communications: {
                ...prev.communications,
...
return (_jsxs("div", { className: "max-w-6xl mx-auto p-6 bg-white", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: "Privacy Preferences" }), _jsxs("p", { className: "text-gray-600", children: ["Manage your consent preferences and exercise your data protection rights.", isGDPRApplicable && ' You have comprehensive rights under GDPR.', isCCPAApplicable && ' California residents have additional privacy rights under CCPA.'] }), lastSaved && (_jsxs("div", { className: "mt-2 flex items-center text-sm text-green-600", children: [_jsx(CheckCircle, { className: "w-4 h-4 mr-1" }), "Last saved: ", lastSaved.toLocaleString()] }))] }), _jsxs("div", { className: "flex flex-col lg:flex-row gap-6", children: [_jsx("div", { className: "lg:w-64 space-y-2", children: [
