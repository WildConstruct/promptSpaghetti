...
export const ApprovalWorkflowManager = ({ workspaceId, currentUserId, userRole }) => {
    ...
    const handleReviewSubmit = async (decision, comment, criteriaEvaluations) => {
        if (!selectedRequest)
            return;
        try {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Approval Workflow" }), _jsx("p", { className: "mt-1 text-sm text-gray-600", children: "Manage approval processes, criteria, and review workflows" })] }), canManageWorkflow && (_jsxs("div", { className: "flex items-center space-x-3", children: [_jsxs("button", { onClick: () => setShowCriteriaModal(true), className: "inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700", children: [_jsx(PlusIcon, { className: "h-4 w-4 mr-2" }), "Add Criteria"] }), _jsxs("button", { onClick: () => setShowRuleModal(true), className: "inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-green-600 hover:bg-green-700", children: [_jsx(PlusIcon, { className: "h-4 w-4 mr-2" }), "Add Rule"] })] }))] }), _jsx("div", { className: "border-b border-gray-200", children: _jsx("nav", { className: "-mb-px flex space-x-8", children: [
                    ...
                    ].map(tab => (_jsxs("button", { onClick: () => setActiveTab(tab.id), className: `flex items-center space-x-2 py-2 px-1 border-b-2 font-medium text-sm ${activeTab === tab.id
                            ? 'border-blue-500 text-blue-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`, children: [_jsx(tab.icon, { className: "h-4 w-4" }), _jsx("span", { children: tab.label })] }, tab.id))) }) }), error && (_jsx("div", { className: "bg-red-50 border border-red-200 rounded-md p-4", children: _jsxs("div", { className: "flex", children: [_jsx(XCircleIcon, { className: "h-5 w-5 text-red-400" }), _jsxs("div", { className: "ml-3", children: [_jsx("h3", { className: "text-sm font-medium text-red-800", children: "Error" }), _jsx("div", { className: "mt-2 text-sm text-red-700", children: error })] })] }) })), _jsxs("div", { className: "mt-6", children: [activeTab === 'dashboard' && (_jsx(ApprovalDashboard, { workspaceId: workspaceId, currentUserId: currentUserId, mode: dashboardMode })), activeTab === 'criteria' && (_jsx("div", { className: "space-y-4", children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: approvalCriteria.map((criteria) => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h3", { className: "font-medium text-gray-900", children: criteria.name }), canManageWorkflow && (_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("button", { onClick: () => setEditingCriteria(criteria), className: "p-1 text-gray-400 hover:text-gray-600", children: _jsx(PencilIcon, { className: "h-4 w-4" }) }), _jsx("button", { onClick: () => handleDeleteCriteria(criteria.id), className: "p-1 text-gray-400 hover:text-red-600", children: _jsx(TrashIcon, { className: "h-4 w-4" }) })] }))] }), criteria.description && (_jsx("p", { className: "text-sm text-gray-600 mb-3", children: criteria.description })), _jsxs("div", { className: "flex items-center justify-between text-sm", children: [_jsxs("span", { className: "text-gray-600", children: ["Weight: ", criteria.weight] }), criteria.is_required && (_jsx("span", { className: "px-2 py-1 bg-red-100 text-red-800 text-xs rounded", children: "Required" }))] })] }, criteria.id))) }) })), activeTab === 'rules' && (_jsx("div", { className: "space-y-4", children: _jsx("div", { className: "grid grid-cols-1 gap-4", children: approvalRules.map((rule) => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { className: "text-lg font-medium text-gray-900", children: rule.name }), canManageWorkflow && (_jsx("div", { className: "flex items-center space-x-2", children: _jsx("button", { onClick: () => setEditingRule(rule), className: "p-1 text-gray-400 hover:text-gray-600", children: _jsx(PencilIcon, { className: "h-4 w-4" }) }) }))] }), rule.description && (_jsx("p", { className: "text-sm text-gray-600 mb-4", children: rule.description })), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Assignment:" }), _jsx("span", { className: "ml-2 text-gray-600", children: rule.reviewer_assignment_type })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Reviewers:" }), _jsx("span", { className: "ml-2 text-gray-600", children: rule.required_reviewers })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Min. Approvals:" }), _jsx("span", { className: "ml-2 text-gray-600", children: rule.minimum_approvals })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Timeout:" }), _jsxs("span", { className: "ml-2 text-gray-600", children: [rule.approval_timeout_hours, "h"] })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Escalation:" }), _jsx("span", { className: "ml-2 text-gray-600", children: rule.escalation_enabled ? 'Yes' : 'No' })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Auto-approval:" }), _jsx("span", { className: "ml-2 text-gray-600", children: rule.auto_approval_enabled ? 'Yes' : 'No' })] })] })] }, rule.id))) }) })), activeTab === 'statistics' && (_jsx(ApprovalStatistics, { workspaceId: workspaceId, period: "30d" }))] }), showCriteriaModal && (_jsx(CriteriaModal, { onSave: handleCreateCriteria, onClose: () => setShowCriteriaModal(false) })), editingCriteria && (_jsx(CriteriaModal, { criteria: editingCriteria, onSave: (data) => handleUpdateCriteria(editingCriteria.id, data), onClose: () => setEditingCriteria(null) })), showReviewInterface && selectedRequest && (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4", children: _jsx("div", { className: "max-w-6xl w-full max-h-[90vh] overflow-y-auto", children: _jsx(ApprovalReviewInterface, { request: selectedRequest, workspaceId: workspaceId, currentUserId: currentUserId, onReviewSubmit: handleReviewSubmit, onClose: () => {
                            setShowReviewInterface(false);
                            setSelectedRequest(null);
                        } }) }) }))] }));
};
