...
export const RealTimePreviewPanel = ({ visible = true, onClose, className = '', enablePerformanceMonitoring = true, maxResults = 5 }) => {
    // Store hooks
    ...
    if (!visible)
        return null;
    return (_jsxs("div", { className: `real-time-preview-panel ${className}`, style: {
            position: 'fixed',
            right: '20px',
            top: '20px',
            width: '400px',
            ...
            fontFamily: 'system-ui, -apple-system, sans-serif'
                    ...
                    background: '#f8fafc'
                                    ...
                                    fontSize: '12px',
                                    cursor: 'pointer'
                                }, children: "\uD83D\uDDD1\uFE0F Clear" }), enablePerformanceMonitoring && (_jsx("button", { onClick: () => setShowPerformanceDetails(!showPerformanceDetails), style: {
                                    padding: '6px 12px',
                                    ...
                                    fontSize: '12px',
                                    cursor: 'pointer'
                                }, children: "\uD83D\uDCCA Stats" }))] })] }), showPerformanceDetails && (_jsxs("div", { style: {
                    padding: '12px 20px',
                    borderBottom: '1px solid #e2e8f0',
                    background: '#fafafa',
                    fontSize: '12px'
                }, children: [_jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Sync Count:" }), " ", syncCount] }), _jsxs("div", { children: [_jsx("strong", { children: "Last Sync:" }), " ", formatTime(lastSyncTime)] }), _jsxs("div", { children: [_jsx("strong", { children: "Avg Time:" }), " ", Math.round(performanceMetrics.avgSyncTime), "ms"] }), _jsxs("div", { children: [_jsx("strong", { children: "Success Rate:" }), " ", Math.round(performanceMetrics.successRate * 100), "%"] }), _jsxs("div", { children: [_jsx("strong", { children: "Cache Hit:" }), " ", Math.round(performanceMetrics.cacheHitRate * 100), "%"] }), performanceStats && (_jsxs("div", { children: [_jsx("strong", { children: "Exec Time:" }), " ", performanceStats.averageTime, "ms"] }))] }), changeAnalysis && (_jsxs("div", { style: { marginTop: '8px', padding: '8px', background: 'white', borderRadius: '4px' }, children: [_jsx("strong", { children: "Last Change:" }), " ", changeAnalysis.type, "(", changeAnalysis.significance, "% significance,", changeAnalysis.affectedCount, " items affected)"] }))] })), _jsxs("div", { style: {
                    maxHeight: '400px',
                    overflowY: 'auto',
                    padding: '12px 0'
                            ...
                            color: '#dc2626',
                            fontSize: '14px'
                        }, children: [_jsx("strong", { children: "Error:" }), " ", error] })), isLoading && (_jsxs("div", { style: {
                            padding: '20px',
                            textAlign: 'center',
                            color: '#6b7280'
                        }, children: [_jsx("div", { style: { fontSize: '24px', marginBottom: '8px' }, children: "\u23F3" }), _jsx("div", { children: "Generating previews..." })] })), results.length === 0 && !isLoading && !error && (_jsxs("div", { style: {
                            padding: '40px 20px',
                            textAlign: 'center',
                            color: '#9ca3af'
                        }, children: [_jsx("div", { style: { fontSize: '32px', marginBottom: '12px' }, children: "\uD83C\uDFAF" }), _jsx("div", { style: { fontSize: '16px', marginBottom: '4px' }, children: "No previews yet" }), _jsx("div", { style: { fontSize: '14px' }, children: "Enable real-time sync or click refresh to generate previews" })] })), results.slice(0, maxResults).map((result, index) => (_jsxs("div", { style: {
                            margin: '0 20px 8px',
                            padding: '12px',
                            ...
                            transition: 'all 0.2s ease'
                        }, onClick: () => handleResultClick(index), children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsxs("span", { style: {
                                                    background: '#e2e8f0',
                                                    padding: '2px 6px',
                                                    borderRadius: '4px',
                                                    fontSize: '11px',
                                                    fontWeight: '600'
                                                }, children: ["Seed ", result.seed] }), result.executionTimeMs && (_jsxs("span", { style: { fontSize: '11px', color: '#6b7280' }, children: [result.executionTimeMs, "ms"] }))] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '4px' }, children: [result.locked && (_jsx("span", { title: `Locked: ${result.lockedNote || 'No note'}`, style: { fontSize: '14px' }, children: "\uD83D\uDD12" })), _jsx("button", { onClick: (e) => {
                                                    e.stopPropagation();
                                                    ...
                                                    opacity: 0.7,
                                                    padding: '2px'
                                                }, title: result.locked ? 'Unlock result' : 'Lock result', children: result.locked ? '🔓' : '🔒' })] })] }), _jsx("div", { style: { fontSize: '14px', lineHeight: '1.4' }, children: result.error ? (_jsx("div", { style: { color: '#dc2626', fontStyle: 'italic' }, children: result.error })) : (_jsx("div", { style: { color: '#374151' }, children: result.output || 'No output' })) })] }, `${result.seed}-${index}`))), results.length > maxResults && (_jsxs("div", { style: {
                            padding: '12px 20px',
                            textAlign: 'center',
                            color: '#6b7280',
                            fontSize: '14px'
                        }, children: ["... and ", results.length - maxResults, " more results"] }))] }), showLockDialog && (_jsx("div", { style: {
                    position: 'absolute',
                    inset: 0,
