...
export declare     getAnalytics: () => { helpInteractions: Array<{
            event: string;
            data: any;
            timestamp: number;
            sessionId: string }>;
        userStruggles: Array<{ event: string;
            data: any;
            timestamp: number;
            sessionId: string }>;
        effectiveness: Record<string, { views: number;
            helpful: number }>;
    };
...
export declare const HELP_SYSTEM_CONFIG: { ANALYTICS_ENABLED: boolean;
