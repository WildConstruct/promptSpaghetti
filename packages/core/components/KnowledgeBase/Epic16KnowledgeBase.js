...
export const Epic16KnowledgeBase = ({ userId, userRole, initialView = 'search', initialArticleId, onAnalytics }) => {
    ...
    if (kbState.loading && !kbState.selectedArticle) {
        return (_jsx("div", { className: "flex items-center justify-center h-64", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: "animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600" }), _jsx("span", { className: "text-gray-600", children: "Loading knowledge base..." })] }) }));
    }
    // Render error state
    ...
    return (_jsxs("div", { className: "epic16-knowledge-base h-full", children: [kbState.currentView === 'search' && (_jsxs("div", { children: [_jsx(KnowledgeBaseSearch, { knowledgeService: knowledgeService, userId: userId, onArticleSelect: handleArticleSelect, onSearchPerformed: handleSearchPerformed }), _jsxs("div", { className: "max-w-6xl mx-auto px-6 py-12", children: [_jsxs("div", { className: "mb-12", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Browse by Category" }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4", children: Object.values(KnowledgeCategory).map(category => (_jsxs("button", { onClick: () => handleCategorySelect(category), className: "flex flex-col items-center p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all", children: [_jsx("div", { className: "text-3xl mb-2", children: getCategoryIcon(category) }), _jsx("div", { className: "text-sm font-medium text-gray-900 text-center", children: formatCategoryName(category) })] }, category))) })] }), _jsxs("div", { className: "mb-12", children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "Popular Articles" }), _jsx("button", { onClick: () => setKbState(prev => ({ ...prev, currentView: 'browse' })), className: "text-blue-600 hover:text-blue-800 text-sm font-medium", children: "View All \u2192" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: kbState.popularArticles.map(article => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer", onClick: () => handleArticleSelect(article.id), children: [_jsxs("div", { className: "flex items-start justify-between mb-3", children: [_jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800", children: formatCategoryName(article.category) }), _jsxs("span", { className: "text-xs text-gray-500", children: [article.views, " views"] })] }), _jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2 line-clamp-2", children: article.title }), _jsx("p", { className: "text-gray-600 text-sm mb-4 line-clamp-3", children: article.excerpt || article.content.substring(0, 150) + '...' }), _jsxs("div", { className: "flex items-center justify-between text-sm text-gray-500", children: [_jsxs("span", { children: [article.estimatedReadTime, " min read"] }), _jsx("div", { className: "flex items-center", children: [...Array(5)].map((_, i) => (_jsx("svg", { className: `w-4 h-4 ${i < Math.round(article.ratings.reduce((sum, r) => sum + r.rating, 0) / article.ratings.length || 0)
                                                                    ? 'text-yellow-400'
                                                                    : 'text-gray-300'}`, fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }, i))) })] })] }, article.id))) })] }), _jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Recently Updated" }), _jsx("div", { className: "space-y-4", children: kbState.recentArticles.map(article => (_jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer", onClick: () => handleArticleSelect(article.id), children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-3 mb-2", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900", children: article.title }), _jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800", children: "Updated" })] }), _jsx("p", { className: "text-gray-600 text-sm mb-2 line-clamp-2", children: article.excerpt || article.content.substring(0, 200) + '...' }), _jsxs("div", { className: "flex items-center space-x-4 text-sm text-gray-500", children: [_jsx("span", { className: "bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs", children: formatCategoryName(article.category) }), _jsxs("span", { children: [article.estimatedReadTime, " min read"] }), _jsxs("span", { children: ["Updated ", new Date(article.lastUpdated).toLocaleDateString()] })] })] }), _jsxs("div", { className: "text-right", children: [_jsx("div", { className: "flex items-center mb-1", children: [...Array(5)].map((_, i) => (_jsx("svg", { className: `w-4 h-4 ${i < Math.round(article.ratings.reduce((sum, r) => sum + r.rating, 0) / article.ratings.length || 0)
                                                                        ? 'text-yellow-400'
                                                                        : 'text-gray-300'}`, fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }, i))) }), _jsxs("div", { className: "text-xs text-gray-500", children: [article.views, " views"] })] })] }) }, article.id))) })] })] })] })), kbState.currentView === 'article' && kbState.selectedArticle && (_jsx(KnowledgeBaseArticleViewer, { article: kbState.selectedArticle, knowledgeService: knowledgeService, userId: userId, onArticleSelect: handleArticleSelect, onClose: handleBackToSearch })), kbState.currentView === 'browse' && (_jsxs("div", { className: "max-w-6xl mx-auto px-6 py-8", children: [_jsxs("div", { className: "flex items-center justify-between mb-8", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: kbState.selectedCategory
                                            ? `${formatCategoryName(kbState.selectedCategory)} Articles`
                                            : 'Browse All Articles' }), _jsx("p", { className: "text-gray-600 mt-2", children: "Find comprehensive guides, tutorials, and documentation" })] }), _jsx("button", { onClick: handleBackToSearch, className: "px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200", children: "Back to Search" })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: (kbState.selectedCategory
                            ...
                            : [...kbState.popularArticles, ...kbState.recentArticles]).map(article => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer", onClick: () => handleArticleSelect(article.id), children: [_jsxs("div", { className: "flex items-start justify-between mb-3", children: [_jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800", children: formatCategoryName(article.category) }), _jsxs("span", { className: "text-xs text-gray-500", children: [article.views, " views"] })] }), _jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2 line-clamp-2", children: article.title }), _jsx("p", { className: "text-gray-600 text-sm mb-4 line-clamp-3", children: article.excerpt || article.content.substring(0, 150) + '...' }), _jsxs("div", { className: "flex items-center justify-between text-sm text-gray-500", children: [_jsxs("span", { children: [article.estimatedReadTime, " min read"] }), _jsx("div", { className: "flex items-center", children: [...Array(5)].map((_, i) => (_jsx("svg", { className: `w-4 h-4 ${i < Math.round(article.ratings.reduce((sum, r) => sum + r.rating, 0) / article.ratings.length || 0)
                                                    ? 'text-yellow-400'
                                                    : 'text-gray-300'}`, fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }, i))) })] })] }, article.id))) })] }))] }));
};
