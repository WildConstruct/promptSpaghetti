...
export const ConstraintRuleManager = ({ validator, onConstraintsChange, onClose }) => {
    ...
    return (_jsxs("div", { className: "constraint-rule-manager", children: [_jsxs("div", { className: "rule-manager-header", children: [_jsx("h2", { children: "Constraint Rule Management" }), _jsxs("div", { className: "header-actions", children: [_jsxs("button", { className: "export-btn", onClick: handleExportConstraints, title: "Export constraints", children: [_jsx(Download, { size: 16 }), "Export"] }), _jsxs("label", { className: "import-btn", title: "Import constraints", children: [_jsx(Upload, { size: 16 }), "Import", _jsx("input", { type: "file", accept: ".json", onChange: handleImportConstraints, style: { display: 'none' } })] }), _jsxs("button", { className: "create-btn", onClick: handleCreateConstraint, children: [_jsx(Plus, { size: 16 }), "New Rule"] }), _jsx("button", { className: "close-btn", onClick: onClose, children: _jsx(X, { size: 16 }) })] })] }), _jsxs("div", { className: "rule-manager-filters", children: [_jsxs("div", { className: "filter-group", children: [_jsx("label", { children: "Category:" }), _jsxs("select", { value: filterCategory, onChange: (e) => setFilterCategory(e.target.value), children: [_jsx("option", { value: "all", children: "All Categories" }), _jsx("option", { value: "era_compatibility", children: "Era Compatibility" }), _jsx("option", { value: "social_class_appropriateness", children: "Social Class" }), _jsx("option", { value: "material_availability", children: "Material Availability" }), _jsx("option", { value: "cultural_appropriateness", children: "Cultural Sensitivity" }), _jsx("option", { value: "temporal_consistency", children: "Temporal Consistency" }), _jsx("option", { value: "regional_authenticity", children: "Regional Authenticity" })] })] }), _jsxs("div", { className: "filter-group", children: [_jsx("label", { children: "Enforcement:" }), _jsxs("select", { value: filterEnforcement, onChange: (e) => setFilterEnforcement(e.target.value), children: [_jsx("option", { value: "all", children: "All Levels" }), _jsx("option", { value: "strict", children: "Strict" }), _jsx("option", { value: "warning", children: "Warning" }), _jsx("option", { value: "suggestion", children: "Suggestion" })] })] })] }), _jsxs("div", { className: "constraints-list", children: [filteredConstraints.map(constraint => (_jsx(ConstraintRuleItem, { constraint: constraint, onEdit: handleEditConstraint, onDelete: handleDeleteConstraint }, constraint.id))), filteredConstraints.length === 0 && (_jsxs("div", { className: "no-constraints", children: [_jsx(Info, { size: 24 }), _jsx("p", { children: "No constraints match the current filters." })] }))] }), editingConstraint && (_jsx(ConstraintEditor, { constraint: editingConstraint, isCreating: isCreating, onChange: setEditingConstraint, onSave: handleSaveConstraint, onCancel: handleCancelEdit }))] }));
};
const ConstraintRuleItem = ({ constraint, onEdit, onDelete }) => {
    ...
    return (_jsxs("div", { className: "constraint-rule-item", children: [_jsxs("div", { className: "rule-header", children: [_jsxs("div", { className: "rule-title", children: [getEnforcementIcon(constraint.enforcement), _jsx("span", { className: "rule-name", children: constraint.message }), _jsx("span", { className: "rule-type", children: constraint.rule })] }), _jsxs("div", { className: "rule-actions", children: [_jsx("button", { className: "edit-btn", onClick: () => onEdit(constraint), title: "Edit constraint", children: _jsx(Edit3, { size: 14 }) }), _jsx("button", { className: "delete-btn", onClick: () => onDelete(constraint.id), title: "Delete constraint", children: _jsx(Trash2, { size: 14 }) })] })] }), _jsxs("div", { className: "rule-details", children: [_jsx("div", { className: "rule-description", children: constraint.description }), constraint.historical_basis && (_jsxs("div", { className: "historical-basis", children: [_jsx("strong", { children: "Historical Basis:" }), " ", constraint.historical_basis] })), _jsxs("div", { className: "rule-scope", children: [_jsxs("span", { children: ["Eras: ", constraint.eras.map(era => era.name).join(', ')] }), constraint.regions && (_jsxs("span", { children: ["Regions: ", constraint.regions.join(', ')] })), constraint.social_classes && (_jsxs("span", { children: ["Classes: ", constraint.social_classes.join(', ')] }))] })] })] }));
};
const ConstraintEditor = ({ constraint, isCreating, onChange, onSave, onCancel }) => {
