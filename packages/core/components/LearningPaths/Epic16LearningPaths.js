...
export const Epic16LearningPaths = ({ userId, userRole, userTier, onAnalytics, onCertification }) => {
    ...
    if (loading && !selectedPath) {
        return (_jsx("div", { className: "flex items-center justify-center h-64", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: "animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600" }), _jsx("span", { className: "text-gray-600", children: "Loading learning system..." })] }) }));
    }
    // Render error state
