...
export const FilePreview = ({ file, mode = 'compact', isHover = false, onClick, onToggleFavorite, style, className }) => {
    ...
    const renderThumbnail = useCallback(() => {
        if (thumbnail) {
            return (_jsx("img", { src: thumbnail, alt: `${file.name} preview`, style: {
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
                    borderRadius: '4px'
    ...
    if (mode === 'compact') {
        return (_jsxs("div", { className: className, style: {
                ...
                if (e.key === 'Enter' || e.key === ' ') {
                    ...
                    handleClick();
            ...
            } : undefined, children: [_jsx("div", { style: { width: '60px', height: '45px', flexShrink: 0 }, children: renderThumbnail() }), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: {
                                fontSize: '14px',
                                fontWeight: '600',
                                color: '#333',
                                marginBottom: '4px',
                                ...
                                display: 'flex',
                                gap: '12px'
                            }, children: [_jsxs("span", { children: [fileStats.totalNodes, " nodes"] }), _jsx("span", { children: formatFileSize(file.size) }), _jsx("span", { children: formatRelativeTime(file.lastModified) })] })] }), _jsx("div", { style: { flexShrink: 0, display: 'flex', gap: '8px' }, children: onToggleFavorite && (_jsx("button", { onClick: handleFavoriteClick, style: {
                            background: 'none',
                            border: 'none',
                            cursor: 'pointer',
                            padding: '4px',
    ...
    return (_jsxs("div", { className: className, style: {
            ...
            maxWidth: '500px'
                    ...
                    marginBottom: '16px'
                                    ...
                                    color: '#666',
                                    lineHeight: '1.4'
                                }, children: file.metadata.description }))] }), onToggleFavorite && (_jsx("button", { onClick: handleFavoriteClick, style: {
                            background: 'none',
                            border: 'none',
                            cursor: 'pointer',
                            padding: '4px',
