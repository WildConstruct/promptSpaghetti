...
export const HoverPreview = ({ file, targetElement, delay = 300, onClick, children }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { ref: triggerRef, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, onFocus: handleFocus, onBlur: handleBlur, style: { display: 'inline-block' }, children: children }), isVisible && (_jsx("div", { ref: previewRef, className: "absolute", style: {
                    position: 'fixed',
                    left: `${position.x}px`,
                    top: `${position.y}px`,
                    zIndex: 10000,
                ...
                }, onMouseEnter: handlePreviewMouseEnter, onMouseLeave: handlePreviewMouseLeave, onClick: handlePreviewClick, role: "tooltip", "aria-label": `Preview of ${file.metadata.title || file.name}`, children: _jsx(FilePreview, { file: file, mode: "full", isHover: true, onClick: onClick ? handlePreviewClick : undefined }) })), _jsx("style", { jsx: true, global: true, children: `
        @keyframes fadeIn {
          from {
            opacity: 0;
