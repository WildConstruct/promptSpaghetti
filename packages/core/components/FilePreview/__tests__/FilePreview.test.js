...
describe('FilePreview Component', () => {
    ...
    describe('Compact Mode', () => {
        it('renders file preview in compact mode', () => {
            render(_jsx(FilePreview, { file: mockFile, mode: "compact" }));
        ...
        it('displays formatted file size correctly', () => {
            ...
            render(_jsx(FilePreview, { file: largeFile, mode: "compact" }));
        ...
        it('handles onClick event in compact mode', () => {
            ...
            render(_jsx(FilePreview, { file: mockFile, mode: "compact", onClick: handleClick }));
    ...
    describe('Full Mode', () => {
        it('renders file preview in full mode with all metadata', () => {
            render(_jsx(FilePreview, { file: mockFile, mode: "full" }));
    ...
    describe('Thumbnail Generation', () => {
        ...
        it('uses cached thumbnail if available', () => {
            ...
            render(_jsx(FilePreview, { file: fileWithThumbnail, mode: "full" }));
    ...
    describe('Favorite Status', () => {
        it('shows favorite star when file is favorite', () => {
            ...
            render(_jsx(FilePreview, { file: favoriteFile, mode: "compact" }));
    ...
    describe('File Size Formatting', () => {
        it('formats bytes correctly', () => {
            ...
            render(_jsx(FilePreview, { file: smallFile, mode: "compact" }));
            expect(screen.getByText('512 B')).toBeInTheDocument();
        });
        it('formats kilobytes correctly', () => {
            const mediumFile = { ...mockFile, size: 2048 };
            render(_jsx(FilePreview, { file: mediumFile, mode: "compact" }));
        ...
        it('handles zero size', () => {
            ...
            render(_jsx(FilePreview, { file: emptyFile, mode: "compact" }));
    ...
    describe('Missing Metadata Handling', () => {
        it('handles missing title gracefully', () => {
            ...
            render(_jsx(FilePreview, { file: fileWithoutTitle, mode: "full" }));
        ...
        it('handles empty tags array', () => {
            ...
            render(_jsx(FilePreview, { file: fileWithoutTags, mode: "full" }));
        ...
        it('handles missing description', () => {
            ...
            render(_jsx(FilePreview, { file: fileWithoutDescription, mode: "full" }));
            expect(screen.getByText('Test Graph')).toBeInTheDocument();
        });
    });
    describe('Performance', () => {
        it('memoizes component to prevent unnecessary re-renders', () => {
            const { rerender } = render(_jsx(FilePreview, { file: mockFile, mode: "compact" }));
            ...
            rerender(_jsx(FilePreview, { file: mockFile, mode: "compact" }));
        ...
        it('regenerates thumbnail only when file changes', async () => {
            const { rerender } = render(_jsx(FilePreview, { file: mockFile, mode: "full" }));
            await waitFor(() => {
                expect(mockProjectManager.generateThumbnail).toHaveBeenCalledTimes(1);
            });
            const newFile = { ...mockFile, id: 'different-file' };
            rerender(_jsx(FilePreview, { file: newFile, mode: "full" }));
            await waitFor(() => {
    ...
    describe('Accessibility', () => {
        it('has proper ARIA attributes', () => {
            render(_jsx(FilePreview, { file: mockFile, mode: "compact", onClick: () => { } }));
    ...
    describe('Error Boundaries', () => {
        it('handles invalid date objects', () => {
            ...
            expect(() => {
                render(_jsx(FilePreview, { file: fileWithInvalidDate, mode: "compact" }));
            }).not.toThrow();
        });
        it('handles missing metadata object', () => {
            ...
            expect(() => {
                render(_jsx(FilePreview, { file: fileWithoutMetadata, mode: "full" }));
            }).not.toThrow();
        });
    });
});
