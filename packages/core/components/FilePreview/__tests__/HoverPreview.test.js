...
describe('HoverPreview Component', () => {
    ...
    describe('Basic Functionality', () => {
        it('renders trigger element', () => {
            render(_jsx(HoverPreview, { file: mockFile, children: _jsx("span", { children: "Hover target" }) }));
    ...
    describe('Hover Behavior', () => {
        it('shows preview after hover delay', async () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 500, children: _jsx("span", { children: "Hover target" }) }));
        ...
        it('hides preview when mouse leaves', async () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 200, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            fireEvent.mouseEnter(trigger);
    ...
    describe('Preview Content', () => {
        it('displays file information in preview', async () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 100, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            fireEvent.mouseEnter(trigger);
    ...
    describe('Performance', () => {
        it('debounces hover events', () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 300, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            // Rapid hover events
            fireEvent.mouseEnter(trigger);
            fireEvent.mouseLeave(trigger);
        ...
        it('cleans up timers on unmount', () => {
            const { unmount } = render(_jsx(HoverPreview, { file: mockFile, delay: 500, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            fireEvent.mouseEnter(trigger);
    ...
    describe('Error Handling', () => {
        ...
        it('handles missing file metadata gracefully', async () => {
            ...
            render(_jsx(HoverPreview, { file: fileWithoutMetadata, delay: 100, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            fireEvent.mouseEnter(trigger);
            jest.advanceTimersByTime(100);
            await waitFor(() => {
    ...
    describe('Accessibility', () => {
        ...
        it('supports focus events for keyboard users', async () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 100, children: _jsx("span", { tabIndex: 0, children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
    ...
    describe('Custom Delay', () => {
        it('respects custom delay prop', async () => {
            render(_jsx(HoverPreview, { file: mockFile, delay: 1000, children: _jsx("span", { children: "Hover target" }) }));
            const trigger = screen.getByText('Hover target');
            fireEvent.mouseEnter(trigger);
