...
export const BulkClassificationTools = ({ dataElements, classificationRules = [], onBulkClassification, onValidationResults, context }) => {
    ...
    return (_jsxs("div", { className: "bulk-classification-tools bg-white border border-gray-200 rounded-lg p-6 shadow-sm", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2", children: "Bulk Classification Tools" }), _jsx("p", { className: "text-sm text-gray-600", children: "Efficiently classify multiple data elements using templates, rules, or manual assignment" })] }), _jsxs("div", { className: "mb-6 grid grid-cols-3 gap-4", children: [_jsxs("div", { className: "p-4 bg-blue-50 rounded-lg", children: [_jsx("h4", { className: "font-medium text-blue-900", children: "Total Elements" }), _jsx("p", { className: "text-2xl font-bold text-blue-700", children: dataElements.length })] }), _jsxs("div", { className: "p-4 bg-yellow-50 rounded-lg", children: [_jsx("h4", { className: "font-medium text-yellow-900", children: "Unclassified" }), _jsx("p", { className: "text-2xl font-bold text-yellow-700", children: categorizedElements.unclassified.length })] }), _jsxs("div", { className: "p-4 bg-green-50 rounded-lg", children: [_jsx("h4", { className: "font-medium text-green-900", children: "Selected" }), _jsx("p", { className: "text-2xl font-bold text-green-700", children: state.selectedElements.size })] })] }), _jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-3", children: "Classification Method" }), _jsx("div", { className: "grid grid-cols-2 gap-3", children: [
                        ...
                        ].map(method => (_jsxs("button", { type: "button", onClick: () => setState(prev => ({ ...prev, operationType: method.value })), className: `p-3 text-left border-2 rounded-lg transition-colors ${state.operationType === method.value
                                ? 'border-blue-500 bg-blue-50 text-blue-700'
                                : 'border-gray-200 hover:border-gray-300'}`, children: [_jsx("div", { className: "font-medium", children: method.label }), _jsx("div", { className: "text-xs text-gray-600 mt-1", children: method.desc })] }, method.value))) })] }), state.operationType === 'manual' && (_jsxs("div", { className: "mb-6 p-4 bg-gray-50 rounded-lg", children: [_jsx("h4", { className: "font-medium text-gray-900 mb-3", children: "Manual Classification" }), _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Classification Level" }), _jsxs("select", { value: state.manualClassification || '', onChange: (e) => setState(prev => ({ ...prev, manualClassification: e.target.value })), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500", children: [_jsx("option", { value: "", children: "Select classification..." }), CLASSIFICATION_LEVELS.map(level => (_jsx("option", { value: level, children: level }, level)))] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Rationale" }), _jsx("textarea", { value: state.rationale, onChange: (e) => setState(prev => ({ ...prev, rationale: e.target.value })), placeholder: "Explain why this classification is appropriate...", className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500", rows: 2 })] })] })] })), state.operationType === 'template' && (_jsxs("div", { className: "mb-6 p-4 bg-gray-50 rounded-lg", children: [_jsx("h4", { className: "font-medium text-gray-900 mb-3", children: "Template Selection" }), _jsx("div", { className: "grid grid-cols-1 gap-2", children: templates.map(template => (_jsx("button", { type: "button", onClick: () => setState(prev => ({ ...prev, selectedTemplate: template })), className: `p-3 text-left border rounded-lg transition-colors ${state.selectedTemplate?.id === template.id
                                ? 'border-blue-500 bg-blue-50'
                                : 'border-gray-200 hover:border-gray-300'}`, children: _jsxs("div", { className: "flex justify-between items-center", children: [_jsxs("div", { children: [_jsx("div", { className: "font-medium", children: template.name }), _jsx("div", { className: "text-sm text-gray-600", children: template.description })] }), _jsx("span", { className: `px-2 py-1 rounded text-xs font-medium ${template.classification === 'PUBLIC' ? 'bg-green-100 text-green-800' :
                                            template.classification === 'INTERNAL' ? 'bg-blue-100 text-blue-800' :
                                                template.classification === 'CONFIDENTIAL' ? 'bg-yellow-100 text-yellow-800' :
                                                    'bg-red-100 text-red-800'}`, children: template.classification })] }) }, template.id))) })] })), _jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Data Owner" }), _jsx("input", { type: "text", value: state.dataOwner, onChange: (e) => setState(prev => ({ ...prev, dataOwner: e.target.value })), placeholder: "Enter data owner name or role", className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" })] }), _jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-3", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Select Data Elements" }), _jsxs("div", { className: "space-x-2", children: [_jsx("button", { type: "button", onClick: () => handleSelectAll(categorizedElements.unclassified.map(el => el.id)), className: "text-sm text-blue-600 hover:text-blue-700", children: "Select Unclassified" }), _jsx("button", { type: "button", onClick: () => handleSelectAll(dataElements.map(el => el.id)), className: "text-sm text-blue-600 hover:text-blue-700", children: "Select All" }), _jsx("button", { type: "button", onClick: handleDeselectAll, className: "text-sm text-gray-600 hover:text-gray-700", children: "Deselect All" })] })] }), _jsx("div", { className: "border border-gray-200 rounded-lg max-h-64 overflow-y-auto", children: dataElements.map(element => {
                            const isSelected = state.selectedElements.has(element.id);
                            const suggestion = suggestions.get(element.id);
                            return (_jsx("div", { className: `p-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 ${isSelected ? 'bg-blue-50' : ''}`, children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", checked: isSelected, onChange: (e) => handleElementSelection(element.id, e.target.checked), className: "h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" }), _jsxs("div", { children: [_jsx("div", { className: "font-medium text-sm", children: element.name }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Type: ", element.type, " | ID: ", element.id] }), suggestion && (_jsxs("div", { className: "text-xs text-blue-600 mt-1", children: ["Suggested: ", suggestion.classification, " (", suggestion.confidence, "%)"] }))] })] }), _jsx("div", { className: "flex items-center space-x-2", children: element.existingClassification && (_jsx("span", { className: `px-2 py-1 rounded text-xs font-medium ${element.existingClassification.classification === 'PUBLIC' ? 'bg-green-100 text-green-800' :
                                                    element.existingClassification.classification === 'INTERNAL' ? 'bg-blue-100 text-blue-800' :
                                                        element.existingClassification.classification === 'CONFIDENTIAL' ? 'bg-yellow-100 text-yellow-800' :
                                                            'bg-red-100 text-red-800'}`, children: element.existingClassification.classification })) })] }) }, element.id));
                        }) })] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("div", { className: "space-x-3", children: state.selectedElements.size > 0 && (_jsxs("button", { type: "button", onClick: () => setShowPreview(!showPreview), className: "px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50", children: [showPreview ? 'Hide' : 'Show', " Preview (", state.selectedElements.size, " items)"] })) }), _jsx("div", { className: "space-x-3", children: _jsx("button", { type: "button", disabled: state.selectedElements.size === 0 || state.processing, onClick: handleApplyClassifications, className: "px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed", children: state.processing ? 'Processing...' : 'Apply Classifications' }) })] }), showPreview && state.selectedElements.size > 0 && (_jsxs("div", { className: "mt-6 border border-gray-200 rounded-lg", children: [_jsx("div", { className: "px-4 py-3 bg-gray-50 border-b border-gray-200", children: _jsx("h4", { className: "font-medium text-gray-900", children: "Classification Preview" }) }), _jsx("div", { className: "max-h-48 overflow-y-auto", children: generatePreview().map((classification, index) => (_jsx("div", { className: "p-3 border-b border-gray-100 last:border-b-0", children: _jsxs("div", { className: "flex justify-between items-center", children: [_jsxs("div", { children: [_jsx("div", { className: "font-medium text-sm", children: classification.dataElement }), _jsx("div", { className: "text-xs text-gray-600", children: classification.rationale })] }), _jsx("span", { className: `px-2 py-1 rounded text-xs font-medium ${classification.classification === 'PUBLIC' ? 'bg-green-100 text-green-800' :
                                            classification.classification === 'INTERNAL' ? 'bg-blue-100 text-blue-800' :
                                                classification.classification === 'CONFIDENTIAL' ? 'bg-yellow-100 text-yellow-800' :
                                                    'bg-red-100 text-red-800'}`, children: classification.classification })] }) }, index))) })] }))] }));
};
