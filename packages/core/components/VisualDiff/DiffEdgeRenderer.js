...
export const DiffEdgeRenderer = memo(({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, selected }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("defs", { children: _jsx("marker", { id: `arrow-${diffState || 'unchanged'}`, markerWidth: "12", markerHeight: "12", refX: "9", refY: "3", orient: "auto", markerUnits: "strokeWidth", children: _jsx("path", { d: "M0,0 L0,6 L9,3 z", fill: selected ? '#3b82f6' : getEdgeStyle().stroke }) }) }), _jsx("path", { id: id, d: edgePath, style: getEdgeStyle(), fill: "none", markerEnd: getMarkerEnd() }), label && (_jsxs("g", { transform: `translate(${labelX}, ${labelY})`, children: [_jsx("rect", { x: "-25", y: "-10", width: "50", height: "20", rx: "10", fill: "white", stroke: getEdgeStyle().stroke, strokeWidth: "1" }), _jsx("text", { x: "0", y: "0", textAnchor: "middle", dominantBaseline: "middle", style: {
                            fontSize: '10px',
                            fontWeight: '500',
                            fill: getEdgeStyle().stroke
                        }, children: label })] })), diffState === 'modified' && changeDetails && Object.keys(changeDetails).length > 0 && (_jsxs("g", { transform: `translate(${labelX}, ${labelY - 20})`, children: [_jsx("circle", { r: "4", fill: "#f59e0b", stroke: "white", strokeWidth: "1" }), _jsx("text", { x: "0", y: "1", textAnchor: "middle", dominantBaseline: "middle", style: {
                            fontSize: '8px',
                            fontWeight: 'bold',
                            fill: 'white'
                        }, children: "!" })] }))] }));
