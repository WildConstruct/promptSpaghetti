...
export const DirectorPreviewToolbar = ({ nodes, edges, isPreviewOpen, onPreviewToggle, onHighlightPath, className = '', compactMode = false }) => {
    ...
    return (_jsxs("div", { className: `director-preview-toolbar ${className}`, children: [_jsxs("div", { className: `toolbar-main ${compactMode ? 'compact' : 'expanded'}`, children: [_jsxs("div", { className: "toolbar-section preview-controls", children: [_jsxs("div", { className: "section-title", children: [_jsx("span", { className: "section-icon", children: "\uD83C\uDFAC" }), _jsx("span", { className: "section-label", children: "Director Preview" })] }), _jsxs("div", { className: "controls-row", children: [_jsxs("button", { className: `preview-btn ${isPreviewOpen ? 'active' : ''}`, onClick: onPreviewToggle, title: "Toggle Preview Modal", children: [_jsx("span", { className: "btn-icon", children: "\uD83D\uDCFA" }), _jsx("span", { className: "btn-label", children: "Preview" })] }), _jsxs("label", { className: "toggle-control", children: [_jsx("input", { type: "checkbox", checked: realTimeEnabled, onChange: (e) => setRealTimeEnabled(e.target.checked) }), _jsx("span", { className: "toggle-slider" }), _jsx("span", { className: "toggle-label", children: "Live" })] }), _jsxs("div", { className: "count-selector", children: [_jsx("label", { htmlFor: "preview-count", children: "Variants:" }), _jsxs("select", { id: "preview-count", value: previewCount, onChange: (e) => setPreviewCount(Number(e.target.value)), className: "count-select", children: [_jsx("option", { value: 1, children: "1" }), _jsx("option", { value: 2, children: "2" }), _jsx("option", { value: 3, children: "3" }), _jsx("option", { value: 5, children: "5" }), _jsx("option", { value: 8, children: "8" })] })] })] })] }), _jsxs("div", { className: "toolbar-section performance-metrics", children: [_jsxs("div", { className: "section-title", children: [_jsx("span", { className: "section-icon", children: "\u26A1" }), _jsx("span", { className: "section-label", children: "Performance" })] }), _jsxs("div", { className: "metrics-row", children: [_jsxs("div", { className: "metric", children: [_jsx("span", { className: "metric-value", children: graphMetrics.nodeCount }), _jsx("span", { className: "metric-label", children: "Nodes" })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { className: "metric-value", children: graphMetrics.edgeCount }), _jsx("span", { className: "metric-label", children: "Edges" })] }), _jsxs("div", { className: "metric", children: [_jsxs("span", { className: "metric-value", style: { color: getPerformanceColor(graphMetrics.estimatedTime) }, children: [graphMetrics.estimatedTime, "ms"] }), _jsx("span", { className: "metric-label", children: "Est. Time" })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { className: "metric-value", children: currentVariants.length }), _jsx("span", { className: "metric-label", children: "Ready" })] })] })] }), !compactMode && (_jsxs("div", { className: "toolbar-section advanced-settings", children: [_jsxs("div", { className: "section-title", children: [_jsx("span", { className: "section-icon", children: "\u2699\uFE0F" }), _jsx("span", { className: "section-label", children: "Settings" })] }), _jsxs("div", { className: "settings-row", children: [_jsxs("label", { className: "setting-control", children: [_jsx("input", { type: "checkbox", checked: autoRefresh, onChange: (e) => setAutoRefresh(e.target.checked) }), _jsx("span", { children: "Auto-refresh" })] }), _jsxs("label", { className: "setting-control", children: [_jsx("input", { type: "checkbox", checked: showVarianceAnalysis, onChange: (e) => setShowVarianceAnalysis(e.target.checked) }), _jsx("span", { children: "Variance Analysis" })] }), _jsxs("button", { onClick: () => {
                                        ...
                                        }, className: "setting-control", style: {
                                            display: 'flex',
                                            alignItems: 'center',
                                            gap: '6px',
                                            padding: '6px 10px',
                                        ...
                                        }, title: "Open Advanced Settings (Alt+S)", children: [_jsx("span", { children: "\u2699\uFE0F" }), _jsx("span", { children: "Advanced" })] })] })] })), lastError && (_jsx("div", { className: "toolbar-section error-section", children: _jsxs("div", { className: "error-display", children: [_jsx("span", { className: "error-icon", children: "\u26A0\uFE0F" }), _jsx("span", { className: "error-text", children: lastError }), _jsx("button", { className: "error-dismiss", onClick: () => setLastError(null), children: "\u00D7" })] }) }))] }), realTimeEnabled && (_jsx(RealTimePreviewIntegration, { nodes: nodes, edges: edges, enableRealTime: realTimeEnabled, previewCount: previewCount, autoRefresh: autoRefresh, showVarianceAnalysis: showVarianceAnalysis, onPreviewUpdate: handlePreviewUpdate, onHighlightPath: onHighlightPath, onError: handlePreviewError })), _jsx("style", { jsx: true, children: `
