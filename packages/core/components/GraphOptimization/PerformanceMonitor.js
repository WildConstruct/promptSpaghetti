...
export const PerformanceMonitor = ({ isVisible, onToggle, onMetricsCollected }) => {
    ...
    if (!isVisible) {
        return (_jsx("div", { onClick: onToggle, style: {
                position: 'fixed',
                bottom: '20px',
                right: '20px',
                width: '60px',
    ...
    return (_jsxs("div", { style: {
            ...
            overflow: 'hidden',
                    ...
                    borderBottom: '1px solid #e9ecef',
                            ...
                            color: performanceStatus.color,
                            fontWeight: '500',
                        }, children: [performanceStatus.label, " Performance"] })] }), _jsxs("div", { style: {
                    padding: '16px',
                    display: 'grid',
                    ...
                    fontSize: '13px',
                            ...
                            textAlign: 'center',
                                    ...
                                    borderRadius: '50%',
                                    margin: '0 auto',
                                } })] })] }), stats.recentMetrics.length > 0 && (_jsxs("div", { style: {
                    padding: '16px',
                    borderTop: '1px solid #e9ecef',
                            ...
                            color: '#495057',
                            marginBottom: '12px',
                        }, children: "Recent Executions" }), _jsx("div", { style: {
                            display: 'flex',
                            flexDirection: 'column',
                            gap: '4px',
                            maxHeight: '120px',
                            overflowY: 'auto',
                        }, children: stats.recentMetrics.slice(-6).reverse().map((metric, index) => (_jsxs("div", { style: {
                                display: 'flex',
                                justifyContent: 'space-between',
                                alignItems: 'center',
                                padding: '6px 0',
                            ...
                            }, children: [_jsx("div", { children: new Date(metric.timestamp).toLocaleTimeString() }), _jsx("div", { style: {
                                        color: metric.duration < 100 ? '#28a745' :
                                            metric.duration < 300 ? '#ffc107' : '#dc3545',
                                        fontWeight: '500',
                                    }, children: formatDuration(metric.duration) })] }, metric.timestamp))) })] })), _jsxs("div", { style: {
                    padding: '12px 16px',
                    backgroundColor: '#f8f9fa',
                    borderTop: '1px solid #e9ecef',
                    display: 'flex',
                    gap: '8px',
                            ...
                            fontSize: '12px',
                            cursor: 'pointer',
                        }, children: "Clear History" }), _jsx("button", { onClick: () => {
