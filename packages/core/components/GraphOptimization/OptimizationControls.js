...
export const OptimizationControls = ({ settings, onSettingsChange, isOpen, onClose }) => {
    ...
    return (_jsx("div", { style: {
            ...
            zIndex: 1000,
                ...
                boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)',
                        ...
                        fontSize: '14px',
                        color: '#856404',
                    }, children: ["\u26A0\uFE0F ", _jsx("strong", { children: "Note:" }), " Experimental features may affect graph execution behavior. Enable them only if you understand the implications."] }), _jsx("div", { style: {
                        display: 'grid',
                        gap: '16px',
                        marginBottom: '24px',
                    }, children: optimizationFeatures.map((feature) => (_jsx("div", { style: {
                            padding: '16px',
                            ...
                            backgroundColor: localSettings[feature.key] ? '#f8f9fa' : 'white',
                                ...
                                marginBottom: '8px',
                                                        ...
                                                        fontWeight: '600',
                                                        color: '#333',
                                                    }, children: feature.title }), feature.experimental && (_jsx("span", { style: {
                                                        padding: '2px 6px',
                                                    ...
                                                    }, children: "Experimental" })), feature.recommended && (_jsx("span", { style: {
                                                        padding: '2px 6px',
                                                        ...
                                                        fontWeight: '500',
                                                        textTransform: 'uppercase',
                                                    }, children: "Recommended" }))] }), _jsx("p", { style: {
                                                margin: '0 0 8px 0',
                                                fontSize: '14px',
                                                color: '#6c757d',
                                                lineHeight: 1.4,
                        ...
                        marginBottom: '24px',
                                ...
                                fontSize: '14px',
                                color: '#0066cc',
                            }, children: "\uD83D\uDCC8 Current Configuration Impact" }), _jsx("div", { style: {
                                fontSize: '13px',
                                color: '#0066cc',
                                lineHeight: 1.5,
                            }, children: (() => {
                                ...
                                return (_jsxs(_Fragment, { children: [_jsxs("div", { children: ["\u2022 ", highImpact, " high-impact optimization", highImpact !== 1 ? 's' : '', " enabled"] }), _jsxs("div", { children: ["\u2022 ", mediumImpact, " medium-impact optimization", mediumImpact !== 1 ? 's' : '', " enabled"] }), _jsxs("div", { children: ["\u2022 Expected performance improvement: ", highImpact * 30 + mediumImpact * 15, "%"] })] }));
                            })() })] }), _jsxs("div", { style: {
                        display: 'flex',
                        gap: '12px',
                        justifyContent: 'flex-end',
                                ...
                                cursor: 'pointer',
                                fontSize: '14px',
                            }, children: "Reset to Defaults" }), _jsx("button", { onClick: handleCancel, style: {
                                padding: '10px 20px',
                                ...
                                cursor: 'pointer',
                                fontSize: '14px',
                            }, children: "Cancel" }), _jsx("button", { onClick: handleApplyChanges, disabled: !hasChanges, style: {
                                padding: '10px 20px',
                                border: 'none',
