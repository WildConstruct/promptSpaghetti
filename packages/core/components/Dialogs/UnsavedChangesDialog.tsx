...
interface UnsavedChangesDialogProps { isOpen: boolean;
  projectName?: string;
  onSave: () => void
  onDontSave: () => void;
  onCancel: () => void;
  ...
  const saveButtonStyle: React.CSSProperties = { ...buttonBaseStyle,
  backgroundColor: '#3b82f6',
  color: 'white' }
};
  const dontSaveButtonStyle: React.CSSProperties = { ...buttonBaseStyle,
  backgroundColor: '#dc2626',
  color: 'white' }
};
  const cancelButtonStyle: React.CSSProperties = { ...buttonBaseStyle,
