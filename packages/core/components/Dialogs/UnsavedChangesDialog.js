...
export const UnsavedChangesDialog = ({ isOpen, projectName, onSave, onDontSave, onCancel, actionDescription = "continuing" }) => {
    if (!isOpen)
        return null;
    const overlayStyle = {
        position: 'fixed',
