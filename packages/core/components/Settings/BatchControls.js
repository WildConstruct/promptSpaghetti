 ...
 */
export const BatchControls = ({ settings, onChange }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: '16px'
                            ...
                            color: uiColors.text.primary,
                            marginBottom: '8px'
                        }, children: "Output Format" }), _jsx("div", { style: {
                            display: 'grid',
                            ...
                            return (_jsxs("button", { onClick: () => handleOutputFormatChange(format.value), style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '8px',
                                    padding: '10px 12px',
                                    ...
                                    if (!isSelected) {
                                        e.currentTarget.style.backgroundColor = uiColors.ui.hover;
                                ...
                                }, children: [_jsx(Icon, { size: 16, color: isSelected ? uiColors.accent.primary : uiColors.text.secondary }), _jsxs("div", { children: [_jsx("div", { style: {
                                                    fontSize: '13px',
                                                    fontWeight: 500,
                                                ...
                                                }, children: format.description })] })] }, format.value));
                            ...
                            fontSize: '11px',
                            color: uiColors.text.secondary
                        }, children: [_jsx("strong", { children: "Preview:" }), " ", getSampleFilename(), ".txt"] })] }), _jsx("div", { style: { marginBottom: '20px' }, children: _jsxs("div", { style: {
                        display: 'flex',
                        ...
                        gap: '12px'
                                ...
                                marginLeft: '24px',
                                marginTop: '-8px'
                            }, children: "Automatically trigger download when batch processing completes" })] }) }), _jsxs("div", { style: {
                    padding: '12px',
                    backgroundColor: uiColors.ui.hover,
                    borderRadius: '6px',
                    border: `1px solid ${uiColors.ui.border}`
                            ...
                            fontWeight: 500,
                            color: uiColors.text.primary
                        }, children: [_jsx(FiDownload, { size: 14 }), "Batch Configuration Summary"] }), _jsxs("div", { style: {
                            display: 'grid',
