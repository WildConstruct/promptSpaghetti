 ...
 */
export const SeedControls = ({ settings, onChange }) => {
    const [tempSeedValue, setTempSeedValue] = useState(settings.value?.toString() || '');
    ...
    return (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsxs("div", { style: {
                    ...
                    marginBottom: '16px'
                        ...
                        }, children: "Seed Settings" })] }), _jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    gap: '12px',
                    marginBottom: '16px',
                    ...
                    border: `1px solid ${uiColors.ui.border}`
                            ...
                            fontSize: '14px',
                            fontWeight: 500
                        }, children: [_jsx("input", { type: "checkbox", checked: settings.enabled, onChange: (e) => handleEnabledChange(e.target.checked), style: { accentColor: uiColors.accent.primary } }), _jsx("span", { style: { color: uiColors.text.primary }, children: "Enable Deterministic Seed" })] }), _jsx("div", { style: {
                            fontSize: '12px',
                            color: uiColors.text.secondary,
                            marginLeft: 'auto'
                        }, children: settings.enabled ? (_jsxs("span", { style: { color: uiColors.accent.primary }, children: [_jsx(FiEye, { size: 12, style: { marginRight: '4px' } }), "Deterministic"] })) : (_jsxs("span", { children: [_jsx(FiEyeOff, { size: 12, style: { marginRight: '4px' } }), "Random"] })) })] }), settings.enabled && (_jsxs("div", { style: { marginLeft: '20px' }, children: [_jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("label", { style: {
                                    display: 'block',
                                    fontSize: '13px',
                                    fontWeight: 500,
                                    color: uiColors.text.primary,
                                    marginBottom: '6px'
                                }, children: "Seed Value" }), _jsxs("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: [_jsx("input", { type: "number", value: tempSeedValue, onChange: (e) => handleSeedChange(e.target.value), placeholder: "Enter seed number", min: "0", style: {
                                            flex: 1,
                                            padding: '8px 12px',
                                            border: `1px solid ${uiColors.ui.border}`,
                                            borderRadius: '6px',
                                        ...
                                        }, children: [_jsx(FiRefreshCw, { size: 14 }), "Generate"] })] }), _jsx("div", { style: {
                                    fontSize: '11px',
                                    color: uiColors.text.secondary,
                                    marginTop: '4px'
                                }, children: "Same seed produces identical results across runs" })] }), _jsx("div", { style: { marginBottom: '16px' }, children: _jsxs("label", { style: {
                                display: 'flex',
                                alignItems: 'center',
                                gap: '8px',
                                cursor: 'pointer',
                                fontSize: '13px'
                            }, children: [_jsx("input", { type: "checkbox", checked: settings.autoGenerate, onChange: (e) => handleAutoGenerateChange(e.target.checked), style: { accentColor: uiColors.accent.primary } }), _jsx("span", { style: { color: uiColors.text.primary }, children: "Auto-generate new seed for each execution" })] }) }), settings.history && settings.history.length > 0 && (_jsxs("div", { children: [_jsxs("div", { style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    marginBottom: '8px'
                                            ...
                                            cursor: 'pointer',
                                            transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)'
                                        }, title: "Clear seed history", children: "Clear" })] }), _jsx("div", { style: {
                                    display: 'flex',
                                    flexWrap: 'wrap',
                                    gap: '6px'
                                }, children: settings.history.slice(0, 5).map((historySeed, index) => (_jsxs("button", { onClick: () => handleUseHistorySeed(historySeed), style: {
                                        padding: '4px 8px',
                                        ...
                                        cursor: 'pointer',
                                        transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)'
                                    }, title: `Use seed: ${historySeed}`, children: [historySeed.toString().slice(0, 8), "..."] }, index))) })] }))] }))] }));
};
