...
export const DataSourceConfigurationPanel = ({ visible, onClose, onSave, initialDataSources = [] }) => {
    ...
    const handleToggleSource = useCallback((sourceId) => {
        const updatedSources = dataSources.map(ds => ds.id === sourceId ? { ...ds, enabled: !ds.enabled } : ds);
        setDataSources(updatedSources);
        onSave(updatedSources);
    }, [dataSources, onSave]);
                ...
                overflow: 'hidden'
                        ...
                        flexDirection: 'column'
                                ...
                                alignItems: 'center'
                                        ...
                                        fontSize: 12,
                                        cursor: 'pointer'
                                    }, children: "+ Add New" })] }), _jsx("div", { style: { flex: 1, overflowY: 'auto', padding: 8 }, children: dataSources.map(source => (_jsxs("div", { style: {
                                    padding: 12,
                                    marginBottom: 8,
                                    ...
                                    borderRadius: 6,
                                    cursor: 'pointer'
                                }, onClick: () => setSelectedSourceId(source.id), children: [_jsxs("div", { style: {
                                            display: 'flex',
                                            justifyContent: 'space-between',
                                            ...
                                            gap: 4,
                                            marginBottom: 8
                                        }, children: [source.metadata.tags.slice(0, 3).map(tag => (_jsx("span", { style: {
                                                    background: '#4a5568',
                                                    color: '#e2e8f0',
                                                    padding: '2px 6px',
                                                    borderRadius: 3,
                                                    fontSize: 10
                                                }, children: tag }, tag))), source.metadata.tags.length > 3 && (_jsxs("span", { style: { color: '#a0aec0', fontSize: 10 }, children: ["+", source.metadata.tags.length - 3] }))] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: (e) => {
                                                    e.stopPropagation();
                                                    ...
                                                    fontSize: 10,
                                                    cursor: 'pointer'
                                                }, children: "Delete" })] })] }, source.id))) })] }), _jsxs("div", { style: { flex: 1, display: 'flex', flexDirection: 'column' }, children: [_jsxs("div", { style: {
                                padding: 16,
                                borderBottom: '1px solid #4a5568',
                                display: 'flex',
                                justifyContent: 'space-between',
                                alignItems: 'center'
                            }, children: [_jsx("h2", { style: { color: '#e2e8f0', margin: 0, fontSize: 20 }, children: "External Data Sources Configuration" }), _jsx("button", { onClick: onClose, style: {
                                        padding: '8px 16px',
                                        background: '#4a5568',
                                        border: 'none',
                                        borderRadius: 4,
                                        ...
                                        fontSize: 14,
                                        cursor: 'pointer'
                                    }, children: "Close" })] }), _jsx("div", { style: { flex: 1, overflow: 'hidden' }, children: showForm && editingSource ? (_jsx(DataSourceForm, { source: editingSource, onUpdate: updateEditingSource, onSave: handleSaveSource, onCancel: () => {
                                    setShowForm(false);
                                    setEditingSource(null);
                                }, onAddTag: addTag, onRemoveTag: removeTag })) : selectedSource ? (_jsx(DataSourceDetails, { source: selectedSource, onEdit: () => handleEditSource(selectedSource) })) : (_jsx("div", { style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    height: '100%',
                                    color: '#a0aec0',
                                    fontSize: 16
                                }, children: "Select a data source to view details or click \"Add New\" to create one" })) })] })] }) }));
};
// Data Source Form Component
const DataSourceForm = ({ source, onUpdate, onSave, onCancel, onAddTag, onRemoveTag }) => {
    ...
    return (_jsx("div", { style: { height: '100%', overflowY: 'auto', padding: 24 }, children: _jsxs("div", { style: { maxWidth: 800 }, children: [_jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("h3", { style: { color: '#e2e8f0', marginBottom: 16, fontSize: 16 }, children: "Basic Information" }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', color: '#a0aec0', fontSize: 12, marginBottom: 4 }, children: "Name *" }), _jsx("input", { type: "text", value: source.name, onChange: (e) => onUpdate({ name: e.target.value }), style: {
                                        ...
                                        fontSize: 14,
                                        resize: 'vertical'
                                    }, placeholder: "Describe this data source..." })] }), source.type === 'api' && (_jsxs("div", { children: [_jsx("label", { style: { display: 'block', color: '#a0aec0', fontSize: 12, marginBottom: 4 }, children: "API Endpoint *" }), _jsx("input", { type: "url", value: source.endpoint || '', onChange: (e) => onUpdate({ endpoint: e.target.value }), style: {
                                        width: '100%',
                                        padding: 8,
                                        background: '#1a202c',
                                        border: '1px solid #4a5568',
                                        ...
                                        color: '#e2e8f0',
                                        fontSize: 14
                                    }, placeholder: "https://api.example.com/v1" })] }))] }), _jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("h3", { style: { color: '#e2e8f0', marginBottom: 16, fontSize: 16 }, children: "Tags" }), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 12 }, children: source.metadata.tags.map(tag => (_jsxs("span", { style: {
                                    background: '#4a5568',
                                    color: '#e2e8f0',
                                    padding: '4px 8px',
                                    borderRadius: 4,
                                    ...
                                    alignItems: 'center',
                                    gap: 4
                                }, children: [tag, _jsx("button", { onClick: () => onRemoveTag(tag), style: {
                                            background: 'none',
                                            border: 'none',
                                            color: '#f56565',
                                            cursor: 'pointer',
                                            fontSize: 12,
                                            padding: 0
                                        }, children: "\u00D7" })] }, tag))) }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx("input", { type: "text", value: newTag, onChange: (e) => setNewTag(e.target.value), onKeyDown: (e) => e.key === 'Enter' && handleTagAdd(), placeholder: "Add tag...", style: {
                                        flex: 1,
                                        padding: 6,
                                        background: '#1a202c',
                                        border: '1px solid #4a5568',
...
const DataSourceDetails = ({ source, onEdit }) => {
    return (_jsx("div", { style: { height: '100%', overflowY: 'auto', padding: 24 }, children: _jsxs("div", { style: { maxWidth: 800 }, children: [_jsxs("div", { style: {
                        display: 'flex',
                        justifyContent: 'space-between',
                        alignItems: 'flex-start',
                        marginBottom: 24
                                ...
                                fontSize: 14,
                                cursor: 'pointer'
                            }, children: "Edit" })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }, children: [_jsxs("div", { children: [_jsx("h4", { style: { color: '#e2e8f0', fontSize: 16, marginBottom: 12 }, children: "Connection" }), source.endpoint && (_jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: "Endpoint: " }), _jsx("span", { style: { color: '#e2e8f0', fontSize: 12, fontFamily: 'monospace' }, children: source.endpoint })] })), _jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: "Auth: " }), _jsx("span", { style: { color: '#e2e8f0', fontSize: 12 }, children: source.authentication?.type || 'None' })] })] }), _jsxs("div", { children: [_jsx("h4", { style: { color: '#e2e8f0', fontSize: 16, marginBottom: 12 }, children: "Caching" }), _jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: "Strategy: " }), _jsx("span", { style: { color: '#e2e8f0', fontSize: 12 }, children: source.caching.strategy })] }), _jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: "TTL: " }), _jsxs("span", { style: { color: '#e2e8f0', fontSize: 12 }, children: [source.caching.ttl, "s"] })] }), _jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("span", { style: { color: '#a0aec0', fontSize: 12 }, children: "Max Size: " }), _jsxs("span", { style: { color: '#e2e8f0', fontSize: 12 }, children: [source.caching.maxSize, "MB"] })] })] })] }), _jsxs("div", { style: { marginTop: 24 }, children: [_jsx("h4", { style: { color: '#e2e8f0', fontSize: 16, marginBottom: 12 }, children: "Tags" }), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8 }, children: source.metadata.tags.map(tag => (_jsx("span", { style: {
                                    background: '#4a5568',
                                    color: '#e2e8f0',
                                    padding: '4px 8px',
                                    borderRadius: 4,
                                    fontSize: 12
                                }, children: tag }, tag))) })] }), source.transforms.length > 0 && (_jsxs("div", { style: { marginTop: 24 }, children: [_jsxs("h4", { style: { color: '#e2e8f0', fontSize: 16, marginBottom: 12 }, children: ["Data Transforms (", source.transforms.length, ")"] }), _jsx("div", { style: { background: '#1a202c', padding: 16, borderRadius: 6 }, children: source.transforms.map((transform, index) => (_jsxs("div", { style: { marginBottom: index < source.transforms.length - 1 ? 12 : 0 }, children: [_jsxs("div", { style: { color: '#e2e8f0', fontSize: 14, marginBottom: 4 }, children: [transform.name, " (", transform.type, ")"] }), _jsx("div", { style: { color: '#a0aec0', fontSize: 12 }, children: transform.enabled ? 'Enabled' : 'Disabled' })] }, transform.id))) })] }))] }) }));
};
