...
export const effectiveLevel = nodeId ? getNodeDisclosureLevel(nodeId, nodeType) : globalDisclosureLevel;
...
if (compact) {
    return (_jsxs("div", { style: {
            ...
            fontSize: 11
                    ...
                    fontSize: 10,
                    cursor: 'pointer'
                }, children: DISCLOSURE_LEVELS.map(option => (_jsx("option", { value: option.value, children: option.label.split(' - ')[0] }, option.value))) })] }));
}
return (_jsx("div", { style: { marginBottom: 16 }, children: _jsxs("div", { style: {
            ...
            padding: 12
                    ...
                    gap: 8
                            ...
                            fontSize: 11,
                            cursor: 'pointer'
                        }, children: DISCLOSURE_LEVELS.map(option => (_jsx("option", { value: option.value, children: option.label }, option.value))) })] }), _jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("label", { style: {
                            display: 'block',
                            fontSize: 11,
                            color: '#a0aec0',
                            marginBottom: 4,
                            ...
                            fontSize: 11,
                            cursor: 'pointer'
                        }, children: INHERITANCE_MODES.map(option => (_jsx("option", { value: option.value, children: option.label }, option.value))) }), _jsxs("div", { style: {
                            fontSize: 10,
                            color: '#6b7280',
                            marginTop: 2,
                            lineHeight: 1.4
                        }, children: [preferenceInheritance === 'global' && 'All nodes use the global default level', preferenceInheritance === 'nodeType' && 'Nodes inherit from their type-specific preferences', preferenceInheritance === 'individual' && 'Each node can have its own disclosure level'] })] }), showNodeSpecificControls && nodeId && (_jsxs("div", { style: {
                    ...
                    marginTop: 12
                            ...
                            color: '#e2e8f0',
                            marginBottom: 8
                        }, children: ["This Node (", nodeType || 'unknown', ")"] }), nodePrefs && (_jsx("div", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 8,
                            marginBottom: 8
                                ...
                                cursor: 'pointer'
                                        ...
                                        height: 12,
                                        cursor: 'pointer'
                                    } }), "Use global default"] }) })), !nodePrefs?.useGlobalDefault && (_jsxs("div", { style: { marginBottom: 8 }, children: [_jsx("label", { style: {
                                    display: 'block',
                                    fontSize: 10,
                                    color: '#a0aec0',
                                    marginBottom: 4
                                }, children: "Node-specific level" }), _jsx("select", { value: effectiveLevel, onChange: (e) => handleNodeLevelChange(e.target.value), style: {
                                    width: '100%',
                                    padding: '4px 6px',
                                    background: '#2d3748',
                                    color: '#e2e8f0',
                                    ...
                                    fontSize: 10,
                                    cursor: 'pointer'
                                }, children: DISCLOSURE_LEVELS.map(option => (_jsx("option", { value: option.value, children: option.label }, option.value))) })] }))] })), _jsxs("div", { style: {
                    display: 'flex',
