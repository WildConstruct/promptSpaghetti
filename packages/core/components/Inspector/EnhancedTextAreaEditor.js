...
export const EnhancedTextAreaEditor = ({ label, value, fieldKey, error, onChange, placeholder, disabled = false, rows = 4, maxLength, minLength, autoResize = false, showWordCount = false, enableInlineCorrections = true, autoApplyCorrections = false, showCorrectionHighlights = true, }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: 16, position: 'relative' }, children: [_jsxs("label", { htmlFor: inputId, style: labelStyle, children: [label, error && (_jsx("span", { style: { color: '#f56565', marginLeft: 4, fontSize: 10 }, children: "*" })), suggestions.length > 0 && enableInlineCorrections && (_jsxs("span", { style: { color: '#fbb040', marginLeft: 8, fontSize: 10 }, children: [suggestions.length, " correction", suggestions.length !== 1 ? 's' : '', " available"] }))] }), _jsxs("div", { style: { position: 'relative' }, children: [_jsx("textarea", { ref: textareaRef, id: inputId, value: localValue, onChange: (e) => handleChange(e.target.value), onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), onSelect: handleCursorPositionChange, onKeyUp: handleCursorPositionChange, onKeyDown: handleKeyDown, placeholder: placeholder || `Enter ${label.toLowerCase()}...`, disabled: disabled, rows: autoResize ? undefined : rows, maxLength: maxLength, minLength: minLength, style: textareaStyle }), enableInlineCorrections && showSuggestions && suggestions.length > 0 && (_jsxs("div", { ref: suggestionsRef, style: suggestionStyle, children: [suggestions.slice(0, 5).map((suggestion) => (_jsxs("div", { style: {
                                    padding: '8px 12px',
