...
export const VariationList = ({ nodeId, variations, onAdd, onRemove, onUpdate, onReorder, maxVariations = 50, placeholder = 'Add a variation...', allowQuickEntry = true }) => {
    ...
    return (_jsxs("div", { style: { marginBottom: 16 }, children: [_jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    marginBottom: 12
                            ...
                            cursor: 'pointer',
                            color: '#6b7280'
                        }, title: "Quick entry (comma-separated)", children: quickEntryMode ? 'List' : 'Quick' }))] }), quickEntryMode ? (_jsxs("div", { style: { marginBottom: 12 }, children: [_jsx("textarea", { value: quickEntryText, onChange: (e) => setQuickEntryText(e.target.value), placeholder: "Enter variations separated by commas...", style: {
                            width: '100%',
                            height: 80,
                            padding: '8px 12px',
                            border: '1px solid #4a5568',
                            ...
                            marginTop: 8
                                ...
                                }, children: "Add All" }), _jsx("button", { onClick: () => {
                                    setQuickEntryMode(false);
                                    setQuickEntryText('');
                                }, style: {
                                    background: '#4a5568',
                                    ...
                                    color: '#e2e8f0',
                                    cursor: 'pointer'
                                }, children: "Cancel" })] })] })) : (_jsx(_Fragment, { children: _jsxs("div", { style: {
                        display: 'flex',
                        gap: 8,
                        marginBottom: 12
                    ...
                    background: '#2d3748'
                        ...
                        fontStyle: 'italic',
                        fontSize: 13
                    }, children: "No variations yet. Add some above." })) : (variations.map((variation, index) => (_jsxs("div", { draggable: true, onDragStart: (e) => handleDragStart(e, index), onDragOver: (e) => handleDragOver(e, index), onDrop: (e) => handleDrop(e, index), style: {
                        display: 'flex',
                        alignItems: 'center',
                        padding: '8px 12px',
                        ...
                        cursor: 'move'
                                ...
                                fontSize: 14,
                                outline: 'none'
                            } })) : (_jsx("span", { onClick: () => startEdit(index), style: {
                                flex: 1,
                                cursor: 'pointer',
                                fontSize: 14,
                                color: '#374151'
                            }, title: "Click to edit", children: variation })), _jsx("button", { onClick: () => handleRemove(index), style: {
                                background: 'none',
                                border: 'none',
                                color: '#ef4444',
                                cursor: 'pointer',
                                ...
                                marginLeft: 8,
                                padding: 4
                            }, title: "Remove variation", children: "\u00D7" })] }, index)))) }), variations.length >= maxVariations && (_jsxs("div", { style: {
                    marginTop: 8,
                    fontSize: 12,
                    color: '#ef4444',
                    textAlign: 'center'
