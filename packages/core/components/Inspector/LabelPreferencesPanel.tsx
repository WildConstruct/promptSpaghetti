...
interface LabelPreferencesPanelProps { onClose?: () => void;
  ...
  const handlePreferenceChange = useCallback((updates: Partial<NodeLabelPreferences>) => { setLabelPreferences(updates) }, [setLabelPreferences]);
