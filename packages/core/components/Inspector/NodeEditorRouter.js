...
export const NodeEditorRouter = ({ node, schema, onChange, onGlobalPreviewRequest }: { node: any, schema: any, onChange: (nodeId: string, data: any) => void, onGlobalPreviewRequest?: () => void }) => {
    if (!node || !schema) {
        return null;
    }
