...
export const VariableEditor = ({ _____nodeId, nodeData, onChange }) => {
    ...
    return (_jsxs("div", { className: "variable-editor", children: [_jsxs(ProgressiveDisclosureSection, { title: "Variable Settings", level: "basic", description: isSetVariable ? 'Define what value to store' : 'Retrieve stored values', defaultExpanded: true, priority: "critical", fieldName: isSetVariable ? 'value' : 'variableName', children: [wrapVariableNameHelp(_jsx(TextFieldEditor, { label: isSetVariable ? 'Store As' : 'Retrieve Variable', value: variableName || label, fieldKey: isSetVariable ? 'label' : 'variableName', zodType: null, onChange: (value) => handleFieldChange(isSetVariable ? 'label' : 'variableName', value), placeholder: isSetVariable ? 'Name for this stored value...' : 'Variable name to retrieve...' })), isSetVariable && wrapTemplateHelp(_jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("label", { style: {
                                ...
                                }, placeholder: "Enter value template... Use {variable} syntax for dynamic content.", showPreview: true, autoComplete: true, nodeType: "setVariable" }), _jsxs("div", { style: {
                                    fontSize: 10,
                                    color: '#a0aec0',
                                    marginTop: 4
                                }, children: ["Use natural language with ", '{variable}', " syntax. Variables become input ports."] }), nodeData.extractedVariables?.length > 0 && (_jsxs("div", { style: {
                                    fontSize: 10,
                                    color: '#4299e1',
                                    marginTop: 6,
                                    padding: 6,
                                ...
                                }, children: [_jsx("strong", { children: "\uD83E\uDD16 Auto-detected:" }), " ", ' ', nodeData.extractedVariables?.map((v, idx) => (_jsxs("span", { children: [v.name || 'variable', " (", v.inferredType || 'auto', ")", v.defaultValue && ` = "${v.defaultValue}"`, idx < nodeData.extractedVariables.length - 1 ? ', ' : ''] }, v.name || `var_${idx}`))) || 'No variables detected'] }))] })), isGetVariable && (_jsxs("div", { style: {
                            fontSize: 12,
                            color: '#a0aec0',
                            padding: 12,
                            background: 'rgba(66, 153, 225, 0.1)',
                            borderRadius: 6,
                            border: '1px solid rgba(66, 153, 225, 0.3)'
                        }, children: [_jsx("strong", { children: "\uD83D\uDCA1 Simplified Workflow:" }), " Variables are automatically managed by templates. This node retrieves values stored by template-based nodes."] }))] }), debugMode && (_jsxs(ProgressiveDisclosureSection, { title: "Advanced Settings", level: "advanced", description: "Technical configuration for developers", defaultExpanded: false, priority: "optional", fieldName: "variableType", children: [_jsx(TextFieldEditor, { label: "Technical Variable Name", value: variableName, fieldKey: "variableName", zodType: null, onChange: (value) => handleFieldChange('variableName', value), placeholder: "Internal variable identifier..." }), _jsx(SelectEditor, { label: "Variable Type", value: variableType, fieldKey: "variableType", options: VARIABLE_TYPES, zodType: null, onChange: (value) => handleFieldChange('variableType', value) }), isSetVariable && (_jsxs(_Fragment, { children: [_jsx("div", { style: { marginBottom: 16 }, children: _jsxs("label", { style: {
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 8,
                                        fontSize: 12,
                                        ...
                                        cursor: 'pointer'
                                                ...
                                                height: 14,
                                                cursor: 'pointer'
                                            } }), "Allow overwriting existing variable"] }) }), _jsx(SelectEditor, { label: "Scope", value: scope, fieldKey: "scope", options: SCOPE_OPTIONS, zodType: null, onChange: (value) => handleFieldChange('scope', value) })] })), isGetVariable && (_jsxs(_Fragment, { children: [_jsx("div", { style: { marginBottom: 16 }, children: _jsxs("label", { style: {
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 8,
                                        fontSize: 12,
                                        ...
                                        cursor: 'pointer'
                                                ...
                                                height: 14,
                                                cursor: 'pointer'
                                            } }), "Variable is required"] }) }), _jsx(TextFieldEditor, { label: "Default Value", value: defaultValue, fieldKey: "defaultValue", zodType: null, onChange: (value) => handleFieldChange('defaultValue', value), placeholder: "Fallback value if variable not found..." })] }))] }))] }));
};
