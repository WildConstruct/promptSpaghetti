...
export const LiveChatWidget = ({ element, interactiveService, userId, userName, userAvatar, isMinimized = false, onMinimize, onClose }) => {
    ...
    const renderMessage = useCallback((message) => {
        ...
        return (_jsxs("div", { className: `flex ${isOwn ? 'justify-end' : 'justify-start'} mb-4`, children: [!isOwn && !isSystem && (_jsx("div", { className: "flex-shrink-0 mr-3", children: message.userAvatar ? (_jsx("img", { src: message.userAvatar, alt: message.userName, className: "w-8 h-8 rounded-full" })) : (_jsx("div", { className: "w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-xs font-medium text-gray-600", children: message.userName.charAt(0).toUpperCase() }) })) })), _jsxs("div", { className: `max-w-xs lg:max-w-md ${isOwn ? 'order-first' : ''}`, children: [!isOwn && !isSystem && (_jsx("div", { className: "text-xs text-gray-500 mb-1", children: message.userName })), _jsx("div", { className: `rounded-lg px-4 py-2 ${isSystem
                                ? 'bg-gray-100 text-gray-700 text-center text-sm'
                                : isOwn
                                    ? 'bg-blue-600 text-white'
                                    : 'bg-gray-100 text-gray-900'}`, children: message.type === 'file' && message.attachments ? (_jsxs("div", { children: [_jsx("div", { className: "mb-2", children: message.message }), message.attachments.map(attachment => (_jsx("div", { className: "border border-gray-200 rounded p-2 bg-white", children: _jsxs("div", { className: "flex items-center space-x-2", children: [attachment.thumbnail ? (_jsx("img", { src: attachment.thumbnail, alt: attachment.name, className: "w-8 h-8 rounded" })) : (_jsx("div", { className: "w-8 h-8 bg-gray-200 rounded flex items-center justify-center", children: _jsx("svg", { className: "w-4 h-4 text-gray-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" }) }) })), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("div", { className: "text-sm font-medium text-gray-900 truncate", children: attachment.name }), _jsxs("div", { className: "text-xs text-gray-500", children: [(attachment.size / 1024).toFixed(1), " KB"] })] }), _jsx("a", { href: attachment.url, download: attachment.name, className: "text-blue-600 hover:text-blue-800 text-sm", children: "Download" })] }) }, attachment.id)))] })) : (_jsx("div", { className: "whitespace-pre-wrap", children: message.message })) }), _jsxs("div", { className: `text-xs text-gray-500 mt-1 ${isOwn ? 'text-right' : 'text-left'}`, children: [formatTimestamp(message.timestamp), message.edited && _jsx("span", { className: "ml-1", children: "(edited)" })] })] }), isOwn && (_jsx("div", { className: "flex-shrink-0 ml-3", children: userAvatar ? (_jsx("img", { src: userAvatar, alt: userName, className: "w-8 h-8 rounded-full" })) : (_jsx("div", { className: "w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-xs font-medium text-white", children: userName.charAt(0).toUpperCase() }) })) }))] }, message.id));
    ...
    if (isMinimized) {
        return (_jsx("div", { className: "fixed bottom-4 right-4 z-50", children: _jsxs("button", { onClick: onMinimize, className: "bg-blue-600 text-white rounded-full p-3 shadow-lg hover:bg-blue-700 transition-colors", children: [_jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" }) }), messages.length > 1 && (_jsx("div", { className: "absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center", children: messages.length - 1 }))] }) }));
    }
    return (_jsxs("div", { className: "fixed bottom-4 right-4 w-96 h-96 bg-white rounded-lg shadow-xl border border-gray-200 flex flex-col z-50", children: [_jsxs("div", { className: "flex items-center justify-between p-4 border-b border-gray-200 bg-blue-600 text-white rounded-t-lg", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: `w-3 h-3 rounded-full ${isConnected ? 'bg-green-400' : 'bg-red-400'}` }), _jsx("h3", { className: "font-medium", children: "Community Chat" }), _jsxs("span", { className: "text-xs opacity-75", children: ["(", onlineUsers.length, " online)"] })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("button", { onClick: onMinimize, className: "p-1 hover:bg-blue-700 rounded", title: "Minimize", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M20 12H4" }) }) }), _jsx("button", { onClick: onClose, className: "p-1 hover:bg-blue-700 rounded", title: "Close", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] })] }), _jsx("div", { className: "flex-1 overflow-y-auto p-4 space-y-4", children: !isConnected ? (_jsxs("div", { className: "text-center text-gray-500 py-8", children: [_jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-2" }), _jsx("div", { children: "Connecting to chat..." })] })) : (_jsxs(_Fragment, { children: [messages.map(renderMessage), renderTypingIndicator(), _jsx("div", { ref: messagesEndRef })] })) }), isConnected && (_jsx("div", { className: "border-t border-gray-200 p-4", children: _jsxs("div", { className: "flex items-end space-x-2", children: [_jsxs("div", { className: "flex-1", children: [_jsx("textarea", { value: currentMessage, onChange: handleMessageChange, onKeyPress: handleKeyPress, placeholder: "Type your message...", className: "w-full p-2 border border-gray-300 rounded-md resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent", rows: 2, disabled: !isConnected }), _jsxs("div", { className: "flex items-center justify-between mt-1", children: [_jsxs("span", { className: "text-xs text-gray-500", children: [currentMessage.length, "/", maxMessageLength] }), chatConfig.file_uploads && (_jsx("button", { onClick: () => fileInputRef.current?.click(), disabled: uploading, className: "text-gray-400 hover:text-gray-600 disabled:opacity-50", title: "Attach file", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" }) }) }))] })] }), _jsx("button", { onClick: handleSendMessage, disabled: !currentMessage.trim() || !isConnected || uploading, className: "px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed", children: uploading ? (_jsxs("svg", { className: "w-4 h-4 animate-spin", fill: "none", viewBox: "0 0 24 24", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })) : (_jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 19l9 2-9-18-9 18 9-2zm0 0v-8" }) })) })] }) })), _jsx("input", { ref: fileInputRef, type: "file", multiple: true, accept: "image/*,text/*,.pdf,.doc,.docx", onChange: (e) => e.target.files && handleFileUpload(e.target.files), className: "hidden" })] }));
};
