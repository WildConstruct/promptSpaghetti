...
const ScheduleListView = ({ schedules, onScheduleClick, onScheduleUpdate, loading }) => {
    const columns = [
        {
            title: 'Title',
            dataIndex: 'title',
