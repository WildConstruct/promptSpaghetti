        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-blue-900">
              {getLeaderboardTitle(activeTab, activeMetric)}
            </h3>
            <p className="text-sm text-blue-700">
              {leaderboard.totalEntries} entries • Updated {formatTimeAgo(lastRefresh)}
            </p>
          </div>
          <div className="text-right">
            <div className="text-2xl font-bold text-blue-900">
              {formatScore(leaderboard.metadata.topScore, activeMetric)}
            </div>
            <div className="text-sm text-blue-700">Top Score</div>
          </div>
        </div>
      </div>
    );
