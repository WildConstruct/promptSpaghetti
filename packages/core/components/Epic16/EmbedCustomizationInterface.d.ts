...
export interface CustomTheme { id: string;
    ...
    borderRadius: { small: number;
        medium: number;
        large: number };
    shadows: { small: string;
        medium: string;
        large: string };

export declare const PresetSelector: React.FC<{ presets: EmbedPreset[];
    selectedPreset?: string;
    onPresetSelect: (preset: EmbedPreset) => void }>;
export declare const VisualLayoutBuilder: React.FC<{ widgets: EmbedWidget[];
