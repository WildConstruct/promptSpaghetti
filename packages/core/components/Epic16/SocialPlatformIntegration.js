...
// Main component
export const SocialPlatformIntegration = ({ template, platforms = SOCIAL_PLATFORMS, trackingEnabled = true, onShareComplete, onAnalyticsUpdate, className = '', showAnalytics = true, customizations = {
    autoHashtags: true,
    customBranding: true,
    ...
    const handleBulkShare = useCallback(async () => {
        const sharePromises = selectedPlatforms.map(platformId => handleSingleShare(platformId).catch(err => ({ platformId, error: err })));
        await Promise.all(sharePromises);
    }, [selectedPlatforms, handleSingleShare]);
    const copyShareLink = useCallback(async () => {
        const shareUrl = `${window.location.origin}/templates/${template.id}${trackingEnabled ? '?utm_source=direct&utm_medium=link&utm_campaign=template_share' : ''}`;
        try {
    ...
    return (_jsxs("div", { className: `bg-white border border-gray-200 rounded-lg overflow-hidden ${className}`, children: [_jsx("div", { className: "border-b border-gray-200 p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(ShareIcon, { className: "h-6 w-6 text-blue-500" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Social Platform Integration" }), _jsxs("p", { className: "text-sm text-gray-600", children: ["Share \"", template.title, "\" across multiple platforms"] })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("button", { onClick: copyShareLink, className: "flex items-center gap-2 px-3 py-1 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded text-sm", children: [_jsx(LinkIcon, { className: "h-4 w-4" }), "Copy Link"] }), _jsxs("button", { onClick: () => setShowCustomization(!showCustomization), className: "flex items-center gap-2 px-3 py-1 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded text-sm", children: [_jsx(Cog6ToothIcon, { className: "h-4 w-4" }), "Customize"] })] })] }) }), showAnalytics && Object.keys(shareResults).length > 0 && (_jsxs("div", { className: "border-b border-gray-200 p-4 bg-blue-50", children: [_jsx("h4", { className: "font-medium text-gray-900 mb-3", children: "Share Performance" }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-blue-600", children: totalAnalytics.totalShares }), _jsx("div", { className: "text-xs text-gray-600", children: "Total Shares" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-green-600", children: totalAnalytics.successfulShares }), _jsx("div", { className: "text-xs text-gray-600", children: "Successful" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-purple-600", children: totalAnalytics.totalReach.toLocaleString() }), _jsx("div", { className: "text-xs text-gray-600", children: "Total Reach" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-orange-600", children: totalAnalytics.totalEngagements }), _jsx("div", { className: "text-xs text-gray-600", children: "Engagements" })] }), _jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "text-2xl font-bold text-indigo-600", children: [totalAnalytics.averageCTR.toFixed(1), "%"] }), _jsx("div", { className: "text-xs text-gray-600", children: "Avg CTR" })] })] })] })), _jsxs("div", { className: "p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Select Platforms" }), _jsxs("div", { className: "flex items-center gap-2 text-sm text-gray-600", children: [_jsxs("span", { children: [selectedPlatforms.length, " of ", enabledPlatforms.length, " selected"] }), selectedPlatforms.length > 0 && (_jsxs("button", { onClick: handleBulkShare, disabled: Object.values(isSharing).some(Boolean), className: "flex items-center gap-1 px-3 py-1 bg-blue-600 text-white hover:bg-blue-700 rounded disabled:opacity-50", children: [_jsx(RocketLaunchIcon, { className: "h-4 w-4" }), "Share All"] }))] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: enabledPlatforms.map(platform => {
                            ...
                            return (_jsxs("div", { className: `border rounded-lg p-4 cursor-pointer transition-all ${isSelected
                                    ...
                                    : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'}`, onClick: () => handlePlatformToggle(platform.id), children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "p-2 rounded-lg", style: { backgroundColor: `${platform.color}10`, color: platform.color }, children: _jsx(Icon, { className: "h-5 w-5" }) }), _jsxs("div", { children: [_jsx("div", { className: "font-medium text-gray-900", children: platform.displayName }), _jsx("div", { className: "text-xs text-gray-600", children: platform.description })] })] }), _jsx("input", { type: "checkbox", checked: isSelected, onChange: () => handlePlatformToggle(platform.id), className: "h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded", onClick: (e) => e.stopPropagation() })] }), shareResult && (_jsxs("div", { className: "mb-3 p-2 bg-gray-100 rounded text-xs", children: [_jsxs("div", { className: "flex items-center gap-2", children: [shareResult.success ? (_jsx(CheckIcon, { className: "h-3 w-3 text-green-600" })) : (_jsx(XMarkIcon, { className: "h-3 w-3 text-red-600" })), _jsx("span", { className: shareResult.success ? 'text-green-600' : 'text-red-600', children: shareResult.success ? 'Shared successfully' : 'Share failed' })] }), shareResult.success && (_jsxs("div", { className: "mt-1 grid grid-cols-3 gap-1 text-gray-600", children: [_jsxs("div", { children: [shareResult.analytics.views, " views"] }), _jsxs("div", { children: [shareResult.analytics.clicks, " clicks"] }), _jsxs("div", { children: [shareResult.analytics.engagements, " eng."] })] }))] })), isSelected && (_jsx("div", { className: "space-y-2", children: _jsx("button", { onClick: (e) => {
                                                e.stopPropagation();
                                                handleSingleShare(platform.id);
                                            }, disabled: isSharing, className: "w-full flex items-center justify-center gap-2 px-3 py-1 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded text-sm disabled:opacity-50", children: isSharing ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "animate-spin rounded-full h-3 w-3 border border-gray-400 border-t-transparent" }), "Sharing..."] })) : (_jsxs(_Fragment, { children: [_jsx(ShareIcon, { className: "h-3 w-3" }), "Share Now"] })) }) })), _jsxs("div", { className: "flex items-center gap-1 mt-2 text-xs text-gray-500", children: [platform.features.hashtags && _jsx(HashtagIcon, { className: "h-3 w-3" }), platform.features.mediaUpload && _jsx(PhotoIcon, { className: "h-3 w-3" }), platform.features.scheduledPosting && _jsx(CalendarIcon, { className: "h-3 w-3" }), platform.features.analytics && _jsx(ChartBarIcon, { className: "h-3 w-3" })] })] }, platform.id));
                        }) })] }), showCustomization && selectedPlatforms.length > 0 && (_jsxs("div", { className: "border-t border-gray-200 p-4 bg-gray-50", children: [_jsx("h4", { className: "font-medium text-gray-900 mb-4", children: "Customize Share Content" }), selectedPlatforms.map(platformId => {
                        const platform = platforms.find(p => p.id === platformId);
                        const content = shareContent[platformId];
                        if (!platform || !content)
                            return null;
                        return (_jsxs("div", { className: "mb-6 p-4 bg-white border border-gray-200 rounded-lg", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(platform.icon, { className: "h-4 w-4", style: { color: platform.color } }), _jsx("span", { className: "font-medium text-gray-900", children: platform.displayName })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Title" }), _jsx("input", { type: "text", value: content.title, onChange: (e) => handleContentChange(platformId, { title: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-md text-sm", maxLength: platform.limits.maxTextLength })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Description" }), _jsx("textarea", { value: content.description, onChange: (e) => handleContentChange(platformId, { description: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-md text-sm", rows: 3, maxLength: platform.limits.maxTextLength }), _jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [content.description.length, " / ", platform.limits.maxTextLength] })] })] }), platform.features.hashtags && (_jsxs("div", { className: "mt-4", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Hashtags" }), _jsx("input", { type: "text", value: content.hashtags.join(' '), onChange: (e) => handleContentChange(platformId, {
                                                hashtags: e.target.value.split(' ').filter(tag => tag.startsWith('#')).slice(0, platform.limits.maxHashtags)
                                            }), placeholder: "#AI #productivity #templates", className: "w-full px-3 py-2 border border-gray-300 rounded-md text-sm" }), _jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [content.hashtags.length, " / ", platform.limits.maxHashtags, " hashtags"] })] }))] }, platformId));
                    })] }))] }));
};
