...
export const ArticleEditor = ({ article, categories, onSave, onCancel, _____onUploadAttachment }) => {
...
export const ArticleManagement = ({ articles, categories, currentUser, onCreateArticle, onUpdateArticle, onDeleteArticle, _____onPublishArticle, _____onArchiveArticle, onDuplicateArticle, onUploadAttachment, _____onCreateCategory, _____onUpdateCategory, className = '' }) => {
