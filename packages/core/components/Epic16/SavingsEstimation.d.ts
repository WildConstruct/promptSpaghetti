...
interface SavingsBreakdown { tokenSavings: {
    ...
    timeSavings: { templateTimeSpent: number;
        manualTimeSpent: number;
        netTimeSavings: number;
        timeEfficiency: number };
    qualitySavings: { templateQualityValue: number;
        manualQualityValue: number;
        qualityImprovement: number };
    totalSavings: { monthlySavings: number;
        yearlySavings: number;
        totalProjectSavings: number;
        savingsPerUse: number };
    productivity: { productivityGain: number;
