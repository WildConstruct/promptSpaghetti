...
export const KnowledgeBaseDemo = ({ initialMode = 'browse', currentUser = demoAuthors[0], className = '' }) => {
    ...
    const updatedStats = useMemo(() => ({
        ...
        recentlyUpdated: [...articles].sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()).slice(0, 3),
