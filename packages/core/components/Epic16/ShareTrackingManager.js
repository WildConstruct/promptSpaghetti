...
import { ChartBarIcon, ArrowTrendingUpIcon, FunnelIcon, GlobeAltIcon, DevicePhoneMobileIcon, ComputerDesktopIcon, MapPinIcon, UserGroupIcon, TrendingUpIcon, TrendingDownIcon, ArrowUpIcon, InformationCircleIcon, Squares2X2Icon, FlagIcon, ExclamationTriangleIcon, CheckCircleIcon, XCircleIcon, FaceSmileIcon, SparklesIcon } from '@heroicons/react/24/outline';
// Utility functions
...
// Main component
export const ShareTrackingManager = ({ templateId, template, shares = [], onShareUpdate, onAnalyticsRefresh, className = '', realTimeUpdates = true, showAdvancedMetrics = true }) => {
    ...
    return (_jsxs("div", { className: `bg-white border border-gray-200 rounded-lg overflow-hidden ${className}`, children: [_jsx("div", { className: "border-b border-gray-200 p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(ChartBarIcon, { className: "h-6 w-6 text-blue-500" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900", children: "Share Tracking & Analytics" }), _jsxs("p", { className: "text-sm text-gray-600", children: [template?.title || `Template ${templateId}`, " \u2022 ", trackingData.totalShares, " total shares"] })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("button", { onClick: handleRefresh, disabled: isRefreshing, className: "flex items-center gap-2 px-3 py-1 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded text-sm disabled:opacity-50", children: [_jsx(ArrowTrendingUpIcon, { className: `h-4 w-4 ${isRefreshing ? 'animate-spin' : ''}` }), "Refresh"] }), _jsx("div", { className: "flex items-center gap-1 text-xs text-gray-500", children: realTimeUpdates && (_jsxs(_Fragment, { children: [_jsx("div", { className: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }), "Live"] })) })] })] }) }), activeAlerts.length > 0 && (_jsx("div", { className: "border-b border-gray-200 p-4 bg-yellow-50", children: _jsx("div", { className: "space-y-2", children: activeAlerts.slice(0, 3).map(alert => {
                        ...
                        const Icon = tab.icon;
                        return (_jsxs("button", { onClick: () => setActiveTab(tab.id), className: `flex items-center gap-2 py-3 px-4 text-sm font-medium border-b-2 transition-colors ${activeTab === tab.id
                                ? 'border-blue-500 text-blue-600'
                                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`, children: [_jsx(Icon, { className: "h-4 w-4" }), tab.label, tab.id === 'alerts' && activeAlerts.length > 0 && (_jsx("span", { className: "ml-1 px-1.5 py-0.5 text-xs bg-red-100 text-red-600 rounded-full", children: activeAlerts.length }))] }, tab.id));
                    }) }) }), _jsxs("div", { className: "p-6", children: [activeTab === 'overview' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 mb-4", children: "Performance Overview" }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsxs("div", { className: "bg-gray-50 rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h5", { className: "font-medium text-gray-700", children: "Engagement Rate" }), _jsxs("div", { className: "flex items-center gap-1 text-sm text-green-600", children: [_jsx(ArrowUpIcon, { className: "h-3 w-3" }), "+12.5%"] })] }), _jsxs("div", { className: "text-2xl font-bold text-gray-900 mb-2", children: [trackingData.performanceMetrics.engagementRate.toFixed(1), "%"] }), _jsx("div", { className: "text-sm text-gray-600", children: "vs. last period" })] }), _jsxs("div", { className: "bg-gray-50 rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h5", { className: "font-medium text-gray-700", children: "Viral Coefficient" }), _jsxs("div", { className: "flex items-center gap-1 text-sm text-orange-600", children: [_jsx(TrendingUpIcon, { className: "h-3 w-3" }), trackingData.performanceMetrics.viralCoefficient.toFixed(1)] })] }), _jsx("div", { className: "text-2xl font-bold text-gray-900 mb-2", children: trackingData.performanceMetrics.viralCoefficient.toFixed(2) }), _jsx("div", { className: "text-sm text-gray-600", children: "shares per user" })] })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 mb-4", children: "Recommendations" }), _jsx("div", { className: "space-y-3", children: trackingData.recommendations.slice(0, 3).map(rec => (_jsx("div", { className: "border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsxs("span", { className: `px-2 py-1 text-xs rounded-full ${rec.priority === 'high' ? 'bg-red-100 text-red-700' :
                                                                            rec.priority === 'medium' ? 'bg-yellow-100 text-yellow-700' :
                                                                                'bg-blue-100 text-blue-700'}`, children: [rec.priority, " priority"] }), _jsx("span", { className: "text-xs text-gray-500", children: rec.type })] }), _jsx("h5", { className: "font-medium text-gray-900 mb-1", children: rec.title }), _jsx("p", { className: "text-sm text-gray-600 mb-2", children: rec.description }), _jsxs("div", { className: "flex items-center gap-4 text-xs text-gray-500", children: [_jsxs("span", { children: ["Impact: ", rec.impact] }), _jsxs("span", { children: ["Effort: ", rec.effort] }), _jsxs("span", { children: ["Confidence: ", (rec.confidence * 100).toFixed(0), "%"] })] })] }), _jsx(SparklesIcon, { className: "h-5 w-5 text-blue-500 flex-shrink-0" })] }) }, rec.id))) })] })] })), activeTab === 'platforms' && (_jsxs("div", { className: "space-y-6", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Platform Breakdown" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: Object.values(trackingData.platformBreakdown).map(platform => (_jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h5", { className: "font-medium text-gray-900 capitalize", children: platform.platform }), _jsxs("div", { className: `flex items-center gap-1 text-xs ${platform.trends.direction === 'up' ? 'text-green-600' :
                                                        platform.trends.direction === 'down' ? 'text-red-600' :
                                                            'text-gray-600'}`, children: [platform.trends.direction === 'up' ? _jsx(TrendingUpIcon, { className: "h-3 w-3" }) :
                                                            platform.trends.direction === 'down' ? _jsx(TrendingDownIcon, { className: "h-3 w-3" }) : null, platform.trends.percentage.toFixed(1), "%"] })] }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-gray-600", children: "Shares:" }), _jsx("span", { className: "font-medium", children: platform.totalShares })] }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-gray-600", children: "Success Rate:" }), _jsxs("span", { className: "font-medium", children: [platform.successRate.toFixed(1), "%"] })] }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-gray-600", children: "Avg. Engagement:" }), _jsx("span", { className: "font-medium", children: platform.averageEngagement.toFixed(1) })] }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-gray-600", children: "Revenue:" }), _jsx("span", { className: "font-medium", children: ShareTrackingUtils.formatMetric(platform.revenueGenerated, 'currency') })] })] })] }, platform.platform))) })] })), activeTab === 'demographics' && (_jsxs("div", { className: "space-y-6", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Demographic Insights" }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [_jsx("h5", { className: "font-medium text-gray-900 mb-4", children: "Top Age Groups" }), _jsx("div", { className: "space-y-3", children: trackingData.demographicInsights.topAgeGroups.map((group, index) => (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-xs font-medium text-blue-600", children: ["#", index + 1] }), _jsxs("div", { children: [_jsxs("div", { className: "font-medium text-gray-900", children: [group.group, " years"] }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Engagement: ", group.engagement.toFixed(1)] })] })] }), _jsx("div", { className: "text-right", children: _jsxs("div", { className: "font-medium text-gray-900", children: [group.percentage, "%"] }) })] }, group.group))) })] }), _jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [_jsx("h5", { className: "font-medium text-gray-900 mb-4", children: "Top Locations" }), _jsx("div", { className: "space-y-3", children: trackingData.demographicInsights.topLocations.map((location, index) => (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(MapPinIcon, { className: "h-4 w-4 text-gray-400" }), _jsxs("div", { children: [_jsx("div", { className: "font-medium text-gray-900", children: location.location }), _jsxs("div", { className: "text-xs text-gray-500", children: [location.shares, " shares"] })] })] }), _jsx("div", { className: "text-right", children: _jsx("div", { className: "font-medium text-gray-900", children: ShareTrackingUtils.formatMetric(location.revenue, 'currency') }) })] }, location.location))) })] }), _jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [_jsx("h5", { className: "font-medium text-gray-900 mb-4", children: "Device Preferences" }), _jsx("div", { className: "space-y-3", children: trackingData.demographicInsights.devicePreferences.map(device => {
                                                    const DeviceIcon = device.device === 'Mobile' ? DevicePhoneMobileIcon : ComputerDesktopIcon;
                                                    return (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(DeviceIcon, { className: "h-4 w-4 text-gray-400" }), _jsxs("div", { children: [_jsx("div", { className: "font-medium text-gray-900", children: device.device }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Performance: ", device.performance.toFixed(1)] })] })] }), _jsx("div", { className: "text-right", children: _jsxs("div", { className: "font-medium text-gray-900", children: [device.usage, "%"] }) })] }, device.device));
                                                }) })] }), _jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [_jsx("h5", { className: "font-medium text-gray-900 mb-4", children: "Top Interests" }), _jsx("div", { className: "space-y-3", children: trackingData.demographicInsights.topInterests.map(interest => (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-2 h-2 bg-blue-500 rounded-full" }), _jsxs("div", { children: [_jsx("div", { className: "font-medium text-gray-900", children: interest.interest }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Conversion: ", interest.conversion.toFixed(1), "%"] })] })] }), _jsx("div", { className: "text-right", children: _jsx("div", { className: "font-medium text-gray-900", children: interest.affinity.toFixed(1) }) })] }, interest.interest))) })] })] })] })), activeTab === 'funnel' && (_jsxs("div", { className: "space-y-6", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Conversion Funnel" }), _jsx("div", { className: "relative", children: Object.values(trackingData.conversionFunnel).map((stage, index) => (_jsxs("div", { className: "relative mb-4", children: [_jsxs("div", { className: "flex items-center justify-between p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg", style: {
                                                width: `${Math.max(stage.percentage, 10)}%`,
                                                minWidth: '200px'
                                            }, children: [_jsxs("div", { children: [_jsx("div", { className: "font-semibold capitalize", children: stage.stage }), _jsxs("div", { className: "text-sm opacity-90", children: [stage.count.toLocaleString(), " users"] })] }), _jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "font-semibold", children: [stage.percentage.toFixed(1), "%"] }), index > 0 && (_jsxs("div", { className: "text-xs opacity-75", children: ["-", stage.dropOffRate, "% drop"] }))] })] }), _jsxs("div", { className: "mt-2 ml-4 text-xs text-gray-500", children: ["Avg. time: ", Math.floor(stage.averageTime / 60), "m ", stage.averageTime % 60, "s"] })] }, stage.stage))) })] })), activeTab === 'alerts' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h4", { className: "font-medium text-gray-900", children: "Alerts & Notifications" }), _jsxs("div", { className: "text-sm text-gray-600", children: [activeAlerts.length, " active alerts"] })] }), _jsx("div", { className: "space-y-4", children: trackingData.alerts.map(alert => {
                                    const AlertIcon = alert.type === 'success' ? CheckCircleIcon :
                                        alert.type === 'warning' ? ExclamationTriangleIcon :
                                            alert.type === 'error' ? XCircleIcon : InformationCircleIcon;
                                    const alertColors = {
                                    ...
                                    return (_jsx("div", { className: `border rounded-lg p-4 ${isDismissed ? 'opacity-50' : ''} ${alertColors[alert.type]}`, children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx(AlertIcon, { className: "h-5 w-5 flex-shrink-0 mt-0.5" }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("h5", { className: "font-medium", children: alert.title }), _jsxs("div", { className: "text-xs opacity-75", children: [alert.timestamp.toLocaleDateString(), " ", alert.timestamp.toLocaleTimeString()] })] }), _jsx("p", { className: "text-sm opacity-90 mb-2", children: alert.message }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2 text-xs", children: [alert.platform && (_jsx("span", { className: "px-2 py-1 bg-white bg-opacity-20 rounded capitalize", children: alert.platform })), alert.actionRequired && (_jsx("span", { className: "px-2 py-1 bg-red-100 text-red-700 rounded", children: "Action Required" }))] }), !isDismissed && (_jsx("button", { onClick: () => handleAlertDismiss(alert.id), className: "text-xs hover:underline opacity-75 hover:opacity-100", children: "Dismiss" }))] })] })] }) }, alert.id));
                                }) }), trackingData.alerts.length === 0 && (_jsxs("div", { className: "text-center py-8 text-gray-500", children: [_jsx(FaceSmileIcon, { className: "h-12 w-12 mx-auto mb-4 text-gray-300" }), _jsx("h5", { className: "font-medium text-gray-700 mb-2", children: "All Good!" }), _jsx("p", { className: "text-sm", children: "No alerts or issues to report at this time." })] }))] }))] })] }));
};
