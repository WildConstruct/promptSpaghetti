...
export const ApiIntegrationManager = ({ workspaceId, onClose }) => {
    ...
    const renderApiKeysTab = () => (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold", children: "API Keys" }), _jsxs("button", { onClick: () => setShowCreateApiKey(true), className: "flex items-center space-x-2 px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors", children: [_jsx(PlusIcon, { className: "h-4 w-4" }), _jsx("span", { children: "Create API Key" })] })] }), _jsx("div", { className: "space-y-3", children: apiKeys.map(key => (_jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("h4", { className: "font-medium text-gray-900", children: key.name }), _jsx("span", { className: `px-2 py-1 text-xs rounded-full ${getStatusColor(key.is_active)}`, children: key.is_active ? 'Active' : 'Inactive' })] }), _jsx("div", { className: "mt-2 flex items-center space-x-4 text-sm text-gray-600", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(KeyIcon, { className: "h-4 w-4" }), _jsx("code", { className: "bg-gray-100 px-2 py-1 rounded", children: formatKey(key.key, visibleKeys.has(key.id)) }), _jsx("button", { onClick: () => toggleKeyVisibility(key.id), className: "text-gray-400 hover:text-gray-600", children: visibleKeys.has(key.id) ? (_jsx(EyeSlashIcon, { className: "h-4 w-4" })) : (_jsx(EyeIcon, { className: "h-4 w-4" })) }), _jsx("button", { onClick: () => copyToClipboard(key.key), className: "text-gray-400 hover:text-gray-600", children: _jsx(DocumentDuplicateIcon, { className: "h-4 w-4" }) })] }) }), _jsxs("div", { className: "mt-2 flex items-center space-x-6 text-sm text-gray-500", children: [_jsxs("span", { children: ["Usage: ", key.usage_count.toLocaleString()] }), _jsxs("span", { children: ["Rate limit: ", key.rate_limit, "/hour"] }), _jsxs("span", { children: ["Last used: ", key.last_used?.toLocaleDateString() || 'Never'] }), key.expires_at && (_jsxs("span", { children: ["Expires: ", key.expires_at.toLocaleDateString()] }))] }), _jsx("div", { className: "mt-2 flex items-center space-x-2", children: key.permissions.map(permission => (_jsx("span", { className: "px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded", children: permission }, permission))) })] }), _jsx("div", { className: "flex items-center space-x-2", children: _jsx("button", { onClick: () => setShowDeleteConfirm(key.id), className: "p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-colors", children: _jsx(TrashIcon, { className: "h-4 w-4" }) }) })] }) }, key.id))) }), apiKeys.length === 0 && (_jsxs("div", { className: "text-center py-8 text-gray-500", children: [_jsx(KeyIcon, { className: "h-12 w-12 mx-auto mb-4 text-gray-300" }), _jsx("p", { children: "No API keys found. Create your first API key to get started." })] }))] }));
    const renderWebhooksTab = () => (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Webhooks" }), _jsxs("button", { onClick: () => setShowCreateWebhook(true), className: "flex items-center space-x-2 px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors", children: [_jsx(PlusIcon, { className: "h-4 w-4" }), _jsx("span", { children: "Create Webhook" })] })] }), _jsx("div", { className: "space-y-3", children: webhooks.map(webhook => (_jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("h4", { className: "font-medium text-gray-900", children: webhook.name }), _jsx("span", { className: `px-2 py-1 text-xs rounded-full ${getStatusColor(webhook.is_active)}`, children: webhook.is_active ? 'Active' : 'Inactive' })] }), _jsxs("div", { className: "mt-2 flex items-center space-x-2 text-sm text-gray-600", children: [_jsx(GlobeAltIcon, { className: "h-4 w-4" }), _jsx("code", { className: "bg-gray-100 px-2 py-1 rounded text-xs", children: webhook.url })] }), _jsxs("div", { className: "mt-2 flex items-center space-x-6 text-sm text-gray-500", children: [_jsxs("span", { children: ["Success: ", webhook.success_count.toLocaleString()] }), _jsxs("span", { children: ["Failures: ", webhook.failure_count.toLocaleString()] }), _jsxs("span", { children: ["Last triggered: ", webhook.last_triggered?.toLocaleDateString() || 'Never'] })] }), _jsx("div", { className: "mt-2 flex items-center space-x-2", children: webhook.events.map(event => (_jsx("span", { className: "px-2 py-1 bg-green-100 text-green-800 text-xs rounded", children: event }, event))) })] }), _jsx("div", { className: "flex items-center space-x-2", children: _jsx("button", { onClick: () => setShowDeleteConfirm(webhook.id), className: "p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-colors", children: _jsx(TrashIcon, { className: "h-4 w-4" }) }) })] }) }, webhook.id))) }), webhooks.length === 0 && (_jsxs("div", { className: "text-center py-8 text-gray-500", children: [_jsx(BellIcon, { className: "h-12 w-12 mx-auto mb-4 text-gray-300" }), _jsx("p", { children: "No webhooks configured. Create your first webhook to receive notifications." })] }))] }));
    const renderUsageTab = () => (_jsxs("div", { className: "space-y-6", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Usage Statistics" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "flex-shrink-0", children: _jsx(KeyIcon, { className: "h-8 w-8 text-blue-600" }) }), _jsxs("div", { className: "ml-4", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Total API Calls" }), _jsx("div", { className: "text-2xl font-bold text-gray-900", children: totalApiUsage.toLocaleString() })] })] }) }), _jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "flex-shrink-0", children: _jsx(BellIcon, { className: "h-8 w-8 text-green-600" }) }), _jsxs("div", { className: "ml-4", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Webhook Calls" }), _jsx("div", { className: "text-2xl font-bold text-gray-900", children: totalWebhookCalls.toLocaleString() })] })] }) }), _jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "flex-shrink-0", children: _jsx(ChartBarIcon, { className: "h-8 w-8 text-purple-600" }) }), _jsxs("div", { className: "ml-4", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Success Rate" }), _jsxs("div", { className: "text-2xl font-bold text-gray-900", children: [webhookSuccessRate, "%"] })] })] }) })] }), _jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: [_jsx("h4", { className: "font-medium mb-4", children: "Recent Activity" }), _jsxs("div", { className: "space-y-2 text-sm", children: [_jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-100", children: [_jsx("span", { children: "API Key \"Production\" used" }), _jsx("span", { className: "text-gray-500", children: "2 minutes ago" })] }), _jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-100", children: [_jsx("span", { children: "Webhook \"Slack Notifications\" triggered" }), _jsx("span", { className: "text-gray-500", children: "5 minutes ago" })] }), _jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-100", children: [_jsx("span", { children: "API Key \"Development\" created" }), _jsx("span", { className: "text-gray-500", children: "1 hour ago" })] })] })] })] }));
    const renderDocumentationTab = () => (_jsxs("div", { className: "space-y-6", children: [_jsx("h3", { className: "text-lg font-semibold", children: "API Documentation" }), _jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6", children: [_jsx("h4", { className: "font-medium mb-4", children: "Authentication" }), _jsx("p", { className: "text-sm text-gray-600 mb-4", children: "Include your API key in the Authorization header:" }), _jsx("code", { className: "block bg-gray-100 p-3 rounded text-sm", children: "Authorization: Bearer YOUR_API_KEY" })] }), _jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6", children: [_jsx("h4", { className: "font-medium mb-4", children: "Workflow Operations" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("h5", { className: "font-medium text-sm", children: "Get Workflow States" }), _jsx("code", { className: "block bg-gray-100 p-3 rounded text-sm mt-2", children: "GET /api/workflow/states/:workspaceId" })] }), _jsxs("div", { children: [_jsx("h5", { className: "font-medium text-sm", children: "Transition State" }), _jsxs("code", { className: "block bg-gray-100 p-3 rounded text-sm mt-2", children: ["POST /api/workflow/transition", JSON.stringify({
                                                resource_id: "resource_uuid",
                                                to_state_id: "state_uuid",
                                                comment: "Transition comment"
                                            }, null, 2)] })] }), _jsxs("div", { children: [_jsx("h5", { className: "font-medium text-sm", children: "Create Approval" }), _jsxs("code", { className: "block bg-gray-100 p-3 rounded text-sm mt-2", children: ["POST /api/workflow/approvals", JSON.stringify({
                                                resource_id: "resource_uuid",
                                                transition_id: "transition_uuid",
                                                requester_id: "user_id"
                                            }, null, 2)] })] })] })] }), _jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-6", children: [_jsx("h4", { className: "font-medium mb-4", children: "Webhook Events" }), _jsx("p", { className: "text-sm text-gray-600 mb-4", children: "Your webhook endpoint will receive POST requests with the following structure:" }), _jsx("code", { className: "block bg-gray-100 p-3 rounded text-sm", children: JSON.stringify({
                            event: "state_changed",
    ...
    return (_jsxs("div", { className: "bg-white rounded-lg shadow-sm border border-gray-200", children: [_jsx("div", { className: "border-b border-gray-200 p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(GlobeAltIcon, { className: "h-6 w-6 text-gray-600" }), _jsxs("div", { children: [_jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "API Integration" }), _jsx("p", { className: "text-sm text-gray-500", children: "Manage API keys, webhooks, and external integrations" })] })] }), onClose && (_jsx("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600 transition-colors", children: _jsx(XCircleIcon, { className: "h-5 w-5" }) }))] }) }), _jsx("div", { className: "border-b border-gray-200", children: _jsx("nav", { className: "flex space-x-8 px-4", children: tabs.map(tab => (_jsxs("button", { onClick: () => setActiveTab(tab.id), className: `flex items-center space-x-2 py-4 px-1 border-b-2 font-medium text-sm ${activeTab === tab.id
                            ? 'border-blue-500 text-blue-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`, children: [_jsx(tab.icon, { className: "h-4 w-4" }), _jsx("span", { children: tab.label })] }, tab.id))) }) }), _jsxs("div", { className: "p-4", children: [error && (_jsx("div", { className: "mb-4 bg-red-50 border border-red-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx(ExclamationTriangleIcon, { className: "h-5 w-5 text-red-600 mr-2" }), _jsx("span", { className: "text-red-800", children: error })] }) })), loading ? (_jsx("div", { className: "flex items-center justify-center h-64", children: _jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600" }) })) : (_jsxs(_Fragment, { children: [activeTab === 'api_keys' && renderApiKeysTab(), activeTab === 'webhooks' && renderWebhooksTab(), activeTab === 'usage' && renderUsageTab(), activeTab === 'documentation' && renderDocumentationTab()] }))] }), showCreateApiKey && (_jsx(CreateApiKeyModal, { onClose: () => setShowCreateApiKey(false), onSubmit: handleCreateApiKey })), showCreateWebhook && (_jsx(CreateWebhookModal, { onClose: () => setShowCreateWebhook(false), onSubmit: handleCreateWebhook, availableEvents: availableEvents })), showDeleteConfirm && (_jsx(DeleteConfirmationModal, { onClose: () => setShowDeleteConfirm(null), onConfirm: () => {
...
const CreateWebhookModal = ({ onClose, onSubmit, availableEvents }) => {
    ...
    return (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: _jsxs("div", { className: "bg-white rounded-lg p-6 w-full max-w-md", children: [_jsx("h3", { className: "text-lg font-semibold mb-4", children: "Create Webhook" }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Name" }), _jsx("input", { type: "text", value: formData.name, onChange: (e) => setFormData(prev => ({ ...prev, name: e.target.value })), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500", required: true })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "URL" }), _jsx("input", { type: "url", value: formData.url, onChange: (e) => setFormData(prev => ({ ...prev, url: e.target.value })), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500", required: true })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Events" }), _jsx("div", { className: "space-y-2 max-h-40 overflow-y-auto", children: availableEvents.map(event => (_jsxs("label", { className: "flex items-center", children: [_jsx("input", { type: "checkbox", checked: formData.events.includes(event), onChange: (e) => {
                                                ...
                                                }, className: "mr-2" }), event] }, event))) })] }), _jsxs("div", { className: "flex justify-end space-x-2", children: [_jsx("button", { type: "button", onClick: onClose, className: "px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors", children: "Cancel" }), _jsx("button", { type: "submit", className: "px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors", children: "Create Webhook" })] })] })] }) }));
};
const DeleteConfirmationModal = ({ onClose, onConfirm, itemType }) => {
