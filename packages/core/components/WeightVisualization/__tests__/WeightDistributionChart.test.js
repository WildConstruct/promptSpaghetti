...
describe('WeightDistributionChart', () => {
    it('renders pie chart by default', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions }));
    ...
    it('renders bar chart when type is specified', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, type: "bar" }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    it('renders donut chart when type is specified', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, type: "donut" }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    it('shows empty state when no options provided', () => {
        render(_jsx(WeightDistributionChart, { options: [] }));
        expect(screen.getByText('No options to visualize')).toBeInTheDocument();
    });
    it('displays option labels when showLabels is true', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, showLabels: true }));
    ...
    it('handles hover interactions', () => {
        ...
        render(_jsx(WeightDistributionChart, { options: mockOptions, onOptionHover: mockOnHover }));
    ...
    it('handles click interactions', () => {
        ...
        render(_jsx(WeightDistributionChart, { options: mockOptions, onOptionClick: mockOnClick }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    ...
    it('applies custom color schemes', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, colorScheme: "professional" }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    it('renders with custom dimensions', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, width: 300, height: 300 }));
        const svg = screen.getByRole('img', { hidden: true });
    ...
    it('calculates correct percentages', () => {
        ...
        render(_jsx(WeightDistributionChart, { options: options, showPercentages: true }));
    ...
    it('handles zero weights gracefully', () => {
        ...
        render(_jsx(WeightDistributionChart, { options: options }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    ...
    it('truncates long option names in labels', () => {
        ...
        render(_jsx(WeightDistributionChart, { options: options, showLabels: true }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
});
describe('WeightDistributionChart Color Schemes', () => {
    ...
    it('uses warm color scheme', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, colorScheme: "warm" }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
    it('uses cool color scheme', () => {
        render(_jsx(WeightDistributionChart, { options: mockOptions, colorScheme: "cool" }));
        const svg = screen.getByRole('img', { hidden: true });
        expect(svg).toBeInTheDocument();
    });
});
