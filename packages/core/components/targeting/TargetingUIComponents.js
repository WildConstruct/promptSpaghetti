...
export const AudienceSelector = ({ audiences, selectedAudience, onSelect, onCreate, onEdit, onDelete, showAnalytics = true, compact = false }) => {
...
export const AdvancedConditionBuilder = ({ conditions, onChange, availableFields, onPreview, showVisualBuilder = true }) => {
...
export const GeographicTargeting = ({ selectedCountries, selectedRegions, selectedCities, onCountriesChange, _____onRegionsChange, _____onCitiesChange, excludeMode = false, onExcludeModeChange }) => {
...
export const SegmentManagement = ({ segments, onCreateSegment, onUpdateSegment, onDeleteSegment, onDuplicateSegment }) => {
    const [expandedSegment, setExpandedSegment] = useState(null);
    const [_____editingSegment, setEditingSegment] = useState(null);
...
export const TargetingAnalytics = ({ analytics, timeRange, onTimeRangeChange }) => {
    return (_jsxs("div", { className: "targeting-analytics", children: [_jsxs("div", { className: "analytics-header", children: [_jsxs("div", { className: "header-title", children: [_jsx(BarChart3, { size: 20 }), _jsx("h3", { children: "Targeting Performance" })] }), _jsx("div", { className: "time-range-selector", children: ['24h', '7d', '30d', '90d'].map(range => (_jsx("button", { className: `time-btn ${timeRange === range ? 'active' : ''}`, onClick: () => onTimeRangeChange(range), children: range }, range))) })] }), _jsx("div", { className: "analytics-overview", children: _jsxs("div", { className: "metric-cards", children: [_jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: _jsx(Users, { size: 24 }) }), _jsxs("div", { className: "metric-content", children: [_jsx("div", { className: "metric-value", children: analytics.totalUsers.toLocaleString() }), _jsx("div", { className: "metric-label", children: "Total Users" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: _jsx(Target, { size: 24 }) }), _jsxs("div", { className: "metric-content", children: [_jsx("div", { className: "metric-value", children: analytics.activeTargeting.toLocaleString() }), _jsx("div", { className: "metric-label", children: "Active Targeting" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: _jsx(TrendingUp, { size: 24 }) }), _jsxs("div", { className: "metric-content", children: [_jsxs("div", { className: "metric-value", children: [(analytics.conversionRate * 100).toFixed(1), "%"] }), _jsx("div", { className: "metric-label", children: "Conversion Rate" })] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("div", { className: "metric-icon", children: _jsx(Eye, { size: 24 }) }), _jsxs("div", { className: "metric-content", children: [_jsx("div", { className: "metric-value", children: analytics.impressions.toLocaleString() }), _jsx("div", { className: "metric-label", children: "Impressions" })] })] })] }) }), _jsxs("div", { className: "analytics-charts", children: [_jsxs("div", { className: "chart-section", children: [_jsx("h4", { children: "Top Performing Segments" }), _jsx("div", { className: "segments-performance", children: analytics.topSegments.map(segment => (_jsxs("div", { className: "segment-performance", children: [_jsx("div", { className: "segment-name", children: segment.name }), _jsx("div", { className: "performance-bar", children: _jsx("div", { className: "performance-fill", style: { width: `${segment.performance}%` } }) }), _jsx("div", { className: "segment-users", children: segment.users.toLocaleString() })] }, segment.id))) })] }), _jsxs("div", { className: "chart-section", children: [_jsx("h4", { children: "Geographic Distribution" }), _jsx("div", { className: "geographic-chart", children: Object.entries(analytics.geographicBreakdown).map(([country, count]) => (_jsxs("div", { className: "geo-item", children: [_jsx("span", { className: "country-name", children: country }), _jsx("span", { className: "user-count", children: count.toLocaleString() })] }, country))) })] })] })] }));
};
