...
export const AudienceSelector = ({ audiences, selectedAudience, onSelect, onCreate, onEdit, onDelete, showAnalytics = false, compact = false }) => {
...
export const AdvancedConditionBuilder = ({ conditions, onChange, availableFields, onPreview, showVisualBuilder = false }) => {
