...
export const GeographicTargeting = ({ selectedCountries, selectedRegions, selectedCities, onCountriesChange, onRegionsChange, onCitiesChange, excludeMode = false, onExcludeModeChange }) => {
