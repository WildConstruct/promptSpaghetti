...
export const TemplateGallery = ({ workspaceId, onSelectTemplate, onCreateFromTemplate, className = '', showCreateButton = true, allowCreation = true, viewMode: initialViewMode = 'grid' }) => {
