...
export const CommentEditor = ({ initialContent = '', onSave, onCancel, placeholder = 'Write a comment...', submitLabel = 'Post', workspaceId, maxLength = 5000, showPreview = false, allowFormatting = true, allowMentions = true, allowAttachments = false }) => {
