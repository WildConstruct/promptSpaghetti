...
export const CommentThread = ({ resourceId, resourceType, workspaceId, userId, targetData, className = '', maxHeight = '400px', showReplies = true, allowEditing = true, allowModeration = false, realTime = true }) => {
