...
export const WorkflowHistoryVisualization = ({ workspaceId, resourceId, maxEntries = 20, showFilters = true, compact = false }) => {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-medium text-gray-900", children: "Workflow History" }), showFilters && (_jsxs("button", { onClick: () => setShowFilterPanel(!showFilterPanel), className: "flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 hover:text-gray-900", children: [_jsx(FunnelIcon, { className: "h-4 w-4" }), _jsx("span", { children: "Filters" })] }))] }), showFilterPanel && (_jsxs("div", { className: "bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Action Type" }), _jsxs("select", { value: filters.action_type, onChange: (e) => handleFilterChange('action_type', e.target.value), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500", children: [_jsx("option", { value: "", children: "All actions" }), _jsx("option", { value: "state_changed", children: "State Changed" }), _jsx("option", { value: "approval_requested", children: "Approval Requested" }), _jsx("option", { value: "approved", children: "Approved" }), _jsx("option", { value: "rejected", children: "Rejected" }), _jsx("option", { value: "lock_acquired", children: "Lock Acquired" }), _jsx("option", { value: "lock_released", children: "Lock Released" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "From Date" }), _jsx("input", { type: "date", value: filters.date_from, onChange: (e) => handleFilterChange('date_from', e.target.value), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "To Date" }), _jsx("input", { type: "date", value: filters.date_to, onChange: (e) => handleFilterChange('date_to', e.target.value), className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" })] })] }), _jsx("div", { className: "flex justify-end space-x-2", children: _jsx("button", { onClick: clearFilters, className: "px-3 py-2 text-sm text-gray-600 hover:text-gray-900", children: "Clear Filters" }) })] })), history.length === 0 ? (_jsxs("div", { className: "text-center py-8", children: [_jsx(ClockIcon, { className: "mx-auto h-12 w-12 text-gray-400" }), _jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No history found" }), _jsx("p", { className: "mt-1 text-sm text-gray-500", children: "No workflow history matches your current filters." })] })) : (_jsx("div", { className: "space-y-4", children: history.map((entry, index) => (_jsxs("div", { className: `flex items-start space-x-4 ${compact ? 'py-2' : 'py-4'} ${index < history.length - 1 ? 'border-b border-gray-200' : ''}`, children: [_jsxs("div", { className: "flex-shrink-0 relative", children: [_jsx("div", { className: "flex items-center justify-center w-8 h-8 bg-white border-2 border-gray-200 rounded-full", children: getActionIcon(entry.action_type) }), index < history.length - 1 && (_jsx("div", { className: "absolute top-8 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-gray-200" }))] }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("span", { className: "text-sm font-medium text-gray-900", children: getActionDescription(entry) }), entry.action_type === 'state_changed' && entry.new_state_id && (_jsx("span", { className: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium", style: {
                                                        backgroundColor: `${getStateColor(entry.new_state_id)}20`,
                                                        color: getStateColor(entry.new_state_id)
                                                    }, children: getStateName(entry.new_state_id) }))] }), _jsx("time", { className: "text-xs text-gray-500", children: formatTimestamp(entry.action_timestamp) })] }), _jsxs("div", { className: "mt-1 flex items-center space-x-2 text-sm text-gray-600", children: [_jsx(UserIcon, { className: "h-3 w-3" }), _jsx("span", { children: entry.actor_id }), _jsx("span", { children: "\u2022" }), _jsx(CalendarIcon, { className: "h-3 w-3" }), _jsx("span", { children: new Date(entry.action_timestamp).toLocaleString() })] }), entry.comment && (_jsxs("div", { className: "mt-2 flex items-start space-x-2", children: [_jsx(ChatBubbleLeftIcon, { className: "h-4 w-4 text-gray-400 mt-0.5" }), _jsxs("p", { className: "text-sm text-gray-700 italic", children: ["\"", entry.comment, "\""] })] })), Object.keys(entry.metadata).length > 0 && !compact && (_jsx("div", { className: "mt-2 text-xs text-gray-500", children: _jsxs("details", { className: "cursor-pointer", children: [_jsx("summary", { className: "hover:text-gray-700", children: "Additional details" }), _jsx("div", { className: "mt-1 pl-4 border-l-2 border-gray-200", children: _jsx("pre", { className: "text-xs text-gray-600 whitespace-pre-wrap", children: JSON.stringify(entry.metadata, null, 2) }) })] }) }))] })] }, entry.id))) })), history.length >= maxEntries && (_jsx("div", { className: "text-center", children: _jsx("button", { onClick: () => fetchHistory(workspaceId, { ...filters, limit: maxEntries * 2 }), className: "px-4 py-2 text-sm text-blue-600 hover:text-blue-800", children: "Load more history" }) }))] }));
};
