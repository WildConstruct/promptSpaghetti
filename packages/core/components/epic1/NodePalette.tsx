...
const nodeIcons = {
  ...
  promptWizard: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 21-6-6l1.5-10.5L18 3l1.5 1.5L21 3l1.5 1.5L21 6l1.5 1.5L21 9l-1.5-1.5L18 9l1.5-1.5ZM3 21l12-12L9 3 3 9l12 12Z"/></svg>',
};
...
const nodeTypes: NodeTypeInfo[] = [
  ...
  { type: 'promptWizard', label: 'Prompt Wizard', icon: nodeIcons.promptWizard, category: 'Input' },
];
