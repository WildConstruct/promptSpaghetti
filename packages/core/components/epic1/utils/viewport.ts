...
export function captureViewport(instance: ReactFlowInstance | null | undefined): Viewport | null {
  try {
    if (!instance || typeof (instance as any).getViewport !== 'function') return null;
...
export function restoreViewport(instance: ReactFlowInstance | null | undefined, vp: Viewport | null): void {
  try {
