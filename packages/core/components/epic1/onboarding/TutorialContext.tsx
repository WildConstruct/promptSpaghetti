...
const tutorialSteps: TutorialStep[] = [
  ...
  {
    id: 'paste-prompt',
    title: 'Create Nodes from Text',
    description: 'Enter a prompt to automatically create nodes. Use "or" for variations (e.g., "brave knight or wise wizard").',
    target: '.prompt-wizard-button',
    action: 'click',
    hint: 'Click the Wizard button in the toolbar to open the prompt parser',
    position: 'bottom',
    spotlight: true,
  },
  {
