...
const DiffViewerToolbar = ({ session, comparison, onViewModeChange, onHighlightModeChange, onFiltersChange, zoomLevel, onZoomChange, showAnnotations, onToggleAnnotations }) => {
