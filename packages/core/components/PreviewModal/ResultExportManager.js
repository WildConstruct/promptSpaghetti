...
export const ResultExportManager = ({ results, selectedResultIds, onExportComplete, onExportError, className = '' }) => {
    ...
    const handleExport = useCallback(async () => {
        ...
        try {
            ...
            const exportPayload = await prepareExportPayload(selectedResults, exportOptions);
            ...
            if (!response.ok) {
                throw ErrorFactory.createAPIError(response.status, `Export failed: ${response.statusText}`, '/api/export');
            }
            ...
            throw ErrorFactory.createGraphExecutionError('Result export failed', exportError, { operation: 'export_results', format: selectedFormat.id });
        }
        finally {
    ...
    return (_jsxs("div", { className: `result-export-manager ${className}`, style: {
            ...
            overflow: 'hidden'
                    ...
                    background: 'rgba(255, 255, 255, 0.8)'
                            ...
                            alignItems: 'center',
                            gap: 8
                        }, children: ["\uD83D\uDCE4 Export ", selectedResults.length, " Result", selectedResults.length !== 1 ? 's' : ''] }), _jsx("div", { style: {
                            fontSize: 14,
                            color: '#64748b',
                            marginTop: 4
                        }, children: "Choose professional export format for film industry workflows" })] }), !selectedFormat ? (_jsx("div", { style: { padding: 20 }, children: Object.entries(formatsByCategory).map(([category, formats]) => (_jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("h4", { style: {
                                margin: '0 0 12px 0',
                                fontSize: 14,
                                fontWeight: 600,
                                color: '#374151'
                            }, children: categoryLabels[category] }), _jsx("div", { style: {
                                display: 'grid',
                                gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))',
                                gap: 12
                            }, children: formats.map((format) => (_jsxs("button", { onClick: () => handleFormatSelect(format), style: {
                                    padding: 16,
                                    background: 'white',
                                    ...
                                    ':hover': {
                                        ...
                                        boxShadow: '0 2px 4px rgba(59, 130, 246, 0.1)'
                                            ...
                                            marginBottom: 6
                                                    ...
                                                    fontWeight: 600,
                                                    color: '#1f2937'
                                                }, children: format.name }), format.vfxCompatible && (_jsx("span", { style: {
                                                    ...
                                                    borderRadius: 4,
                                                    fontWeight: 500
                                                }, children: "VFX" }))] }), _jsx("div", { style: {
                                            fontSize: 12,
                                            color: '#6b7280',
                                            lineHeight: 1.4
                                        }, children: format.description })] }, format.id))) })] }, category))) })) : (
            /* Export Options */
            _jsxs("div", { style: { padding: 20 }, children: [_jsxs("div", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 12,
                            marginBottom: 20,
                            ...
                            borderRadius: 8
                                            ...
                                            fontSize: 14,
                                            color: '#64748b'
                                        }, children: selectedFormat.description })] })] }), _jsx("div", { style: { marginBottom: 20 }, children: _jsxs("div", { style: {
                                display: 'flex',
                                flexWrap: 'wrap',
                                gap: 16
                                        ...
                                        cursor: 'pointer',
                                        fontSize: 14
                                    }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.includeMetadata || false, onChange: (e) => setExportOptions(prev => prev ? {
                                                ...prev,
                                                includeMetadata: e.target.checked
                                            } : null), style: { accentColor: '#3b82f6' } }), "Include Metadata"] }), _jsxs("label", { style: {
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 6,
                                        cursor: 'pointer',
                                        fontSize: 14
                                    }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.includeExecutionPath || false, onChange: (e) => setExportOptions(prev => prev ? {
                                                ...prev,
                                                includeExecutionPath: e.target.checked
                                            } : null), style: { accentColor: '#3b82f6' } }), "Include Execution Path"] }), selectedFormat.category === 'report' && (_jsxs("label", { style: {
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 6,
                                        cursor: 'pointer',
                                        fontSize: 14
                                    }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.includeVarianceAnalysis || false, onChange: (e) => setExportOptions(prev => prev ? {
                                                ...prev,
                                                includeVarianceAnalysis: e.target.checked
                                            } : null), style: { accentColor: '#3b82f6' } }), "Include Variance Analysis"] }))] }) }), _jsxs("button", { onClick: () => setShowAdvancedOptions(!showAdvancedOptions), style: {
                            background: 'none',
                            ...
                            alignItems: 'center',
                            gap: 6
                        }, children: [_jsx("span", { children: showAdvancedOptions ? '▼' : '▶' }), "Advanced Options"] }), showAdvancedOptions && (_jsxs("div", { style: {
                            background: 'rgba(248, 250, 252, 0.8)',
                            border: '1px solid #e5e7eb',
                            borderRadius: 8,
                            padding: 16,
                            marginBottom: 20
                        }, children: [selectedFormat.vfxCompatible && (_jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("h5", { style: {
                                            margin: '0 0 8px 0',
                                            fontSize: 14,
                                            fontWeight: 600,
                                            color: '#374151'
                                        }, children: "\uD83E\uDD16 VFX Pipeline Settings" }), _jsxs("div", { style: {
                                            display: 'grid',
                                            ...
                                            gap: 12
                                                            ...
                                                            color: '#6b7280',
                                                            marginBottom: 4
                                                        }, children: "Target Pipeline" }), _jsxs("select", { value: exportOptions?.vfxOptions?.targetPipeline || 'stable-diffusion', onChange: (e) => setExportOptions(prev => prev ? {
                                                            ...prev,
                                                            vfxOptions: {
                                                                ...prev.vfxOptions,
                                                            ...
                                                            borderRadius: 4,
                                                            fontSize: 13
                                                        }, children: [_jsx("option", { value: "stable-diffusion", children: "Stable Diffusion" }), _jsx("option", { value: "midjourney", children: "Midjourney" }), _jsx("option", { value: "dalle", children: "DALL-E" }), _jsx("option", { value: "custom", children: "Custom" })] })] }), _jsxs("div", { children: [_jsx("label", { style: {
                                                            display: 'block',
                                                            fontSize: 12,
                                                            fontWeight: 500,
                                                            color: '#6b7280',
                                                            marginBottom: 4
                                                        }, children: "Resolution" }), _jsxs("select", { value: `${exportOptions?.vfxOptions?.resolution?.[0]}x${exportOptions?.vfxOptions?.resolution?.[1]}`, onChange: (e) => {
                                                            ...
                                                            borderRadius: 4,
                                                            fontSize: 13
                                                        }, children: [_jsx("option", { value: "1920x1080", children: "1920\u00D71080 (HD)" }), _jsx("option", { value: "2560x1440", children: "2560\u00D71440 (QHD)" }), _jsx("option", { value: "3840x2160", children: "3840\u00D72160 (4K)" }), _jsx("option", { value: "1024x1024", children: "1024\u00D71024 (Square)" })] })] })] })] })), selectedFormat.category === 'script' && (_jsxs("div", { children: [_jsx("h5", { style: {
                                            margin: '0 0 8px 0',
                                            fontSize: 14,
                                            fontWeight: 600,
                                            color: '#374151'
                                        }, children: "\uD83C\uDFAC Script Format Settings" }), _jsxs("div", { style: {
                                            display: 'flex',
                                            flexWrap: 'wrap',
                                            gap: 12
                                        }, children: [_jsxs("label", { style: {
                                                    ...
                                                    cursor: 'pointer',
                                                    fontSize: 13
                                                }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.filmOptions?.includeCharacterNotes || false, onChange: (e) => setExportOptions(prev => prev ? {
                                                            ...prev,
                                                            filmOptions: {
                                                                ...prev.filmOptions,
                                                                includeCharacterNotes: e.target.checked
                                                            }
                                                        } : null), style: { accentColor: '#3b82f6' } }), "Character Notes"] }), _jsxs("label", { style: {
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    gap: 6,
                                                    cursor: 'pointer',
                                                    fontSize: 13
                                                }, children: [_jsx("input", { type: "checkbox", checked: exportOptions?.filmOptions?.includeDirectorNotes || false, onChange: (e) => setExportOptions(prev => prev ? {
                                                            ...prev,
                                                            filmOptions: {
                                                                ...prev.filmOptions,
                                                                includeDirectorNotes: e.target.checked
                                                            }
                                                        } : null), style: { accentColor: '#3b82f6' } }), "Director Notes"] })] })] }))] })), _jsxs("div", { style: {
                            display: 'flex',
                            ...
                            gap: 12
                                    ...
                                    gap: 8
                                            ...
                                            } }), "Exporting..."] })) : (_jsxs(_Fragment, { children: ["\uD83D\uDCE4 Export ", selectedResults.length, " Result", selectedResults.length !== 1 ? 's' : ''] })) })] })] })), _jsx("style", { children: `
          @keyframes spin {
...
async function prepareExportPayload(results, options) {
