...
export const BadgeShowcase = ({ userId, variant = 'full', showProgressBars = true, enableNotifications = true, className = '' }) => {
    const { userBadges, availableBadges, recentUnlocks, getBadgesByCategory, _____getBadgesByTier, getNextBadges, getBadgeProgress, getStatistics, getLeaderboardPosition, markNotificationRead, clearAllNotifications, hasUnreadNotifications, isLoading } = useBadgeSystem({
        userId,
    ...
    const renderOverview = () => (_jsxs("div", { className: "badge-overview", children: [_jsxs("div", { className: "overview-stats", children: [_jsx(Card, { className: "stat-card level-card", children: _jsxs(CardContent, { className: "stat-content", children: [_jsx("div", { className: "stat-icon", children: _jsx(Crown, { className: "w-8 h-8 text-yellow-500" }) }), _jsxs("div", { className: "stat-info", children: [_jsx("div", { className: "stat-value", children: statistics?.level || 0 }), _jsx("div", { className: "stat-label", children: "Level" })] })] }) }), _jsx(Card, { className: "stat-card points-card", children: _jsxs(CardContent, { className: "stat-content", children: [_jsx("div", { className: "stat-icon", children: _jsx(Star, { className: "w-8 h-8 text-blue-500" }) }), _jsxs("div", { className: "stat-info", children: [_jsx("div", { className: "stat-value", children: statistics?.totalPoints || 0 }), _jsx("div", { className: "stat-label", children: "Points" })] })] }) }), _jsx(Card, { className: "stat-card badges-card", children: _jsxs(CardContent, { className: "stat-content", children: [_jsx("div", { className: "stat-icon", children: _jsx(Award, { className: "w-8 h-8 text-purple-500" }) }), _jsxs("div", { className: "stat-info", children: [_jsx("div", { className: "stat-value", children: statistics?.badgeCount || 0 }), _jsx("div", { className: "stat-label", children: "Badges" })] })] }) }), _jsx(Card, { className: "stat-card completion-card", children: _jsxs(CardContent, { className: "stat-content", children: [_jsx("div", { className: "stat-icon", children: _jsx(Target, { className: "w-8 h-8 text-green-500" }) }), _jsxs("div", { className: "stat-info", children: [_jsxs("div", { className: "stat-value", children: [statistics?.completionPercentage || 0, "%"] }), _jsx("div", { className: "stat-label", children: "Complete" })] })] }) })] }), leaderboardPosition > 0 && (_jsxs(Card, { className: "leaderboard-position", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "position-title", children: [_jsx(Trophy, { className: "w-5 h-5" }), "Leaderboard Position"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "position-display", children: [_jsxs("div", { className: "position-rank", children: ["#", leaderboardPosition] }), _jsx("div", { className: "position-subtitle", children: "Global Ranking" })] }) })] })), statistics && statistics.experience > 0 && (_jsxs(Card, { className: "experience-progress", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Level Progress" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "experience-info", children: [_jsxs("div", { className: "exp-values", children: [_jsxs("span", { children: ["Level ", statistics.level] }), _jsxs("span", { children: [statistics.experience, " XP"] })] }), _jsx(Progress, { value: (statistics.experience % 100), className: "exp-progress" })] }) })] }))] }));
    const renderBadgeGrid = (badges) => (_jsx("div", { className: "badge-grid", children: badges.map((badge, _____index) => {
            const isUnlocked = userBadges.some(ub => ub.badgeId === badge.id);
            const progress = getBadgeProgress(badge.id);
            return (_jsx(Card, { className: `badge-card ${isUnlocked ? 'unlocked' : 'locked'} ${getTierColor(badge.tier)}`, children: _jsxs(CardContent, { className: "badge-content", children: [_jsxs("div", { className: "badge-header", children: [_jsx("div", { className: `badge-icon ${getRarityColor(badge.rarity)}`, children: getBadgeIcon(badge.icon) }), _jsx("div", { className: "badge-tier", children: _jsx(Badge, { variant: "secondary", className: `tier-badge ${getTierColor(badge.tier)}`, children: badge.tier.toUpperCase() }) })] }), _jsxs("div", { className: "badge-info", children: [_jsx("div", { className: "badge-name", children: badge.name }), _jsx("div", { className: "badge-description", children: badge.description }), _jsxs("div", { className: "badge-points", children: [badge.points, " points"] })] }), !isUnlocked && showProgressBars && progress > 0 && (_jsxs("div", { className: "badge-progress", children: [_jsxs("div", { className: "progress-info", children: [_jsx("span", { children: "Progress" }), _jsxs("span", { children: [Math.round(progress), "%"] })] }), _jsx(Progress, { value: progress, className: "badge-progress-bar" })] })), !isUnlocked && (_jsxs("div", { className: "badge-requirements", children: [_jsx("div", { className: "requirements-title", children: "Requirements:" }), _jsx("ul", { className: "requirements-list", children: badge.requirements.map((req, i) => (_jsx("li", { children: req }, i))) })] })), isUnlocked && (_jsxs("div", { className: "badge-unlocked", children: [_jsxs("div", { className: "unlock-indicator", children: [_jsx(Award, { className: "w-4 h-4 text-green-500" }), _jsx("span", { children: "Unlocked" })] }), userBadges.find(ub => ub.badgeId === badge.id) && (_jsx("div", { className: "unlock-date", children: new Date(userBadges.find(ub => ub.badgeId === badge.id).unlockedAt).toLocaleDateString() }))] }))] }) }, badge.id));
        }) }));
    const renderNotifications = () => {
        if (recentUnlocks.length === 0)
            return null;
        return (_jsxs(Card, { className: "badge-notifications", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "notifications-header", children: [_jsxs(CardTitle, { children: [_jsx(Bell, { className: "w-5 h-5" }), "Recent Unlocks"] }), _jsx(Button, { variant: "ghost", size: "sm", onClick: clearAllNotifications, children: "Clear All" })] }) }), _jsx(CardContent, { children: _jsx("div", { className: "notifications-list", children: recentUnlocks.map((unlock, index) => {
                            const badge = availableBadges.find(b => b.id === unlock.badgeId);
                            if (!badge)
                                return null;
                            return (_jsxs("div", { className: "notification-item", children: [_jsxs("div", { className: "notification-content", children: [_jsx("div", { className: "notification-badge", children: getBadgeIcon(badge.icon) }), _jsxs("div", { className: "notification-info", children: [_jsx("div", { className: "notification-title", children: "Badge Unlocked!" }), _jsx("div", { className: "notification-badge-name", children: badge.name }), _jsxs("div", { className: "notification-points", children: ["+", badge.points, " points"] })] }), unlock.isLevelUp && (_jsxs("div", { className: "level-up-indicator", children: [_jsx(Crown, { className: "w-4 h-4" }), _jsxs("span", { children: ["Level ", unlock.newLevel, "!"] })] }))] }), _jsx(Button, { variant: "ghost", size: "sm", onClick: () => markNotificationRead(index), children: _jsx(X, { className: "w-4 h-4" }) })] }, index));
                        }) }) })] }));
    };
    const renderNextBadges = () => {
        ...
        if (nextBadges.length === 0)
            return null;
        return (_jsxs(Card, { className: "next-badges", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { children: [_jsx(Target, { className: "w-5 h-5" }), "Next to Unlock"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "next-badges-grid", children: nextBadges.map(badge => (_jsxs("div", { className: "next-badge-item", children: [_jsx("div", { className: "next-badge-icon", children: getBadgeIcon(badge.icon) }), _jsxs("div", { className: "next-badge-info", children: [_jsx("div", { className: "next-badge-name", children: badge.name }), _jsxs("div", { className: "next-badge-progress", children: [_jsx(Progress, { value: badge.progress, className: "mini-progress" }), _jsxs("span", { className: "progress-text", children: [Math.round(badge.progress), "%"] })] })] })] }, badge.id))) }) })] }));
    };
