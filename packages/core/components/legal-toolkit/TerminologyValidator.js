...
export const TerminologyValidator = ({ text, onValidationResults, jurisdiction = 'Universal', practiceArea = 'General', autoValidate = true, className = '' }) => {
    ...
    const identifyLegalTerms = (tokens) => {
        ...
        tokens.forEach(token => {
            const isLegalTerm = LEGAL_TERMINOLOGY_DB.some(term => term.term.toLowerCase() === token.token.toLowerCase());
            if (isLegalTerm) {
                legalTerms.push({
                    term: token.token,
                    start: token.start,
        ...
        for (let i = 0; i < tokens.length - 1; i++) {
            ...
            const isLegalTerm = LEGAL_TERMINOLOGY_DB.some(term => term.term.toLowerCase() === twoWordTerm.toLowerCase());
            if (isLegalTerm) {
                legalTerms.push({
                    term: twoWordTerm,
        ...
        for (let i = 0; i < tokens.length - 2; i++) {
            ...
            const _____isLegalTerm = LEGAL_TERMINOLOGY_DB.some(term => term.term.toLowerCase() === threeWordTerm.toLowerCase());
            if (threeWordTerm) {
                legalTerms.push({
                    term: threeWordTerm,
                    start: tokens[i].start,
    ...
    const validateTerm = async (termInfo, fullText, settings) => {
        const matchingTerms = LEGAL_TERMINOLOGY_DB.filter(dbTerm => dbTerm.term.toLowerCase() === termInfo.term.toLowerCase());
    ...
    const findAlternativeTerms = (term, settings) => {
        return LEGAL_TERMINOLOGY_DB
            .filter(dbTerm => dbTerm.jurisdiction === settings.jurisdiction || dbTerm.jurisdiction === 'Universal')
            .filter(dbTerm => dbTerm.alternatives?.some(alt => alt.toLowerCase().includes(term.toLowerCase())) ||
    ...
    return (_jsxs("div", { className: `terminology-validator ${className}`, children: [_jsx("style", { children: `
        ...
        ` }), _jsxs("div", { className: "validator-header", children: [_jsx("h2", { className: "validator-title", children: "Legal Terminology Validation" }), (jurisdiction !== 'Universal' || practiceArea !== 'General') && (_jsxs("div", { className: "validator-info", children: [jurisdiction !== 'Universal' && (_jsxs("span", { className: "info-item", children: ["Jurisdiction: ", jurisdiction] })), practiceArea !== 'General' && (_jsxs("span", { className: "info-item", children: ["Practice Area: ", practiceArea] }))] })), _jsxs("div", { className: "validator-controls", children: [_jsx("button", { className: "validate-btn", onClick: validateTerminology, disabled: isValidating || !text, children: isValidating ? 'Validating...' : 'Validate Terms' }), _jsx("button", { className: "settings-btn", onClick: () => setShowSettings(!showSettings), children: "\u2699\uFE0F Settings" }), isValidating && (_jsx("div", { className: "progress-container", children: _jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: { width: `${validationProgress}%` } }) }) }))] }), validationResults.length > 0 && (_jsxs("div", { className: "validation-summary", children: [_jsxs("div", { className: "summary-card", children: [_jsx("div", { className: "summary-number", style: { color: '#4299e1' }, children: summary.total }), _jsx("div", { className: "summary-label", children: "Total Terms" })] }), _jsxs("div", { className: "summary-card", children: [_jsx("div", { className: "summary-number", style: { color: '#48bb78' }, children: summary.valid }), _jsx("div", { className: "summary-label", children: "Valid" })] }), _jsxs("div", { className: "summary-card", children: [_jsx("div", { className: "summary-number", style: { color: '#f56565' }, children: summary.invalid }), _jsx("div", { className: "summary-label", children: "Issues Found" })] }), _jsxs("div", { className: "summary-card", children: [_jsxs("div", { className: "summary-number", style: { color: '#ed8936' }, children: [summary.total > 0 ? Math.round((summary.valid / summary.total) * 100) : 0, "%"] }), _jsx("div", { className: "summary-label", children: "Accuracy" })] })] }))] }), showSettings && (_jsx("div", { className: "settings-panel", children: _jsxs("div", { className: "settings-grid", children: [_jsxs("div", { className: "setting-group", children: [_jsx("label", { className: "setting-label", children: "Jurisdiction" }), _jsxs("select", { className: "setting-input", value: settings.jurisdiction, onChange: (e) => setSettings(prev => ({ ...prev, jurisdiction: e.target.value })), children: [_jsx("option", { value: "Universal", children: "Universal" }), _jsx("option", { value: "United States", children: "United States" }), _jsx("option", { value: "European Union", children: "European Union" }), _jsx("option", { value: "United Kingdom", children: "United Kingdom" }), _jsx("option", { value: "Canada", children: "Canada" }), _jsx("option", { value: "Australia", children: "Australia" })] })] }), _jsxs("div", { className: "setting-group", children: [_jsx("label", { className: "setting-label", children: "Practice Area" }), _jsxs("select", { className: "setting-input", value: settings.practiceArea, onChange: (e) => setSettings(prev => ({ ...prev, practiceArea: e.target.value })), children: [_jsx("option", { value: "General", children: "General" }), _jsx("option", { value: "Contract Law", children: "Contract Law" }), _jsx("option", { value: "Tort Law", children: "Tort Law" }), _jsx("option", { value: "Constitutional Law", children: "Constitutional Law" }), _jsx("option", { value: "Privacy Law", children: "Privacy Law" }), _jsx("option", { value: "Corporate Law", children: "Corporate Law" }), _jsx("option", { value: "Employment Law", children: "Employment Law" })] })] }), _jsxs("div", { className: "setting-group", children: [_jsx("label", { className: "setting-label", children: "Validation Strictness" }), _jsxs("select", { className: "setting-input", value: settings.strictness, onChange: (e) => setSettings(prev => ({ ...prev, strictness: e.target.value })), children: [_jsx("option", { value: "lenient", children: "Lenient" }), _jsx("option", { value: "moderate", children: "Moderate" }), _jsx("option", { value: "strict", children: "Strict" })] })] }), _jsx("div", { className: "setting-group", children: _jsxs("label", { className: "setting-checkbox", children: [_jsx("input", { type: "checkbox", checked: settings.checkConsistency, onChange: (e) => setSettings(prev => ({ ...prev, checkConsistency: e.target.checked })) }), "Check Consistency"] }) })] }) })), _jsxs("div", { className: "validator-content", children: [_jsx("div", { className: "text-panel", children: _jsx("div", { className: "highlighted-text", ref: textRef, dangerouslySetInnerHTML: { __html: highlightedText } }) }), _jsxs("div", { className: "results-panel", children: [_jsxs("div", { className: "results-title", children: ["Validation Results (", validationResults.length, ")"] }), validationResults.length > 0 ? (validationResults.map((result, index) => (_jsxs("div", { className: `result-item ${result.isValid ? 'valid' : 'invalid'} ${selectedResult === result ? 'selected' : ''}`, onClick: () => setSelectedResult(result), children: [_jsx("div", { className: "result-term", children: result.term }), _jsxs("div", { className: "result-confidence", children: ["Confidence: ", Math.round(result.confidence * 100), "%"] }), _jsxs("div", { className: "result-context", children: ["\"", result.context, "\""] }), result.suggestions.length > 0 && (_jsxs("div", { className: "result-suggestions", children: ["Suggestions: ", result.suggestions.map(s => s.term).join(', ')] }))] }, index)))) : (_jsxs("div", { className: "no-results", children: [_jsx("div", { className: "no-results-icon", children: "\uD83D\uDCD6" }), _jsx("div", { children: text
