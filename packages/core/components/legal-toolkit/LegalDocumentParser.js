...
export const LegalDocumentParser = ({ onDocumentParsed, supportedTypes = ['contract', 'policy', 'regulation', 'agreement', 'statute'], maxFileSize = 10 * 1024 * 1024, // 10MB default
className = '' }) => {
    ...
    return (_jsxs("div", { className: `legal-document-parser ${className}`, children: [_jsx("style", { children: `
        ...
        ` }), _jsxs("div", { className: `upload-area ${dragActive ? 'drag-active' : ''} ${isProcessing ? 'processing' : ''}`, onDragEnter: handleDragEnter, onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop, onClick: !isProcessing ? openFileDialog : undefined, children: [_jsx("input", { ref: fileInputRef, type: "file", className: "file-input", onChange: handleFileInputChange, accept: ".pdf,.docx,.doc,.txt,.rtf" }), isProcessing ? (_jsxs("div", { className: "processing-overlay", children: [_jsx("div", { className: "spinner" }), _jsx("div", { className: "progress-container", children: _jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: { width: `${uploadProgress}%` } }) }) }), _jsx("div", { className: "processing-status", children: processingStatus })] })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "upload-icon", children: "\uD83D\uDCC4" }), _jsx("div", { className: "upload-text", children: dragActive ? 'Drop your document here' : 'Click or drag document to upload' }), _jsxs("div", { className: "upload-subtext", children: ["Supports PDF, Word, RTF, and plain text files (max ", Math.round(maxFileSize / (1024 * 1024)), "MB)"] })] }))] }), error && (_jsx("div", { className: "error-message", children: error })), _jsxs("div", { className: "supported-types", children: [_jsx("h4", { children: "Supported Document Types" }), _jsx("div", { className: "types-grid", children: supportedTypes.map(type => (_jsx("div", { className: "type-tag", children: type.replace('_', ' ').toUpperCase() }, type))) })] })] }));
};
