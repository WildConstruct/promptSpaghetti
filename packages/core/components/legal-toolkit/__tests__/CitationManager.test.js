...
describe('CitationManager Component', () => {
    const mockOnCitationAdd = jest.fn();
    const mockOnCitationEdit = jest.fn();
    const mockOnCitationDelete = jest.fn();
    beforeEach(() => {
        jest.clearAllMocks();
    });
    describe('Initial Rendering', () => {
        it('renders citation manager interface', () => {
            render(_jsx(CitationManager, { citations: [], onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
        ...
        it('displays existing citations', () => {
            render(_jsx(CitationManager, { citations: mockCitations, onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
    ...
    describe('Citation Display', () => {
        ...
        it('shows different citation styles correctly', () => {
            const { rerender } = render(_jsx(CitationManager, { citations: mockCitations, onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
            expect(screen.getByText(/Bluebook Style/i)).toBeInTheDocument();
            rerender(_jsx(CitationManager, { citations: mockCitations, onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "alwd" }));
    ...
    describe('Adding Citations', () => {
        ...
        it('fills and submits add citation form', async () => {
            ...
            expect(mockOnCitationAdd).toHaveBeenCalledWith(expect.objectContaining({
                type: 'bluebook',
    ...
    describe('Citation Formatting', () => {
        ...
        it('displays pinpoint citations when available', () => {
            const citationWithPinpoint = [{
                    ...mockCitations[0],
                    pinpoint: 'at 495'
                }];
            render(_jsx(CitationManager, { citations: citationWithPinpoint, onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
    ...
    describe('Error Handling', () => {
        it('handles invalid citation data gracefully', () => {
            ...
            render(_jsx(CitationManager, { citations: [invalidCitation], onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
        ...
        it('handles callback errors gracefully', async () => {
            ...
            const user = userEvent.setup();
            render(_jsx(CitationManager, { citations: [], onCitationAdd: errorCallback, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook" }));
            const addButton = screen.getByText(/Add New Citation/i);
            await user.click(addButton);
    ...
    describe('Custom Class Names', () => {
        it('applies custom className correctly', () => {
            const { container } = render(_jsx(CitationManager, { citations: mockCitations, onCitationAdd: mockOnCitationAdd, onCitationEdit: mockOnCitationEdit, onCitationDelete: mockOnCitationDelete, citationStyle: "bluebook", className: "custom-citation-manager" }));
