...
describe('ComplianceChecker Component', () => {
    const mockOnComplianceResults = jest.fn();
    beforeEach(() => {
        jest.clearAllMocks();
    });
    describe('Initial Rendering', () => {
        it('renders compliance checker interface', () => {
            render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['gdpr', 'ccpa'], onComplianceResults: mockOnComplianceResults }));
        ...
        it('displays selected regulations', () => {
            render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['gdpr', 'ccpa', 'hipaa'], onComplianceResults: mockOnComplianceResults }));
        ...
        it('shows document information', () => {
            render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['gdpr'], onComplianceResults: mockOnComplianceResults }));
            expect(screen.getByText('Privacy Policy')).toBeInTheDocument();
        ...
        it('enables auto-check when specified', () => {
            render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['gdpr'], onComplianceResults: mockOnComplianceResults, autoCheck: true }));
    ...
    describe('Compliance Checking Process', () => {
        ...
        it('calls onComplianceResults when check completes', async () => {
            ...
            await user.click(startButton);
            await waitFor(() => {
                expect(mockOnComplianceResults).toHaveBeenCalledWith(expect.arrayContaining([
    ...
    describe('Error Handling', () => {
        it('handles compliance check errors gracefully', async () => {
            ...
            render(_jsx(ComplianceChecker, { document: errorDocument, regulations: ['gdpr'], onComplianceResults: mockOnComplianceResults }));
            const startButton = screen.getByText(/Start Compliance Check/i);
            await user.click(startButton);
            await waitFor(() => {
        ...
        it('handles unsupported regulations', () => {
            render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['unknown_regulation'], onComplianceResults: mockOnComplianceResults }));
    ...
    describe('Custom Class Names', () => {
        it('applies custom className correctly', () => {
            const { container } = render(_jsx(ComplianceChecker, { document: mockDocument, regulations: ['gdpr'], onComplianceResults: mockOnComplianceResults, className: "custom-compliance-checker" }));
