...
export const VFXChecklistTemplates = ({ templates = [], currentUser, onTemplateSelect, onTemplateCreate, onTemplateUpdate, onTemplateDelete, onTemplateClone, readonly = false, className = '' }) => {
...
const TemplateCard = ({ template, currentUser, isSelected, onSelect, onUse, onClone, onUpdate, onDelete, readonly = false }) => {
    ...
    return (_jsxs(Card, { className: `template-card cursor-pointer hover:shadow-lg transition-all ${isSelected ? 'ring-2 ring-blue-500' : ''} ${isBuiltIn ? 'border-blue-200 bg-blue-50' : ''}`, children: [_jsxs(CardHeader, { className: "pb-3", children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [getCategoryIcon(template.category), _jsx("h3", { className: "font-semibold text-sm truncate", children: template.name }), isBuiltIn && (_jsx(Badge, { variant: "secondary", className: "text-xs", children: "Built-in" })), template.isPublic && (_jsx(Badge, { variant: "secondary", className: "text-xs", children: "Public" }))] }), template.description && (_jsx("p", { className: "text-xs text-gray-600 line-clamp-2", children: template.description }))] }), _jsx("div", { className: "flex items-center gap-1 ml-2", children: _jsx(Button, { variant: "ghost", size: "sm", onClick: onSelect, children: _jsx(Eye, { className: "w-3 h-3" }) }) })] }), _jsxs("div", { className: "flex items-center gap-4 text-xs text-gray-500 mt-2", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Users, { className: "w-3 h-3" }), _jsxs("span", { children: [template.usageCount, " uses"] })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(CheckSquare, { className: "w-3 h-3" }), _jsxs("span", { children: [template.items.length, " items"] })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Clock, { className: "w-3 h-3" }), _jsxs("span", { children: [template.items.reduce((sum, item) => sum + (item.estimatedHours || 0), 0), "h"] })] })] })] }), isSelected && (_jsx(CardContent, { className: "pt-0 border-t", children: _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsxs("h4", { className: "text-sm font-medium mb-2", children: ["Template Items (", template.items.length, ")"] }), _jsxs("div", { className: "space-y-1 max-h-32 overflow-y-auto", children: [template.items.slice(0, 5).map((item, index) => (_jsxs("div", { className: "flex items-center gap-2 text-xs", children: [_jsx("div", { className: "w-2 h-2 rounded-full", style: {
                                                        backgroundColor: item.priority === 'critical' ? '#dc2626' :
                                                            item.priority === 'high' ? '#ef4444' :
                                                                item.priority === 'medium' ? '#f59e0b' : '#10b981'
                                                    } }), _jsx("span", { className: "truncate", children: item.title })] }, index))), template.items.length > 5 && (_jsxs("div", { className: "text-xs text-gray-500 italic", children: ["+", template.items.length - 5, " more items..."] }))] })] }), _jsxs("div", { className: "flex items-center justify-between pt-2 border-t", children: [_jsxs("div", { className: "text-xs text-gray-500", children: ["By ", template.createdBy.name] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Button, { variant: "default", size: "sm", onClick: onUse, children: "Use Template" }), onClone && (_jsx(Button, { variant: "outline", size: "sm", onClick: onClone, children: _jsx(Copy, { className: "w-3 h-3" }) })), !readonly && isOwner && onUpdate && (_jsx(Button, { variant: "outline", size: "sm", children: _jsx(Edit3, { className: "w-3 h-3" }) })), !readonly && isOwner && onDelete && !isBuiltIn && (_jsx(Button, { variant: "outline", size: "sm", onClick: () => onDelete(template.id), children: _jsx(Trash2, { className: "w-3 h-3" }) }))] })] })] }) }))] }));
};
