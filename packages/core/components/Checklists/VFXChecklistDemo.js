...
import VFXChecklistSystem from './VFXChecklistSystem.js';
import VFXChecklistTemplates from './VFXChecklistTemplates.js';
...
export const VFXChecklistDemo = ({ title = 'Wild Construct VFX Checklist System', showTemplates = true, showAnalytics = true, showTeamPanel = true, initialUser = DEMO_TEAM[0], className = '' }) => {
    // State management
    ...
    const analytics = useMemo(() => {
        ...
        const overdue = items.filter(item => item.dueDate && new Date(item.dueDate) < new Date() && item.status !== 'approved').length;
    ...
    const handleItemUpdate = useCallback((itemId, updates) => {
        setChecklist(prev => ({
            ...
            metadata: {
                ...prev.metadata,
                completedItems: prev.items.filter(item => item.id === itemId ? updates.status === 'approved' : item.status === 'approved').length,
                lastActivity: new Date().toISOString()
            }
        }));
    }, []);
    ...
    return (_jsx("div", { className: `vfx-checklist-demo ${className}`, children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(CheckSquare, { className: "w-6 h-6 text-blue-600" }), _jsxs("div", { children: [_jsx("span", { className: "text-xl", children: title }), _jsx("div", { className: "text-sm text-gray-500 mt-1", children: "Professional VFX Workflow Management" })] }), _jsx(Badge, { variant: "secondary", className: "ml-2", children: "Wild Construct v2.0" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs(Select, { value: currentUser.id, onValueChange: (userId) => {
                                                const user = DEMO_TEAM.find(u => u.id === userId);
                                                if (user)
                                                    setCurrentUser(user);
                                            }, children: [_jsx(SelectTrigger, { className: "w-48", children: _jsx(SelectValue, {}) }), _jsx(SelectContent, { children: DEMO_TEAM.map(user => (_jsx(SelectItem, { value: user.id, children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: `w-2 h-2 rounded-full ${user.isOnline ? 'bg-green-500' : 'bg-gray-400'}` }), _jsx("span", { children: user.name }), _jsx(Badge, { variant: "outline", className: "text-xs ml-1", children: user.role.replace('_', ' ') })] }) }, user.id))) })] }), _jsxs(Button, { variant: "outline", size: "sm", children: [_jsx(Download, { className: "w-4 h-4 mr-2" }), "Export"] })] })] }), showStatistics && (_jsxs("div", { className: "grid grid-cols-2 md:grid-cols-6 gap-3 mt-4", children: [_jsxs("div", { className: "bg-blue-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-blue-900", children: analytics.totalItems }), _jsx("div", { className: "text-xs text-blue-700", children: "Total Items" })] }), _jsxs("div", { className: "bg-green-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-green-900", children: analytics.completedItems }), _jsx("div", { className: "text-xs text-green-700", children: "Completed" })] }), _jsxs("div", { className: "bg-amber-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-amber-900", children: analytics.inProgressItems }), _jsx("div", { className: "text-xs text-amber-700", children: "In Progress" })] }), _jsxs("div", { className: "bg-red-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-red-900", children: analytics.criticalItems }), _jsx("div", { className: "text-xs text-red-700", children: "Critical" })] }), _jsxs("div", { className: "bg-purple-50 p-3 rounded-lg text-center", children: [_jsxs("div", { className: "text-lg font-bold text-purple-900", children: [Math.round(analytics.completionRate), "%"] }), _jsx("div", { className: "text-xs text-purple-700", children: "Complete" })] }), _jsxs("div", { className: "bg-gray-50 p-3 rounded-lg text-center", children: [_jsx("div", { className: "text-lg font-bold text-gray-900", children: analytics.overdue }), _jsx("div", { className: "text-xs text-gray-700", children: "Overdue" })] })] })), _jsxs("div", { className: "flex items-center gap-4 mt-4 pt-4 border-t", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Switch, { checked: autoRefresh, onCheckedChange: setAutoRefresh, id: "auto-refresh" }), _jsx("label", { htmlFor: "auto-refresh", className: "text-sm", children: "Auto-refresh" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Switch, { checked: showCompactView, onCheckedChange: setShowCompactView, id: "compact-view" }), _jsx("label", { htmlFor: "compact-view", className: "text-sm", children: "Compact View" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Switch, { checked: showStatistics, onCheckedChange: setShowStatistics, id: "show-stats" }), _jsx("label", { htmlFor: "show-stats", className: "text-sm", children: "Show Statistics" })] })] })] }), _jsx(CardContent, { children: _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [_jsxs(TabsList, { className: "grid w-full grid-cols-4", children: [_jsxs(TabsTrigger, { value: "checklist", className: "flex items-center gap-2", children: [_jsx(CheckSquare, { className: "w-4 h-4" }), "Checklist"] }), showTemplates && (_jsxs(TabsTrigger, { value: "templates", className: "flex items-center gap-2", children: [_jsx(FileText, { className: "w-4 h-4" }), "Templates"] })), showAnalytics && (_jsxs(TabsTrigger, { value: "analytics", className: "flex items-center gap-2", children: [_jsx(BarChart3, { className: "w-4 h-4" }), "Analytics"] })), showTeamPanel && (_jsxs(TabsTrigger, { value: "team", className: "flex items-center gap-2", children: [_jsx(Users, { className: "w-4 h-4" }), "Team"] }))] }), _jsx(TabsContent, { value: "checklist", className: "mt-6", children: _jsx(VFXChecklistSystem, { checklist: checklist, currentUser: currentUser, onChecklistUpdate: handleChecklistUpdate, onItemCreate: handleItemCreate, onItemUpdate: handleItemUpdate, onItemDelete: handleItemDelete, onCommentCreate: handleCommentCreate, showStatistics: showStatistics, compactView: showCompactView }) }), showTemplates && (_jsx(TabsContent, { value: "templates", className: "mt-6", children: _jsx(VFXChecklistTemplates, { templates: customTemplates, currentUser: currentUser, onTemplateSelect: handleTemplateSelect }) })), showAnalytics && (_jsx(TabsContent, { value: "analytics", className: "mt-6", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-sm flex items-center gap-2", children: [_jsx(Target, { className: "w-4 h-4" }), "Status Distribution"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: Object.entries(analytics.statusDistribution).map(([status, count]) => (_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("span", { className: "text-sm capitalize", children: status.replace('_', ' ') }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-12 h-2 rounded-full bg-gray-200", children: _jsx("div", { className: "h-full rounded-full bg-blue-500", style: { width: `${(count / analytics.totalItems) * 100}%` } }) }), _jsx("span", { className: "text-sm font-medium w-6", children: count })] })] }, status))) }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-sm flex items-center gap-2", children: [_jsx(TrendingUp, { className: "w-4 h-4" }), "Performance Metrics"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-sm", children: "Estimated Hours:" }), _jsxs("span", { className: "font-medium", children: [analytics.totalEstimated, "h"] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-sm", children: "Actual Hours:" }), _jsxs("span", { className: "font-medium", children: [analytics.totalActual, "h"] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-sm", children: "Efficiency:" }), _jsxs("span", { className: `font-medium ${analytics.efficiency >= 0 ? 'text-green-600' : 'text-red-600'}`, children: [analytics.efficiency >= 0 ? '+' : '', analytics.efficiency.toFixed(1), "%"] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("span", { className: "text-sm", children: "Completion Rate:" }), _jsxs("span", { className: "font-medium", children: [analytics.completionRate.toFixed(1), "%"] })] })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-sm flex items-center gap-2", children: [_jsx(AlertTriangle, { className: "w-4 h-4" }), "Priority Analysis"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: Object.entries(analytics.priorityDistribution).map(([priority, count]) => {
                                                            const color = priority === 'critical' ? 'bg-red-500' :
                                                                priority === 'high' ? 'bg-orange-500' :
                                                                    priority === 'medium' ? 'bg-yellow-500' : 'bg-green-500';
                                                            return (_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("span", { className: "text-sm capitalize", children: priority }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-12 h-2 rounded-full bg-gray-200", children: _jsx("div", { className: `h-full rounded-full ${color}`, style: { width: `${(count / analytics.totalItems) * 100}%` } }) }), _jsx("span", { className: "text-sm font-medium w-6", children: count })] })] }, priority));
                                                        }) }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-sm flex items-center gap-2", children: [_jsx(Activity, { className: "w-4 h-4" }), "Team Activity"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: DEMO_TEAM.slice(0, 4).map(member => {
