...
return (_jsxs("div", { role: "button", "data-testid": `node-${id}`, tabIndex: 0, onClick: (e) => {
    ...
    })(), children: [_jsxs("div", { style: headerStyle, children: [_jsx("span", { style: { fontSize: 16, filter: 'drop-shadow(0 1px 1px rgba(0,0,0,0.3))' }, children: typeof nodeMeta.icon === 'string' ? nodeMeta.icon : '🔧' }), _jsx("span", { style: { letterSpacing: '0.01em' }, children: nodeMeta.label }), hasVariations && (_jsx("div", { style: variationBadgeStyle, title: `${data.variations.length} variations`, children: data.variations.length }))] }), _jsxs("div", { style: contentStyle, children: [_jsx("div", { style: titleStyle, children: data?.label || nodeMeta.label || nodeType || id }), properties.length > 0 && (_jsx("div", { style: propertiesStyle, children: properties.map(([k, v], idx) => (_jsxs("div", { style: {
                            marginBottom: idx < properties.length - 1 ? '3px' : 0,
                            opacity: 0.8
                        }, children: [_jsxs("span", { style: {
                                    color: professionalColors.text.tertiary,
                                    fontWeight: 500
                                }, children: [k, ":"] }), ' ', _jsx("span", { style: { color: professionalColors.text.secondary }, children: String(v).length > 22 ? String(v).slice(0, 22) + '…' : String(v) })] }, k))) }))] }), _jsx(Handle, { type: "target", position: Position.Left, id: "target", style: inputHandleStyle, isConnectable: true }), _jsx(Handle, { type: "source", position: Position.Right, id: "source", style: outputHandleStyle, isConnectable: true })] }));
try { }
catch (error) {
