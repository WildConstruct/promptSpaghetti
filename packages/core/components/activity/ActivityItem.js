...
export const ActivityItem = ({ activity, onClick, compact = false, showProject = true, isLast = false, }) => {
    ...
    return (_jsxs("div", { className: `activity-item ${compact ? 'activity-item--compact' : ''} ${onClick ? 'activity-item--clickable' : ''} ${isLast ? 'activity-item--last' : ''}`, onClick: onClick, children: [_jsx("div", { className: "activity-item__icon", children: icon }), _jsxs("div", { className: "activity-item__content", children: [_jsxs("div", { className: "activity-item__header", children: [_jsx("div", { className: "activity-item__title", children: title }), _jsx("div", { className: "activity-item__time", children: formatTime(new Date(activity.created_at)) })] }), description && (_jsx("div", { className: "activity-item__description", children: description })), showProject && activity.project_name && (_jsxs("div", { className: "activity-item__context", children: [_jsxs("span", { className: "activity-item__project", children: ["\uD83D\uDCC1 ", activity.project_name] }), activity.resource_name && (_jsxs("span", { className: "activity-item__resource", children: ["\u2022 ", activity.resource_name] }))] })), !compact && (_jsxs("div", { className: "activity-item__meta", children: [_jsx("span", { className: "activity-item__event-type", children: activity.event_type }), activity.aggregation_key && (_jsx("span", { className: "activity-item__group", children: "Grouped" }))] }))] })] }));
};
