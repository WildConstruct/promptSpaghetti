...
export interface ProfessionalSpinnerProps { size?: 'small' | 'medium' | 'large' | 'xl';
...
export const ProfessionalSpinner: React.FC<ProfessionalSpinnerProps> = ({ )
  ...
  const renderSpinner = () => { switch (type) {
    case 'spinner':
      return;
        <div
          style={{
...
export interface InlineLoaderProps { loading: boolean;
  size?: 'small' | 'medium';
  text?: string;
