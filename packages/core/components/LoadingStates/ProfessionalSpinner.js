...
export const ProfessionalSpinner = ({ size = 'medium', variant = 'primary', type = 'spinner', message, progress }) => {
    ...
    const renderSpinner = () => {
        switch (type) {
            ...
            case 'dots':
                return (_jsx("div", { className: "spinner-dots", style: { gap: spinnerSize / 4 }, children: [0, 1, 2].map((i) => (_jsx("div", { className: "dot", style: {
                            width: spinnerSize / 3,
    ...
    return (_jsxs("div", { style: containerStyle, children: [renderSpinner(), message && (_jsx("div", { style: {
                    fontSize: textSize,
                    color: '#9ca3af',
                    textAlign: 'center',
                    fontWeight: 500,
                ...
                }, children: message })), typeof progress === 'number' && (_jsxs("div", { style: {
                    width: spinnerSize * 2,
                    height: 4,
...
export const LoadingOverlay = ({ visible, message, progress, variant = 'primary', backdrop = 'blur', onCancel }) => {
    if (!visible)
        return null;
    ...
    return (_jsx("div", { style: getBackdropStyle(), children: _jsxs("div", { style: {
                ...
                minWidth: 200,
                textAlign: 'center'
            }, children: [_jsx(ProfessionalSpinner, { size: "large", variant: variant, type: "spinner", message: message, progress: progress }), onCancel && (_jsx("button", { onClick: onCancel, style: {
                        marginTop: 20,
...
export const InlineLoader = ({ loading, size = 'medium', text, children }) => {
    if (!loading) {
