...
import { FiDownload, FiFile, FiClock, FiBarChart3, FiPlus, FiRefreshCw } from 'react-icons/fi';
export const ExportManager = ({ projectId, className = '' }) => {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            ...
            case 'jobs':
                return (_jsx(ExportJobList, { jobs: jobs, onCancel: cancelExportJob, onRefresh: fetchJobs, loading: loading, error: error }));
            case 'statistics':
