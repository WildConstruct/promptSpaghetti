...
interface VFXExportPreviewProps {
  ...
  export const VFXExportPreview: React.FC<VFXExportPreviewProps> = ({,)
  exportData,
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-white">
                VFX Pipeline v{previewData.metadata?.version}
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
  ...
  description: 'Compatible with professional rendering engines',
            ...
            { 
              ...
              description: 'Can reproduce identical results with same seed'].map((item) => (),
