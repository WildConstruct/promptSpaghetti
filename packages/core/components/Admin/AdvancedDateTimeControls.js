...
export const AdvancedDateTimeControls = ({ value, onChange, businessHours, onBusinessHoursChange, conflictDetection = true, smartSuggestions = true, allowPastDates = false, className = '' }) => {
    ...
    const filteredTimezones = useMemo(() => {
        ...
        Object.entries(TIMEZONE_GROUPS).forEach(([group, timezones]) => {
            const matchingTimezones = timezones.filter(tz => tz.label.toLowerCase().includes(query) ||
    ...
    return (_jsx("div", { className: `space-y-4 ${className}`, children: _jsxs(Tabs, { value: currentTab, onValueChange: setCurrentTab, className: "w-full", children: [_jsxs(TabsList, { className: "grid w-full grid-cols-4", children: [_jsx(TabsTrigger, { value: "datetime", children: "Date & Time" }), _jsx(TabsTrigger, { value: "timezone", children: "Timezone" }), _jsx(TabsTrigger, { value: "business", children: "Business Hours" }), _jsx(TabsTrigger, { value: "preview", children: "Preview" })] }), _jsxs(TabsContent, { value: "datetime", className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Calendar, { className: "h-4 w-4" }), "Select Date"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [_jsx(Input, { type: "date", value: selectedDate.toISOString().split('T')[0], onChange: (e) => handleDateChange(new Date(e.target.value)), min: allowPastDates ? undefined : new Date().toISOString().split('T')[0] }), _jsx("p", { className: "text-sm text-gray-600", children: formatDisplayDate(selectedDate) })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Clock, { className: "h-4 w-4" }), "Select Time"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-3", children: [_jsx(Select, { value: selectedTime, onValueChange: handleTimeChange, children: timeOptions.map(time => (_jsx("option", { value: time, children: formatDisplayTime(time) }, time))) }), _jsx("p", { className: "text-sm text-gray-600", children: formatDisplayTime(selectedTime) })] }) })] })] }), smartTimeSuggestions.length > 0 && (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Zap, { className: "h-4 w-4" }), "Smart Suggestions"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "flex flex-wrap gap-2", children: smartTimeSuggestions.map((suggestion, index) => (_jsx(Button, { variant: "outline", size: "sm", onClick: () => {
                                                setSelectedDate(suggestion);
                                                setSelectedTime(`${suggestion.getHours().toString().padStart(2, '0')}:${suggestion.getMinutes().toString().padStart(2, '0')}`);
                                            }, children: formatDisplayTime(`${suggestion.getHours().toString().padStart(2, '0')}:${suggestion.getMinutes().toString().padStart(2, '0')}`) }, index))) }) })] })), conflictDetection && (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [conflictInfo.hasConflict ? (_jsx(AlertTriangle, { className: "h-4 w-4 text-orange-600" })) : (_jsx(CheckCircle, { className: "h-4 w-4 text-green-600" })), "Conflict Detection"] }) }), _jsx(CardContent, { children: conflictInfo.hasConflict ? (_jsxs("div", { className: "space-y-2", children: [_jsxs(Badge, { variant: conflictInfo.severity === 'high' ? 'destructive' : 'default', children: [conflictInfo.severity, " priority"] }), _jsx("p", { className: "text-gray-900", children: conflictInfo.description }), conflictInfo.suggestion && (_jsx("p", { className: "text-sm text-blue-600", children: conflictInfo.suggestion }))] })) : (_jsx("p", { className: "text-green-600", children: "No conflicts detected" })) })] }))] }), _jsx(TabsContent, { value: "timezone", className: "space-y-4", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Globe, { className: "h-4 w-4" }), "Select Timezone"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-4", children: [_jsx("div", { className: "relative", children: _jsx(Input, { placeholder: "Search timezones...", value: timezoneSearchQuery, onChange: (e) => setTimezoneSearchQuery(e.target.value) }) }), _jsxs("div", { className: "p-3 border rounded-lg bg-blue-50", children: [_jsxs("p", { className: "font-medium", children: ["Current: ", selectedTimezone] }), _jsx("p", { className: "text-sm text-gray-600", children: TIMEZONE_GROUPS.Popular.find(tz => tz.value === selectedTimezone)?.label })] }), _jsx("div", { className: "space-y-3", children: Object.entries(filteredTimezones).map(([group, timezones]) => (_jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 mb-2", children: group }), _jsx("div", { className: "space-y-1", children: timezones.map((timezone) => (_jsx("button", { className: `w-full text-left p-2 rounded border hover:bg-gray-50 ${selectedTimezone === timezone.value ? 'bg-blue-50 border-blue-300' : ''}`, onClick: () => handleTimezoneChange(timezone.value), children: _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "font-medium", children: timezone.label }), _jsx(Badge, { variant: "outline", className: "text-xs", children: timezone.offset })] }) }, timezone.value))) })] }, group))) })] }) })] }) }), _jsx(TabsContent, { value: "business", className: "space-y-4", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Building, { className: "h-4 w-4" }), "Business Hours Configuration"] }) }), _jsxs(CardContent, { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("input", { type: "checkbox", id: "businessHoursEnabled", checked: currentBusinessHours.enabled, onChange: (e) => {
                                                    const newBusinessHours = { ...currentBusinessHours, enabled: e.target.checked };
                                                    setCurrentBusinessHours(newBusinessHours);
                                                    onBusinessHoursChange?.(newBusinessHours);
                                                } }), _jsx("label", { htmlFor: "businessHoursEnabled", className: "font-medium", children: "Enable business hours restrictions" })] }), currentBusinessHours.enabled && (_jsxs(_Fragment, { children: [_jsxs("div", { children: [_jsx("h4", { className: "font-medium mb-2", children: "Quick Presets" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2", children: COMMON_BUSINESS_HOURS.map((preset, index) => (_jsx(Button, { variant: "outline", size: "sm", onClick: () => applyBusinessHoursPreset(preset), children: preset.name }, index))) })] }), _jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Start Time" }), _jsx(Select, { value: currentBusinessHours.startTime, onValueChange: (time) => {
                                                                    const newBusinessHours = { ...currentBusinessHours, startTime: time };
                                                                    setCurrentBusinessHours(newBusinessHours);
                                                                    onBusinessHoursChange?.(newBusinessHours);
                                                                }, children: timeOptions.filter((_, index) => index % 4 === 0).map(time => (_jsx("option", { value: time, children: formatDisplayTime(time) }, time))) })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "End Time" }), _jsx(Select, { value: currentBusinessHours.endTime, onValueChange: (time) => {
                                                                    const newBusinessHours = { ...currentBusinessHours, endTime: time };
                                                                    setCurrentBusinessHours(newBusinessHours);
                                                                    onBusinessHoursChange?.(newBusinessHours);
                                                                }, children: timeOptions.filter((_, index) => index % 4 === 0).map(time => (_jsx("option", { value: time, children: formatDisplayTime(time) }, time))) })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium mb-2", children: "Working Days" }), _jsx("div", { className: "flex flex-wrap gap-2", children: WEEKDAY_NAMES.map((day, index) => (_jsxs("label", { className: "flex items-center space-x-1 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: currentBusinessHours.workdays.includes(index), onChange: (e) => {
                                                                        ...
                                                                        setCurrentBusinessHours(newBusinessHours);
                                                                        onBusinessHoursChange?.(newBusinessHours);
                                                                    } }), _jsx("span", { className: "text-sm", children: day })] }, index))) })] })] }))] })] }) }), _jsx(TabsContent, { value: "preview", className: "space-y-4", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Eye, { className: "h-4 w-4" }), "Schedule Preview"] }) }), _jsxs(CardContent, { className: "space-y-4", children: [_jsxs("div", { className: "p-4 border rounded-lg bg-gray-50", children: [_jsx("h4", { className: "font-medium mb-2", children: "Selected Date & Time" }), _jsxs("div", { className: "space-y-2", children: [_jsxs("p", { children: [_jsx("strong", { children: "Date:" }), " ", formatDisplayDate(selectedDate)] }), _jsxs("p", { children: [_jsx("strong", { children: "Time:" }), " ", formatDisplayTime(selectedTime)] }), _jsxs("p", { children: [_jsx("strong", { children: "Timezone:" }), " ", selectedTimezone] }), _jsxs("p", { children: [_jsx("strong", { children: "Full DateTime:" }), " ", dateTimeInTimezone.toISOString()] })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium mb-2", children: "Time in Other Zones" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2", children: TIMEZONE_GROUPS.Popular.slice(0, 4).map((tz) => {
                                                    ...
                                                    return (_jsxs("div", { className: "p-2 border rounded text-sm", children: [_jsx("p", { className: "font-medium", children: tz.value }), _jsx("p", { className: "text-gray-600", children: timeInZone })] }, tz.value));
                                                }) })] }), currentBusinessHours.enabled && (_jsxs("div", { children: [_jsx("h4", { className: "font-medium mb-2", children: "Business Hours Status" }), _jsx("div", { className: "p-3 border rounded-lg", children: conflictInfo.hasConflict ? (_jsxs("div", { className: "flex items-center gap-2 text-orange-600", children: [_jsx(AlertTriangle, { className: "h-4 w-4" }), _jsx("span", { children: "Outside business hours" })] })) : (_jsxs("div", { className: "flex items-center gap-2 text-green-600", children: [_jsx(CheckCircle, { className: "h-4 w-4" }), _jsx("span", { children: "Within business hours" })] })) })] }))] })] }) })] }) }));
};
