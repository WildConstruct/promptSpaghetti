...
export const UsageQuotaDashboard = ({ onQuotaCreate, onQuotaUpdate, onQuotaDelete, onViolationResolve, _____onQuotaOverride, className = '' }) => {
    // State management
...
const OverviewTab = ({ systemMetrics, _____quotas, _____violations, analytics }) => {
