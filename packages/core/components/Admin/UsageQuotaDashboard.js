...
export const UsageQuotaDashboard = ({ onQuotaCreate, onQuotaUpdate, onQuotaDelete, onViolationResolve, onQuotaOverride, className = '' }) => {
    // State management
    ...
    // Event handlers
    const handleQuotaCreate = async (quota) => {
        if (onQuotaCreate) {
...
const OverviewTab = ({ systemMetrics, quotas, violations, analytics }) => {
    return (_jsxs("div", { className: "overview-tab", children: [_jsxs("div", { className: "metrics-overview", children: [_jsxs("div", { className: "metric-card", children: [_jsxs("div", { className: "metric-header", children: [_jsx(Shield, { size: 20 }), _jsx("span", { children: "Total Quotas" })] }), _jsx("div", { className: "metric-value", children: systemMetrics.totalQuotas }), _jsxs("div", { className: "metric-detail", children: [systemMetrics.activeQuotas, " active, ", systemMetrics.totalQuotas - systemMetrics.activeQuotas, " disabled"] })] }), _jsxs("div", { className: "metric-card", children: [_jsxs("div", { className: "metric-header", children: [_jsx(AlertTriangle, { size: 20 }), _jsx("span", { children: "Violations" })] }), _jsx("div", { className: "metric-value text-red-600", children: systemMetrics.totalViolations }), _jsxs("div", { className: "metric-detail", children: [systemMetrics.activeViolations, " active violations"] })] }), _jsxs("div", { className: "metric-card", children: [_jsxs("div", { className: "metric-header", children: [_jsx(BarChart3, { size: 20 }), _jsx("span", { children: "Utilization Rate" })] }), _jsxs("div", { className: "metric-value text-blue-600", children: [systemMetrics.utilizationRate, "%"] }), _jsx("div", { className: "metric-detail", children: "Average across all quotas" })] }), _jsxs("div", { className: "metric-card", children: [_jsxs("div", { className: "metric-header", children: [_jsx(TrendingUp, { size: 20 }), _jsx("span", { children: "Usage Trend" })] }), _jsx("div", { className: "metric-value text-green-600", children: analytics.usageTrend === 'increasing' ? _jsx(TrendingUp, { size: 24 }) :
                                    analytics.usageTrend === 'decreasing' ? _jsx(TrendingDown, { size: 24 }) :
                                        _jsx(Activity, { size: 24 }) }), _jsxs("div", { className: "metric-detail", children: [Math.round(analytics.trendSignificance * 100), "% confidence"] })] })] }), _jsxs("div", { className: "top-violations-section", children: [_jsxs("h2", { children: [_jsx(AlertTriangle, { size: 20 }), "Top Violated Quotas"] }), _jsx("div", { className: "violations-list", children: systemMetrics.topViolatedQuotas.map(quota => (_jsxs("div", { className: "violation-item", children: [_jsxs("div", { className: "violation-info", children: [_jsx("span", { className: "quota-name", children: quota.quotaName }), _jsx("span", { className: `severity-badge ${quota.severity}`, children: quota.severity.toUpperCase() })] }), _jsxs("div", { className: "violation-stats", children: [_jsxs("span", { className: "violation-count", children: [quota.violationCount, " violations"] }), _jsxs("span", { className: "last-violation", children: ["Last: ", Math.floor((Date.now() - quota.lastViolation.getTime()) / 60000), "m ago"] })] })] }, quota.quotaId))) })] }), _jsxs("div", { className: "recent-activity-section", children: [_jsxs("h2", { children: [_jsx(Clock, { size: 20 }), "Recent Activity"] }), _jsx("div", { className: "activity-list", children: systemMetrics.recentActivity.map((activity, index) => (_jsxs("div", { className: "activity-item", children: [_jsx("div", { className: "activity-icon", children: activity.type === 'violation_occurred' ? _jsx(AlertCircle, { size: 16 }) :
                                        activity.type === 'quota_created' ? _jsx(Plus, { size: 16 }) :
                                            activity.type === 'quota_updated' ? _jsx(Edit2, { size: 16 }) :
                                                _jsx(CheckCircle, { size: 16 }) }), _jsxs("div", { className: "activity-content", children: [_jsx("div", { className: "activity-description", children: activity.description }), _jsxs("div", { className: "activity-time", children: [Math.floor((Date.now() - activity.timestamp.getTime()) / 60000), "m ago"] })] }), _jsx("div", { className: `activity-severity ${activity.severity}`, children: activity.severity })] }, index))) })] })] }));
};
// Additional tab components would be implemented here...
// QuotasTab, ViolationsTab, AnalyticsTab, TemplatesTab, OperationsTab
// Placeholder implementations
const QuotasTab = ({ quotas, onQuotaToggle }) => (_jsxs("div", { className: "quotas-tab", children: [_jsx("h2", { children: "Quotas Management" }), quotas.map((quota) => (_jsxs("div", { className: "quota-card", children: [_jsxs("div", { className: "quota-header", children: [_jsx("span", { className: "quota-name", children: quota.quotaName }), _jsx("button", { onClick: () => onQuotaToggle(quota.quotaId, !quota.enabled), className: `toggle-button ${quota.enabled ? 'enabled' : 'disabled'}`, children: quota.enabled ? _jsx(Play, { size: 16 }) : _jsx(Pause, { size: 16 }) })] }), _jsxs("div", { className: "quota-details", children: [_jsxs("span", { children: ["Type: ", quota.quotaType] }), _jsxs("span", { children: ["Limit: ", quota.limitValue.toLocaleString(), " ", quota.limitUnit, "/", quota.limitPeriod] }), _jsxs("span", { children: ["Enforcement: ", quota.enforcementAction] })] })] }, quota.quotaId)))] }));
const ViolationsTab = ({ violations }) => (_jsxs("div", { className: "violations-tab", children: [_jsx("h2", { children: "Violations Management" }), violations.map((violation) => (_jsxs("div", { className: "violation-card", children: [_jsxs("div", { className: "violation-header", children: [_jsx("span", { className: "violation-id", children: violation.violationId }), _jsx("span", { className: `severity-badge ${violation.severity}`, children: violation.severity })] }), _jsxs("div", { className: "violation-details", children: [_jsxs("span", { children: ["User: ", violation.userId] }), _jsxs("span", { children: ["Exceeded by: ", violation.exceededBy.toLocaleString()] }), _jsxs("span", { children: ["Status: ", violation.status] })] })] }, violation.violationId)))] }));
const AnalyticsTab = ({ analytics, systemMetrics }) => (_jsxs("div", { className: "analytics-tab", children: [_jsx("h2", { children: "Usage Analytics" }), _jsx("div", { className: "analytics-content", children: _jsxs("div", { className: "analytics-summary", children: [_jsxs("div", { className: "summary-card", children: [_jsx("span", { children: "Total Usage" }), _jsx("span", { className: "value", children: analytics[0]?.totalUsage?.toLocaleString() })] }), _jsxs("div", { className: "summary-card", children: [_jsx("span", { children: "Peak Usage" }), _jsx("span", { className: "value", children: analytics[0]?.peakUsage?.toLocaleString() })] }), _jsxs("div", { className: "summary-card", children: [_jsx("span", { children: "Unique Users" }), _jsx("span", { className: "value", children: analytics[0]?.uniqueUsers?.toLocaleString() })] })] }) })] }));
const TemplatesTab = ({ templates }) => (_jsxs("div", { className: "templates-tab", children: [_jsx("h2", { children: "Quota Templates" }), templates.map((template) => (_jsxs("div", { className: "template-card", children: [_jsxs("div", { className: "template-header", children: [_jsx("span", { className: "template-name", children: template.templateName }), _jsx("span", { className: "template-category", children: template.category })] }), _jsxs("div", { className: "template-details", children: [_jsxs("span", { children: ["Usage count: ", template.usageCount] }), _jsxs("span", { children: [template.quotaDefinitions.length, " quota definitions"] })] })] }, template.templateId)))] }));
const OperationsTab = ({ operations }) => (_jsxs("div", { className: "operations-tab", children: [_jsx("h2", { children: "Admin Operations" }), operations.map((operation) => (_jsxs("div", { className: "operation-card", children: [_jsxs("div", { className: "operation-header", children: [_jsx("span", { className: "operation-type", children: operation.operationType }), _jsx("span", { className: `status-badge ${operation.status}`, children: operation.status })] }), _jsxs("div", { className: "operation-details", children: [_jsxs("span", { children: ["Target: ", operation.targetType, "#", operation.targetId] }), _jsxs("span", { children: ["By: ", operation.adminUserId] }), _jsxs("span", { children: [Math.floor((Date.now() - operation.timestamp.getTime()) / 60000), "m ago"] })] })] }, operation.operationId)))] }));
