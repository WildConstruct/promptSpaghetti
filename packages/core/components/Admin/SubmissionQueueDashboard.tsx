      ...
      <div className="queue-header">
        <div className="header-content">
          ...
          <div className="header-actions">
            <Button onClick={loadSubmissionQueue} disabled={loading} variant="outline">
                  ...
                  {submissions.map(submission => (
                    <div key={submission.id} className="submission-row">
                        ...
                        {submission.validation_results.some(r => r.severity === 'error') && (
                          <div className="validation-warnings">
                            ...
                            <span className="text-red-600">
                              {submission.validation_results.filter(r => r.severity === 'error').length} validation
                              errors
                            </span>
                          </div>
                        )}
                      ...
                      <div className="submission-actions">
                        ...
                        <Button size="sm" onClick={() => window.open(`/admin/submissions/${submission.id}`, '_blank')}>
