      ...
      <div className="overview-header">
        <div className="item-info">
          <div className="item-type-badge">
            <Badge className={getTypeColor(reviewItem.type)}>{formatItemType(reviewItem.type)}</Badge>
          </div>
          <h2 className="item-title">{reviewItem.title}</h2>
          {reviewItem.description && <p className="item-description">{reviewItem.description}</p>}
        </div>
        <div className="item-metadata">
          <div className="metadata-grid">
            ...
            <div className="metadata-item">
              ...
              <Badge className={getPriorityColor(reviewItem.priority)}>{reviewItem.priority}</Badge>
            </div>
          ...
          <CardContent>
            <div className="verification-progress">
              <div className="progress-header">
                ...
                <span>
                  {reviewItem.verification_data.verification_criteria.filter(c => c.status === 'passed').length}/
                  {reviewItem.verification_data.verification_criteria.length} Complete
                </span>
              </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="graph-preview">
                    <pre className="graph-json">{JSON.stringify(reviewItem.template_data.graph_json, null, 2)}</pre>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    Validation Results
                    <Badge variant="outline">{reviewItem.template_data.validation_results.length} rules checked</Badge>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      {reviewItem.template_data.previous_reviews.map((review, index) => (
                        <div key={index} className="history-item">
                          <div className="review-meta">
                            <Badge className={`rating-${review.rating}`}>{review.rating}/5 stars</Badge>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant="outline">{reviewItem.verification_data.documents.length} files</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="documents-grid">
                {reviewItem.verification_data.documents.map(doc => (
            ...
            <div className="decision-options">
              ...
              <div className="overall-score">
                ...
                <div className="score-bar">
                  <div className="score-fill" style={{ width: `${calculateOverallScore()}%` }} />
                </div>
              </div>
            </div>
          </CardContent>
                    ...
                    <div className="category-header">
                      ...
                      <div className="rating-controls">
                        {[1, 2, 3, 4, 5].map(rating => (
                          <button
                            key={rating}
                            className={`rating-star ${existingFeedback?.rating >= rating ? 'active' : ''}`}
