...
export const PolicyEnforcementWorkflow = ({ className = '' }) => {
    ...
    const renderWorkflowsList = () => (_jsxs("div", { className: "workflows-section", children: [_jsxs("div", { className: "workflows-header", children: [_jsx("h3", { children: "Enforcement Workflows" }), _jsxs("div", { className: "header-actions", children: [_jsxs(Button, { variant: "outline", children: [_jsx(RefreshCw, { className: "w-4 h-4 mr-2" }), "Refresh"] }), _jsxs(Button, { onClick: () => setIsDesignerOpen(true), children: [_jsx(Workflow, { className: "w-4 h-4 mr-2" }), "Create Workflow"] })] })] }), _jsx("div", { className: "workflows-grid", children: workflows.map(workflow => (_jsxs(Card, { className: "workflow-card", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "workflow-header", children: [_jsxs("div", { className: "workflow-info", children: [_jsx("h4", { children: workflow.name }), _jsx("p", { children: workflow.description })] }), _jsx(Badge, { className: getStatusColor(workflow.status), children: workflow.status.toUpperCase() })] }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "workflow-details", children: [_jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Policy" }), _jsx("span", { className: "detail-value", children: workflow.policyName })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Steps" }), _jsx("span", { className: "detail-value", children: workflow.steps.length })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Executions" }), _jsx("span", { className: "detail-value", children: workflow.executionCount })] }), _jsxs("div", { className: "detail-item", children: [_jsx("span", { className: "detail-label", children: "Success Rate" }), _jsxs("span", { className: "detail-value", children: [workflow.successRate, "%"] })] })] }), _jsxs("div", { className: "workflow-steps-preview", children: [_jsx("h5", { children: "Workflow Steps" }), _jsxs("div", { className: "steps-flow", children: [workflow.steps.slice(0, 3).map((step, index) => {
                                                    const StepIcon = getStepIcon(step.type);
                                                    return (_jsxs(React.Fragment, { children: [_jsxs("div", { className: "step-preview", children: [_jsx(StepIcon, { className: "w-4 h-4" }), _jsx("span", { children: step.name })] }), index < Math.min(workflow.steps.length - 1, 2) && (_jsx(ArrowRight, { className: "w-3 h-3 text-gray-400" }))] }, step.stepId));
                                                }), workflow.steps.length > 3 && (_jsxs("span", { className: "more-steps", children: ["+", workflow.steps.length - 3, " more"] }))] })] }), _jsxs("div", { className: "workflow-actions", children: [_jsxs(Button, { onClick: () => setSelectedWorkflow(workflow), size: "sm", variant: "outline", children: [_jsx(Eye, { className: "w-4 h-4 mr-1" }), "View"] }), _jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(Edit3, { className: "w-4 h-4 mr-1" }), "Edit"] }), workflow.status === 'active' ? (_jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(Pause, { className: "w-4 h-4 mr-1" }), "Pause"] })) : (_jsxs(Button, { size: "sm", variant: "outline", children: [_jsx(Play, { className: "w-4 h-4 mr-1" }), "Start"] }))] })] })] }, workflow.workflowId))) })] }));
    const renderExecutionsList = () => (_jsx("div", { className: "executions-section", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Recent Executions" }) }), _jsx(CardContent, { children: _jsx("div", { className: "executions-list", children: executions.map(execution => (_jsxs("div", { className: "execution-item", children: [_jsxs("div", { className: "execution-main", children: [_jsxs("div", { className: "execution-info", children: [_jsxs("div", { className: "execution-title", children: [execution.workflowName, _jsx(Badge, { className: getStatusColor(execution.status), children: execution.status.replace('_', ' ').toUpperCase() })] }), _jsxs("div", { className: "execution-meta", children: [_jsxs("span", { children: [execution.entityType, ": ", execution.entityId] }), _jsx("span", { children: "\u2022" }), _jsxs("span", { children: ["Started: ", execution.triggeredAt.toLocaleString()] }), _jsx("span", { children: "\u2022" }), _jsxs("span", { children: ["By: ", execution.triggeredBy] })] })] }), _jsxs("div", { className: "execution-progress", children: [_jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: {
                                                            width: `${(execution.currentStep / execution.totalSteps) * 100}%`
                                                        } }) }), _jsxs("span", { className: "progress-text", children: ["Step ", execution.currentStep, " of ", execution.totalSteps] })] })] }), execution.status === 'pending_approval' && (_jsxs("div", { className: "execution-actions", children: [_jsxs(Button, { size: "sm", className: "approve-btn", children: [_jsx(CheckCircle, { className: "w-4 h-4 mr-1" }), "Approve"] }), _jsxs(Button, { size: "sm", variant: "outline", className: "reject-btn", children: [_jsx(XCircle, { className: "w-4 h-4 mr-1" }), "Reject"] })] })), _jsxs("div", { className: "execution-context", children: [_jsx("h6", { children: "Execution Context" }), _jsx("div", { className: "context-items", children: Object.entries(execution.context).map(([key, value]) => (_jsxs("div", { className: "context-item", children: [_jsxs("span", { className: "context-key", children: [key.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase()), ":"] }), _jsx("span", { className: "context-value", children: typeof value === 'object' ? JSON.stringify(value) : String(value) })] }, key))) })] })] }, execution.executionId))) }) })] }) }));
    const renderWorkflowDetails = () => {
        ...
        return (_jsx("div", { className: "workflow-details-overlay", children: _jsxs(Card, { className: "workflow-details-modal", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "details-header", children: [_jsxs("div", { className: "header-info", children: [_jsx("h3", { children: selectedWorkflow.name }), _jsx(Badge, { className: getStatusColor(selectedWorkflow.status), children: selectedWorkflow.status.toUpperCase() })] }), _jsx(Button, { onClick: () => setSelectedWorkflow(null), variant: "outline", size: "sm", children: _jsx(XCircle, { className: "w-4 h-4" }) })] }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "workflow-visualization", children: [_jsx("h4", { children: "Workflow Steps" }), _jsx("div", { className: "steps-diagram", children: selectedWorkflow.steps.map((step, index) => {
                                            const StepIcon = getStepIcon(step.type);
                                            return (_jsxs(React.Fragment, { children: [_jsxs("div", { className: `step-node ${step.enabled ? 'enabled' : 'disabled'}`, children: [_jsx("div", { className: "step-icon", children: _jsx(StepIcon, { className: "w-5 h-5" }) }), _jsxs("div", { className: "step-content", children: [_jsx("h5", { children: step.name }), _jsx("p", { children: step.type.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }), step.config.action && (_jsx(Badge, { className: getSeverityColor(step.config.action.severity), children: step.config.action.severity.toUpperCase() }))] })] }), index < selectedWorkflow.steps.length - 1 && (_jsx("div", { className: "step-connector", children: _jsx(ArrowRight, { className: "w-4 h-4 text-gray-400" }) }))] }, step.stepId));
    ...
    return (_jsxs("div", { className: `policy-enforcement-workflow ${className}`, children: [_jsx("div", { className: "workflow-header", children: _jsxs("div", { className: "header-info", children: [_jsx("h2", { children: "Policy Enforcement Workflows" }), _jsx("p", { children: "Manage automated enforcement workflows and monitor executions" })] }) }), _jsx("div", { className: "workflow-tabs", children: _jsxs("div", { className: "tab-buttons", children: [_jsxs("button", { onClick: () => setActiveTab('workflows'), className: `tab-button ${activeTab === 'workflows' ? 'active' : ''}`, children: [_jsx(Workflow, { className: "w-4 h-4" }), "Workflows (", workflows.length, ")"] }), _jsxs("button", { onClick: () => setActiveTab('executions'), className: `tab-button ${activeTab === 'executions' ? 'active' : ''}`, children: [_jsx(Activity, { className: "w-4 h-4" }), "Executions (", executions.length, ")"] }), _jsxs("button", { onClick: () => setActiveTab('actions'), className: `tab-button ${activeTab === 'actions' ? 'active' : ''}`, children: [_jsx(Target, { className: "w-4 h-4" }), "Actions (", enforcementActions.length, ")"] })] }) }), _jsxs("div", { className: "tab-content", children: [activeTab === 'workflows' && renderWorkflowsList(), activeTab === 'executions' && renderExecutionsList(), activeTab === 'actions' && (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Enforcement Actions" }) }), _jsx(CardContent, { children: _jsx("div", { className: "actions-grid", children: enforcementActions.map(action => (_jsxs("div", { className: "action-card", children: [_jsxs("div", { className: "action-header", children: [_jsx("h5", { children: action.name }), _jsx(Badge, { className: getSeverityColor(action.severity), children: action.severity.toUpperCase() })] }), _jsx("p", { children: action.description }), _jsxs("div", { className: "action-properties", children: [action.automated && _jsx(Badge, { className: "property-badge", children: "Automated" }), action.requiresApproval && _jsx(Badge, { className: "property-badge", children: "Requires Approval" }), action.reversible && _jsx(Badge, { className: "property-badge", children: "Reversible" })] })] }, action.id))) }) })] }))] }), selectedWorkflow && renderWorkflowDetails(), _jsx("style", { jsx: true, children: `
