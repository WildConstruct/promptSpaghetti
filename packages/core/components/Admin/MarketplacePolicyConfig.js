...
export const MarketplacePolicyConfig = ({ className = '' }) => {
    ...
    const filteredTemplates = policyTemplates.filter(template => selectedCategory === 'all' || template.category === selectedCategory);
    const renderCategoryFilter = () => (_jsx("div", { className: "category-filter", children: _jsx("div", { className: "filter-buttons", children: ['creator', 'buyer', 'template', 'transaction', 'system'].map(category => {
                const Icon = getCategoryIcon(category);
                const count = policyTemplates.filter(t => t.category === category).length;
                return (_jsxs("button", { onClick: () => setSelectedCategory(category), className: `category-button ${selectedCategory === category ? 'active' : ''}`, children: [_jsx(Icon, { className: "w-4 h-4" }), _jsx("span", { children: category.charAt(0).toUpperCase() + category.slice(1) }), _jsx(Badge, { className: "count-badge", children: count })] }, category));
            }) }) }));
    const renderTemplateCard = (template) => (_jsxs(Card, { className: "template-card", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "template-header", children: [_jsxs("div", { className: "template-info", children: [_jsxs("div", { className: "template-title", children: [_jsx("h4", { children: template.name }), _jsxs("div", { className: "template-badges", children: [_jsx(Badge, { className: getCategoryColor(template.category), children: template.category.toUpperCase() }), template.isSystemTemplate && (_jsxs(Badge, { className: "text-purple-600 bg-purple-100", children: [_jsx(Shield, { className: "w-3 h-3 mr-1" }), "SYSTEM"] }))] })] }), _jsx("p", { className: "template-description", children: template.description })] }), _jsx("div", { className: "template-actions", children: _jsxs(Button, { onClick: () => setEditingTemplate(template), size: "sm", variant: "outline", children: [_jsx(Edit3, { className: "w-4 h-4 mr-1" }), "Configure"] }) })] }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "template-stats", children: [_jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Rules" }), _jsx("span", { className: "stat-value", children: template.rules.length })] }), _jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Active" }), _jsx("span", { className: "stat-value", children: template.rules.filter(r => r.enabled).length })] }), _jsxs("div", { className: "stat-item", children: [_jsx("span", { className: "stat-label", children: "Severity" }), _jsx(Badge, { className: template.defaultSeverity === 'critical' ? 'text-red-600 bg-red-100' :
                                            template.defaultSeverity === 'high' ? 'text-orange-600 bg-orange-100' :
                                                template.defaultSeverity === 'medium' ? 'text-yellow-600 bg-yellow-100' :
                                                    'text-blue-600 bg-blue-100', children: template.defaultSeverity.toUpperCase() })] })] }), _jsxs("div", { className: "template-rules", children: [_jsx("h5", { children: "Policy Rules" }), _jsxs("div", { className: "rules-list", children: [template.rules.slice(0, 3).map(rule => (_jsxs("div", { className: "rule-item", children: [_jsxs("div", { className: "rule-info", children: [_jsx("span", { className: "rule-name", children: rule.name }), _jsx("span", { className: "rule-description", children: rule.description })] }), _jsx("div", { className: "rule-status", children: rule.enabled ? (_jsx(CheckCircle, { className: "w-4 h-4 text-green-500" })) : (_jsx(X, { className: "w-4 h-4 text-gray-400" })) })] }, rule.id))), template.rules.length > 3 && (_jsxs("div", { className: "more-rules", children: ["+", template.rules.length - 3, " more rules"] }))] })] })] })] }, template.templateId));
    const renderTemplateEditor = () => {
        if (!editingTemplate)
            return null;
        return (_jsx("div", { className: "template-editor-overlay", children: _jsxs(Card, { className: "template-editor", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "editor-header", children: [_jsxs("div", { className: "editor-title", children: [_jsxs("h3", { children: ["Configure Policy: ", editingTemplate.name] }), _jsx(Badge, { className: getCategoryColor(editingTemplate.category), children: editingTemplate.category.toUpperCase() })] }), _jsx(Button, { onClick: () => setEditingTemplate(null), variant: "outline", size: "sm", children: _jsx(X, { className: "w-4 h-4" }) })] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "editor-content", children: [_jsxs("div", { className: "editor-section", children: [_jsx("h4", { children: "Threshold Configuration" }), _jsx("div", { className: "thresholds-grid", children: Object.entries(editingTemplate.configurable.thresholds).map(([key, value]) => (_jsxs("div", { className: "threshold-item", children: [_jsx("label", { className: "threshold-label", children: key.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase()) }), _jsx("input", { type: "number", value: value, className: "threshold-input", readOnly: true })] }, key))) })] }), _jsxs("div", { className: "editor-section", children: [_jsx("h4", { children: "Timeframe Settings" }), _jsx("div", { className: "timeframes-grid", children: Object.entries(editingTemplate.configurable.timeframes).map(([key, value]) => (_jsxs("div", { className: "timeframe-item", children: [_jsx("label", { className: "timeframe-label", children: key.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase()) }), _jsxs("div", { className: "timeframe-input-group", children: [_jsx("input", { type: "number", value: value, className: "timeframe-input", readOnly: true }), _jsx("span", { className: "timeframe-unit", children: key.includes('Period') ? 'days' : 'hours' })] })] }, key))) })] }), _jsxs("div", { className: "editor-section", children: [_jsx("h4", { children: "Policy Rules" }), _jsx("div", { className: "rules-editor", children: editingTemplate.rules.map(rule => (_jsxs("div", { className: "rule-editor-item", children: [_jsxs("div", { className: "rule-editor-header", children: [_jsxs("div", { className: "rule-editor-info", children: [_jsx("h5", { children: rule.name }), _jsx("p", { children: rule.description })] }), _jsx("div", { className: "rule-editor-controls", children: _jsxs("label", { className: "rule-toggle", children: [_jsx("input", { type: "checkbox", checked: rule.enabled, readOnly: true }), _jsx("span", { children: "Enabled" })] }) })] }), _jsxs("div", { className: "rule-editor-details", children: [_jsxs("div", { className: "rule-condition", children: [_jsx("label", { children: "Condition" }), _jsx("code", { className: "condition-code", children: rule.condition })] }), _jsxs("div", { className: "rule-action", children: [_jsx("label", { children: "Action" }), _jsx("select", { className: "action-select", value: rule.action, readOnly: true, children: editingTemplate.configurable.actions.map(action => (_jsx("option", { value: action, children: action.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase()) }, action))) })] })] })] }, rule.id))) })] }), _jsxs("div", { className: "editor-actions", children: [_jsxs(Button, { className: "save-button", children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), "Save Configuration"] }), _jsxs(Button, { variant: "outline", children: [_jsx(Target, { className: "w-4 h-4 mr-2" }), "Test Policy"] })] })] }) })] }) }));
    };
    return (_jsxs("div", { className: `marketplace-policy-config ${className}`, children: [_jsxs("div", { className: "config-header", children: [_jsxs("div", { className: "header-info", children: [_jsx("h2", { children: "Marketplace Policy Configuration" }), _jsx("p", { children: "Configure and customize policies for marketplace operations" })] }), _jsx("div", { className: "header-actions", children: _jsxs(Button, { onClick: () => setIsCreatingNew(true), children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Create Policy"] }) })] }), renderCategoryFilter(), _jsx("div", { className: "templates-section", children: _jsx("div", { className: "templates-grid", children: filteredTemplates.map(template => renderTemplateCard(template)) }) }), editingTemplate && renderTemplateEditor(), _jsx("div", { className: "config-info", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Policy Configuration Guide" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "guide-content", children: [_jsxs("div", { className: "guide-section", children: [_jsx(Info, { className: "w-5 h-5 text-blue-500" }), _jsxs("div", { children: [_jsx("h4", { children: "Getting Started" }), _jsx("p", { children: "Select a policy category to view available templates. Each template contains pre-configured rules that can be customized for your marketplace needs." })] })] }), _jsxs("div", { className: "guide-section", children: [_jsx(Zap, { className: "w-5 h-5 text-orange-500" }), _jsxs("div", { children: [_jsx("h4", { children: "Rule Conditions" }), _jsx("p", { children: "Policy rules use expressions to evaluate conditions. Variables like user.trustScore and template.qualityScore are automatically populated from your system data." })] })] }), _jsxs("div", { className: "guide-section", children: [_jsx(Shield, { className: "w-5 h-5 text-green-500" }), _jsxs("div", { children: [_jsx("h4", { children: "Enforcement Actions" }), _jsx("p", { children: "When a policy rule is triggered, the configured action is automatically executed. Actions range from notifications to account restrictions." })] })] })] }) })] }) }), _jsx("style", { jsx: true, children: `
