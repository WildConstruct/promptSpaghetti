...
import { CheckCircle, XCircle, Clock, AlertCircle, Users, FileText, TrendingUp, TrendingDown, Search, Eye, RefreshCw } from 'lucide-react';
export const VerificationDashboard = ({ className = '', onRequestSelect }) => {
    ...
    const handleStatusUpdate = (requestId, newStatus) => {
        setVerificationQueue(prev => prev.map(item => item.requestId === requestId
