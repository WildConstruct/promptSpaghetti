...
const OverviewTab = ({ dashboardState, onPlaybookExecute, onIncidentCreate }) => {
...
const IncidentsTab = ({ incidents, onIncidentCreate }) => {
...
const PlaybooksTab = ({ executions, onPlaybookExecute }) => {
...
const AnalyticsTab = ({ performanceMetrics, recentActivity }) => {
