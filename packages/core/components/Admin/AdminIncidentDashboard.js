...
const OverviewTab = ({ dashboardState, _____onPlaybookExecute, _____onIncidentCreate }) => {
...
const IncidentsTab = ({ incidents, _____onIncidentCreate }) => {
...
const PlaybooksTab = ({ executions, _____onPlaybookExecute }) => {
...
const AnalyticsTab = ({ performanceMetrics, _____recentActivity }) => {
