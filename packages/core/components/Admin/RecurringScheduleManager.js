...
export const RecurringScheduleManager = ({ className = '', _____userId, _____userRole }) => {
    ...
    if (loading) {
        return (_jsx("div", { className: `p-6 ${className}`, children: _jsxs("div", { className: "flex items-center justify-center h-64", children: [_jsx(RefreshCw, { className: "h-8 w-8 animate-spin text-blue-600" }), _jsx("span", { className: "ml-2 text-lg", children: "Loading recurring schedules..." })] }) }));
    }
    return (_jsxs("div", { className: `p-6 space-y-6 ${className}`, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Recurring Schedules" }), _jsx("p", { className: "text-gray-600 mt-1", children: "Manage recurring schedules with advanced pattern configuration" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { variant: "outline", children: [_jsx(Filter, { className: "h-4 w-4 mr-2" }), "Templates"] }), _jsxs(Button, { onClick: () => setShowCreateModal(true), children: [_jsx(Plus, { className: "h-4 w-4 mr-2" }), "Create Recurring Schedule"] })] })] }), _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "w-full", children: [_jsxs(TabsList, { className: "grid w-full grid-cols-4", children: [_jsx(TabsTrigger, { value: "schedules", children: "Schedules" }), _jsx(TabsTrigger, { value: "patterns", children: "Pattern Builder" }), _jsxs(TabsTrigger, { value: "conflicts", children: ["Conflicts (", conflicts.length, ")"] }), _jsx(TabsTrigger, { value: "analytics", children: "Analytics" })] }), _jsxs(TabsContent, { value: "schedules", className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col sm:flex-row gap-4", children: [_jsx("div", { className: "flex-1", children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "h-4 w-4 absolute left-3 top-3 text-gray-400" }), _jsx(Input, { placeholder: "Search recurring schedules...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "pl-10" })] }) }), _jsxs(Select, { value: statusFilter, onValueChange: setStatusFilter, children: [_jsx("option", { value: "all", children: "All Status" }), _jsx("option", { value: "pending", children: "Pending" }), _jsx("option", { value: "active", children: "Active" }), _jsx("option", { value: "paused", children: "Paused" }), _jsx("option", { value: "completed", children: "Completed" }), _jsx("option", { value: "cancelled", children: "Cancelled" })] }), _jsxs(Select, { value: actionFilter, onValueChange: setActionFilter, children: [_jsx("option", { value: "all", children: "All Actions" }), _jsx("option", { value: "enable", children: "Enable" }), _jsx("option", { value: "disable", children: "Disable" }), _jsx("option", { value: "update_value", children: "Update Value" }), _jsx("option", { value: "modify_percentage", children: "Modify Percentage" }), _jsx("option", { value: "activate_rollout", children: "Activate Rollout" })] })] }), _jsx("div", { className: "space-y-4", children: filteredSchedules.map((schedule) => {
                                    const ActionIcon = ACTION_CONFIG[schedule.action].icon;
                                    const StatusIcon = STATUS_CONFIG[schedule.status].icon;
                                    return (_jsx(Card, { children: _jsx(CardContent, { className: "p-6", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-start space-x-4", children: [_jsx("div", { className: "p-2 rounded-lg bg-blue-100", children: _jsx(Repeat, { className: "h-5 w-5 text-blue-600" }) }), _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-2 mb-2", children: [_jsx("h3", { className: "text-lg font-semibold", children: schedule.name }), schedule.conflictCount > 0 && (_jsxs(Badge, { variant: "destructive", className: "text-xs", children: [schedule.conflictCount, " conflicts"] }))] }), _jsx("p", { className: "text-gray-600 mb-3", children: schedule.description }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Toggle:" }), _jsx("p", { className: "text-gray-900", children: schedule.toggleId })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Pattern:" }), _jsx("p", { className: "text-gray-900", children: schedule.recurrence ? getRecurrenceDescription(schedule.recurrence) : 'No pattern' })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Next Run:" }), _jsx("p", { className: "text-gray-900", children: schedule.nextExecution ? formatDate(schedule.nextExecution) : 'Not scheduled' })] }), _jsxs("div", { children: [_jsx("span", { className: "font-medium text-gray-700", children: "Success Rate:" }), _jsxs("p", { className: "text-gray-900", children: [schedule.performanceMetrics.successRate.toFixed(1), "%"] })] })] }), _jsxs("div", { className: "mt-4", children: [_jsx("span", { className: "font-medium text-gray-700 text-sm", children: "Next 3 occurrences:" }), _jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: schedule.nextOccurrences.slice(0, 3).map((date, index) => (_jsx(Badge, { variant: "outline", className: "text-xs", children: formatDate(date) }, index))) })] })] })] }), _jsxs("div", { className: "flex items-start space-x-4", children: [_jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "flex items-center space-x-2 mb-2", children: [_jsxs(Badge, { className: ACTION_CONFIG[schedule.action].color, children: [_jsx(ActionIcon, { className: "h-3 w-3 mr-1" }), ACTION_CONFIG[schedule.action].label] }), _jsxs(Badge, { className: STATUS_CONFIG[schedule.status].color, children: [_jsx(StatusIcon, { className: "h-3 w-3 mr-1" }), schedule.status] })] }), _jsxs("p", { className: "text-sm text-gray-600", children: [schedule.executionCount, " executions, ", schedule.failureCount, " failed"] })] }), _jsxs("div", { className: "flex flex-col space-y-2", children: [schedule.status === ScheduleStatus.ACTIVE ? (_jsx(Button, { size: "sm", variant: "outline", onClick: () => handlePauseSchedule(schedule.id), children: _jsx(Pause, { className: "h-4 w-4" }) })) : (_jsx(Button, { size: "sm", variant: "outline", onClick: () => handleResumeSchedule(schedule.id), children: _jsx(Play, { className: "h-4 w-4" }) })), _jsx(Button, { size: "sm", variant: "outline", children: _jsx(Edit, { className: "h-4 w-4" }) }), _jsx(Button, { size: "sm", variant: "outline", onClick: () => handleDuplicateSchedule(schedule.id), children: _jsx(Copy, { className: "h-4 w-4" }) }), _jsx(Button, { size: "sm", variant: "destructive", onClick: () => handleDeleteSchedule(schedule.id), children: _jsx(Trash2, { className: "h-4 w-4" }) })] })] })] }) }) }, schedule.id));
                                }) })] }), _jsx(TabsContent, { value: "patterns", className: "space-y-6", children: _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Pattern Presets" }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: RECURRENCE_PRESETS.map((preset) => (_jsx("div", { className: "p-3 border rounded-lg hover:bg-gray-50 cursor-pointer", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-medium", children: preset.name }), _jsx("p", { className: "text-sm text-gray-600", children: preset.description })] }), _jsx(Button, { size: "sm", variant: "outline", children: "Use" })] }) }, preset.id))) }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Custom Pattern Builder" }) }), _jsx(CardContent, { children: _jsx(RecurrenceEditor, { value: {
                                                    type: 'weekly',
                                                    interval: 1
                                                }, onChange: (recurrence) => {
                                                    console.log('Recurrence updated:', recurrence);
                                                } }) })] })] }) }), _jsx(TabsContent, { value: "conflicts", className: "space-y-6", children: _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(AlertTriangle, { className: "h-5 w-5 text-orange-600" }), "Schedule Conflicts"] }) }), _jsx(CardContent, { children: conflicts.length === 0 ? (_jsxs("div", { className: "text-center py-8", children: [_jsx(CheckCircle, { className: "h-12 w-12 text-green-600 mx-auto mb-4" }), _jsx("p", { className: "text-lg font-medium text-gray-900", children: "No conflicts detected" }), _jsx("p", { className: "text-gray-600", children: "All recurring schedules are properly configured" })] })) : (_jsx("div", { className: "space-y-4", children: conflicts.map((conflict) => (_jsx("div", { className: "p-4 border rounded-lg", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsxs(Badge, { variant: conflict.severity === 'critical' ? 'destructive' : 'default', className: "text-xs", children: [conflict.severity, " priority"] }), _jsx(Badge, { variant: "outline", className: "text-xs", children: conflict.type.replace('_', ' ') })] }), _jsx("p", { className: "font-medium text-gray-900 mb-1", children: conflict.description }), _jsx("p", { className: "text-sm text-gray-600 mb-3", children: conflict.suggestedResolution })] }), _jsxs("div", { className: "flex space-x-2", children: [_jsx(Button, { size: "sm", variant: "outline", children: "Auto-resolve" }), _jsx(Button, { size: "sm", children: "Review" })] })] }) }, conflict.id))) })) })] }) }), _jsxs(TabsContent, { value: "analytics", className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Active Schedules" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "text-3xl font-bold text-green-600", children: schedules.filter(s => s.status === ScheduleStatus.ACTIVE).length }), _jsx("p", { className: "text-sm text-gray-600", children: "Currently running" })] })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Average Success Rate" }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "text-3xl font-bold text-blue-600", children: [(schedules.reduce((sum, s) => sum + s.performanceMetrics.successRate, 0) / schedules.length).toFixed(1), "%"] }), _jsx("p", { className: "text-sm text-gray-600", children: "Across all schedules" })] })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Total Executions" }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "text-3xl font-bold text-purple-600", children: schedules.reduce((sum, s) => sum + s.executionCount, 0) }), _jsx("p", { className: "text-sm text-gray-600", children: "All time" })] })] })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(BarChart3, { className: "h-5 w-5" }), "Performance Trends"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "h-64 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg", children: _jsx("p", { className: "text-gray-600", children: "Performance trends chart would be rendered here" }) }) })] })] })] })] }));
};
