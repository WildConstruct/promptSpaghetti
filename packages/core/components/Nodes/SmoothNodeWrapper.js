...
export const SmoothNodeWrapper = ({ id, data, selected, children, nodeType = 'default', isSelected = false, isConnectable = true, onNodeClick, onNodeDoubleClick, onNodeDelete }) => {
    ...
    const getNodeStyle = () => {
        const baseStyle = {
            ...
            minWidth: 160,
            minHeight: 80,
            ...createSmoothTransition(['transform', 'box-shadow', 'border-color', 'background'], animationDurations.normal, easingFunctions.cinema4d.professional)
        };
    ...
    const getHandleStyle = (type) => ({
        ...
        ...createSmoothTransition(['background', 'border-color', 'box-shadow', 'transform'], animationDurations.micro)
    });
    ...
    return (_jsxs("div", { ref: nodeRef, style: getNodeStyle(), className: `smooth-node ${isAnimating ? 'animate-node-create' : ''}`, onClick: handleClick, onDoubleClick: handleDoubleClick, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...hoverProps, children: [_jsx(Handle, { type: "target", position: Position.Left, style: getHandleStyle('target'), onMouseEnter: (e) => {
                    ...
                    zIndex: 1
                        ...
                        } }), children, (selected || isSelected) && (_jsx("div", { style: {
                            position: 'absolute',
                            inset: -2,
                            borderRadius: 14,
...
export const NodeCreationAnimator = ({ children, isCreating, onAnimationComplete }) => {
    useEffect(() => {
    ...
    return (_jsx("div", { className: isCreating ? 'animate-node-create' : '', style: {
