...
export const ScheduledExecutionManager = ({ workspaceId, resourceId, onClose }) => {
    ...
    const renderSchedulesTab = () => (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Scheduled Executions" }), _jsxs("button", { onClick: () => setShowCreateSchedule(true), className: "flex items-center space-x-2 px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors", children: [_jsx(PlusIcon, { className: "h-4 w-4" }), _jsx("span", { children: "Create Schedule" })] })] }), _jsx("div", { className: "space-y-3", children: schedules.map(schedule => (_jsx("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("h4", { className: "font-medium text-gray-900", children: schedule.schedule_name }), _jsx("span", { className: `px-2 py-1 text-xs rounded-full ${schedule.enabled
                                                    ? 'bg-green-100 text-green-800'
                                                    : 'bg-gray-100 text-gray-800'}`, children: schedule.enabled ? 'Enabled' : 'Disabled' }), _jsx("span", { className: "px-2 py-1 text-xs rounded bg-blue-100 text-blue-800", children: schedule.schedule_type.toUpperCase() })] }), _jsxs("div", { className: "mt-2 flex items-center space-x-4 text-sm text-gray-600", children: [_jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(ClockIcon, { className: "h-4 w-4" }), _jsx("span", { children: formatScheduleExpression(schedule) })] }), _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(CogIcon, { className: "h-4 w-4" }), _jsx("span", { children: schedule.action_type.replace('_', ' ') })] })] }), _jsxs("div", { className: "mt-2 flex items-center space-x-6 text-sm text-gray-500", children: [_jsxs("span", { children: ["Runs: ", schedule.run_count, schedule.max_runs ? `/${schedule.max_runs}` : ''] }), _jsxs("span", { children: ["Next: ", schedule.next_run_at?.toLocaleString() || 'N/A'] }), _jsxs("span", { children: ["Last: ", schedule.last_run_at?.toLocaleString() || 'Never'] })] })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("button", { onClick: () => handleRunNow(schedule.id), className: "p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition-colors", title: "Run now", children: _jsx(PlayIcon, { className: "h-4 w-4" }) }), _jsx("button", { onClick: () => handleToggleSchedule(schedule.id), className: `p-2 rounded-md transition-colors ${schedule.enabled
                                            ? 'text-orange-600 hover:text-orange-800 hover:bg-orange-50'
                                            : 'text-green-600 hover:text-green-800 hover:bg-green-50'}`, title: schedule.enabled ? 'Disable' : 'Enable', children: schedule.enabled ? _jsx(PauseIcon, { className: "h-4 w-4" }) : _jsx(PlayIcon, { className: "h-4 w-4" }) }), _jsx("button", { onClick: () => setShowDeleteConfirm(schedule.id), className: "p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-colors", title: "Delete", children: _jsx(TrashIcon, { className: "h-4 w-4" }) })] })] }) }, schedule.id))) }), schedules.length === 0 && (_jsxs("div", { className: "text-center py-8 text-gray-500", children: [_jsx(ClockIcon, { className: "h-12 w-12 mx-auto mb-4 text-gray-300" }), _jsx("p", { children: "No scheduled executions found. Create your first schedule to get started." })] }))] }));
    const renderExecutionLogsTab = () => (_jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-semibold", children: "Execution Logs" }), _jsx("div", { className: "space-y-3", children: executionLogs.map(log => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("span", { className: `px-2 py-1 text-xs rounded-full font-medium ${getStatusColor(log.status)}`, children: log.status.toUpperCase() }), _jsxs("span", { className: "text-sm text-gray-600", children: ["Schedule: ", schedules.find(s => s.id === log.schedule_id)?.schedule_name || 'Unknown'] }), _jsxs("span", { className: "text-sm text-gray-500", children: ["Execution ID: ", log.execution_id] })] }), _jsxs("div", { className: "mt-2 flex items-center space-x-4 text-sm text-gray-600", children: [_jsxs("span", { children: ["Started: ", log.started_at.toLocaleString()] }), log.completed_at && (_jsxs("span", { children: ["Completed: ", log.completed_at.toLocaleString()] })), log.execution_time_ms && (_jsxs("span", { children: ["Duration: ", (log.execution_time_ms / 1000).toFixed(2), "s"] })), log.retry_attempt > 0 && (_jsxs("span", { children: ["Retry: ", log.retry_attempt] }))] }), log.error_message && (_jsx("div", { className: "mt-2 p-2 bg-red-50 border border-red-200 rounded text-sm text-red-800", children: log.error_message }))] }), _jsx("div", { className: "flex items-center space-x-2", children: _jsx("button", { onClick: () => toggleLogExpansion(log.id), className: "p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md transition-colors", children: expandedLogs.has(log.id) ? (_jsx(ChevronDownIcon, { className: "h-4 w-4" })) : (_jsx(ChevronRightIcon, { className: "h-4 w-4" })) }) })] }), expandedLogs.has(log.id) && (_jsxs("div", { className: "mt-4 border-t border-gray-200 pt-4", children: [_jsx("h5", { className: "font-medium text-sm mb-2", children: "Execution Details" }), _jsx("pre", { className: "bg-gray-100 p-3 rounded text-xs overflow-x-auto", children: JSON.stringify({
                                    ...
                                    }, null, 2) })] }))] }, log.id))) }), executionLogs.length === 0 && (_jsxs("div", { className: "text-center py-8 text-gray-500", children: [_jsx(ClockIcon, { className: "h-12 w-12 mx-auto mb-4 text-gray-300" }), _jsx("p", { children: "No execution logs found." })] }))] }));
...
const DeleteScheduleModal = ({ onClose, onConfirm }) => {
