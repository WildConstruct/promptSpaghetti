...
export const DemoModeManager = ({ children, onModeChange, initialConfig = {} }) => {
    ...
    return (_jsxs(_Fragment, { children: [children, config.brandingVisible && !config.screenshotMode && (_jsxs("div", { className: "demo-branding", "data-demo-safe": "true", children: [_jsx("div", { style: { fontSize: '12px', fontWeight: 600, marginBottom: 2 }, children: "\uD83C\uDFAC PromptScape Studio" }), _jsx("div", { style: { fontSize: '10px', opacity: 0.8 }, children: "Professional Prompt Generation" })] })), isTransitioning && (_jsx("div", { style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
                    ...
                    zIndex: 9999,
                    pointerEvents: 'none'
                }, children: _jsx(ProfessionalSpinner, { size: "medium", variant: "cinema4d", type: "pulse", message: "Switching demo mode..." }) })), !config.screenshotMode && process.env.NODE_ENV === 'development' && (_jsx(DemoControlPanel, { config: config, onConfigChange: updateConfig }))] }));
};
const DemoControlPanel = ({ config, onConfigChange }) => {
    const [panelVisible, setPanelVisible] = useState(false);
    return (_jsxs(_Fragment, { children: [_jsx("button", { onClick: () => setPanelVisible(!panelVisible), style: {
                    position: 'fixed',
                    top: 10,
                    right: 10,
                ...
                }, className: "development-only", title: "Demo Controls (Alt+Shift+[key])", children: "\uD83C\uDFAD Demo" }), panelVisible && (_jsxs("div", { style: {
                    position: 'fixed',
                    top: 50,
                    right: 10,
