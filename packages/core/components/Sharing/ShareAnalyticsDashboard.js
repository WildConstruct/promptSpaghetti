    ...
    return (_jsxs("div", { style: {
            ...
            border: '1px solid #e5e7eb'
                    ...
                    marginBottom: '32px'
                            ...
                            fontWeight: '600',
                            color: '#374151'
                        }, children: "Share Sources" }), _jsx("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))',
                            gap: '12px'
                        }, children: Object.entries(metrics.breakdowns.byPlatform).map(([platform, count]) => (_jsxs("div", { style: {
                                padding: '12px',
                                ...
                                alignItems: 'center'
                                        ...
                                        fontWeight: '600',
                                        color: '#6b7280'
                                    }, children: count })] }, platform))) })] }), _jsxs("div", { style: { marginBottom: '32px' }, children: [_jsx("h4", { style: {
                            margin: '0 0 16px 0',
                            fontSize: '16px',
                            fontWeight: '600',
                            color: '#374151'
                        }, children: "Geographic Distribution" }), _jsx("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))',
                            gap: '12px'
                        }, children: Object.entries(metrics.breakdowns.byGeography).map(([country, count]) => (_jsxs("div", { style: {
                                padding: '8px 12px',
                                ...
                                justifyContent: 'space-between',
                                alignItems: 'center'
                            }, children: [_jsx("span", { style: { fontSize: '13px', color: '#374151' }, children: country }), _jsx("span", { style: {
                                        fontSize: '13px',
                                        fontWeight: '600',
                                        color: '#6b7280'
                                    }, children: count })] }, country))) })] }), _jsxs("div", { style: {
                    display: 'grid',
                    ...
                    gap: '24px'
                                    ...
                                    fontWeight: '600',
                                    color: '#374151'
                                }, children: "Engagement Details" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsx("span", { style: { fontSize: '14px', color: '#6b7280' }, children: "Comments:" }), _jsx("span", { style: { fontSize: '14px', fontWeight: '500' }, children: metrics.metrics.totalComments })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsx("span", { style: { fontSize: '14px', color: '#6b7280' }, children: "Clones:" }), _jsx("span", { style: { fontSize: '14px', fontWeight: '500' }, children: metrics.metrics.totalClones })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsx("span", { style: { fontSize: '14px', color: '#6b7280' }, children: "Downloads:" }), _jsx("span", { style: { fontSize: '14px', fontWeight: '500' }, children: metrics.metrics.totalDownloads })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsx("span", { style: { fontSize: '14px', color: '#6b7280' }, children: "Avg Rating:" }), _jsxs("span", { style: { fontSize: '14px', fontWeight: '500' }, children: [metrics.metrics.averageRating.toFixed(1), "/5"] })] })] })] }), _jsxs("div", { children: [_jsx("h4", { style: {
                                    margin: '0 0 12px 0',
                                    fontSize: '16px',
                                    fontWeight: '600',
                                    color: '#374151'
                                }, children: "Device Breakdown" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: Object.entries(metrics.breakdowns.byDevice).map(([device, count]) => (_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsxs("span", { style: {
                                                fontSize: '14px',
                                                color: '#6b7280',
                                                textTransform: 'capitalize'
                                            }, children: [device, ":"] }), _jsx("span", { style: { fontSize: '14px', fontWeight: '500' }, children: count })] }, device))) })] })] })] }));
};
