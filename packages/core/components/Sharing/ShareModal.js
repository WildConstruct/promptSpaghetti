            ...
            zIndex: 1000
                ...
                boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)'
                        ...
                        borderBottom: '1px solid #e5e7eb'
                                        ...
                                        color: '#6b7280',
                                        padding: '4px'
                                    }, children: "\u00D7" })] }), _jsx("div", { style: { display: 'flex', gap: '8px', marginTop: '16px' }, children: ['options', 'permissions', 'preview'].map(tab => (_jsx("button", { onClick: () => setActiveTab(tab), style: {
                                    padding: '8px 16px',
                                    border: 'none',
                                    ...
                                    fontSize: '14px',
                                    fontWeight: '500'
                                }, children: tab }, tab))) })] }), _jsxs("div", { style: { padding: '24px', maxHeight: '500px', overflowY: 'auto' }, children: [activeTab === 'options' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '20px' }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Title" }), _jsx("input", { type: "text", value: customTitle, onChange: (e) => setCustomTitle(e.target.value), style: {
                                                width: '100%',
                                                padding: '8px 12px',
                                                ...
                                                resize: 'vertical'
                                                        ...
                                                        borderRadius: '6px',
                                                        fontSize: '14px'
                                                    }, children: [_jsx("option", { value: "link", children: "Share Link" }), _jsx("option", { value: "embed", children: "Embed Code" }), _jsx("option", { value: "export", children: "Export File" }), _jsx("option", { value: "clone", children: "Clone Template" })] })] })] }), _jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '12px', color: '#374151' }, children: "Share on Social Platforms" }), _jsx("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }, children: ['twitter', 'linkedin', 'discord', 'slack', 'teams', 'email'].map(platform => (_jsx("button", { onClick: () => handlePlatformToggle(platform), style: {
                                                    padding: '8px 12px',
                                                    border: `1px solid ${selectedPlatforms.includes(platform) ? '#3b82f6' : '#d1d5db'}`,
                                                    backgroundColor: selectedPlatforms.includes(platform) ? '#eff6ff' : 'white',
                                                    borderRadius: '6px',
                                                    cursor: 'pointer',
                                                    fontSize: '12px',
                                                    textTransform: 'capitalize',
                                                    color: selectedPlatforms.includes(platform) ? '#3b82f6' : '#6b7280'
                                                }, children: platform }, platform))) })] })] })), activeTab === 'permissions' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '16px' }, children: [_jsx("h3", { style: { margin: 0, fontSize: '18px', fontWeight: '600', color: '#111827' }, children: "Access Permissions" }), Object.entries(permissions).map(([key, value]) => {
                                    if (typeof value !== 'boolean')
                                        return null;
                                    return (_jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("input", { type: "checkbox", checked: value, onChange: (e) => setPermissions(prev => ({ ...prev, [key]: e.target.checked })), style: { width: '16px', height: '16px' } }), _jsx("span", { style: { fontSize: '14px', color: '#374151', textTransform: 'capitalize' }, children: key.replace(/([A-Z])/g, ' $1').toLowerCase() })] }, key));
                                })] })), activeTab === 'preview' && shareResponse && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '20px' }, children: [_jsx("h3", { style: { margin: 0, fontSize: '18px', fontWeight: '600', color: '#111827' }, children: "Share Created Successfully!" }), _jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Share Link" }), _jsxs("div", { style: { display: 'flex', gap: '8px' }, children: [_jsx("input", { type: "text", value: shareResponse.shareLink.shortUrl, readOnly: true, style: {
                                                        flex: 1,
                                                        padding: '8px 12px',
                                                        border: '1px solid #d1d5db',
                                                        borderRadius: '6px',
                                                        ...
                                                        cursor: 'pointer',
                                                        fontSize: '14px'
                                                    }, children: "Copy" })] })] }), Object.keys(shareResponse.socialLinks).length > 0 && (_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Social Platform Links" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: Object.entries(shareResponse.socialLinks).map(([platform, url]) => (_jsxs("div", { style: { display: 'flex', gap: '8px', alignItems: 'center' }, children: [_jsxs("span", { style: {
                                                            fontSize: '12px',
                                                            textTransform: 'capitalize',
                                                            minWidth: '80px',
                                                            color: '#6b7280'
                                                            ...
                                                            textDecoration: 'none',
                                                            fontSize: '14px'
                                                        }, children: ["Open ", platform] })] }, platform))) })] })), shareFormat === 'embed' && (_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontWeight: '500', marginBottom: '8px', color: '#374151' }, children: "Embed Code" }), _jsx("textarea", { value: shareResponse.embedCodes.responsive, readOnly: true, rows: 4, style: {
                                                width: '100%',
                                                padding: '8px 12px',
                                                border: '1px solid #d1d5db',
                                                borderRadius: '6px',
                                                ...
                                                cursor: 'pointer',
                                                fontSize: '12px'
                                            }, children: "Copy Embed Code" })] }))] }))] }), _jsxs("div", { style: {
                        padding: '16px 24px',
                        ...
                        gap: '12px'
                                ...
                                fontSize: '14px',
                                color: '#374151'
                            }, children: "Cancel" }), activeTab !== 'preview' && (_jsx("button", { onClick: handleCreateShare, disabled: isLoading, style: {
                                padding: '8px 16px',
                                ...
                                fontSize: '14px',
                                fontWeight: '500'
                            }, children: isLoading ? 'Creating...' : 'Create Share' }))] })] }) }));
};
