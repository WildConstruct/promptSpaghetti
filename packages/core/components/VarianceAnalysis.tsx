...
import { varianceAnalysisService, 
  VarianceMetrics, 
  DiversityIndicator }
  VarianceSuggestion 
...
interface VarianceAnalysisProps { results: PreviewResultWithPath;
...
const CompactVarianceDisplay: React.FC<{ ,
  ...
  varianceInfo: ReturnType<typeof varianceAnalysisService.getVarianceLevelInfo> }> = ({ analysis, varianceInfo }) => (
  <div style={ {
    display: 'flex'
    alignItems: 'center'
    gap: 8
...
const SuggestionCard: React.FC<{ ,
  ...
  onClick?: () => void }> = ({ suggestion, onClick }) => {
  const typeColors = {
