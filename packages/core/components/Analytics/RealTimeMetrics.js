...
export const RealTimeMetrics = ({ metrics, loading }) => {
    ...
    if (loading) {
        return (_jsxs("div", { className: "real-time-metrics loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading real-time metrics..." })] }));
    }
