...
export const AutomatedOptimizationSuggestions = ({ funnelDefinition, analyticsInfrastructure, optimizationConfig = defaultOptimizationConfig, userContext, automationLevel = 'semi_automated', onSuggestionGenerated, onAutomatedAction, onExport }) => {
