 ...
 */
export const FunnelConfiguration = ({ initialFunnel, templates = [], availableEvents = [], availableProperties = [], onSave, onCancel, onValidation }) => {
    ...
    return (_jsxs("div", { className: "funnel-configuration", children: [_jsxs("div", { className: "configuration-header", children: [_jsx("h2", { children: "Funnel Configuration" }), _jsxs("div", { className: "header-actions", children: [_jsx("button", { onClick: () => setShowTemplateModal(true), className: "template-button", children: "Use Template" }), _jsx("button", { onClick: onCancel, className: "cancel-button", children: "Cancel" }), _jsx("button", { onClick: handleSave, disabled: !isValid, className: "save-button", children: "Save Funnel" })] })] }), _jsx("div", { className: "configuration-tabs", children: ['basic', 'steps', 'conditions', 'success', 'analytics'].map(tab => (_jsx("button", { onClick: () => setActiveTab(tab), className: `tab-button ${activeTab === tab ? 'active' : ''}`, children: tab.charAt(0).toUpperCase() + tab.slice(1) }, tab))) }), _jsxs("div", { className: "configuration-content", children: [validationErrors.length > 0 && (_jsx(ValidationPanel, { errors: validationErrors })), activeTab === 'basic' && (_jsx(BasicConfiguration, { funnel: funnel, onChange: handleBasicInfoChange, onConfigChange: handleConfigurationChange })), activeTab === 'steps' && (_jsx(StepsConfiguration, { steps: funnel.steps || [], availableEvents: availableEvents, availableProperties: availableProperties, onStepAdd: handleStepAdd, onStepUpdate: handleStepUpdate, onStepDelete: handleStepDelete, onStepReorder: handleStepReorder, draggedItem: draggedItem, onDragStart: setDraggedItem, onDragEnd: () => setDraggedItem(null) })), activeTab === 'conditions' && (_jsx(ConditionalPathsConfiguration, { paths: funnel.conditionalPaths || [], steps: funnel.steps || [], onChange: (paths) => setFunnel(prev => ({ ...prev, conditionalPaths: paths })) })), activeTab === 'success' && (_jsx(SuccessCriteriaConfiguration, { criteria: funnel.successCriteria, steps: funnel.steps || [], onChange: (criteria) => setFunnel(prev => ({ ...prev, successCriteria: criteria })) })), activeTab === 'analytics' && (_jsx(AnalyticsConfiguration, { analytics: funnel.analytics, onChange: (analytics) => setFunnel(prev => ({ ...prev, analytics })) }))] }), showTemplateModal && (_jsx(TemplateSelectionModal, { templates: templates, onSelect: handleTemplateApply, onClose: () => setShowTemplateModal(false) }))] }));
};
...
const PropertyMatchersEditor = ({ matchers, availableProperties, onChange }) => {
    ...
    const updateMatcher = (index, updates) => {
        const newMatchers = matchers.map((matcher, i) => i === index ? { ...matcher, ...updates } : matcher);
        onChange(newMatchers);
    };
    const removeMatcher = (index) => {
        onChange(matchers.filter((_, i) => i !== index));
    };
    return (_jsxs("div", { className: "property-matchers-editor", children: [_jsxs("div", { className: "matchers-header", children: [_jsx("h5", { children: "Property Matchers" }), _jsx("button", { onClick: addMatcher, className: "add-matcher-button", children: "Add Matcher" })] }), matchers.map((matcher, index) => (_jsxs("div", { className: "property-matcher", children: [_jsxs("div", { className: "form-row", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Property" }), _jsxs("select", { value: matcher.propertyPath, onChange: (e) => updateMatcher(index, { propertyPath: e.target.value }), className: "form-select", children: [_jsx("option", { value: "", children: "Select property..." }), availableProperties.map(prop => (_jsxs("option", { value: prop.path, children: [prop.name, " (", prop.path, ")"] }, prop.path)))] })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Operator" }), _jsxs("select", { value: matcher.operator, onChange: (e) => updateMatcher(index, { operator: e.target.value }), className: "form-select", children: [_jsx("option", { value: "equals", children: "Equals" }), _jsx("option", { value: "contains", children: "Contains" }), _jsx("option", { value: "startsWith", children: "Starts With" }), _jsx("option", { value: "endsWith", children: "Ends With" }), _jsx("option", { value: "matches", children: "Matches Regex" }), _jsx("option", { value: "exists", children: "Exists" }), _jsx("option", { value: "in", children: "In List" }), _jsx("option", { value: "between", children: "Between" })] })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Value" }), _jsx("input", { type: "text", value: matcher.value, onChange: (e) => updateMatcher(index, { value: e.target.value }), className: "form-input" })] }), _jsx("button", { onClick: () => removeMatcher(index), className: "remove-matcher-button", children: "\u00D7" })] }), _jsxs("div", { className: "matcher-options", children: [_jsxs("label", { children: [_jsx("input", { type: "checkbox", checked: matcher.caseSensitive || false, onChange: (e) => updateMatcher(index, { caseSensitive: e.target.checked }) }), "Case Sensitive"] }), _jsxs("label", { children: [_jsx("input", { type: "checkbox", checked: matcher.required || false, onChange: (e) => updateMatcher(index, { required: e.target.checked }) }), "Required"] })] })] }, index)))] }));
};
const TimeConstraintsEditor = ({ constraints, onChange }) => {
    return (_jsxs("div", { className: "time-constraints-editor", children: [_jsx("h5", { children: "Time Constraints" }), _jsxs("div", { className: "form-row", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Min Time from Previous (seconds)" }), _jsx("input", { type: "number", min: "0", value: constraints.minTimeFromPrevious ? constraints.minTimeFromPrevious / 1000 : '', onChange: (e) => onChange({
                                    ...constraints,
                                    minTimeFromPrevious: e.target.value ? parseInt(e.target.value) * 1000 : undefined
                                }), className: "form-input" })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Max Time from Previous (seconds)" }), _jsx("input", { type: "number", min: "0", value: constraints.maxTimeFromPrevious ? constraints.maxTimeFromPrevious / 1000 : '', onChange: (e) => onChange({
                                    ...constraints,
                                    maxTimeFromPrevious: e.target.value ? parseInt(e.target.value) * 1000 : undefined
                                }), className: "form-input" })] })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Max Time from Start (seconds)" }), _jsx("input", { type: "number", min: "0", value: constraints.maxTimeFromStart ? constraints.maxTimeFromStart / 1000 : '', onChange: (e) => onChange({
                            ...constraints,
                            maxTimeFromStart: e.target.value ? parseInt(e.target.value) * 1000 : undefined
                        }), className: "form-input" })] })] }));
};
// Placeholder components for other tabs
const ConditionalPathsConfiguration = () => (_jsx("div", { children: "Conditional Paths Configuration (TODO: Implement)" }));
const SuccessCriteriaConfiguration = () => (_jsx("div", { children: "Success Criteria Configuration (TODO: Implement)" }));
const AnalyticsConfiguration = () => (_jsx("div", { children: "Analytics Configuration (TODO: Implement)" }));
const TemplateSelectionModal = ({ templates, onSelect, onClose }) => {
    return (_jsx("div", { className: "modal-overlay", children: _jsxs("div", { className: "template-modal", children: [_jsxs("div", { className: "modal-header", children: [_jsx("h3", { children: "Choose Funnel Template" }), _jsx("button", { onClick: onClose, className: "close-button", children: "\u00D7" })] }), _jsx("div", { className: "template-grid", children: templates.map(template => (_jsxs("div", { className: "template-card", children: [_jsxs("div", { className: "template-info", children: [_jsx("h4", { children: template.name }), _jsx("p", { children: template.description }), _jsxs("div", { className: "template-meta", children: [_jsx("span", { className: "category", children: template.category }), _jsxs("span", { className: "steps-count", children: [template.steps.length, " steps"] })] }), _jsx("div", { className: "template-tags", children: template.tags.map(tag => (_jsx("span", { className: "tag", children: tag }, tag))) })] }), _jsx("button", { onClick: () => onSelect(template), className: "use-template-button", children: "Use Template" })] }, template.id))) }), templates.length === 0 && (_jsx("div", { className: "empty-templates", children: _jsx("p", { children: "No templates available." }) }))] }) }));
};
