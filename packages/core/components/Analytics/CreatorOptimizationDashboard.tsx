...
export const CreatorOptimizationDashboard: React.FC<CreatorOptimizationDashboardProps> = ({
  ...
  const generateCreatorOverviewMetrics = (profile: CreatorProfile): CreatorOverviewMetrics => {
    return {
  ...
  const generateOptimizationRecommendations = (profile: CreatorProfile): CreatorOptimizationRecommendation[] => {
    return [
      {
  ...
  const generateGrowthOpportunities = (profile: CreatorProfile): CreatorGrowthOpportunity[] => {
    return [
      {
  ...
  const generateLearningResources = (profile: CreatorProfile): CreatorLearningResource[] => {
    return [
      {
  ...
  const generateSuccessStories = (profile: CreatorProfile): CreatorSuccessStory[] => {
    return [
      {
  ...
  const generateAutomatedSuggestions = (profile: CreatorProfile): AutomatedSuggestion[] => {
    return [
      {
  ...
  const generateGoalProgress = (profile: CreatorProfile): CreatorGoalProgress[] => {
  ...
  // Handle action taken
  const handleActionTaken = useCallback((actionType: string, details: Record<string, any>) => {
  ...
  const handleExport = useCallback(() => {
    if (!optimizationData || !onExport) return;
