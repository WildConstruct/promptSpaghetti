...
export const FunnelAnomalyDetection = ({ funnelDefinition, analyticsInfrastructure, timeRange, detectionConfig = defaultDetectionConfig, alertConfig = defaultAlertConfig, segments = [], cohorts = [], realTimeMonitoring = false, onAnomalyDetected, onAlertTriggered, onExport }) => {
    ...
    const loadAnomalyData = useCallback(async () => {
        try {
            ...
            if (result.success && result.data) {
                const anomalyData = await processAnomalyDetectionData(result.data, detectionConfig, alertConfig);
    ...
    const processAnomalyDetectionData = async (rawData, config, alertCfg) => {
    ...
    const handleAcknowledgeAnomaly = useCallback((anomalyId) => {
        setDetectionData(prev => {
            ...
            return {
                ...prev,
                currentAnomalies: prev.currentAnomalies.map(anomaly => anomaly.id === anomalyId
    ...
    if (loading) {
        return (_jsxs("div", { className: "funnel-anomaly-detection-loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading anomaly detection data..." })] }));
    }
    if (error) {
        return (_jsxs("div", { className: "funnel-anomaly-detection-error", children: [_jsx("h3", { children: "Error Loading Anomaly Detection" }), _jsx("p", { className: "error-message", children: error }), _jsx("button", { onClick: loadAnomalyData, className: "retry-button", children: "Retry" })] }));
    }
    if (!detectionData) {
        return _jsx("div", { className: "funnel-anomaly-detection-error", children: "No data available" });
    }
    return (_jsxs("div", { className: "funnel-anomaly-detection", children: [_jsxs("div", { className: "anomaly-detection-header", children: [_jsxs("div", { className: "detection-info", children: [_jsx("h3", { children: "Funnel Anomaly Detection" }), _jsxs("p", { children: ["Real-time monitoring and alerting for ", funnelDefinition.name] })] }), _jsxs("div", { className: "system-health", children: [_jsxs("div", { className: "health-metric", children: [_jsx("span", { className: "label", children: "System Health" }), _jsxs("span", { className: "value", children: [Math.round(detectionData.systemHealth.systemAvailability * 100), "%"] })] }), _jsxs("div", { className: "health-metric", children: [_jsx("span", { className: "label", children: "Detection Latency" }), _jsxs("span", { className: "value", children: [detectionData.systemHealth.detectionLatency, "s"] })] }), _jsxs("div", { className: "health-metric", children: [_jsx("span", { className: "label", children: "False Positive Rate" }), _jsxs("span", { className: "value", children: [Math.round(detectionData.systemHealth.falsePositiveRate * 100), "%"] })] })] }), _jsxs("div", { className: "detection-controls", children: [_jsxs("label", { className: "real-time-toggle", children: [_jsx("input", { type: "checkbox", checked: realTimeEnabled, onChange: (e) => setRealTimeEnabled(e.target.checked) }), "Real-time Monitoring"] }), _jsx("button", { onClick: handleExport, className: "export-button", children: "Export Data" })] })] }), _jsxs("div", { className: "detection-tabs", children: [_jsxs("button", { className: `tab ${activeTab === 'current' ? 'active' : ''}`, onClick: () => setActiveTab('current'), children: ["Current Anomalies (", detectionData.currentAnomalies.length, ")"] }), _jsxs("button", { className: `tab ${activeTab === 'historical' ? 'active' : ''}`, onClick: () => setActiveTab('historical'), children: ["Historical (", detectionData.historicalAnomalies.length, ")"] }), _jsxs("button", { className: `tab ${activeTab === 'predicted' ? 'active' : ''}`, onClick: () => setActiveTab('predicted'), children: ["Predictions (", detectionData.predictedAnomalies.length, ")"] }), _jsxs("button", { className: `tab ${activeTab === 'alerts' ? 'active' : ''}`, onClick: () => setActiveTab('alerts'), children: ["Alert History (", detectionData.alertHistory.length, ")"] })] }), _jsxs("div", { className: "detection-filters", children: [_jsxs("select", { value: filterSeverity, onChange: (e) => setFilterSeverity(e.target.value), className: "severity-filter", children: [_jsx("option", { value: "all", children: "All Severities" }), _jsx("option", { value: "critical", children: "Critical" }), _jsx("option", { value: "high", children: "High" }), _jsx("option", { value: "medium", children: "Medium" }), _jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "info", children: "Info" })] }), _jsxs("select", { value: filterType, onChange: (e) => setFilterType(e.target.value), className: "type-filter", children: [_jsx("option", { value: "all", children: "All Types" }), _jsx("option", { value: "performance_drop", children: "Performance Drop" }), _jsx("option", { value: "conversion_anomaly", children: "Conversion Anomaly" }), _jsx("option", { value: "traffic_anomaly", children: "Traffic Anomaly" }), _jsx("option", { value: "revenue_anomaly", children: "Revenue Anomaly" }), _jsx("option", { value: "technical_anomaly", children: "Technical Anomaly" })] })] }), _jsx("div", { className: "detection-content", children: activeTab === 'current' || activeTab === 'historical' ? (_jsx("div", { className: "anomaly-list", children: filteredAnomalies.length === 0 ? (_jsx("div", { className: "no-anomalies", children: _jsx("p", { children: "No anomalies detected matching current filters" }) })) : (filteredAnomalies.map(anomaly => (_jsxs("div", { className: `anomaly-card ${anomaly.severity}`, children: [_jsxs("div", { className: "anomaly-header", children: [_jsxs("div", { className: "anomaly-title", children: [_jsx("h4", { children: anomaly.description }), _jsx("span", { className: `severity-badge ${anomaly.severity}`, children: anomaly.severity.toUpperCase() }), _jsx("span", { className: `status-badge ${anomaly.status}`, children: anomaly.status.replace('_', ' ').toUpperCase() })] }), _jsxs("div", { className: "anomaly-meta", children: [_jsx("span", { className: "timestamp", children: new Date(anomaly.timestamp).toLocaleString() }), _jsxs("span", { className: "confidence", children: [Math.round(anomaly.confidence * 100), "% confidence"] })] })] }), _jsxs("div", { className: "anomaly-metrics", children: [_jsxs("div", { className: "metric", children: [_jsx("span", { className: "label", children: "Metric:" }), _jsx("span", { className: "value", children: anomaly.metric })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { className: "label", children: "Expected:" }), _jsx("span", { className: "value", children: anomaly.expectedValue.toFixed(3) })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { className: "label", children: "Actual:" }), _jsx("span", { className: "value", children: anomaly.actualValue.toFixed(3) })] }), _jsxs("div", { className: "metric", children: [_jsx("span", { className: "label", children: "Deviation:" }), _jsxs("span", { className: `value ${anomaly.deviation < 0 ? 'negative' : 'positive'}`, children: [anomaly.deviationPercentage.toFixed(1), "%"] })] })] }), anomaly.impact && (_jsxs("div", { className: "impact-summary", children: [_jsx("strong", { children: "Impact:" }), _jsxs("div", { className: "impact-metrics", children: [anomaly.impact.revenueImpact !== 0 && (_jsxs("span", { className: "impact-metric", children: ["Revenue: $", Math.abs(anomaly.impact.revenueImpact)] })), anomaly.impact.userImpact !== 0 && (_jsxs("span", { className: "impact-metric", children: ["Users: ", anomaly.impact.userImpact] })), _jsxs("span", { className: "impact-metric", children: ["Scope: ", anomaly.impact.scopeOfImpact.replace('_', ' ')] })] })] })), anomaly.rootCauses.length > 0 && (_jsxs("div", { className: "root-causes", children: [_jsx("strong", { children: "Likely Causes:" }), _jsx("ul", { children: anomaly.rootCauses.slice(0, 2).map((cause, index) => (_jsxs("li", { children: [cause.description, " (", Math.round(cause.probability * 100), "% probability)"] }, index))) })] })), anomaly.recommendations.length > 0 && (_jsxs("div", { className: "recommendations", children: [_jsx("strong", { children: "Recommended Actions:" }), _jsx("ul", { children: anomaly.recommendations.slice(0, 2).map((rec, index) => (_jsxs("li", { className: `priority-${rec.priority}`, children: [rec.action, " (", rec.priority, " priority)"] }, index))) })] })), _jsxs("div", { className: "anomaly-actions", children: [anomaly.status === 'new' && (_jsx("button", { onClick: () => handleAcknowledgeAnomaly(anomaly.id), className: "acknowledge-button", children: "Acknowledge" })), _jsx("button", { onClick: () => setSelectedAnomaly(anomaly), className: "details-button", children: "View Details" })] })] }, anomaly.id)))) })) : activeTab === 'predicted' ? (_jsx("div", { className: "prediction-list", children: detectionData.predictedAnomalies.map((prediction, index) => (_jsxs("div", { className: "prediction-card", children: [_jsxs("div", { className: "prediction-header", children: [_jsxs("h4", { children: ["Predicted ", prediction.type.replace('_', ' ')] }), _jsx("span", { className: `severity-badge ${prediction.expectedSeverity}`, children: prediction.expectedSeverity.toUpperCase() })] }), _jsxs("div", { className: "prediction-details", children: [_jsxs("div", { className: "prediction-meta", children: [_jsxs("span", { children: ["Expected: ", new Date(prediction.predictedTimestamp).toLocaleString()] }), _jsxs("span", { children: ["Probability: ", Math.round(prediction.probability * 100), "%"] })] }), _jsxs("div", { className: "preventive-actions", children: [_jsx("strong", { children: "Preventive Actions:" }), _jsx("ul", { children: prediction.preventiveActions.map((action, actionIndex) => (_jsxs("li", { children: [action.action, " (Effectiveness: ", Math.round(action.effectiveness * 100), "%)"] }, actionIndex))) })] })] })] }, index))) })) : (_jsx("div", { className: "alert-history", children: detectionData.alertHistory.map(alert => (_jsxs("div", { className: `alert-card ${alert.severity}`, children: [_jsxs("div", { className: "alert-header", children: [_jsx("h4", { children: alert.message }), _jsx("span", { className: `status-badge ${alert.status}`, children: alert.status.toUpperCase() })] }), _jsxs("div", { className: "alert-details", children: [_jsxs("div", { className: "alert-meta", children: [_jsxs("span", { children: ["Channel: ", alert.channel] }), _jsxs("span", { children: ["Recipient: ", alert.recipient] }), _jsxs("span", { children: ["Time: ", new Date(alert.timestamp).toLocaleString()] })] }), alert.acknowledgedBy && (_jsxs("div", { className: "alert-acknowledgment", children: ["Acknowledged by ", alert.acknowledgedBy, " at ", new Date(alert.acknowledgedAt).toLocaleString()] }))] })] }, alert.id))) })) }), selectedAnomaly && (_jsx("div", { className: "anomaly-detail-modal", children: _jsx("div", { className: "modal-overlay", onClick: () => setSelectedAnomaly(null), children: _jsxs("div", { className: "modal-content", onClick: e => e.stopPropagation(), children: [_jsxs("div", { className: "modal-header", children: [_jsx("h3", { children: "Anomaly Details" }), _jsx("button", { onClick: () => setSelectedAnomaly(null), className: "close-button", children: "\u00D7" })] }), _jsxs("div", { className: "modal-body", children: [_jsxs("div", { className: "anomaly-overview", children: [_jsx("h4", { children: selectedAnomaly.description }), _jsxs("div", { className: "anomaly-badges", children: [_jsx("span", { className: `severity-badge ${selectedAnomaly.severity}`, children: selectedAnomaly.severity }), _jsx("span", { className: "algorithm-badge", children: selectedAnomaly.algorithm })] })] }), _jsx("div", { className: "detailed-metrics", children: _jsx("h5", { children: "Detailed Metrics" }) }), _jsx("div", { className: "context-analysis", children: _jsx("h5", { children: "Context Analysis" }) })] })] }) }) }))] }));
};
