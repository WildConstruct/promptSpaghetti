...
export const MarketplaceFunnelIntegration = ({ funnelDefinition, analyticsInfrastructure, marketplaceContext, integrationMode = 'embedded_widget', widgetConfig = defaultWidgetConfig, userRole = 'viewer', onOptimizationAction, onInsightInteraction, onExport }) => {
