...
export const CreatorOptimizationDashboard = ({ creatorId, creatorProfile, funnelDefinition, analyticsInfrastructure, timeRange = { start: Date.now() - 30 * 24 * 60 * 60 * 1000, end: Date.now() }, dashboardMode = 'overview', onActionTaken, onGoalSet, onExport }) => {
    ...
    // Handle goal setting
    const handleGoalSet = useCallback((goalData) => {
        const goal = {
