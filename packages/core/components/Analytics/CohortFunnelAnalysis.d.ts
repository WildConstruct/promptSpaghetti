...
export interface CohortTemporalPerformance { period: number;
    periodLabel: string;
    entries: number;
    conversions: number;
    conversionRate: number;
...
export interface CohortProgressionMetrics { progressionRate: number;
...
export interface ValueDistribution { lowValue: {
        threshold: number;
        percentage: number;
        totalValue: number }
}
    };
    mediumValue: { threshold: number;
        percentage: number;
        totalValue: number };
    highValue: { threshold: number;
        percentage: number;
        totalValue: number };
    topPercentile: { threshold: number;
        percentage: number;
        totalValue: number };
...
export interface PeerCohortComparison { peerCohortId: string;
...
export interface MaturityMetrics { overallMaturity: number;
...
export interface LifecycleHealthMetrics { healthScore: number;
...
export interface PredictionResult { timeframe: number;
...
export interface CohortAnalysisExportData { analysisMode: CohortAnalysisMode;
    ...
    visualizations: { comparative: string;
        retention: string;
        lifecycle: string;
        behavior: string };
    insights: CohortInsight[];
