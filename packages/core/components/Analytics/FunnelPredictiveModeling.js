...
export const FunnelPredictiveModeling = ({ funnelDefinition, analyticsInfrastructure, timeRange, modelConfig = defaultModelConfig, segments = [], cohorts = [], forecastHorizon = 'medium', onPredictionUpdate, onModelAlert, onExport }) => {
    ...
    const loadModelingData = useCallback(async () => {
        try {
            ...
            if (result.success && result.data) {
                const predictiveData = await processPredictiveData(result.data, modelConfig, selectedHorizon);
    ...
    const processPredictiveData = async (rawData, config, horizon) => {
    ...
    const generatePerformanceForecasts = (models, horizon) => {
    ...
    if (loading) {
        return (_jsxs("div", { className: "funnel-predictive-modeling-loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading predictive modeling data..." })] }));
    }
    if (error) {
        return (_jsxs("div", { className: "funnel-predictive-modeling-error", children: [_jsx("h3", { children: "Error Loading Predictive Modeling" }), _jsx("p", { className: "error-message", children: error }), _jsx("button", { onClick: loadModelingData, className: "retry-button", children: "Retry" })] }));
    }
    if (!modelingData) {
        return _jsx("div", { className: "funnel-predictive-modeling-error", children: "No data available" });
    }
    return (_jsxs("div", { className: "funnel-predictive-modeling", children: [_jsxs("div", { className: "modeling-header", children: [_jsxs("div", { className: "modeling-info", children: [_jsx("h3", { children: "Predictive Funnel Modeling" }), _jsxs("p", { children: ["AI-powered performance forecasting for ", funnelDefinition.name] })] }), _jsxs("div", { className: "modeling-controls", children: [_jsx("select", { value: selectedModel, onChange: (e) => setSelectedModel(e.target.value), className: "model-selector", children: modelConfig.models.map(model => (_jsx("option", { value: model, children: model.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }, model))) }), _jsxs("select", { value: selectedHorizon, onChange: (e) => setSelectedHorizon(e.target.value), className: "horizon-selector", children: [_jsx("option", { value: "short", children: "Short Term (7 days)" }), _jsx("option", { value: "medium", children: "Medium Term (30 days)" }), _jsx("option", { value: "long", children: "Long Term (90 days)" })] }), _jsxs("label", { className: "realtime-toggle", children: [_jsx("input", { type: "checkbox", checked: realtimeUpdates, onChange: (e) => setRealtimeUpdates(e.target.checked) }), "Real-time Updates"] }), _jsx("button", { onClick: handleExport, className: "export-button", children: "Export Predictions" })] })] }), _jsxs("div", { className: "modeling-tabs", children: [_jsx("button", { className: `tab ${activeTab === 'forecasts' ? 'active' : ''}`, onClick: () => setActiveTab('forecasts'), children: "Performance Forecasts" }), _jsx("button", { className: `tab ${activeTab === 'behavior' ? 'active' : ''}`, onClick: () => setActiveTab('behavior'), children: "Behavior Predictions" }), _jsx("button", { className: `tab ${activeTab === 'churn' ? 'active' : ''}`, onClick: () => setActiveTab('churn'), children: "Churn Analysis" }), _jsx("button", { className: `tab ${activeTab === 'scenarios' ? 'active' : ''}`, onClick: () => setActiveTab('scenarios'), children: "Scenario Planning" }), _jsx("button", { className: `tab ${activeTab === 'models' ? 'active' : ''}`, onClick: () => setActiveTab('models'), children: "Model Performance" })] }), _jsxs("div", { className: "modeling-content", children: [activeTab === 'forecasts' && (_jsx("div", { className: "performance-forecasts", children: modelingData.performanceForecasts
                            .filter(forecast => forecast.model === selectedModel)
                            .map(forecast => (_jsxs("div", { className: "forecast-card", children: [_jsxs("div", { className: "forecast-header", children: [_jsxs("h4", { children: [forecast.model.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()), " Forecast"] }), _jsxs("span", { className: "horizon-badge", children: [forecast.horizon, " term"] })] }), _jsx("div", { className: "forecast-metrics", children: _jsxs("div", { className: "metric-grid", children: [_jsxs("div", { className: "metric-card", children: [_jsx("span", { className: "metric-label", children: "Conversion Rate" }), _jsxs("span", { className: "metric-value", children: [Math.round(forecast.metrics.conversionRate.forecastedValue * 100), "%"] }), _jsxs("span", { className: `metric-change ${forecast.metrics.conversionRate.changePercent >= 0 ? 'positive' : 'negative'}`, children: [forecast.metrics.conversionRate.changePercent >= 0 ? '+' : '', forecast.metrics.conversionRate.changePercent.toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("span", { className: "metric-label", children: "Revenue" }), _jsxs("span", { className: "metric-value", children: ["$", forecast.metrics.revenue.forecastedValue.toLocaleString()] }), _jsxs("span", { className: `metric-change ${forecast.metrics.revenue.changePercent >= 0 ? 'positive' : 'negative'}`, children: [forecast.metrics.revenue.changePercent >= 0 ? '+' : '', forecast.metrics.revenue.changePercent.toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("span", { className: "metric-label", children: "User Acquisition" }), _jsx("span", { className: "metric-value", children: forecast.metrics.userAcquisition.forecastedValue.toLocaleString() }), _jsxs("span", { className: `metric-change ${forecast.metrics.userAcquisition.changePercent >= 0 ? 'positive' : 'negative'}`, children: [forecast.metrics.userAcquisition.changePercent >= 0 ? '+' : '', forecast.metrics.userAcquisition.changePercent.toFixed(1), "%"] })] }), _jsxs("div", { className: "metric-card", children: [_jsx("span", { className: "metric-label", children: "Churn Rate" }), _jsxs("span", { className: "metric-value", children: [Math.round(forecast.metrics.churnRate.forecastedValue * 100), "%"] }), _jsxs("span", { className: `metric-change ${forecast.metrics.churnRate.changePercent <= 0 ? 'positive' : 'negative'}`, children: [forecast.metrics.churnRate.changePercent >= 0 ? '+' : '', forecast.metrics.churnRate.changePercent.toFixed(1), "%"] })] })] }) }), _jsxs("div", { className: "forecast-factors", children: [_jsx("h5", { children: "Key Factors" }), _jsx("div", { className: "factor-list", children: forecast.factors.slice(0, 3).map((factor, index) => (_jsxs("div", { className: "factor-item", children: [_jsx("span", { className: "factor-name", children: factor.factor }), _jsxs("span", { className: "factor-impact", children: ["Impact: ", Math.round(factor.impact * 100), "%"] }), _jsxs("span", { className: "factor-confidence", children: ["Confidence: ", Math.round(factor.confidence * 100), "%"] })] }, index))) })] }), _jsxs("div", { className: "forecast-accuracy", children: [_jsx("strong", { children: "Model Accuracy:" }), " ", Math.round(forecast.accuracy.accuracy * 100), "%", _jsxs("span", { className: "accuracy-details", children: ["(MAPE: ", forecast.accuracy.mape.toFixed(1), "%, R\u00B2: ", forecast.accuracy.r2.toFixed(3), ")"] })] })] }, forecast.forecastId))) })), activeTab === 'behavior' && (_jsxs("div", { className: "behavior-predictions", children: [_jsxs("div", { className: "behavior-summary", children: [_jsx("h4", { children: "User Behavior Predictions" }), _jsxs("div", { className: "summary-stats", children: [_jsxs("div", { className: "stat", children: [_jsx("span", { className: "stat-label", children: "High Conversion Probability" }), _jsx("span", { className: "stat-value", children: modelingData.userBehaviorPredictions.filter(p => p.conversionProbability.probability > 0.7).length })] }), _jsxs("div", { className: "stat", children: [_jsx("span", { className: "stat-label", children: "High Churn Risk" }), _jsx("span", { className: "stat-value", children: modelingData.userBehaviorPredictions.filter(p => p.churnRisk.riskLevel === 'high' || p.churnRisk.riskLevel === 'critical').length })] }), _jsxs("div", { className: "stat", children: [_jsx("span", { className: "stat-label", children: "Avg Conversion Probability" }), _jsxs("span", { className: "stat-value", children: [Math.round(modelingData.userBehaviorPredictions.reduce((sum, p) => sum + p.conversionProbability.probability, 0) /
                                                                modelingData.userBehaviorPredictions.length * 100), "%"] })] })] })] }), _jsx("div", { className: "behavior-list", children: modelingData.userBehaviorPredictions.slice(0, 10).map(prediction => (_jsxs("div", { className: "behavior-card", children: [_jsxs("div", { className: "behavior-header", children: [_jsxs("h5", { children: ["User ", prediction.userId] }), _jsx("span", { className: "segment-badge", children: prediction.segment })] }), _jsxs("div", { className: "behavior-metrics", children: [_jsxs("div", { className: "behavior-metric", children: [_jsx("span", { className: "metric-label", children: "Conversion Probability" }), _jsxs("span", { className: "metric-value", children: [Math.round(prediction.conversionProbability.probability * 100), "%"] })] }), _jsxs("div", { className: "behavior-metric", children: [_jsx("span", { className: "metric-label", children: "Churn Risk" }), _jsx("span", { className: `risk-badge ${prediction.churnRisk.riskLevel}`, children: prediction.churnRisk.riskLevel.toUpperCase() })] }), _jsxs("div", { className: "behavior-metric", children: [_jsx("span", { className: "metric-label", children: "Engagement Trend" }), _jsx("span", { className: `trend-badge ${prediction.engagement.trend}`, children: prediction.engagement.trend.toUpperCase() })] })] }), _jsxs("div", { className: "recommended-interventions", children: [_jsx("strong", { children: "Recommended Actions:" }), _jsx("ul", { children: prediction.recommendedInterventions.slice(0, 2).map((intervention, index) => (_jsx("li", { className: `priority-${intervention.priority}`, children: intervention.description }, index))) })] })] }, prediction.userId))) })] })), activeTab === 'churn' && (_jsx("div", { className: "churn-analysis", children: modelingData.churnPredictions.map((churnPred, index) => (_jsxs("div", { className: "churn-prediction-card", children: [_jsxs("div", { className: "churn-header", children: [_jsxs("h4", { children: [churnPred.timeHorizon, "-Day Churn Prediction"] }), _jsxs("div", { className: "churn-rate", children: [_jsxs("span", { className: "current-rate", children: ["Current: ", Math.round(churnPred.churnRate.currentRate * 100), "%"] }), _jsxs("span", { className: "predicted-rate", children: ["Predicted: ", Math.round(churnPred.churnRate.predictedRate * 100), "%"] })] })] }), _jsxs("div", { className: "risk-segments", children: [_jsx("h5", { children: "Risk Segments" }), _jsx("div", { className: "segment-grid", children: churnPred.riskSegments.map(segment => (_jsxs("div", { className: `risk-segment ${segment.riskLevel}`, children: [_jsx("h6", { children: segment.segmentName }), _jsxs("div", { className: "segment-metrics", children: [_jsxs("span", { children: ["Risk: ", segment.riskLevel] }), _jsxs("span", { children: ["Size: ", segment.size] }), _jsxs("span", { children: ["Churn Prob: ", Math.round(segment.churnProbability * 100), "%"] })] })] }, segment.segmentId))) })] }), _jsxs("div", { className: "prevention-strategies", children: [_jsx("h5", { children: "Prevention Strategies" }), _jsx("div", { className: "strategy-list", children: churnPred.preventionStrategies.map(strategy => (_jsxs("div", { className: "strategy-card", children: [_jsx("h6", { children: strategy.name }), _jsx("p", { children: strategy.description }), _jsxs("div", { className: "strategy-metrics", children: [_jsxs("span", { children: ["Effectiveness: ", Math.round(strategy.effectiveness * 100), "%"] }), _jsxs("span", { children: ["Cost: $", strategy.cost.toLocaleString()] }), _jsxs("span", { children: ["Timeline: ", strategy.timeline, " days"] })] })] }, strategy.strategyId))) })] }), _jsxs("div", { className: "impact-analysis", children: [_jsx("h5", { children: "Impact Analysis" }), _jsxs("div", { className: "impact-metrics", children: [_jsxs("div", { className: "impact-metric", children: [_jsx("span", { className: "label", children: "Revenue Impact" }), _jsxs("span", { className: "value", children: ["$", churnPred.impactAnalysis.revenueImpact.toLocaleString()] })] }), _jsxs("div", { className: "impact-metric", children: [_jsx("span", { className: "label", children: "User Impact" }), _jsx("span", { className: "value", children: churnPred.impactAnalysis.userImpact })] }), _jsxs("div", { className: "impact-metric", children: [_jsx("span", { className: "label", children: "Net Impact" }), _jsxs("span", { className: "value", children: ["$", churnPred.impactAnalysis.netImpact.toLocaleString()] })] })] })] })] }, index))) })), activeTab === 'scenarios' && (_jsxs("div", { className: "scenario-analysis", children: [_jsx("h4", { children: "Scenario Planning" }), _jsx("div", { className: "scenario-grid", children: modelingData.scenarioAnalysis.map(scenario => (_jsxs("div", { className: "scenario-card", children: [_jsxs("div", { className: "scenario-header", children: [_jsx("h5", { children: scenario.name }), _jsxs("span", { className: "probability-badge", children: [Math.round(scenario.probability * 100), "% probability"] })] }), _jsx("p", { className: "scenario-description", children: scenario.description }), _jsxs("div", { className: "scenario-parameters", children: [_jsx("strong", { children: "Key Parameters:" }), _jsx("ul", { children: scenario.parameters.map((param, index) => (_jsxs("li", { children: [param.parameter, ": ", param.baseValue, " \u2192 ", param.scenarioValue, "(", Math.round(param.impact * 100), "% impact)"] }, index))) })] }), _jsxs("div", { className: "scenario-outcomes", children: [_jsx("strong", { children: "Expected Outcomes:" }), _jsx("div", { className: "outcome-metrics", children: scenario.outcomes.map((outcome, index) => (_jsxs("div", { className: "outcome-metric", children: [_jsx("span", { className: "metric-name", children: outcome.metric.replace('_', ' ') }), _jsx("span", { className: "metric-value", children: outcome.predictedValue.toLocaleString() }), _jsxs("span", { className: `metric-impact ${outcome.impact >= 0 ? 'positive' : 'negative'}`, children: [outcome.impact >= 0 ? '+' : '', Math.round(outcome.impact * 100), "%"] })] }, index))) })] }), _jsxs("div", { className: "scenario-recommendations", children: [_jsx("strong", { children: "Recommendations:" }), _jsx("ul", { children: scenario.recommendations.map((rec, index) => (_jsxs("li", { children: [rec.action, " (Expected benefit: $", rec.expectedBenefit.toLocaleString(), ")"] }, index))) })] })] }, scenario.scenarioId))) })] })), activeTab === 'models' && (_jsxs("div", { className: "model-performance", children: [_jsx("h4", { children: "Model Performance Dashboard" }), _jsx("div", { className: "model-grid", children: modelingData.modelPerformance.map(model => (_jsxs("div", { className: "model-card", children: [_jsxs("div", { className: "model-header", children: [_jsx("h5", { children: model.model.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) }), _jsxs("span", { className: "last-update", children: ["Updated: ", new Date(model.lastUpdate).toLocaleDateString()] })] }), _jsxs("div", { className: "model-accuracy", children: [_jsxs("div", { className: "accuracy-metric", children: [_jsx("span", { className: "label", children: "Overall Accuracy" }), _jsxs("span", { className: "value", children: [Math.round(model.accuracy.overall * 100), "%"] })] }), _jsxs("div", { className: "accuracy-metric", children: [_jsx("span", { className: "label", children: "Precision" }), _jsxs("span", { className: "value", children: [Math.round(model.accuracy.precision * 100), "%"] })] }), _jsxs("div", { className: "accuracy-metric", children: [_jsx("span", { className: "label", children: "Recall" }), _jsxs("span", { className: "value", children: [Math.round(model.accuracy.recall * 100), "%"] })] }), _jsxs("div", { className: "accuracy-metric", children: [_jsx("span", { className: "label", children: "F1 Score" }), _jsx("span", { className: "value", children: model.accuracy.f1Score.toFixed(3) })] })] }), _jsxs("div", { className: "training-info", children: [_jsx("strong", { children: "Training Details:" }), _jsxs("div", { className: "training-metrics", children: [_jsxs("span", { children: ["Training Size: ", model.training.trainingSize.toLocaleString()] }), _jsxs("span", { children: ["Features: ", model.training.features] }), _jsxs("span", { children: ["Training Time: ", Math.round(model.training.trainingTime / 60), "m"] })] })] }), model.drift.detected && (_jsxs("div", { className: `drift-alert ${model.drift.severity}`, children: [_jsx("strong", { children: "Model Drift Detected" }), _jsxs("p", { children: ["Severity: ", model.drift.severity] }), _jsx("p", { children: model.drift.recommendation })] }))] }, model.model))) }), _jsxs("div", { className: "feature-importance", children: [_jsx("h5", { children: "Feature Importance" }), _jsx("div", { className: "importance-list", children: modelingData.featureImportance.slice(0, 10).map(feature => (_jsxs("div", { className: "importance-item", children: [_jsx("span", { className: "feature-name", children: feature.feature.replace('_', ' ') }), _jsx("div", { className: "importance-bar", children: _jsx("div", { className: "importance-fill", style: { width: `${feature.importance * 100}%` } }) }), _jsxs("span", { className: "importance-value", children: [Math.round(feature.importance * 100), "%"] }), _jsx("span", { className: `actionability-badge ${feature.actionability}`, children: feature.actionability })] }, feature.feature))) })] })] }))] })] }));
};
