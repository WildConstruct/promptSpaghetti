...
export interface EngagementMetricsTrendAnalysisProps { analyticsInfrastructure: ConversionAnalyticsInfrastructure;
...
export interface TrendAnalysisConfig { algorithms: TrendAlgorithm[];
...
export interface EngagementMetricsExportData { metricsData: EngagementMetricsData[];
    ...
    metadata: { exportTimestamp: number;
        version: string;
