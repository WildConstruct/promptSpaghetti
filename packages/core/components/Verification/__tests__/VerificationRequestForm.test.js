...
describe('VerificationRequestForm', () => {
    beforeEach(() => {
        ...
        mockOnSubmit.mockResolvedValue({ requestId: 'req_123', status: 'pending' });
    });
    describe('Form Rendering', () => {
        test('renders verification form with header and progress steps', () => {
            render(_jsx(VerificationRequestForm, { ...defaultProps }));
    ...
    describe('Cancel Functionality', () => {
        ...
        test('does not render cancel button when onCancel is not provided', () => {
            render(_jsx(VerificationRequestForm, { userId: "test-user", onSubmit: mockOnSubmit }));
