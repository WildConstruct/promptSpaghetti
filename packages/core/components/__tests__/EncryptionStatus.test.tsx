...
describe('EncryptionStatus Components', () => { const mockEncryptionState: EncryptionState = {,
  status: 'encrypted',
  ...
  describe('EncryptionDetails', () => { const mockHandlers = {
  onEncrypt: jest.fn()
  onDecrypt: jest.fn()
  onChangeAlgorithm: jest.fn() }
    ...
    it('formats data sizes correctly', () => { const smallDataState: EncryptionState = {
  status: 'encrypted'
  dataSize: 512 }
};
  ...
  dataSize: 1024 * 1024 * 1024 * 2.5 }
    ...
    it('shows correct strength colors', () => { const strongState: EncryptionState = {
  status: 'encrypted'
  strength: 'strong' }
};
  ...
  strength: 'weak' }
    ...
    it('provides correct algorithm strength descriptions', () => { const aes256State: EncryptionState = {
  status: 'encrypted'
  algorithm: 'AES-256-GCM' }
};
  ...
  describe('Component Integration', () => {
    ...
    it('handles different encryption algorithms', () => { const algorithms: EncryptionAlgorithm = [
