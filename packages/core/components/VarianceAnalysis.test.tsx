...
const mockAnalysis = { overallVariance: 'medium' as const
  varianceScore: 0.65
  diversityMetrics: {
...
describe('VarianceAnalysis', () => { beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe('Basic Rendering', () => { it('should render variance analysis for multiple results', () => {
      const results = [
    ...
    it('should render compact mode correctly', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
  ...
  describe('Diversity Metrics', () => { it('should display diversity metric cards', () => {
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
    ...
    it('should show metric levels correctly', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
    ...
    it('should display metric descriptions', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
  ...
  describe('Creative Range Summary', () => { it('should display creative range information', () => {
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
    ...
    it('should show unique and common elements', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
    ...
    it('should display repetition rate and creativity score', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
  ...
  describe('Suggestions', () => { it('should display optimization suggestions', () => {
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
    ...
    it('should show suggestion categories and impacts', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
    ...
    it('should handle suggestion clicks for actionable suggestions', () => { const mockOnSuggestionClick = jest.fn<unknown, unknown>();
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
    ...
    it('should not handle clicks for non-actionable suggestions', () => { const mockOnSuggestionClick = jest.fn<unknown, unknown>();
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
  ...
  describe('Variance Levels', () => { it('should display low variance styling', () => {
  const lowVarianceAnalysis = {
  ...mockAnalysis
  overallVariance: 'low' as const
  varianceScore: 0.2 }
};
      const lowVarianceInfo = { color: '#ef4444'
  background: '#fef2f2'
  border: '#fecaca'
  icon: '🔴'
  description: 'Results are very similar' }
    ...
    it('should display high variance styling', () => { const highVarianceAnalysis = {
  ...mockAnalysis
  overallVariance: 'high' as const
  varianceScore: 0.9 }
};
      const highVarianceInfo = { color: '#10b981'
  background: '#f0fdf4'
  border: '#bbf7d0'
  icon: '🟢'
  ...
  describe('Service Integration', () => { it('should call variance analysis service with correct parameters', () => {
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
  ...
  describe('Edge Cases', () => { it('should handle empty suggestions', () => {
  ...
  suggestions: [] }
    ...
    it('should handle empty unique/common elements', () => { const analysisWithEmptyElements = {
  ...mockAnalysis
  creativeRange: {
  ...
  commonElements: [] }
    ...
    it('should handle missing onSuggestionClick prop', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
  ...
  describe('Accessibility', () => { it('should have proper ARIA attributes', () => {
      const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
    ...
    it('should be keyboard navigable for actionable suggestions', () => { const results = [
        createMockResult(1, 'First result') }
        createMockResult(2, 'Second result')
      ];
      render(<VarianceAnalysis results={results} />);
