...
export const SentimentDashboard = ({ resourceId, resourceType, timeRange, refreshInterval }) => {
    ...
    const loadAnalytics = async () => {
        ...
        setError(null);
        try {
            const analyticsData = await sentimentService.getSentimentAnalytics(resourceId, resourceType, selectedTimeRange);
        ...
        return (_jsxs("div", { style: {
                ...
                border: '1px solid #e5e7eb'
                        ...
                        display: 'flex'
                                ...
                                fontSize: '12px',
                                fontWeight: '600'
                            }, children: sentimentDistribution.positive.percentage > 10 &&
                                ...
                                fontSize: '12px',
                                fontWeight: '600'
                            }, children: sentimentDistribution.neutral.percentage > 10 &&
                                formatPercentage(sentimentDistribution.neutral.percentage) }), _jsx("div", { style: {
                                ...
                                fontSize: '12px',
                                fontWeight: '600'
                            }, children: sentimentDistribution.negative.percentage > 10 &&
                                formatPercentage(sentimentDistribution.negative.percentage) })] }), _jsxs("div", { style: {
                        display: 'grid',
                        ...
                        gap: '12px'
                                        ...
                                        fontSize: '10px',
                                        color: '#9ca3af'
                                    }, children: ["Avg: ", sentimentDistribution.positive.averageScore.toFixed(2)] })] }), _jsxs("div", { style: { textAlign: 'center' }, children: [_jsx("div", { style: {
                                        fontSize: '24px',
                                        fontWeight: '700',
                                        color: '#6b7280',
                                        marginBottom: '4px'
                                        ...
                                        fontSize: '10px',
                                        color: '#9ca3af'
                                    }, children: ["Avg: ", sentimentDistribution.neutral.averageScore.toFixed(2)] })] }), _jsxs("div", { style: { textAlign: 'center' }, children: [_jsx("div", { style: {
                                        fontSize: '24px',
                                        fontWeight: '700',
                                        color: '#dc2626',
                                        marginBottom: '4px'
    ...
    const renderEmotionAnalysis = () => {
        ...
        return (_jsxs("div", { style: {
                ...
                border: '1px solid #e5e7eb'
                        ...
                        fontWeight: '600',
                        color: '#111827'
                    }, children: "\uD83C\uDFAD Emotion Analysis" }), emotionAnalytics.dominant && (_jsxs("div", { style: {
                        ...
                        textAlign: 'center'
                            ...
                            }, children: ["Dominant Emotion: ", emotionAnalytics.dominant] })] })), _jsx("div", { style: {
                        display: 'grid',
                        gridTemplateColumns: 'repeat(4, 1fr)',
                        gap: '8px'
                    }, children: Object.entries(emotionAnalytics.distribution).map(([emotion, percentage]) => (_jsxs("div", { style: {
                            textAlign: 'center',
                            padding: '8px',
                            backgroundColor: '#f9fafb',
                            borderRadius: '6px'
                        }, children: [_jsx("div", { style: { fontSize: '20px', marginBottom: '4px' }, children: getEmotionIcon(emotion) }), _jsx("div", { style: {
                                    fontSize: '11px',
                                    color: '#374151',
                                    textTransform: 'capitalize',
                                    marginBottom: '2px'
                                    ...
                                    fontWeight: '600',
                                    color: '#6b7280'
                                }, children: formatPercentage(percentage) })] }, emotion))) }), _jsxs("div", { style: {
                        marginTop: '12px',
                        padding: '8px',
                        ...
                        color: '#92400e',
                        textAlign: 'center'
                    }, children: ["\uD83C\uDF00 Mixed emotions detected in ", formatPercentage(emotionAnalytics.mixedEmotionRate), " of feedback"] })] }));
    };
    const renderToxicityAnalysis = () => {
        ...
        return (_jsxs("div", { style: {
                ...
                border: '1px solid #e5e7eb'
                        ...
                        }, children: ["Overall Level: ", toxicityAnalytics.overallLevel] }) }), _jsx("div", { style: {
                        display: 'grid',
                        gridTemplateColumns: 'repeat(5, 1fr)',
                        gap: '8px',
                        marginBottom: '16px'
                    }, children: Object.entries(toxicityAnalytics.distribution).map(([level, percentage]) => (_jsxs("div", { style: {
                            textAlign: 'center',
                            padding: '8px',
                            backgroundColor: '#f9fafb',
                            borderRadius: '6px',
                            border: `2px solid ${getToxicityColor(level)}20`
                                    ...
                                    color: '#374151',
                                    textTransform: 'capitalize'
                                }, children: level })] }, level))) }), _jsx("div", { style: {
                        display: 'grid',
                        gridTemplateColumns: 'repeat(3, 1fr)',
                        gap: '8px',
                        marginBottom: '12px'
                    }, children: Object.entries(toxicityAnalytics.categories).map(([category, percentage]) => (_jsxs("div", { style: {
                            padding: '6px 8px',
                            ...
                            textAlign: 'center'
                                    ...
                                    color: '#9ca3af',
                                    textTransform: 'capitalize'
                                }, children: category.replace('_', ' ') })] }, category))) }), toxicityAnalytics.actionRequired > 0 && (_jsxs("div", { style: {
                        padding: '8px',
                        ...
                        color: '#dc2626',
                        textAlign: 'center'
                    }, children: ["\u26A0\uFE0F ", formatPercentage(toxicityAnalytics.actionRequired), " of content requires moderation action"] }))] }));
    };
                ...
                border: '1px solid #e5e7eb'
                        ...
                        marginBottom: '16px'
                                ...
                                gap: '8px'
                                                ...
                                                fontSize: '11px',
                                                color: '#6b7280'
                                            }, children: "Helpfulness" })] })] })] }), _jsxs("div", { style: {
                        display: 'grid',
                        ...
                        marginBottom: '16px'
                                        ...
                                        fontWeight: '600',
                                        color: '#059669'
                                    }, children: "\uD83D\uDFE2 Top Positive Keywords" }), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '4px' }, children: insights.topPositiveKeywords.map(keyword => (_jsx("span", { style: {
                                            padding: '2px 6px',
                                            backgroundColor: '#dcfce7',
                                            color: '#166534',
                                            borderRadius: '4px',
                                            fontSize: '11px'
                                        }, children: keyword }, keyword))) })] }), _jsxs("div", { children: [_jsx("h4", { style: {
                                        margin: '0 0 8px 0',
                                        fontSize: '14px',
                                        fontWeight: '600',
                                        color: '#dc2626'
                                    }, children: "\uD83D\uDD34 Top Negative Keywords" }), _jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '4px' }, children: insights.topNegativeKeywords.map(keyword => (_jsx("span", { style: {
                                            padding: '2px 6px',
                                            backgroundColor: '#fecaca',
                                            color: '#991b1b',
                                            borderRadius: '4px',
                                            fontSize: '11px'
                                        }, children: keyword }, keyword))) })] })] }), insights.emergingTopics.length > 0 && (_jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("h4", { style: {
                                margin: '0 0 8px 0',
                                fontSize: '14px',
                                fontWeight: '600',
                                color: '#7c2d12'
                            }, children: "\uD83D\uDCC8 Emerging Topics" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px' }, children: insights.emergingTopics.map(topic => (_jsxs("div", { style: {
                                    display: 'flex',
                                    ...
                                    fontSize: '12px'
                                            ...
                                            fontWeight: '600'
                                        }, children: [topic.sentiment, " (+", topic.growth, "%)"] })] }, topic.topic))) })] })), insights.recommendations.length > 0 && (_jsxs("div", { children: [_jsx("h4", { style: {
                                margin: '0 0 8px 0',
                                fontSize: '14px',
                                fontWeight: '600',
                                color: '#7c2d12'
                            }, children: "\uD83C\uDFAF Recommendations" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px' }, children: insights.recommendations.map((rec, index) => (_jsxs("div", { style: {
                                    padding: '8px',
                                    ...
                                    fontSize: '12px'
                                            ...
                                            color: '#374151',
                                            lineHeight: '1.3'
                                        }, children: rec.description })] }, index))) })] }))] }));
    };
    if (isLoading) {
        return (_jsxs("div", { style: {
                padding: '40px',
