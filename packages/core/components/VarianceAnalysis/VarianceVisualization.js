...
export const VarianceVisualization = ({ results, varianceAnalysis, className = '' }) => {
    const [activeChart, setActiveChart] = useState('length');
    // Prepare chart data
    const chartData = useMemo(() => {
        const validResults = results.filter(r => !r.error && r.output);
        const lengthData = validResults.map((result, index) => ({
            label: `Seed ${result.seed}`,
            value: result.output?.length || 0,
            color: `hsl(${(index * 137.5) % 360}, 70%, 60%)`
        }));
        const wordCountData = validResults.map((result, index) => ({
            label: `Seed ${result.seed}`,
    ...
    const BarChart = ({ data, title, maxValue, showValues = true }) => {
        ...
        return (_jsxs("div", { style: {
                ...
                padding: 16
                        ...
                        fontWeight: 600,
                        color: '#374151'
                    }, children: title }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: data.map((item, index) => (_jsxs("div", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 8
    ...
    const RadialChart = ({ data, title }) => {
        ...
        return (_jsxs("div", { style: {
                ...
                textAlign: 'center'
                        ...
                        gap: 16,
                        justifyItems: 'center'
                    }, children: data.map((item, index) => (_jsxs("div", { style: {
                            display: 'flex',
                            flexDirection: 'column',
                            alignItems: 'center',
                            gap: 8
                        }, children: [_jsxs("div", { style: { position: 'relative' }, children: [_jsxs("svg", { width: "100", height: "100", style: { transform: 'rotate(-90deg)' }, children: [_jsx("circle", { cx: centerX / 2, cy: centerY / 2, r: 30, fill: "none", stroke: "#f3f4f6", strokeWidth: "6" }), _jsx("circle", { cx: centerX / 2, cy: centerY / 2, r: 30, fill: "none", stroke: item.color, strokeWidth: "6", strokeLinecap: "round", strokeDasharray: circumference / 2, strokeDashoffset: circumference / 2 * (1 - item.value / 100), style: { transition: 'stroke-dashoffset 0.5s ease' } })] }), _jsxs("div", { style: {
                                            position: 'absolute',
                                            top: '50%',
                                            left: '50%',
    ...
    const HistogramChart = ({ data, title, binCount = 5 }) => {
        ...
        return (_jsxs("div", { style: {
                ...
                padding: 16
                        ...
                        fontWeight: 600,
                        color: '#374151'
                    }, children: [title, " Distribution"] }), _jsx("div", { style: {
                        display: 'flex',
                        alignItems: 'end',
                        gap: 4,
                        height: 120,
                        padding: '10px 0'
                    }, children: bins.map((bin, index) => (_jsxs("div", { style: {
                            flex: 1,
                            display: 'flex',
                            flexDirection: 'column',
                            alignItems: 'center',
                            gap: 4
                                ...
                                }, children: bin.value > 0 ? bin.value : '' }), _jsx("div", { style: {
                                    fontSize: 9,
                                    color: '#6b7280',
                                    textAlign: 'center',
                                    lineHeight: 1,
                                ...
                                }, children: bin.label })] }, index))) })] }));
    };
    if (!varianceAnalysis || results.length < 2) {
        return (_jsxs("div", { className: `variance-visualization ${className}`, style: {
                background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)',
                borderRadius: 12,
                border: '1px solid #e2e8f0',
                padding: 24,
                textAlign: 'center'
            }, children: [_jsx("div", { style: { fontSize: 24, marginBottom: 12 }, children: "\uD83D\uDCC8" }), _jsx("div", { style: { fontSize: 16, fontWeight: 600, color: '#1e293b', marginBottom: 8 }, children: "Visualization Unavailable" }), _jsx("div", { style: { fontSize: 14, color: '#64748b' }, children: "Generate at least 2 results to enable variance visualization" })] }));
    }
    return (_jsxs("div", { className: `variance-visualization ${className}`, style: {
            background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)',
            borderRadius: 12,
            ...
            overflow: 'hidden'
                    ...
                    background: 'rgba(255, 255, 255, 0.8)'
                            ...
                            alignItems: 'center',
                            gap: 8
                        }, children: "\uD83D\uDCC8 Variance Visualization" }), _jsx("div", { style: {
                            fontSize: 14,
                            color: '#64748b',
                            marginTop: 4
                        }, children: "Interactive charts and distribution analysis" })] }), _jsx("div", { style: {
                    display: 'flex',
                    borderBottom: '1px solid #e2e8f0',
                    ...
                    { id: 'creativity', label: '🎨 Creative Metrics', icon: '🎨' }
                ].map(chart => (_jsx("button", { onClick: () => setActiveChart(chart.id), style: {
                        flex: 1,
                        padding: 12,
                        border: 'none',
                        ...
                        cursor: 'pointer',
                        transition: 'all 0.2s'
                    }, children: chart.label }, chart.id))) }), _jsxs("div", { style: { padding: 20 }, children: [activeChart === 'length' && (_jsxs("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))',
                            gap: 16
                        }, children: [_jsx(BarChart, { data: chartData.length, title: "Character Length by Result", showValues: true }), _jsx(BarChart, { data: chartData.wordCount, title: "Word Count by Result", showValues: true }), _jsx(HistogramChart, { data: chartData.length, title: "Length", binCount: 4 })] })), activeChart === 'similarity' && (_jsxs("div", { style: {
                            display: 'grid',
                            ...
                            gap: 16
                                    ...
                                    padding: 16
                                            ...
                                            color: '#374151'
                                                    ...
                                                    background: '#f8fafc',
                                                    borderRadius: 4
                                                }, children: [_jsx("span", { style: { fontSize: 13, color: '#374151' }, children: "Tone Variation" }), _jsxs("span", { style: { fontSize: 14, fontWeight: 600, color: '#8b5cf6' }, children: [varianceAnalysis.toneVariation, "%"] })] })] })] }), _jsxs("div", { style: {
                                    background: 'white',
                                    borderRadius: 8,
                                    border: '1px solid #e5e7eb',
                                    padding: 16
                                            ...
                                            gap: 2,
                                            fontSize: 10
                                        }, children: results.map((result1, i) => (results.map((result2, j) => {
                                            const similarity = i === j ? 1 : (i < j ? Math.random() * 0.6 + 0.2 : // Simulated similarity
                                            ...
                                            marginTop: 8,
                                            textAlign: 'center'
                                        }, children: "Darker = More Similar" })] })] })), activeChart === 'content' && (_jsxs("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))',
                            gap: 16
                        }, children: [chartData.contentTypes.length > 0 && (_jsx(BarChart, { data: chartData.contentTypes, title: "Content Type Distribution", showValues: true })), _jsxs("div", { style: {
                                    background: 'white',
                                    borderRadius: 8,
                                    border: '1px solid #e5e7eb',
                                    padding: 16
                                            ...
                                            fontWeight: 600,
                                            color: '#374151'
                                        }, children: "Content Metrics" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsxs("div", { style: {
                                                    display: 'flex',
                                                    justifyContent: 'space-between',
                                                    alignItems: 'center',
                                                    padding: 8,
                                                    ...
                                                    background: '#f8fafc',
                                                    borderRadius: 4
                                                }, children: [_jsx("span", { style: { fontSize: 13, color: '#374151' }, children: "Valid Results" }), _jsx("span", { style: { fontSize: 14, fontWeight: 600, color: '#10b981' }, children: results.filter(r => !r.error && r.output).length })] })] })] })] })), activeChart === 'creativity' && (_jsx("div", { children: _jsx(RadialChart, { data: chartData.creativity, title: "Creative Performance Metrics" }) }))] })] }));
};
