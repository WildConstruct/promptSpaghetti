...
export const VFXPipelineVisualizer = ({ scene, scenes = [], _____realTimeUpdate = true, showControls = true, _____onSceneUpdate, className = '' }) => {
    ...
    const SceneVisualization3D = ({ scene }) => {
        ...
        return (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Camera, { className: "w-5 h-5 text-blue-600" }), "3D Scene Composition: ", scene.name] }), _jsxs("div", { className: "flex items-center gap-4 text-sm text-gray-600", children: [_jsx("span", { children: scene.historicalPeriod }), _jsx("span", { children: scene.region }), _jsxs(Badge, { variant: scene.accuracy.expertValidated ? 'default' : 'secondary', children: [scene.accuracy.overall, "% Accurate"] })] })] }), _jsx(CardContent, { children: _jsxs("div", { className: "relative", children: [_jsxs("svg", { width: canvasWidth, height: canvasHeight, className: "border rounded", children: [showGrid && (_jsx("defs", { children: _jsx("pattern", { id: "grid", width: "40", height: "40", patternUnits: "userSpaceOnUse", children: _jsx("path", { d: "M 40 0 L 0 0 0 40", fill: "none", stroke: "#e5e7eb", strokeWidth: "1" }) }) })), showGrid && _jsx("rect", { width: "100%", height: "100%", fill: "url(#grid)" }), _jsxs("g", { className: "environment-layers", children: [_jsx("defs", { children: _jsxs("linearGradient", { id: "skyGradient", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [_jsx("stop", { offset: "0%", stopColor: "#87CEEB" }), _jsx("stop", { offset: "100%", stopColor: "#E0F6FF" })] }) }), _jsx("rect", { width: "100%", height: "60%", fill: "url(#skyGradient)" }), _jsx("polygon", { points: `0,${canvasHeight * 0.6} ${canvasWidth},${canvasHeight * 0.6} ${canvasWidth},${canvasHeight} 0,${canvasHeight}`, fill: "#8B7355" })] }), _jsx("g", { className: "scene-assets", children: scene.assets.map((asset, index) => {
                                            const pos = project3DToIsometric((index % 5) * 100 - 200, 0, Math.floor(index / 5) * 80 - 100);
                                            const color = asset.accuracy > 90 ? '#10b981' :
                                                asset.accuracy > 70 ? '#f59e0b' : '#ef4444';
                                            return (_jsxs("g", { transform: `translate(${pos.x}, ${pos.y})`, children: [asset.type === 'building' && (_jsx("polygon", { points: "-15,-20 15,-20 20,-15 20,20 -20,20 -20,-15", fill: color, fillOpacity: "0.8", stroke: "#374151", strokeWidth: "2" })), asset.type === 'prop' && (_jsx("circle", { r: "8", fill: color, fillOpacity: "0.8", stroke: "#374151", strokeWidth: "2" })), asset.type === 'vegetation' && (_jsx("polygon", { points: "-8,15 0,-20 8,15", fill: "#22c55e", fillOpacity: "0.8", stroke: "#166534", strokeWidth: "2" })), _jsx("circle", { r: "3", cx: "15", cy: "-15", fill: color }), _jsx("text", { x: "15", y: "-10", textAnchor: "middle", fontSize: "10", fill: "#374151", fontWeight: "600", children: Math.round(asset.accuracy) })] }, asset.id));
                                        }) }), _jsx("g", { className: "scene-characters", children: scene.characters.map((character, index) => {
                                            const pos = project3DToIsometric(character.position.x || (index * 60 - 120), character.position.y || 0, character.position.z || (index * 30 - 60));
                                            const color = character.type === 'hero' ? '#3b82f6' :
                                                character.type === 'crowd' ? '#8b5cf6' : '#6b7280';
                                            return (_jsxs("g", { transform: `translate(${pos.x}, ${pos.y})`, children: [_jsx("ellipse", { rx: "6", ry: "3", cy: "20", fill: color, fillOpacity: "0.3" }), _jsx("rect", { x: "-3", y: "5", width: "6", height: "15", rx: "3", fill: color }), _jsx("circle", { r: "4", cy: "-2", fill: color }), _jsx("text", { x: "0", y: "35", textAnchor: "middle", fontSize: "8", fill: "#374151", fontWeight: "500", children: character.type.charAt(0).toUpperCase() })] }, character.id));
                                        }) }), _jsx("g", { className: "camera-view", children: _jsxs("g", { transform: `translate(${canvasWidth - 80}, 40)`, children: [_jsx("circle", { r: "25", fill: "rgba(59, 130, 246, 0.1)", stroke: "#3b82f6", strokeWidth: "2" }), _jsx("polygon", { points: "-8,-8 8,-8 12,0 8,8 -8,8", fill: "#3b82f6", transform: "rotate(45)" }), _jsx("text", { x: "0", y: "40", textAnchor: "middle", fontSize: "10", fill: "#3b82f6", children: "Camera" })] }) })] }), showControls && (_jsxs("div", { className: "absolute top-2 right-2 flex flex-col gap-2", children: [_jsx(Button, { variant: "outline", size: "sm", onClick: () => setShowGrid(!showGrid), className: "bg-white/90", children: "Grid" }), _jsxs(Select, { value: viewMode, onValueChange: (value) => setViewMode(value), children: [_jsx(SelectTrigger, { className: "w-20 h-8 bg-white/90", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "2d", children: "2D" }), _jsx(SelectItem, { value: "3d", children: "3D" }), _jsx(SelectItem, { value: "timeline", children: "Time" })] })] })] }))] }) })] }));
    };
    ...
    const HistoricalAccuracyDashboard = ({ scene }) => {
        ...
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center justify-between", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(CheckCircle, { className: "w-5 h-5 text-green-600" }), "Historical Accuracy Score"] }), _jsx(Badge, { variant: scene.accuracy.expertValidated ? 'default' : 'secondary', children: scene.accuracy.expertValidated ? 'Expert Validated' : 'Pending Review' })] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "flex items-center justify-center mb-6", children: _jsxs("div", { className: "relative w-32 h-32", children: [_jsxs("svg", { className: "w-full h-full transform -rotate-90", children: [_jsx("circle", { cx: "64", cy: "64", r: "56", stroke: "#e5e7eb", strokeWidth: "8", fill: "none" }), _jsx("circle", { cx: "64", cy: "64", r: "56", stroke: scene.accuracy.overall >= 80 ? '#10b981' : scene.accuracy.overall >= 60 ? '#f59e0b' : '#ef4444', strokeWidth: "8", fill: "none", strokeDasharray: `${(scene.accuracy.overall / 100) * 351.86} 351.86`, strokeLinecap: "round" })] }), _jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [_jsxs("span", { className: "text-3xl font-bold text-gray-900", children: [scene.accuracy.overall, "%"] }), _jsx("span", { className: "text-sm text-gray-600", children: "Accurate" })] })] }) }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: accuracyMetrics.map(metric => (_jsxs("div", { className: `p-3 rounded-lg ${getAccuracyColor(metric.value)}`, children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [metric.icon, _jsx("span", { className: "text-sm font-medium", children: metric.label })] }), _jsxs("div", { className: "text-lg font-bold", children: [metric.value, "%"] })] }, metric.label))) })] })] }), scene.accuracy.violations.length > 0 && (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(AlertTriangle, { className: "w-5 h-5 text-orange-600" }), "Accuracy Violations (", scene.accuracy.violations.length, ")"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: scene.accuracy.violations.map((violation, index) => (_jsxs("div", { className: "border rounded-lg p-4", children: [_jsx("div", { className: "flex items-start justify-between mb-2", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { className: getSeverityColor(violation.severity), children: violation.severity.toUpperCase() }), _jsx(Badge, { variant: "outline", children: violation.type.toUpperCase() })] }) }), _jsx("p", { className: "text-sm font-medium text-gray-900 mb-1", children: violation.element }), _jsx("p", { className: "text-sm text-gray-600 mb-2", children: violation.description }), _jsxs("div", { className: "text-xs text-blue-600 bg-blue-50 p-2 rounded", children: ["\uD83D\uDCA1 Suggestion: ", violation.suggestion] })] }, index))) }) })] }))] }));
    };
    // Material Properties Visualization
    const MaterialPropertiesVisualizer = ({ assets }) => {
        return (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Brush, { className: "w-5 h-5 text-purple-600" }), "Material Properties Analysis"] }) }), _jsx(CardContent, { children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: assets.map(asset => (_jsxs("div", { className: "border rounded-lg p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h4", { className: "font-medium text-gray-900", children: asset.name }), _jsxs(Badge, { variant: asset.accuracy > 80 ? 'default' : 'secondary', children: [asset.accuracy, "%"] })] }), _jsx("div", { className: "space-y-2", children: asset.materials.map((material, idx) => (_jsxs("div", { className: "flex items-center justify-between text-sm", children: [_jsx("span", { className: "text-gray-600", children: material.name }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-16 h-2 bg-gray-200 rounded-full overflow-hidden", children: _jsx("div", { className: `h-full rounded-full ${material.historicallyAccurate ? 'bg-green-500' : 'bg-orange-500'}`, style: { width: `${material.value * 100}%` } }) }), _jsxs("span", { className: "text-xs text-gray-500", children: [Math.round(material.value * 100), "%"] })] })] }, idx))) })] }, asset.id))) }) })] }));
    };
    ...
    const CrowdVisualization = ({ characters }) => {
        ...
        return (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Users, { className: "w-5 h-5 text-purple-600" }), "Crowd Analysis: ", crowdStats.total, " Characters"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("div", { children: [_jsx("h4", { className: "text-sm font-semibold text-gray-900 mb-3", children: "Character Types" }), _jsx("div", { className: "space-y-2", children: Object.entries(crowdStats.types).map(([type, count]) => {
    ...
    const TimelineVisualization = ({ scenes }) => {
        ...
        return (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Clock, { className: "w-5 h-5 text-indigo-600" }), "VFX Production Timeline"] }), _jsxs("div", { className: "flex items-center gap-4 mt-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Button, { variant: "outline", size: "sm", onClick: () => setIsPlaying(!isPlaying), children: isPlaying ? _jsx(Pause, { className: "w-4 h-4" }) : _jsx(Play, { className: "w-4 h-4" }) }), _jsx(Button, { variant: "outline", size: "sm", children: _jsx(Rewind, { className: "w-4 h-4" }) }), _jsx(Button, { variant: "outline", size: "sm", children: _jsx(SkipForward, { className: "w-4 h-4" }) })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "text-sm text-gray-600", children: "Speed:" }), _jsx(Slider, { value: [animationSpeed], onValueChange: (value) => setAnimationSpeed(value[0]), max: 5, min: 0.5, step: 0.5, className: "w-20" })] })] })] }), _jsx(CardContent, { children: _jsxs("div", { className: "relative", children: [_jsx("div", { className: "relative h-2 bg-gray-200 rounded-full mb-8", children: _jsx("div", { className: "absolute h-full bg-blue-500 rounded-full transition-all duration-1000", style: { width: `${(timelineItems.length > 0 ? (selectedScene ? timelineItems.findIndex(t => t.id === selectedScene.id) + 1 : 1) / timelineItems.length : 0) * 100}%` } }) }), _jsx("div", { className: "space-y-4", children: timelineItems.map((item, index) => (_jsxs("div", { className: `flex items-center gap-4 p-4 rounded-lg cursor-pointer transition-all ${selectedScene?.id === item.id ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 hover:bg-gray-100'}`, onClick: () => {
                                        const scene = scenes.find(s => s.id === item.id);
                                        if (scene)
                                            setSelectedScene(scene);
                                    }, children: [_jsx("div", { className: `w-4 h-4 rounded-full flex-shrink-0 ${item.status === 'completed' ? 'bg-green-500' : 'bg-yellow-500'}` }), _jsxs("div", { className: "flex-1", children: [_jsx("h4", { className: "font-medium text-gray-900", children: item.name }), _jsx("p", { className: "text-sm text-gray-600", children: item.period })] }), _jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "text-lg font-bold text-gray-900", children: [item.accuracy, "%"] }), _jsx(Badge, { variant: item.status === 'completed' ? 'default' : 'secondary', children: item.status === 'completed' ? 'Complete' : 'In Progress' })] })] }, item.id))) })] }) })] }));
    };
    ...
    const AssetRelationshipGraph = ({ assets }) => {
        ...
        return (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(Layers, { className: "w-5 h-5 text-indigo-600" }), "Asset Relationship Network"] }), _jsxs("div", { className: "text-sm text-gray-600", children: [Object.keys(assetCategories).length, " categories, ", assets.length, " total assets"] })] }), _jsx(CardContent, { children: _jsxs("div", { className: "space-y-6", children: [_jsx("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-3", children: Object.entries(assetCategories).map(([type, typeAssets]) => (_jsx("div", { className: "p-3 rounded-lg border-2 border-gray-200 hover:border-gray-300 cursor-pointer transition-colors", onClick: () => setSelectedAsset(selectedAsset === type ? null : type), style: {
