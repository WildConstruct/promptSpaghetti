 ...
 */
export const kpiThresholds: Record<string, KPIThresholds> = { // Runtime KPIs (lower is better)
  runtime_fcp: { }
 ...
 */
export function calculateKPIStatus(kpiId: string, value: number): 'excellent' | 'good' | 'warning' | 'critical' { const thresholds = kpiThresholds[kpiId];
 ...
 else { return slope > 0 ? 'improving' : 'degrading';
  /**
