...
export const performanceTargets: Record<string, PerformanceTarget> = {
 ...
 */
export const environmentAdjustments: Record<string, Record<string, number>> = {
  development: {
 ...
 */
export const deviceAdjustments: Record<string, Record<string, number>> = {
  'high-end': {
 ...
 */
export function getTargetsForUserSegment(segment: PerformanceTargetConfig['userSegment']): Record<string, PerformanceTarget> {
