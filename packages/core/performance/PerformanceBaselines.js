...
(function (MeasurementType) {
    ...
    MeasurementType["RATIO"] = "ratio"; // decimal ratios
})(MeasurementType || (MeasurementType = {}));
// Performance test environments
export var TestEnvironment;
...
export class PerformanceBaselineManager {
     ...
     */
    addMeasurement(baselineId, measurement) {
     ...
     */
    checkThreshold(baselineId, value) {
        const baseline = this.baselines.get(baselineId);
        if (!baseline) {
            throw new Error(`Baseline not found: ${baselineId}`);
        }
...
export const createDefaultBaselines = (manager) => {
