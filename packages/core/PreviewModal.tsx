...
export const PreviewModal: React.FC<PreviewModalProps> = ({ open
  ...
  cursor: 'pointer' }
            ...
            <button
              onClick={ () => {
                if (compareMode) {
                  clearComparison() } else { setCompareMode(true) }
}
              style={ {
          ...
          <div>
            ...
            {showVarianceAnalysis && results.length >= 2 && (
              <div style={{ marginBottom: 20 }}>
                ...
                <div>Variance Analysis would go here</div>
              </div>
            )}
            {/* Comparison View */}
                      ...
                      >
                        ...
                        {res.executionPath && (
                          <span style={{ marginLeft: 8 }}>
                            • {res.executionPath.steps.length} steps • {res.executionPath.randomizationPoints.length}{' '}
                            random points
                          </span>
                        )}
                      </div>
                          ...
                          return (
                            ...
                            >
                              <div>
                                ...
                                <span style={{ marginLeft: 4 }}>"{choice.selectedOption}"</span>
                              </div>
  ...
  borderTop: '1px solid #e5e7eb' }
        ...
        >
          <div style={{ fontSize: 12, color: '#6b7280' }}>
            ...
            {regeneratingResults.length > 0 && <span>⟳ {regeneratingResults.length} regenerating</span>}
          </div>
  ...
  fontSize: 12 }
        ...
        {exportDialog.open && <div>Export Options Dialog would go here</div>}
      </div>
    </div>
  );
};
