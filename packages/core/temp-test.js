...
class ParserSecurity {
   ...
   */
  private escapeSpecialCharacters(text) {
   ...
   */
  private containsExecutableCode(text) {
   ...
   */
  private validateStructure(response) {
   ...
   */
  private hasCycles(edges[], nodeCount) {
    const adjacency[][] = Array(nodeCount).fill(null).map(() => []);
