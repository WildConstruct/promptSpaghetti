...
exports.BaseNode = zod_1.z.object({
    ...
    extractedVariables: zod_1.z.array(zod_1.z.object({
        name: zod_1.z.string(),
...
exports.IncludeNodeSchema = exports.BaseNode.extend({
    ...
    name: security_1.SecurityValidation.safePropertyKey()
});
exports.SetVariableNodeSchema = exports.BaseNode.extend({
    type: zod_1.z.literal('SetVariable'),
    key: security_1.SecurityValidation.variableName(),
    value: security_1.SecurityValidation.safeValue()
});
...
exports.ConditionalNodeSchema = exports.BaseNode.extend({
    ...
    branches: zod_1.z.array(zod_1.z.object({
        condition: security_1.SecurityValidation.safeExpression(),
        output: security_1.SecurityValidation.safeString(),
        label: security_1.SecurityValidation.safeString().optional()
    })).optional(),
    defaultOutput: security_1.SecurityValidation.safeString().optional(),
    conditionalConfig: zod_1.z.object({
        allowVariableAccess: zod_1.z.boolean().optional(),
        strictMode: zod_1.z.boolean().optional(),
        customFunctions: zod_1.z.record(security_1.SecurityValidation.safeValue()).optional()
    }).optional()
});
