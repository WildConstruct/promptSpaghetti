...
interface WorkflowStore {
    ...
    fetchApprovals: (workspaceId: string, filters?: any) => Promise<void>;
    ...
    fetchLocks: (workspaceId: string, filters?: any) => Promise<void>;
    ...
    fetchHistory: (workspaceId: string, filters?: any) => Promise<void>;
...
export declare const useWorkflowStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<WorkflowStore>, "setState"> & {
    setState<A extends string | {
        type: string;
    }>(partial: WorkflowStore | Partial<WorkflowStore> | ((state: WorkflowStore) => WorkflowStore | Partial<WorkflowStore>), replace?: boolean | undefined, action?: A | undefined): void;
}>;
export {};
