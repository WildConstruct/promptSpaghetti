...
export enum LearningMetricType { // Tutorial Analytics
...
export interface LearningAnalyticsReportConfig { report_type: 'executive_summary' | 'detailed_analysis' | 'performance_review' | 'trend_analysis';
