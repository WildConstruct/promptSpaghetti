...
export interface ConversionFunnelDefinition { id: string;
    ...
    analytics: { enableRealTimeTracking: boolean;
...
export interface ConversionStep { id: string;
    ...
    successMetrics: { expectedCompletionRate: number;
        averageTimeToComplete: number;
        criticalSuccessFactors: string[] };
    branches: StepBranch[];
    metadata: { businessValue: number;
...
export interface PropertyMatcher { propertyPath: string;
...
export interface TimeWindow { start: string;
    end: string;
    daysOfWeek: number[];
    timezone?: string }
}
...
export interface SuccessCriteria { primary: {
    ...
    secondary: Array<{ stepId: string;
        requirements: ConditionLogic;
        weight: number;
        isOptional: boolean }>;
    scoreCalculation: { method: 'weighted' | 'binary' | 'progressive' | 'custom';
...
export interface FlexibleConversionEvent extends EnhancedConversionEvent { flexibleProperties: {
    ...
    templateContext?: { templateId: string;
        ...
        popularity: number;
        tags: string[] };
    sessionContext: { isNewSession: boolean;
...
export interface ConversionCohort { id: string;
    ...
    analysis: { retentionPeriods: number[];
    ...
    performance: { conversionRates: TimeSeriesData[];
...
export interface UserSegment { id: string;
    ...
    performance: { averageConversionRate: number;
        averageTimeToConvert: number;
    ...
    metadata: { businessValue: 'high' | 'medium' | 'low';
...
export interface TemplateEntity { id: string;
    ...
    conversionMetrics: { totalViews: number;
    ...
    engagement: { averageViewTime: number;
        bounceRate: number;
        shareCount: number;
