...
export declare class LearningAnalyticsServiceImpl implements LearningAnalyticsService {
    ...
    constructor(apiClient: any, skillAssessmentEngine: SkillAssessmentEngine, tutorialService: MarketplaceTutorialSystemService);
    ...
    identifyKnowledgeGaps(skillDomain?: SkillDomain): Promise<any[]>;
