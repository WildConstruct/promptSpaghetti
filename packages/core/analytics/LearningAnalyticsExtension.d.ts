...
export declare enum LearningMetricType { TUTORIAL_START = "tutorial_start",
...
export interface LearningAnalyticsEvent extends AnalyticsEvent { learning_context: {
...
export interface TutorialAnalyticsEvent extends LearningAnalyticsEvent { tutorial_context: {
        tutorial_id: string;
    ...
    learning_outcomes: { skills_demonstrated?: string[];
...
export interface KnowledgeBaseAnalyticsEvent extends LearningAnalyticsEvent { knowledge_context: {
        search_query?: string;
        search_results_count?: number;
        content_relevance_score?: number;
        resolution_success?: boolean;
        follow_up_actions?: string[] };
    content_quality: { helpfulness_rating?: number;
...
export interface CommunityAnalyticsEvent extends LearningAnalyticsEvent { contribution_context: {
        contribution_type: string;
        contribution_id?: string;
        review_type?: string;
        collaboration_mode?: string;
        mentor_involvement?: boolean };
    community_impact: { knowledge_sharing_score?: number;
...
export interface LearningEffectivenessMetrics { content_id: string;
    content_type: ContentType;
    period_start: Date;
    period_end: Date;
    engagement_metrics: {
    ...
    learning_outcomes: { skill_acquisition_rate: number;
...
export interface UserLearningAnalytics { user_id: string;
    ...
    skill_development: { skills_acquired: Array<{
            skill_domain: SkillDomain;
    ...
    engagement_patterns: { preferred_learning_times: string[];
    ...
    learning_effectiveness: { completion_rate_trend: number;
        time_to_competency_improvement: number;
        real_world_application_success: number;
        learning_satisfaction_trend: number;
        knowledge_transfer_rate: number };
    marketplace_correlation: { learning_to_purchase_correlation: number;
...
export interface LearningSessionPattern { pattern_type: 'intensive' | 'distributed' | 'sporadic' | 'consistent';
...
export interface HelpSeekingBehavior { help_request_frequency: number;
...
export interface CollaborationEngagement { peer_interaction_frequency: number;
...
export interface CommunityKnowledgeMetrics { community_id: string;
    analysis_period: string;
    content_creation: {
    ...
    knowledge_sharing: { knowledge_transfer_events: number;
    ...
    learning_impact: { community_content_effectiveness: number;
...
export interface KnowledgeBaseUsageMetrics { knowledge_base_id: string;
    analysis_period: string;
    usage_patterns: {
    ...
    content_effectiveness: { content_utilization_rate: Record<ContentType, number>;
    ...
    search_intelligence: { popular_search_terms: Array<{
            term: string;
            frequency: number;
            success_rate: number }>;
        failed_search_patterns: Array<{ pattern: string;
            frequency: number;
            suggested_content: string[] }>;
        semantic_search_effectiveness: number;
        query_refinement_patterns: QueryRefinementPattern[];
    };
    user_journey_analytics: { typical_user_paths: UserPath[];
...
export interface ContentGap { gap_type: 'missing_content' | 'insufficient_depth' | 'outdated_information' | 'accessibility_issue';
    topic_area: string;
    skill_level: SkillLevel;
...
export interface OutdatedContent { content_id: string;
    content_type: ContentType;
    last_updated: Date;
...
export interface QueryRefinementPattern { initial_query: string;
...
export interface UserPath { path_pattern: string[];
    frequency: number;
    success_rate: number;
    average_time_minutes: number;
...
export interface CrossContentNavigation { from_content_type: ContentType;
...
export interface LearningProgressionMetric { progression_type: 'linear' | 'branching' | 'circular' | 'exploratory';
...
export interface LearningAnalyticsService { trackLearningEvent(event: LearningAnalyticsEvent): Promise<void>;
...
export interface LearningTrend { trend_type: 'skill_demand' | 'content_popularity' | 'learning_pattern' | 'community_growth';
...
export interface PerformanceAnomaly { anomaly_type: 'sudden_drop' | 'sudden_spike' | 'gradual_decline' | 'stagnation';
    content_id: string;
    content_type: ContentType;
    detection_date: Date;
...
export interface PersonalizedInsight { insight_type: 'learning_opportunity' | 'skill_gap' | 'performance_improvement' | 'engagement_optimization';
    title: string;
    description: string;
...
export interface LearningPathAnalytics { learning_path_id: string;
    analysis_period: string;
    ...
    effectiveness_metrics: { skill_acquisition_success: number;
        real_world_application_rate: number;
        user_satisfaction_score: number;
        knowledge_retention_rate: number };
    personalization_impact: { personalized_vs_standard_performance: number;
        adaptation_effectiveness: number;
        user_preference_alignment: number };

}
}
export interface SkillDevelopmentROI { user_id: string;
    analysis_period: string;
    investment_metrics: {
    ...
    outcome_metrics: { skills_acquired: number;
        competency_improvements: number;
        marketplace_success_correlation: number;
        career_advancement_indicators: string[] };
    roi_calculation: { learning_efficiency_score: number;
...
export interface CommunityHealthScore { community_id: string;
    ...
    health_trends: { trend_direction: 'improving' | 'stable' | 'declining';
...
export interface KnowledgeTransferMetrics { analysis_period: string;
    transfer_volume: {
    ...
    transfer_effectiveness: { knowledge_adoption_rate: number;
        application_success_rate: number;
        retention_rate: number;
        amplification_factor: number };
    network_analysis: { knowledge_hub_identification: KnowledgeHub[];
        transfer_pathway_analysis: TransferPathway[];
        bottleneck_identification: KnowledgeBottleneck[] };

}
}
export interface KnowledgeHub { hub_id: string;
...
export interface TransferPathway { pathway_id: string;
...
export interface KnowledgeBottleneck { bottleneck_type: 'content_gap' | 'access_barrier' | 'quality_issue' | 'discovery_problem';
...
export interface RealTimeLearningActivity { active_learners: number;
...
export interface RealTimeCommunityEngagement { active_contributors: number;
...
export interface RealTimeKnowledgeActivity { search_queries_per_minute: number;
...
export interface LearningAnalyticsQuery extends AnalyticsQuery { learning_filters: {
    ...
    performance_filters: { min_completion_rate?: number;
...
export interface AnalyticsCorrelationQuery { primary_metrics: LearningMetricType[];
...
export interface CrossPlatformInsights { correlation_strength: number;
    ...
    causal_relationships: Array<{ cause_metric: string;
        effect_metric: string;
        causal_strength: number;
        time_lag_hours: number;
        confidence_interval: [number, number] }>;
    actionable_insights: Array<{ insight: string;
...
export interface LearningDataExport { export_id: string;
...
export interface ComprehensiveAnalyticsReport { report_id: string;
    generated_at: Date;
    ...
    detailed_sections: Array<{ section_title: string;
    ...
    appendices: { methodology: string;
        data_sources: string[];
        limitations: string[];
        definitions: Record<string, string> };

export declare const LearningAnalyticsEventSchema: z.ZodObject<{ learning_context: z.ZodObject<{ }
    ...
    }, "strip", z.ZodTypeAny, { content_id: string;
        content_type: ContentType;
        ...
        learning_objective?: string | undefined }, { content_id: string;
        content_type: ContentType;
        session_id?: string | undefined;
        skill_domain?: "security" | "writing" | "database" | "business" | "marketing" | "tools" | "design" | "programming" | "web-development" | "mobile-development" | "data-science" | "devops" | "soft-skills" | "project-management" | "ai-ml" | "quality-assurance" | "blockchain" | "game-development" | undefined;
        skill_level?: "advanced" | "expert" | "intermediate" | "beginner" | undefined;
    ...
    user_context: z.ZodObject<{ ,
        ...
        current_learning_path: z.ZodOptional<z.ZodString> }, "strip", z.ZodTypeAny, { user_role: string;
        skill_profile_snapshot?: unknown;
        learning_goals?: string[] | undefined;
        current_learning_path?: string | undefined }, { user_role: string;
        skill_profile_snapshot?: unknown;
        learning_goals?: string[] | undefined;
    ...
    performance_context: z.ZodObject<{ ,
        ...
        satisfaction_score: z.ZodOptional<z.ZodNumber> }, "strip", z.ZodTypeAny, { completion_percentage?: number | undefined;
        ...
        satisfaction_score?: number | undefined }, { completion_percentage?: number | undefined;
        time_spent_seconds?: number | undefined;
        interaction_count?: number | undefined;
        error_count?: number | undefined;
        help_requests?: number | undefined;
        satisfaction_score?: number | undefined }>;
}, "strip", z.ZodTypeAny, { learning_context: {
        content_id: string;
        content_type: ContentType;
        session_id?: string | undefined;
        skill_domain?: "security" | "writing" | "database" | "business" | "marketing" | "tools" | "design" | "programming" | "web-development" | "mobile-development" | "data-science" | "devops" | "soft-skills" | "project-management" | "ai-ml" | "quality-assurance" | "blockchain" | "game-development" | undefined;
    ...
    user_context: { user_role: string;
        ...
        learning_goals?: string[] | undefined;
        current_learning_path?: string | undefined };
    performance_context: { completion_percentage?: number | undefined;
        time_spent_seconds?: number | undefined;
        interaction_count?: number | undefined;
        error_count?: number | undefined;
        help_requests?: number | undefined;
...
export declare const LearningAnalyticsQuerySchema: z.ZodObject<{ learning_filters: z.ZodOptional<z.ZodObject<{ }
    ...
    }, "strip", z.ZodTypeAny, { user_segments?: LearningAnalyticsSegment[] | undefined;
        ...
        learning_objectives?: string[] | undefined }, { user_segments?: LearningAnalyticsSegment[] | undefined;
        skill_domains?: ("security" | "writing" | "database" | "business" | "marketing" | "tools" | "design" | "programming" | "web-development" | "mobile-development" | "data-science" | "devops" | "soft-skills" | "project-management" | "ai-ml" | "quality-assurance" | "blockchain" | "game-development")[] | undefined;
        skill_levels?: ("advanced" | "expert" | "intermediate" | "beginner")[] | undefined;
        content_types?: ContentType[] | undefined;
    ...
    performance_filters: z.ZodOptional<z.ZodObject<{ 
        ...
        time_range_minutes: z.ZodOptional<z.ZodObject<{ }
            min: z.ZodNumber;
            max: z.ZodNumber;
        }, "strip", z.ZodTypeAny, { min: number;
            max: number }, { min: number;
            max: number }>>;
    }, "strip", z.ZodTypeAny, { min_completion_rate?: number | undefined;
...
}, "strip", z.ZodTypeAny, { learning_filters?: {
        user_segments?: LearningAnalyticsSegment[] | undefined;
        skill_domains?: ("security" | "writing" | "database" | "business" | "marketing" | "tools" | "design" | "programming" | "web-development" | "mobile-development" | "data-science" | "devops" | "soft-skills" | "project-management" | "ai-ml" | "quality-assurance" | "blockchain" | "game-development")[] | undefined;
        skill_levels?: ("advanced" | "expert" | "intermediate" | "beginner")[] | undefined;
        content_types?: ContentType[] | undefined;
        learning_objectives?: string[] | undefined } | undefined;
    performance_filters?: { min_completion_rate?: number | undefined;
        min_satisfaction_score?: number | undefined;
        min_skill_acquisition_rate?: number | undefined;
        time_range_minutes?: {
            min: number;
