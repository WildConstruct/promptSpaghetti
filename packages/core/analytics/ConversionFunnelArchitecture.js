...
export class ConversionArchitectureManager {
     ...
     */
    createEnhancedEvent(baseEvent, touchpoints, privacyConsent) {
     ...
     */
    calculateAttribution(touchpoints) {
    ...
    calculateFirstTouchAttribution(touchpoints) {
    ...
    calculateLastTouchAttribution(touchpoints) {
    ...
    selectPrimaryAttribution(models) {
