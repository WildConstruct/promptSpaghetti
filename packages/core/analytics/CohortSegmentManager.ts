...
export class CohortSegmentManager {
   ...
   */
  public createSegment(definition: Partial<UserSegment>): UserSegment {
   ...
   */
  public getUserCohorts(userId: string): string {
...
export const createCohortSegmentManager = (): CohortSegmentManager => {
