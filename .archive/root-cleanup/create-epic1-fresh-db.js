...
console.log(`   - Critical Priority: ${freshDatabase.tasks.filter(t => t.priority === 'CRITICAL').length}`);
console.log(`   - High Priority: ${freshDatabase.tasks.filter(t => t.priority === 'HIGH').length}`);
console.log(`   - Medium Priority: ${freshDatabase.tasks.filter(t => t.priority === 'MEDIUM').length}`);
console.log(`   - Total Estimated Hours: ${freshDatabase.tasks.reduce((sum, t) => sum + t.estimatedHours, 0)}`);
