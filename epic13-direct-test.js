...
async function testEpic13Components() {
  ...
  try {
    ...
    const methods = [
      'storeEvent', 'storeGraphExecution', 'storeNodeExecution', 
      'storeTokenUsage', 'getAnalyticsSummary', 'getTimeSeriesData'
    ];
  ...
  try {
    ...
    const apiMethods = [
      'getSummary', 'getTimeSeries', 'getDashboardData', 
      'getCostSummary', 'getAlerts', 'exportData'
    ];
