...
const deploymentBlockerTasks = [
  {
    ...
    description:
      'Create packages/core/database/types.ts with foundational database interfaces. This is the most critical task as 1000+ cascading errors depend on these core types. Implement PaginatedResult<T> interface, PaginationOptions interface, and Role/Permission types for RBAC system.',
    estimate: '2 hours',
    priority: 'critical',
  ...
  },
  {
    ...
    description:
      'Install missing WebAuthn and FIDO2 type packages that are preventing authentication system compilation. Install @types/webauthn and @types/fido2-lib packages and configure proper TypeScript definitions for authentication system.',
    estimate: '1 hour',
    priority: 'critical',
    wipClass: 'infrastructure',
    epic: 'TypeScript Infrastructure',
  ...
  },
  {
    ...
    description:
      'Resolve Fastify plugin integration gaps causing authentication system failures. Fix request.user property registration, implement fastify.database property plugin, and complete AuditService.logAction method implementation.',
    estimate: '2 hours',
    priority: 'critical',
  ...
  },
  {
    ...
    description:
      'Fix critical variable scoping issues in template parser system blocking VFX export and template functionality. Resolve "variable \'template\' out of scope" errors and complete function signature repairs in packages/core/utils/templateParser.ts.',
    estimate: '3 hours',
    priority: 'critical',
    wipClass: 'bug-fix',
    epic: 'TypeScript Infrastructure',
  ...
  },
  {
    ...
    description:
      'Complete VFXRenderingData interface definition and resolve return statement syntax errors in VFX export system. Fix packages/core/services/VFXExporter.ts and complete weights property type definitions.',
    estimate: '2 hours',
    priority: 'critical',
    wipClass: 'feature',
    epic: 'TypeScript Infrastructure',
  ...
  },
  {
    ...
    description:
      'Resolve security interface type conflicts blocking security middleware and rate limiting systems. Fix RateLimitAction interface missing properties, resolve enum/class naming conflicts, and fix export assignment syntax errors.',
    estimate: '3 hours',
    priority: 'critical',
    wipClass: 'security',
    epic: 'TypeScript Infrastructure',
  ...
  },
  {
    ...
    description:
      'Fix missing export resolutions blocking module dependency resolution. Resolve SerializedGraph export mismatches, ValidationResult export conflicts, and missing database model exports across multiple modules.',
    estimate: '2 hours',
    priority: 'critical',
    wipClass: 'infrastructure',
    epic: 'TypeScript Infrastructure',
