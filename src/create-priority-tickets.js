...
const authenticationTasks = [
  {
    ...
    description:
      'Install React Router v6 and configure BrowserRouter in App.tsx. Create route structure for authentication pages (/login, /register, /reset-password, /profile). Update existing tab-based navigation to work with router.',
    estimate: '4 hours',
    priority: 'high',
  ...
  },
  {
    ...
    description:
      'Implement Zustand authentication store following existing graphStore patterns. Add JWT token storage, automatic refresh mechanism, and session persistence using localStorage.',
    estimate: '5 hours',
    priority: 'high',
    wipClass: 'feature',
    epic: 'Authentication Frontend Integration',
  ...
  },
  {
    ...
    description:
      'Create PrivateRoute wrapper component with redirect logic for unauthenticated users. Add return URL preservation for post-login redirect and test route protection.',
    estimate: '3 hours',
    priority: 'high',
    wipClass: 'security',
    epic: 'Authentication Frontend Integration',
  ...
  },
  {
    ...
    description:
      'Create LoginPage, RegistrationPage, PasswordResetPage, and EmailVerificationPage components wrapping existing auth forms. Add proper page layouts and navigation elements.',
    estimate: '4 hours',
    priority: 'high',
    wipClass: 'feature',
    epic: 'Authentication Frontend Integration',
  ...
  },
  {
    ...
    description:
      'Connect authentication store to existing backend endpoints. Implement automatic token refresh, logout functionality, and handle authentication errors and expired tokens.',
    estimate: '5 hours',
    priority: 'high',
  ...
  },
  {
    ...
    description:
      'Modify header to show authentication status, add login/logout buttons with proper routing, implement user profile access menu, and ensure navigation updates reflect authentication state changes.',
    estimate: '3 hours',
    priority: 'medium',
    wipClass: 'feature',
    epic: 'Authentication Frontend Integration',
...
const fileBrowserTasks = [
  {
    ...
    description:
      'Create FileBrowser main component with tree structure, FolderTree component with expand/collapse, FileItem component, drag-and-drop functionality, and context menu system.',
    estimate: '6 hours',
    priority: 'high',
    wipClass: 'feature',
  ...
  },
  {
    ...
    description:
      'Implement secure file management API endpoints (/api/files/*) for upload, delete, rename, move, and duplicate operations. Add proper validation and error handling.',
    estimate: '5 hours',
    priority: 'high',
    wipClass: 'backend',
    epic: 'File Browser & Project Management System',
  ...
  },
  {
    ...
    description:
      'Design .psg file format JSON schema, create TypeScript interfaces, implement project serialization/deserialization, and add validation with error handling.',
    estimate: '4 hours',
    priority: 'high',
    wipClass: 'infrastructure',
    epic: 'File Browser & Project Management System',
  ...
  },
  {
    ...
    description:
      'Modify GraphEditor to accept file path parameter, implement auto-save to file system, add file loading from browser selection, and handle unsaved changes when switching files.',
    estimate: '5 hours',
    priority: 'high',
    wipClass: 'integration',
    epic: 'File Browser & Project Management System',
  ...
  },
  {
    ...
    description:
      'Create SearchBar component with advanced filtering, implement file content indexing, add metadata and tag-based filtering, sorting options, and real-time search with debouncing.',
    estimate: '4 hours',
    priority: 'medium',
    wipClass: 'feature',
    epic: 'File Browser & Project Management System',
  ...
  },
  {
    ...
    description:
      'Build FilePreview component with graph thumbnails, implement favorites/bookmarks system, create RecentFiles component, and add quick navigation sidebar.',
    estimate: '4 hours',
    priority: 'medium',
    wipClass: 'feature',
    epic: 'File Browser & Project Management System',
