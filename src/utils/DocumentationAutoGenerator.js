  ...
  async generateREADMEs() {
    ...
    try {
      ...
      if (projectInfo.apis && projectInfo.apis.length > 0) {
        readme += this.templates.readme.apiSection
          .replace('{{apiDocs}}', 'See [API Documentation](docs/generated/api.md) for complete API reference.');
      }
      ...
      if (projectInfo.examples && projectInfo.examples.length > 0) {
        ...
        readme += this.templates.readme.examplesSection
