...
export class NodeExecutionError extends BaseError {
    constructor(nodeId, operation, message, cause, context) {
        super(`Node ${nodeId} failed during ${operation}: ${message}`, ErrorCode.NODE_EXECUTION_ERROR, ErrorSeverity.MEDIUM, { nodeId, operation, ...context }, {
            cause,
...
export class DatabaseConnectionError extends BaseError {
    constructor(message, context, cause) {
        super(`Database connection failed: ${message}`, ErrorCode.DATABASE_CONNECTION_ERROR, ErrorSeverity.CRITICAL, context, {
            cause,
...
export class MFAError extends BaseError {
    constructor(message, mfaType, context) {
        super(message, ErrorCode.MFA_ERROR, ErrorSeverity.MEDIUM, { ...context, metadata: { mfaType } }, {
...
export class ProjectLockedError extends BaseError {
    constructor(projectId, context) {
        super('Project is locked and cannot be modified', ErrorCode.PROJECT_LOCKED_ERROR, ErrorSeverity.MEDIUM, { ...context, metadata: { projectId } }, {
...
export class APIError extends BaseError {
    constructor(statusCode, message, endpoint, context) {
        super(`HTTP ${statusCode}: ${message}`, ErrorCode.API_ERROR, statusCode >= 500 ? ErrorSeverity.HIGH : ErrorSeverity.MEDIUM, { ...context, metadata: { statusCode, endpoint } }, {
...
export class ValidationError extends BaseError {
    constructor(field, value, expected, context) {
        super(`Invalid ${field}: expected ${expected}, got ${typeof value}`, ErrorCode.VALIDATION_ERROR, ErrorSeverity.LOW, { ...context, metadata: { field, value, expected } }, {
...
export class ConfigurationError extends BaseError {
    constructor(message, configKey, context) {
        super(message, ErrorCode.CONFIGURATION_ERROR, ErrorSeverity.HIGH, { ...context, metadata: { configKey } }, {
