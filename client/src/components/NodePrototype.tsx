            ...
            style={{
              background:
                index === selectedOptionIndex
                  ? professionalColors.accent.blue + '40'
              ...
              style={{
                background:
                  selectedDesign === design
                    ? professionalColors.accent.orange
      ...
      >
        ...
        <div style={{ fontSize: '14px', lineHeight: 1.6, color: professionalColors.text.secondary }}>
          <div style={{ marginBottom: '10px' }}>
            <strong style={{ color: professionalColors.text.primary }}>Current:</strong> Generic labels, requires
            inspector for content
          </div>
          <div style={{ marginBottom: '10px' }}>
            <strong style={{ color: professionalColors.text.primary }}>Option 1:</strong> Shows current selection with
            percentage
          </div>
          <div style={{ marginBottom: '10px' }}>
            <strong style={{ color: professionalColors.text.primary }}>Option 2:</strong> Lists top 3 options with
            bullets
          </div>
          <div style={{ marginBottom: '10px' }}>
            <strong style={{ color: professionalColors.text.primary }}>Option 3:</strong> Compact tags for quick
            scanning
          </div>
          <div>
            <strong style={{ color: professionalColors.text.primary }}>Option 4:</strong> Interactive buttons for direct
            selection
          </div>
        </div>
      </div>
