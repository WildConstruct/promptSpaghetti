    ...
    >
      ...
      <div style={{ marginBottom: '16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
          <span>FPS</span>
          <span style={{ color: fps < 30 ? '#ff4444' : fps < 50 ? '#ffaa00' : '#00ff00' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
          <span>Memory</span>
          <span style={{ color: memory.percentage > 80 ? '#ff4444' : memory.percentage > 60 ? '#ffaa00' : '#00ff00' }}>
      ...
      {report?.cacheStats && (
        <div style={{ marginBottom: '16px' }}>
          <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#00ff00' }}>Cache Performance</h4>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
            <span>Hit Rate</span>
            <span style={{ color: report.cacheStats.hitRate > 85 ? '#00ff00' : '#ffaa00' }}>
      ...
      {report?.workerStats && (
        <div style={{ marginBottom: '16px' }}>
          <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#00ff00' }}>Worker Pool</h4>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
            <span>Queue Length</span>
            <span style={{ color: report.workerStats.queueLength > 5 ? '#ffaa00' : '#00ff00' }}>
      ...
      {report?.metrics && Object.keys(report.metrics).length > 0 && (
        <div>
          <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#00ff00' }}>
            Operation Metrics
          </h4>
            ...
            {Object.entries(report.metrics).map(([name, stats]) => (
              <div 
                ...
                style={{ 
                  marginBottom: '8px',
                  padding: '4px',
                  backgroundColor: selectedMetric === name ? 'rgba(0, 255, 0, 0.1)' : 'transparent',
                  cursor: 'pointer',
                  borderRadius: '4px'
                }}
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2px' }}>
                  <span style={{ fontSize: '11px', color: '#88ff88' }}>{name}</span>
                ...
                {selectedMetric === name && (
                  <div style={{ fontSize: '10px', marginTop: '4px', paddingLeft: '8px' }}>
