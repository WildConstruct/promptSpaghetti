...
async function loadCoreModules() {
  if (!coreModules) {
    try {
      ...
      // Load advanced nodes
      advancedNodes.WeightedAdvanced = await import('../../../../packages/core/dist/packages/core/runtime/nodes/WeightedAdvanced.js');
      advancedNodes.Conditional = await import('../../../../packages/core/dist/packages/core/runtime/nodes/Conditional.js');
      advancedNodes.Sequential = await import('../../../../packages/core/dist/packages/core/runtime/nodes/Sequential.js');
