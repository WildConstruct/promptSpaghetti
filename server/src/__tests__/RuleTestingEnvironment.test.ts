...
jest.mock('../services/ComplianceRuleEngine', () => ({
  ComplianceRuleEngine: jest.fn<unknown[], unknown>().mockImplementation(() => ({
    detectConflicts: jest.fn<unknown[], unknown>().mockResolvedValue([] as unknown as unknown),
    resolveConflicts: jest.fn<unknown[], unknown>().mockResolvedValue([] as unknown as unknown),
    evaluateRules: jest.fn<unknown[], unknown>().mockResolvedValue([] as unknown as unknown)
  }))
}));

jest.mock('../services/RuleTestingFramework', () => ({
  RuleTestingFramework: jest.fn<unknown[], unknown>().mockImplementation(() => ({
    generateTests: jest.fn<unknown[], unknown>().mockResolvedValue([] as unknown as unknown),
    executeTestSuite: jest.fn<unknown[], unknown>().mockResolvedValue({} as unknown as unknown),
