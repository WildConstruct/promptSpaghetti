  ...
  app.get(
    '/api/files/list',
    {
      preHandler: [
        ...
        rateLimiter({ key: 'files:list', limitPerMinute: 120 })
      ]
    },
    async (req, reply) => {
  ...
  app.post(
    '/api/files/upload',
    {
      preHandler: [
        ...
        rateLimiter({ key: 'files:upload', limitPerMinute: 60 })
      ]
    },
    async (req, reply) => {
      const admin = getSupabaseAdmin();
  ...
  app.get(
    '/api/files/download',
    {
      preHandler: [
        ...
        rateLimiter({ key: 'files:download', limitPerMinute: 120 })
      ]
    },
    async (req, reply) => {
      const admin = getSupabaseAdmin();
  ...
  app.delete(
    '/api/files/delete',
    {
      preHandler: [
        ...
        rateLimiter({ key: 'files:delete', limitPerMinute: 60 })
      ]
    },
    async (req, reply) => {
      const admin = getSupabaseAdmin();
