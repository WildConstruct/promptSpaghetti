...
class MockConflictResolver extends EventEmitter {
  processOperation = jest.fn<unknown[], unknown>();
...
class MockPresenceManager extends EventEmitter {
  addUserPresence = jest.fn<unknown[], unknown>();
  updateUserPresence = jest.fn<unknown[], unknown>();
  removeUserPresence = jest.fn<unknown[], unknown>();
  getDocumentUsers = jest.fn(() => []);
}

class MockConnectionManager extends EventEmitter {
  getConnectionInfo = jest.fn<unknown[], unknown>();
