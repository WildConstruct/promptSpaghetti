...
describe('OAuthPolicyService', () => {
  ...
  beforeEach(() => {
    ...
    mockPolicyAuthoringService.createPolicy = jest.fn<unknown[], unknown>().mockResolvedValue('policy-123' as unknown as unknown as unknown as unknown);
    ...
    mockPolicyAcceptanceService.recordPolicyAcceptance = jest.fn<unknown[], unknown>().mockResolvedValue('consent-123' as unknown as unknown as unknown as unknown);
    mockComplianceReportingService.generateReport = jest.fn<unknown[], unknown>().mockResolvedValue('report-123' as unknown as unknown as unknown as unknown);
  ...
  describe('Client Registration Policy Enforcement', () => {
    test('should enforce client registration policy successfully', async () => {
      ...
      jest.spyOn(oauthPolicyService as any, 'mapViolations').mockReturnValue([] as unknown as unknown as unknown as unknown);
      jest.spyOn(
        oauthPolicyService as any,
        'generateRecommendations'
      ).mockReturnValue([] as unknown as unknown as unknown as unknown);
      jest.spyOn(
        oauthPolicyService as any,
      ...
      ).mockReturnValue(new Date( as unknown));
