...
describe('WebSocketServer', () => {
  ...
  describe('initialization', () => {
    ...
    it('should start server on configured port', async () => {
      ...
      (WebSocket.Server as jest.MockedClass<typeof WebSocket.Server>).mockImplementation(() => mockWss as any);
  ...
  describe('error handling', () => {
    it('should handle server start errors gracefully', async () => {
      ...
      (WebSocket.Server as jest.MockedClass<typeof WebSocket.Server>).mockImplementation(() => {
