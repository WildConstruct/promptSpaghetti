...
describe('PresenceManager', () => {
  ...
  describe('status transitions', () => {
    ...
    it('should transition user status based on activity', (done) => {
  ...
  describe('cleanup', () => {
    it('should remove stale users during cleanup', (done) => {
      presenceManager.addUserPresence('conn-1', 'user-1', 'doc-1');
      ...
      }, config.offlineTimeout + config.cleanupInterval + 100);
    });

    it('should emit user_left event during cleanup', (done) => {
      presenceManager.addUserPresence('conn-1', 'user-1', 'doc-1');
