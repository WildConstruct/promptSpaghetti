...
describe('State Transition Tests', () => {
  ...
  describe('Comprehensive Test Suite', () => {
    it('should run all transition tests successfully', async () => {
      ...
      const validTransitionTests = results.details.filter(d => 
        d.test.includes('Valid transition') && d.result === 'passed'
      );
      const invalidTransitionTests = results.details.filter(d => 
        d.test.includes('Invalid transition') && d.result === 'passed'
      );
