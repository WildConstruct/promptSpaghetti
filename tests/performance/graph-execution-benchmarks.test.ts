...
describe('Graph Execution Benchmarks with Multiple Seeds', () => {
  ...
  test('Branching graph execution benchmark', async () => {
    ...
    console.log(
      `Branching graph: ${result.summary.throughput.toFixed(1)} exec/sec, ${(result.summary.determinismScore * 100).toFixed(1)}% deterministic`
    );
  }, 30000);
  ...
  test('Complex graph execution benchmark', async () => {
    ...
    console.log(
      `Complex graph: ${result.summary.throughput.toFixed(1)} exec/sec, ${(result.summary.determinismScore * 100).toFixed(1)}% deterministic`
    );
  }, 30000);
