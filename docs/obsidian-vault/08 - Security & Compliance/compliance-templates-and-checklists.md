...
1. [Framework-Specific Checklists](#framework-specific-checklists)
2. [Audit Preparation Templates](#audit-preparation-templates)
3. [Compliance Assessment Forms](#compliance-assessment-forms)
4. [Incident Response Templates](#incident-response-templates)
5. [Training Documentation Templates](#training-documentation-templates)
6. [Vendor Compliance Templates](#vendor-compliance-templates)
7. [Regulatory Reporting Templates](#regulatory-reporting-templates)
...
- [ ] **Legal Basis Identification**
  ...
  - [ ] Article 6(1)(f) - Legitimate interests assessment completed

- [ ] **Special Category Data (Article 9)**
  - [ ] Explicit consent obtained (where applicable)
  - [ ] Necessity for employment/social protection assessed
  - [ ] Vital interests protection documented
  - [ ] Public interest/official authority basis established
  - [ ] Healthcare purposes documented
  - [ ] Archiving/research/statistical purposes justified
...
- [ ] **Data Subject Rights Implementation**
  ...
  - [ ] Right to data portability technical capability
  - [ ] Right to object mechanisms implemented
  - [ ] Rights related to automated decision-making addressed

- [ ] **Privacy by Design and Default**
  - [ ] Data minimization principle implemented
  - [ ] Purpose limitation controls in place
  - [ ] Accuracy maintenance procedures established
  - [ ] Storage limitation policies enforced
  - [ ] Integrity and confidentiality measures active
...
- [ ] A.7.2.2 - Information security awareness training provided
...
- [ ] A.8.2.2 - Information labeling procedures followed
...
- [ ] A.9.2.2 - User access provisioning procedures documented
- [ ] A.9.2.3 - Management of privileged access rights controlled
- [ ] A.9.2.4 - User access rights reviewed regularly
- [ ] A.9.3.1 - Use of secret authentication information controlled
- [ ] A.9.4.1 - Information access restriction procedures implemented
...
|-----------|--------|---------------|
| Threat Likelihood | ☐ Very Low ☐ Low ☐ Medium ☐ High ☐ Very High | |
| Vulnerability Severity | ☐ Very Low ☐ Low ☐ Medium ☐ High ☐ Very High | |
...
- [ ] Code migration controls prevent unauthorized changes
- [ ] Change testing requirements specified and enforced
...
- [ ] Media handling and retention policies enforced
...
- [ ] Terminated employee access removal procedures enforced
- [ ] System access logging and monitoring active
...
- [ ] Financial statement preparation controls verified
...
- [ ] **Audit Planning Meeting Scheduled**
  ...
  - [ ] Audit methodology agreed upon
  - [ ] Resource requirements determined

- [ ] **Documentation Review Initiated**
  - [ ] Policy and procedure documents current
  - [ ] Control evidence collection begun
...
- [ ] **Final Preparations**
  ...
  - [ ] Workspace prepared for audit team

- [ ] **Evidence Package Assembly**
  - [ ] Control documentation organized
  - [ ] Testing evidence prepared
  - [ ] Exception documentation compiled
  - [ ] Management responses drafted
...
- [ ] **Preventive Controls**
  ...
  - Physical controls sufficiency: ☐ High ☐ Medium ☐ Low

- [ ] **Detective Controls**
  - Monitoring controls effectiveness: ☐ High ☐ Medium ☐ Low
