...
**Status: Appendix / Candidate Implementation Path – vendor-specific and replaceable**  
**Note:** Not beta-critical until the abstract preview interface exists; after that, these are candidate backend paths.

## Appendix A: Recommended Preview Backend Candidate – Krea

**Krea API Integration Guide for Prompt Spaghetti**  
...
```json
{
  ...
  "imageUrls": [
    ...
    "https://your-background-plate-url.com/scene-crop.jpg"
  ],
...
## Appendix B: ControlNet / Pose / Direction Node Spec
...
```json
{
  ...
  "strength": 0.65,
  "imageUrls": [
    "https://your-control-image-url (depth map or pose)",
    "https://background-plate-crop-url"
  ],
  "negative_prompt": "...",
  "guidance_scale": 7.5
}
