...
_Store a JS/JSON map inside the app code_
_Pros_: Zero impact on generator assets.
_Cons_: Requires code deploy to update metadata, blocking content authors.
